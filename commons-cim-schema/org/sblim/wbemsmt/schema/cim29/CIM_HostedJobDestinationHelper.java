 ...
 * 
 * Description: Helper class for CIM_HostedJobDestination
 *    
 * 
 * generated Class
 * @see CIM_HostedJobDestination
 */
...
public class CIM_HostedJobDestinationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostedJobDestination or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedJobDestination.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_HostedJobDestination.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostedJobDestination or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_HostedJobDestination(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostedJobDestinationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HostedJobDestination.");
                        resultArrayList.add(new CIM_HostedJobDestination(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedJobDestination.");
                        resultArrayList.add(new CIM_HostedJobDestination(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedJobDestination.");
                        resultArrayList.add(new CIM_HostedJobDestination(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedJobDestination getInstance(WBEMClient client,
    ...
    public final static CIM_HostedJobDestination getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostedJobDestination) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostedJobDestination(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostedJobDestination getInstance(WBEMClient client, String namespace,
            CIM_System Antecedent, CIM_JobDestination Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedJobDestination.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedJobDestination.PROPERTY_DEPENDENT_CIM_JOBDESTINATION.NAME,
                new CIMDataType(CIM_JobDestination.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostedJobDestination.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_HostedJobDestination createInstance(WBEMClient client,
            CIM_HostedJobDestination dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_HostedJobDestination newDataInstance = CIM_HostedJobDestinationHelper.getInstance(
     ...
     */
    public final static CIM_HostedJobDestination modifyInstance(WBEMClient client,
            CIM_HostedJobDestination dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedJobDestination dataInstance2 = CIM_HostedJobDestinationHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedJobDestination dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedJobDestination.getPackages());
    }
