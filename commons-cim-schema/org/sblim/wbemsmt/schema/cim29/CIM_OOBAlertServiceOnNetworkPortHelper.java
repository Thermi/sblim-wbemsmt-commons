 ...
 * 
 * Description: Helper class for CIM_OOBAlertServiceOnNetworkPort
 *    
 * 
 * generated Class
 * @see CIM_OOBAlertServiceOnNetworkPort
 */
...
public class CIM_OOBAlertServiceOnNetworkPortHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_OOBAlertServiceOnNetworkPort or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_OOBAlertServiceOnNetworkPort.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_OOBAlertServiceOnNetworkPort.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_OOBAlertServiceOnNetworkPort or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkPort(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_OOBAlertServiceOnNetworkPortHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_OOBAlertServiceOnNetworkPort.");
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_OOBAlertServiceOnNetworkPort.");
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_OOBAlertServiceOnNetworkPort.");
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkPort(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_OOBAlertServiceOnNetworkPort getInstance(WBEMClient client,
    ...
    public final static CIM_OOBAlertServiceOnNetworkPort getInstance(WBEMClient client,
        ...
        Class clazz = CIM_OOBAlertServiceOnNetworkPortHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_OOBAlertServiceOnNetworkPort) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_OOBAlertServiceOnNetworkPort(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_OOBAlertServiceOnNetworkPort getInstance(WBEMClient client,
            String namespace, CIM_NetworkPort Antecedent, CIM_OOBAlertService Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_OOBAlertServiceOnNetworkPort.PROPERTY_ANTECEDENT_CIM_NETWORKPORT.NAME,
                new CIMDataType(CIM_NetworkPort.CIM_CLASS_NAME), setThis, false, false,
                CIM_OOBAlertServiceOnNetworkPort.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_OOBAlertServiceOnNetworkPort.PROPERTY_DEPENDENT_CIM_OOBALERTSERVICE.NAME,
     ...
     *
     */
    public final static CIM_OOBAlertServiceOnNetworkPort createInstance(WBEMClient client,
            CIM_OOBAlertServiceOnNetworkPort dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_OOBAlertServiceOnNetworkPort newDataInstance = CIM_OOBAlertServiceOnNetworkPortHelper
     ...
     */
    public final static CIM_OOBAlertServiceOnNetworkPort modifyInstance(WBEMClient client,
            CIM_OOBAlertServiceOnNetworkPort dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_OOBAlertServiceOnNetworkPort dataInstance2 = CIM_OOBAlertServiceOnNetworkPortHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_OOBAlertServiceOnNetworkPort dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_OOBAlertServiceOnNetworkPort.getPackages());
    }
