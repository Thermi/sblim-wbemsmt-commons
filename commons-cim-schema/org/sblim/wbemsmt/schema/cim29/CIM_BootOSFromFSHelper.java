 ...
 * 
 * Description: Helper class for CIM_BootOSFromFS
 *    
 * 
 * generated Class
 * @see CIM_BootOSFromFS
 */
...
public class CIM_BootOSFromFSHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BootOSFromFS or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BootOSFromFS.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_BootOSFromFS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BootOSFromFS or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BootOSFromFS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BootOSFromFS(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BootOSFromFSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BootOSFromFS.");
                        resultArrayList.add(new CIM_BootOSFromFS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BootOSFromFS.");
                        resultArrayList.add(new CIM_BootOSFromFS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BootOSFromFS.");
                        resultArrayList.add(new CIM_BootOSFromFS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BootOSFromFS getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_BootOSFromFS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BootOSFromFS) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BootOSFromFS(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BootOSFromFS getInstance(WBEMClient client, String namespace,
            CIM_FileSystem Antecedent, CIM_OperatingSystem Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_BootOSFromFS.PROPERTY_ANTECEDENT_CIM_FILESYSTEM.NAME, new CIMDataType(
                        CIM_FileSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_BootOSFromFS.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_BootOSFromFS.PROPERTY_DEPENDENT_CIM_OPERATINGSYSTEM.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_BootOSFromFS createInstance(WBEMClient client,
            CIM_BootOSFromFS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_BootOSFromFS newDataInstance = CIM_BootOSFromFSHelper
     ...
     */
    public final static CIM_BootOSFromFS modifyInstance(WBEMClient client,
            CIM_BootOSFromFS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BootOSFromFS dataInstance2 = CIM_BootOSFromFSHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BootOSFromFS dataInstance)
            throws WbemsmtException {
