...
public final class CIM_LogRecordHelper {

	public final static String CIM_CLASS_NAME = "CIM_LogRecord";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_LogRecord.Java_Package_List.size(); i++) {
						if (!((String)(CIM_LogRecord.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_LogRecord.Java_Package_List.get(i))).endsWith(".")) {
							CIM_LogRecord.Java_Package_List.setElementAt((String)(CIM_LogRecord.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_LogRecord.");
						resultArrayList.add(new CIM_LogRecord(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_LogRecord.");
						resultArrayList.add(new CIM_LogRecord(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_LogRecord.");
						resultArrayList.add(new CIM_LogRecord(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_LogRecord getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_LogRecordHelper.getInstance(cimClient, new CIM_LogRecord(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_LogRecord getInstance(CIMClient cimClient, CIM_LogRecord dataInstance) {
		...
		return CIM_LogRecordHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_LogRecord getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_LogRecord dataInstance = null;
		try {
			dataInstance = new CIM_LogRecord(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_LogRecord createInstance(CIMClient cimClient, CIM_LogRecord dataInstance, boolean notifyDifferencies){ 
		...
		CIM_LogRecord newDataInstance = null;
		try {
			newDataInstance = CIM_LogRecordHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_LogRecord modifyInstance(CIMClient cimClient, CIM_LogRecord dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_LogRecordHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_LogRecord dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_LogRecord dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_LogRecord.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_LogRecord.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_LogRecord.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_LogRecord.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_LogRecord.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DataFormat(String DataFormat) {
		return true;
	}

	public static boolean isValid_LogCreationClassName(String LogCreationClassName) {
		return true;
	}

	public static boolean isValid_LogName(String LogName) {
		return true;
	}

	public static boolean isValid_MessageTimestamp(Calendar MessageTimestamp) {
		return true;
	}

	public static boolean isValid_RecordID(String RecordID) {
		return true;
	}
