 ...
 * 
 * Description: Helper class for CIM_SoftwareFeatureComponent
 *    
 * 
 * generated Class
 * @see CIM_SoftwareFeatureComponent
 */
...
public class CIM_SoftwareFeatureComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareFeatureComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareFeatureComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SoftwareFeatureComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareFeatureComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SoftwareFeatureComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareFeatureComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareFeatureComponent.");
                        resultArrayList.add(new CIM_SoftwareFeatureComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareFeatureComponent.");
                        resultArrayList.add(new CIM_SoftwareFeatureComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareFeatureComponent.");
                        resultArrayList.add(new CIM_SoftwareFeatureComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareFeatureComponent getInstance(WBEMClient client,
    ...
    public final static CIM_SoftwareFeatureComponent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareFeatureComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareFeatureComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareFeatureComponent getInstance(WBEMClient client,
            String namespace, CIM_SoftwareFeature GroupComponent, CIM_SoftwareFeature PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SoftwareFeatureComponent.PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREFEATURE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SoftwareFeatureComponent.PROPERTY_PARTCOMPONENT_CIM_SOFTWAREFEATURE.NAME,
                new CIMDataType(CIM_SoftwareFeature.CIM_CLASS_NAME), setThis, false, false,
                CIM_SoftwareFeatureComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SoftwareFeatureComponent createInstance(WBEMClient client,
            CIM_SoftwareFeatureComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SoftwareFeatureComponent newDataInstance = CIM_SoftwareFeatureComponentHelper
     ...
     */
    public final static CIM_SoftwareFeatureComponent modifyInstance(WBEMClient client,
            CIM_SoftwareFeatureComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareFeatureComponent dataInstance2 = CIM_SoftwareFeatureComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SoftwareFeatureComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareFeatureComponent.getPackages());
    }
