 ...
 * 
 * Description: Helper class for CIM_ProductFRU
 *    
 * 
 * generated Class
 * @see CIM_ProductFRU
...
public class CIM_ProductFRUHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductFRU or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductFRU.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ProductFRU.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductFRU or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ProductFRU.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProductFRU(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductFRUHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_ProductFRU.");
                        resultArrayList.add(new CIM_ProductFRU(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_ProductFRU.");
                        resultArrayList.add(new CIM_ProductFRU(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductFRU.");
                        resultArrayList.add(new CIM_ProductFRU(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductFRU getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ProductFRU getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductFRU) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductFRU(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductFRU getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ProductFRU.PROPERTY_PRODUCT_CIM_PRODUCT.NAME,
                new CIMDataType(CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductFRU.CIM_CLASS_NAME);

        setThis = FRU != null ? FRU.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_ProductFRU.PROPERTY_FRU_CIM_FRU.NAME,
     ...
     *
     */
    public final static CIM_ProductFRU createInstance(WBEMClient client,
            CIM_ProductFRU dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProductFRU newDataInstance = CIM_ProductFRUHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_ProductFRU modifyInstance(WBEMClient client,
            CIM_ProductFRU dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductFRU dataInstance2 = CIM_ProductFRUHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProductFRU dataInstance)
            throws WbemsmtException {
