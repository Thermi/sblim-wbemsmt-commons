 ...
 * 
 * Description: Helper class for CIM_ScopedSetting
 *    
 * 
 * generated Class
 * @see CIM_ScopedSetting
 */
...
public class CIM_ScopedSettingHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ScopedSetting or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ScopedSetting.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ScopedSetting.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ScopedSetting or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ScopedSetting.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ScopedSetting(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ScopedSettingHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ScopedSetting.");
                        resultArrayList.add(new CIM_ScopedSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ScopedSetting.");
                        resultArrayList.add(new CIM_ScopedSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ScopedSetting.");
                        resultArrayList.add(new CIM_ScopedSetting(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ScopedSetting getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ScopedSetting getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ScopedSetting) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ScopedSetting(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ScopedSetting getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement Antecedent, CIM_ScopedSettingData Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ScopedSetting.PROPERTY_ANTECEDENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
                        CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_ScopedSetting.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ScopedSetting.PROPERTY_DEPENDENT_CIM_SCOPEDSETTINGDATA.NAME, new CIMDataType(
                        CIM_ScopedSettingData.CIM_CLASS_NAME), setThis, false, false,
                CIM_ScopedSetting.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ScopedSetting createInstance(WBEMClient client,
            CIM_ScopedSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ScopedSetting newDataInstance = CIM_ScopedSettingHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ScopedSetting modifyInstance(WBEMClient client,
            CIM_ScopedSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ScopedSetting dataInstance2 = CIM_ScopedSettingHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ScopedSetting dataInstance)
            throws WbemsmtException {
