...
public class CIM_EnabledLogicalElementHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_EnabledLogicalElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_EnabledLogicalElement.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_EnabledLogicalElement.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_EnabledLogicalElement.");
                        resultArrayList.add(new CIM_EnabledLogicalElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_EnabledLogicalElement.");
                        resultArrayList.add(new CIM_EnabledLogicalElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_EnabledLogicalElement.");
                        resultArrayList.add(new CIM_EnabledLogicalElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_EnabledLogicalElement getInstance(WBEMClient client,
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_EnabledLogicalElement dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_EnabledLogicalElement.getPackages());
    }
