 ...
 * 
 * Description: Helper class for CIM_CollectionSetting
 *    
 * 
 * generated Class
 * @see CIM_CollectionSetting
 */
...
public class CIM_CollectionSettingHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CollectionSetting or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CollectionSetting.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CollectionSetting.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CollectionSetting or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_CollectionSetting(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CollectionSettingHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CollectionSetting.");
                        resultArrayList.add(new CIM_CollectionSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CollectionSetting.");
                        resultArrayList.add(new CIM_CollectionSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CollectionSetting.");
                        resultArrayList.add(new CIM_CollectionSetting(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CollectionSetting getInstance(WBEMClient client,
     ...
     */
    public final static CIM_CollectionSetting getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CollectionSetting) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CollectionSetting(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CollectionSetting getInstance(WBEMClient client, String namespace,
            CIM_CollectionOfMSEs Collection, CIM_Setting Setting
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CollectionSetting.PROPERTY_COLLECTION_CIM_COLLECTIONOFMSES.NAME,
                new CIMDataType(CIM_CollectionOfMSEs.CIM_CLASS_NAME), setThis, false, false,
                CIM_CollectionSetting.CIM_CLASS_NAME);

        setThis = Setting != null ? Setting.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_CollectionSetting.PROPERTY_SETTING_CIM_SETTING.NAME,
                new CIMDataType(CIM_Setting.CIM_CLASS_NAME), setThis, false, false,
                CIM_CollectionSetting.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CollectionSetting createInstance(WBEMClient client,
            CIM_CollectionSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_CollectionSetting newDataInstance = CIM_CollectionSettingHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_CollectionSetting modifyInstance(WBEMClient client,
            CIM_CollectionSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CollectionSetting dataInstance2 = CIM_CollectionSettingHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_CollectionSetting dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CollectionSetting.getPackages());
    }
