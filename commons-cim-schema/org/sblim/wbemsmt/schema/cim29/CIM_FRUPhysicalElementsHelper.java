 ...
 * 
 * Description: Helper class for CIM_FRUPhysicalElements
 *    
 * 
 * generated Class
 * @see CIM_FRUPhysicalElements
 */
...
public class CIM_FRUPhysicalElementsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FRUPhysicalElements or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FRUPhysicalElements.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FRUPhysicalElements.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FRUPhysicalElements or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_FRUPhysicalElements(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FRUPhysicalElementsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FRUPhysicalElements.");
                        resultArrayList.add(new CIM_FRUPhysicalElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FRUPhysicalElements.");
                        resultArrayList.add(new CIM_FRUPhysicalElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FRUPhysicalElements.");
                        resultArrayList.add(new CIM_FRUPhysicalElements(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FRUPhysicalElements getInstance(WBEMClient client,
    ...
    public final static CIM_FRUPhysicalElements getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FRUPhysicalElements) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FRUPhysicalElements(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FRUPhysicalElements getInstance(WBEMClient client, String namespace,
            CIM_FRU FRU, CIM_PhysicalElement Component
        ...
        keyProperties[0] = new CIMProperty(CIM_FRUPhysicalElements.PROPERTY_FRU_CIM_FRU.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_FRUPhysicalElements.PROPERTY_COMPONENT_CIM_PHYSICALELEMENT.NAME,
                new CIMDataType(CIM_PhysicalElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_FRUPhysicalElements.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FRUPhysicalElements createInstance(WBEMClient client,
            CIM_FRUPhysicalElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FRUPhysicalElements newDataInstance = CIM_FRUPhysicalElementsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_FRUPhysicalElements modifyInstance(WBEMClient client,
            CIM_FRUPhysicalElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FRUPhysicalElements dataInstance2 = CIM_FRUPhysicalElementsHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FRUPhysicalElements dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FRUPhysicalElements.getPackages());
    }
