...
public class CIM_IdentificationOfManagedSystem extends CIM_Dependency {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_SYSTEMIDENTIFICATION {
        /**
    ...
    public CIM_IdentificationOfManagedSystem(WBEMClient client, String namespace)
    ...
    public CIM_IdentificationOfManagedSystem(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_IdentificationOfManagedSystem() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_System(WBEMClient client, String namespace,
        ...
        CIM_IdentificationOfManagedSystem fco = new CIM_IdentificationOfManagedSystem(client,
                namespace);
    ...
    public CIM_SystemIdentification get_Dependent_CIM_SystemIdentification(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMIDENTIFICATION.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SYSTEMIDENTIFICATION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Dependent_CIM_SystemIdentification(CIM_SystemIdentification newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMIDENTIFICATION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_SystemIdentification(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_Dependent_CIM_SystemIdentification(WBEMClient client,
            String namespace, CIM_SystemIdentification newValue) throws WbemsmtException {
        CIM_IdentificationOfManagedSystem fco = new CIM_IdentificationOfManagedSystem(client,
                namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMIDENTIFICATION.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_SystemIdentification(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SYSTEMIDENTIFICATION.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_SystemIdentification(
    ...
    public String getObjectName() {
        return CIM_IdentificationOfManagedSystem.CIM_CLASS_NAME;
    }
