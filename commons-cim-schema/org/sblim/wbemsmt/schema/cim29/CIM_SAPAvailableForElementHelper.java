 ...
 * 
 * Description: Helper class for CIM_SAPAvailableForElement
 *    
 * 
 * generated Class
 * @see CIM_SAPAvailableForElement
 */
...
public class CIM_SAPAvailableForElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SAPAvailableForElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SAPAvailableForElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SAPAvailableForElement.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SAPAvailableForElement or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_SAPAvailableForElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SAPAvailableForElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SAPAvailableForElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SAPAvailableForElement.");
                        resultArrayList.add(new CIM_SAPAvailableForElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SAPAvailableForElement.");
                        resultArrayList.add(new CIM_SAPAvailableForElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SAPAvailableForElement.");
                        resultArrayList.add(new CIM_SAPAvailableForElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SAPAvailableForElement getInstance(WBEMClient client,
    ...
    public final static CIM_SAPAvailableForElement getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SAPAvailableForElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SAPAvailableForElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SAPAvailableForElement getInstance(WBEMClient client, String namespace,
            CIM_ServiceAccessPoint AvailableSAP, CIM_ManagedElement ManagedElement
        ...
        setThis = AvailableSAP != null ? AvailableSAP.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_SAPAvailableForElement.PROPERTY_AVAILABLESAP_CIM_SERVICEACCESSPOINT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SAPAvailableForElement.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_SAPAvailableForElement createInstance(WBEMClient client,
            CIM_SAPAvailableForElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SAPAvailableForElement newDataInstance = CIM_SAPAvailableForElementHelper.getInstance(
     ...
     */
    public final static CIM_SAPAvailableForElement modifyInstance(WBEMClient client,
            CIM_SAPAvailableForElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SAPAvailableForElement dataInstance2 = CIM_SAPAvailableForElementHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SAPAvailableForElement dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SAPAvailableForElement.getPackages());
    }
