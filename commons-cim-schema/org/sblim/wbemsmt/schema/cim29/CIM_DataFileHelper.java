 ...
 * 
 * Description: Helper class for CIM_DataFile
 *    
 * 
 * generated Class
 * @see CIM_DataFile
...
public class CIM_DataFileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DataFile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DataFile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_DataFile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DataFile or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_DataFile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_DataFile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DataFileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_DataFile.");
                        resultArrayList.add(new CIM_DataFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_DataFile.");
                        resultArrayList.add(new CIM_DataFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DataFile.");
                        resultArrayList.add(new CIM_DataFile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DataFile getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_DataFile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {

        CIM_DataFile dataInstance = null;
        Class clazz = CIM_DataFileHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DataFile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DataFile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DataFile getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_DataFile.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DataFile.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_DataFile.PROPERTY_CSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_DataFile.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_DataFile.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DataFile.CIM_CLASS_NAME);

        setThis = FSCreationClassName;

        keyProperties[3] = new CIMProperty(CIM_DataFile.PROPERTY_FSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DataFile.CIM_CLASS_NAME);

        setThis = FSName;

        keyProperties[4] = new CIMProperty(CIM_DataFile.PROPERTY_FSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_DataFile.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[5] = new CIMProperty(CIM_DataFile.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_DataFile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_DataFile createInstance(WBEMClient client, CIM_DataFile dataInstance,
        ...
        CIM_DataFile newDataInstance = CIM_DataFileHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_DataFile modifyInstance(WBEMClient client, CIM_DataFile dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DataFile dataInstance2 = CIM_DataFileHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_DataFile dataInstance)
            throws WbemsmtException {
