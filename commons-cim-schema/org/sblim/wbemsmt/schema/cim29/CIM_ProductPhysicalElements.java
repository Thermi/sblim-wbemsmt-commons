...
public class CIM_ProductPhysicalElements extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
    ...
    public CIM_ProductPhysicalElements(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ProductPhysicalElements(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ProductPhysicalElements() {
    }
    ...
    public static CIMProperty create_Product_CIM_Product(WBEMClient client, String namespace,
        ...
        CIM_ProductPhysicalElements fco = new CIM_ProductPhysicalElements(client, namespace);
    ...
    public String getObjectName() {
        return CIM_ProductPhysicalElements.CIM_CLASS_NAME;
    }
