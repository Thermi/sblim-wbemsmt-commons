 ...
 * 
 * Description: Helper class for CIM_VolatileStorage
 *    
 * 
 * generated Class
 * @see CIM_VolatileStorage
 */
...
public class CIM_VolatileStorageHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_VolatileStorage or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_VolatileStorage.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VolatileStorage.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_VolatileStorage or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_VolatileStorage.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VolatileStorage(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VolatileStorageHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VolatileStorage.");
                        resultArrayList.add(new CIM_VolatileStorage(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VolatileStorage.");
                        resultArrayList.add(new CIM_VolatileStorage(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VolatileStorage.");
                        resultArrayList.add(new CIM_VolatileStorage(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VolatileStorage getInstance(WBEMClient client,
     ...
     */
    public final static CIM_VolatileStorage getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_VolatileStorage) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_VolatileStorage(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_VolatileStorage getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_VolatileStorage.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VolatileStorage.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[1] = new CIMProperty(CIM_VolatileStorage.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VolatileStorage.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_VolatileStorage.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_VolatileStorage.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_VolatileStorage.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VolatileStorage.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_VolatileStorage createInstance(WBEMClient client,
            CIM_VolatileStorage dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_VolatileStorage newDataInstance = CIM_VolatileStorageHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_VolatileStorage modifyInstance(WBEMClient client,
            CIM_VolatileStorage dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VolatileStorage dataInstance2 = CIM_VolatileStorageHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_VolatileStorage dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VolatileStorage.getPackages());
    }
