 ...
 * 
 * Description: Helper class for CIM_UnixFile
 *    
 * 
 * generated Class
 * @see CIM_UnixFile
...
public class CIM_UnixFileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_UnixFile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_UnixFile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_UnixFile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_UnixFile or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_UnixFile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_UnixFile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_UnixFileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_UnixFile.");
                        resultArrayList.add(new CIM_UnixFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_UnixFile.");
                        resultArrayList.add(new CIM_UnixFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_UnixFile.");
                        resultArrayList.add(new CIM_UnixFile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_UnixFile getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_UnixFile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_UnixFile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_UnixFile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_UnixFile getInstance(WBEMClient client, String namespace,
            String CSCreationClassName, String CSName, String FSCreationClassName, String FSName,
            String LFCreationClassName, String LFName
        ...
        keyProperties[0] = new CIMProperty(CIM_UnixFile.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixFile.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_UnixFile.PROPERTY_CSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixFile.CIM_CLASS_NAME);

        setThis = FSCreationClassName;

        keyProperties[2] = new CIMProperty(CIM_UnixFile.PROPERTY_FSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixFile.CIM_CLASS_NAME);

        setThis = FSName;

        keyProperties[3] = new CIMProperty(CIM_UnixFile.PROPERTY_FSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixFile.CIM_CLASS_NAME);

        setThis = LFCreationClassName;

        keyProperties[4] = new CIMProperty(CIM_UnixFile.PROPERTY_LFCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixFile.CIM_CLASS_NAME);

        setThis = LFName;

        keyProperties[5] = new CIMProperty(CIM_UnixFile.PROPERTY_LFNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixFile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_UnixFile createInstance(WBEMClient client, CIM_UnixFile dataInstance,
        ...
        CIM_UnixFile newDataInstance = CIM_UnixFileHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_UnixFile modifyInstance(WBEMClient client, CIM_UnixFile dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_UnixFile dataInstance2 = CIM_UnixFileHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_UnixFile dataInstance)
            throws WbemsmtException {
