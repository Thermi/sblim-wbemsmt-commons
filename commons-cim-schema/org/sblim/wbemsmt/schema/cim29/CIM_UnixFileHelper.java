...
public final class CIM_UnixFileHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_UnixFile.");
						resultArrayList.add(new CIM_UnixFile(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_UnixFile.");
						resultArrayList.add(new CIM_UnixFile(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_UnixFile.");
						resultArrayList.add(new CIM_UnixFile(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_UnixFile getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_UnixFileHelper.getInstance(cimClient, new CIM_UnixFile(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UnixFile getInstance(CIMClient cimClient, CIM_UnixFile dataInstance) {
		...
		return CIM_UnixFileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UnixFile getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_UnixFile dataInstance = null;
		try {
			dataInstance = new CIM_UnixFile(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_UnixFile.getPackages();
	...
	*/	
	public final static CIM_UnixFile createInstance(CIMClient cimClient, CIM_UnixFile dataInstance, boolean notifyDifferencies){ 
		...
		CIM_UnixFile newDataInstance = null;
		try {
			newDataInstance = CIM_UnixFileHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_UnixFile modifyInstance(CIMClient cimClient, CIM_UnixFile dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_UnixFileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_UnixFile dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_UnixFile dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_UnixFile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_UnixFile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_UnixFile.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_UnixFile.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_UnixFile.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_FSCreationClassName(String FSCreationClassName) {
		return true;
	}

	public static boolean isValid_FSName(String FSName) {
		return true;
	}

	public static boolean isValid_FileInodeNumber(String FileInodeNumber) {
		return true;
	}

	public static boolean isValid_GroupID(String GroupID) {
		return true;
	}

	public static boolean isValid_LFCreationClassName(String LFCreationClassName) {
		return true;
	}

	public static boolean isValid_LFName(String LFName) {
		return true;
	}

	public static boolean isValid_LastModifiedInode(Calendar LastModifiedInode) {
		return true;
	}

	public static boolean isValid_LinkCount(UnsignedInt64 LinkCount) {
		return true;
	}

	public static boolean isValid_LinkMax(UnsignedInt64 LinkMax) {
		return true;
	}

	public static boolean isValid_NameMax(UnsignedInt64 NameMax) {
		return true;
	}

	public static boolean isValid_PathMax(UnsignedInt64 PathMax) {
		return true;
	}

	public static boolean isValid_PosixAsyncIo(UnsignedInt64 PosixAsyncIo) {
		return true;
	}

	public static boolean isValid_PosixChownRestricted(UnsignedInt64 PosixChownRestricted) {
		return true;
	}

	public static boolean isValid_PosixNoTrunc(UnsignedInt64 PosixNoTrunc) {
		return true;
	}

	public static boolean isValid_PosixPrioIo(UnsignedInt64 PosixPrioIo) {
		return true;
	}

	public static boolean isValid_PosixSyncIo(UnsignedInt64 PosixSyncIo) {
		return true;
	}

	public static boolean isValid_SaveText(Boolean SaveText) {
		return true;
	}

	public static boolean isValid_SetGid(Boolean SetGid) {
		return true;
	}

	public static boolean isValid_SetUid(Boolean SetUid) {
		return true;
	}
