...
public class CIM_TapeDrive extends CIM_MediaAccessDevice  {
	...
	public final static String CIM_CLASS_NAME = "CIM_TapeDrive"; //$NON-NLS-1$
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_TapeDrive.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_TapeDrive.Java_Package_List.toArray(new String[CIM_TapeDrive.Java_Package_List.size()]);
    }
