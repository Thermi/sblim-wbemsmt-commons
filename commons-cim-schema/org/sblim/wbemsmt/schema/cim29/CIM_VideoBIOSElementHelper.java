 ...
 * 
 * Description: Helper class for CIM_VideoBIOSElement
 *    
 * 
 * generated Class
 * @see CIM_VideoBIOSElement
 */
...
public class CIM_VideoBIOSElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_VideoBIOSElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_VideoBIOSElement.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_VideoBIOSElement or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_VideoBIOSElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VideoBIOSElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VideoBIOSElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VideoBIOSElement.");
                        resultArrayList.add(new CIM_VideoBIOSElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VideoBIOSElement.");
                        resultArrayList.add(new CIM_VideoBIOSElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VideoBIOSElement.");
                        resultArrayList.add(new CIM_VideoBIOSElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VideoBIOSElement getInstance(WBEMClient client,
     ...
     */
    public final static CIM_VideoBIOSElement getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_VideoBIOSElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_VideoBIOSElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_VideoBIOSElement getInstance(WBEMClient client, String namespace,
            String Name, String SoftwareElementID,
            javax.cim.UnsignedInteger16 SoftwareElementState,
            javax.cim.UnsignedInteger16 TargetOperatingSystem
        ...
        keyProperties[0] = new CIMProperty(CIM_VideoBIOSElement.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VideoBIOSElement.CIM_CLASS_NAME);

        setThis = SoftwareElementID;

        keyProperties[1] = new CIMProperty(CIM_VideoBIOSElement.PROPERTY_SOFTWAREELEMENTID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VideoBIOSElement.CIM_CLASS_NAME);

        setThis = SoftwareElementState;

        keyProperties[2] = new CIMProperty(CIM_VideoBIOSElement.PROPERTY_SOFTWAREELEMENTSTATE.NAME,
                CIMDataType.UINT16_T, setThis, true, false, CIM_VideoBIOSElement.CIM_CLASS_NAME);

        setThis = TargetOperatingSystem;

        keyProperties[3] = new CIMProperty(
                CIM_VideoBIOSElement.PROPERTY_TARGETOPERATINGSYSTEM.NAME, CIMDataType.UINT16_T,
                setThis, true, false, CIM_VideoBIOSElement.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_VideoBIOSElement createInstance(WBEMClient client,
            CIM_VideoBIOSElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_VideoBIOSElement newDataInstance = CIM_VideoBIOSElementHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_VideoBIOSElement modifyInstance(WBEMClient client,
            CIM_VideoBIOSElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VideoBIOSElement dataInstance2 = CIM_VideoBIOSElementHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_VideoBIOSElement dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VideoBIOSElement.getPackages());
    }
