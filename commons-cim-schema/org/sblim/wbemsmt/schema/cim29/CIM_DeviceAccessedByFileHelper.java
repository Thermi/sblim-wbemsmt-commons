 ...
 * 
 * Description: Helper class for CIM_DeviceAccessedByFile
 *    
 * 
 * generated Class
 * @see CIM_DeviceAccessedByFile
 */
...
public class CIM_DeviceAccessedByFileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DeviceAccessedByFile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DeviceAccessedByFile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_DeviceAccessedByFile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DeviceAccessedByFile or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_DeviceAccessedByFile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DeviceAccessedByFileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DeviceAccessedByFile.");
                        resultArrayList.add(new CIM_DeviceAccessedByFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DeviceAccessedByFile.");
                        resultArrayList.add(new CIM_DeviceAccessedByFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DeviceAccessedByFile.");
                        resultArrayList.add(new CIM_DeviceAccessedByFile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DeviceAccessedByFile getInstance(WBEMClient client,
    ...
    public final static CIM_DeviceAccessedByFile getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DeviceAccessedByFile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DeviceAccessedByFile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DeviceAccessedByFile getInstance(WBEMClient client, String namespace,
            CIM_DeviceFile Antecedent, CIM_LogicalDevice Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DeviceAccessedByFile.PROPERTY_ANTECEDENT_CIM_DEVICEFILE.NAME, new CIMDataType(
                        CIM_DeviceFile.CIM_CLASS_NAME), setThis, false, false,
                CIM_DeviceAccessedByFile.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_DeviceAccessedByFile.PROPERTY_DEPENDENT_CIM_LOGICALDEVICE.NAME,
     ...
     *
     */
    public final static CIM_DeviceAccessedByFile createInstance(WBEMClient client,
            CIM_DeviceAccessedByFile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_DeviceAccessedByFile newDataInstance = CIM_DeviceAccessedByFileHelper.getInstance(
     ...
     */
    public final static CIM_DeviceAccessedByFile modifyInstance(WBEMClient client,
            CIM_DeviceAccessedByFile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DeviceAccessedByFile dataInstance2 = CIM_DeviceAccessedByFileHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_DeviceAccessedByFile dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DeviceAccessedByFile.getPackages());
    }
