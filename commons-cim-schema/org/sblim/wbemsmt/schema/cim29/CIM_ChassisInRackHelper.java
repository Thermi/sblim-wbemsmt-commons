 ...
 * 
 * Description: Helper class for CIM_ChassisInRack
 *    
 * 
 * generated Class
 * @see CIM_ChassisInRack
 */
...
public class CIM_ChassisInRackHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ChassisInRack or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ChassisInRack.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ChassisInRack.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ChassisInRack or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ChassisInRack.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ChassisInRack(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ChassisInRackHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ChassisInRack.");
                        resultArrayList.add(new CIM_ChassisInRack(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ChassisInRack.");
                        resultArrayList.add(new CIM_ChassisInRack(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ChassisInRack.");
                        resultArrayList.add(new CIM_ChassisInRack(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ChassisInRack getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ChassisInRack getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ChassisInRack) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ChassisInRack(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ChassisInRack getInstance(WBEMClient client, String namespace,
            CIM_Rack GroupComponent, CIM_Chassis PartComponent
        ...
        keyProperties[0] = new CIMProperty(CIM_ChassisInRack.PROPERTY_GROUPCOMPONENT_CIM_RACK.NAME,
                new CIMDataType(CIM_Rack.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ChassisInRack.PROPERTY_PARTCOMPONENT_CIM_CHASSIS.NAME, new CIMDataType(
                        CIM_Chassis.CIM_CLASS_NAME), setThis, false, false,
                CIM_ChassisInRack.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ChassisInRack createInstance(WBEMClient client,
            CIM_ChassisInRack dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ChassisInRack newDataInstance = CIM_ChassisInRackHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ChassisInRack modifyInstance(WBEMClient client,
            CIM_ChassisInRack dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ChassisInRack dataInstance2 = CIM_ChassisInRackHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ChassisInRack dataInstance)
            throws WbemsmtException {
