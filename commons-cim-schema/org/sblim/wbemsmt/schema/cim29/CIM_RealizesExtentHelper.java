 ...
 * 
 * Description: Helper class for CIM_RealizesExtent
 *    
 * 
 * generated Class
 * @see CIM_RealizesExtent
 */
...
public class CIM_RealizesExtentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RealizesExtent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RealizesExtent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_RealizesExtent.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RealizesExtent or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_RealizesExtent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RealizesExtent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RealizesExtentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RealizesExtent.");
                        resultArrayList.add(new CIM_RealizesExtent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RealizesExtent.");
                        resultArrayList.add(new CIM_RealizesExtent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RealizesExtent.");
                        resultArrayList.add(new CIM_RealizesExtent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RealizesExtent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_RealizesExtent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RealizesExtent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RealizesExtent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RealizesExtent getInstance(WBEMClient client, String namespace,
            CIM_PhysicalComponent Antecedent, CIM_StorageExtent Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RealizesExtent.PROPERTY_ANTECEDENT_CIM_PHYSICALCOMPONENT.NAME, new CIMDataType(
                        CIM_PhysicalComponent.CIM_CLASS_NAME), setThis, false, false,
                CIM_RealizesExtent.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_RealizesExtent.PROPERTY_DEPENDENT_CIM_STORAGEEXTENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_RealizesExtent createInstance(WBEMClient client,
            CIM_RealizesExtent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_RealizesExtent newDataInstance = CIM_RealizesExtentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_RealizesExtent modifyInstance(WBEMClient client,
            CIM_RealizesExtent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RealizesExtent dataInstance2 = CIM_RealizesExtentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RealizesExtent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RealizesExtent.getPackages());
    }
