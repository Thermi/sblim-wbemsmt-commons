 ...
 * 
 * Description: Helper class for CIM_BIOSFeatureBIOSElements
 *    
 * 
 * generated Class
 * @see CIM_BIOSFeatureBIOSElements
 */
...
public class CIM_BIOSFeatureBIOSElementsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BIOSFeatureBIOSElements or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BIOSFeatureBIOSElements.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_BIOSFeatureBIOSElements.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BIOSFeatureBIOSElements or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_BIOSFeatureBIOSElements(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BIOSFeatureBIOSElementsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BIOSFeatureBIOSElements.");
                        resultArrayList.add(new CIM_BIOSFeatureBIOSElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BIOSFeatureBIOSElements.");
                        resultArrayList.add(new CIM_BIOSFeatureBIOSElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BIOSFeatureBIOSElements.");
                        resultArrayList.add(new CIM_BIOSFeatureBIOSElements(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BIOSFeatureBIOSElements getInstance(WBEMClient client,
    ...
    public final static CIM_BIOSFeatureBIOSElements getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BIOSFeatureBIOSElements) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BIOSFeatureBIOSElements(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BIOSFeatureBIOSElements getInstance(WBEMClient client,
            String namespace, CIM_BIOSFeature GroupComponent, CIM_BIOSElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_BIOSFeatureBIOSElements.PROPERTY_GROUPCOMPONENT_CIM_BIOSFEATURE.NAME,
                new CIMDataType(CIM_BIOSFeature.CIM_CLASS_NAME), setThis, false, false,
                CIM_BIOSFeatureBIOSElements.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_BIOSFeatureBIOSElements.PROPERTY_PARTCOMPONENT_CIM_BIOSELEMENT.NAME,
                new CIMDataType(CIM_BIOSElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_BIOSFeatureBIOSElements.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BIOSFeatureBIOSElements createInstance(WBEMClient client,
            CIM_BIOSFeatureBIOSElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_BIOSFeatureBIOSElements newDataInstance = CIM_BIOSFeatureBIOSElementsHelper
     ...
     */
    public final static CIM_BIOSFeatureBIOSElements modifyInstance(WBEMClient client,
            CIM_BIOSFeatureBIOSElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BIOSFeatureBIOSElements dataInstance2 = CIM_BIOSFeatureBIOSElementsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_BIOSFeatureBIOSElements dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_BIOSFeatureBIOSElements.getPackages());
    }
