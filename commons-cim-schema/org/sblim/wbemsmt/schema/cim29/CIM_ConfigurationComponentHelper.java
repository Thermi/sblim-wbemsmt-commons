 ...
 * 
 * Description: Helper class for CIM_ConfigurationComponent
 *    
 * 
 * generated Class
 * @see CIM_ConfigurationComponent
 */
...
public class CIM_ConfigurationComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ConfigurationComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ConfigurationComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ConfigurationComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ConfigurationComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ConfigurationComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ConfigurationComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ConfigurationComponent.");
                        resultArrayList.add(new CIM_ConfigurationComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ConfigurationComponent.");
                        resultArrayList.add(new CIM_ConfigurationComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ConfigurationComponent.");
                        resultArrayList.add(new CIM_ConfigurationComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ConfigurationComponent getInstance(WBEMClient client,
    ...
    public final static CIM_ConfigurationComponent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ConfigurationComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ConfigurationComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ConfigurationComponent getInstance(WBEMClient client, String namespace,
            CIM_Configuration ConfigGroup, CIM_Configuration ConfigComponent
        ...
        setThis = ConfigGroup != null ? ConfigGroup.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_ConfigurationComponent.PROPERTY_CONFIGGROUP_CIM_CONFIGURATION.NAME,
                new CIMDataType(CIM_Configuration.CIM_CLASS_NAME), setThis, false, false,
                CIM_ConfigurationComponent.CIM_CLASS_NAME);

        setThis = ConfigComponent != null ? ConfigComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ConfigurationComponent.PROPERTY_CONFIGCOMPONENT_CIM_CONFIGURATION.NAME,
                new CIMDataType(CIM_Configuration.CIM_CLASS_NAME), setThis, false, false,
                CIM_ConfigurationComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ConfigurationComponent createInstance(WBEMClient client,
            CIM_ConfigurationComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ConfigurationComponent newDataInstance = CIM_ConfigurationComponentHelper.getInstance(
     ...
     */
    public final static CIM_ConfigurationComponent modifyInstance(WBEMClient client,
            CIM_ConfigurationComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ConfigurationComponent dataInstance2 = CIM_ConfigurationComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ConfigurationComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ConfigurationComponent.getPackages());
    }
