 ...
 * 
 * Description: Helper class for CIM_UnixProcessStatistics
 *    
 * 
 * generated Class
 * @see CIM_UnixProcessStatistics
 */
...
public class CIM_UnixProcessStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_UnixProcessStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_UnixProcessStatistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_UnixProcessStatistics.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_UnixProcessStatistics or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_UnixProcessStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_UnixProcessStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_UnixProcessStatistics.");
                        resultArrayList.add(new CIM_UnixProcessStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_UnixProcessStatistics.");
                        resultArrayList.add(new CIM_UnixProcessStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_UnixProcessStatistics.");
                        resultArrayList.add(new CIM_UnixProcessStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_UnixProcessStatistics getInstance(WBEMClient client,
    ...
    public final static CIM_UnixProcessStatistics getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_UnixProcessStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_UnixProcessStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_UnixProcessStatistics getInstance(WBEMClient client, String namespace,
            CIM_UnixProcess Element, CIM_UnixProcessStatisticalInformation Stats
        ...
        keyProperties[0] = new CIMProperty(
                CIM_UnixProcessStatistics.PROPERTY_ELEMENT_CIM_UNIXPROCESS.NAME, new CIMDataType(
                        CIM_UnixProcess.CIM_CLASS_NAME), setThis, false, false,
                CIM_UnixProcessStatistics.CIM_CLASS_NAME);

        setThis = Stats != null ? Stats.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_UnixProcessStatistics.PROPERTY_STATS_CIM_UNIXPROCESSSTATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME), setThis,
                false, false, CIM_UnixProcessStatistics.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_UnixProcessStatistics createInstance(WBEMClient client,
            CIM_UnixProcessStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_UnixProcessStatistics newDataInstance = CIM_UnixProcessStatisticsHelper.getInstance(
     ...
     */
    public final static CIM_UnixProcessStatistics modifyInstance(WBEMClient client,
            CIM_UnixProcessStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_UnixProcessStatistics dataInstance2 = CIM_UnixProcessStatisticsHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_UnixProcessStatistics dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_UnixProcessStatistics.getPackages());
    }
