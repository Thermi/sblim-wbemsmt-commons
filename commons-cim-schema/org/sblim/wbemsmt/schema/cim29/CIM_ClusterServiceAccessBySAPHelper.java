 ...
 * 
 * Description: Helper class for CIM_ClusterServiceAccessBySAP
 *    
 * 
 * generated Class
 * @see CIM_ClusterServiceAccessBySAP
 */
...
public class CIM_ClusterServiceAccessBySAPHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ClusterServiceAccessBySAP or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ClusterServiceAccessBySAP.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ClusterServiceAccessBySAP.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ClusterServiceAccessBySAP or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ClusterServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ClusterServiceAccessBySAPHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ClusterServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ClusterServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ClusterServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ClusterServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ClusterServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ClusterServiceAccessBySAP(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ClusterServiceAccessBySAP getInstance(WBEMClient client,
    ...
    public final static CIM_ClusterServiceAccessBySAP getInstance(WBEMClient client,
        ...
        Class clazz = CIM_ClusterServiceAccessBySAPHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ClusterServiceAccessBySAP) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ClusterServiceAccessBySAP(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ClusterServiceAccessBySAP getInstance(WBEMClient client,
            String namespace, CIM_ClusteringService Antecedent, CIM_ClusteringSAP Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ClusterServiceAccessBySAP.PROPERTY_ANTECEDENT_CIM_CLUSTERINGSERVICE.NAME,
                new CIMDataType(CIM_ClusteringService.CIM_CLASS_NAME), setThis, false, false,
                CIM_ClusterServiceAccessBySAP.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ClusterServiceAccessBySAP.PROPERTY_DEPENDENT_CIM_CLUSTERINGSAP.NAME,
                new CIMDataType(CIM_ClusteringSAP.CIM_CLASS_NAME), setThis, false, false,
                CIM_ClusterServiceAccessBySAP.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ClusterServiceAccessBySAP createInstance(WBEMClient client,
            CIM_ClusterServiceAccessBySAP dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ClusterServiceAccessBySAP newDataInstance = CIM_ClusterServiceAccessBySAPHelper
     ...
     */
    public final static CIM_ClusterServiceAccessBySAP modifyInstance(WBEMClient client,
            CIM_ClusterServiceAccessBySAP dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ClusterServiceAccessBySAP dataInstance2 = CIM_ClusterServiceAccessBySAPHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ClusterServiceAccessBySAP dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ClusterServiceAccessBySAP.getPackages());
    }
