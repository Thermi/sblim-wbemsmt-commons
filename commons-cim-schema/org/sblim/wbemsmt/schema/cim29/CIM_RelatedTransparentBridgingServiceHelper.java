			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_RelatedTransparentBridgingService.Java_Package_List.size(); i++) {
						if (!((String)(CIM_RelatedTransparentBridgingService.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_RelatedTransparentBridgingService.Java_Package_List.get(i))).endsWith(".")) {
							CIM_RelatedTransparentBridgingService.Java_Package_List.setElementAt((String)(CIM_RelatedTransparentBridgingService.Java_Package_List.get(i)) + ("."), i);
						}
