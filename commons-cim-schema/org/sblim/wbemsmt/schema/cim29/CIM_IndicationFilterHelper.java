...
public class CIM_IndicationFilterHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_IndicationFilter.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_IndicationFilter.");
                        resultArrayList.add(new CIM_IndicationFilter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_IndicationFilter.");
                        resultArrayList.add(new CIM_IndicationFilter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_IndicationFilter.");
                        resultArrayList.add(new CIM_IndicationFilter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_IndicationFilter getInstance(WBEMClient client,
     ...
     */
    public final static CIM_IndicationFilter getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_IndicationFilter getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_IndicationFilter.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_IndicationFilter.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_IndicationFilter.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_IndicationFilter.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_IndicationFilter.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_IndicationFilter.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_IndicationFilter.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_IndicationFilter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_IndicationFilter createInstance(WBEMClient client,
            CIM_IndicationFilter dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_IndicationFilter newDataInstance = CIM_IndicationFilterHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_IndicationFilter modifyInstance(WBEMClient client,
            CIM_IndicationFilter dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_IndicationFilter dataInstance2 = CIM_IndicationFilterHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_IndicationFilter dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_IndicationFilter.getPackages());
    }
