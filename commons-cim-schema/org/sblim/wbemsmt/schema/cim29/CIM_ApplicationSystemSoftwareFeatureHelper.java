...
public final class CIM_ApplicationSystemSoftwareFeatureHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					Class clazz = CIM_ApplicationSystemSoftwareFeatureHelper.findClass(cimClient, cimInstance);
					if (clazz == null) {
	...
	*/	
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_ApplicationSystemSoftwareFeature.getPackages();
