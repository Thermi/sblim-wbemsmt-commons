 ...
 * 
 * Description: Helper class for CIM_ApplicationSystemSoftwareFeature
 *    
 * 
 * generated Class
 * @see CIM_ApplicationSystemSoftwareFeature
 */
...
public class CIM_ApplicationSystemSoftwareFeatureHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ApplicationSystemSoftwareFeature or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ApplicationSystemSoftwareFeature.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ApplicationSystemSoftwareFeature.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ApplicationSystemSoftwareFeature or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ApplicationSystemSoftwareFeature(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ApplicationSystemSoftwareFeatureHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ApplicationSystemSoftwareFeature.");
                        resultArrayList.add(new CIM_ApplicationSystemSoftwareFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ApplicationSystemSoftwareFeature.");
                        resultArrayList.add(new CIM_ApplicationSystemSoftwareFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ApplicationSystemSoftwareFeature.");
                        resultArrayList.add(new CIM_ApplicationSystemSoftwareFeature(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ApplicationSystemSoftwareFeature getInstance(WBEMClient client,
    ...
    public final static CIM_ApplicationSystemSoftwareFeature getInstance(WBEMClient client,
        ...
        Class clazz = CIM_ApplicationSystemSoftwareFeatureHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ApplicationSystemSoftwareFeature) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ApplicationSystemSoftwareFeature(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ApplicationSystemSoftwareFeature getInstance(WBEMClient client,
            String namespace, CIM_ApplicationSystem GroupComponent,
            CIM_SoftwareFeature PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ApplicationSystemSoftwareFeature.PROPERTY_GROUPCOMPONENT_CIM_APPLICATIONSYSTEM.NAME,
                new CIMDataType(CIM_ApplicationSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_ApplicationSystemSoftwareFeature.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ApplicationSystemSoftwareFeature.PROPERTY_PARTCOMPONENT_CIM_SOFTWAREFEATURE.NAME,
                new CIMDataType(CIM_SoftwareFeature.CIM_CLASS_NAME), setThis, false, false,
                CIM_ApplicationSystemSoftwareFeature.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ApplicationSystemSoftwareFeature createInstance(WBEMClient client,
            CIM_ApplicationSystemSoftwareFeature dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ApplicationSystemSoftwareFeature newDataInstance = CIM_ApplicationSystemSoftwareFeatureHelper
     ...
     */
    public final static CIM_ApplicationSystemSoftwareFeature modifyInstance(WBEMClient client,
            CIM_ApplicationSystemSoftwareFeature dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ApplicationSystemSoftwareFeature dataInstance2 = CIM_ApplicationSystemSoftwareFeatureHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ApplicationSystemSoftwareFeature dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ApplicationSystemSoftwareFeature.getPackages());
    }
