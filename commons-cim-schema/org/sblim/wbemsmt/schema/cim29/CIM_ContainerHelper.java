 ...
 * 
 * Description: Helper class for CIM_Container
 *    
 * 
 * generated Class
 * @see CIM_Container
...
public class CIM_ContainerHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Container or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Container.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Container.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Container or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Container.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Container(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ContainerHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Container.");
                        resultArrayList.add(new CIM_Container(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Container.");
                        resultArrayList.add(new CIM_Container(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Container.");
                        resultArrayList.add(new CIM_Container(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Container getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Container getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Container) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Container(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Container getInstance(WBEMClient client, String namespace,
            CIM_PhysicalPackage GroupComponent, CIM_PhysicalElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_Container.PROPERTY_GROUPCOMPONENT_CIM_PHYSICALPACKAGE.NAME, new CIMDataType(
                        CIM_PhysicalPackage.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_Container.PROPERTY_PARTCOMPONENT_CIM_PHYSICALELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_Container createInstance(WBEMClient client, CIM_Container dataInstance,
        ...
        CIM_Container newDataInstance = CIM_ContainerHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Container modifyInstance(WBEMClient client, CIM_Container dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Container dataInstance2 = CIM_ContainerHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Container dataInstance)
            throws WbemsmtException {
