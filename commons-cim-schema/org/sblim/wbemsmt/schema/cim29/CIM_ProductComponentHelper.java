 ...
 * 
 * Description: Helper class for CIM_ProductComponent
 *    
 * 
 * generated Class
 * @see CIM_ProductComponent
 */
...
public class CIM_ProductComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductComponent.CIM_CLASS_NAME
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductComponent or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ProductComponent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProductComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductComponent.");
                        resultArrayList.add(new CIM_ProductComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductComponent.");
                        resultArrayList.add(new CIM_ProductComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductComponent.");
                        resultArrayList.add(new CIM_ProductComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductComponent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ProductComponent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductComponent getInstance(WBEMClient client, String namespace,
            CIM_Product GroupComponent, CIM_Product PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProductComponent.PROPERTY_GROUPCOMPONENT_CIM_PRODUCT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProductComponent.PROPERTY_PARTCOMPONENT_CIM_PRODUCT.NAME, new CIMDataType(
                        CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProductComponent createInstance(WBEMClient client,
            CIM_ProductComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProductComponent newDataInstance = CIM_ProductComponentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProductComponent modifyInstance(WBEMClient client,
            CIM_ProductComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductComponent dataInstance2 = CIM_ProductComponentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProductComponent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductComponent.getPackages());
    }
