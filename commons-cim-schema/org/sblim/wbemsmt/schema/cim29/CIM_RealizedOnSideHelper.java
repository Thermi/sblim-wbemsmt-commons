 ...
 * 
 * Description: Helper class for CIM_RealizedOnSide
 *    
 * 
 * generated Class
 * @see CIM_RealizedOnSide
 */
...
public class CIM_RealizedOnSideHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RealizedOnSide or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RealizedOnSide.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_RealizedOnSide.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RealizedOnSide or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_RealizedOnSide.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RealizedOnSide(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RealizedOnSideHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RealizedOnSide.");
                        resultArrayList.add(new CIM_RealizedOnSide(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RealizedOnSide.");
                        resultArrayList.add(new CIM_RealizedOnSide(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RealizedOnSide.");
                        resultArrayList.add(new CIM_RealizedOnSide(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RealizedOnSide getInstance(WBEMClient client,
     ...
     */
    public final static CIM_RealizedOnSide getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RealizedOnSide) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RealizedOnSide(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RealizedOnSide getInstance(WBEMClient client, String namespace,
            CIM_PhysicalMedia Antecedent, CIM_StorageExtent Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RealizedOnSide.PROPERTY_ANTECEDENT_CIM_PHYSICALMEDIA.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_RealizedOnSide.PROPERTY_DEPENDENT_CIM_STORAGEEXTENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_RealizedOnSide createInstance(WBEMClient client,
            CIM_RealizedOnSide dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_RealizedOnSide newDataInstance = CIM_RealizedOnSideHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_RealizedOnSide modifyInstance(WBEMClient client,
            CIM_RealizedOnSide dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RealizedOnSide dataInstance2 = CIM_RealizedOnSideHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RealizedOnSide dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RealizedOnSide.getPackages());
    }
