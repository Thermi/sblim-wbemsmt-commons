...
public class CIM_ObjectManager extends CIM_WBEMService {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("ElementName", new CIMProperty("ElementName", CIMDataType.STRING_T,
                null));
        propertiesToCheck.put("GatherStatisticalData", new CIMProperty("GatherStatisticalData",
    ...
    public Boolean get_GatherStatisticalData() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_GATHERSTATISTICALDATA.NAME
    ...
    public boolean set_GatherStatisticalData(Boolean newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_GATHERSTATISTICALDATA.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_GatherStatisticalData(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_GatherStatisticalData(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_GatherStatisticalData(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_CIM_ObjectManagerCommunicationMechanism_CIM_CommMechanismForManagers(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ObjectManagerCommunicationMechanism_CIM_CommMechanismForManagers(
                cimClient, CIM_ASSOCIATOR_CLASS_NAME_CIM_COMMMECHANISMFORMANAGER,
    ...
    public java.util.List getAssociated_CIM_ObjectManagerCommunicationMechanism_CIM_CommMechanismForManagers(
        ...
        return getAssociated_CIM_ObjectManagerCommunicationMechanism_CIM_CommMechanismForManagers(
                cimClient, CIM_ASSOCIATOR_CLASS_NAME_CIM_COMMMECHANISMFORMANAGER, resultClass,
    ...
    public java.util.List getAssociated_CIM_ObjectManagerCommunicationMechanism_CIM_CommMechanismForManagerNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ObjectManagerCommunicationMechanism_CIM_CommMechanismForManagerNames(
                cimClient, true, CIM_ASSOCIATOR_CLASS_NAME_CIM_COMMMECHANISMFORMANAGER,
    ...
    public java.util.List getAssociated_CIM_Namespace_CIM_NamespaceInManagers(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Namespace_CIM_NamespaceInManagers(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, CIM_Namespace.CIM_CLASS_NAME,
    ...
    public java.util.List getAssociated_CIM_Namespace_CIM_NamespaceInManagerNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_Namespace_CIM_NamespaceInManagerNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, CIM_Namespace.CIM_CLASS_NAME,
                null, null);
    }
