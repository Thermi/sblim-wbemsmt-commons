 ...
 * 
 * Description: Helper class for CIM_ServiceComponent
 *    
 * 
 * generated Class
 * @see CIM_ServiceComponent
 */
...
public class CIM_ServiceComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceComponent.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceComponent or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ServiceComponent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ServiceComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceComponent.");
                        resultArrayList.add(new CIM_ServiceComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceComponent.");
                        resultArrayList.add(new CIM_ServiceComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceComponent.");
                        resultArrayList.add(new CIM_ServiceComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceComponent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ServiceComponent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceComponent getInstance(WBEMClient client, String namespace,
            CIM_Service GroupComponent, CIM_Service PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ServiceComponent.PROPERTY_GROUPCOMPONENT_CIM_SERVICE.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ServiceComponent.PROPERTY_PARTCOMPONENT_CIM_SERVICE.NAME, new CIMDataType(
                        CIM_Service.CIM_CLASS_NAME), setThis, false, false,
                CIM_ServiceComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ServiceComponent createInstance(WBEMClient client,
            CIM_ServiceComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ServiceComponent newDataInstance = CIM_ServiceComponentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ServiceComponent modifyInstance(WBEMClient client,
            CIM_ServiceComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceComponent dataInstance2 = CIM_ServiceComponentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ServiceComponent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceComponent.getPackages());
    }
