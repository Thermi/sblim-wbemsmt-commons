...
public class CIM_VirtualComputerSystemHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualComputerSystem.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_VirtualComputerSystem.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_VirtualComputerSystem.");
                        resultArrayList.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VirtualComputerSystem.");
                        resultArrayList.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VirtualComputerSystem.");
                        resultArrayList.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VirtualComputerSystem getInstance(WBEMClient client,
    ...
    public final static CIM_VirtualComputerSystem getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VirtualComputerSystem.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_VirtualComputerSystem.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_VirtualComputerSystem.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static CIM_VirtualComputerSystem createInstance(WBEMClient client,
            CIM_VirtualComputerSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VirtualComputerSystem newDataInstance = CIM_VirtualComputerSystemHelper.getInstance(
     ...
     */
    public final static CIM_VirtualComputerSystem modifyInstance(WBEMClient client,
            CIM_VirtualComputerSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VirtualComputerSystem dataInstance2 = CIM_VirtualComputerSystemHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VirtualComputerSystem dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VirtualComputerSystem.getPackages());
    }
