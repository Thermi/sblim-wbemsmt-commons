 ...
 * 
 * Description: Helper class for CIM_ComputerSystemProcessor
 *    
 * 
 * generated Class
 * @see CIM_ComputerSystemProcessor
 */
...
public class CIM_ComputerSystemProcessorHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ComputerSystemProcessor or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ComputerSystemProcessor.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ComputerSystemProcessor.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ComputerSystemProcessor or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ComputerSystemProcessorHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ComputerSystemProcessor.");
                        resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ComputerSystemProcessor.");
                        resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ComputerSystemProcessor.");
                        resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ComputerSystemProcessor getInstance(WBEMClient client,
    ...
    public final static CIM_ComputerSystemProcessor getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ComputerSystemProcessor) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ComputerSystemProcessor(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ComputerSystemProcessor getInstance(WBEMClient client,
            String namespace, CIM_UnitaryComputerSystem GroupComponent, CIM_Processor PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ComputerSystemProcessor.PROPERTY_GROUPCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ComputerSystemProcessor.PROPERTY_PARTCOMPONENT_CIM_PROCESSOR.NAME,
                new CIMDataType(CIM_Processor.CIM_CLASS_NAME), setThis, false, false,
                CIM_ComputerSystemProcessor.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ComputerSystemProcessor createInstance(WBEMClient client,
            CIM_ComputerSystemProcessor dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ComputerSystemProcessor newDataInstance = CIM_ComputerSystemProcessorHelper
     ...
     */
    public final static CIM_ComputerSystemProcessor modifyInstance(WBEMClient client,
            CIM_ComputerSystemProcessor dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ComputerSystemProcessor dataInstance2 = CIM_ComputerSystemProcessorHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ComputerSystemProcessor dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ComputerSystemProcessor.getPackages());
    }
