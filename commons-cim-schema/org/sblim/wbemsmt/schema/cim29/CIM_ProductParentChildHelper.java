 ...
 * 
 * Description: Helper class for CIM_ProductParentChild
 *    
 * 
 * generated Class
 * @see CIM_ProductParentChild
 */
...
public class CIM_ProductParentChildHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductParentChild or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductParentChild.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductParentChild.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductParentChild or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ProductParentChild.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProductParentChild(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductParentChildHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductParentChild.");
                        resultArrayList.add(new CIM_ProductParentChild(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductParentChild.");
                        resultArrayList.add(new CIM_ProductParentChild(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductParentChild.");
                        resultArrayList.add(new CIM_ProductParentChild(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductParentChild getInstance(WBEMClient client,
    ...
    public final static CIM_ProductParentChild getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductParentChild) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductParentChild(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductParentChild getInstance(WBEMClient client, String namespace,
            CIM_Product Parent, CIM_Product Child
        ...
        setThis = Parent != null ? Parent.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(CIM_ProductParentChild.PROPERTY_PARENT_CIM_PRODUCT.NAME,
                new CIMDataType(CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductParentChild.CIM_CLASS_NAME);

        setThis = Child != null ? Child.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_ProductParentChild.PROPERTY_CHILD_CIM_PRODUCT.NAME,
                new CIMDataType(CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductParentChild.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProductParentChild createInstance(WBEMClient client,
            CIM_ProductParentChild dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProductParentChild newDataInstance = CIM_ProductParentChildHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProductParentChild modifyInstance(WBEMClient client,
            CIM_ProductParentChild dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductParentChild dataInstance2 = CIM_ProductParentChildHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProductParentChild dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductParentChild.getPackages());
    }
