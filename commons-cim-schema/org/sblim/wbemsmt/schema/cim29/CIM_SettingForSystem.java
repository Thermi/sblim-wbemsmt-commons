...
public class CIM_SettingForSystem extends CIM_HostedDependency {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_SYSTEMSETTING {
        /**
    ...
    public CIM_SettingForSystem(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_SettingForSystem(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SettingForSystem() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_System(WBEMClient client, String namespace,
        ...
        CIM_SettingForSystem fco = new CIM_SettingForSystem(client, namespace);
    ...
    public CIM_SystemSetting get_Dependent_CIM_SystemSetting(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMSETTING.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SYSTEMSETTING.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Dependent_CIM_SystemSetting(CIM_SystemSetting newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMSETTING.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_SystemSetting(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_Dependent_CIM_SystemSetting(WBEMClient client,
            String namespace, CIM_SystemSetting newValue) throws WbemsmtException {
        CIM_SettingForSystem fco = new CIM_SettingForSystem(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMSETTING.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_SystemSetting(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SYSTEMSETTING.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_SystemSetting(
    ...
    public String getObjectName() {
        return CIM_SettingForSystem.CIM_CLASS_NAME;
    }
