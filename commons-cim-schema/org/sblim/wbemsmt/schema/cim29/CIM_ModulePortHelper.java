 ...
 * 
 * Description: Helper class for CIM_ModulePort
 *    
 * 
 * generated Class
 * @see CIM_ModulePort
...
public class CIM_ModulePortHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ModulePort or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ModulePort.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ModulePort.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ModulePort or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ModulePort.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ModulePort(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ModulePortHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_ModulePort.");
                        resultArrayList.add(new CIM_ModulePort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_ModulePort.");
                        resultArrayList.add(new CIM_ModulePort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ModulePort.");
                        resultArrayList.add(new CIM_ModulePort(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ModulePort getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ModulePort getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ModulePort) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ModulePort(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ModulePort getInstance(WBEMClient client, String namespace,
            CIM_LogicalModule GroupComponent, CIM_NetworkPort PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ModulePort.PROPERTY_GROUPCOMPONENT_CIM_LOGICALMODULE.NAME, new CIMDataType(
                        CIM_LogicalModule.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ModulePort.PROPERTY_PARTCOMPONENT_CIM_NETWORKPORT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_ModulePort createInstance(WBEMClient client,
            CIM_ModulePort dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ModulePort newDataInstance = CIM_ModulePortHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_ModulePort modifyInstance(WBEMClient client,
            CIM_ModulePort dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ModulePort dataInstance2 = CIM_ModulePortHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ModulePort dataInstance)
            throws WbemsmtException {
