...
public class CIM_ResidesOnExtent extends CIM_Dependency {
    ...
    public CIM_ResidesOnExtent(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ResidesOnExtent(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_Antecedent_CIM_StorageExtent(WBEMClient client,
        ...
        CIM_ResidesOnExtent fco = new CIM_ResidesOnExtent(client, namespace);
    ...
    public String getObjectName() {
        return CIM_ResidesOnExtent.CIM_CLASS_NAME;
    }
