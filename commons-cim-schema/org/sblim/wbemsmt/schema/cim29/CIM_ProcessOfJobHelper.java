 ...
 * 
 * Description: Helper class for CIM_ProcessOfJob
 *    
 * 
 * generated Class
 * @see CIM_ProcessOfJob
 */
...
public class CIM_ProcessOfJobHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProcessOfJob or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProcessOfJob.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ProcessOfJob.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProcessOfJob or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ProcessOfJob.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProcessOfJob(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProcessOfJobHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProcessOfJob.");
                        resultArrayList.add(new CIM_ProcessOfJob(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProcessOfJob.");
                        resultArrayList.add(new CIM_ProcessOfJob(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProcessOfJob.");
                        resultArrayList.add(new CIM_ProcessOfJob(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProcessOfJob getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ProcessOfJob getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProcessOfJob) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProcessOfJob(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProcessOfJob getInstance(WBEMClient client, String namespace,
            CIM_Job GroupComponent, CIM_Process PartComponent
        ...
        keyProperties[0] = new CIMProperty(CIM_ProcessOfJob.PROPERTY_GROUPCOMPONENT_CIM_JOB.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProcessOfJob.PROPERTY_PARTCOMPONENT_CIM_PROCESS.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_ProcessOfJob createInstance(WBEMClient client,
            CIM_ProcessOfJob dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProcessOfJob newDataInstance = CIM_ProcessOfJobHelper
     ...
     */
    public final static CIM_ProcessOfJob modifyInstance(WBEMClient client,
            CIM_ProcessOfJob dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProcessOfJob dataInstance2 = CIM_ProcessOfJobHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProcessOfJob dataInstance)
            throws WbemsmtException {
