 ...
 * 
 * Description: Helper class for CIM_AssociatedProcessorMemory
 *    
 * 
 * generated Class
 * @see CIM_AssociatedProcessorMemory
 */
...
public class CIM_AssociatedProcessorMemoryHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_AssociatedProcessorMemory or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AssociatedProcessorMemory.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AssociatedProcessorMemory.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_AssociatedProcessorMemory or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_AssociatedProcessorMemory.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_AssociatedProcessorMemory(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_AssociatedProcessorMemoryHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AssociatedProcessorMemory.");
                        resultArrayList.add(new CIM_AssociatedProcessorMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AssociatedProcessorMemory.");
                        resultArrayList.add(new CIM_AssociatedProcessorMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AssociatedProcessorMemory.");
                        resultArrayList.add(new CIM_AssociatedProcessorMemory(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AssociatedProcessorMemory getInstance(WBEMClient client,
    ...
    public final static CIM_AssociatedProcessorMemory getInstance(WBEMClient client,
        ...
        Class clazz = CIM_AssociatedProcessorMemoryHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_AssociatedProcessorMemory) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_AssociatedProcessorMemory(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_AssociatedProcessorMemory createInstance(WBEMClient client,
            CIM_AssociatedProcessorMemory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_AssociatedProcessorMemory newDataInstance = CIM_AssociatedProcessorMemoryHelper
     ...
     */
    public final static CIM_AssociatedProcessorMemory modifyInstance(WBEMClient client,
            CIM_AssociatedProcessorMemory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AssociatedProcessorMemory dataInstance2 = CIM_AssociatedProcessorMemoryHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_AssociatedProcessorMemory dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AssociatedProcessorMemory.getPackages());
    }
