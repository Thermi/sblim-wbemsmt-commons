 ...
 * 
 * Description: Helper class for CIM_SystemPartition
 *    
 * 
 * generated Class
 * @see CIM_SystemPartition
 */
...
public class CIM_SystemPartitionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemPartition or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemPartition.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemPartition.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemPartition or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_SystemPartition.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemPartition(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemPartitionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemPartition.");
                        resultArrayList.add(new CIM_SystemPartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemPartition.");
                        resultArrayList.add(new CIM_SystemPartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemPartition.");
                        resultArrayList.add(new CIM_SystemPartition(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemPartition getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SystemPartition getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemPartition) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemPartition(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemPartition getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem GroupComponent, CIM_UnitaryComputerSystem PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemPartition.PROPERTY_GROUPCOMPONENT_CIM_COMPUTERSYSTEM.NAME,
                new CIMDataType(CIM_ComputerSystem.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SystemPartition.PROPERTY_PARTCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME,
                new CIMDataType(CIM_UnitaryComputerSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_SystemPartition.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemPartition createInstance(WBEMClient client,
            CIM_SystemPartition dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemPartition newDataInstance = CIM_SystemPartitionHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SystemPartition modifyInstance(WBEMClient client,
            CIM_SystemPartition dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemPartition dataInstance2 = CIM_SystemPartitionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemPartition dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemPartition.getPackages());
    }
