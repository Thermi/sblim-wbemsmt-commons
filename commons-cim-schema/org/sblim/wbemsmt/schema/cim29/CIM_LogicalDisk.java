...
public class CIM_LogicalDisk extends CIM_StorageExtent  {
	...
	static {
		...
		for (int i = 0; i < CIM_StorageExtent.CIM_PropertyNameList.size(); i++) {
			...
			CIM_LogicalDisk.CIM_PropertyNameList.add(CIM_StorageExtent.CIM_PropertyNameList.elementAt(i));
		}
		
				
		for (int i = 0; i < CIM_StorageExtent.CIM_PropertyList.size(); i++) {
			
			CIM_LogicalDisk.CIM_PropertyList.add(CIM_StorageExtent.CIM_PropertyList.elementAt(i));
		}
	...
	*	Class constructor
	*/	
	public CIM_LogicalDisk(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_LogicalDisk(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_LogicalDisk.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_LogicalDisk.Java_Package_List.toArray(new String[CIM_LogicalDisk.Java_Package_List.size()]);
    }
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof CIM_LogicalDisk)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((CIM_LogicalDisk)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_LogicalDisk)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_LogicalDisk)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_LogicalDisk)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_LogicalDisk)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_LogicalDisk)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_LogicalDisk)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_LogicalDisk)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_LogicalDisk)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public ArrayList getAssociated_CIM_StorageExtent_CIM_LogicalDiskBasedOnExtents(CIMClient cimClient,
	...
	public ArrayList getAssociated_CIM_StorageExtent_CIM_LogicalDiskBasedOnExtent_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_DiskPartition_CIM_LogicalDiskBasedOnPartitions(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_DiskPartition_CIM_LogicalDiskBasedOnPartition_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_StorageVolume_CIM_LogicalDiskBasedOnVolumes(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_StorageVolume_CIM_LogicalDiskBasedOnVolume_Names(CIMClient cimClient, boolean deep) {
