...
public class CIM_TapePartitionOnSurface extends CIM_BasedOn {
    ...
    public CIM_TapePartitionOnSurface(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_TapePartitionOnSurface(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_TapePartitionOnSurface() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_StorageExtent(WBEMClient client,
        ...
        CIM_TapePartitionOnSurface fco = new CIM_TapePartitionOnSurface(client, namespace);
    ...
    public String getObjectName() {
        return CIM_TapePartitionOnSurface.CIM_CLASS_NAME;
    }
