 ...
 * 
 * Description: Helper class for CIM_Cluster
 *    
 * 
 * generated Class
 * @see CIM_Cluster
...
public class CIM_ClusterHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Cluster or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Cluster.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Cluster.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Cluster or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Cluster.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Cluster(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ClusterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Cluster.");
                        resultArrayList.add(new CIM_Cluster(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Cluster.");
                        resultArrayList.add(new CIM_Cluster(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Cluster.");
                        resultArrayList.add(new CIM_Cluster(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Cluster getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Cluster getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Cluster) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Cluster(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Cluster getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_Cluster.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Cluster.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_Cluster.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Cluster.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Cluster createInstance(WBEMClient client, CIM_Cluster dataInstance,
        ...
        CIM_Cluster newDataInstance = CIM_ClusterHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Cluster modifyInstance(WBEMClient client, CIM_Cluster dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Cluster dataInstance2 = CIM_ClusterHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Cluster dataInstance)
            throws WbemsmtException {
