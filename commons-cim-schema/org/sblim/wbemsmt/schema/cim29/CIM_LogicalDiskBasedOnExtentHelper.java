 ...
 * 
 * Description: Helper class for CIM_LogicalDiskBasedOnExtent
 *    
 * 
 * generated Class
 * @see CIM_LogicalDiskBasedOnExtent
 */
...
public class CIM_LogicalDiskBasedOnExtentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_LogicalDiskBasedOnExtent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalDiskBasedOnExtent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_LogicalDiskBasedOnExtent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_LogicalDiskBasedOnExtent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_LogicalDiskBasedOnExtent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_LogicalDiskBasedOnExtentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_LogicalDiskBasedOnExtent.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnExtent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LogicalDiskBasedOnExtent.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnExtent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LogicalDiskBasedOnExtent.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnExtent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LogicalDiskBasedOnExtent getInstance(WBEMClient client,
    ...
    public final static CIM_LogicalDiskBasedOnExtent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_LogicalDiskBasedOnExtent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_LogicalDiskBasedOnExtent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_LogicalDiskBasedOnExtent getInstance(WBEMClient client,
            String namespace, CIM_StorageExtent Antecedent, CIM_LogicalDisk Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_LogicalDiskBasedOnExtent.PROPERTY_ANTECEDENT_CIM_STORAGEEXTENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_LogicalDiskBasedOnExtent.PROPERTY_DEPENDENT_CIM_LOGICALDISK.NAME,
     ...
     *
     */
    public final static CIM_LogicalDiskBasedOnExtent createInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnExtent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_LogicalDiskBasedOnExtent newDataInstance = CIM_LogicalDiskBasedOnExtentHelper
     ...
     */
    public final static CIM_LogicalDiskBasedOnExtent modifyInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnExtent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LogicalDiskBasedOnExtent dataInstance2 = CIM_LogicalDiskBasedOnExtentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnExtent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LogicalDiskBasedOnExtent.getPackages());
    }
