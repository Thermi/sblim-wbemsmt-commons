...
public class CIM_MemoryWithMedia extends CIM_Dependency {
     ...
     * 
     */
    public static class PROPERTY_ANTECEDENT_CIM_PHYSICALMEMORY {
        /**
    ...
    public CIM_MemoryWithMedia(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_MemoryWithMedia(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public CIM_PhysicalMemory get_Antecedent_CIM_PhysicalMemory(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_PHYSICALMEMORY.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_PHYSICALMEMORY.NAME
    ...
    public boolean set_Antecedent_CIM_PhysicalMemory(CIM_PhysicalMemory newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_PHYSICALMEMORY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Antecedent_CIM_PhysicalMemory(currentProperty,
                    newValue);
    ...
    public static CIMProperty create_Antecedent_CIM_PhysicalMemory(WBEMClient client,
            String namespace, CIM_PhysicalMemory newValue) throws WbemsmtException {
        CIM_MemoryWithMedia fco = new CIM_MemoryWithMedia(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_ANTECEDENT_CIM_PHYSICALMEMORY.NAME);
        if (property != null) {
            property = setPropertyValue_Antecedent_CIM_PhysicalMemory(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_PHYSICALMEMORY.NAME
    ...
    private static CIMProperty setPropertyValue_Antecedent_CIM_PhysicalMemory(
    ...
    public String getObjectName() {
        return CIM_MemoryWithMedia.CIM_CLASS_NAME;
    }
