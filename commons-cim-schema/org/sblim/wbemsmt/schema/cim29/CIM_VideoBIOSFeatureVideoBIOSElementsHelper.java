 ...
 * 
 * Description: Helper class for CIM_VideoBIOSFeatureVideoBIOSElements
 *    
 * 
 * generated Class
 * @see CIM_VideoBIOSFeatureVideoBIOSElements
 */
...
public class CIM_VideoBIOSFeatureVideoBIOSElementsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_VideoBIOSFeatureVideoBIOSElements or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_VideoBIOSFeatureVideoBIOSElements.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_VideoBIOSFeatureVideoBIOSElements or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_VideoBIOSFeatureVideoBIOSElements.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VideoBIOSFeatureVideoBIOSElements(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VideoBIOSFeatureVideoBIOSElementsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VideoBIOSFeatureVideoBIOSElements.");
                        resultArrayList.add(new CIM_VideoBIOSFeatureVideoBIOSElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VideoBIOSFeatureVideoBIOSElements.");
                        resultArrayList.add(new CIM_VideoBIOSFeatureVideoBIOSElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VideoBIOSFeatureVideoBIOSElements.");
                        resultArrayList.add(new CIM_VideoBIOSFeatureVideoBIOSElements(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VideoBIOSFeatureVideoBIOSElements getInstance(WBEMClient client,
    ...
    public final static CIM_VideoBIOSFeatureVideoBIOSElements getInstance(WBEMClient client,
        ...
        Class clazz = CIM_VideoBIOSFeatureVideoBIOSElementsHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_VideoBIOSFeatureVideoBIOSElements) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_VideoBIOSFeatureVideoBIOSElements(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_VideoBIOSFeatureVideoBIOSElements getInstance(WBEMClient client,
            String namespace, CIM_VideoBIOSFeature GroupComponent,
            CIM_VideoBIOSElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_VideoBIOSFeatureVideoBIOSElements.PROPERTY_GROUPCOMPONENT_CIM_VIDEOBIOSFEATURE.NAME,
                new CIMDataType(CIM_VideoBIOSFeature.CIM_CLASS_NAME), setThis, false, false,
                CIM_VideoBIOSFeatureVideoBIOSElements.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_VideoBIOSFeatureVideoBIOSElements.PROPERTY_PARTCOMPONENT_CIM_VIDEOBIOSELEMENT.NAME,
                new CIMDataType(CIM_VideoBIOSElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_VideoBIOSFeatureVideoBIOSElements.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_VideoBIOSFeatureVideoBIOSElements createInstance(WBEMClient client,
            CIM_VideoBIOSFeatureVideoBIOSElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_VideoBIOSFeatureVideoBIOSElements newDataInstance = CIM_VideoBIOSFeatureVideoBIOSElementsHelper
     ...
     */
    public final static CIM_VideoBIOSFeatureVideoBIOSElements modifyInstance(WBEMClient client,
            CIM_VideoBIOSFeatureVideoBIOSElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VideoBIOSFeatureVideoBIOSElements dataInstance2 = CIM_VideoBIOSFeatureVideoBIOSElementsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_VideoBIOSFeatureVideoBIOSElements dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VideoBIOSFeatureVideoBIOSElements.getPackages());
    }
