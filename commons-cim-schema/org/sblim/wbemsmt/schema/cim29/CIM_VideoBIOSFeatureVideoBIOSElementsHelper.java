...
public final class CIM_VideoBIOSFeatureVideoBIOSElementsHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					Class clazz = CIM_VideoBIOSFeatureVideoBIOSElementsHelper.findClass(cimClient, cimInstance);
					if (clazz == null) {
	...
	*/	
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_VideoBIOSFeatureVideoBIOSElements.getPackages();
