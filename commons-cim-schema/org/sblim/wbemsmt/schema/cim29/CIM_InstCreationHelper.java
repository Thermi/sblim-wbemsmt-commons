...
public class CIM_InstCreationHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_InstCreation.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_InstCreation.");
                        resultArrayList.add(new CIM_InstCreation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_InstCreation.");
                        resultArrayList.add(new CIM_InstCreation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_InstCreation.");
                        resultArrayList.add(new CIM_InstCreation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_InstCreation getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_InstCreation getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static CIM_InstCreation createInstance(WBEMClient client,
            CIM_InstCreation dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_InstCreation newDataInstance = CIM_InstCreationHelper
     ...
     */
    public final static CIM_InstCreation modifyInstance(WBEMClient client,
            CIM_InstCreation dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_InstCreation dataInstance2 = CIM_InstCreationHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_InstCreation dataInstance)
            throws WbemsmtException {
