 ...
 * 
 * Description: Helper class for CIM_ProductProductDependency
 *    
 * 
 * generated Class
 * @see CIM_ProductProductDependency
 */
...
public class CIM_ProductProductDependencyHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductProductDependency or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductProductDependency.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductProductDependency.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductProductDependency or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ProductProductDependency.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProductProductDependency(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductProductDependencyHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductProductDependency.");
                        resultArrayList.add(new CIM_ProductProductDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductProductDependency.");
                        resultArrayList.add(new CIM_ProductProductDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductProductDependency.");
                        resultArrayList.add(new CIM_ProductProductDependency(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductProductDependency getInstance(WBEMClient client,
    ...
    public final static CIM_ProductProductDependency getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductProductDependency) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductProductDependency(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductProductDependency getInstance(WBEMClient client,
            String namespace, CIM_Product RequiredProduct, CIM_Product DependentProduct
        ...
        setThis = RequiredProduct != null ? RequiredProduct.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_ProductProductDependency.PROPERTY_REQUIREDPRODUCT_CIM_PRODUCT.NAME,
                new CIMDataType(CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductProductDependency.CIM_CLASS_NAME);

        setThis = DependentProduct != null ? DependentProduct.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ProductProductDependency.PROPERTY_DEPENDENTPRODUCT_CIM_PRODUCT.NAME,
                new CIMDataType(CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductProductDependency.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProductProductDependency createInstance(WBEMClient client,
            CIM_ProductProductDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProductProductDependency newDataInstance = CIM_ProductProductDependencyHelper
     ...
     */
    public final static CIM_ProductProductDependency modifyInstance(WBEMClient client,
            CIM_ProductProductDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductProductDependency dataInstance2 = CIM_ProductProductDependencyHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProductProductDependency dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductProductDependency.getPackages());
    }
