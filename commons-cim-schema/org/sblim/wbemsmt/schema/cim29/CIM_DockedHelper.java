 ...
 * 
 * Description: Helper class for CIM_Docked
 *    
 * 
 * generated Class
 * @see CIM_Docked
...
public class CIM_DockedHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Docked or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Docked.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Docked.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Docked or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Docked.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Docked(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DockedHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Docked.");
                        resultArrayList.add(new CIM_Docked(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Docked.");
                        resultArrayList.add(new CIM_Docked(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Docked.");
                        resultArrayList.add(new CIM_Docked(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Docked getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Docked getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Docked) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Docked(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Docked getInstance(WBEMClient client, String namespace,
            CIM_Chassis Antecedent, CIM_Chassis Dependent
        ...
        keyProperties[0] = new CIMProperty(CIM_Docked.PROPERTY_ANTECEDENT_CIM_CHASSIS.NAME,
                new CIMDataType(CIM_Chassis.CIM_CLASS_NAME), setThis, false, false,
                CIM_Docked.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_Docked.PROPERTY_DEPENDENT_CIM_CHASSIS.NAME,
                new CIMDataType(CIM_Chassis.CIM_CLASS_NAME), setThis, false, false,
                CIM_Docked.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Docked createInstance(WBEMClient client, CIM_Docked dataInstance,
        ...
        CIM_Docked newDataInstance = CIM_DockedHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Docked modifyInstance(WBEMClient client, CIM_Docked dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Docked dataInstance2 = CIM_DockedHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Docked dataInstance)
            throws WbemsmtException {
