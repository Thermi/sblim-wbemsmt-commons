 ...
 *
 *
 * Description: The use of this class is deprecated in lieu of SCSIProtocolController. The latter reflects the protocol- related issues of SCSI interfaces, since these are not bus master-type Controllers. Capabilities and management of the SCSIController.
 * 
 */
...
public class CIM_SCSIController extends CIM_Controller  {
	...
	*/
	...
	/**
	*	Signal capabilities that can be supported by the SCSI Controller. For example, the Controller may support "Single Ended" and "Differential". In this case, the values 3 and 4 would be written to the Signal Capabilities array.
	*/
