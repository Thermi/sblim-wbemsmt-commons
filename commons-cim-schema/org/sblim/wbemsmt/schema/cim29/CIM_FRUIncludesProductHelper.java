 ...
 * 
 * Description: Helper class for CIM_FRUIncludesProduct
 *    
 * 
 * generated Class
 * @see CIM_FRUIncludesProduct
 */
...
public class CIM_FRUIncludesProductHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FRUIncludesProduct or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FRUIncludesProduct.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FRUIncludesProduct.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FRUIncludesProduct or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_FRUIncludesProduct.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FRUIncludesProduct(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FRUIncludesProductHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FRUIncludesProduct.");
                        resultArrayList.add(new CIM_FRUIncludesProduct(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FRUIncludesProduct.");
                        resultArrayList.add(new CIM_FRUIncludesProduct(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FRUIncludesProduct.");
                        resultArrayList.add(new CIM_FRUIncludesProduct(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FRUIncludesProduct getInstance(WBEMClient client,
    ...
    public final static CIM_FRUIncludesProduct getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FRUIncludesProduct) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FRUIncludesProduct(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FRUIncludesProduct getInstance(WBEMClient client, String namespace,
            CIM_FRU FRU, CIM_Product Component
        ...
        keyProperties[0] = new CIMProperty(CIM_FRUIncludesProduct.PROPERTY_FRU_CIM_FRU.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_FRUIncludesProduct.PROPERTY_COMPONENT_CIM_PRODUCT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_FRUIncludesProduct createInstance(WBEMClient client,
            CIM_FRUIncludesProduct dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FRUIncludesProduct newDataInstance = CIM_FRUIncludesProductHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_FRUIncludesProduct modifyInstance(WBEMClient client,
            CIM_FRUIncludesProduct dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FRUIncludesProduct dataInstance2 = CIM_FRUIncludesProductHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FRUIncludesProduct dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FRUIncludesProduct.getPackages());
    }
