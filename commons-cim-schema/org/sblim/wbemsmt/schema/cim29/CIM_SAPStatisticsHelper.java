 ...
 * 
 * Description: Helper class for CIM_SAPStatistics
 *    
 * 
 * generated Class
 * @see CIM_SAPStatistics
 */
...
public class CIM_SAPStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SAPStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SAPStatistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_SAPStatistics.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SAPStatistics or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_SAPStatistics.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SAPStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SAPStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SAPStatistics.");
                        resultArrayList.add(new CIM_SAPStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SAPStatistics.");
                        resultArrayList.add(new CIM_SAPStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SAPStatistics.");
                        resultArrayList.add(new CIM_SAPStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SAPStatistics getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_SAPStatistics getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SAPStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SAPStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SAPStatistics getInstance(WBEMClient client, String namespace,
            CIM_SAPStatisticalInformation Stats, CIM_ServiceAccessPoint Element
        ...
        setThis = Stats != null ? Stats.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_SAPStatistics.PROPERTY_STATS_CIM_SAPSTATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_SAPStatisticalInformation.CIM_CLASS_NAME), setThis, false,
                false, CIM_SAPStatistics.CIM_CLASS_NAME);

        setThis = Element != null ? Element.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_SAPStatistics.PROPERTY_ELEMENT_CIM_SERVICEACCESSPOINT.NAME, new CIMDataType(
                        CIM_ServiceAccessPoint.CIM_CLASS_NAME), setThis, false, false,
     ...
     *
     */
    public final static CIM_SAPStatistics createInstance(WBEMClient client,
            CIM_SAPStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SAPStatistics newDataInstance = CIM_SAPStatisticsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SAPStatistics modifyInstance(WBEMClient client,
            CIM_SAPStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SAPStatistics dataInstance2 = CIM_SAPStatisticsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SAPStatistics dataInstance)
            throws WbemsmtException {
