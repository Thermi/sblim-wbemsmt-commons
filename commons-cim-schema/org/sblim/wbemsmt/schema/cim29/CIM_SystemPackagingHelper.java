 ...
 * 
 * Description: Helper class for CIM_SystemPackaging
 *    
 * 
 * generated Class
 * @see CIM_SystemPackaging
 */
...
public class CIM_SystemPackagingHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemPackaging or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemPackaging.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemPackaging.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemPackaging or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_SystemPackaging.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemPackaging(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemPackagingHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemPackaging.");
                        resultArrayList.add(new CIM_SystemPackaging(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemPackaging.");
                        resultArrayList.add(new CIM_SystemPackaging(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemPackaging.");
                        resultArrayList.add(new CIM_SystemPackaging(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemPackaging getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SystemPackaging getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemPackaging) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemPackaging(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemPackaging getInstance(WBEMClient client, String namespace,
            CIM_PhysicalElement Antecedent, CIM_System Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemPackaging.PROPERTY_ANTECEDENT_CIM_PHYSICALELEMENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(CIM_SystemPackaging.PROPERTY_DEPENDENT_CIM_SYSTEM.NAME,
     ...
     *
     */
    public final static CIM_SystemPackaging createInstance(WBEMClient client,
            CIM_SystemPackaging dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemPackaging newDataInstance = CIM_SystemPackagingHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SystemPackaging modifyInstance(WBEMClient client,
            CIM_SystemPackaging dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemPackaging dataInstance2 = CIM_SystemPackagingHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemPackaging dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemPackaging.getPackages());
    }
