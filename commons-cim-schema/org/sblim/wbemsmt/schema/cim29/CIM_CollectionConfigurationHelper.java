 ...
 * 
 * Description: Helper class for CIM_CollectionConfiguration
 *    
 * 
 * generated Class
 * @see CIM_CollectionConfiguration
 */
...
public class CIM_CollectionConfigurationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CollectionConfiguration or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CollectionConfiguration.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CollectionConfiguration.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CollectionConfiguration or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_CollectionConfiguration(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CollectionConfigurationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CollectionConfiguration.");
                        resultArrayList.add(new CIM_CollectionConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CollectionConfiguration.");
                        resultArrayList.add(new CIM_CollectionConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CollectionConfiguration.");
                        resultArrayList.add(new CIM_CollectionConfiguration(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CollectionConfiguration getInstance(WBEMClient client,
    ...
    public final static CIM_CollectionConfiguration getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CollectionConfiguration) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CollectionConfiguration(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CollectionConfiguration getInstance(WBEMClient client,
            String namespace, CIM_CollectionOfMSEs Collection, CIM_Configuration Configuration
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CollectionConfiguration.PROPERTY_COLLECTION_CIM_COLLECTIONOFMSES.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_CollectionConfiguration.PROPERTY_CONFIGURATION_CIM_CONFIGURATION.NAME,
     ...
     *
     */
    public final static CIM_CollectionConfiguration createInstance(WBEMClient client,
            CIM_CollectionConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CollectionConfiguration newDataInstance = CIM_CollectionConfigurationHelper
     ...
     */
    public final static CIM_CollectionConfiguration modifyInstance(WBEMClient client,
            CIM_CollectionConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CollectionConfiguration dataInstance2 = CIM_CollectionConfigurationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_CollectionConfiguration dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CollectionConfiguration.getPackages());
    }
