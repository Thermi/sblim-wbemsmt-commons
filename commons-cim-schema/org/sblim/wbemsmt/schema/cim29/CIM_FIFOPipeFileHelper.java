 ...
 * 
 * Description: Helper class for CIM_FIFOPipeFile
 *    
 * 
 * generated Class
 * @see CIM_FIFOPipeFile
 */
...
public class CIM_FIFOPipeFileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FIFOPipeFile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FIFOPipeFile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_FIFOPipeFile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FIFOPipeFile or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_FIFOPipeFile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FIFOPipeFile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FIFOPipeFileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FIFOPipeFile.");
                        resultArrayList.add(new CIM_FIFOPipeFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FIFOPipeFile.");
                        resultArrayList.add(new CIM_FIFOPipeFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FIFOPipeFile.");
                        resultArrayList.add(new CIM_FIFOPipeFile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FIFOPipeFile getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_FIFOPipeFile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FIFOPipeFile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FIFOPipeFile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FIFOPipeFile getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_FIFOPipeFile.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FIFOPipeFile.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_FIFOPipeFile.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FIFOPipeFile.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_FIFOPipeFile.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FIFOPipeFile.CIM_CLASS_NAME);

        setThis = FSCreationClassName;

        keyProperties[3] = new CIMProperty(CIM_FIFOPipeFile.PROPERTY_FSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FIFOPipeFile.CIM_CLASS_NAME);

        setThis = FSName;

        keyProperties[4] = new CIMProperty(CIM_FIFOPipeFile.PROPERTY_FSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FIFOPipeFile.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[5] = new CIMProperty(CIM_FIFOPipeFile.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FIFOPipeFile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FIFOPipeFile createInstance(WBEMClient client,
            CIM_FIFOPipeFile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_FIFOPipeFile newDataInstance = CIM_FIFOPipeFileHelper
     ...
     */
    public final static CIM_FIFOPipeFile modifyInstance(WBEMClient client,
            CIM_FIFOPipeFile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FIFOPipeFile dataInstance2 = CIM_FIFOPipeFileHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FIFOPipeFile dataInstance)
            throws WbemsmtException {
