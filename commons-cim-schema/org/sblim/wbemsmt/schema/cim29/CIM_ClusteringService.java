...
public class CIM_ClusteringService extends CIM_Service {
    ...
    public static class METHOD_ADDNODE {
        /**
         * Constant for method AddNode
         */
        public final static String NAME = "AddNode";

        /**
         * constants for parameter CS
         */
        public static class PARAMETER_CS {
            /*
             * Name of the parameter CS
             */
            public final static String NAME = "CS";
    ...
    public static class METHOD_EVICTNODE {
        /**
         * Constant for method EvictNode
         */
        public final static String NAME = "EvictNode";
    ...
    public CIM_ClusteringService(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ClusteringService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ClusteringService() {
    }
    ...
    /**
     * Get the list with CIM_ClusteringSAP objects associated by the association CIM_ClusterServiceAccessBySAP
     * 
    ...
    public java.util.List getAssociated_CIM_ClusteringSAP_CIM_ClusterServiceAccessBySAPs(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ClusteringSAP_CIM_ClusterServiceAccessBySAPs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_CLUSTERSERVICEACCESSBYSAP,
                CIM_ClusteringSAP.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_ClusteringSAP_CIM_ClusterServiceAccessBySAPs(
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_ClusteringServiceHelper.checkException(enumeration);
    ...
    public java.util.List getAssociated_CIM_ClusteringSAP_CIM_ClusterServiceAccessBySAPNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ClusteringSAP_CIM_ClusterServiceAccessBySAPNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_CLUSTERSERVICEACCESSBYSAP,
    ...
    /**
     * Get the list with CIM_Cluster objects associated by the association CIM_HostedClusterService
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_Cluster_CIM_HostedClusterServices(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Cluster_CIM_HostedClusterServices(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDCLUSTERSERVICE, CIM_Cluster.CIM_CLASS_NAME,
    ...
    public java.util.List getAssociated_CIM_Cluster_CIM_HostedClusterServiceNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_Cluster_CIM_HostedClusterServiceNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDCLUSTERSERVICE, CIM_Cluster.CIM_CLASS_NAME,
                null, null);
    }
    ...
    /**
     * Invokes the Method AddNode
     * <br>
     * @param client the cimclient
     * AddNode brings a new ComputerSystem into a Cluster. The node to be added is specified as a parameter to the method. The return value should be 0 if the Computer System is successfully added, 1 if the method is not supported and any other number if an error occurred. In a subclass, the set of possible return codes could be specified, using a ValueMap qualifier on the method. The strings to which the ValueMap contents are 'translated' may also be specified in the subclass as a Values array qualifier.
     *   @param CS The node to add to the cluster.
     *
     */

    public AddNodeResult invoke_AddNode(WBEMClient cimClient, CIM_ComputerSystem CS)
            throws WbemsmtException {

        CIMArgument[] inParameter = new CIMArgument[1];
        CIMArgument[] outParameter = new CIMArgument[0];

        inParameter[0] = new CIMArgument("CS", new CIMDataType(CIM_ComputerSystem.CIM_CLASS_NAME),
                CS);

        javax.cim.UnsignedInteger32 resultObject = null;

        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(), METHOD_ADDNODE.NAME,
            ...
            throw new InvokeMethodException(e, new InvokeMethodUserObject(this.getCimObjectPath(),
                    METHOD_ADDNODE.NAME, inParameter, outParameter));
        }
    ...
    /**
     * Result object for the method AddNode
     */
    ...
    /**
     * Invokes the Method EvictNode
     * <br>
     * @param client the cimclient
     * EvictNode removes a ComputerSystem from a Cluster. The node to be evicted is specified as a parameter to the method. The return value should be 0 if the ComputerSystem is successfully evicted, 1 if the method is not supported and any other number if an error occurred. In a subclass, the set of possible return codes could be specified, using a ValueMap qualifier on the method. The strings to which the ValueMap contents are 'translated' may also be specified in the subclass as a Values array qualifier.
     *   @param CS The node to remove from the cluster.
     *
     */

    public EvictNodeResult invoke_EvictNode(WBEMClient cimClient, CIM_ComputerSystem CS)
            throws WbemsmtException {
        ...
        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(), METHOD_EVICTNODE.NAME,
                    inParameter, outParameter);
            if (oResult != null) {
            ...
            throw new InvokeMethodException(e, new InvokeMethodUserObject(this.getCimObjectPath(),
                    METHOD_EVICTNODE.NAME, inParameter, outParameter));
        }

        EvictNodeResult result = new EvictNodeResult();
        result.setResultObject(resultObject);
    ...
    /**
     * Result object for the method EvictNode
     */
    public static class EvictNodeResult {
        /**
         * The return value of the method
         */
    ...
    public String getObjectName() {
        return CIM_ClusteringService.CIM_CLASS_NAME;
    }
