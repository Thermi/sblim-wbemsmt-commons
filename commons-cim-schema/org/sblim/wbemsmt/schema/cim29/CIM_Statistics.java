...
public class CIM_Statistics extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
    ...
    public CIM_Statistics(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_Statistics(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_Stats_CIM_StatisticalInformation(WBEMClient client,
        ...
        CIM_Statistics fco = new CIM_Statistics(client, namespace);
    ...
    public String getObjectName() {
        return CIM_Statistics.CIM_CLASS_NAME;
    }
