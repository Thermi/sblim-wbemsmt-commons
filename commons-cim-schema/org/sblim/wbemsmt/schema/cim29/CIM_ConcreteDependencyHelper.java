 ...
 * 
 * Description: Helper class for CIM_ConcreteDependency
 *    
 * 
 * generated Class
 * @see CIM_ConcreteDependency
 */
...
public class CIM_ConcreteDependencyHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ConcreteDependency or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ConcreteDependency.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ConcreteDependency.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ConcreteDependency or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ConcreteDependency.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ConcreteDependency(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ConcreteDependencyHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ConcreteDependency.");
                        resultArrayList.add(new CIM_ConcreteDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ConcreteDependency.");
                        resultArrayList.add(new CIM_ConcreteDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ConcreteDependency.");
                        resultArrayList.add(new CIM_ConcreteDependency(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ConcreteDependency getInstance(WBEMClient client,
    ...
    public final static CIM_ConcreteDependency getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ConcreteDependency) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ConcreteDependency(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ConcreteDependency getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ConcreteDependency.PROPERTY_ANTECEDENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ConcreteDependency.PROPERTY_DEPENDENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_ConcreteDependency createInstance(WBEMClient client,
            CIM_ConcreteDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ConcreteDependency newDataInstance = CIM_ConcreteDependencyHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ConcreteDependency modifyInstance(WBEMClient client,
            CIM_ConcreteDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ConcreteDependency dataInstance2 = CIM_ConcreteDependencyHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ConcreteDependency dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ConcreteDependency.getPackages());
    }
