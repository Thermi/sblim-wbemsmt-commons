/** 
 * CIM_SoftwareElementHelper.java
 *
...
public final class CIM_SoftwareElementHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_SoftwareElement.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SoftwareElement.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_SoftwareElement.Java_Package_List.get(i))).endsWith(".")) {
							CIM_SoftwareElement.Java_Package_List.setElementAt((String)(CIM_SoftwareElement.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SoftwareElement.");
						resultArrayList.add(new CIM_SoftwareElement(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SoftwareElement.");
						resultArrayList.add(new CIM_SoftwareElement(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SoftwareElement.");
						resultArrayList.add(new CIM_SoftwareElement(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SoftwareElement getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SoftwareElementHelper.getInstance(cimClient, new CIM_SoftwareElement(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SoftwareElement getInstance(CIMClient cimClient, CIM_SoftwareElement dataInstance) {
		...
		return CIM_SoftwareElementHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SoftwareElement getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SoftwareElement dataInstance = null;
		try {
			dataInstance = new CIM_SoftwareElement(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SoftwareElement createInstance(CIMClient cimClient, CIM_SoftwareElement dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SoftwareElement newDataInstance = null;
		try {
			newDataInstance = CIM_SoftwareElementHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SoftwareElement modifyInstance(CIMClient cimClient, CIM_SoftwareElement dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SoftwareElementHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SoftwareElement dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SoftwareElement dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SoftwareElement.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SoftwareElement.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SoftwareElement.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SoftwareElement.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SoftwareElement.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BuildNumber(String BuildNumber) {
		return true;
	}

	public static boolean isValid_CodeSet(String CodeSet) {
		return true;
	}

	public static boolean isValid_IdentificationCode(String IdentificationCode) {
		return true;
	}

	public static boolean isValid_LanguageEdition(String LanguageEdition) {
		return true;
	}
	...
	public static boolean isValid_OtherTargetOS(String OtherTargetOS) {
		return true;
	}
	...
	public static boolean isValid_SoftwareElementID(String SoftwareElementID) {
		return true;
	}

	public static boolean isValid_SoftwareElementState(UnsignedInt16 SoftwareElementState) {
		return true;
	}

	public static boolean isValid_TargetOperatingSystem(UnsignedInt16 TargetOperatingSystem) {
		return true;
	}
