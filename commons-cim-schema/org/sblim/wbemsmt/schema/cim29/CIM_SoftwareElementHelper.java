 ...
 * 
 * Description: Helper class for CIM_SoftwareElement
 *    
 * 
 * generated Class
 * @see CIM_SoftwareElement
 */
...
public class CIM_SoftwareElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SoftwareElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareElement or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_SoftwareElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SoftwareElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareElement.");
                        resultArrayList.add(new CIM_SoftwareElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareElement.");
                        resultArrayList.add(new CIM_SoftwareElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareElement.");
                        resultArrayList.add(new CIM_SoftwareElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareElement getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SoftwareElement getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareElement getInstance(WBEMClient client, String namespace,
            String Name, String SoftwareElementID,
            javax.cim.UnsignedInteger16 SoftwareElementState,
            javax.cim.UnsignedInteger16 TargetOperatingSystem, String Version
        ...
        CIMProperty[] keyProperties = new CIMProperty[5];

        Object setThis = null;

        setThis = Name;

        keyProperties[0] = new CIMProperty(CIM_SoftwareElement.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SoftwareElement.CIM_CLASS_NAME);

        setThis = SoftwareElementID;

        keyProperties[1] = new CIMProperty(CIM_SoftwareElement.PROPERTY_SOFTWAREELEMENTID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SoftwareElement.CIM_CLASS_NAME);

        setThis = SoftwareElementState;

        keyProperties[2] = new CIMProperty(CIM_SoftwareElement.PROPERTY_SOFTWAREELEMENTSTATE.NAME,
                CIMDataType.UINT16_T, setThis, true, false, CIM_SoftwareElement.CIM_CLASS_NAME);

        setThis = TargetOperatingSystem;

        keyProperties[3] = new CIMProperty(CIM_SoftwareElement.PROPERTY_TARGETOPERATINGSYSTEM.NAME,
                CIMDataType.UINT16_T, setThis, true, false, CIM_SoftwareElement.CIM_CLASS_NAME);

        setThis = Version;

        keyProperties[4] = new CIMProperty(CIM_SoftwareElement.PROPERTY_VERSION.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SoftwareElement.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SoftwareElement createInstance(WBEMClient client,
            CIM_SoftwareElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SoftwareElement newDataInstance = CIM_SoftwareElementHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SoftwareElement modifyInstance(WBEMClient client,
            CIM_SoftwareElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareElement dataInstance2 = CIM_SoftwareElementHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SoftwareElement dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareElement.getPackages());
    }
