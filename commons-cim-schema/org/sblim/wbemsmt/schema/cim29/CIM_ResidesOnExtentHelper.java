 ...
 * 
 * Description: Helper class for CIM_ResidesOnExtent
 *    
 * 
 * generated Class
 * @see CIM_ResidesOnExtent
 */
...
public class CIM_ResidesOnExtentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ResidesOnExtent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ResidesOnExtent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ResidesOnExtent.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ResidesOnExtent or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_ResidesOnExtent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ResidesOnExtent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ResidesOnExtentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ResidesOnExtent.");
                        resultArrayList.add(new CIM_ResidesOnExtent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ResidesOnExtent.");
                        resultArrayList.add(new CIM_ResidesOnExtent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ResidesOnExtent.");
                        resultArrayList.add(new CIM_ResidesOnExtent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ResidesOnExtent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ResidesOnExtent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ResidesOnExtent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ResidesOnExtent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ResidesOnExtent getInstance(WBEMClient client, String namespace,
            CIM_StorageExtent Antecedent, CIM_LogicalElement Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ResidesOnExtent.PROPERTY_ANTECEDENT_CIM_STORAGEEXTENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ResidesOnExtent.PROPERTY_DEPENDENT_CIM_LOGICALELEMENT.NAME, new CIMDataType(
                        CIM_LogicalElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_ResidesOnExtent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ResidesOnExtent createInstance(WBEMClient client,
            CIM_ResidesOnExtent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ResidesOnExtent newDataInstance = CIM_ResidesOnExtentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ResidesOnExtent modifyInstance(WBEMClient client,
            CIM_ResidesOnExtent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ResidesOnExtent dataInstance2 = CIM_ResidesOnExtentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ResidesOnExtent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ResidesOnExtent.getPackages());
    }
