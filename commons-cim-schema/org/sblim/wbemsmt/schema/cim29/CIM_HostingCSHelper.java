 ...
 * 
 * Description: Helper class for CIM_HostingCS
 *    
 * 
 * generated Class
 * @see CIM_HostingCS
...
public class CIM_HostingCSHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostingCS or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostingCS.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_HostingCS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostingCS or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_HostingCS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostingCS(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostingCSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_HostingCS.");
                        resultArrayList.add(new CIM_HostingCS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_HostingCS.");
                        resultArrayList.add(new CIM_HostingCS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostingCS.");
                        resultArrayList.add(new CIM_HostingCS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostingCS getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_HostingCS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostingCS) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostingCS(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostingCS getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem Antecedent, CIM_VirtualComputerSystem Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostingCS.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostingCS.PROPERTY_DEPENDENT_CIM_VIRTUALCOMPUTERSYSTEM.NAME, new CIMDataType(
                        CIM_VirtualComputerSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostingCS.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_HostingCS createInstance(WBEMClient client, CIM_HostingCS dataInstance,
        ...
        CIM_HostingCS newDataInstance = CIM_HostingCSHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_HostingCS modifyInstance(WBEMClient client, CIM_HostingCS dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostingCS dataInstance2 = CIM_HostingCSHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostingCS dataInstance)
            throws WbemsmtException {
