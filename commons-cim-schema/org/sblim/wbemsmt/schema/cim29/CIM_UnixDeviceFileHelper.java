 ...
 * 
 * Description: Helper class for CIM_UnixDeviceFile
 *    
 * 
 * generated Class
 * @see CIM_UnixDeviceFile
 */
...
public class CIM_UnixDeviceFileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_UnixDeviceFile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_UnixDeviceFile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_UnixDeviceFile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_UnixDeviceFile or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_UnixDeviceFile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_UnixDeviceFile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_UnixDeviceFileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_UnixDeviceFile.");
                        resultArrayList.add(new CIM_UnixDeviceFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_UnixDeviceFile.");
                        resultArrayList.add(new CIM_UnixDeviceFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_UnixDeviceFile.");
                        resultArrayList.add(new CIM_UnixDeviceFile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_UnixDeviceFile getInstance(WBEMClient client,
     ...
     */
    public final static CIM_UnixDeviceFile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_UnixDeviceFile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_UnixDeviceFile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_UnixDeviceFile getInstance(WBEMClient client, String namespace,
            String CSCreationClassName, String CSName, String CreationClassName,
            String FSCreationClassName, String FSName, String Name
        ...
        keyProperties[0] = new CIMProperty(CIM_UnixDeviceFile.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixDeviceFile.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_UnixDeviceFile.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixDeviceFile.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_UnixDeviceFile.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixDeviceFile.CIM_CLASS_NAME);

        setThis = FSCreationClassName;

        keyProperties[3] = new CIMProperty(CIM_UnixDeviceFile.PROPERTY_FSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixDeviceFile.CIM_CLASS_NAME);

        setThis = FSName;

        keyProperties[4] = new CIMProperty(CIM_UnixDeviceFile.PROPERTY_FSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixDeviceFile.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[5] = new CIMProperty(CIM_UnixDeviceFile.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixDeviceFile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_UnixDeviceFile createInstance(WBEMClient client,
            CIM_UnixDeviceFile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_UnixDeviceFile newDataInstance = CIM_UnixDeviceFileHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_UnixDeviceFile modifyInstance(WBEMClient client,
            CIM_UnixDeviceFile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_UnixDeviceFile dataInstance2 = CIM_UnixDeviceFileHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_UnixDeviceFile dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_UnixDeviceFile.getPackages());
    }
