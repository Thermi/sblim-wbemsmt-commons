 ...
 * 
 * Description: Helper class for CIM_HostedBootSAP
 *    
 * 
 * generated Class
 * @see CIM_HostedBootSAP
 */
...
public class CIM_HostedBootSAPHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostedBootSAP or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedBootSAP.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_HostedBootSAP.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostedBootSAP or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_HostedBootSAP.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostedBootSAP(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostedBootSAPHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HostedBootSAP.");
                        resultArrayList.add(new CIM_HostedBootSAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedBootSAP.");
                        resultArrayList.add(new CIM_HostedBootSAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedBootSAP.");
                        resultArrayList.add(new CIM_HostedBootSAP(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedBootSAP getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_HostedBootSAP getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostedBootSAP) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostedBootSAP(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostedBootSAP getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem Antecedent, CIM_BootSAP Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedBootSAP.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
                        CIM_ComputerSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostedBootSAP.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_HostedBootSAP.PROPERTY_DEPENDENT_CIM_BOOTSAP.NAME,
                new CIMDataType(CIM_BootSAP.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostedBootSAP.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_HostedBootSAP createInstance(WBEMClient client,
            CIM_HostedBootSAP dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedBootSAP newDataInstance = CIM_HostedBootSAPHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedBootSAP modifyInstance(WBEMClient client,
            CIM_HostedBootSAP dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedBootSAP dataInstance2 = CIM_HostedBootSAPHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedBootSAP dataInstance)
            throws WbemsmtException {
