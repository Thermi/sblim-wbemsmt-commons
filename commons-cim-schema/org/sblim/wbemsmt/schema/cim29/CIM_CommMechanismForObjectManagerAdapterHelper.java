 ...
 * 
 * Description: Helper class for CIM_CommMechanismForObjectManagerAdapter
 *    
 * 
 * generated Class
 * @see CIM_CommMechanismForObjectManagerAdapter
 */
...
public class CIM_CommMechanismForObjectManagerAdapterHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CommMechanismForObjectManagerAdapter or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_CommMechanismForObjectManagerAdapter.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CommMechanismForObjectManagerAdapter or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_CommMechanismForObjectManagerAdapter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CommMechanismForObjectManagerAdapter(
                                cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CommMechanismForObjectManagerAdapterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CommMechanismForObjectManagerAdapter.");
                        resultArrayList.add(new CIM_CommMechanismForObjectManagerAdapter(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CommMechanismForObjectManagerAdapter.");
                        resultArrayList.add(new CIM_CommMechanismForObjectManagerAdapter(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CommMechanismForObjectManagerAdapter.");
                        resultArrayList.add(new CIM_CommMechanismForObjectManagerAdapter(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CommMechanismForObjectManagerAdapter getInstance(WBEMClient client,
    ...
    public final static CIM_CommMechanismForObjectManagerAdapter getInstance(WBEMClient client,
        ...
        Class clazz = CIM_CommMechanismForObjectManagerAdapterHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CommMechanismForObjectManagerAdapter) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CommMechanismForObjectManagerAdapter(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CommMechanismForObjectManagerAdapter getInstance(WBEMClient client,
            String namespace, CIM_ObjectManagerAdapter Antecedent,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CommMechanismForObjectManagerAdapter.PROPERTY_ANTECEDENT_CIM_OBJECTMANAGERADAPTER.NAME,
                new CIMDataType(CIM_ObjectManagerAdapter.CIM_CLASS_NAME), setThis, false, false,
                CIM_CommMechanismForObjectManagerAdapter.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_CommMechanismForObjectManagerAdapter.PROPERTY_DEPENDENT_CIM_OBJECTMANAGERCOMMUNICATIONMECHANISM.NAME,
                new CIMDataType(CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME), setThis,
                false, false, CIM_CommMechanismForObjectManagerAdapter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CommMechanismForObjectManagerAdapter createInstance(WBEMClient client,
            CIM_CommMechanismForObjectManagerAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CommMechanismForObjectManagerAdapter newDataInstance = CIM_CommMechanismForObjectManagerAdapterHelper
     ...
     */
    public final static CIM_CommMechanismForObjectManagerAdapter modifyInstance(WBEMClient client,
            CIM_CommMechanismForObjectManagerAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CommMechanismForObjectManagerAdapter dataInstance2 = CIM_CommMechanismForObjectManagerAdapterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_CommMechanismForObjectManagerAdapter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CommMechanismForObjectManagerAdapter.getPackages());
    }
