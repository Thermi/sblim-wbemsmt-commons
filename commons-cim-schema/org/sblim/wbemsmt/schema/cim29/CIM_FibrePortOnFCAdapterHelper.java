 ...
 * 
 * Description: Helper class for CIM_FibrePortOnFCAdapter
 *    
 * 
 * generated Class
 * @see CIM_FibrePortOnFCAdapter
 */
...
public class CIM_FibrePortOnFCAdapterHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FibrePortOnFCAdapter or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FibrePortOnFCAdapter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FibrePortOnFCAdapter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FibrePortOnFCAdapter or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_FibrePortOnFCAdapter(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FibrePortOnFCAdapterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FibrePortOnFCAdapter.");
                        resultArrayList.add(new CIM_FibrePortOnFCAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FibrePortOnFCAdapter.");
                        resultArrayList.add(new CIM_FibrePortOnFCAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FibrePortOnFCAdapter.");
                        resultArrayList.add(new CIM_FibrePortOnFCAdapter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FibrePortOnFCAdapter getInstance(WBEMClient client,
    ...
    public final static CIM_FibrePortOnFCAdapter getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FibrePortOnFCAdapter) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FibrePortOnFCAdapter(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FibrePortOnFCAdapter getInstance(WBEMClient client, String namespace,
            CIM_FibreChannelAdapter Antecedent, CIM_FibrePort Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_FibrePortOnFCAdapter.PROPERTY_ANTECEDENT_CIM_FIBRECHANNELADAPTER.NAME,
                new CIMDataType(CIM_FibreChannelAdapter.CIM_CLASS_NAME), setThis, false, false,
                CIM_FibrePortOnFCAdapter.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_FibrePortOnFCAdapter.PROPERTY_DEPENDENT_CIM_FIBREPORT.NAME, new CIMDataType(
                        CIM_FibrePort.CIM_CLASS_NAME), setThis, false, false,
                CIM_FibrePortOnFCAdapter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FibrePortOnFCAdapter createInstance(WBEMClient client,
            CIM_FibrePortOnFCAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FibrePortOnFCAdapter newDataInstance = CIM_FibrePortOnFCAdapterHelper.getInstance(
     ...
     */
    public final static CIM_FibrePortOnFCAdapter modifyInstance(WBEMClient client,
            CIM_FibrePortOnFCAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FibrePortOnFCAdapter dataInstance2 = CIM_FibrePortOnFCAdapterHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FibrePortOnFCAdapter dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FibrePortOnFCAdapter.getPackages());
    }
