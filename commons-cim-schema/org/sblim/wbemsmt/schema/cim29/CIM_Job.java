...
public class CIM_Job extends CIM_LogicalElement {
    ...
    public static class METHOD_KILLJOB {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@24d424d4
    ...
    public static class PROPERTY_LOCALORUTCTIME {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@52b052b0
    ...
    public static class PROPERTY_RECOVERYACTION {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@34043404
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public static class PROPERTY_RUNDAYOFWEEK {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@20b220b2
    ...
    public static class PROPERTY_RUNMONTH {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@2c0a2c0a
    ...
    public boolean set_ElapsedTime(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ELAPSEDTIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ElapsedTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_ErrorCode(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ERRORCODE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ErrorCode(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_JobRunTimes(javax.cim.UnsignedInteger32 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_JOBRUNTIMES.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_JobRunTimes(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_JobStatus(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_JOBSTATUS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_JobStatus(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_LocalOrUtcTime(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_LOCALORUTCTIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_LocalOrUtcTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_Notify(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_NOTIFY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Notify(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_Owner(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_OWNER.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Owner(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_PercentComplete(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PERCENTCOMPLETE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_PercentComplete(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_RunDay(Byte newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_RUNDAY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_RunDay(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_RunDayOfWeek(Byte newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_RUNDAYOFWEEK.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_RunDayOfWeek(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_RunMonth(javax.cim.UnsignedInteger8 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_RUNMONTH.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_RunMonth(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_RunStartInterval(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_RUNSTARTINTERVAL.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_RunStartInterval(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_ScheduledStartTime(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SCHEDULEDSTARTTIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ScheduledStartTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_StartTime(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_STARTTIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_StartTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_TimeSubmitted(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_TIMESUBMITTED.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_TimeSubmitted(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_UntilTime(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_UNTILTIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_UntilTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    /**
     * Get the list with CIM_ManagedElement objects associated by the association CIM_OwningJobElement
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_OwningJobElements(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_OwningJobElements(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT, CIM_ManagedElement.CIM_CLASS_NAME,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT or a subclass 
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_OwningJobElements(
        ...
        return getAssociated_CIM_ManagedElement_CIM_OwningJobElements(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT, resultClass, role, resultRole,
                false, false, null);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_OwningJobElement
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_OwningJobElementNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_OwningJobElementNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT, CIM_ManagedElement.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_OwningJobElementNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT,
    ...
    /**
     * Get the list with CIM_OwningJobElement associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_OwningJobElement(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_OwningJobElementHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_OwningJobElement(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_OwningJobElement
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_OwningJobElement(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_OWNINGJOBELEMENT, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_OwningJobElement.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AffectedJobElements(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_AffectedJobElements(cimClient,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AffectedJobElements(
        ...
        return getAssociated_CIM_ManagedElement_CIM_AffectedJobElements(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_AFFECTEDJOBELEMENT, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AffectedJobElementNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_AffectedJobElementNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_AFFECTEDJOBELEMENT,
                CIM_ManagedElement.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_AffectedJobElementNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_AFFECTEDJOBELEMENT,
                    CIM_ManagedElement.CIM_CLASS_NAME, null, null));
        }
    ...
    public java.util.List getAssociations_CIM_AffectedJobElement(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_AFFECTEDJOBELEMENT, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
    ...
    public java.util.List getAssociationNames_CIM_AffectedJobElement(WBEMClient cimClient,
            String role, boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_AFFECTEDJOBELEMENT, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_AFFECTEDJOBELEMENT, role));
        }
    ...
    /**
     * Get the list with CIM_Process objects associated by the association CIM_ProcessOfJob
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_Process_CIM_ProcessOfJobs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Process_CIM_ProcessOfJobs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PROCESSOFJOB, CIM_Process.CIM_CLASS_NAME, null, null,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_Process_CIM_ProcessOfJobNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Process_CIM_ProcessOfJobNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PROCESSOFJOB, CIM_Process.CIM_CLASS_NAME, null, null);
    }
    ...
    /**
     * Get the list with CIM_JobDestination objects associated by the association CIM_JobDestinationJobs
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_JobDestination_CIM_JobDestinationJobss(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_JobDestination_CIM_JobDestinationJobss(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS,
                CIM_JobDestination.CIM_CLASS_NAME, null, null, false, false, null);
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_JobDestination_CIM_JobDestinationJobss(
        ...
        return getAssociated_CIM_JobDestination_CIM_JobDestinationJobss(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS, resultClass, role, resultRole,
                false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_JobDestination(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_JobDestinationJobs
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_JobDestination_CIM_JobDestinationJobsNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_JobDestination_CIM_JobDestinationJobsNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS,
                CIM_JobDestination.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_JobDestination_CIM_JobDestinationJobsNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS,
                    CIM_JobDestination.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_JobDestinationJobs associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_JobDestinationJobs(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_JobDestinationJobsHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_JobDestinationJobs(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_JobDestinationJobs
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_JobDestinationJobs(WBEMClient cimClient,
            String role, boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_JobDestinationJobs.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
