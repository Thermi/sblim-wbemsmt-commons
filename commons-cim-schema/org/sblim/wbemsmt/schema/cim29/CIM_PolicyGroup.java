 ...
 *
 *
 * Description: An aggregation of PolicySet instances (PolicyGroups and/or PolicyRules) that have the same decision strategy and inherit policy roles. PolicyGroup instances are defined and named relative to the CIM_System that provides their context.
 * 
 */
...
public class CIM_PolicyGroup extends CIM_PolicySet  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_IPSECPOLICYFORENDPOINT = "CIM_IPsecPolicyForEndpoint";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_IPSECPOLICYFORSYSTEM = "CIM_IPsecPolicyForSystem";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_POLICYGROUPINPOLICYGROUP = "CIM_PolicyGroupInPolicyGroup";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_POLICYGROUPINSYSTEM = "CIM_PolicyGroupInSystem";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_POLICYRULEINPOLICYGROUP = "CIM_PolicyRuleInPolicyGroup";
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_PolicySet.Java_Package_List.size(); i++) {
			if (((String)CIM_PolicySet.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim29")){
				continue;
			}
