 ...
 * 
 * Description: Helper class for CIM_HostedFileSystem
 *    
 * 
 * generated Class
 * @see CIM_HostedFileSystem
 */
...
public class CIM_HostedFileSystemHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostedFileSystem or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedFileSystem.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostedFileSystem or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_HostedFileSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostedFileSystem(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostedFileSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HostedFileSystem.");
                        resultArrayList.add(new CIM_HostedFileSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedFileSystem.");
                        resultArrayList.add(new CIM_HostedFileSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedFileSystem.");
                        resultArrayList.add(new CIM_HostedFileSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedFileSystem getInstance(WBEMClient client,
     ...
     */
    public final static CIM_HostedFileSystem getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostedFileSystem) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostedFileSystem(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostedFileSystem getInstance(WBEMClient client, String namespace,
            CIM_System GroupComponent, CIM_FileSystem PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedFileSystem.PROPERTY_GROUPCOMPONENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedFileSystem.PROPERTY_PARTCOMPONENT_CIM_FILESYSTEM.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_HostedFileSystem createInstance(WBEMClient client,
            CIM_HostedFileSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedFileSystem newDataInstance = CIM_HostedFileSystemHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedFileSystem modifyInstance(WBEMClient client,
            CIM_HostedFileSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedFileSystem dataInstance2 = CIM_HostedFileSystemHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedFileSystem dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedFileSystem.getPackages());
    }
