...
public class CIM_ComputerSystem extends CIM_System {
    ...
    public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS = "CIM_ComponentCS";
    ...
    public static class METHOD_SETPOWERSTATE {
        ...
        public static class PARAMETER_POWERSTATE {
             ...
             */
            //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@68726872
    ...
    public static class PROPERTY_DEDICATED {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@81e081e
    ...
    public static class PROPERTY_POWERMANAGEMENTCAPABILITIES {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@1a741a74
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public static class PROPERTY_RESETCAPABILITY {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@50185018
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public boolean set_Dedicated(javax.cim.UnsignedInteger16[] newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dedicated(currentProperty, newValue);
    ...
    public boolean set_IdentifyingDescriptions(String[] newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_IDENTIFYINGDESCRIPTIONS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_IdentifyingDescriptions(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_OtherDedicatedDescriptions(String[] newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_OTHERDEDICATEDDESCRIPTIONS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_OtherDedicatedDescriptions(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_PowerManagementCapabilities(javax.cim.UnsignedInteger16[] newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_POWERMANAGEMENTCAPABILITIES.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_PowerManagementCapabilities(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public boolean set_ResetCapability(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_RESETCAPABILITY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ResetCapability(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    /**
     * Get the list with CIM_BIOSElement objects associated by the association CIM_SystemBIOS
     * 
    ...
    public java.util.List getAssociated_CIM_BIOSElement_CIM_SystemBIOSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_BIOSElement_CIM_SystemBIOSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMBIOS, CIM_BIOSElement.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_BIOSElement_CIM_SystemBIOSNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_BIOSElement_CIM_SystemBIOSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMBIOS, CIM_BIOSElement.CIM_CLASS_NAME, null,
                null);
    }
    ...
    /**
     * Get the list with CIM_BootSAP objects associated by the association CIM_HostedBootSAP
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_BootSAP_CIM_HostedBootSAPs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_BootSAP_CIM_HostedBootSAPs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP, CIM_BootSAP.CIM_CLASS_NAME, null,
                null, false, false, null);
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_BootSAP_CIM_HostedBootSAPs(WBEMClient cimClient,
        ...
        return getAssociated_CIM_BootSAP_CIM_HostedBootSAPs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP, resultClass, role, resultRole, false,
                false, null);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_HostedBootSAP
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_BootSAP_CIM_HostedBootSAPNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_BootSAP_CIM_HostedBootSAPNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP, CIM_BootSAP.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_BootSAP_CIM_HostedBootSAPNames(WBEMClient cimClient,
        ...
        return getAssociated_CIM_BootSAP_CIM_HostedBootSAPNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP, resultClass, role, resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_BootSAP_CIM_HostedBootSAPNames(WBEMClient cimClient,
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP,
    ...
    /**
     * Get the list with CIM_HostedBootSAP associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_HostedBootSAP(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_HostedBootSAPHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_HostedBootSAP(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_HostedBootSAP
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_HostedBootSAP(WBEMClient cimClient, String role,
            boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBOOTSAP, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_HostedBootSAP.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_OperatingSystem objects associated by the association CIM_InstalledOS
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_OperatingSystem_CIM_InstalledOSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_OperatingSystem_CIM_InstalledOSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, CIM_OperatingSystem.CIM_CLASS_NAME,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_OperatingSystem_CIM_InstalledOSs(WBEMClient cimClient,
        ...
        return getAssociated_CIM_OperatingSystem_CIM_InstalledOSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, resultClass, role, resultRole, false,
                false, null);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_InstalledOS
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_OperatingSystem_CIM_InstalledOSNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_OperatingSystem_CIM_InstalledOSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, CIM_OperatingSystem.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_OperatingSystem_CIM_InstalledOSNames(
        ...
        return getAssociated_CIM_OperatingSystem_CIM_InstalledOSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, resultClass, role, resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_OperatingSystem_CIM_InstalledOSNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS,
    ...
    /**
     * Get the list with CIM_InstalledOS associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_InstalledOS(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_InstalledOSHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_InstalledOS(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_InstalledOS
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_InstalledOS(WBEMClient cimClient, String role,
            boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_InstalledOS.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_ComputerSystem objects associated by the association CIM_ComponentCS
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_ComponentCSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_ComponentCSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
                null, false, false, null);
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_ComponentCSs(WBEMClient cimClient,
        ...
        return getAssociated_CIM_ComputerSystem_CIM_ComponentCSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS, resultClass, role, resultRole, false,
                false, null);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_ComponentCS
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_ComponentCSNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_ComponentCSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_ComponentCSNames(
            WBEMClient cimClient, String resultClass, String role, String resultRole)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_ComponentCSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS, resultClass, role, resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_ComponentCSNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS,
    ...
    /**
     * Get the list with CIM_ComponentCS associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_ComponentCS(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_ComponentCSHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_ComponentCS(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_ComponentCS
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_ComponentCS(WBEMClient cimClient, String role,
            boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPONENTCS, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_ComponentCS.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_UnitaryComputerSystem objects associated by the association CIM_SystemPartition
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_UnitaryComputerSystem_CIM_SystemPartitions(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_UnitaryComputerSystem_CIM_SystemPartitions(cimClient,
    ...
    public java.util.List getAssociated_CIM_UnitaryComputerSystem_CIM_SystemPartitionNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_UnitaryComputerSystem_CIM_SystemPartitionNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMPARTITION,
    ...
    /**
     * Get the list with CIM_VirtualComputerSystem objects associated by the association CIM_HostingCS
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSs(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, CIM_VirtualComputerSystem.CIM_CLASS_NAME,
                null, null, false, false, null);
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSs(
        ...
        return getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, resultClass, role, resultRole, false,
                false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_HostingCS
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, CIM_VirtualComputerSystem.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSNames(
        ...
        return getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, resultClass, role, resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_VirtualComputerSystem_CIM_HostingCSNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS,
                    CIM_VirtualComputerSystem.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_HostingCS associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_HostingCS(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_HostingCSHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_HostingCS(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_HostingCS
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_HostingCS(WBEMClient cimClient, String role,
            boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, role));
        }
    ...
    /**
     * Get the list with CIM_Cluster objects associated by the association CIM_ParticipatingCS
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_Cluster_CIM_ParticipatingCSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Cluster_CIM_ParticipatingCSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PARTICIPATINGCS, CIM_Cluster.CIM_CLASS_NAME, null,
                null, false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_Cluster(cimInstance));
                        continue;
                    }
    ...
    public java.util.List getAssociated_CIM_Cluster_CIM_ParticipatingCSNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Cluster_CIM_ParticipatingCSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PARTICIPATINGCS, CIM_Cluster.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_Cluster_CIM_ParticipatingCSNames(WBEMClient cimClient,
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    ...
                    CIM_Cluster.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_ClusteringSAP objects associated by the association CIM_HostedClusterSAP
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_ClusteringSAP_CIM_HostedClusterSAPs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ClusteringSAP_CIM_HostedClusterSAPs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDCLUSTERSAP, CIM_ClusteringSAP.CIM_CLASS_NAME,
                null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_ClusteringSAP_CIM_HostedClusterSAPs(
            WBEMClient cimClient, String resultClass, String role, String resultRole)
            throws WbemsmtException {
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_ClusteringSAP(cimInstance));
                        continue;
                    }
    ...
    public java.util.List getAssociated_CIM_ClusteringSAP_CIM_HostedClusterSAPNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ClusteringSAP_CIM_HostedClusterSAPNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDCLUSTERSAP, CIM_ClusteringSAP.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_ClusteringSAP_CIM_HostedClusterSAPNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    ...
                    CIM_ClusteringSAP.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_PhysicalPackage objects associated by the association CIM_ComputerSystemPackage
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_PhysicalPackage_CIM_ComputerSystemPackages(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalPackage_CIM_ComputerSystemPackages(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPUTERSYSTEMPACKAGE,
                CIM_PhysicalPackage.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_PhysicalPackage_CIM_ComputerSystemPackageNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalPackage_CIM_ComputerSystemPackageNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPUTERSYSTEMPACKAGE,
