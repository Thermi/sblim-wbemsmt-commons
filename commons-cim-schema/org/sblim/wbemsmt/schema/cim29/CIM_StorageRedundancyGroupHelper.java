 ...
 * 
 * Description: Helper class for CIM_StorageRedundancyGroup
 *    
 * 
 * generated Class
 * @see CIM_StorageRedundancyGroup
 */
...
public class CIM_StorageRedundancyGroupHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_StorageRedundancyGroup or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_StorageRedundancyGroup.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_StorageRedundancyGroup.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_StorageRedundancyGroup or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_StorageRedundancyGroup(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_StorageRedundancyGroupHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_StorageRedundancyGroup.");
                        resultArrayList.add(new CIM_StorageRedundancyGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_StorageRedundancyGroup.");
                        resultArrayList.add(new CIM_StorageRedundancyGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_StorageRedundancyGroup.");
                        resultArrayList.add(new CIM_StorageRedundancyGroup(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_StorageRedundancyGroup getInstance(WBEMClient client,
    ...
    public final static CIM_StorageRedundancyGroup getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_StorageRedundancyGroup) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_StorageRedundancyGroup(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_StorageRedundancyGroup getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_StorageRedundancyGroup.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_StorageRedundancyGroup.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_StorageRedundancyGroup.PROPERTY_NAME.NAME,
     ...
     *
     */
    public final static CIM_StorageRedundancyGroup createInstance(WBEMClient client,
            CIM_StorageRedundancyGroup dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_StorageRedundancyGroup newDataInstance = CIM_StorageRedundancyGroupHelper.getInstance(
     ...
     */
    public final static CIM_StorageRedundancyGroup modifyInstance(WBEMClient client,
            CIM_StorageRedundancyGroup dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_StorageRedundancyGroup dataInstance2 = CIM_StorageRedundancyGroupHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_StorageRedundancyGroup dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_StorageRedundancyGroup.getPackages());
    }
