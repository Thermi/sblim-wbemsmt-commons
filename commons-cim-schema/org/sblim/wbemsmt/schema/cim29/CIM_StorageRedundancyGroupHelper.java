/** 
 * CIM_StorageRedundancyGroupHelper.java
 *
...
public final class CIM_StorageRedundancyGroupHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StorageRedundancyGroup.");
						resultArrayList.add(new CIM_StorageRedundancyGroup(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StorageRedundancyGroup.");
						resultArrayList.add(new CIM_StorageRedundancyGroup(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StorageRedundancyGroup.");
						resultArrayList.add(new CIM_StorageRedundancyGroup(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StorageRedundancyGroup getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StorageRedundancyGroupHelper.getInstance(cimClient, new CIM_StorageRedundancyGroup(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageRedundancyGroup getInstance(CIMClient cimClient, CIM_StorageRedundancyGroup dataInstance) {
		...
		return CIM_StorageRedundancyGroupHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageRedundancyGroup getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StorageRedundancyGroup dataInstance = null;
		try {
			dataInstance = new CIM_StorageRedundancyGroup(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_StorageRedundancyGroup.getPackages();
	...
	*/	
	public final static CIM_StorageRedundancyGroup createInstance(CIMClient cimClient, CIM_StorageRedundancyGroup dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StorageRedundancyGroup newDataInstance = null;
		try {
			newDataInstance = CIM_StorageRedundancyGroupHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StorageRedundancyGroup modifyInstance(CIMClient cimClient, CIM_StorageRedundancyGroup dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StorageRedundancyGroupHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StorageRedundancyGroup dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StorageRedundancyGroup dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StorageRedundancyGroup.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StorageRedundancyGroup.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StorageRedundancyGroup.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StorageRedundancyGroup.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StorageRedundancyGroup.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_IsConcatenated(Boolean IsConcatenated) {
		return true;
	}

	public static boolean isValid_IsStriped(Boolean IsStriped) {
		return true;
	}

	public static boolean isValid_StorageRedundancy(UnsignedInt16 StorageRedundancy) {
		return true;
	}
