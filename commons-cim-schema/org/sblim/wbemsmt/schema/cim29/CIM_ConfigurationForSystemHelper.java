 ...
 * 
 * Description: Helper class for CIM_ConfigurationForSystem
 *    
 * 
 * generated Class
 * @see CIM_ConfigurationForSystem
 */
...
public class CIM_ConfigurationForSystemHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ConfigurationForSystem or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ConfigurationForSystem.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ConfigurationForSystem.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ConfigurationForSystem or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ConfigurationForSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ConfigurationForSystem(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ConfigurationForSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ConfigurationForSystem.");
                        resultArrayList.add(new CIM_ConfigurationForSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ConfigurationForSystem.");
                        resultArrayList.add(new CIM_ConfigurationForSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ConfigurationForSystem.");
                        resultArrayList.add(new CIM_ConfigurationForSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ConfigurationForSystem getInstance(WBEMClient client,
    ...
    public final static CIM_ConfigurationForSystem getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ConfigurationForSystem) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ConfigurationForSystem(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ConfigurationForSystem getInstance(WBEMClient client, String namespace,
            CIM_System Antecedent, CIM_SystemConfiguration Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ConfigurationForSystem.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ConfigurationForSystem.PROPERTY_DEPENDENT_CIM_SYSTEMCONFIGURATION.NAME,
     ...
     *
     */
    public final static CIM_ConfigurationForSystem createInstance(WBEMClient client,
            CIM_ConfigurationForSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ConfigurationForSystem newDataInstance = CIM_ConfigurationForSystemHelper.getInstance(
     ...
     */
    public final static CIM_ConfigurationForSystem modifyInstance(WBEMClient client,
            CIM_ConfigurationForSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ConfigurationForSystem dataInstance2 = CIM_ConfigurationForSystemHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ConfigurationForSystem dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ConfigurationForSystem.getPackages());
    }
