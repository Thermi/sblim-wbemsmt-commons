...
public class CIM_ConcreteIdentity extends CIM_LogicalIdentity {
    ...
    public CIM_ConcreteIdentity(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ConcreteIdentity(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ConcreteIdentity() {
    }
    ...
    public static CIMProperty create_SystemElement_CIM_ManagedElement(WBEMClient client,
        ...
        CIM_ConcreteIdentity fco = new CIM_ConcreteIdentity(client, namespace);
    ...
    public boolean set_SameElement_CIM_ManagedElement(CIM_ManagedElement newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SAMEELEMENT_CIM_MANAGEDELEMENT.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_SameElement_CIM_ManagedElement(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public String getObjectName() {
        return CIM_ConcreteIdentity.CIM_CLASS_NAME;
    }
