/** 
 * CIM_BGPProtocolEndpointHelper.java
 *
...
public final class CIM_BGPProtocolEndpointHelper {

	public final static String CIM_CLASS_NAME = "CIM_BGPProtocolEndpoint";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_BGPProtocolEndpoint.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BGPProtocolEndpoint.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_BGPProtocolEndpoint.Java_Package_List.get(i))).endsWith(".")) {
							CIM_BGPProtocolEndpoint.Java_Package_List.setElementAt((String)(CIM_BGPProtocolEndpoint.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BGPProtocolEndpoint.");
						resultArrayList.add(new CIM_BGPProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BGPProtocolEndpoint.");
						resultArrayList.add(new CIM_BGPProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BGPProtocolEndpoint.");
						resultArrayList.add(new CIM_BGPProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BGPProtocolEndpoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BGPProtocolEndpointHelper.getInstance(cimClient, new CIM_BGPProtocolEndpoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPProtocolEndpoint getInstance(CIMClient cimClient, CIM_BGPProtocolEndpoint dataInstance) {
		...
		return CIM_BGPProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPProtocolEndpoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BGPProtocolEndpoint dataInstance = null;
		try {
			dataInstance = new CIM_BGPProtocolEndpoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPProtocolEndpoint createInstance(CIMClient cimClient, CIM_BGPProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BGPProtocolEndpoint newDataInstance = null;
		try {
			newDataInstance = CIM_BGPProtocolEndpointHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPProtocolEndpoint modifyInstance(CIMClient cimClient, CIM_BGPProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BGPProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BGPProtocolEndpoint dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BGPProtocolEndpoint dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BGPProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BGPProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BGPProtocolEndpoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BGPProtocolEndpoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BGPProtocolEndpoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AdminStatus(UnsignedInt16 AdminStatus) {
		return true;
	}

	public static boolean isValid_ConnectRetryInterval(UnsignedInt32 ConnectRetryInterval) {
		return true;
	}

	public static boolean isValid_HoldTime(UnsignedInt16 HoldTime) {
		return true;
	}

	public static boolean isValid_HoldTimeConfigured(UnsignedInt16 HoldTimeConfigured) {
		return true;
	}

	public static boolean isValid_IsEBGP(Boolean IsEBGP) {
		return true;
	}

	public static boolean isValid_IsEBGPMultihop(Boolean IsEBGPMultihop) {
		return true;
	}

	public static boolean isValid_KeepAlive(UnsignedInt16 KeepAlive) {
		return true;
	}

	public static boolean isValid_KeepAliveConfigured(UnsignedInt16 KeepAliveConfigured) {
		return true;
	}

	public static boolean isValid_LocalAddress(String LocalAddress) {
		return true;
	}

	public static boolean isValid_LocalIdentifier(String LocalIdentifier) {
		return true;
	}

	public static boolean isValid_LocalPort(UnsignedInt16 LocalPort) {
		return true;
	}

	public static boolean isValid_MinASOriginationInterval(UnsignedInt16 MinASOriginationInterval) {
		return true;
	}

	public static boolean isValid_MinRouteAdvertisementInterval(UnsignedInt16 MinRouteAdvertisementInterval) {
		return true;
	}

	public static boolean isValid_NegotiatedVersion(String NegotiatedVersion) {
		return true;
	}

	public static boolean isValid_PeerIdentifier(String PeerIdentifier) {
		return true;
	}

	public static boolean isValid_ProtocolIFType(UnsignedInt16 ProtocolIFType) {
		return true;
	}

	public static boolean isValid_RemoteAS(UnsignedInt16 RemoteAS) {
		return true;
	}

	public static boolean isValid_RemoteAddress(String RemoteAddress) {
		return true;
	}

	public static boolean isValid_RemotePort(UnsignedInt16 RemotePort) {
		return true;
	}

	public static boolean isValid_State(UnsignedInt16 State) {
		return true;
	}
