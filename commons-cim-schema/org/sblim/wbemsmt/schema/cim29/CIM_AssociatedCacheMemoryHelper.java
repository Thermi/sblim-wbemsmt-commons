 ...
 * 
 * Description: Helper class for CIM_AssociatedCacheMemory
 *    
 * 
 * generated Class
 * @see CIM_AssociatedCacheMemory
 */
...
public class CIM_AssociatedCacheMemoryHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_AssociatedCacheMemory or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AssociatedCacheMemory.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AssociatedCacheMemory.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_AssociatedCacheMemory or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_AssociatedCacheMemory.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_AssociatedCacheMemoryHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AssociatedCacheMemory.");
                        resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AssociatedCacheMemory.");
                        resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AssociatedCacheMemory.");
                        resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AssociatedCacheMemory getInstance(WBEMClient client,
    ...
    public final static CIM_AssociatedCacheMemory getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_AssociatedCacheMemory) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_AssociatedCacheMemory(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_AssociatedCacheMemory createInstance(WBEMClient client,
            CIM_AssociatedCacheMemory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_AssociatedCacheMemory newDataInstance = CIM_AssociatedCacheMemoryHelper.getInstance(
     ...
     */
    public final static CIM_AssociatedCacheMemory modifyInstance(WBEMClient client,
            CIM_AssociatedCacheMemory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AssociatedCacheMemory dataInstance2 = CIM_AssociatedCacheMemoryHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_AssociatedCacheMemory dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AssociatedCacheMemory.getPackages());
    }
