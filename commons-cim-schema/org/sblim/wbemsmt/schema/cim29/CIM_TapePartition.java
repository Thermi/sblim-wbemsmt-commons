...
public class CIM_TapePartition extends CIM_MediaPartition {
    ...
    /**
     * Constants of property UnusedBlocks
     ...
     */
    public static class PROPERTY_UNUSEDBLOCKS {
        /**
         * name of the property UnusedBlocks
         */
        public final static String NAME = "UnusedBlocks";
    ...
    public CIM_TapePartition(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_TapePartition(CIMInstance cimInstance) throws WbemsmtException {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("UnusedBlocks", new CIMProperty("UnusedBlocks", CIMDataType.UINT64_T,
                null));
    ...
    /**
     * Get the property UnusedBlocks
     *     * <br>
     * Number of blocks that are currently unused/not written on the Partition. When this number is multiplied by the BlockSize, inherited from StorageExtent, the total number of bytes available for writing can be computed.
     *     */

    public javax.cim.UnsignedInteger64 get_UnusedBlocks() {
        CIMProperty currentProperty = getProperty(PROPERTY_UNUSEDBLOCKS.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_UNUSEDBLOCKS.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_UnusedBlocks(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_UNUSEDBLOCKS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_UnusedBlocks(currentProperty, newValue);
    ...
    /**
     * Get the property UnusedBlocks by getting the class from the server<br>
    ...
    public static CIMProperty create_UnusedBlocks(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_TapePartition fco = new CIM_TapePartition(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_UNUSEDBLOCKS.NAME);
        if (property != null) {
            property = setPropertyValue_UnusedBlocks(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_UNUSEDBLOCKS.NAME + " was not found in instance "
    ...
    private static CIMProperty setPropertyValue_UnusedBlocks(CIMProperty currentProperty,
    ...
    /**
     * Get the list with CIM_StorageExtent objects associated by the association CIM_TapePartitionOnSurface
     * 
    ...
    public java.util.List getAssociated_CIM_StorageExtent_CIM_TapePartitionOnSurfaces(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_StorageExtent_CIM_TapePartitionOnSurfaces(cimClient,
    ...
    public java.util.List getAssociated_CIM_StorageExtent_CIM_TapePartitionOnSurfaces(
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_TapePartitionHelper.checkException(enumeration);
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_TapePartitionHelper.findClass(cimClient, cimInstance);
    ...
    public java.util.List getAssociated_CIM_StorageExtent_CIM_TapePartitionOnSurfaceNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_StorageExtent_CIM_TapePartitionOnSurfaceNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_TAPEPARTITIONONSURFACE,
    ...
    /**
     * Get the list with CIM_PhysicalTape objects associated by the association CIM_RealizesTapePartition
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_PhysicalTape_CIM_RealizesTapePartitions(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalTape_CIM_RealizesTapePartitions(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REALIZESTAPEPARTITION,
                CIM_PhysicalTape.CIM_CLASS_NAME, null, null, false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_PhysicalTape(cimInstance));
                        continue;
                    }
    ...
    public java.util.List getAssociated_CIM_PhysicalTape_CIM_RealizesTapePartitionNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalTape_CIM_RealizesTapePartitionNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REALIZESTAPEPARTITION,
                CIM_PhysicalTape.CIM_CLASS_NAME, null, null);
    }
    ...
    public String getObjectName() {
        return CIM_TapePartition.CIM_CLASS_NAME;
    }
