 ...
 * 
 * Description: Helper class for CIM_MediaAccessStatInfo
 *    
 * 
 * generated Class
 * @see CIM_MediaAccessStatInfo
 */
...
public class CIM_MediaAccessStatInfoHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MediaAccessStatInfo or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MediaAccessStatInfo.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_MediaAccessStatInfo.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MediaAccessStatInfo or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_MediaAccessStatInfo.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MediaAccessStatInfo(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MediaAccessStatInfoHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MediaAccessStatInfo.");
                        resultArrayList.add(new CIM_MediaAccessStatInfo(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MediaAccessStatInfo.");
                        resultArrayList.add(new CIM_MediaAccessStatInfo(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MediaAccessStatInfo.");
                        resultArrayList.add(new CIM_MediaAccessStatInfo(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MediaAccessStatInfo getInstance(WBEMClient client,
    ...
    public final static CIM_MediaAccessStatInfo getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MediaAccessStatInfo) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MediaAccessStatInfo(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_MediaAccessStatInfo getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_MediaAccessStatInfo.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessStatInfo.CIM_CLASS_NAME);

        setThis = DeviceCreationClassName;

        keyProperties[1] = new CIMProperty(
                CIM_MediaAccessStatInfo.PROPERTY_DEVICECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessStatInfo.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[2] = new CIMProperty(CIM_MediaAccessStatInfo.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessStatInfo.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_MediaAccessStatInfo.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessStatInfo.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[4] = new CIMProperty(
                CIM_MediaAccessStatInfo.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessStatInfo.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[5] = new CIMProperty(CIM_MediaAccessStatInfo.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessStatInfo.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MediaAccessStatInfo createInstance(WBEMClient client,
            CIM_MediaAccessStatInfo dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_MediaAccessStatInfo newDataInstance = CIM_MediaAccessStatInfoHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_MediaAccessStatInfo modifyInstance(WBEMClient client,
            CIM_MediaAccessStatInfo dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MediaAccessStatInfo dataInstance2 = CIM_MediaAccessStatInfoHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MediaAccessStatInfo dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MediaAccessStatInfo.getPackages());
    }
