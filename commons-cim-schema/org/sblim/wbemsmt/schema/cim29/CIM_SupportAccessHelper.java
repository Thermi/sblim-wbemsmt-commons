 ...
 * 
 * Description: Helper class for CIM_SupportAccess
 *    
 * 
 * generated Class
 * @see CIM_SupportAccess
 */
...
public class CIM_SupportAccessHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SupportAccess or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SupportAccess.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_SupportAccess.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SupportAccess or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_SupportAccess.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SupportAccess(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SupportAccessHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SupportAccess.");
                        resultArrayList.add(new CIM_SupportAccess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SupportAccess.");
                        resultArrayList.add(new CIM_SupportAccess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SupportAccess.");
                        resultArrayList.add(new CIM_SupportAccess(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SupportAccess getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_SupportAccess getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SupportAccess) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SupportAccess(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SupportAccess getInstance(WBEMClient client, String namespace,
        ...
        setThis = SupportAccessId;

        keyProperties[0] = new CIMProperty(CIM_SupportAccess.PROPERTY_SUPPORTACCESSID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SupportAccess.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SupportAccess createInstance(WBEMClient client,
            CIM_SupportAccess dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SupportAccess newDataInstance = CIM_SupportAccessHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SupportAccess modifyInstance(WBEMClient client,
            CIM_SupportAccess dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SupportAccess dataInstance2 = CIM_SupportAccessHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SupportAccess dataInstance)
            throws WbemsmtException {
