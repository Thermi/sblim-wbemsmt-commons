...
public class CIM_SoftwareFeatureServiceImplementation extends CIM_Dependency {
    ...
    public CIM_SoftwareFeatureServiceImplementation(WBEMClient client, String namespace)
    ...
    public CIM_SoftwareFeatureServiceImplementation(CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SoftwareFeatureServiceImplementation() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_SoftwareFeature(WBEMClient client,
        ...
        CIM_SoftwareFeatureServiceImplementation fco = new CIM_SoftwareFeatureServiceImplementation(
                client, namespace);
    ...
    public String getObjectName() {
        return CIM_SoftwareFeatureServiceImplementation.CIM_CLASS_NAME;
    }
