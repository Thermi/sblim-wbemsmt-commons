...
public final class CIM_NextHopRouteHelper {

	public final static String CIM_CLASS_NAME = "CIM_NextHopRoute";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_NextHopRoute.Java_Package_List.size(); i++) {
						if (!((String)(CIM_NextHopRoute.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_NextHopRoute.Java_Package_List.get(i))).endsWith(".")) {
							CIM_NextHopRoute.Java_Package_List.setElementAt((String)(CIM_NextHopRoute.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_NextHopRoute.");
						resultArrayList.add(new CIM_NextHopRoute(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_NextHopRoute.");
						resultArrayList.add(new CIM_NextHopRoute(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_NextHopRoute.");
						resultArrayList.add(new CIM_NextHopRoute(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_NextHopRoute getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_NextHopRouteHelper.getInstance(cimClient, new CIM_NextHopRoute(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_NextHopRoute getInstance(CIMClient cimClient, CIM_NextHopRoute dataInstance) {
		...
		return CIM_NextHopRouteHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_NextHopRoute getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_NextHopRoute dataInstance = null;
		try {
			dataInstance = new CIM_NextHopRoute(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_NextHopRoute createInstance(CIMClient cimClient, CIM_NextHopRoute dataInstance, boolean notifyDifferencies){ 
		...
		CIM_NextHopRoute newDataInstance = null;
		try {
			newDataInstance = CIM_NextHopRouteHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_NextHopRoute modifyInstance(CIMClient cimClient, CIM_NextHopRoute dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_NextHopRouteHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_NextHopRoute dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_NextHopRoute dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_NextHopRoute.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_NextHopRoute.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_NextHopRoute.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_NextHopRoute.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_NextHopRoute.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_RouteMetric(UnsignedInt16 RouteMetric) {
		return true;
	}

	public static boolean isValid_TypeOfRoute(UnsignedInt16 TypeOfRoute) {
		return true;
	}
