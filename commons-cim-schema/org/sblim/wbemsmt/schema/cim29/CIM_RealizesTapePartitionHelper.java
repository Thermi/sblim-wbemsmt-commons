 ...
 * 
 * Description: Helper class for CIM_RealizesTapePartition
 *    
 * 
 * generated Class
 * @see CIM_RealizesTapePartition
 */
...
public class CIM_RealizesTapePartitionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RealizesTapePartition or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RealizesTapePartition.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RealizesTapePartition.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RealizesTapePartition or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_RealizesTapePartition(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RealizesTapePartitionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RealizesTapePartition.");
                        resultArrayList.add(new CIM_RealizesTapePartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RealizesTapePartition.");
                        resultArrayList.add(new CIM_RealizesTapePartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RealizesTapePartition.");
                        resultArrayList.add(new CIM_RealizesTapePartition(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RealizesTapePartition getInstance(WBEMClient client,
    ...
    public final static CIM_RealizesTapePartition getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RealizesTapePartition) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RealizesTapePartition(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RealizesTapePartition getInstance(WBEMClient client, String namespace,
            CIM_PhysicalTape Antecedent, CIM_TapePartition Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RealizesTapePartition.PROPERTY_ANTECEDENT_CIM_PHYSICALTAPE.NAME,
                new CIMDataType(CIM_PhysicalTape.CIM_CLASS_NAME), setThis, false, false,
                CIM_RealizesTapePartition.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_RealizesTapePartition.PROPERTY_DEPENDENT_CIM_TAPEPARTITION.NAME,
     ...
     *
     */
    public final static CIM_RealizesTapePartition createInstance(WBEMClient client,
            CIM_RealizesTapePartition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_RealizesTapePartition newDataInstance = CIM_RealizesTapePartitionHelper.getInstance(
     ...
     */
    public final static CIM_RealizesTapePartition modifyInstance(WBEMClient client,
            CIM_RealizesTapePartition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RealizesTapePartition dataInstance2 = CIM_RealizesTapePartitionHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_RealizesTapePartition dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RealizesTapePartition.getPackages());
    }
