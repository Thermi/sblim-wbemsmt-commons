 ...
 * 
 * Description: Helper class for CIM_ComponentCS
 *    
 * 
 * generated Class
 * @see CIM_ComponentCS
...
public class CIM_ComponentCSHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ComponentCS or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ComponentCS.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ComponentCS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ComponentCS or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ComponentCS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ComponentCS(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ComponentCSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ComponentCS.");
                        resultArrayList.add(new CIM_ComponentCS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ComponentCS.");
                        resultArrayList.add(new CIM_ComponentCS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ComponentCS.");
                        resultArrayList.add(new CIM_ComponentCS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ComponentCS getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ComponentCS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ComponentCS) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ComponentCS(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ComponentCS getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem GroupComponent, CIM_ComputerSystem PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ComponentCS.PROPERTY_GROUPCOMPONENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ComponentCS.PROPERTY_PARTCOMPONENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
                        CIM_ComputerSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_ComponentCS.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ComponentCS createInstance(WBEMClient client,
            CIM_ComponentCS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ComponentCS newDataInstance = CIM_ComponentCSHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_ComponentCS modifyInstance(WBEMClient client,
            CIM_ComponentCS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ComponentCS dataInstance2 = CIM_ComponentCSHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ComponentCS dataInstance)
            throws WbemsmtException {
