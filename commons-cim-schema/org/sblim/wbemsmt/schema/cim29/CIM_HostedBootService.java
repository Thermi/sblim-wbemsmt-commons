...
public class CIM_HostedBootService extends CIM_HostedService {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_BOOTSERVICE {
        /**
    ...
    public CIM_HostedBootService(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HostedBootService(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_HostedBootService() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_System(WBEMClient client, String namespace,
        ...
        CIM_HostedBootService fco = new CIM_HostedBootService(client, namespace);
    ...
    public CIM_BootService get_Dependent_CIM_BootService(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_BOOTSERVICE.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_BOOTSERVICE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Dependent_CIM_BootService(CIM_BootService newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_BOOTSERVICE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_BootService(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_Dependent_CIM_BootService(WBEMClient client, String namespace,
            CIM_BootService newValue) throws WbemsmtException {
        CIM_HostedBootService fco = new CIM_HostedBootService(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_BOOTSERVICE.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_BootService(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_BOOTSERVICE.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_BootService(
    ...
    public String getObjectName() {
        return CIM_HostedBootService.CIM_CLASS_NAME;
    }
