/** 
 * CIM_SecurityAssociationEndpointHelper.java
 *
...
public final class CIM_SecurityAssociationEndpointHelper {

	public final static String CIM_CLASS_NAME = "CIM_SecurityAssociationEndpoint";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_SecurityAssociationEndpoint.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SecurityAssociationEndpoint.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_SecurityAssociationEndpoint.Java_Package_List.get(i))).endsWith(".")) {
							CIM_SecurityAssociationEndpoint.Java_Package_List.setElementAt((String)(CIM_SecurityAssociationEndpoint.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SecurityAssociationEndpoint.");
						resultArrayList.add(new CIM_SecurityAssociationEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SecurityAssociationEndpoint.");
						resultArrayList.add(new CIM_SecurityAssociationEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SecurityAssociationEndpoint.");
						resultArrayList.add(new CIM_SecurityAssociationEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SecurityAssociationEndpoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SecurityAssociationEndpointHelper.getInstance(cimClient, new CIM_SecurityAssociationEndpoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SecurityAssociationEndpoint getInstance(CIMClient cimClient, CIM_SecurityAssociationEndpoint dataInstance) {
		...
		return CIM_SecurityAssociationEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SecurityAssociationEndpoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SecurityAssociationEndpoint dataInstance = null;
		try {
			dataInstance = new CIM_SecurityAssociationEndpoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SecurityAssociationEndpoint createInstance(CIMClient cimClient, CIM_SecurityAssociationEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SecurityAssociationEndpoint newDataInstance = null;
		try {
			newDataInstance = CIM_SecurityAssociationEndpointHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SecurityAssociationEndpoint modifyInstance(CIMClient cimClient, CIM_SecurityAssociationEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SecurityAssociationEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SecurityAssociationEndpoint dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SecurityAssociationEndpoint dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SecurityAssociationEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SecurityAssociationEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SecurityAssociationEndpoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SecurityAssociationEndpoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SecurityAssociationEndpoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_IdleDurationSeconds(UnsignedInt64 IdleDurationSeconds) {
		return true;
	}

	public static boolean isValid_InstallDate(Calendar InstallDate) {
		return true;
	}

	public static boolean isValid_LifetimeKilobytes(UnsignedInt64 LifetimeKilobytes) {
		return true;
	}

	public static boolean isValid_LifetimeSeconds(UnsignedInt64 LifetimeSeconds) {
		return true;
	}

	public static boolean isValid_PacketLoggingActive(Boolean PacketLoggingActive) {
		return true;
	}

	public static boolean isValid_RefreshThresholdKbytesPercentage(UnsignedInt8 RefreshThresholdKbytesPercentage) {
		return true;
	}

	public static boolean isValid_RefreshThresholdSecondsPercentage(UnsignedInt8 RefreshThresholdSecondsPercentage) {
		return true;
	}
