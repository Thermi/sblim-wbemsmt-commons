...
public class CIM_ProductComponent extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_PARTCOMPONENT_CIM_PRODUCT {
        /**
    ...
    public CIM_ProductComponent(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ProductComponent(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ProductComponent() {
    }
    ...
    public static CIMProperty create_GroupComponent_CIM_Product(WBEMClient client,
        ...
        CIM_ProductComponent fco = new CIM_ProductComponent(client, namespace);
    ...
    public CIM_Product get_PartComponent_CIM_Product(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_CIM_PRODUCT.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_CIM_PRODUCT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_PartComponent_CIM_Product(CIM_Product newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_CIM_PRODUCT.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_PartComponent_CIM_Product(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_PartComponent_CIM_Product(WBEMClient client, String namespace,
            CIM_Product newValue) throws WbemsmtException {
        CIM_ProductComponent fco = new CIM_ProductComponent(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_PARTCOMPONENT_CIM_PRODUCT.NAME);
        if (property != null) {
            property = setPropertyValue_PartComponent_CIM_Product(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_CIM_PRODUCT.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_PartComponent_CIM_Product(
            CIMProperty currentProperty, CIM_Product newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return CIM_ProductComponent.CIM_CLASS_NAME;
    }
