 ...
 * 
 * Description: Helper class for CIM_ClassDeletion
 *    
 * 
 * generated Class
 * @see CIM_ClassDeletion
 */
...
public class CIM_ClassDeletionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ClassDeletion or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ClassDeletion.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ClassDeletion.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ClassDeletion or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ClassDeletion.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ClassDeletion(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ClassDeletionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ClassDeletion.");
                        resultArrayList.add(new CIM_ClassDeletion(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ClassDeletion.");
                        resultArrayList.add(new CIM_ClassDeletion(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ClassDeletion.");
                        resultArrayList.add(new CIM_ClassDeletion(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ClassDeletion getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ClassDeletion getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ClassDeletion) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ClassDeletion(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_ClassDeletion createInstance(WBEMClient client,
            CIM_ClassDeletion dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ClassDeletion newDataInstance = CIM_ClassDeletionHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ClassDeletion modifyInstance(WBEMClient client,
            CIM_ClassDeletion dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ClassDeletion dataInstance2 = CIM_ClassDeletionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ClassDeletion dataInstance)
            throws WbemsmtException {
