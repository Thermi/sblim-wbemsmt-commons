 ...
 * 
 * Description: Helper class for CIM_OwningJobElement
 *    
 * 
 * generated Class
 * @see CIM_OwningJobElement
 */
...
public class CIM_OwningJobElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_OwningJobElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_OwningJobElement.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_OwningJobElement or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_OwningJobElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_OwningJobElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_OwningJobElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_OwningJobElement.");
                        resultArrayList.add(new CIM_OwningJobElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_OwningJobElement.");
                        resultArrayList.add(new CIM_OwningJobElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_OwningJobElement.");
                        resultArrayList.add(new CIM_OwningJobElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_OwningJobElement getInstance(WBEMClient client,
     ...
     */
    public final static CIM_OwningJobElement getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_OwningJobElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_OwningJobElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_OwningJobElement getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement OwningElement, CIM_Job OwnedElement
        ...
        setThis = OwningElement != null ? OwningElement.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_OwningJobElement.PROPERTY_OWNINGELEMENT_CIM_MANAGEDELEMENT.NAME,
                new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_OwningJobElement.CIM_CLASS_NAME);

        setThis = OwnedElement != null ? OwnedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_OwningJobElement.PROPERTY_OWNEDELEMENT_CIM_JOB.NAME,
                new CIMDataType(CIM_Job.CIM_CLASS_NAME), setThis, false, false,
                CIM_OwningJobElement.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_OwningJobElement createInstance(WBEMClient client,
            CIM_OwningJobElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_OwningJobElement newDataInstance = CIM_OwningJobElementHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_OwningJobElement modifyInstance(WBEMClient client,
            CIM_OwningJobElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_OwningJobElement dataInstance2 = CIM_OwningJobElementHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_OwningJobElement dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_OwningJobElement.getPackages());
    }
