 ...
 * 
 * Description: Helper class for CIM_ProductServiceComponent
 *    
 * 
 * generated Class
 * @see CIM_ProductServiceComponent
 */
...
public class CIM_ProductServiceComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductServiceComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductServiceComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductServiceComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductServiceComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProductServiceComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductServiceComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductServiceComponent.");
                        resultArrayList.add(new CIM_ProductServiceComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductServiceComponent.");
                        resultArrayList.add(new CIM_ProductServiceComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductServiceComponent.");
                        resultArrayList.add(new CIM_ProductServiceComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductServiceComponent getInstance(WBEMClient client,
    ...
    public final static CIM_ProductServiceComponent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductServiceComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductServiceComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductServiceComponent getInstance(WBEMClient client,
            String namespace, CIM_Product GroupComponent, CIM_Service PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProductServiceComponent.PROPERTY_GROUPCOMPONENT_CIM_PRODUCT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProductServiceComponent.PROPERTY_PARTCOMPONENT_CIM_SERVICE.NAME,
     ...
     *
     */
    public final static CIM_ProductServiceComponent createInstance(WBEMClient client,
            CIM_ProductServiceComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProductServiceComponent newDataInstance = CIM_ProductServiceComponentHelper
     ...
     */
    public final static CIM_ProductServiceComponent modifyInstance(WBEMClient client,
            CIM_ProductServiceComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductServiceComponent dataInstance2 = CIM_ProductServiceComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProductServiceComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductServiceComponent.getPackages());
    }
