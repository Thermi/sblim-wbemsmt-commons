 ...
 */
public class CIM_FRUIncludesProduct  {
	
	protected CIMInstance cimInstance			= new CIMInstance();
	protected CIMInstance original_cimInstance	= null;
	protected CIMObjectPath cimObjectPath		= null; 
	
	public final static String CIM_CLASS_NAME = "CIM_FRUIncludesProduct"; //$NON-NLS-1$
	...
	public final static String CIM_PROPERTY_CIM_PRODUCT = "Component"; //$NON-NLS-1$
	...
	*	Class constructor
	*/	
	public CIM_FRUIncludesProduct(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_FRUIncludesProduct(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (this.cimInstance == null && ((CIM_FRUIncludesProduct)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_FRUIncludesProduct)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_FRUIncludesProduct)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_FRUIncludesProduct)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_FRUIncludesProduct)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_FRUIncludesProduct)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_FRUIncludesProduct)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_FRUIncludesProduct)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_FRUIncludesProduct)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public CIMObjectPath get_CIM_FRU() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_FRUIncludesProduct.CIM_PROPERTY_CIM_FRU);
	...
	public CIMObjectPath get_CIM_Product() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_FRUIncludesProduct.CIM_PROPERTY_CIM_PRODUCT);
