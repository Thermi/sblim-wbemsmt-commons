...
public class CIM_LogicalDiskBasedOnPartition extends CIM_LogicalDiskBasedOnExtent {
     ...
     * 
     */
    public static class PROPERTY_ANTECEDENT_CIM_DISKPARTITION {
        /**
    ...
    public CIM_LogicalDiskBasedOnPartition(WBEMClient client, String namespace)
    ...
    public CIM_LogicalDiskBasedOnPartition(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_LogicalDiskBasedOnPartition() {
    }
    ...
    public CIM_DiskPartition get_Antecedent_CIM_DiskPartition(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_DISKPARTITION.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_DISKPARTITION.NAME
    ...
    public boolean set_Antecedent_CIM_DiskPartition(CIM_DiskPartition newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_DISKPARTITION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Antecedent_CIM_DiskPartition(currentProperty,
                    newValue);
    ...
    public static CIMProperty create_Antecedent_CIM_DiskPartition(WBEMClient client,
            String namespace, CIM_DiskPartition newValue) throws WbemsmtException {
        CIM_LogicalDiskBasedOnPartition fco = new CIM_LogicalDiskBasedOnPartition(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_ANTECEDENT_CIM_DISKPARTITION.NAME);
        if (property != null) {
            property = setPropertyValue_Antecedent_CIM_DiskPartition(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_DISKPARTITION.NAME
    ...
    private static CIMProperty setPropertyValue_Antecedent_CIM_DiskPartition(
    ...
    public String getObjectName() {
        return CIM_LogicalDiskBasedOnPartition.CIM_CLASS_NAME;
    }
