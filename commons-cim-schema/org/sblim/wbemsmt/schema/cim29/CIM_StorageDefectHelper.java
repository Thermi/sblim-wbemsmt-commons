 ...
 * 
 * Description: Helper class for CIM_StorageDefect
 *    
 * 
 * generated Class
 * @see CIM_StorageDefect
 */
...
public class CIM_StorageDefectHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_StorageDefect or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_StorageDefect.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_StorageDefect.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_StorageDefect or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_StorageDefect.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_StorageDefect(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_StorageDefectHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_StorageDefect.");
                        resultArrayList.add(new CIM_StorageDefect(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_StorageDefect.");
                        resultArrayList.add(new CIM_StorageDefect(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_StorageDefect.");
                        resultArrayList.add(new CIM_StorageDefect(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_StorageDefect getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_StorageDefect getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_StorageDefect) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_StorageDefect(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_StorageDefect getInstance(WBEMClient client, String namespace,
            CIM_StorageExtent Extent, CIM_StorageError Error
        ...
        setThis = Extent != null ? Extent.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_StorageDefect.PROPERTY_EXTENT_CIM_STORAGEEXTENT.NAME, new CIMDataType(
                        CIM_StorageExtent.CIM_CLASS_NAME), setThis, false, false,
                CIM_StorageDefect.CIM_CLASS_NAME);

        setThis = Error != null ? Error.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_StorageDefect.PROPERTY_ERROR_CIM_STORAGEERROR.NAME,
                new CIMDataType(CIM_StorageError.CIM_CLASS_NAME), setThis, false, false,
                CIM_StorageDefect.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_StorageDefect createInstance(WBEMClient client,
            CIM_StorageDefect dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_StorageDefect newDataInstance = CIM_StorageDefectHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_StorageDefect modifyInstance(WBEMClient client,
            CIM_StorageDefect dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_StorageDefect dataInstance2 = CIM_StorageDefectHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_StorageDefect dataInstance)
            throws WbemsmtException {
