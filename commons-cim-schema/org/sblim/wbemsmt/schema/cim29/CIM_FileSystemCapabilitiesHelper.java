 ...
 * 
 * Description: Helper class for CIM_FileSystemCapabilities
 *    
 * 
 * generated Class
 * @see CIM_FileSystemCapabilities
 */
...
public class CIM_FileSystemCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FileSystemCapabilities or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FileSystemCapabilities.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FileSystemCapabilities.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FileSystemCapabilities or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_FileSystemCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FileSystemCapabilities(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FileSystemCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FileSystemCapabilities.");
                        resultArrayList.add(new CIM_FileSystemCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FileSystemCapabilities.");
                        resultArrayList.add(new CIM_FileSystemCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FileSystemCapabilities.");
                        resultArrayList.add(new CIM_FileSystemCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FileSystemCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_FileSystemCapabilities getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FileSystemCapabilities) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FileSystemCapabilities(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FileSystemCapabilities getInstance(WBEMClient client, String namespace,
            String InstanceID
        ...
        keyProperties[0] = new CIMProperty(CIM_FileSystemCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_FileSystemCapabilities createInstance(WBEMClient client,
            CIM_FileSystemCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FileSystemCapabilities newDataInstance = CIM_FileSystemCapabilitiesHelper.getInstance(
     ...
     */
    public final static CIM_FileSystemCapabilities modifyInstance(WBEMClient client,
            CIM_FileSystemCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FileSystemCapabilities dataInstance2 = CIM_FileSystemCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_FileSystemCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FileSystemCapabilities.getPackages());
    }
