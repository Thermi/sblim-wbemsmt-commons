 ...
 * 
 * Description: Helper class for CIM_Rack
 *    
 * 
 * generated Class
 * @see CIM_Rack
...
public class CIM_RackHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Rack or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Rack.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Rack.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Rack or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Rack.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Rack(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RackHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Rack.");
                        resultArrayList.add(new CIM_Rack(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class "
                                ...
                                + " could not be found. Constructing instance of class CIM_Rack.");
                        resultArrayList.add(new CIM_Rack(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Rack.");
                        resultArrayList.add(new CIM_Rack(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Rack getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Rack getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Rack) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Rack(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Rack getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_Rack.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Rack.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[1] = new CIMProperty(CIM_Rack.PROPERTY_TAG.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Rack.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Rack createInstance(WBEMClient client, CIM_Rack dataInstance,
        ...
        CIM_Rack newDataInstance = CIM_RackHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Rack modifyInstance(WBEMClient client, CIM_Rack dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Rack dataInstance2 = CIM_RackHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Rack dataInstance)
            throws WbemsmtException {
