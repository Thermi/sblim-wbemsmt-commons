/** 
 * CIM_ProtocolAdapterHelper.java
 *
...
public final class CIM_ProtocolAdapterHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ProtocolAdapter.");
						resultArrayList.add(new CIM_ProtocolAdapter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ProtocolAdapter.");
						resultArrayList.add(new CIM_ProtocolAdapter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ProtocolAdapter.");
						resultArrayList.add(new CIM_ProtocolAdapter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ProtocolAdapter getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ProtocolAdapterHelper.getInstance(cimClient, new CIM_ProtocolAdapter(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ProtocolAdapter getInstance(CIMClient cimClient, CIM_ProtocolAdapter dataInstance) {
		...
		return CIM_ProtocolAdapterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ProtocolAdapter getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ProtocolAdapter dataInstance = null;
		try {
			dataInstance = new CIM_ProtocolAdapter(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_ProtocolAdapter.getPackages();
	...
	*/	
	public final static CIM_ProtocolAdapter createInstance(CIMClient cimClient, CIM_ProtocolAdapter dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ProtocolAdapter newDataInstance = null;
		try {
			newDataInstance = CIM_ProtocolAdapterHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ProtocolAdapter modifyInstance(CIMClient cimClient, CIM_ProtocolAdapter dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ProtocolAdapterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ProtocolAdapter dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ProtocolAdapter dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ProtocolAdapter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ProtocolAdapter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ProtocolAdapter.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ProtocolAdapter.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ProtocolAdapter.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_OtherProtocolAdapterType(String OtherProtocolAdapterType) {
		return true;
	}

	public static boolean isValid_ProtocolAdapterType(UnsignedInt16 ProtocolAdapterType) {
		return true;
	}
