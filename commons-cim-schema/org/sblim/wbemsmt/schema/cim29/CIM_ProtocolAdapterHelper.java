 ...
 * 
 * Description: Helper class for CIM_ProtocolAdapter
 *    
 * 
 * generated Class
 * @see CIM_ProtocolAdapter
 */
...
public class CIM_ProtocolAdapterHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProtocolAdapter or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProtocolAdapter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProtocolAdapter.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProtocolAdapter or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_ProtocolAdapter.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProtocolAdapter(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProtocolAdapterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProtocolAdapter.");
                        resultArrayList.add(new CIM_ProtocolAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProtocolAdapter.");
                        resultArrayList.add(new CIM_ProtocolAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProtocolAdapter.");
                        resultArrayList.add(new CIM_ProtocolAdapter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProtocolAdapter getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ProtocolAdapter getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProtocolAdapter) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProtocolAdapter(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProtocolAdapter getInstance(WBEMClient client, String namespace,
            String CreationClassName, String SystemCreationClassName, String SystemName
        ...
        keyProperties[0] = new CIMProperty(CIM_ProtocolAdapter.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ProtocolAdapter.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[1] = new CIMProperty(
                CIM_ProtocolAdapter.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_ProtocolAdapter.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[2] = new CIMProperty(CIM_ProtocolAdapter.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ProtocolAdapter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProtocolAdapter createInstance(WBEMClient client,
            CIM_ProtocolAdapter dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProtocolAdapter newDataInstance = CIM_ProtocolAdapterHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProtocolAdapter modifyInstance(WBEMClient client,
            CIM_ProtocolAdapter dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProtocolAdapter dataInstance2 = CIM_ProtocolAdapterHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProtocolAdapter dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProtocolAdapter.getPackages());
    }
