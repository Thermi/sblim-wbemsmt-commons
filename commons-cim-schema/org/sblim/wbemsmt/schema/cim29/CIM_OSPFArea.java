	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_RoutingProtocolDomain.Java_Package_List.size(); i++) {
			if (((String)CIM_RoutingProtocolDomain.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim29")){
				continue;
			}
