 ...
 * 
 * Description: Helper class for CIM_ServiceAffectsElement
 *    
 * 
 * generated Class
 * @see CIM_ServiceAffectsElement
 */
...
public class CIM_ServiceAffectsElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceAffectsElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceAffectsElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ServiceAffectsElement.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceAffectsElement or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ServiceAffectsElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceAffectsElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceAffectsElement.");
                        resultArrayList.add(new CIM_ServiceAffectsElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceAffectsElement.");
                        resultArrayList.add(new CIM_ServiceAffectsElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceAffectsElement.");
                        resultArrayList.add(new CIM_ServiceAffectsElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceAffectsElement getInstance(WBEMClient client,
    ...
    public final static CIM_ServiceAffectsElement getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceAffectsElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceAffectsElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceAffectsElement getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement AffectedElement, CIM_Service AffectingElement
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ServiceAffectsElement.PROPERTY_AFFECTEDELEMENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ServiceAffectsElement.PROPERTY_AFFECTINGELEMENT_CIM_SERVICE.NAME,
     ...
     *
     */
    public final static CIM_ServiceAffectsElement createInstance(WBEMClient client,
            CIM_ServiceAffectsElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ServiceAffectsElement newDataInstance = CIM_ServiceAffectsElementHelper.getInstance(
     ...
     */
    public final static CIM_ServiceAffectsElement modifyInstance(WBEMClient client,
            CIM_ServiceAffectsElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceAffectsElement dataInstance2 = CIM_ServiceAffectsElementHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ServiceAffectsElement dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceAffectsElement.getPackages());
    }
