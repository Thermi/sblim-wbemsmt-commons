 ...
 * 
 * Description: Helper class for CIM_SystemComponent
 *    
 * 
 * generated Class
 * @see CIM_SystemComponent
 */
...
public class CIM_SystemComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemComponent.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemComponent or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_SystemComponent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemComponent.");
                        resultArrayList.add(new CIM_SystemComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemComponent.");
                        resultArrayList.add(new CIM_SystemComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemComponent.");
                        resultArrayList.add(new CIM_SystemComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemComponent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SystemComponent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemComponent getInstance(WBEMClient client, String namespace,
            CIM_System GroupComponent, CIM_ManagedSystemElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemComponent.PROPERTY_GROUPCOMPONENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SystemComponent.PROPERTY_PARTCOMPONENT_CIM_MANAGEDSYSTEMELEMENT.NAME,
                new CIMDataType(CIM_ManagedSystemElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_SystemComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemComponent createInstance(WBEMClient client,
            CIM_SystemComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemComponent newDataInstance = CIM_SystemComponentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SystemComponent modifyInstance(WBEMClient client,
            CIM_SystemComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemComponent dataInstance2 = CIM_SystemComponentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemComponent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemComponent.getPackages());
    }
