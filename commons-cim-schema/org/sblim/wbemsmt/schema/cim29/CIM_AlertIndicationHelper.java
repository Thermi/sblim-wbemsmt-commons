/** 
 * CIM_AlertIndicationHelper.java
 *
...
public final class CIM_AlertIndicationHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_AlertIndication(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_AlertIndication.Java_Package_List.size(); i++) {
						if (!((String)(CIM_AlertIndication.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_AlertIndication.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_AlertIndication.Java_Package_List.setElementAt((String)(CIM_AlertIndication.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_AlertIndication.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AlertIndication.");
						resultArrayList.add(new CIM_AlertIndication(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AlertIndication.");
						resultArrayList.add(new CIM_AlertIndication(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AlertIndication.");
						resultArrayList.add(new CIM_AlertIndication(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_AlertIndication getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_AlertIndicationHelper.getInstance(cimClient, new CIM_AlertIndication(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AlertIndication getInstance(CIMClient cimClient, CIM_AlertIndication dataInstance) {
		...
		return CIM_AlertIndicationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AlertIndication getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_AlertIndication dataInstance = null;
		try {
			dataInstance = new CIM_AlertIndication(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AlertIndication createInstance(CIMClient cimClient, CIM_AlertIndication dataInstance, boolean notifyDifferencies){ 
		...
		CIM_AlertIndication newDataInstance = null;
		try {
			newDataInstance = CIM_AlertIndicationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AlertIndication modifyInstance(CIMClient cimClient, CIM_AlertIndication dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_AlertIndicationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_AlertIndication dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_AlertIndication dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_AlertIndication.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_AlertIndication.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_AlertIndication.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_AlertIndication.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_AlertIndication.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AlertType(UnsignedInt16 AlertType) {
		return true;
	}

	public static boolean isValid_AlertingElementFormat(UnsignedInt16 AlertingElementFormat) {
		return true;
	}

	public static boolean isValid_AlertingManagedElement(String AlertingManagedElement) {
		return true;
	}
	...
	public static boolean isValid_EventID(String EventID) {
		return true;
	}

	public static boolean isValid_EventTime(Calendar EventTime) {
		return true;
	}

	public static boolean isValid_OtherAlertType(String OtherAlertType) {
		return true;
	}

	public static boolean isValid_OtherAlertingElementFormat(String OtherAlertingElementFormat) {
		return true;
	}

	public static boolean isValid_OtherSeverity(String OtherSeverity) {
		return true;
	}

	public static boolean isValid_PerceivedSeverity(UnsignedInt16 PerceivedSeverity) {
		return true;
	}

	public static boolean isValid_ProbableCause(UnsignedInt16 ProbableCause) {
		return true;
	}

	public static boolean isValid_ProbableCauseDescription(String ProbableCauseDescription) {
		return true;
	}

	public static boolean isValid_ProviderName(String ProviderName) {
		return true;
	}

	public static boolean isValid_RecommendedActions(String[] RecommendedActions) {
		return true;
	}
	...
	public static boolean isValid_Trending(UnsignedInt16 Trending) {
		return true;
	}
