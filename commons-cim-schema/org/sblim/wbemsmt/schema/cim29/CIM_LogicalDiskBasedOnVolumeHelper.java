 ...
 * 
 * Description: Helper class for CIM_LogicalDiskBasedOnVolume
 *    
 * 
 * generated Class
 * @see CIM_LogicalDiskBasedOnVolume
 */
...
public class CIM_LogicalDiskBasedOnVolumeHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_LogicalDiskBasedOnVolume or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalDiskBasedOnVolume.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_LogicalDiskBasedOnVolume.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_LogicalDiskBasedOnVolume or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_LogicalDiskBasedOnVolume(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_LogicalDiskBasedOnVolumeHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_LogicalDiskBasedOnVolume.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnVolume(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LogicalDiskBasedOnVolume.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnVolume(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LogicalDiskBasedOnVolume.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnVolume(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LogicalDiskBasedOnVolume getInstance(WBEMClient client,
    ...
    public final static CIM_LogicalDiskBasedOnVolume getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_LogicalDiskBasedOnVolume) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_LogicalDiskBasedOnVolume(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_LogicalDiskBasedOnVolume getInstance(WBEMClient client,
            String namespace, CIM_StorageVolume Antecedent, CIM_LogicalDisk Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_LogicalDiskBasedOnVolume.PROPERTY_ANTECEDENT_CIM_STORAGEVOLUME.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_LogicalDiskBasedOnVolume.PROPERTY_DEPENDENT_CIM_LOGICALDISK.NAME,
     ...
     *
     */
    public final static CIM_LogicalDiskBasedOnVolume createInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnVolume dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_LogicalDiskBasedOnVolume newDataInstance = CIM_LogicalDiskBasedOnVolumeHelper
     ...
     */
    public final static CIM_LogicalDiskBasedOnVolume modifyInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnVolume dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LogicalDiskBasedOnVolume dataInstance2 = CIM_LogicalDiskBasedOnVolumeHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnVolume dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LogicalDiskBasedOnVolume.getPackages());
    }
