 ...
 * 
 * Description: CommMechanismForAdapter is an association between an ObjectManager's communication mechanism and a ProtocolAdapter that supports that mechanism to translate requests and responses for the Object Manager.
 * 
 * generated Class
 */
...
public class CIM_CommMechanismForAdapter extends CIM_Dependency {
     ...
     * 
     */
    public static class PROPERTY_ANTECEDENT_CIM_PROTOCOLADAPTER {
        /**
    ...
    public CIM_CommMechanismForAdapter(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_CommMechanismForAdapter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_CommMechanismForAdapter() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("Antecedent", new CIMProperty("Antecedent", new CIMDataType(
                CIM_ProtocolAdapter.CIM_CLASS_NAME), null));
    ...
    public CIM_ProtocolAdapter get_Antecedent_CIM_ProtocolAdapter(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_PROTOCOLADAPTER.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_PROTOCOLADAPTER.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return CIM_ProtocolAdapterHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_Antecedent_CIM_ProtocolAdapter(CIM_ProtocolAdapter newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_PROTOCOLADAPTER.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Antecedent_CIM_ProtocolAdapter(currentProperty,
                    newValue);
    ...
    public static CIMProperty create_Antecedent_CIM_ProtocolAdapter(WBEMClient client,
            String namespace, CIM_ProtocolAdapter newValue) throws WbemsmtException {
        CIM_CommMechanismForAdapter fco = new CIM_CommMechanismForAdapter(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_ANTECEDENT_CIM_PROTOCOLADAPTER.NAME);
        if (property != null) {
            property = setPropertyValue_Antecedent_CIM_ProtocolAdapter(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_PROTOCOLADAPTER.NAME
    ...
    private static CIMProperty setPropertyValue_Antecedent_CIM_ProtocolAdapter(
            CIMProperty currentProperty, CIM_ProtocolAdapter newValue) {
        Object setThis = null;
    ...
    public boolean set_Dependent_CIM_ObjectManagerCommunicationMechanism(
        ...
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_OBJECTMANAGERCOMMUNICATIONMECHANISM.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_ObjectManagerCommunicationMechanism(
    ...
    public String getObjectName() {
        return CIM_CommMechanismForAdapter.CIM_CLASS_NAME;
    }
