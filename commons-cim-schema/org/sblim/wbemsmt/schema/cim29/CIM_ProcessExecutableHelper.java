 ...
 * 
 * Description: Helper class for CIM_ProcessExecutable
 *    
 * 
 * generated Class
 * @see CIM_ProcessExecutable
 */
...
public class CIM_ProcessExecutableHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProcessExecutable or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProcessExecutable.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProcessExecutable.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProcessExecutable or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProcessExecutable(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProcessExecutableHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProcessExecutable.");
                        resultArrayList.add(new CIM_ProcessExecutable(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProcessExecutable.");
                        resultArrayList.add(new CIM_ProcessExecutable(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProcessExecutable.");
                        resultArrayList.add(new CIM_ProcessExecutable(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProcessExecutable getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ProcessExecutable getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProcessExecutable) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProcessExecutable(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProcessExecutable getInstance(WBEMClient client, String namespace,
            CIM_DataFile Antecedent, CIM_Process Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProcessExecutable.PROPERTY_ANTECEDENT_CIM_DATAFILE.NAME, new CIMDataType(
                        CIM_DataFile.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProcessExecutable.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ProcessExecutable.PROPERTY_DEPENDENT_CIM_PROCESS.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_ProcessExecutable createInstance(WBEMClient client,
            CIM_ProcessExecutable dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProcessExecutable newDataInstance = CIM_ProcessExecutableHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProcessExecutable modifyInstance(WBEMClient client,
            CIM_ProcessExecutable dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProcessExecutable dataInstance2 = CIM_ProcessExecutableHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProcessExecutable dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProcessExecutable.getPackages());
    }
