 ...
 *
 *
 * Description: A class representing a rule-specific or reusable policy action to be performed if the PolicyConditions for a Policy Rule evaluate to TRUE. Since all operational details of a PolicyAction are provided in subclasses of this object, this class is abstract.
 * 
 */
...
public class CIM_PolicyAction extends CIM_Policy  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_POLICYACTIONINPOLICYRULE = "CIM_PolicyActionInPolicyRule";
