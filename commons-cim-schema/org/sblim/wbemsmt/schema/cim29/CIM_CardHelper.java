...
public final class CIM_CardHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_Card.");
						resultArrayList.add(new CIM_Card(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_Card.");
						resultArrayList.add(new CIM_Card(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_Card.");
						resultArrayList.add(new CIM_Card(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_Card getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CardHelper.getInstance(cimClient, new CIM_Card(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Card getInstance(CIMClient cimClient, CIM_Card dataInstance) {
		...
		return CIM_CardHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Card getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_Card dataInstance = null;
		try {
			dataInstance = new CIM_Card(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_Card.getPackages();
	...
	*/	
	public final static CIM_Card createInstance(CIMClient cimClient, CIM_Card dataInstance, boolean notifyDifferencies){ 
		...
		CIM_Card newDataInstance = null;
		try {
			newDataInstance = CIM_CardHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_Card modifyInstance(CIMClient cimClient, CIM_Card dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_CardHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_Card dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_Card dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_Card.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_Card.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_Card.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_Card.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_Card.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_HostingBoard(Boolean HostingBoard) {
		return true;
	}

	public static boolean isValid_OperatingVoltages(Short[] OperatingVoltages) {
		return true;
	}

	public static boolean isValid_RequirementsDescription(String RequirementsDescription) {
		return true;
	}

	public static boolean isValid_RequiresDaughterBoard(Boolean RequiresDaughterBoard) {
		return true;
	}

	public static boolean isValid_SlotLayout(String SlotLayout) {
		return true;
	}

	public static boolean isValid_SpecialRequirements(Boolean SpecialRequirements) {
		return true;
	}
