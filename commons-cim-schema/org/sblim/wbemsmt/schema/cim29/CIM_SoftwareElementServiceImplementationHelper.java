...
public final class CIM_SoftwareElementServiceImplementationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					Class clazz = CIM_SoftwareElementServiceImplementationHelper.findClass(cimClient, cimInstance);
					if (clazz == null) {
	...
	*/	
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_SoftwareElementServiceImplementation.getPackages();
