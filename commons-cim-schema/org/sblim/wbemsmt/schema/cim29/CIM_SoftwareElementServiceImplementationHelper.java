 ...
 * 
 * Description: Helper class for CIM_SoftwareElementServiceImplementation
 *    
 * 
 * generated Class
 * @see CIM_SoftwareElementServiceImplementation
 */
...
public class CIM_SoftwareElementServiceImplementationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareElementServiceImplementation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_SoftwareElementServiceImplementation.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareElementServiceImplementation or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_SoftwareElementServiceImplementation.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SoftwareElementServiceImplementation(
                                cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareElementServiceImplementationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareElementServiceImplementation.");
                        resultArrayList.add(new CIM_SoftwareElementServiceImplementation(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareElementServiceImplementation.");
                        resultArrayList.add(new CIM_SoftwareElementServiceImplementation(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareElementServiceImplementation.");
                        resultArrayList.add(new CIM_SoftwareElementServiceImplementation(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareElementServiceImplementation getInstance(WBEMClient client,
    ...
    public final static CIM_SoftwareElementServiceImplementation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_SoftwareElementServiceImplementationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareElementServiceImplementation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareElementServiceImplementation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareElementServiceImplementation getInstance(WBEMClient client,
            String namespace, CIM_SoftwareElement Antecedent, CIM_Service Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SoftwareElementServiceImplementation.PROPERTY_ANTECEDENT_CIM_SOFTWAREELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SoftwareElementServiceImplementation.PROPERTY_DEPENDENT_CIM_SERVICE.NAME,
     ...
     *
     */
    public final static CIM_SoftwareElementServiceImplementation createInstance(WBEMClient client,
            CIM_SoftwareElementServiceImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SoftwareElementServiceImplementation newDataInstance = CIM_SoftwareElementServiceImplementationHelper
     ...
     */
    public final static CIM_SoftwareElementServiceImplementation modifyInstance(WBEMClient client,
            CIM_SoftwareElementServiceImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareElementServiceImplementation dataInstance2 = CIM_SoftwareElementServiceImplementationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SoftwareElementServiceImplementation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareElementServiceImplementation.getPackages());
    }
