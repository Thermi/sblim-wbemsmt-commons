...
public class CIM_LogicalElementHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalElement.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_LogicalElement.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_LogicalElement.");
                        resultArrayList.add(new CIM_LogicalElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LogicalElement.");
                        resultArrayList.add(new CIM_LogicalElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LogicalElement.");
                        resultArrayList.add(new CIM_LogicalElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LogicalElement getInstance(WBEMClient client,
     ...
     */
    public final static CIM_LogicalElement getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     */
    public final static void deleteInstance(WBEMClient client, CIM_LogicalElement dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LogicalElement.getPackages());
    }
