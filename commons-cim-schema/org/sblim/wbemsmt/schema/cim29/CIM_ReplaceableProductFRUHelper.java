 ...
 * 
 * Description: Helper class for CIM_ReplaceableProductFRU
 *    
 * 
 * generated Class
 * @see CIM_ReplaceableProductFRU
 */
...
public class CIM_ReplaceableProductFRUHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ReplaceableProductFRU or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ReplaceableProductFRU.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ReplaceableProductFRU.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ReplaceableProductFRU or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ReplaceableProductFRU.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ReplaceableProductFRU(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ReplaceableProductFRUHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ReplaceableProductFRU.");
                        resultArrayList.add(new CIM_ReplaceableProductFRU(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ReplaceableProductFRU.");
                        resultArrayList.add(new CIM_ReplaceableProductFRU(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ReplaceableProductFRU.");
                        resultArrayList.add(new CIM_ReplaceableProductFRU(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ReplaceableProductFRU getInstance(WBEMClient client,
    ...
    public final static CIM_ReplaceableProductFRU getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ReplaceableProductFRU) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ReplaceableProductFRU(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ReplaceableProductFRU getInstance(WBEMClient client, String namespace,
            CIM_Product Product, CIM_FRU FRU
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ReplaceableProductFRU.PROPERTY_PRODUCT_CIM_PRODUCT.NAME, new CIMDataType(
                        CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ReplaceableProductFRU.CIM_CLASS_NAME);

        setThis = FRU != null ? FRU.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_ReplaceableProductFRU.PROPERTY_FRU_CIM_FRU.NAME,
                new CIMDataType(CIM_FRU.CIM_CLASS_NAME), setThis, false, false,
                CIM_ReplaceableProductFRU.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ReplaceableProductFRU createInstance(WBEMClient client,
            CIM_ReplaceableProductFRU dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ReplaceableProductFRU newDataInstance = CIM_ReplaceableProductFRUHelper.getInstance(
     ...
     */
    public final static CIM_ReplaceableProductFRU modifyInstance(WBEMClient client,
            CIM_ReplaceableProductFRU dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ReplaceableProductFRU dataInstance2 = CIM_ReplaceableProductFRUHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ReplaceableProductFRU dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ReplaceableProductFRU.getPackages());
    }
