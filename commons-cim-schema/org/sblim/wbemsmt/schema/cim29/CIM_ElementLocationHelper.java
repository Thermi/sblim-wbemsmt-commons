 ...
 * 
 * Description: Helper class for CIM_ElementLocation
 *    
 * 
 * generated Class
 * @see CIM_ElementLocation
 */
...
public class CIM_ElementLocationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ElementLocation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementLocation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ElementLocation.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ElementLocation or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_ElementLocation.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementLocation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ElementLocationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ElementLocation.");
                        resultArrayList.add(new CIM_ElementLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementLocation.");
                        resultArrayList.add(new CIM_ElementLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementLocation.");
                        resultArrayList.add(new CIM_ElementLocation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementLocation getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ElementLocation getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ElementLocation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ElementLocation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ElementLocation getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement Element, CIM_Location PhysicalLocation
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementLocation.PROPERTY_ELEMENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
                        CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_ElementLocation.CIM_CLASS_NAME);

        setThis = PhysicalLocation != null ? PhysicalLocation.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ElementLocation.PROPERTY_PHYSICALLOCATION_CIM_LOCATION.NAME, new CIMDataType(
                        CIM_Location.CIM_CLASS_NAME), setThis, false, false,
                CIM_ElementLocation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ElementLocation createInstance(WBEMClient client,
            CIM_ElementLocation dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ElementLocation newDataInstance = CIM_ElementLocationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ElementLocation modifyInstance(WBEMClient client,
            CIM_ElementLocation dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementLocation dataInstance2 = CIM_ElementLocationHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ElementLocation dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementLocation.getPackages());
    }
