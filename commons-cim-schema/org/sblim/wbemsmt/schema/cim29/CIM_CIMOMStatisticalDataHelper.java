 ...
 * 
 * Description: Helper class for CIM_CIMOMStatisticalData
 *    
 * 
 * generated Class
 * @see CIM_CIMOMStatisticalData
 */
...
public class CIM_CIMOMStatisticalDataHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CIMOMStatisticalData or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CIMOMStatisticalData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CIMOMStatisticalData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CIMOMStatisticalData or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_CIMOMStatisticalData.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CIMOMStatisticalDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CIMOMStatisticalData.");
                        resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CIMOMStatisticalData.");
                        resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CIMOMStatisticalData.");
                        resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CIMOMStatisticalData getInstance(WBEMClient client,
    ...
    public final static CIM_CIMOMStatisticalData getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CIMOMStatisticalData) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CIMOMStatisticalData(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_CIMOMStatisticalData createInstance(WBEMClient client,
            CIM_CIMOMStatisticalData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CIMOMStatisticalData newDataInstance = CIM_CIMOMStatisticalDataHelper.getInstance(
     ...
     */
    public final static CIM_CIMOMStatisticalData modifyInstance(WBEMClient client,
            CIM_CIMOMStatisticalData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CIMOMStatisticalData dataInstance2 = CIM_CIMOMStatisticalDataHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_CIMOMStatisticalData dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CIMOMStatisticalData.getPackages());
    }
