 ...
 * 
 * Description: A class derived from ComputerSystem that represents the ability to virtualize or emulate another ComputerSystem.
 * 
 * generated Class
 */
...
public class CIM_VirtualComputerSystem extends CIM_ComputerSystem {
    ...
    public boolean set_VirtualSystem(String newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_VirtualSystem(currentProperty, newValue);
    ...
    /**
     * Get the list with CIM_ComputerSystem objects associated by the association CIM_HostingCS
     * 
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_HostingCSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_HostingCSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_HostingCSs(WBEMClient cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_VirtualComputerSystemHelper.checkException(enumeration);
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_HostingCSNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_HostingCSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTINGCS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
                null);
    }
