...
public class CIM_SystemBIOS extends CIM_SystemComponent {
    ...
    public CIM_SystemBIOS(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_SystemBIOS(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_GroupComponent_CIM_ComputerSystem(WBEMClient client,
        ...
        CIM_SystemBIOS fco = new CIM_SystemBIOS(client, namespace);
    ...
    public String getObjectName() {
        return CIM_SystemBIOS.CIM_CLASS_NAME;
    }
