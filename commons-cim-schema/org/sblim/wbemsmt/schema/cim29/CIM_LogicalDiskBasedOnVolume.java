...
public class CIM_LogicalDiskBasedOnVolume extends CIM_LogicalDiskBasedOnExtent {
    ...
    public CIM_LogicalDiskBasedOnVolume(WBEMClient client, String namespace)
    ...
    public CIM_LogicalDiskBasedOnVolume(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_LogicalDiskBasedOnVolume() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_StorageVolume(WBEMClient client,
        ...
        CIM_LogicalDiskBasedOnVolume fco = new CIM_LogicalDiskBasedOnVolume(client, namespace);
    ...
    public String getObjectName() {
        return CIM_LogicalDiskBasedOnVolume.CIM_CLASS_NAME;
    }
