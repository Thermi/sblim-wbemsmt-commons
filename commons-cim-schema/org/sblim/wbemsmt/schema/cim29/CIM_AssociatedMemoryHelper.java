 ...
 * 
 * Description: Helper class for CIM_AssociatedMemory
 *    
 * 
 * generated Class
 * @see CIM_AssociatedMemory
 */
...
public class CIM_AssociatedMemoryHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_AssociatedMemory or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AssociatedMemory.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_AssociatedMemory or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_AssociatedMemory.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_AssociatedMemory(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_AssociatedMemoryHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AssociatedMemory.");
                        resultArrayList.add(new CIM_AssociatedMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AssociatedMemory.");
                        resultArrayList.add(new CIM_AssociatedMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AssociatedMemory.");
                        resultArrayList.add(new CIM_AssociatedMemory(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AssociatedMemory getInstance(WBEMClient client,
     ...
     */
    public final static CIM_AssociatedMemory getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_AssociatedMemory) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_AssociatedMemory(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_AssociatedMemory getInstance(WBEMClient client, String namespace,
            CIM_Memory Antecedent, CIM_LogicalElement Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_AssociatedMemory.PROPERTY_ANTECEDENT_CIM_MEMORY.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_AssociatedMemory.PROPERTY_DEPENDENT_CIM_LOGICALELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_AssociatedMemory createInstance(WBEMClient client,
            CIM_AssociatedMemory dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_AssociatedMemory newDataInstance = CIM_AssociatedMemoryHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_AssociatedMemory modifyInstance(WBEMClient client,
            CIM_AssociatedMemory dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AssociatedMemory dataInstance2 = CIM_AssociatedMemoryHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_AssociatedMemory dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AssociatedMemory.getPackages());
    }
