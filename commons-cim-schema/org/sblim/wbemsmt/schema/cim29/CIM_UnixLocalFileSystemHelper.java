 ...
 * 
 * Description: Helper class for CIM_UnixLocalFileSystem
 *    
 * 
 * generated Class
 * @see CIM_UnixLocalFileSystem
 */
...
public class CIM_UnixLocalFileSystemHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_UnixLocalFileSystem or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_UnixLocalFileSystem.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_UnixLocalFileSystem.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_UnixLocalFileSystem or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_UnixLocalFileSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_UnixLocalFileSystem(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_UnixLocalFileSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_UnixLocalFileSystem.");
                        resultArrayList.add(new CIM_UnixLocalFileSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_UnixLocalFileSystem.");
                        resultArrayList.add(new CIM_UnixLocalFileSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_UnixLocalFileSystem.");
                        resultArrayList.add(new CIM_UnixLocalFileSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_UnixLocalFileSystem getInstance(WBEMClient client,
    ...
    public final static CIM_UnixLocalFileSystem getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_UnixLocalFileSystem) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_UnixLocalFileSystem(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_UnixLocalFileSystem getInstance(WBEMClient client, String namespace,
            String CSCreationClassName, String CSName, String CreationClassName, String Name
        ...
        keyProperties[0] = new CIMProperty(
                CIM_UnixLocalFileSystem.PROPERTY_CSCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixLocalFileSystem.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_UnixLocalFileSystem.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixLocalFileSystem.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_UnixLocalFileSystem.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixLocalFileSystem.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_UnixLocalFileSystem.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixLocalFileSystem.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_UnixLocalFileSystem createInstance(WBEMClient client,
            CIM_UnixLocalFileSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_UnixLocalFileSystem newDataInstance = CIM_UnixLocalFileSystemHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_UnixLocalFileSystem modifyInstance(WBEMClient client,
            CIM_UnixLocalFileSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_UnixLocalFileSystem dataInstance2 = CIM_UnixLocalFileSystemHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_UnixLocalFileSystem dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_UnixLocalFileSystem.getPackages());
    }
