 ...
 * 
 * Description: Helper class for CIM_SystemStatistics
 *    
 * 
 * generated Class
 * @see CIM_SystemStatistics
 */
...
public class CIM_SystemStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemStatistics.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemStatistics or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_SystemStatistics.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemStatistics.");
                        resultArrayList.add(new CIM_SystemStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemStatistics.");
                        resultArrayList.add(new CIM_SystemStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemStatistics.");
                        resultArrayList.add(new CIM_SystemStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemStatistics getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SystemStatistics getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemStatistics getInstance(WBEMClient client, String namespace,
            CIM_SystemStatisticalInformation Stats, CIM_System Element
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemStatistics.PROPERTY_STATS_CIM_SYSTEMSTATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_SystemStatisticalInformation.CIM_CLASS_NAME), setThis, false,
                false, CIM_SystemStatistics.CIM_CLASS_NAME);

        setThis = Element != null ? Element.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_SystemStatistics.PROPERTY_ELEMENT_CIM_SYSTEM.NAME,
     ...
     *
     */
    public final static CIM_SystemStatistics createInstance(WBEMClient client,
            CIM_SystemStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemStatistics newDataInstance = CIM_SystemStatisticsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SystemStatistics modifyInstance(WBEMClient client,
            CIM_SystemStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemStatistics dataInstance2 = CIM_SystemStatisticsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemStatistics dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemStatistics.getPackages());
    }
