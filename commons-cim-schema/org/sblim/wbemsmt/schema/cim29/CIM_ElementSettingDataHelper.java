...
public class CIM_ElementSettingDataHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementSettingData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ElementSettingData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ElementSettingData.");
                        resultArrayList.add(new CIM_ElementSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementSettingData.");
                        resultArrayList.add(new CIM_ElementSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementSettingData.");
                        resultArrayList.add(new CIM_ElementSettingData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementSettingData getInstance(WBEMClient client,
    ...
    public final static CIM_ElementSettingData getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement ManagedElement, CIM_SettingData SettingData
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementSettingData.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ElementSettingData.PROPERTY_SETTINGDATA_CIM_SETTINGDATA.NAME, new CIMDataType(
                        CIM_SettingData.CIM_CLASS_NAME), setThis, false, false,
                CIM_ElementSettingData.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ElementSettingData createInstance(WBEMClient client,
            CIM_ElementSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ElementSettingData newDataInstance = CIM_ElementSettingDataHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ElementSettingData modifyInstance(WBEMClient client,
            CIM_ElementSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementSettingData dataInstance2 = CIM_ElementSettingDataHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ElementSettingData dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementSettingData.getPackages());
    }
