 ...
 * 
 * Description: Helper class for CIM_MethodParameters
 *    
 * 
 * generated Class
 * @see CIM_MethodParameters
 */
...
public class CIM_MethodParametersHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MethodParameters or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MethodParameters.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MethodParameters or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_MethodParameters.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MethodParameters(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MethodParametersHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MethodParameters.");
                        resultArrayList.add(new CIM_MethodParameters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MethodParameters.");
                        resultArrayList.add(new CIM_MethodParameters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MethodParameters.");
                        resultArrayList.add(new CIM_MethodParameters(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MethodParameters getInstance(WBEMClient client,
     ...
     */
    public final static CIM_MethodParameters getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MethodParameters) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MethodParameters(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static void deleteInstance(WBEMClient client, CIM_MethodParameters dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MethodParameters.getPackages());
    }
