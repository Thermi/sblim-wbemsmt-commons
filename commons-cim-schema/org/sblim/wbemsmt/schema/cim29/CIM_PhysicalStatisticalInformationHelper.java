/** 
 * CIM_PhysicalStatisticalInformationHelper.java
 *
...
public final class CIM_PhysicalStatisticalInformationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					Class clazz = CIM_PhysicalStatisticalInformationHelper.findClass(cimClient, cimInstance);
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PhysicalStatisticalInformation.");
						resultArrayList.add(new CIM_PhysicalStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PhysicalStatisticalInformation.");
						resultArrayList.add(new CIM_PhysicalStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PhysicalStatisticalInformation.");
						resultArrayList.add(new CIM_PhysicalStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PhysicalStatisticalInformation getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PhysicalStatisticalInformationHelper.getInstance(cimClient, new CIM_PhysicalStatisticalInformation(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalStatisticalInformation getInstance(CIMClient cimClient, CIM_PhysicalStatisticalInformation dataInstance) {
		...
		return CIM_PhysicalStatisticalInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalStatisticalInformation getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PhysicalStatisticalInformation dataInstance = null;
		try {
			dataInstance = new CIM_PhysicalStatisticalInformation(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_PhysicalStatisticalInformation.getPackages();
	...
	*/	
	public final static CIM_PhysicalStatisticalInformation createInstance(CIMClient cimClient, CIM_PhysicalStatisticalInformation dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PhysicalStatisticalInformation newDataInstance = null;
		try {
			newDataInstance = CIM_PhysicalStatisticalInformationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalStatisticalInformation modifyInstance(CIMClient cimClient, CIM_PhysicalStatisticalInformation dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PhysicalStatisticalInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PhysicalStatisticalInformation dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PhysicalStatisticalInformation dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PhysicalStatisticalInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PhysicalStatisticalInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PhysicalStatisticalInformation.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PhysicalStatisticalInformation.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PhysicalStatisticalInformation.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_PhysicalCreationClassName(String PhysicalCreationClassName) {
		return true;
	}

	public static boolean isValid_Tag(String Tag) {
		return true;
	}
