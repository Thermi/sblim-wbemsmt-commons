 ...
 * 
 * Description: Helper class for CIM_PhysicalStatisticalInformation
 *    
 * 
 * generated Class
 * @see CIM_PhysicalStatisticalInformation
 */
...
public class CIM_PhysicalStatisticalInformationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PhysicalStatisticalInformation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PhysicalStatisticalInformation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PhysicalStatisticalInformation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PhysicalStatisticalInformationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PhysicalStatisticalInformation.");
                        resultArrayList.add(new CIM_PhysicalStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PhysicalStatisticalInformation.");
                        resultArrayList.add(new CIM_PhysicalStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PhysicalStatisticalInformation.");
                        resultArrayList.add(new CIM_PhysicalStatisticalInformation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PhysicalStatisticalInformation getInstance(WBEMClient client,
    ...
    public final static CIM_PhysicalStatisticalInformation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_PhysicalStatisticalInformationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PhysicalStatisticalInformation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PhysicalStatisticalInformation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_PhysicalStatisticalInformation getInstance(WBEMClient client,
            ...
            String PhysicalCreationClassName, String Tag
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PhysicalStatisticalInformation.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_PhysicalStatisticalInformation.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME);

        setThis = PhysicalCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_PhysicalStatisticalInformation.PROPERTY_PHYSICALCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[3] = new CIMProperty(CIM_PhysicalStatisticalInformation.PROPERTY_TAG.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PhysicalStatisticalInformation createInstance(WBEMClient client,
            CIM_PhysicalStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PhysicalStatisticalInformation newDataInstance = CIM_PhysicalStatisticalInformationHelper
     ...
     */
    public final static CIM_PhysicalStatisticalInformation modifyInstance(WBEMClient client,
            CIM_PhysicalStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PhysicalStatisticalInformation dataInstance2 = CIM_PhysicalStatisticalInformationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_PhysicalStatisticalInformation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PhysicalStatisticalInformation.getPackages());
    }
