 ...
 * 
 * Description: Helper class for CIM_PortImplementsEndpoint
 *    
 * 
 * generated Class
 * @see CIM_PortImplementsEndpoint
 */
...
public class CIM_PortImplementsEndpointHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PortImplementsEndpoint or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PortImplementsEndpoint.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PortImplementsEndpoint.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PortImplementsEndpoint or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PortImplementsEndpoint(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PortImplementsEndpointHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PortImplementsEndpoint.");
                        resultArrayList.add(new CIM_PortImplementsEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PortImplementsEndpoint.");
                        resultArrayList.add(new CIM_PortImplementsEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PortImplementsEndpoint.");
                        resultArrayList.add(new CIM_PortImplementsEndpoint(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PortImplementsEndpoint getInstance(WBEMClient client,
    ...
    public final static CIM_PortImplementsEndpoint getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PortImplementsEndpoint) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PortImplementsEndpoint(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PortImplementsEndpoint getInstance(WBEMClient client, String namespace,
            CIM_LogicalPort Antecedent, CIM_ProtocolEndpoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PortImplementsEndpoint.PROPERTY_ANTECEDENT_CIM_LOGICALPORT.NAME,
                new CIMDataType(CIM_LogicalPort.CIM_CLASS_NAME), setThis, false, false,
                CIM_PortImplementsEndpoint.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_PortImplementsEndpoint.PROPERTY_DEPENDENT_CIM_PROTOCOLENDPOINT.NAME,
                new CIMDataType(CIM_ProtocolEndpoint.CIM_CLASS_NAME), setThis, false, false,
                CIM_PortImplementsEndpoint.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PortImplementsEndpoint createInstance(WBEMClient client,
            CIM_PortImplementsEndpoint dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PortImplementsEndpoint newDataInstance = CIM_PortImplementsEndpointHelper.getInstance(
     ...
     */
    public final static CIM_PortImplementsEndpoint modifyInstance(WBEMClient client,
            CIM_PortImplementsEndpoint dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PortImplementsEndpoint dataInstance2 = CIM_PortImplementsEndpointHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_PortImplementsEndpoint dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PortImplementsEndpoint.getPackages());
    }
