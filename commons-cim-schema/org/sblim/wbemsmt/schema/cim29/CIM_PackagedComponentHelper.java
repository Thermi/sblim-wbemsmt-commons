 ...
 * 
 * Description: Helper class for CIM_PackagedComponent
 *    
 * 
 * generated Class
 * @see CIM_PackagedComponent
 */
...
public class CIM_PackagedComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PackagedComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PackagedComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PackagedComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PackagedComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PackagedComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PackagedComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PackagedComponent.");
                        resultArrayList.add(new CIM_PackagedComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PackagedComponent.");
                        resultArrayList.add(new CIM_PackagedComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PackagedComponent.");
                        resultArrayList.add(new CIM_PackagedComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PackagedComponent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_PackagedComponent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PackagedComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PackagedComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PackagedComponent getInstance(WBEMClient client, String namespace,
            CIM_PhysicalPackage GroupComponent, CIM_PhysicalComponent PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PackagedComponent.PROPERTY_GROUPCOMPONENT_CIM_PHYSICALPACKAGE.NAME,
                new CIMDataType(CIM_PhysicalPackage.CIM_CLASS_NAME), setThis, false, false,
                CIM_PackagedComponent.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_PackagedComponent.PROPERTY_PARTCOMPONENT_CIM_PHYSICALCOMPONENT.NAME,
                new CIMDataType(CIM_PhysicalComponent.CIM_CLASS_NAME), setThis, false, false,
                CIM_PackagedComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PackagedComponent createInstance(WBEMClient client,
            CIM_PackagedComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_PackagedComponent newDataInstance = CIM_PackagedComponentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_PackagedComponent modifyInstance(WBEMClient client,
            CIM_PackagedComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PackagedComponent dataInstance2 = CIM_PackagedComponentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PackagedComponent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PackagedComponent.getPackages());
    }
