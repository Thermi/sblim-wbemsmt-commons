 ...
 * 
 * Description: Helper class for CIM_LogicalDiskBasedOnPartition
 *    
 * 
 * generated Class
 * @see CIM_LogicalDiskBasedOnPartition
 */
...
public class CIM_LogicalDiskBasedOnPartitionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_LogicalDiskBasedOnPartition or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalDiskBasedOnPartition.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_LogicalDiskBasedOnPartition.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_LogicalDiskBasedOnPartition or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_LogicalDiskBasedOnPartition(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_LogicalDiskBasedOnPartitionHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_LogicalDiskBasedOnPartition.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnPartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LogicalDiskBasedOnPartition.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnPartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LogicalDiskBasedOnPartition.");
                        resultArrayList.add(new CIM_LogicalDiskBasedOnPartition(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LogicalDiskBasedOnPartition getInstance(WBEMClient client,
    ...
    public final static CIM_LogicalDiskBasedOnPartition getInstance(WBEMClient client,
        ...
        Class clazz = CIM_LogicalDiskBasedOnPartitionHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_LogicalDiskBasedOnPartition) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_LogicalDiskBasedOnPartition(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_LogicalDiskBasedOnPartition getInstance(WBEMClient client,
            String namespace, CIM_DiskPartition Antecedent, CIM_LogicalDisk Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_LogicalDiskBasedOnPartition.PROPERTY_ANTECEDENT_CIM_DISKPARTITION.NAME,
                new CIMDataType(CIM_DiskPartition.CIM_CLASS_NAME), setThis, false, false,
                CIM_LogicalDiskBasedOnPartition.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_LogicalDiskBasedOnPartition.PROPERTY_DEPENDENT_CIM_LOGICALDISK.NAME,
                new CIMDataType(CIM_LogicalDisk.CIM_CLASS_NAME), setThis, false, false,
                CIM_LogicalDiskBasedOnPartition.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_LogicalDiskBasedOnPartition createInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnPartition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_LogicalDiskBasedOnPartition newDataInstance = CIM_LogicalDiskBasedOnPartitionHelper
     ...
     */
    public final static CIM_LogicalDiskBasedOnPartition modifyInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnPartition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LogicalDiskBasedOnPartition dataInstance2 = CIM_LogicalDiskBasedOnPartitionHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_LogicalDiskBasedOnPartition dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LogicalDiskBasedOnPartition.getPackages());
    }
