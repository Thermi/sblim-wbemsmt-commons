...
public class CIM_RegisteredSubProfileHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RegisteredSubProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RegisteredSubProfile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_RegisteredSubProfile.");
                        resultArrayList.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RegisteredSubProfile.");
                        resultArrayList.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RegisteredSubProfile.");
                        resultArrayList.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RegisteredSubProfile getInstance(WBEMClient client,
    ...
    public final static CIM_RegisteredSubProfile getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_RegisteredSubProfile.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RegisteredSubProfile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_RegisteredSubProfile createInstance(WBEMClient client,
            CIM_RegisteredSubProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_RegisteredSubProfile newDataInstance = CIM_RegisteredSubProfileHelper.getInstance(
     ...
     */
    public final static CIM_RegisteredSubProfile modifyInstance(WBEMClient client,
            CIM_RegisteredSubProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RegisteredSubProfile dataInstance2 = CIM_RegisteredSubProfileHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RegisteredSubProfile dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RegisteredSubProfile.getPackages());
    }
