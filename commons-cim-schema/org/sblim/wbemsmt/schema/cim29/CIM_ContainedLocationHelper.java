 ...
 * 
 * Description: Helper class for CIM_ContainedLocation
 *    
 * 
 * generated Class
 * @see CIM_ContainedLocation
 */
...
public class CIM_ContainedLocationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ContainedLocation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ContainedLocation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ContainedLocation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ContainedLocation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ContainedLocation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ContainedLocationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ContainedLocation.");
                        resultArrayList.add(new CIM_ContainedLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ContainedLocation.");
                        resultArrayList.add(new CIM_ContainedLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ContainedLocation.");
                        resultArrayList.add(new CIM_ContainedLocation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ContainedLocation getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ContainedLocation getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ContainedLocation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ContainedLocation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ContainedLocation getInstance(WBEMClient client, String namespace,
            CIM_Location GroupComponent, CIM_Location PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ContainedLocation.PROPERTY_GROUPCOMPONENT_CIM_LOCATION.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ContainedLocation.PROPERTY_PARTCOMPONENT_CIM_LOCATION.NAME, new CIMDataType(
                        CIM_Location.CIM_CLASS_NAME), setThis, false, false,
                CIM_ContainedLocation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ContainedLocation createInstance(WBEMClient client,
            CIM_ContainedLocation dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ContainedLocation newDataInstance = CIM_ContainedLocationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ContainedLocation modifyInstance(WBEMClient client,
            CIM_ContainedLocation dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ContainedLocation dataInstance2 = CIM_ContainedLocationHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ContainedLocation dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ContainedLocation.getPackages());
    }
