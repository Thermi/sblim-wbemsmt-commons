...
public class CIM_FCPortStatistics extends CIM_NetworkPortStatistics  {
	...
	*/
	...
	/**
	*	Count of transitions in/out of BBcredit zero state. The other side is not providing any credit.
	*/
	public final static String CIM_PROPERTY_BUFFERCREDITNOTRECEIVED = "BufferCreditNotReceived"; //$NON-NLS-1$
	/**
	*	Number of times that the CRC in a frame does not match the CRC computed by the receiver. This count is part of the Link Error Status Block (LESB).
	*/
	public final static String CIM_PROPERTY_CRCERRORS = "CRCErrors"; //$NON-NLS-1$
	/**
	*	Class1FBSY is the count of times that FBSY was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS1FBSY = "Class1FBSY"; //$NON-NLS-1$
	/**
	*	Class1FRJT is the count of times that FRJT was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS1FRJT = "Class1FRJT"; //$NON-NLS-1$
	/**
	*	Class1PBSY is the count of times that PBSY was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS1PBSY = "Class1PBSY"; //$NON-NLS-1$
	/**
	*	Class1PRJT is the count of times that PRJT was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS1PRJT = "Class1PRJT"; //$NON-NLS-1$
	/**
	*	Class2FBSY is the count of times that FBSY was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS2FBSY = "Class2FBSY"; //$NON-NLS-1$
	/**
	*	Class2FRJT is the count of times that FRJT was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS2FRJT = "Class2FRJT"; //$NON-NLS-1$
	/**
	*	Class2PBSY is the count of times that PBSY was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS2PBSY = "Class2PBSY"; //$NON-NLS-1$
	/**
	*	Class2PRJT is the count of times that PRJT was returned to the port.
	*/
	public final static String CIM_PROPERTY_CLASS2PRJT = "Class2PRJT"; //$NON-NLS-1$
	/**
	*	Class3FramesDiscarded is the count of class 3 frames that were discarded upon reception.
	*/
	public final static String CIM_PROPERTY_CLASS3FRAMESDISCARDED = "Class3FramesDiscarded"; //$NON-NLS-1$
	/**
	*	Count of invalid frame delimiters received at this port. An example is a frame with a class 2 start and a class 3 at the end.
	*/
	...
	*/
	...
	/**
	*	FBSYFrames is the count of times that FBSY was returned to the port.
	*/
	public final static String CIM_PROPERTY_FBSYFRAMES = "FBSYFrames"; //$NON-NLS-1$
	/**
	*	FRJTFrames is the count of times that FRJT was returned to the port.
	*/
	...
	*/
	...
	/**
	*	The number of transmission words that had an invalid character (8b10b code violation) in one or more of its characters, had a K28.5 (8b10b control) in its second, third or fourth character positions, and/or had an incorrect Beginning Running Disparity. This count is part of the Link Error Status Block (LESB).
	*/
	...
	*/
	...
	/**
	*	LinkFailure is the number of times a link error has occurred. This count is part of the Link Error Status Block (LESB).
	*/
	...
	*/
	...
	/**
	*	Number of times that signal is lost on the Port since last reset of the Device. This count is part of the Link Error Status Block (LESB).
	*/
	public final static String CIM_PROPERTY_LOSSOFSIGNALCOUNTER = "LossOfSignalCounter"; //$NON-NLS-1$
	/**
	*	Number of times that synchronization is lost on the Port since last reset of the Device. Synchronization is assumed lost after a timeout period (identified by the Receiver TransmitterTimeout property) is exceeded. This count is part of the Link Error Status Block (LESB).
	*/
	...
	*/
	...
	/**
	*	PBSYFrames is the count of times that PBSY was returned to the port.
	*/
	public final static String CIM_PROPERTY_PBSYFRAMES = "PBSYFrames"; //$NON-NLS-1$
	/**
	*	PRJTFrames is the count of times that PRJT was returned to the port.
	*/
	public final static String CIM_PROPERTY_PRJTFRAMES = "PRJTFrames"; //$NON-NLS-1$
	/**
	*	Count of primitive sequence protocol errors detected at this port. This count is part of the Link Error Status Block (LESB).
	*/
	public final static String CIM_PROPERTY_PRIMITIVESEQPROTOCOLERRCOUNT = "PrimitiveSeqProtocolErrCount"; //$NON-NLS-1$
	/**
	*	RXBroadcastFrames is the count of broadcast frames or packets received.
	*/
	...
	*/
	...
	/**
	*	TXBroadcastFrames is the count of broadcast frames or packets transmitted.
	*/
