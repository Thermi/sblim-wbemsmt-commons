...
public class CIM_UnixProcessHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_UnixProcess.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_UnixProcess.");
                        resultArrayList.add(new CIM_UnixProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_UnixProcess.");
                        resultArrayList.add(new CIM_UnixProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_UnixProcess.");
                        resultArrayList.add(new CIM_UnixProcess(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_UnixProcess getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_UnixProcess getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_UnixProcess getInstance(WBEMClient client, String namespace,
            ...
            String OSCreationClassName, String OSName
        ...
        keyProperties[0] = new CIMProperty(CIM_UnixProcess.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixProcess.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_UnixProcess.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixProcess.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_UnixProcess.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixProcess.CIM_CLASS_NAME);

        setThis = Handle;

        keyProperties[3] = new CIMProperty(CIM_UnixProcess.PROPERTY_HANDLE.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixProcess.CIM_CLASS_NAME);

        setThis = OSCreationClassName;

        keyProperties[4] = new CIMProperty(CIM_UnixProcess.PROPERTY_OSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixProcess.CIM_CLASS_NAME);

        setThis = OSName;

        keyProperties[5] = new CIMProperty(CIM_UnixProcess.PROPERTY_OSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixProcess.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_UnixProcess createInstance(WBEMClient client,
            CIM_UnixProcess dataInstance, boolean notifyDifferencies) throws WbemsmtException {
     ...
     */
    public final static CIM_UnixProcess modifyInstance(WBEMClient client,
            CIM_UnixProcess dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_UnixProcess dataInstance2 = CIM_UnixProcessHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_UnixProcess dataInstance)
            throws WbemsmtException {
