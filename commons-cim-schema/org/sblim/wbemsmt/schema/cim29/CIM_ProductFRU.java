...
public class CIM_ProductFRU extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
    ...
    public CIM_ProductFRU(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ProductFRU(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_Product_CIM_Product(WBEMClient client, String namespace,
        ...
        CIM_ProductFRU fco = new CIM_ProductFRU(client, namespace);
    ...
    public String getObjectName() {
        return CIM_ProductFRU.CIM_CLASS_NAME;
    }
