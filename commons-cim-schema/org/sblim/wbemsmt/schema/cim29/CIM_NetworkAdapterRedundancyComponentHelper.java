 ...
 * 
 * Description: Helper class for CIM_NetworkAdapterRedundancyComponent
 *    
 * 
 * generated Class
 * @see CIM_NetworkAdapterRedundancyComponent
 */
...
public class CIM_NetworkAdapterRedundancyComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_NetworkAdapterRedundancyComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_NetworkAdapterRedundancyComponent.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_NetworkAdapterRedundancyComponent or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_NetworkAdapterRedundancyComponent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_NetworkAdapterRedundancyComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_NetworkAdapterRedundancyComponentHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_NetworkAdapterRedundancyComponent.");
                        resultArrayList.add(new CIM_NetworkAdapterRedundancyComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_NetworkAdapterRedundancyComponent.");
                        resultArrayList.add(new CIM_NetworkAdapterRedundancyComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_NetworkAdapterRedundancyComponent.");
                        resultArrayList.add(new CIM_NetworkAdapterRedundancyComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_NetworkAdapterRedundancyComponent getInstance(WBEMClient client,
    ...
    public final static CIM_NetworkAdapterRedundancyComponent getInstance(WBEMClient client,
        ...
        Class clazz = CIM_NetworkAdapterRedundancyComponentHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_NetworkAdapterRedundancyComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_NetworkAdapterRedundancyComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_NetworkAdapterRedundancyComponent getInstance(WBEMClient client,
            String namespace, CIM_ExtraCapacityGroup GroupComponent,
            CIM_NetworkAdapter PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_NetworkAdapterRedundancyComponent.PROPERTY_GROUPCOMPONENT_CIM_EXTRACAPACITYGROUP.NAME,
                new CIMDataType(CIM_ExtraCapacityGroup.CIM_CLASS_NAME), setThis, false, false,
                CIM_NetworkAdapterRedundancyComponent.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_NetworkAdapterRedundancyComponent.PROPERTY_PARTCOMPONENT_CIM_NETWORKADAPTER.NAME,
     ...
     *
     */
    public final static CIM_NetworkAdapterRedundancyComponent createInstance(WBEMClient client,
            CIM_NetworkAdapterRedundancyComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_NetworkAdapterRedundancyComponent newDataInstance = CIM_NetworkAdapterRedundancyComponentHelper
     ...
     */
    public final static CIM_NetworkAdapterRedundancyComponent modifyInstance(WBEMClient client,
            CIM_NetworkAdapterRedundancyComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_NetworkAdapterRedundancyComponent dataInstance2 = CIM_NetworkAdapterRedundancyComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_NetworkAdapterRedundancyComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_NetworkAdapterRedundancyComponent.getPackages());
    }
