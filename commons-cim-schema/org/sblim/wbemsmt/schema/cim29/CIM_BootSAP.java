...
public class CIM_BootSAP extends CIM_ServiceAccessPoint  {
	...
	static {
		...
		for (int i = 0; i < CIM_ServiceAccessPoint.CIM_PropertyNameList.size(); i++) {
			...
			CIM_BootSAP.CIM_PropertyNameList.add(CIM_ServiceAccessPoint.CIM_PropertyNameList.elementAt(i));
		}
	...
	*	Class constructor
	*/	
	public CIM_BootSAP(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_BootSAP(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof CIM_BootSAP)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((CIM_BootSAP)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_BootSAP)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_BootSAP)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_BootSAP)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_BootSAP)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_BootSAP)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_BootSAP)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_BootSAP)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_BootSAP)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public ArrayList getAssociated_CIM_BootService_CIM_BootServiceAccessBySAPs(CIMClient cimClient,
	...
	public ArrayList getAssociated_CIM_BootService_CIM_BootServiceAccessBySAP_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_ComputerSystem_CIM_HostedBootSAPs(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_ComputerSystem_CIM_HostedBootSAP_Names(CIMClient cimClient, boolean deep) {
