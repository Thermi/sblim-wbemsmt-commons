 ...
 * 
 * Description: Helper class for CIM_HostedClusterService
 *    
 * 
 * generated Class
 * @see CIM_HostedClusterService
 */
...
public class CIM_HostedClusterServiceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostedClusterService or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedClusterService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_HostedClusterService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostedClusterService or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_HostedClusterService(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostedClusterServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HostedClusterService.");
                        resultArrayList.add(new CIM_HostedClusterService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedClusterService.");
                        resultArrayList.add(new CIM_HostedClusterService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedClusterService.");
                        resultArrayList.add(new CIM_HostedClusterService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedClusterService getInstance(WBEMClient client,
    ...
    public final static CIM_HostedClusterService getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostedClusterService) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostedClusterService(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostedClusterService getInstance(WBEMClient client, String namespace,
            CIM_Cluster Antecedent, CIM_ClusteringService Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedClusterService.PROPERTY_ANTECEDENT_CIM_CLUSTER.NAME, new CIMDataType(
                        CIM_Cluster.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostedClusterService.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_HostedClusterService.PROPERTY_DEPENDENT_CIM_CLUSTERINGSERVICE.NAME,
     ...
     *
     */
    public final static CIM_HostedClusterService createInstance(WBEMClient client,
            CIM_HostedClusterService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_HostedClusterService newDataInstance = CIM_HostedClusterServiceHelper.getInstance(
     ...
     */
    public final static CIM_HostedClusterService modifyInstance(WBEMClient client,
            CIM_HostedClusterService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedClusterService dataInstance2 = CIM_HostedClusterServiceHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedClusterService dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedClusterService.getPackages());
    }
