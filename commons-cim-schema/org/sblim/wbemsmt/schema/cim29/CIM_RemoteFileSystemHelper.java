 ...
 * 
 * Description: Helper class for CIM_RemoteFileSystem
 *    
 * 
 * generated Class
 * @see CIM_RemoteFileSystem
 */
...
public class CIM_RemoteFileSystemHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RemoteFileSystem or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RemoteFileSystem.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RemoteFileSystem.CIM_CLASS_NAME
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RemoteFileSystem or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_RemoteFileSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RemoteFileSystem(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RemoteFileSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RemoteFileSystem.");
                        resultArrayList.add(new CIM_RemoteFileSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RemoteFileSystem.");
                        resultArrayList.add(new CIM_RemoteFileSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RemoteFileSystem.");
                        resultArrayList.add(new CIM_RemoteFileSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RemoteFileSystem getInstance(WBEMClient client,
     ...
     */
    public final static CIM_RemoteFileSystem getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RemoteFileSystem) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RemoteFileSystem(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RemoteFileSystem getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_RemoteFileSystem.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RemoteFileSystem.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_RemoteFileSystem.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RemoteFileSystem.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_RemoteFileSystem.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RemoteFileSystem.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_RemoteFileSystem.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RemoteFileSystem.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_RemoteFileSystem createInstance(WBEMClient client,
            CIM_RemoteFileSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_RemoteFileSystem newDataInstance = CIM_RemoteFileSystemHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_RemoteFileSystem modifyInstance(WBEMClient client,
            CIM_RemoteFileSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RemoteFileSystem dataInstance2 = CIM_RemoteFileSystemHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RemoteFileSystem dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RemoteFileSystem.getPackages());
    }
