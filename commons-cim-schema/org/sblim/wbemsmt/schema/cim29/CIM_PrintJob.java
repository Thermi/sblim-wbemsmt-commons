 ...
 *
 *
 * Description: Description of a print request that is either waiting on a Queue for a Printer to become available, in the process of being output on a Printer, or that has previously been printed on a Printer. PrintJobs are weak to their current Queue, or to the last Queue that held them.
 * 
 */
...
public class CIM_PrintJob extends CIM_Job  {
	...
	*/
	...
	/**
	*	Provides additional textual descriptions of how this Job should be scheduled. This free-form string property is deprecated in lieu of the more semantically rich SettingData class, JobScheduleSettingData.
	*/
