 ...
 * 
 * Description: Helper class for CIM_ServiceStatisticalInformation
 *    
 * 
 * generated Class
 * @see CIM_ServiceStatisticalInformation
 */
...
public class CIM_ServiceStatisticalInformationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceStatisticalInformation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceStatisticalInformation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ServiceStatisticalInformation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceStatisticalInformation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ServiceStatisticalInformation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceStatisticalInformationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceStatisticalInformation.");
                        resultArrayList.add(new CIM_ServiceStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceStatisticalInformation.");
                        resultArrayList.add(new CIM_ServiceStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceStatisticalInformation.");
                        resultArrayList.add(new CIM_ServiceStatisticalInformation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceStatisticalInformation getInstance(WBEMClient client,
    ...
    public final static CIM_ServiceStatisticalInformation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_ServiceStatisticalInformationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceStatisticalInformation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceStatisticalInformation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceStatisticalInformation getInstance(WBEMClient client,
            String namespace, String CreationClassName, String Name,
            String ServiceCreationClassName, String ServiceName, String SystemCreationClassName,
            String SystemName
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ServiceStatisticalInformation.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ServiceStatisticalInformation.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_ServiceStatisticalInformation.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ServiceStatisticalInformation.CIM_CLASS_NAME);

        setThis = ServiceCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_ServiceStatisticalInformation.PROPERTY_SERVICECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ServiceStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[3] = new CIMProperty(
                CIM_ServiceStatisticalInformation.PROPERTY_SERVICENAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_ServiceStatisticalInformation.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[4] = new CIMProperty(
                CIM_ServiceStatisticalInformation.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ServiceStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[5] = new CIMProperty(
                CIM_ServiceStatisticalInformation.PROPERTY_SYSTEMNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_ServiceStatisticalInformation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ServiceStatisticalInformation createInstance(WBEMClient client,
            CIM_ServiceStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ServiceStatisticalInformation newDataInstance = CIM_ServiceStatisticalInformationHelper
     ...
     */
    public final static CIM_ServiceStatisticalInformation modifyInstance(WBEMClient client,
            CIM_ServiceStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceStatisticalInformation dataInstance2 = CIM_ServiceStatisticalInformationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ServiceStatisticalInformation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceStatisticalInformation.getPackages());
    }
