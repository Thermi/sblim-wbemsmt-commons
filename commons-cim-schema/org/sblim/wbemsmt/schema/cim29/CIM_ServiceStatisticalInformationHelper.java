/** 
 * CIM_ServiceStatisticalInformationHelper.java
 *
...
public final class CIM_ServiceStatisticalInformationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ServiceStatisticalInformation.");
						resultArrayList.add(new CIM_ServiceStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ServiceStatisticalInformation.");
						resultArrayList.add(new CIM_ServiceStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ServiceStatisticalInformation.");
						resultArrayList.add(new CIM_ServiceStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ServiceStatisticalInformation getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ServiceStatisticalInformationHelper.getInstance(cimClient, new CIM_ServiceStatisticalInformation(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ServiceStatisticalInformation getInstance(CIMClient cimClient, CIM_ServiceStatisticalInformation dataInstance) {
		...
		return CIM_ServiceStatisticalInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ServiceStatisticalInformation getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ServiceStatisticalInformation dataInstance = null;
		try {
			dataInstance = new CIM_ServiceStatisticalInformation(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_ServiceStatisticalInformation.getPackages();
	...
	*/	
	public final static CIM_ServiceStatisticalInformation createInstance(CIMClient cimClient, CIM_ServiceStatisticalInformation dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ServiceStatisticalInformation newDataInstance = null;
		try {
			newDataInstance = CIM_ServiceStatisticalInformationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ServiceStatisticalInformation modifyInstance(CIMClient cimClient, CIM_ServiceStatisticalInformation dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ServiceStatisticalInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ServiceStatisticalInformation dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ServiceStatisticalInformation dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ServiceStatisticalInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ServiceStatisticalInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ServiceStatisticalInformation.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ServiceStatisticalInformation.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ServiceStatisticalInformation.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
