 ...
 * 
 * Description: Helper class for CIM_PhysicalStatistics
 *    
 * 
 * generated Class
 * @see CIM_PhysicalStatistics
 */
...
public class CIM_PhysicalStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PhysicalStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PhysicalStatistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PhysicalStatistics.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PhysicalStatistics or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PhysicalStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PhysicalStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PhysicalStatistics.");
                        resultArrayList.add(new CIM_PhysicalStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PhysicalStatistics.");
                        resultArrayList.add(new CIM_PhysicalStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PhysicalStatistics.");
                        resultArrayList.add(new CIM_PhysicalStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PhysicalStatistics getInstance(WBEMClient client,
    ...
    public final static CIM_PhysicalStatistics getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PhysicalStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PhysicalStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PhysicalStatistics getInstance(WBEMClient client, String namespace,
            CIM_PhysicalStatisticalInformation Stats, CIM_PhysicalElement Element
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PhysicalStatistics.PROPERTY_STATS_CIM_PHYSICALSTATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME), setThis, false,
                false, CIM_PhysicalStatistics.CIM_CLASS_NAME);

        setThis = Element != null ? Element.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_PhysicalStatistics.PROPERTY_ELEMENT_CIM_PHYSICALELEMENT.NAME, new CIMDataType(
                        CIM_PhysicalElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_PhysicalStatistics.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PhysicalStatistics createInstance(WBEMClient client,
            CIM_PhysicalStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PhysicalStatistics newDataInstance = CIM_PhysicalStatisticsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_PhysicalStatistics modifyInstance(WBEMClient client,
            CIM_PhysicalStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PhysicalStatistics dataInstance2 = CIM_PhysicalStatisticsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PhysicalStatistics dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PhysicalStatistics.getPackages());
    }
