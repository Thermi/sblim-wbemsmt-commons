 ...
 * 
 * Description: Helper class for CIM_IdentificationOfManagedSystem
 *    
 * 
 * generated Class
 * @see CIM_IdentificationOfManagedSystem
 */
...
public class CIM_IdentificationOfManagedSystemHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_IdentificationOfManagedSystem or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_IdentificationOfManagedSystem.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_IdentificationOfManagedSystem.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_IdentificationOfManagedSystem or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_IdentificationOfManagedSystem(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_IdentificationOfManagedSystemHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_IdentificationOfManagedSystem.");
                        resultArrayList.add(new CIM_IdentificationOfManagedSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_IdentificationOfManagedSystem.");
                        resultArrayList.add(new CIM_IdentificationOfManagedSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_IdentificationOfManagedSystem.");
                        resultArrayList.add(new CIM_IdentificationOfManagedSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_IdentificationOfManagedSystem getInstance(WBEMClient client,
    ...
    public final static CIM_IdentificationOfManagedSystem getInstance(WBEMClient client,
        ...
        Class clazz = CIM_IdentificationOfManagedSystemHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_IdentificationOfManagedSystem) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_IdentificationOfManagedSystem(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_IdentificationOfManagedSystem getInstance(WBEMClient client,
            String namespace, CIM_System Antecedent, CIM_SystemIdentification Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_IdentificationOfManagedSystem.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME,
                new CIMDataType(CIM_System.CIM_CLASS_NAME), setThis, false, false,
                CIM_IdentificationOfManagedSystem.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_IdentificationOfManagedSystem.PROPERTY_DEPENDENT_CIM_SYSTEMIDENTIFICATION.NAME,
     ...
     *
     */
    public final static CIM_IdentificationOfManagedSystem createInstance(WBEMClient client,
            CIM_IdentificationOfManagedSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_IdentificationOfManagedSystem newDataInstance = CIM_IdentificationOfManagedSystemHelper
     ...
     */
    public final static CIM_IdentificationOfManagedSystem modifyInstance(WBEMClient client,
            CIM_IdentificationOfManagedSystem dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_IdentificationOfManagedSystem dataInstance2 = CIM_IdentificationOfManagedSystemHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_IdentificationOfManagedSystem dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_IdentificationOfManagedSystem.getPackages());
    }
