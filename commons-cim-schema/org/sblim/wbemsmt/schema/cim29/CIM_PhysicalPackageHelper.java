/** 
 * CIM_PhysicalPackageHelper.java
 *
...
public final class CIM_PhysicalPackageHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_PhysicalPackage.Java_Package_List.size(); i++) {
						if (!((String)(CIM_PhysicalPackage.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_PhysicalPackage.Java_Package_List.get(i))).endsWith(".")) {
							CIM_PhysicalPackage.Java_Package_List.setElementAt((String)(CIM_PhysicalPackage.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PhysicalPackage.");
						resultArrayList.add(new CIM_PhysicalPackage(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PhysicalPackage.");
						resultArrayList.add(new CIM_PhysicalPackage(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PhysicalPackage.");
						resultArrayList.add(new CIM_PhysicalPackage(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PhysicalPackage getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PhysicalPackageHelper.getInstance(cimClient, new CIM_PhysicalPackage(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalPackage getInstance(CIMClient cimClient, CIM_PhysicalPackage dataInstance) {
		...
		return CIM_PhysicalPackageHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalPackage getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PhysicalPackage dataInstance = null;
		try {
			dataInstance = new CIM_PhysicalPackage(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalPackage createInstance(CIMClient cimClient, CIM_PhysicalPackage dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PhysicalPackage newDataInstance = null;
		try {
			newDataInstance = CIM_PhysicalPackageHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalPackage modifyInstance(CIMClient cimClient, CIM_PhysicalPackage dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PhysicalPackageHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PhysicalPackage dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PhysicalPackage dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PhysicalPackage.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PhysicalPackage.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PhysicalPackage.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PhysicalPackage.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PhysicalPackage.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Depth(Float Depth) {
		return true;
	}

	public static boolean isValid_Height(Float Height) {
		return true;
	}

	public static boolean isValid_HotSwappable(Boolean HotSwappable) {
		return true;
	}

	public static boolean isValid_Removable(Boolean Removable) {
		return true;
	}

	public static boolean isValid_RemovalConditions(UnsignedInt16 RemovalConditions) {
		return true;
	}

	public static boolean isValid_Replaceable(Boolean Replaceable) {
		return true;
	}
	...
	public static boolean isValid_Width(Float Width) {
		return true;
	}
