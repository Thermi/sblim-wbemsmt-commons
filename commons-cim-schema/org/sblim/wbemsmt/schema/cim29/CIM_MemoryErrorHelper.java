 ...
 * 
 * Description: Helper class for CIM_MemoryError
 *    
 * 
 * generated Class
 * @see CIM_MemoryError
...
public class CIM_MemoryErrorHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MemoryError or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MemoryError.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_MemoryError.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MemoryError or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_MemoryError.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MemoryError(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MemoryErrorHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MemoryError.");
                        resultArrayList.add(new CIM_MemoryError(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MemoryError.");
                        resultArrayList.add(new CIM_MemoryError(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MemoryError.");
                        resultArrayList.add(new CIM_MemoryError(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MemoryError getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_MemoryError getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MemoryError) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MemoryError(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_MemoryError getInstance(WBEMClient client, String namespace,
            String DeviceCreationClassName, String DeviceID, String SystemCreationClassName,
            String SystemName
        ...
        keyProperties[0] = new CIMProperty(CIM_MemoryError.PROPERTY_DEVICECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MemoryError.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[1] = new CIMProperty(CIM_MemoryError.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MemoryError.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(CIM_MemoryError.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MemoryError.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_MemoryError.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MemoryError.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MemoryError createInstance(WBEMClient client,
            CIM_MemoryError dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MemoryError newDataInstance = CIM_MemoryErrorHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_MemoryError modifyInstance(WBEMClient client,
            CIM_MemoryError dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MemoryError dataInstance2 = CIM_MemoryErrorHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MemoryError dataInstance)
            throws WbemsmtException {
