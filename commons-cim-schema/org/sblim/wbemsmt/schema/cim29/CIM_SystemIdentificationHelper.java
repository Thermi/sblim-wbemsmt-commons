/** 
 * CIM_SystemIdentificationHelper.java
 *
...
public final class CIM_SystemIdentificationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SystemIdentification.");
						resultArrayList.add(new CIM_SystemIdentification(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SystemIdentification.");
						resultArrayList.add(new CIM_SystemIdentification(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SystemIdentification.");
						resultArrayList.add(new CIM_SystemIdentification(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SystemIdentification getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SystemIdentificationHelper.getInstance(cimClient, new CIM_SystemIdentification(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SystemIdentification getInstance(CIMClient cimClient, CIM_SystemIdentification dataInstance) {
		...
		return CIM_SystemIdentificationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SystemIdentification getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SystemIdentification dataInstance = null;
		try {
			dataInstance = new CIM_SystemIdentification(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_SystemIdentification.getPackages();
	...
	*/	
	public final static CIM_SystemIdentification createInstance(CIMClient cimClient, CIM_SystemIdentification dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SystemIdentification newDataInstance = null;
		try {
			newDataInstance = CIM_SystemIdentificationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SystemIdentification modifyInstance(CIMClient cimClient, CIM_SystemIdentification dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SystemIdentificationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SystemIdentification dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SystemIdentification dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SystemIdentification.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SystemIdentification.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SystemIdentification.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SystemIdentification.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SystemIdentification.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_FormatDescriptions(String[] FormatDescriptions) {
		return true;
	}

	public static boolean isValid_IdentificationData(String[] IdentificationData) {
		return true;
	}

	public static boolean isValid_IdentificationFormats(UnsignedInt16[] IdentificationFormats) {
		return true;
	}
	...
	public static boolean isValid_NamespaceCreationClassName(String NamespaceCreationClassName) {
		return true;
	}

	public static boolean isValid_NamespaceName(String NamespaceName) {
		return true;
	}

	public static boolean isValid_ObjectManagerCreationClassName(String ObjectManagerCreationClassName) {
		return true;
	}

	public static boolean isValid_ObjectManagerName(String ObjectManagerName) {
		return true;
	}
