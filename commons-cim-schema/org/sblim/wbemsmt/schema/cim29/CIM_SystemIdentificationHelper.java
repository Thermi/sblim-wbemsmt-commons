 ...
 * 
 * Description: Helper class for CIM_SystemIdentification
 *    
 * 
 * generated Class
 * @see CIM_SystemIdentification
 */
...
public class CIM_SystemIdentificationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemIdentification or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemIdentification.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemIdentification.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemIdentification or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SystemIdentification(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemIdentificationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemIdentification.");
                        resultArrayList.add(new CIM_SystemIdentification(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemIdentification.");
                        resultArrayList.add(new CIM_SystemIdentification(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemIdentification.");
                        resultArrayList.add(new CIM_SystemIdentification(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemIdentification getInstance(WBEMClient client,
    ...
    public final static CIM_SystemIdentification getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemIdentification) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemIdentification(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemIdentification getInstance(WBEMClient client, String namespace,
            String CreationClassName, String Name, String NamespaceCreationClassName,
            String NamespaceName, String ObjectManagerCreationClassName, String ObjectManagerName,
            String SystemCreationClassName, String SystemName
        ...
        CIMProperty[] keyProperties = new CIMProperty[8];
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemIdentification.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_SystemIdentification.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);

        setThis = NamespaceCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_SystemIdentification.PROPERTY_NAMESPACECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);

        setThis = NamespaceName;

        keyProperties[3] = new CIMProperty(CIM_SystemIdentification.PROPERTY_NAMESPACENAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);

        setThis = ObjectManagerCreationClassName;

        keyProperties[4] = new CIMProperty(
                CIM_SystemIdentification.PROPERTY_OBJECTMANAGERCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);

        setThis = ObjectManagerName;

        keyProperties[5] = new CIMProperty(
                CIM_SystemIdentification.PROPERTY_OBJECTMANAGERNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[6] = new CIMProperty(
                CIM_SystemIdentification.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[7] = new CIMProperty(CIM_SystemIdentification.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemIdentification.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemIdentification createInstance(WBEMClient client,
            CIM_SystemIdentification dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SystemIdentification newDataInstance = CIM_SystemIdentificationHelper.getInstance(
     ...
     */
    public final static CIM_SystemIdentification modifyInstance(WBEMClient client,
            CIM_SystemIdentification dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemIdentification dataInstance2 = CIM_SystemIdentificationHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemIdentification dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemIdentification.getPackages());
    }
