 ...
 * 
 * Description: Helper class for CIM_DeviceFile
 *    
 * 
 * generated Class
 * @see CIM_DeviceFile
...
public class CIM_DeviceFileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DeviceFile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DeviceFile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_DeviceFile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DeviceFile or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_DeviceFile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_DeviceFile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DeviceFileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_DeviceFile.");
                        resultArrayList.add(new CIM_DeviceFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_DeviceFile.");
                        resultArrayList.add(new CIM_DeviceFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DeviceFile.");
                        resultArrayList.add(new CIM_DeviceFile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DeviceFile getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_DeviceFile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {

        CIM_DeviceFile dataInstance = null;
        Class clazz = CIM_DeviceFileHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DeviceFile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DeviceFile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DeviceFile getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_DeviceFile.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DeviceFile.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_DeviceFile.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DeviceFile.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_DeviceFile.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DeviceFile.CIM_CLASS_NAME);

        setThis = FSCreationClassName;

        keyProperties[3] = new CIMProperty(CIM_DeviceFile.PROPERTY_FSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DeviceFile.CIM_CLASS_NAME);

        setThis = FSName;

        keyProperties[4] = new CIMProperty(CIM_DeviceFile.PROPERTY_FSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_DeviceFile.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[5] = new CIMProperty(CIM_DeviceFile.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_DeviceFile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_DeviceFile createInstance(WBEMClient client,
            CIM_DeviceFile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_DeviceFile newDataInstance = CIM_DeviceFileHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_DeviceFile modifyInstance(WBEMClient client,
            CIM_DeviceFile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DeviceFile dataInstance2 = CIM_DeviceFileHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_DeviceFile dataInstance)
            throws WbemsmtException {
