...
public class CIM_ProtocolEndpoint extends CIM_ServiceAccessPoint {
    ...
    public static class PROPERTY_PROTOCOLIFTYPE {
        ...
        /**
         * constant for value map entry ..4095
         */

        /**
         * constant for value entry IANA Reserved (corresponds to mapEntry ..4095 )
         */
        ...
        /**
         * constant for value map entry ..32767
         */

        /**
         * constant for value entry DMTF Reserved (corresponds to mapEntry ..32767 )
         */
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@28e628e6
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown, VALUE_ENTRY_Other,
                ...
                VALUE_ENTRY_802_11g, VALUE_ENTRY_802_11h, VALUE_ENTRY_DMTF_Reserved,
    ...
    public static class PROPERTY_PROTOCOLTYPE {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@1bc61bc6
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public boolean set_ProtocolIFType(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PROTOCOLIFTYPE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ProtocolIFType(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_ProtocolType(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PROTOCOLTYPE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ProtocolType(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_TimeOfLastStateChange(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_TIMEOFLASTSTATECHANGE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_TimeOfLastStateChange(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    /**
     * Get the list with CIM_ServiceAccessPoint objects associated by the association CIM_BindsTo
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_BindsTos(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ServiceAccessPoint_CIM_BindsTos(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO, CIM_ServiceAccessPoint.CIM_CLASS_NAME, null,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO or a subclass 
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_BindsTos(WBEMClient cimClient,
        ...
        return getAssociated_CIM_ServiceAccessPoint_CIM_BindsTos(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO, resultClass, role, resultRole, false, false,
                null);
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_BindsTos(WBEMClient cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_ProtocolEndpointHelper.checkException(enumeration);
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_ProtocolEndpointHelper.findClass(cimClient, cimInstance);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_BindsTo
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_BindsToNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ServiceAccessPoint_CIM_BindsToNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO, CIM_ServiceAccessPoint.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_BindsToNames(
            WBEMClient cimClient, String resultClass, String role, String resultRole)
            throws WbemsmtException {

        return getAssociated_CIM_ServiceAccessPoint_CIM_BindsToNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO, resultClass, role, resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_BindsToNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO,
    ...
    /**
     * Get the list with CIM_BindsTo associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_BindsTo(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_BindsToHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_BindsTo(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_BindsTo
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_BindsTo(WBEMClient cimClient, String role,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_BINDSTO, role));
        }
    ...
    /**
     * Get the list with CIM_Service objects associated by the association CIM_ProvidesEndpoint
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_Service_CIM_ProvidesEndpoints(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Service_CIM_ProvidesEndpoints(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PROVIDESENDPOINT, CIM_Service.CIM_CLASS_NAME, null,
                null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_Service_CIM_ProvidesEndpointNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Service_CIM_ProvidesEndpointNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PROVIDESENDPOINT, CIM_Service.CIM_CLASS_NAME, null,
                null);
    }
    ...
    /**
     * Get the list with CIM_LogicalPort objects associated by the association CIM_PortImplementsEndpoint
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_LogicalPort_CIM_PortImplementsEndpoints(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_LogicalPort_CIM_PortImplementsEndpoints(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PORTIMPLEMENTSENDPOINT,
                CIM_LogicalPort.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_LogicalPort_CIM_PortImplementsEndpointNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_LogicalPort_CIM_PortImplementsEndpointNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PORTIMPLEMENTSENDPOINT,
