/** 
 * CIM_IndicationSubscriptionHelper.java
 *
...
public final class CIM_IndicationSubscriptionHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_IndicationSubscription(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_IndicationSubscription.Java_Package_List.size(); i++) {
						if (!((String)(CIM_IndicationSubscription.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_IndicationSubscription.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_IndicationSubscription.Java_Package_List.setElementAt((String)(CIM_IndicationSubscription.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_IndicationSubscription.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_IndicationSubscription.");
						resultArrayList.add(new CIM_IndicationSubscription(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_IndicationSubscription.");
						resultArrayList.add(new CIM_IndicationSubscription(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IndicationSubscription.");
						resultArrayList.add(new CIM_IndicationSubscription(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_IndicationSubscription getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_IndicationSubscriptionHelper.getInstance(cimClient, new CIM_IndicationSubscription(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IndicationSubscription getInstance(CIMClient cimClient, CIM_IndicationSubscription dataInstance) {
		...
		return CIM_IndicationSubscriptionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IndicationSubscription getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_IndicationSubscription dataInstance = null;
		try {
			dataInstance = new CIM_IndicationSubscription(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IndicationSubscription createInstance(CIMClient cimClient, CIM_IndicationSubscription dataInstance, boolean notifyDifferencies){ 
		...
		CIM_IndicationSubscription newDataInstance = null;
		try {
			newDataInstance = CIM_IndicationSubscriptionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IndicationSubscription modifyInstance(CIMClient cimClient, CIM_IndicationSubscription dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_IndicationSubscriptionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_IndicationSubscription dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_IndicationSubscription dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_IndicationSubscription.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_IndicationSubscription.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_IndicationSubscription.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_IndicationSubscription.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_IndicationSubscription.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_FailureTriggerTimeInterval(UnsignedInt64 FailureTriggerTimeInterval) {
		return true;
	}

	public static boolean isValid_OnFatalErrorPolicy(UnsignedInt16 OnFatalErrorPolicy) {
		return true;
	}

	public static boolean isValid_OtherOnFatalErrorPolicy(String OtherOnFatalErrorPolicy) {
		return true;
	}

	public static boolean isValid_OtherRepeatNotificationPolicy(String OtherRepeatNotificationPolicy) {
		return true;
	}

	public static boolean isValid_OtherSubscriptionState(String OtherSubscriptionState) {
		return true;
	}

	public static boolean isValid_RepeatNotificationCount(UnsignedInt16 RepeatNotificationCount) {
		return true;
	}

	public static boolean isValid_RepeatNotificationGap(UnsignedInt64 RepeatNotificationGap) {
		return true;
	}

	public static boolean isValid_RepeatNotificationInterval(UnsignedInt64 RepeatNotificationInterval) {
		return true;
	}

	public static boolean isValid_RepeatNotificationPolicy(UnsignedInt16 RepeatNotificationPolicy) {
		return true;
	}

	public static boolean isValid_SubscriptionDuration(UnsignedInt64 SubscriptionDuration) {
		return true;
	}

	public static boolean isValid_SubscriptionStartTime(Calendar SubscriptionStartTime) {
		return true;
	}

	public static boolean isValid_SubscriptionState(UnsignedInt16 SubscriptionState) {
		return true;
	}

	public static boolean isValid_SubscriptionTimeRemaining(UnsignedInt64 SubscriptionTimeRemaining) {
		return true;
	}

	public static boolean isValid_TimeOfLastStateChange(Calendar TimeOfLastStateChange) {
		return true;
	}

	public static boolean isValid_CIM_IndicationFilter(CIM_IndicationFilter CIM_IndicationFilter) {
		return true;
	}

	public static boolean isValid_CIM_ListenerDestination(CIM_ListenerDestination CIM_ListenerDestination) {
		return true;
	}
