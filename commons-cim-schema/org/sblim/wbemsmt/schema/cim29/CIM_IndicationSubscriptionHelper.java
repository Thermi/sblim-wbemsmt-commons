...
public class CIM_IndicationSubscriptionHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_IndicationSubscription.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_IndicationSubscription.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_IndicationSubscription.");
                        resultArrayList.add(new CIM_IndicationSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_IndicationSubscription.");
                        resultArrayList.add(new CIM_IndicationSubscription(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_IndicationSubscription.");
                        resultArrayList.add(new CIM_IndicationSubscription(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_IndicationSubscription getInstance(WBEMClient client,
    ...
    public final static CIM_IndicationSubscription getInstance(WBEMClient client, String namespace,
            CIM_IndicationFilter Filter, CIM_ListenerDestination Handler
        ...
        keyProperties[0] = new CIMProperty(
                CIM_IndicationSubscription.PROPERTY_FILTER_CIM_INDICATIONFILTER.NAME,
                new CIMDataType(CIM_IndicationFilter.CIM_CLASS_NAME), setThis, false, false,
                CIM_IndicationSubscription.CIM_CLASS_NAME);

        setThis = Handler != null ? Handler.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_IndicationSubscription.PROPERTY_HANDLER_CIM_LISTENERDESTINATION.NAME,
                new CIMDataType(CIM_ListenerDestination.CIM_CLASS_NAME), setThis, false, false,
                CIM_IndicationSubscription.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_IndicationSubscription createInstance(WBEMClient client,
            CIM_IndicationSubscription dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_IndicationSubscription newDataInstance = CIM_IndicationSubscriptionHelper.getInstance(
     ...
     */
    public final static CIM_IndicationSubscription modifyInstance(WBEMClient client,
            CIM_IndicationSubscription dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_IndicationSubscription dataInstance2 = CIM_IndicationSubscriptionHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_IndicationSubscription dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_IndicationSubscription.getPackages());
    }
