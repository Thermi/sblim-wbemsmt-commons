 ...
 * 
 * Description: Helper class for CIM_Export
 *    
 * 
 * generated Class
 * @see CIM_Export
...
public class CIM_ExportHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Export or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Export.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Export.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Export or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Export.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Export(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ExportHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Export.");
                        resultArrayList.add(new CIM_Export(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Export.");
                        resultArrayList.add(new CIM_Export(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Export.");
                        resultArrayList.add(new CIM_Export(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Export getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Export getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Export) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Export(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Export getInstance(WBEMClient client, String namespace,
            CIM_LocalFileSystem LocalFS, CIM_Directory Directory
        ...
        setThis = LocalFS != null ? LocalFS.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(CIM_Export.PROPERTY_LOCALFS_CIM_LOCALFILESYSTEM.NAME,
                new CIMDataType(CIM_LocalFileSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_Export.CIM_CLASS_NAME);

        setThis = Directory != null ? Directory.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_Export.PROPERTY_DIRECTORY_CIM_DIRECTORY.NAME,
     ...
     *
     */
    public final static CIM_Export createInstance(WBEMClient client, CIM_Export dataInstance,
        ...
        CIM_Export newDataInstance = CIM_ExportHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Export modifyInstance(WBEMClient client, CIM_Export dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Export dataInstance2 = CIM_ExportHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Export dataInstance)
            throws WbemsmtException {
