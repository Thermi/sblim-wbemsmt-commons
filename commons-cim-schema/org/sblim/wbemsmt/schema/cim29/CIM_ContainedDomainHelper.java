 ...
 * 
 * Description: Helper class for CIM_ContainedDomain
 *    
 * 
 * generated Class
 * @see CIM_ContainedDomain
 */
...
public class CIM_ContainedDomainHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ContainedDomain or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ContainedDomain.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ContainedDomain.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ContainedDomain or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_ContainedDomain.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ContainedDomain(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ContainedDomainHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ContainedDomain.");
                        resultArrayList.add(new CIM_ContainedDomain(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ContainedDomain.");
                        resultArrayList.add(new CIM_ContainedDomain(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ContainedDomain.");
                        resultArrayList.add(new CIM_ContainedDomain(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ContainedDomain getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ContainedDomain getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ContainedDomain) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ContainedDomain(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ContainedDomain getInstance(WBEMClient client, String namespace,
            CIM_AdminDomain GroupComponent, CIM_AdminDomain PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ContainedDomain.PROPERTY_GROUPCOMPONENT_CIM_ADMINDOMAIN.NAME, new CIMDataType(
                        CIM_AdminDomain.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ContainedDomain.PROPERTY_PARTCOMPONENT_CIM_ADMINDOMAIN.NAME, new CIMDataType(
                        CIM_AdminDomain.CIM_CLASS_NAME), setThis, false, false,
                CIM_ContainedDomain.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ContainedDomain createInstance(WBEMClient client,
            CIM_ContainedDomain dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ContainedDomain newDataInstance = CIM_ContainedDomainHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ContainedDomain modifyInstance(WBEMClient client,
            CIM_ContainedDomain dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ContainedDomain dataInstance2 = CIM_ContainedDomainHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ContainedDomain dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ContainedDomain.getPackages());
    }
