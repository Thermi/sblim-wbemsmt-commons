 ...
 * 
 * Description: Helper class for CIM_ProductSoftwareComponent
 *    
 * 
 * generated Class
 * @see CIM_ProductSoftwareComponent
 */
...
public class CIM_ProductSoftwareComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductSoftwareComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductSoftwareComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductSoftwareComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductSoftwareComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProductSoftwareComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductSoftwareComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductSoftwareComponent.");
                        resultArrayList.add(new CIM_ProductSoftwareComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductSoftwareComponent.");
                        resultArrayList.add(new CIM_ProductSoftwareComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductSoftwareComponent.");
                        resultArrayList.add(new CIM_ProductSoftwareComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductSoftwareComponent getInstance(WBEMClient client,
    ...
    public final static CIM_ProductSoftwareComponent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductSoftwareComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductSoftwareComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductSoftwareComponent getInstance(WBEMClient client,
            String namespace, CIM_Product GroupComponent, CIM_SoftwareIdentity PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProductSoftwareComponent.PROPERTY_GROUPCOMPONENT_CIM_PRODUCT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProductSoftwareComponent.PROPERTY_PARTCOMPONENT_CIM_SOFTWAREIDENTITY.NAME,
     ...
     *
     */
    public final static CIM_ProductSoftwareComponent createInstance(WBEMClient client,
            CIM_ProductSoftwareComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProductSoftwareComponent newDataInstance = CIM_ProductSoftwareComponentHelper
     ...
     */
    public final static CIM_ProductSoftwareComponent modifyInstance(WBEMClient client,
            CIM_ProductSoftwareComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductSoftwareComponent dataInstance2 = CIM_ProductSoftwareComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProductSoftwareComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductSoftwareComponent.getPackages());
    }
