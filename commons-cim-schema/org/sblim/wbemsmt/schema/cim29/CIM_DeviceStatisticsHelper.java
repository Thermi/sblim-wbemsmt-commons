 ...
 * 
 * Description: Helper class for CIM_DeviceStatistics
 *    
 * 
 * generated Class
 * @see CIM_DeviceStatistics
 */
...
public class CIM_DeviceStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DeviceStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DeviceStatistics.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DeviceStatistics or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_DeviceStatistics.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_DeviceStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DeviceStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DeviceStatistics.");
                        resultArrayList.add(new CIM_DeviceStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DeviceStatistics.");
                        resultArrayList.add(new CIM_DeviceStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DeviceStatistics.");
                        resultArrayList.add(new CIM_DeviceStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DeviceStatistics getInstance(WBEMClient client,
     ...
     */
    public final static CIM_DeviceStatistics getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DeviceStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DeviceStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DeviceStatistics getInstance(WBEMClient client, String namespace,
            CIM_DeviceStatisticalInformation Stats, CIM_LogicalDevice Element
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DeviceStatistics.PROPERTY_STATS_CIM_DEVICESTATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_DeviceStatisticalInformation.CIM_CLASS_NAME), setThis, false,
                false, CIM_DeviceStatistics.CIM_CLASS_NAME);

        setThis = Element != null ? Element.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_DeviceStatistics.PROPERTY_ELEMENT_CIM_LOGICALDEVICE.NAME, new CIMDataType(
                        CIM_LogicalDevice.CIM_CLASS_NAME), setThis, false, false,
                CIM_DeviceStatistics.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_DeviceStatistics createInstance(WBEMClient client,
            CIM_DeviceStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_DeviceStatistics newDataInstance = CIM_DeviceStatisticsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_DeviceStatistics modifyInstance(WBEMClient client,
            CIM_DeviceStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DeviceStatistics dataInstance2 = CIM_DeviceStatisticsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_DeviceStatistics dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DeviceStatistics.getPackages());
    }
