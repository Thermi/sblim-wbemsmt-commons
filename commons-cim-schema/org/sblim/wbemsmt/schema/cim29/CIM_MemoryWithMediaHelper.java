 ...
 * 
 * Description: Helper class for CIM_MemoryWithMedia
 *    
 * 
 * generated Class
 * @see CIM_MemoryWithMedia
 */
...
public class CIM_MemoryWithMediaHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MemoryWithMedia or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MemoryWithMedia.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_MemoryWithMedia.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MemoryWithMedia or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_MemoryWithMedia.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MemoryWithMedia(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MemoryWithMediaHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MemoryWithMedia.");
                        resultArrayList.add(new CIM_MemoryWithMedia(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MemoryWithMedia.");
                        resultArrayList.add(new CIM_MemoryWithMedia(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MemoryWithMedia.");
                        resultArrayList.add(new CIM_MemoryWithMedia(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MemoryWithMedia getInstance(WBEMClient client,
     ...
     */
    public final static CIM_MemoryWithMedia getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MemoryWithMedia) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MemoryWithMedia(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_MemoryWithMedia getInstance(WBEMClient client, String namespace,
            CIM_PhysicalMemory Antecedent, CIM_PhysicalMedia Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_MemoryWithMedia.PROPERTY_ANTECEDENT_CIM_PHYSICALMEMORY.NAME, new CIMDataType(
                        CIM_PhysicalMemory.CIM_CLASS_NAME), setThis, false, false,
                CIM_MemoryWithMedia.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_MemoryWithMedia.PROPERTY_DEPENDENT_CIM_PHYSICALMEDIA.NAME, new CIMDataType(
                        CIM_PhysicalMedia.CIM_CLASS_NAME), setThis, false, false,
                CIM_MemoryWithMedia.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MemoryWithMedia createInstance(WBEMClient client,
            CIM_MemoryWithMedia dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MemoryWithMedia newDataInstance = CIM_MemoryWithMediaHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_MemoryWithMedia modifyInstance(WBEMClient client,
            CIM_MemoryWithMedia dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MemoryWithMedia dataInstance2 = CIM_MemoryWithMediaHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MemoryWithMedia dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MemoryWithMedia.getPackages());
    }
