 ...
 * 
 * Description: Helper class for CIM_FibrePortActiveLogin
 *    
 * 
 * generated Class
 * @see CIM_FibrePortActiveLogin
 */
...
public class CIM_FibrePortActiveLoginHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FibrePortActiveLogin or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FibrePortActiveLogin.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FibrePortActiveLogin.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FibrePortActiveLogin or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_FibrePortActiveLogin(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FibrePortActiveLoginHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FibrePortActiveLogin.");
                        resultArrayList.add(new CIM_FibrePortActiveLogin(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FibrePortActiveLogin.");
                        resultArrayList.add(new CIM_FibrePortActiveLogin(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FibrePortActiveLogin.");
                        resultArrayList.add(new CIM_FibrePortActiveLogin(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FibrePortActiveLogin getInstance(WBEMClient client,
    ...
    public final static CIM_FibrePortActiveLogin getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FibrePortActiveLogin) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FibrePortActiveLogin(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FibrePortActiveLogin getInstance(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 NegotiatedCOS, CIM_FibrePort LoginOriginator,
            CIM_FibrePort LoginResponder
        ...
        setThis = NegotiatedCOS;

        keyProperties[0] = new CIMProperty(CIM_FibrePortActiveLogin.PROPERTY_NEGOTIATEDCOS.NAME,
                CIMDataType.UINT16_T, setThis, true, false, CIM_FibrePortActiveLogin.CIM_CLASS_NAME);

        setThis = LoginOriginator != null ? LoginOriginator.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_FibrePortActiveLogin.PROPERTY_LOGINORIGINATOR_CIM_FIBREPORT.NAME,
                new CIMDataType(CIM_FibrePort.CIM_CLASS_NAME), setThis, false, false,
                CIM_FibrePortActiveLogin.CIM_CLASS_NAME);

        setThis = LoginResponder != null ? LoginResponder.getCimObjectPath() : null;

        keyProperties[2] = new CIMProperty(
                CIM_FibrePortActiveLogin.PROPERTY_LOGINRESPONDER_CIM_FIBREPORT.NAME,
                new CIMDataType(CIM_FibrePort.CIM_CLASS_NAME), setThis, false, false,
                CIM_FibrePortActiveLogin.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FibrePortActiveLogin createInstance(WBEMClient client,
            CIM_FibrePortActiveLogin dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FibrePortActiveLogin newDataInstance = CIM_FibrePortActiveLoginHelper.getInstance(
     ...
     */
    public final static CIM_FibrePortActiveLogin modifyInstance(WBEMClient client,
            CIM_FibrePortActiveLogin dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FibrePortActiveLogin dataInstance2 = CIM_FibrePortActiveLoginHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FibrePortActiveLogin dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FibrePortActiveLogin.getPackages());
    }
