 ...
 * 
 * Description: Helper class for CIM_AGPSoftwareFeature
 *    
 * 
 * generated Class
 * @see CIM_AGPSoftwareFeature
 */
...
public class CIM_AGPSoftwareFeatureHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_AGPSoftwareFeature or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AGPSoftwareFeature.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AGPSoftwareFeature.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_AGPSoftwareFeature or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_AGPSoftwareFeature.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_AGPSoftwareFeature(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_AGPSoftwareFeatureHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AGPSoftwareFeature.");
                        resultArrayList.add(new CIM_AGPSoftwareFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AGPSoftwareFeature.");
                        resultArrayList.add(new CIM_AGPSoftwareFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AGPSoftwareFeature.");
                        resultArrayList.add(new CIM_AGPSoftwareFeature(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AGPSoftwareFeature getInstance(WBEMClient client,
    ...
    public final static CIM_AGPSoftwareFeature getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_AGPSoftwareFeature) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_AGPSoftwareFeature(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_AGPSoftwareFeature getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_AGPSoftwareFeature.PROPERTY_IDENTIFYINGNUMBER.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_AGPSoftwareFeature.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_AGPSoftwareFeature.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_AGPSoftwareFeature.CIM_CLASS_NAME);

        setThis = ProductName;

        keyProperties[2] = new CIMProperty(CIM_AGPSoftwareFeature.PROPERTY_PRODUCTNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_AGPSoftwareFeature.CIM_CLASS_NAME);

        setThis = Vendor;

        keyProperties[3] = new CIMProperty(CIM_AGPSoftwareFeature.PROPERTY_VENDOR.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_AGPSoftwareFeature.CIM_CLASS_NAME);

        setThis = Version;

        keyProperties[4] = new CIMProperty(CIM_AGPSoftwareFeature.PROPERTY_VERSION.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_AGPSoftwareFeature.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_AGPSoftwareFeature createInstance(WBEMClient client,
            CIM_AGPSoftwareFeature dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_AGPSoftwareFeature newDataInstance = CIM_AGPSoftwareFeatureHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_AGPSoftwareFeature modifyInstance(WBEMClient client,
            CIM_AGPSoftwareFeature dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AGPSoftwareFeature dataInstance2 = CIM_AGPSoftwareFeatureHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_AGPSoftwareFeature dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AGPSoftwareFeature.getPackages());
    }
