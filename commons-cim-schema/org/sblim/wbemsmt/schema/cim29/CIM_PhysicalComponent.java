...
public class CIM_PhysicalComponent extends CIM_PhysicalElement {
    ...
    public static class PROPERTY_REMOVALCONDITIONS {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@79a079a0
    ...
    public CIM_PhysicalComponent(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_PhysicalComponent(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_PhysicalComponent() {
    }
    ...
    public static CIMProperty create_HotSwappable(WBEMClient client, String namespace,
        ...
        CIM_PhysicalComponent fco = new CIM_PhysicalComponent(client, namespace);
    ...
    /**
     * Get the list with CIM_StorageExtent objects associated by the association CIM_RealizesExtent
     * 
    ...
    public java.util.List getAssociated_CIM_StorageExtent_CIM_RealizesExtents(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_StorageExtent_CIM_RealizesExtents(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REALIZESEXTENT, CIM_StorageExtent.CIM_CLASS_NAME,
    ...
    public java.util.List getAssociated_CIM_StorageExtent_CIM_RealizesExtents(WBEMClient cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_PhysicalComponentHelper.checkException(enumeration);
    ...
    public java.util.List getAssociated_CIM_StorageExtent_CIM_RealizesExtentNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_StorageExtent_CIM_RealizesExtentNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REALIZESEXTENT, CIM_StorageExtent.CIM_CLASS_NAME,
                null, null);
    }
    ...
    /**
     * Get the list with CIM_PhysicalPackage objects associated by the association CIM_PackagedComponent
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_PhysicalPackage_CIM_PackagedComponents(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalPackage_CIM_PackagedComponents(cimClient,
    ...
    public java.util.List getAssociated_CIM_PhysicalPackage_CIM_PackagedComponentNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalPackage_CIM_PackagedComponentNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PACKAGEDCOMPONENT,
    ...
    public String getObjectName() {
        return CIM_PhysicalComponent.CIM_CLASS_NAME;
    }
