...
public class CIM_DependencyHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Dependency.CIM_CLASS_NAME,
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Dependency.");
                        resultArrayList.add(new CIM_Dependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Dependency.");
                        resultArrayList.add(new CIM_Dependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Dependency.");
                        resultArrayList.add(new CIM_Dependency(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Dependency getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Dependency getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_Dependency getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_Dependency.PROPERTY_ANTECEDENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_Dependency.PROPERTY_DEPENDENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
                        CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_Dependency.CIM_CLASS_NAME);
     ...
     */
    public final static void deleteInstance(WBEMClient client, CIM_Dependency dataInstance)
            throws WbemsmtException {
