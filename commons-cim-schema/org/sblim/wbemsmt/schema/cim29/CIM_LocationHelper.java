 ...
 * 
 * Description: Helper class for CIM_Location
 *    
 * 
 * generated Class
 * @see CIM_Location
...
public class CIM_LocationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Location or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Location.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Location.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Location or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Location.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Location(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_LocationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Location.");
                        resultArrayList.add(new CIM_Location(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Location.");
                        resultArrayList.add(new CIM_Location(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Location.");
                        resultArrayList.add(new CIM_Location(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Location getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Location getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Location) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Location(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Location getInstance(WBEMClient client, String namespace, String Name,
        ...
        keyProperties[0] = new CIMProperty(CIM_Location.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Location.CIM_CLASS_NAME);

        setThis = PhysicalPosition;

        keyProperties[1] = new CIMProperty(CIM_Location.PROPERTY_PHYSICALPOSITION.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Location.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Location createInstance(WBEMClient client, CIM_Location dataInstance,
        ...
        CIM_Location newDataInstance = CIM_LocationHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Location modifyInstance(WBEMClient client, CIM_Location dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Location dataInstance2 = CIM_LocationHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Location dataInstance)
            throws WbemsmtException {
