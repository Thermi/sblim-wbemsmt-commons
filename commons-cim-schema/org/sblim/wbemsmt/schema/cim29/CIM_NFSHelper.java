 ...
 * 
 * Description: Helper class for CIM_NFS
 *    
 * 
 * generated Class
 * @see CIM_NFS
...
public class CIM_NFSHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_NFS or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_NFS.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_NFS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_NFS or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_NFS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_NFS(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_NFSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_NFS.");
                        resultArrayList.add(new CIM_NFS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class "
                                ...
                                + " could not be found. Constructing instance of class CIM_NFS.");
                        resultArrayList.add(new CIM_NFS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_NFS.");
                        resultArrayList.add(new CIM_NFS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_NFS getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_NFS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_NFS) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_NFS(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_NFS getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_NFS.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_NFS.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_NFS.PROPERTY_CSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_NFS.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_NFS.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_NFS.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_NFS.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_NFS.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_NFS createInstance(WBEMClient client, CIM_NFS dataInstance,
        ...
        CIM_NFS newDataInstance = CIM_NFSHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_NFS modifyInstance(WBEMClient client, CIM_NFS dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_NFS dataInstance2 = CIM_NFSHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_NFS dataInstance)
            throws WbemsmtException {
