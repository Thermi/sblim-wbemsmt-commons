...
public final class CIM_StoragePoolHelper {

	public final static String CIM_CLASS_NAME = "CIM_StoragePool";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_StoragePool.Java_Package_List.size(); i++) {
						if (!((String)(CIM_StoragePool.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_StoragePool.Java_Package_List.get(i))).endsWith(".")) {
							CIM_StoragePool.Java_Package_List.setElementAt((String)(CIM_StoragePool.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StoragePool.");
						resultArrayList.add(new CIM_StoragePool(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StoragePool.");
						resultArrayList.add(new CIM_StoragePool(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StoragePool.");
						resultArrayList.add(new CIM_StoragePool(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StoragePool getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StoragePoolHelper.getInstance(cimClient, new CIM_StoragePool(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StoragePool getInstance(CIMClient cimClient, CIM_StoragePool dataInstance) {
		...
		return CIM_StoragePoolHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StoragePool getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StoragePool dataInstance = null;
		try {
			dataInstance = new CIM_StoragePool(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StoragePool createInstance(CIMClient cimClient, CIM_StoragePool dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StoragePool newDataInstance = null;
		try {
			newDataInstance = CIM_StoragePoolHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StoragePool modifyInstance(CIMClient cimClient, CIM_StoragePool dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StoragePoolHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StoragePool dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StoragePool dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StoragePool.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StoragePool.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StoragePool.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StoragePool.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StoragePool.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_PoolID(String PoolID) {
		return true;
	}
	...
	public static boolean isValid_RemainingManagedSpace(UnsignedInt64 RemainingManagedSpace) {
		return true;
	}

	public static boolean isValid_TotalManagedSpace(UnsignedInt64 TotalManagedSpace) {
		return true;
	}
