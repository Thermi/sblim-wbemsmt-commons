...
public final class CIM_ComputerSystemHelper {
	...
	*/	
	public final static CIM_ComputerSystem getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ComputerSystemHelper.getInstance(cimClient, new CIM_ComputerSystem(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ComputerSystem getInstance(CIMClient cimClient, CIM_ComputerSystem dataInstance) {
		...
		return CIM_ComputerSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ComputerSystem getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_ComputerSystem(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ComputerSystem createInstance(CIMClient cimClient, CIM_ComputerSystem dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ComputerSystem newDataInstance = null;
		try {
			newDataInstance = CIM_ComputerSystemHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ComputerSystem modifyInstance(CIMClient cimClient, CIM_ComputerSystem dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ComputerSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ComputerSystem dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ComputerSystem dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ComputerSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ComputerSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ComputerSystem.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ComputerSystem.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ComputerSystem.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Dedicated(UnsignedInt16[] Dedicated) {
		return true;
	}

	public static boolean isValid_IdentifyingDescriptions(String[] IdentifyingDescriptions) {
		return true;
	}
	...
	public static boolean isValid_OtherDedicatedDescriptions(String[] OtherDedicatedDescriptions) {
		return true;
	}

	public static boolean isValid_OtherIdentifyingInfo(String[] OtherIdentifyingInfo) {
		return true;
	}

	public static boolean isValid_PowerManagementCapabilities(UnsignedInt16[] PowerManagementCapabilities) {
		return true;
	}

	public static boolean isValid_ResetCapability(UnsignedInt16 ResetCapability) {
		return true;
	}
