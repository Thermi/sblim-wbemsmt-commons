...
public class CIM_ComputerSystemHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ComputerSystem.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ComputerSystem.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ComputerSystem.");
                        resultArrayList.add(new CIM_ComputerSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ComputerSystem.");
                        resultArrayList.add(new CIM_ComputerSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ComputerSystem.");
                        resultArrayList.add(new CIM_ComputerSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ComputerSystem getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ComputerSystem getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ComputerSystem getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ComputerSystem.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ComputerSystem.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_ComputerSystem.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ComputerSystem.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ComputerSystem createInstance(WBEMClient client,
            CIM_ComputerSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ComputerSystem newDataInstance = CIM_ComputerSystemHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ComputerSystem modifyInstance(WBEMClient client,
            CIM_ComputerSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ComputerSystem dataInstance2 = CIM_ComputerSystemHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ComputerSystem dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ComputerSystem.getPackages());
    }
