 ...
 * 
 * Description: Helper class for CIM_CompositeExtentBasedOn
 *    
 * 
 * generated Class
 * @see CIM_CompositeExtentBasedOn
 */
...
public class CIM_CompositeExtentBasedOnHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CompositeExtentBasedOn or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CompositeExtentBasedOn.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CompositeExtentBasedOn.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CompositeExtentBasedOn or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CompositeExtentBasedOnHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CompositeExtentBasedOn.");
                        resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CompositeExtentBasedOn.");
                        resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CompositeExtentBasedOn.");
                        resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CompositeExtentBasedOn getInstance(WBEMClient client,
    ...
    public final static CIM_CompositeExtentBasedOn getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CompositeExtentBasedOn) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CompositeExtentBasedOn(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CompositeExtentBasedOn getInstance(WBEMClient client, String namespace,
            CIM_StorageExtent Antecedent, CIM_CompositeExtent Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CompositeExtentBasedOn.PROPERTY_ANTECEDENT_CIM_STORAGEEXTENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_CompositeExtentBasedOn.PROPERTY_DEPENDENT_CIM_COMPOSITEEXTENT.NAME,
                new CIMDataType(CIM_CompositeExtent.CIM_CLASS_NAME), setThis, false, false,
                CIM_CompositeExtentBasedOn.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CompositeExtentBasedOn createInstance(WBEMClient client,
            CIM_CompositeExtentBasedOn dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CompositeExtentBasedOn newDataInstance = CIM_CompositeExtentBasedOnHelper.getInstance(
     ...
     */
    public final static CIM_CompositeExtentBasedOn modifyInstance(WBEMClient client,
            CIM_CompositeExtentBasedOn dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CompositeExtentBasedOn dataInstance2 = CIM_CompositeExtentBasedOnHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_CompositeExtentBasedOn dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CompositeExtentBasedOn.getPackages());
    }
