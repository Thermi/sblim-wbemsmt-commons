/** 
 * CIM_CompositeExtentBasedOnHelper.java
 *
...
public final class CIM_CompositeExtentBasedOnHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_CompositeExtentBasedOn.Java_Package_List.size(); i++) {
						if (!((String)(CIM_CompositeExtentBasedOn.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_CompositeExtentBasedOn.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_CompositeExtentBasedOn.Java_Package_List.setElementAt((String)(CIM_CompositeExtentBasedOn.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_CompositeExtentBasedOn.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CompositeExtentBasedOn.");
						resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CompositeExtentBasedOn.");
						resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CompositeExtentBasedOn.");
						resultArrayList.add(new CIM_CompositeExtentBasedOn(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_CompositeExtentBasedOn getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CompositeExtentBasedOnHelper.getInstance(cimClient, new CIM_CompositeExtentBasedOn(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CompositeExtentBasedOn getInstance(CIMClient cimClient, CIM_CompositeExtentBasedOn dataInstance) {
		...
		return CIM_CompositeExtentBasedOnHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CompositeExtentBasedOn getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_CompositeExtentBasedOn dataInstance = null;
		try {
			dataInstance = new CIM_CompositeExtentBasedOn(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CompositeExtentBasedOn createInstance(CIMClient cimClient, CIM_CompositeExtentBasedOn dataInstance, boolean notifyDifferencies){ 
		...
		CIM_CompositeExtentBasedOn newDataInstance = null;
		try {
			newDataInstance = CIM_CompositeExtentBasedOnHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CompositeExtentBasedOn modifyInstance(CIMClient cimClient, CIM_CompositeExtentBasedOn dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_CompositeExtentBasedOnHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_CompositeExtentBasedOn dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_CompositeExtentBasedOn dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_CompositeExtentBasedOn.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_CompositeExtentBasedOn.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_CompositeExtentBasedOn.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_CompositeExtentBasedOn.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_CompositeExtentBasedOn.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BlockSize(UnsignedInt64 BlockSize) {
		return true;
	}

	public static boolean isValid_LBAMappingIncludesCheckData(Boolean LBAMappingIncludesCheckData) {
		return true;
	}

	public static boolean isValid_LBAsMappedByDecrementing(Boolean LBAsMappedByDecrementing) {
		return true;
	}

	public static boolean isValid_NumberOfBlocks(UnsignedInt64 NumberOfBlocks) {
		return true;
	}

	public static boolean isValid_OrderIndex(UnsignedInt16 OrderIndex) {
		return true;
	}

	public static boolean isValid_UnitsBeforeCheckDataInterleave(UnsignedInt64 UnitsBeforeCheckDataInterleave) {
		return true;
	}

	public static boolean isValid_UnitsOfCheckData(UnsignedInt64 UnitsOfCheckData) {
		return true;
	}

	public static boolean isValid_UnitsOfUserData(UnsignedInt64 UnitsOfUserData) {
		return true;
	}

	public static boolean isValid_UserDataStripeDepth(UnsignedInt64 UserDataStripeDepth) {
		return true;
	}

	public static boolean isValid_CIM_StorageExtent(CIM_StorageExtent CIM_StorageExtent) {
		return true;
	}

	public static boolean isValid_CIM_CompositeExtent(CIM_CompositeExtent CIM_CompositeExtent) {
		return true;
	}
