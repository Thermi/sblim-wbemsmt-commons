...
public class CIM_Mount extends CIM_Dependency {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_FILESYSTEM {
        /**
    ...
    public CIM_Mount(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_Mount(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_Antecedent_CIM_Directory(WBEMClient client, String namespace,
        ...
        CIM_Mount fco = new CIM_Mount(client, namespace);
    ...
    public CIM_FileSystem get_Dependent_CIM_FileSystem(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_FILESYSTEM.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_FILESYSTEM.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Dependent_CIM_FileSystem(CIM_FileSystem newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_FILESYSTEM.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_FileSystem(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_Dependent_CIM_FileSystem(WBEMClient client, String namespace,
            CIM_FileSystem newValue) throws WbemsmtException {
        CIM_Mount fco = new CIM_Mount(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_FILESYSTEM.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_FileSystem(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_FILESYSTEM.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_FileSystem(
    ...
    public String getObjectName() {
        return CIM_Mount.CIM_CLASS_NAME;
    }
