 ...
 * 
 * Description: Helper class for CIM_MemberOfCollection
 *    
 * 
 * generated Class
 * @see CIM_MemberOfCollection
 */
...
public class CIM_MemberOfCollectionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MemberOfCollection or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MemberOfCollection.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_MemberOfCollection.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MemberOfCollection or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_MemberOfCollection.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MemberOfCollection(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MemberOfCollectionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MemberOfCollection.");
                        resultArrayList.add(new CIM_MemberOfCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MemberOfCollection.");
                        resultArrayList.add(new CIM_MemberOfCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MemberOfCollection.");
                        resultArrayList.add(new CIM_MemberOfCollection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MemberOfCollection getInstance(WBEMClient client,
    ...
    public final static CIM_MemberOfCollection getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MemberOfCollection) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MemberOfCollection(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_MemberOfCollection getInstance(WBEMClient client, String namespace,
            CIM_Collection Collection, CIM_ManagedElement Member
        ...
        keyProperties[0] = new CIMProperty(
                CIM_MemberOfCollection.PROPERTY_COLLECTION_CIM_COLLECTION.NAME, new CIMDataType(
                        CIM_Collection.CIM_CLASS_NAME), setThis, false, false,
                CIM_MemberOfCollection.CIM_CLASS_NAME);

        setThis = Member != null ? Member.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_MemberOfCollection.PROPERTY_MEMBER_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_MemberOfCollection createInstance(WBEMClient client,
            CIM_MemberOfCollection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_MemberOfCollection newDataInstance = CIM_MemberOfCollectionHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_MemberOfCollection modifyInstance(WBEMClient client,
            CIM_MemberOfCollection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MemberOfCollection dataInstance2 = CIM_MemberOfCollectionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MemberOfCollection dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MemberOfCollection.getPackages());
    }
