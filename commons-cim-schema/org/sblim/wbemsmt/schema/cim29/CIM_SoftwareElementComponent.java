...
public class CIM_SoftwareElementComponent extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREELEMENT {
        /**
    ...
    public CIM_SoftwareElementComponent(WBEMClient client, String namespace)
    ...
    public CIM_SoftwareElementComponent(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SoftwareElementComponent() {
    }
    ...
    public CIM_SoftwareElement get_GroupComponent_CIM_SoftwareElement(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREELEMENT.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREELEMENT.NAME
    ...
    public boolean set_GroupComponent_CIM_SoftwareElement(CIM_SoftwareElement newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREELEMENT.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_GroupComponent_CIM_SoftwareElement(currentProperty,
                    newValue);
    ...
    public static CIMProperty create_GroupComponent_CIM_SoftwareElement(WBEMClient client,
            String namespace, CIM_SoftwareElement newValue) throws WbemsmtException {
        CIM_SoftwareElementComponent fco = new CIM_SoftwareElementComponent(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREELEMENT.NAME);
        if (property != null) {
            property = setPropertyValue_GroupComponent_CIM_SoftwareElement(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREELEMENT.NAME
    ...
    private static CIMProperty setPropertyValue_GroupComponent_CIM_SoftwareElement(
    ...
    public String getObjectName() {
        return CIM_SoftwareElementComponent.CIM_CLASS_NAME;
    }
