 ...
 * 
 * Description: Helper class for CIM_ExtentRedundancyComponent
 *    
 * 
 * generated Class
 * @see CIM_ExtentRedundancyComponent
 */
...
public class CIM_ExtentRedundancyComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ExtentRedundancyComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ExtentRedundancyComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ExtentRedundancyComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ExtentRedundancyComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ExtentRedundancyComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ExtentRedundancyComponentHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ExtentRedundancyComponent.");
                        resultArrayList.add(new CIM_ExtentRedundancyComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ExtentRedundancyComponent.");
                        resultArrayList.add(new CIM_ExtentRedundancyComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ExtentRedundancyComponent.");
                        resultArrayList.add(new CIM_ExtentRedundancyComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ExtentRedundancyComponent getInstance(WBEMClient client,
    ...
    public final static CIM_ExtentRedundancyComponent getInstance(WBEMClient client,
        ...
        Class clazz = CIM_ExtentRedundancyComponentHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ExtentRedundancyComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ExtentRedundancyComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ExtentRedundancyComponent getInstance(WBEMClient client,
            String namespace, CIM_StorageRedundancyGroup GroupComponent,
            CIM_StorageExtent PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ExtentRedundancyComponent.PROPERTY_GROUPCOMPONENT_CIM_STORAGEREDUNDANCYGROUP.NAME,
                new CIMDataType(CIM_StorageRedundancyGroup.CIM_CLASS_NAME), setThis, false, false,
                CIM_ExtentRedundancyComponent.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ExtentRedundancyComponent.PROPERTY_PARTCOMPONENT_CIM_STORAGEEXTENT.NAME,
                new CIMDataType(CIM_StorageExtent.CIM_CLASS_NAME), setThis, false, false,
                CIM_ExtentRedundancyComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ExtentRedundancyComponent createInstance(WBEMClient client,
            CIM_ExtentRedundancyComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ExtentRedundancyComponent newDataInstance = CIM_ExtentRedundancyComponentHelper
     ...
     */
    public final static CIM_ExtentRedundancyComponent modifyInstance(WBEMClient client,
            CIM_ExtentRedundancyComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ExtentRedundancyComponent dataInstance2 = CIM_ExtentRedundancyComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ExtentRedundancyComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ExtentRedundancyComponent.getPackages());
    }
