 ...
 * 
 * Description: Helper class for CIM_SoftwareFeatureSoftwareElements
 *    
 * 
 * generated Class
 * @see CIM_SoftwareFeatureSoftwareElements
 */
...
public class CIM_SoftwareFeatureSoftwareElementsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareFeatureSoftwareElements or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareFeatureSoftwareElements.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SoftwareFeatureSoftwareElements.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareFeatureSoftwareElements or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SoftwareFeatureSoftwareElements(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareFeatureSoftwareElementsHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareFeatureSoftwareElements.");
                        resultArrayList.add(new CIM_SoftwareFeatureSoftwareElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareFeatureSoftwareElements.");
                        resultArrayList.add(new CIM_SoftwareFeatureSoftwareElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareFeatureSoftwareElements.");
                        resultArrayList.add(new CIM_SoftwareFeatureSoftwareElements(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareFeatureSoftwareElements getInstance(WBEMClient client,
    ...
    public final static CIM_SoftwareFeatureSoftwareElements getInstance(WBEMClient client,
        ...
        Class clazz = CIM_SoftwareFeatureSoftwareElementsHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareFeatureSoftwareElements) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareFeatureSoftwareElements(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareFeatureSoftwareElements getInstance(WBEMClient client,
            String namespace, CIM_SoftwareFeature GroupComponent, CIM_SoftwareElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SoftwareFeatureSoftwareElements.PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREFEATURE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SoftwareFeatureSoftwareElements.PROPERTY_PARTCOMPONENT_CIM_SOFTWAREELEMENT.NAME,
     ...
     *
     */
    public final static CIM_SoftwareFeatureSoftwareElements createInstance(WBEMClient client,
            CIM_SoftwareFeatureSoftwareElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SoftwareFeatureSoftwareElements newDataInstance = CIM_SoftwareFeatureSoftwareElementsHelper
     ...
     */
    public final static CIM_SoftwareFeatureSoftwareElements modifyInstance(WBEMClient client,
            CIM_SoftwareFeatureSoftwareElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareFeatureSoftwareElements dataInstance2 = CIM_SoftwareFeatureSoftwareElementsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SoftwareFeatureSoftwareElements dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareFeatureSoftwareElements.getPackages());
    }
