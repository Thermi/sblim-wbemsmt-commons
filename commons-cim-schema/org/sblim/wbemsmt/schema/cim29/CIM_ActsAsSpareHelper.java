 ...
 * 
 * Description: Helper class for CIM_ActsAsSpare
 *    
 * 
 * generated Class
 * @see CIM_ActsAsSpare
...
public class CIM_ActsAsSpareHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ActsAsSpare or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ActsAsSpare.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ActsAsSpare.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ActsAsSpare or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ActsAsSpare.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ActsAsSpare(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ActsAsSpareHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ActsAsSpare.");
                        resultArrayList.add(new CIM_ActsAsSpare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ActsAsSpare.");
                        resultArrayList.add(new CIM_ActsAsSpare(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ActsAsSpare.");
                        resultArrayList.add(new CIM_ActsAsSpare(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ActsAsSpare getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ActsAsSpare getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ActsAsSpare) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ActsAsSpare(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ActsAsSpare getInstance(WBEMClient client, String namespace,
            CIM_SpareGroup Group, CIM_ManagedSystemElement Spare
        ...
        setThis = Group != null ? Group.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(CIM_ActsAsSpare.PROPERTY_GROUP_CIM_SPAREGROUP.NAME,
                new CIMDataType(CIM_SpareGroup.CIM_CLASS_NAME), setThis, false, false,
                CIM_ActsAsSpare.CIM_CLASS_NAME);

        setThis = Spare != null ? Spare.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ActsAsSpare.PROPERTY_SPARE_CIM_MANAGEDSYSTEMELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_ActsAsSpare createInstance(WBEMClient client,
            CIM_ActsAsSpare dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ActsAsSpare newDataInstance = CIM_ActsAsSpareHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_ActsAsSpare modifyInstance(WBEMClient client,
            CIM_ActsAsSpare dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ActsAsSpare dataInstance2 = CIM_ActsAsSpareHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ActsAsSpare dataInstance)
            throws WbemsmtException {
