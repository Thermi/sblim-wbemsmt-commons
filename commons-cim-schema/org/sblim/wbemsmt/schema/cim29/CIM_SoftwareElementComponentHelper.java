 ...
 * 
 * Description: Helper class for CIM_SoftwareElementComponent
 *    
 * 
 * generated Class
 * @see CIM_SoftwareElementComponent
 */
...
public class CIM_SoftwareElementComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareElementComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareElementComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SoftwareElementComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareElementComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SoftwareElementComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareElementComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareElementComponent.");
                        resultArrayList.add(new CIM_SoftwareElementComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareElementComponent.");
                        resultArrayList.add(new CIM_SoftwareElementComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareElementComponent.");
                        resultArrayList.add(new CIM_SoftwareElementComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareElementComponent getInstance(WBEMClient client,
    ...
    public final static CIM_SoftwareElementComponent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareElementComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareElementComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareElementComponent getInstance(WBEMClient client,
            String namespace, CIM_SoftwareElement GroupComponent, CIM_SoftwareElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SoftwareElementComponent.PROPERTY_GROUPCOMPONENT_CIM_SOFTWAREELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SoftwareElementComponent.PROPERTY_PARTCOMPONENT_CIM_SOFTWAREELEMENT.NAME,
                new CIMDataType(CIM_SoftwareElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_SoftwareElementComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SoftwareElementComponent createInstance(WBEMClient client,
            CIM_SoftwareElementComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SoftwareElementComponent newDataInstance = CIM_SoftwareElementComponentHelper
     ...
     */
    public final static CIM_SoftwareElementComponent modifyInstance(WBEMClient client,
            CIM_SoftwareElementComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareElementComponent dataInstance2 = CIM_SoftwareElementComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SoftwareElementComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareElementComponent.getPackages());
    }
