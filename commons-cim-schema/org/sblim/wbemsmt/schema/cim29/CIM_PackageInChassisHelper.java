 ...
 * 
 * Description: Helper class for CIM_PackageInChassis
 *    
 * 
 * generated Class
 * @see CIM_PackageInChassis
 */
...
public class CIM_PackageInChassisHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PackageInChassis or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PackageInChassis.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PackageInChassis or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_PackageInChassis.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_PackageInChassis(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PackageInChassisHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PackageInChassis.");
                        resultArrayList.add(new CIM_PackageInChassis(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PackageInChassis.");
                        resultArrayList.add(new CIM_PackageInChassis(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PackageInChassis.");
                        resultArrayList.add(new CIM_PackageInChassis(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PackageInChassis getInstance(WBEMClient client,
     ...
     */
    public final static CIM_PackageInChassis getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PackageInChassis) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PackageInChassis(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PackageInChassis getInstance(WBEMClient client, String namespace,
            CIM_Chassis GroupComponent, CIM_PhysicalPackage PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PackageInChassis.PROPERTY_GROUPCOMPONENT_CIM_CHASSIS.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_PackageInChassis.PROPERTY_PARTCOMPONENT_CIM_PHYSICALPACKAGE.NAME,
     ...
     *
     */
    public final static CIM_PackageInChassis createInstance(WBEMClient client,
            CIM_PackageInChassis dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_PackageInChassis newDataInstance = CIM_PackageInChassisHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_PackageInChassis modifyInstance(WBEMClient client,
            CIM_PackageInChassis dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PackageInChassis dataInstance2 = CIM_PackageInChassisHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PackageInChassis dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PackageInChassis.getPackages());
    }
