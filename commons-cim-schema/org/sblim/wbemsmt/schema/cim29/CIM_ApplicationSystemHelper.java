/** 
 * CIM_ApplicationSystemHelper.java
 *
...
public final class CIM_ApplicationSystemHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_ApplicationSystem.Java_Package_List.size(); i++) {
						if (!((String)(CIM_ApplicationSystem.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_ApplicationSystem.Java_Package_List.get(i))).endsWith(".")) {
							CIM_ApplicationSystem.Java_Package_List.setElementAt((String)(CIM_ApplicationSystem.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ApplicationSystem.");
						resultArrayList.add(new CIM_ApplicationSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ApplicationSystem.");
						resultArrayList.add(new CIM_ApplicationSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ApplicationSystem.");
						resultArrayList.add(new CIM_ApplicationSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ApplicationSystem getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ApplicationSystemHelper.getInstance(cimClient, new CIM_ApplicationSystem(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ApplicationSystem getInstance(CIMClient cimClient, CIM_ApplicationSystem dataInstance) {
		...
		return CIM_ApplicationSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ApplicationSystem getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ApplicationSystem dataInstance = null;
		try {
			dataInstance = new CIM_ApplicationSystem(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ApplicationSystem createInstance(CIMClient cimClient, CIM_ApplicationSystem dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ApplicationSystem newDataInstance = null;
		try {
			newDataInstance = CIM_ApplicationSystemHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ApplicationSystem modifyInstance(CIMClient cimClient, CIM_ApplicationSystem dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ApplicationSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ApplicationSystem dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ApplicationSystem dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ApplicationSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ApplicationSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ApplicationSystem.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ApplicationSystem.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ApplicationSystem.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Distribution(UnsignedInt16 Distribution) {
		return true;
	}
	...
	public static boolean isValid_LastServingStatusUpdate(Calendar LastServingStatusUpdate) {
		return true;
	}

	public static boolean isValid_ServingStatus(UnsignedInt16 ServingStatus) {
		return true;
	}
