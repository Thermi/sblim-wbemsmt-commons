 ...
 * 
 * Description: Helper class for CIM_LocalizationCapabilities
 *    
 * 
 * generated Class
 * @see CIM_LocalizationCapabilities
 */
...
public class CIM_LocalizationCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_LocalizationCapabilities or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LocalizationCapabilities.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_LocalizationCapabilities.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_LocalizationCapabilities or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_LocalizationCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_LocalizationCapabilities(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_LocalizationCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_LocalizationCapabilities.");
                        resultArrayList.add(new CIM_LocalizationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LocalizationCapabilities.");
                        resultArrayList.add(new CIM_LocalizationCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LocalizationCapabilities.");
                        resultArrayList.add(new CIM_LocalizationCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LocalizationCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_LocalizationCapabilities getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_LocalizationCapabilities) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_LocalizationCapabilities(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_LocalizationCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(CIM_LocalizationCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_LocalizationCapabilities createInstance(WBEMClient client,
            CIM_LocalizationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_LocalizationCapabilities newDataInstance = CIM_LocalizationCapabilitiesHelper
     ...
     */
    public final static CIM_LocalizationCapabilities modifyInstance(WBEMClient client,
            CIM_LocalizationCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LocalizationCapabilities dataInstance2 = CIM_LocalizationCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_LocalizationCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LocalizationCapabilities.getPackages());
    }
