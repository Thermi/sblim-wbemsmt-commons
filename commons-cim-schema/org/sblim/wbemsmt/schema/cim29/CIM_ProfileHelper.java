 ...
 * 
 * Description: Helper class for CIM_Profile
 *    
 * 
 * generated Class
 * @see CIM_Profile
...
public class CIM_ProfileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Profile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Profile.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Profile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Profile or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Profile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Profile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Profile.");
                        resultArrayList.add(new CIM_Profile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Profile.");
                        resultArrayList.add(new CIM_Profile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Profile.");
                        resultArrayList.add(new CIM_Profile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Profile getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Profile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Profile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Profile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Profile getInstance(WBEMClient client, String namespace,
            String InstanceID
        ...
        keyProperties[0] = new CIMProperty(CIM_Profile.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Profile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Profile createInstance(WBEMClient client, CIM_Profile dataInstance,
        ...
        CIM_Profile newDataInstance = CIM_ProfileHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Profile modifyInstance(WBEMClient client, CIM_Profile dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Profile dataInstance2 = CIM_ProfileHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Profile dataInstance)
            throws WbemsmtException {
