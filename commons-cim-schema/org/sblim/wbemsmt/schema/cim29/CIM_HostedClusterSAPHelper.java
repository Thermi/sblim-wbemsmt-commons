 ...
 * 
 * Description: Helper class for CIM_HostedClusterSAP
 *    
 * 
 * generated Class
 * @see CIM_HostedClusterSAP
 */
...
public class CIM_HostedClusterSAPHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostedClusterSAP or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedClusterSAP.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostedClusterSAP or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_HostedClusterSAP.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostedClusterSAP(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostedClusterSAPHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HostedClusterSAP.");
                        resultArrayList.add(new CIM_HostedClusterSAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedClusterSAP.");
                        resultArrayList.add(new CIM_HostedClusterSAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedClusterSAP.");
                        resultArrayList.add(new CIM_HostedClusterSAP(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedClusterSAP getInstance(WBEMClient client,
     ...
     */
    public final static CIM_HostedClusterSAP getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostedClusterSAP) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostedClusterSAP(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostedClusterSAP getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem Antecedent, CIM_ClusteringSAP Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedClusterSAP.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedClusterSAP.PROPERTY_DEPENDENT_CIM_CLUSTERINGSAP.NAME, new CIMDataType(
                        CIM_ClusteringSAP.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostedClusterSAP.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_HostedClusterSAP createInstance(WBEMClient client,
            CIM_HostedClusterSAP dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedClusterSAP newDataInstance = CIM_HostedClusterSAPHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedClusterSAP modifyInstance(WBEMClient client,
            CIM_HostedClusterSAP dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedClusterSAP dataInstance2 = CIM_HostedClusterSAPHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedClusterSAP dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedClusterSAP.getPackages());
    }
