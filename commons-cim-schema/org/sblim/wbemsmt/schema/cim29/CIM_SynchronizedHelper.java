 ...
 * 
 * Description: Helper class for CIM_Synchronized
 *    
 * 
 * generated Class
 * @see CIM_Synchronized
 */
...
public class CIM_SynchronizedHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Synchronized or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Synchronized.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Synchronized.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Synchronized or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Synchronized.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Synchronized(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SynchronizedHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_Synchronized.");
                        resultArrayList.add(new CIM_Synchronized(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_Synchronized.");
                        resultArrayList.add(new CIM_Synchronized(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Synchronized.");
                        resultArrayList.add(new CIM_Synchronized(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Synchronized getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Synchronized getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Synchronized) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Synchronized(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Synchronized getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement SystemElement, CIM_ManagedElement SyncedElement
        ...
        keyProperties[0] = new CIMProperty(
                CIM_Synchronized.PROPERTY_SYSTEMELEMENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
                        CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_Synchronized.CIM_CLASS_NAME);

        setThis = SyncedElement != null ? SyncedElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_Synchronized.PROPERTY_SYNCEDELEMENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
                        CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_Synchronized.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Synchronized createInstance(WBEMClient client,
            CIM_Synchronized dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_Synchronized newDataInstance = CIM_SynchronizedHelper
     ...
     */
    public final static CIM_Synchronized modifyInstance(WBEMClient client,
            CIM_Synchronized dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Synchronized dataInstance2 = CIM_SynchronizedHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Synchronized dataInstance)
            throws WbemsmtException {
