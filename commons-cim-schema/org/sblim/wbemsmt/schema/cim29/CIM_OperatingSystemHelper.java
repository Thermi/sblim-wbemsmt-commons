/** 
 * CIM_OperatingSystemHelper.java
 *
...
public final class CIM_OperatingSystemHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_OperatingSystem.Java_Package_List.size(); i++) {
						if (!((String)(CIM_OperatingSystem.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_OperatingSystem.Java_Package_List.get(i))).endsWith(".")) {
							CIM_OperatingSystem.Java_Package_List.setElementAt((String)(CIM_OperatingSystem.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_OperatingSystem.");
						resultArrayList.add(new CIM_OperatingSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_OperatingSystem.");
						resultArrayList.add(new CIM_OperatingSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OperatingSystem.");
						resultArrayList.add(new CIM_OperatingSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_OperatingSystem getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_OperatingSystemHelper.getInstance(cimClient, new CIM_OperatingSystem(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OperatingSystem getInstance(CIMClient cimClient, CIM_OperatingSystem dataInstance) {
		...
		return CIM_OperatingSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OperatingSystem getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_OperatingSystem dataInstance = null;
		try {
			dataInstance = new CIM_OperatingSystem(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OperatingSystem createInstance(CIMClient cimClient, CIM_OperatingSystem dataInstance, boolean notifyDifferencies){ 
		...
		CIM_OperatingSystem newDataInstance = null;
		try {
			newDataInstance = CIM_OperatingSystemHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OperatingSystem modifyInstance(CIMClient cimClient, CIM_OperatingSystem dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_OperatingSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_OperatingSystem dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_OperatingSystem dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_OperatingSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_OperatingSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_OperatingSystem.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_OperatingSystem.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_OperatingSystem.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CurrentTimeZone(Short CurrentTimeZone) {
		return true;
	}

	public static boolean isValid_Distributed(Boolean Distributed) {
		return true;
	}

	public static boolean isValid_FreePhysicalMemory(UnsignedInt64 FreePhysicalMemory) {
		return true;
	}

	public static boolean isValid_FreeSpaceInPagingFiles(UnsignedInt64 FreeSpaceInPagingFiles) {
		return true;
	}

	public static boolean isValid_FreeVirtualMemory(UnsignedInt64 FreeVirtualMemory) {
		return true;
	}

	public static boolean isValid_LastBootUpTime(Calendar LastBootUpTime) {
		return true;
	}

	public static boolean isValid_LocalDateTime(Calendar LocalDateTime) {
		return true;
	}

	public static boolean isValid_MaxNumberOfProcesses(UnsignedInt32 MaxNumberOfProcesses) {
		return true;
	}

	public static boolean isValid_MaxProcessMemorySize(UnsignedInt64 MaxProcessMemorySize) {
		return true;
	}

	public static boolean isValid_MaxProcessesPerUser(UnsignedInt32 MaxProcessesPerUser) {
		return true;
	}
	...
	public static boolean isValid_NumberOfLicensedUsers(UnsignedInt32 NumberOfLicensedUsers) {
		return true;
	}

	public static boolean isValid_NumberOfProcesses(UnsignedInt32 NumberOfProcesses) {
		return true;
	}

	public static boolean isValid_NumberOfUsers(UnsignedInt32 NumberOfUsers) {
		return true;
	}

	public static boolean isValid_OSType(UnsignedInt16 OSType) {
		return true;
	}

	public static boolean isValid_OtherTypeDescription(String OtherTypeDescription) {
		return true;
	}

	public static boolean isValid_SizeStoredInPagingFiles(UnsignedInt64 SizeStoredInPagingFiles) {
		return true;
	}

	public static boolean isValid_TotalSwapSpaceSize(UnsignedInt64 TotalSwapSpaceSize) {
		return true;
	}

	public static boolean isValid_TotalVirtualMemorySize(UnsignedInt64 TotalVirtualMemorySize) {
		return true;
	}

	public static boolean isValid_TotalVisibleMemorySize(UnsignedInt64 TotalVisibleMemorySize) {
		return true;
	}

	public static boolean isValid_Version(String Version) {
		return true;
	}
