...
public class CIM_SoftwareFeatureSAPImplementation extends CIM_Dependency {
     ...
     * 
     */
    public static class PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE {
        /**
    ...
    public CIM_SoftwareFeatureSAPImplementation(WBEMClient client, String namespace)
    ...
    public CIM_SoftwareFeatureSAPImplementation(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SoftwareFeatureSAPImplementation() {
    }
    ...
    public CIM_SoftwareFeature get_Antecedent_CIM_SoftwareFeature(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE.NAME
    ...
    public boolean set_Antecedent_CIM_SoftwareFeature(CIM_SoftwareFeature newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Antecedent_CIM_SoftwareFeature(currentProperty,
                    newValue);
    ...
    public static CIMProperty create_Antecedent_CIM_SoftwareFeature(WBEMClient client,
            String namespace, CIM_SoftwareFeature newValue) throws WbemsmtException {
        CIM_SoftwareFeatureSAPImplementation fco = new CIM_SoftwareFeatureSAPImplementation(client,
                namespace);
        CIMProperty property = fco.getProperty(PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE.NAME);
        if (property != null) {
            property = setPropertyValue_Antecedent_CIM_SoftwareFeature(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE.NAME
    ...
    private static CIMProperty setPropertyValue_Antecedent_CIM_SoftwareFeature(
    ...
    public String getObjectName() {
        return CIM_SoftwareFeatureSAPImplementation.CIM_CLASS_NAME;
    }
