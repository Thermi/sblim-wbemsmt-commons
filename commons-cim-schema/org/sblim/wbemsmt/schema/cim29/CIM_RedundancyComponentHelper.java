 ...
 * 
 * Description: Helper class for CIM_RedundancyComponent
 *    
 * 
 * generated Class
 * @see CIM_RedundancyComponent
 */
...
public class CIM_RedundancyComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RedundancyComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RedundancyComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RedundancyComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RedundancyComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_RedundancyComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RedundancyComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RedundancyComponent.");
                        resultArrayList.add(new CIM_RedundancyComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RedundancyComponent.");
                        resultArrayList.add(new CIM_RedundancyComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RedundancyComponent.");
                        resultArrayList.add(new CIM_RedundancyComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RedundancyComponent getInstance(WBEMClient client,
    ...
    public final static CIM_RedundancyComponent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RedundancyComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RedundancyComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RedundancyComponent getInstance(WBEMClient client, String namespace,
            CIM_RedundancyGroup GroupComponent, CIM_ManagedSystemElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RedundancyComponent.PROPERTY_GROUPCOMPONENT_CIM_REDUNDANCYGROUP.NAME,
                new CIMDataType(CIM_RedundancyGroup.CIM_CLASS_NAME), setThis, false, false,
                CIM_RedundancyComponent.CIM_CLASS_NAME);

        setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_RedundancyComponent.PROPERTY_PARTCOMPONENT_CIM_MANAGEDSYSTEMELEMENT.NAME,
     ...
     *
     */
    public final static CIM_RedundancyComponent createInstance(WBEMClient client,
            CIM_RedundancyComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_RedundancyComponent newDataInstance = CIM_RedundancyComponentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_RedundancyComponent modifyInstance(WBEMClient client,
            CIM_RedundancyComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RedundancyComponent dataInstance2 = CIM_RedundancyComponentHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RedundancyComponent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RedundancyComponent.getPackages());
    }
