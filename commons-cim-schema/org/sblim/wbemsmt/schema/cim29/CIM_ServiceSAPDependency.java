...
public class CIM_ServiceSAPDependency extends CIM_Dependency {
    ...
    public CIM_ServiceSAPDependency(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ServiceSAPDependency(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ServiceSAPDependency() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_ServiceAccessPoint(WBEMClient client,
        ...
        CIM_ServiceSAPDependency fco = new CIM_ServiceSAPDependency(client, namespace);
    ...
    public String getObjectName() {
        return CIM_ServiceSAPDependency.CIM_CLASS_NAME;
    }
