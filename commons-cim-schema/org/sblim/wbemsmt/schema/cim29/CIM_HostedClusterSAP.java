...
public class CIM_HostedClusterSAP extends CIM_HostedAccessPoint {
    ...
    public CIM_HostedClusterSAP(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HostedClusterSAP(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_HostedClusterSAP() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_ComputerSystem(WBEMClient client,
        ...
        CIM_HostedClusterSAP fco = new CIM_HostedClusterSAP(client, namespace);
    ...
    public String getObjectName() {
        return CIM_HostedClusterSAP.CIM_CLASS_NAME;
    }
