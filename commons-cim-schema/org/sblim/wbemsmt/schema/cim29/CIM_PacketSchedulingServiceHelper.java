/** 
 * CIM_PacketSchedulingServiceHelper.java
 *
...
public final class CIM_PacketSchedulingServiceHelper {

	public final static String CIM_CLASS_NAME = "CIM_PacketSchedulingService";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_PacketSchedulingService.Java_Package_List.size(); i++) {
						if (!((String)(CIM_PacketSchedulingService.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_PacketSchedulingService.Java_Package_List.get(i))).endsWith(".")) {
							CIM_PacketSchedulingService.Java_Package_List.setElementAt((String)(CIM_PacketSchedulingService.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PacketSchedulingService.");
						resultArrayList.add(new CIM_PacketSchedulingService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PacketSchedulingService.");
						resultArrayList.add(new CIM_PacketSchedulingService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PacketSchedulingService.");
						resultArrayList.add(new CIM_PacketSchedulingService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PacketSchedulingService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PacketSchedulingServiceHelper.getInstance(cimClient, new CIM_PacketSchedulingService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PacketSchedulingService getInstance(CIMClient cimClient, CIM_PacketSchedulingService dataInstance) {
		...
		return CIM_PacketSchedulingServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PacketSchedulingService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PacketSchedulingService dataInstance = null;
		try {
			dataInstance = new CIM_PacketSchedulingService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PacketSchedulingService createInstance(CIMClient cimClient, CIM_PacketSchedulingService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PacketSchedulingService newDataInstance = null;
		try {
			newDataInstance = CIM_PacketSchedulingServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PacketSchedulingService modifyInstance(CIMClient cimClient, CIM_PacketSchedulingService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PacketSchedulingServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PacketSchedulingService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PacketSchedulingService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PacketSchedulingService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PacketSchedulingService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PacketSchedulingService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PacketSchedulingService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PacketSchedulingService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_OtherSchedulerType(String OtherSchedulerType) {
		return true;
	}

	public static boolean isValid_SchedulerType(UnsignedInt16 SchedulerType) {
		return true;
	}
