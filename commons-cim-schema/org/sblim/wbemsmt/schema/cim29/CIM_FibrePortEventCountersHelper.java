 ...
 * 
 * Description: Helper class for CIM_FibrePortEventCounters
 *    
 * 
 * generated Class
 * @see CIM_FibrePortEventCounters
 */
...
public class CIM_FibrePortEventCountersHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FibrePortEventCounters or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FibrePortEventCounters.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FibrePortEventCounters.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FibrePortEventCounters or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_FibrePortEventCounters.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FibrePortEventCounters(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FibrePortEventCountersHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FibrePortEventCounters.");
                        resultArrayList.add(new CIM_FibrePortEventCounters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FibrePortEventCounters.");
                        resultArrayList.add(new CIM_FibrePortEventCounters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FibrePortEventCounters.");
                        resultArrayList.add(new CIM_FibrePortEventCounters(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FibrePortEventCounters getInstance(WBEMClient client,
    ...
    public final static CIM_FibrePortEventCounters getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FibrePortEventCounters) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FibrePortEventCounters(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FibrePortEventCounters getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_FibrePortEventCounters.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_FibrePortEventCounters.CIM_CLASS_NAME);

        setThis = DeviceCreationClassName;

        keyProperties[1] = new CIMProperty(
                CIM_FibrePortEventCounters.PROPERTY_DEVICECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FibrePortEventCounters.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[2] = new CIMProperty(CIM_FibrePortEventCounters.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FibrePortEventCounters.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_FibrePortEventCounters.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FibrePortEventCounters.CIM_CLASS_NAME);
        ...
        keyProperties[4] = new CIMProperty(
                CIM_FibrePortEventCounters.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FibrePortEventCounters.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[5] = new CIMProperty(CIM_FibrePortEventCounters.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FibrePortEventCounters.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FibrePortEventCounters createInstance(WBEMClient client,
            CIM_FibrePortEventCounters dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FibrePortEventCounters newDataInstance = CIM_FibrePortEventCountersHelper.getInstance(
     ...
     */
    public final static CIM_FibrePortEventCounters modifyInstance(WBEMClient client,
            CIM_FibrePortEventCounters dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FibrePortEventCounters dataInstance2 = CIM_FibrePortEventCountersHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_FibrePortEventCounters dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FibrePortEventCounters.getPackages());
    }
