...
public final class CIM_SystemHelper {
	...
	*/	
	public final static CIM_System getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SystemHelper.getInstance(cimClient, new CIM_System(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_System getInstance(CIMClient cimClient, CIM_System dataInstance) {
		...
		return CIM_SystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_System getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_System(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_System.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_System.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_System.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_System.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_PrimaryOwnerContact(String PrimaryOwnerContact) {
		return true;
	}

	public static boolean isValid_PrimaryOwnerName(String PrimaryOwnerName) {
		return true;
	}

	public static boolean isValid_Roles(String[] Roles) {
		return true;
	}
