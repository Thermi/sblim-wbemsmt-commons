 ...
 *
 *
 * Description: The CIM_DiagnosticTest class represents the framework for running diagnostic tests. Specific diagnostic tests may be defined by subclassing and/or instantiating this object. To provide more detail for a type of test(s) (i.e, additional properties and methods), subclassing is appropriate. 
...
public class CIM_DiagnosticTest extends CIM_DiagnosticService  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DIAGNOSTICTESTINPACKAGE = "CIM_DiagnosticTestInPackage";
...
The "Expensive" qualifier can be applied to this class and its RunTest method. If so, the ResourcesUsed property describes the resources that are capitalized, based on a default setup for the test. Multiple resources can be specified since the property is an array.
	*/
	...
	/**
	*	This method is deprecated in favor of using the corresponding functionality contained in the MessageLog class, this is consistant with the deprecation of the Result class in favor of MessageLog. 
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_DiagnosticService.Java_Package_List.size(); i++) {
			if (((String)CIM_DiagnosticService.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim29")){
				continue;
			}
