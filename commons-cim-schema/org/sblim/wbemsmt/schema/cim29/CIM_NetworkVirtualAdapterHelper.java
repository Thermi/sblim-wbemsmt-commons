 ...
 * 
 * Description: Helper class for CIM_NetworkVirtualAdapter
 *    
 * 
 * generated Class
 * @see CIM_NetworkVirtualAdapter
 */
...
public class CIM_NetworkVirtualAdapterHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_NetworkVirtualAdapter or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_NetworkVirtualAdapter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_NetworkVirtualAdapter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_NetworkVirtualAdapter or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_NetworkVirtualAdapter(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_NetworkVirtualAdapterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_NetworkVirtualAdapter.");
                        resultArrayList.add(new CIM_NetworkVirtualAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_NetworkVirtualAdapter.");
                        resultArrayList.add(new CIM_NetworkVirtualAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_NetworkVirtualAdapter.");
                        resultArrayList.add(new CIM_NetworkVirtualAdapter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_NetworkVirtualAdapter getInstance(WBEMClient client,
    ...
    public final static CIM_NetworkVirtualAdapter getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_NetworkVirtualAdapter) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_NetworkVirtualAdapter(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_NetworkVirtualAdapter getInstance(WBEMClient client, String namespace,
            CIM_NetworkAdapter SystemElement, CIM_ExtraCapacityGroup SameElement
        ...
        keyProperties[0] = new CIMProperty(
                CIM_NetworkVirtualAdapter.PROPERTY_SYSTEMELEMENT_CIM_NETWORKADAPTER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_NetworkVirtualAdapter.PROPERTY_SAMEELEMENT_CIM_EXTRACAPACITYGROUP.NAME,
     ...
     *
     */
    public final static CIM_NetworkVirtualAdapter createInstance(WBEMClient client,
            CIM_NetworkVirtualAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_NetworkVirtualAdapter newDataInstance = CIM_NetworkVirtualAdapterHelper.getInstance(
     ...
     */
    public final static CIM_NetworkVirtualAdapter modifyInstance(WBEMClient client,
            CIM_NetworkVirtualAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_NetworkVirtualAdapter dataInstance2 = CIM_NetworkVirtualAdapterHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_NetworkVirtualAdapter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_NetworkVirtualAdapter.getPackages());
    }
