...
public class CIM_PhysicalStatisticalInformation extends CIM_StatisticalInformation {
    ...
    /**
     * Constants of property PhysicalCreationClassName
     * The scoping Element's CreationClassName.
     */
    public static class PROPERTY_PHYSICALCREATIONCLASSNAME {
        /**
         * name of the property PhysicalCreationClassName
         */
        public final static String NAME = "PhysicalCreationClassName";
    ...
    public CIM_PhysicalStatisticalInformation(WBEMClient client, String namespace)
    ...
    public CIM_PhysicalStatisticalInformation(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_PhysicalStatisticalInformation() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("PhysicalCreationClassName", new CIMProperty(
                "PhysicalCreationClassName", CIMDataType.STRING_T, null));
    ...
    public static CIMProperty create_key_CreationClassName(WBEMClient client, String namespace,
        ...
        CIM_PhysicalStatisticalInformation fco = new CIM_PhysicalStatisticalInformation(client,
                namespace);
    ...
    /**
     * Get the property PhysicalCreationClassName
     *     * <br>
     * The scoping Element's CreationClassName.
     *     */

    public String get_key_PhysicalCreationClassName() {
        CIMProperty currentProperty = getProperty(PROPERTY_PHYSICALCREATIONCLASSNAME.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PHYSICALCREATIONCLASSNAME.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    /**
     * Set the property PhysicalCreationClassName
     * <br>
     * The scoping Element's CreationClassName.
     *
     * @return true if the property was found, false if the property was not found and the value was not set
    ...
    public boolean set_key_PhysicalCreationClassName(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PHYSICALCREATIONCLASSNAME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_key_PhysicalCreationClassName(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    /**
     * Get the property PhysicalCreationClassName by getting the class from the server<br>
     * and retrieving the property from it
     * After that the value is set to this property and the property is returned
     * @return null if the property cannot be found in the instance from the server
     * @throws WbemsmtException 
    ...
    public static CIMProperty create_key_PhysicalCreationClassName(WBEMClient client,
            String namespace, String newValue) throws WbemsmtException {
        CIM_PhysicalStatisticalInformation fco = new CIM_PhysicalStatisticalInformation(client,
                namespace);
        CIMProperty property = fco.getProperty(PROPERTY_PHYSICALCREATIONCLASSNAME.NAME);
        if (property != null) {
            property = setPropertyValue_key_PhysicalCreationClassName(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PHYSICALCREATIONCLASSNAME.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_key_PhysicalCreationClassName(
    ...
    /**
     * Get the list with CIM_PhysicalElement objects associated by the association CIM_PhysicalStatistics
     * 
    ...
    public java.util.List getAssociated_CIM_PhysicalElement_CIM_PhysicalStatisticss(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalElement_CIM_PhysicalStatisticss(cimClient,
    ...
    public java.util.List getAssociated_CIM_PhysicalElement_CIM_PhysicalStatisticss(
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_PhysicalStatisticalInformationHelper.checkException(enumeration);
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_PhysicalStatisticalInformationHelper.findClass(cimClient,
                            cimInstance);
    ...
    public java.util.List getAssociated_CIM_PhysicalElement_CIM_PhysicalStatisticsNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_PhysicalElement_CIM_PhysicalStatisticsNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PHYSICALSTATISTICS,
    ...
    public String getObjectName() {
        return CIM_PhysicalStatisticalInformation.CIM_CLASS_NAME;
    }
