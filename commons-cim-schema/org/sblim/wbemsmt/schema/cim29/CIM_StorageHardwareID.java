 ...
 *
 *
 * Description: CIM_StorageHardwareID is a hardware ID that serves as an authorization subject. Example are host controller IDs that serve as authorization subjects in disk array LUN Masking.
 * 
 */
...
public class CIM_StorageHardwareID extends CIM_Identity  {
	...
	*/
	...
	public final static String[] CIM_VALUEMAP_IDTYPE = {"Other","PortWWN","NodeWWN","Hostname"};
