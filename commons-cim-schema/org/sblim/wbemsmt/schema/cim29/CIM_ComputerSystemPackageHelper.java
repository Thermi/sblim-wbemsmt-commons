 ...
 * 
 * Description: Helper class for CIM_ComputerSystemPackage
 *    
 * 
 * generated Class
 * @see CIM_ComputerSystemPackage
 */
...
public class CIM_ComputerSystemPackageHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ComputerSystemPackage or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ComputerSystemPackage.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ComputerSystemPackage.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ComputerSystemPackage or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ComputerSystemPackage(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ComputerSystemPackageHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ComputerSystemPackage.");
                        resultArrayList.add(new CIM_ComputerSystemPackage(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ComputerSystemPackage.");
                        resultArrayList.add(new CIM_ComputerSystemPackage(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ComputerSystemPackage.");
                        resultArrayList.add(new CIM_ComputerSystemPackage(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ComputerSystemPackage getInstance(WBEMClient client,
    ...
    public final static CIM_ComputerSystemPackage getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ComputerSystemPackage) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ComputerSystemPackage(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ComputerSystemPackage getInstance(WBEMClient client, String namespace,
            CIM_PhysicalPackage Antecedent, CIM_ComputerSystem Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ComputerSystemPackage.PROPERTY_ANTECEDENT_CIM_PHYSICALPACKAGE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ComputerSystemPackage.PROPERTY_DEPENDENT_CIM_COMPUTERSYSTEM.NAME,
     ...
     *
     */
    public final static CIM_ComputerSystemPackage createInstance(WBEMClient client,
            CIM_ComputerSystemPackage dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ComputerSystemPackage newDataInstance = CIM_ComputerSystemPackageHelper.getInstance(
     ...
     */
    public final static CIM_ComputerSystemPackage modifyInstance(WBEMClient client,
            CIM_ComputerSystemPackage dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ComputerSystemPackage dataInstance2 = CIM_ComputerSystemPackageHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ComputerSystemPackage dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ComputerSystemPackage.getPackages());
    }
