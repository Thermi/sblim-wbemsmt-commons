...
public class CIM_LogicalDiskBasedOnExtent extends CIM_BasedOn  {
	...
	static {
		...
		for (int i = 0; i < CIM_BasedOn.CIM_PropertyNameList.size(); i++) {
			...
			CIM_LogicalDiskBasedOnExtent.CIM_PropertyNameList.add(CIM_BasedOn.CIM_PropertyNameList.elementAt(i));
		}
	...
	*	Class constructor
	*/	
	public CIM_LogicalDiskBasedOnExtent(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_LogicalDiskBasedOnExtent(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof CIM_LogicalDiskBasedOnExtent)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((CIM_LogicalDiskBasedOnExtent)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_LogicalDiskBasedOnExtent)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_LogicalDiskBasedOnExtent)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_LogicalDiskBasedOnExtent)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_LogicalDiskBasedOnExtent)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_LogicalDiskBasedOnExtent)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_LogicalDiskBasedOnExtent)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_LogicalDiskBasedOnExtent)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_LogicalDiskBasedOnExtent)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public CIMObjectPath get_CIM_StorageExtent() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_LogicalDiskBasedOnExtent.CIM_PROPERTY_CIM_STORAGEEXTENT);
	...
	public CIMObjectPath get_CIM_LogicalDisk() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_LogicalDiskBasedOnExtent.CIM_PROPERTY_CIM_LOGICALDISK);
