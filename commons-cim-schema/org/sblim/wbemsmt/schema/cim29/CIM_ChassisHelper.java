...
public final class CIM_ChassisHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_Chassis.");
						resultArrayList.add(new CIM_Chassis(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_Chassis.");
						resultArrayList.add(new CIM_Chassis(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_Chassis.");
						resultArrayList.add(new CIM_Chassis(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_Chassis getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ChassisHelper.getInstance(cimClient, new CIM_Chassis(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Chassis getInstance(CIMClient cimClient, CIM_Chassis dataInstance) {
		...
		return CIM_ChassisHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Chassis getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_Chassis dataInstance = null;
		try {
			dataInstance = new CIM_Chassis(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_Chassis.getPackages();
	...
	*/	
	public final static CIM_Chassis createInstance(CIMClient cimClient, CIM_Chassis dataInstance, boolean notifyDifferencies){ 
		...
		CIM_Chassis newDataInstance = null;
		try {
			newDataInstance = CIM_ChassisHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_Chassis modifyInstance(CIMClient cimClient, CIM_Chassis dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ChassisHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_Chassis dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_Chassis dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_Chassis.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_Chassis.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_Chassis.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_Chassis.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_Chassis.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ChassisPackageType(UnsignedInt16 ChassisPackageType) {
		return true;
	}

	public static boolean isValid_ChassisTypeDescription(String ChassisTypeDescription) {
		return true;
	}

	public static boolean isValid_ChassisTypes(UnsignedInt16[] ChassisTypes) {
		return true;
	}

	public static boolean isValid_CurrentRequiredOrProduced(Short CurrentRequiredOrProduced) {
		return true;
	}

	public static boolean isValid_HeatGeneration(UnsignedInt16 HeatGeneration) {
		return true;
	}

	public static boolean isValid_MultipleSystemSupport(UnsignedInt16 MultipleSystemSupport) {
		return true;
	}

	public static boolean isValid_NumberOfPowerCords(UnsignedInt16 NumberOfPowerCords) {
		return true;
	}

	public static boolean isValid_RackMountable(UnsignedInt16 RackMountable) {
		return true;
	}

	public static boolean isValid_TypeDescriptions(String[] TypeDescriptions) {
		return true;
	}
