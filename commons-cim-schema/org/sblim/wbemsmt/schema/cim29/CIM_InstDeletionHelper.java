...
public class CIM_InstDeletionHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_InstDeletion.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_InstDeletion.");
                        resultArrayList.add(new CIM_InstDeletion(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_InstDeletion.");
                        resultArrayList.add(new CIM_InstDeletion(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_InstDeletion.");
                        resultArrayList.add(new CIM_InstDeletion(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_InstDeletion getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_InstDeletion getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static CIM_InstDeletion createInstance(WBEMClient client,
            CIM_InstDeletion dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_InstDeletion newDataInstance = CIM_InstDeletionHelper
     ...
     */
    public final static CIM_InstDeletion modifyInstance(WBEMClient client,
            CIM_InstDeletion dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_InstDeletion dataInstance2 = CIM_InstDeletionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_InstDeletion dataInstance)
            throws WbemsmtException {
