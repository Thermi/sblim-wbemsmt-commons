 ...
 * 
 * Description: Helper class for CIM_DiskPartitionBasedOnVolume
 *    
 * 
 * generated Class
 * @see CIM_DiskPartitionBasedOnVolume
 */
...
public class CIM_DiskPartitionBasedOnVolumeHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DiskPartitionBasedOnVolume or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DiskPartitionBasedOnVolume.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_DiskPartitionBasedOnVolume.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DiskPartitionBasedOnVolume or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_DiskPartitionBasedOnVolume(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DiskPartitionBasedOnVolumeHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DiskPartitionBasedOnVolume.");
                        resultArrayList.add(new CIM_DiskPartitionBasedOnVolume(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DiskPartitionBasedOnVolume.");
                        resultArrayList.add(new CIM_DiskPartitionBasedOnVolume(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DiskPartitionBasedOnVolume.");
                        resultArrayList.add(new CIM_DiskPartitionBasedOnVolume(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DiskPartitionBasedOnVolume getInstance(WBEMClient client,
    ...
    public final static CIM_DiskPartitionBasedOnVolume getInstance(WBEMClient client,
        ...
        Class clazz = CIM_DiskPartitionBasedOnVolumeHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DiskPartitionBasedOnVolume) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DiskPartitionBasedOnVolume(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DiskPartitionBasedOnVolume getInstance(WBEMClient client,
            String namespace, CIM_StorageVolume Antecedent, CIM_DiskPartition Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DiskPartitionBasedOnVolume.PROPERTY_ANTECEDENT_CIM_STORAGEVOLUME.NAME,
                new CIMDataType(CIM_StorageVolume.CIM_CLASS_NAME), setThis, false, false,
                CIM_DiskPartitionBasedOnVolume.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_DiskPartitionBasedOnVolume.PROPERTY_DEPENDENT_CIM_DISKPARTITION.NAME,
     ...
     *
     */
    public final static CIM_DiskPartitionBasedOnVolume createInstance(WBEMClient client,
            CIM_DiskPartitionBasedOnVolume dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_DiskPartitionBasedOnVolume newDataInstance = CIM_DiskPartitionBasedOnVolumeHelper
     ...
     */
    public final static CIM_DiskPartitionBasedOnVolume modifyInstance(WBEMClient client,
            CIM_DiskPartitionBasedOnVolume dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DiskPartitionBasedOnVolume dataInstance2 = CIM_DiskPartitionBasedOnVolumeHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_DiskPartitionBasedOnVolume dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DiskPartitionBasedOnVolume.getPackages());
    }
