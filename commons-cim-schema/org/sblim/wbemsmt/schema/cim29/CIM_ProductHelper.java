 ...
 * 
 * Description: Helper class for CIM_Product
 *    
 * 
 * generated Class
 * @see CIM_Product
...
public class CIM_ProductHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Product or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Product.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Product.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Product or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Product.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Product(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Product.");
                        resultArrayList.add(new CIM_Product(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Product.");
                        resultArrayList.add(new CIM_Product(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Product.");
                        resultArrayList.add(new CIM_Product(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Product getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Product getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Product) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Product(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Product getInstance(WBEMClient client, String namespace,
            String IdentifyingNumber, String Name, String Vendor, String Version
        ...
        keyProperties[0] = new CIMProperty(CIM_Product.PROPERTY_IDENTIFYINGNUMBER.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Product.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_Product.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Product.CIM_CLASS_NAME);

        setThis = Vendor;

        keyProperties[2] = new CIMProperty(CIM_Product.PROPERTY_VENDOR.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Product.CIM_CLASS_NAME);

        setThis = Version;

        keyProperties[3] = new CIMProperty(CIM_Product.PROPERTY_VERSION.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Product.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Product createInstance(WBEMClient client, CIM_Product dataInstance,
        ...
        CIM_Product newDataInstance = CIM_ProductHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Product modifyInstance(WBEMClient client, CIM_Product dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Product dataInstance2 = CIM_ProductHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Product dataInstance)
            throws WbemsmtException {
