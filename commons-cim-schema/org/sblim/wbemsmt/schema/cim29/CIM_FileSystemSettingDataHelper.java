 ...
 * 
 * Description: Helper class for CIM_FileSystemSettingData
 *    
 * 
 * generated Class
 * @see CIM_FileSystemSettingData
 */
...
public class CIM_FileSystemSettingDataHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FileSystemSettingData or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FileSystemSettingData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FileSystemSettingData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FileSystemSettingData or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_FileSystemSettingData.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FileSystemSettingData(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FileSystemSettingDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FileSystemSettingData.");
                        resultArrayList.add(new CIM_FileSystemSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FileSystemSettingData.");
                        resultArrayList.add(new CIM_FileSystemSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FileSystemSettingData.");
                        resultArrayList.add(new CIM_FileSystemSettingData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FileSystemSettingData getInstance(WBEMClient client,
    ...
    public final static CIM_FileSystemSettingData getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FileSystemSettingData) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FileSystemSettingData(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FileSystemSettingData getInstance(WBEMClient client, String namespace,
            String InstanceID
        ...
        keyProperties[0] = new CIMProperty(CIM_FileSystemSettingData.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_FileSystemSettingData createInstance(WBEMClient client,
            CIM_FileSystemSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FileSystemSettingData newDataInstance = CIM_FileSystemSettingDataHelper.getInstance(
     ...
     */
    public final static CIM_FileSystemSettingData modifyInstance(WBEMClient client,
            CIM_FileSystemSettingData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FileSystemSettingData dataInstance2 = CIM_FileSystemSettingDataHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_FileSystemSettingData dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FileSystemSettingData.getPackages());
    }
