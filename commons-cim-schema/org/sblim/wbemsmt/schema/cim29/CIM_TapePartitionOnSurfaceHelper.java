 ...
 * 
 * Description: Helper class for CIM_TapePartitionOnSurface
 *    
 * 
 * generated Class
 * @see CIM_TapePartitionOnSurface
 */
...
public class CIM_TapePartitionOnSurfaceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_TapePartitionOnSurface or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_TapePartitionOnSurface.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_TapePartitionOnSurface.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_TapePartitionOnSurface or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_TapePartitionOnSurface(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_TapePartitionOnSurfaceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_TapePartitionOnSurface.");
                        resultArrayList.add(new CIM_TapePartitionOnSurface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_TapePartitionOnSurface.");
                        resultArrayList.add(new CIM_TapePartitionOnSurface(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_TapePartitionOnSurface.");
                        resultArrayList.add(new CIM_TapePartitionOnSurface(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_TapePartitionOnSurface getInstance(WBEMClient client,
    ...
    public final static CIM_TapePartitionOnSurface getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_TapePartitionOnSurface) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_TapePartitionOnSurface(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_TapePartitionOnSurface getInstance(WBEMClient client, String namespace,
            CIM_StorageExtent Antecedent, CIM_TapePartition Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_TapePartitionOnSurface.PROPERTY_ANTECEDENT_CIM_STORAGEEXTENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_TapePartitionOnSurface.PROPERTY_DEPENDENT_CIM_TAPEPARTITION.NAME,
                new CIMDataType(CIM_TapePartition.CIM_CLASS_NAME), setThis, false, false,
                CIM_TapePartitionOnSurface.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_TapePartitionOnSurface createInstance(WBEMClient client,
            CIM_TapePartitionOnSurface dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_TapePartitionOnSurface newDataInstance = CIM_TapePartitionOnSurfaceHelper.getInstance(
     ...
     */
    public final static CIM_TapePartitionOnSurface modifyInstance(WBEMClient client,
            CIM_TapePartitionOnSurface dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_TapePartitionOnSurface dataInstance2 = CIM_TapePartitionOnSurfaceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_TapePartitionOnSurface dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_TapePartitionOnSurface.getPackages());
    }
