...
public class CIM_CollectionSetting extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
    ...
    public CIM_CollectionSetting(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_CollectionSetting(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_CollectionSetting() {
    }
    ...
    public static CIMProperty create_Collection_CIM_CollectionOfMSEs(WBEMClient client,
        ...
        CIM_CollectionSetting fco = new CIM_CollectionSetting(client, namespace);
    ...
    public String getObjectName() {
        return CIM_CollectionSetting.CIM_CLASS_NAME;
    }
