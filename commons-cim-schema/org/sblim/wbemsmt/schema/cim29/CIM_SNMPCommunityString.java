 ...
 *
 *
 * Description: SNMPCommunityString is an access point for an SNMPService. Each instance stores a community string that can be used for making SNMP requests.
 * 
 */
