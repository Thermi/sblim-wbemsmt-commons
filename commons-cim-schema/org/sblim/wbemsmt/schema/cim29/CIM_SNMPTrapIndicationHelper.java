 ...
 * 
 * Description: Helper class for CIM_SNMPTrapIndication
 *    
 * 
 * generated Class
 * @see CIM_SNMPTrapIndication
 */
...
public class CIM_SNMPTrapIndicationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SNMPTrapIndication or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SNMPTrapIndication.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SNMPTrapIndication.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SNMPTrapIndication or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_SNMPTrapIndication.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SNMPTrapIndication(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SNMPTrapIndicationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SNMPTrapIndication.");
                        resultArrayList.add(new CIM_SNMPTrapIndication(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SNMPTrapIndication.");
                        resultArrayList.add(new CIM_SNMPTrapIndication(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SNMPTrapIndication.");
                        resultArrayList.add(new CIM_SNMPTrapIndication(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SNMPTrapIndication getInstance(WBEMClient client,
    ...
    public final static CIM_SNMPTrapIndication getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SNMPTrapIndication) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SNMPTrapIndication(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_SNMPTrapIndication createInstance(WBEMClient client,
            CIM_SNMPTrapIndication dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SNMPTrapIndication newDataInstance = CIM_SNMPTrapIndicationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SNMPTrapIndication modifyInstance(WBEMClient client,
            CIM_SNMPTrapIndication dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SNMPTrapIndication dataInstance2 = CIM_SNMPTrapIndicationHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SNMPTrapIndication dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SNMPTrapIndication.getPackages());
    }
