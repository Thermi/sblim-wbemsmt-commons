...
public class CIM_ConcreteJob extends CIM_Job {
    ...
    public static class METHOD_REQUESTSTATECHANGE {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@69c469c4
        ...
        public static class PARAMETER_REQUESTEDSTATE {
             ...
             * @return the ValueMap entry or null if not found
             */
            //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@11de11de
    ...
    public static class PROPERTY_JOBSTATE {
        ...
        /**
         * constant for value map entry 12..32767
         */

        /**
         * constant for value entry DMTF Reserved (corresponds to mapEntry 12..32767 )
         */
        public final static String VALUE_ENTRY_DMTF_Reserved = "DMTF Reserved";
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@61f661f6
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_New, VALUE_ENTRY_Starting,
                ...
                VALUE_ENTRY_Exception, VALUE_ENTRY_Service, VALUE_ENTRY_DMTF_Reserved,
    ...
    public boolean set_JobState(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_JOBSTATE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_JobState(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_TimeBeforeRemoval(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_TIMEBEFOREREMOVAL.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_TimeBeforeRemoval(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
     ...
     * Requests that the job's state be changed to the value specified in the RequestedState parameter. Invoking the RequestStateChange method multiple times could result in earlier requests being overwritten/lost. 
     * If 0 is returned, then the task completed successfully. Any other return code indicates an error condition.
     *   @param RequestedState Changes the state of a job. 
