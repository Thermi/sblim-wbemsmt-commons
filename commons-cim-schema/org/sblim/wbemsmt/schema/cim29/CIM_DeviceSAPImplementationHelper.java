 ...
 * 
 * Description: Helper class for CIM_DeviceSAPImplementation
 *    
 * 
 * generated Class
 * @see CIM_DeviceSAPImplementation
 */
...
public class CIM_DeviceSAPImplementationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DeviceSAPImplementation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DeviceSAPImplementation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_DeviceSAPImplementation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DeviceSAPImplementation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_DeviceSAPImplementation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DeviceSAPImplementationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DeviceSAPImplementation.");
                        resultArrayList.add(new CIM_DeviceSAPImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DeviceSAPImplementation.");
                        resultArrayList.add(new CIM_DeviceSAPImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DeviceSAPImplementation.");
                        resultArrayList.add(new CIM_DeviceSAPImplementation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DeviceSAPImplementation getInstance(WBEMClient client,
    ...
    public final static CIM_DeviceSAPImplementation getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DeviceSAPImplementation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DeviceSAPImplementation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DeviceSAPImplementation getInstance(WBEMClient client,
            String namespace, CIM_LogicalDevice Antecedent, CIM_ServiceAccessPoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DeviceSAPImplementation.PROPERTY_ANTECEDENT_CIM_LOGICALDEVICE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_DeviceSAPImplementation.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,
     ...
     *
     */
    public final static CIM_DeviceSAPImplementation createInstance(WBEMClient client,
            CIM_DeviceSAPImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_DeviceSAPImplementation newDataInstance = CIM_DeviceSAPImplementationHelper
     ...
     */
    public final static CIM_DeviceSAPImplementation modifyInstance(WBEMClient client,
            CIM_DeviceSAPImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DeviceSAPImplementation dataInstance2 = CIM_DeviceSAPImplementationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_DeviceSAPImplementation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DeviceSAPImplementation.getPackages());
    }
