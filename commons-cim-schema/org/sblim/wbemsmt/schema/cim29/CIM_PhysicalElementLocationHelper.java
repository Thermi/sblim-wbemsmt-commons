 ...
 * 
 * Description: Helper class for CIM_PhysicalElementLocation
 *    
 * 
 * generated Class
 * @see CIM_PhysicalElementLocation
 */
...
public class CIM_PhysicalElementLocationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PhysicalElementLocation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PhysicalElementLocation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PhysicalElementLocation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PhysicalElementLocation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PhysicalElementLocation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PhysicalElementLocationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PhysicalElementLocation.");
                        resultArrayList.add(new CIM_PhysicalElementLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PhysicalElementLocation.");
                        resultArrayList.add(new CIM_PhysicalElementLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PhysicalElementLocation.");
                        resultArrayList.add(new CIM_PhysicalElementLocation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PhysicalElementLocation getInstance(WBEMClient client,
    ...
    public final static CIM_PhysicalElementLocation getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PhysicalElementLocation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PhysicalElementLocation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PhysicalElementLocation getInstance(WBEMClient client,
            String namespace, CIM_PhysicalElement Element, CIM_Location PhysicalLocation
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PhysicalElementLocation.PROPERTY_ELEMENT_CIM_PHYSICALELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_PhysicalElementLocation.PROPERTY_PHYSICALLOCATION_CIM_LOCATION.NAME,
                new CIMDataType(CIM_Location.CIM_CLASS_NAME), setThis, false, false,
                CIM_PhysicalElementLocation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PhysicalElementLocation createInstance(WBEMClient client,
            CIM_PhysicalElementLocation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PhysicalElementLocation newDataInstance = CIM_PhysicalElementLocationHelper
     ...
     */
    public final static CIM_PhysicalElementLocation modifyInstance(WBEMClient client,
            CIM_PhysicalElementLocation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PhysicalElementLocation dataInstance2 = CIM_PhysicalElementLocationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_PhysicalElementLocation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PhysicalElementLocation.getPackages());
    }
