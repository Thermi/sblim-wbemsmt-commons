 ...
 * 
 * Description: Helper class for CIM_HomeForMedia
 *    
 * 
 * generated Class
 * @see CIM_HomeForMedia
 */
...
public class CIM_HomeForMediaHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HomeForMedia or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HomeForMedia.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_HomeForMedia.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HomeForMedia or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_HomeForMedia.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HomeForMedia(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HomeForMediaHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HomeForMedia.");
                        resultArrayList.add(new CIM_HomeForMedia(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HomeForMedia.");
                        resultArrayList.add(new CIM_HomeForMedia(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HomeForMedia.");
                        resultArrayList.add(new CIM_HomeForMedia(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HomeForMedia getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_HomeForMedia getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HomeForMedia) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HomeForMedia(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HomeForMedia getInstance(WBEMClient client, String namespace,
            CIM_StorageMediaLocation Antecedent, CIM_PhysicalMedia Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HomeForMedia.PROPERTY_ANTECEDENT_CIM_STORAGEMEDIALOCATION.NAME,
                new CIMDataType(CIM_StorageMediaLocation.CIM_CLASS_NAME), setThis, false, false,
                CIM_HomeForMedia.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_HomeForMedia.PROPERTY_DEPENDENT_CIM_PHYSICALMEDIA.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_HomeForMedia createInstance(WBEMClient client,
            CIM_HomeForMedia dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HomeForMedia newDataInstance = CIM_HomeForMediaHelper
     ...
     */
    public final static CIM_HomeForMedia modifyInstance(WBEMClient client,
            CIM_HomeForMedia dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HomeForMedia dataInstance2 = CIM_HomeForMediaHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HomeForMedia dataInstance)
            throws WbemsmtException {
