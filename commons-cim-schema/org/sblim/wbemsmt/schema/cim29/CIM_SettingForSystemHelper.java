 ...
 * 
 * Description: Helper class for CIM_SettingForSystem
 *    
 * 
 * generated Class
 * @see CIM_SettingForSystem
 */
...
public class CIM_SettingForSystemHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SettingForSystem or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SettingForSystem.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SettingForSystem or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_SettingForSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SettingForSystem(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SettingForSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SettingForSystem.");
                        resultArrayList.add(new CIM_SettingForSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SettingForSystem.");
                        resultArrayList.add(new CIM_SettingForSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SettingForSystem.");
                        resultArrayList.add(new CIM_SettingForSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SettingForSystem getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SettingForSystem getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SettingForSystem) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SettingForSystem(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SettingForSystem getInstance(WBEMClient client, String namespace,
            CIM_System Antecedent, CIM_SystemSetting Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SettingForSystem.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SettingForSystem.PROPERTY_DEPENDENT_CIM_SYSTEMSETTING.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_SettingForSystem createInstance(WBEMClient client,
            CIM_SettingForSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SettingForSystem newDataInstance = CIM_SettingForSystemHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SettingForSystem modifyInstance(WBEMClient client,
            CIM_SettingForSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SettingForSystem dataInstance2 = CIM_SettingForSystemHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SettingForSystem dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SettingForSystem.getPackages());
    }
