 ...
 * 
 * Description: Helper class for CIM_ComputerSystemMemory
 *    
 * 
 * generated Class
 * @see CIM_ComputerSystemMemory
 */
...
public class CIM_ComputerSystemMemoryHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ComputerSystemMemory or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ComputerSystemMemory.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ComputerSystemMemory.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ComputerSystemMemory or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ComputerSystemMemory(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ComputerSystemMemoryHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ComputerSystemMemory.");
                        resultArrayList.add(new CIM_ComputerSystemMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ComputerSystemMemory.");
                        resultArrayList.add(new CIM_ComputerSystemMemory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ComputerSystemMemory.");
                        resultArrayList.add(new CIM_ComputerSystemMemory(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ComputerSystemMemory getInstance(WBEMClient client,
    ...
    public final static CIM_ComputerSystemMemory getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ComputerSystemMemory) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ComputerSystemMemory(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ComputerSystemMemory getInstance(WBEMClient client, String namespace,
            CIM_UnitaryComputerSystem GroupComponent, CIM_Memory PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ComputerSystemMemory.PROPERTY_GROUPCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ComputerSystemMemory.PROPERTY_PARTCOMPONENT_CIM_MEMORY.NAME, new CIMDataType(
                        CIM_Memory.CIM_CLASS_NAME), setThis, false, false,
                CIM_ComputerSystemMemory.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ComputerSystemMemory createInstance(WBEMClient client,
            CIM_ComputerSystemMemory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ComputerSystemMemory newDataInstance = CIM_ComputerSystemMemoryHelper.getInstance(
     ...
     */
    public final static CIM_ComputerSystemMemory modifyInstance(WBEMClient client,
            CIM_ComputerSystemMemory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ComputerSystemMemory dataInstance2 = CIM_ComputerSystemMemoryHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ComputerSystemMemory dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ComputerSystemMemory.getPackages());
    }
