 ...
 * 
 * Description: Helper class for CIM_FileIdentity
 *    
 * 
 * generated Class
 * @see CIM_FileIdentity
 */
...
public class CIM_FileIdentityHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FileIdentity or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FileIdentity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_FileIdentity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FileIdentity or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_FileIdentity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FileIdentity(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FileIdentityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FileIdentity.");
                        resultArrayList.add(new CIM_FileIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FileIdentity.");
                        resultArrayList.add(new CIM_FileIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FileIdentity.");
                        resultArrayList.add(new CIM_FileIdentity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FileIdentity getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_FileIdentity getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FileIdentity) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FileIdentity(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FileIdentity getInstance(WBEMClient client, String namespace,
            CIM_LogicalFile SystemElement, CIM_UnixFile SameElement
        ...
        keyProperties[0] = new CIMProperty(
                CIM_FileIdentity.PROPERTY_SYSTEMELEMENT_CIM_LOGICALFILE.NAME, new CIMDataType(
                        CIM_LogicalFile.CIM_CLASS_NAME), setThis, false, false,
                CIM_FileIdentity.CIM_CLASS_NAME);

        setThis = SameElement != null ? SameElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_FileIdentity.PROPERTY_SAMEELEMENT_CIM_UNIXFILE.NAME,
                new CIMDataType(CIM_UnixFile.CIM_CLASS_NAME), setThis, false, false,
                CIM_FileIdentity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FileIdentity createInstance(WBEMClient client,
            CIM_FileIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_FileIdentity newDataInstance = CIM_FileIdentityHelper
     ...
     */
    public final static CIM_FileIdentity modifyInstance(WBEMClient client,
            CIM_FileIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FileIdentity dataInstance2 = CIM_FileIdentityHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FileIdentity dataInstance)
            throws WbemsmtException {
