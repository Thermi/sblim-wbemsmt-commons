 ...
 * 
 * Description: Helper class for CIM_BIOSFeature
 *    
 * 
 * generated Class
 * @see CIM_BIOSFeature
...
public class CIM_BIOSFeatureHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BIOSFeature or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BIOSFeature.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_BIOSFeature.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BIOSFeature or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BIOSFeature.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BIOSFeature(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BIOSFeatureHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BIOSFeature.");
                        resultArrayList.add(new CIM_BIOSFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BIOSFeature.");
                        resultArrayList.add(new CIM_BIOSFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BIOSFeature.");
                        resultArrayList.add(new CIM_BIOSFeature(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BIOSFeature getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_BIOSFeature getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BIOSFeature) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BIOSFeature(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BIOSFeature getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_BIOSFeature.PROPERTY_IDENTIFYINGNUMBER.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BIOSFeature.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_BIOSFeature.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BIOSFeature.CIM_CLASS_NAME);

        setThis = ProductName;

        keyProperties[2] = new CIMProperty(CIM_BIOSFeature.PROPERTY_PRODUCTNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BIOSFeature.CIM_CLASS_NAME);

        setThis = Vendor;

        keyProperties[3] = new CIMProperty(CIM_BIOSFeature.PROPERTY_VENDOR.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BIOSFeature.CIM_CLASS_NAME);

        setThis = Version;

        keyProperties[4] = new CIMProperty(CIM_BIOSFeature.PROPERTY_VERSION.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BIOSFeature.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BIOSFeature createInstance(WBEMClient client,
            CIM_BIOSFeature dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_BIOSFeature newDataInstance = CIM_BIOSFeatureHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_BIOSFeature modifyInstance(WBEMClient client,
            CIM_BIOSFeature dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BIOSFeature dataInstance2 = CIM_BIOSFeatureHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BIOSFeature dataInstance)
            throws WbemsmtException {
