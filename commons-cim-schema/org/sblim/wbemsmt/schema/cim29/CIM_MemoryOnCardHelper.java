 ...
 * 
 * Description: Helper class for CIM_MemoryOnCard
 *    
 * 
 * generated Class
 * @see CIM_MemoryOnCard
 */
...
public class CIM_MemoryOnCardHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MemoryOnCard or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MemoryOnCard.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_MemoryOnCard.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MemoryOnCard or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_MemoryOnCard.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MemoryOnCard(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MemoryOnCardHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MemoryOnCard.");
                        resultArrayList.add(new CIM_MemoryOnCard(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MemoryOnCard.");
                        resultArrayList.add(new CIM_MemoryOnCard(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MemoryOnCard.");
                        resultArrayList.add(new CIM_MemoryOnCard(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MemoryOnCard getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_MemoryOnCard getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MemoryOnCard) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MemoryOnCard(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_MemoryOnCard getInstance(WBEMClient client, String namespace,
            CIM_Card GroupComponent, CIM_PhysicalMemory PartComponent
        ...
        keyProperties[0] = new CIMProperty(CIM_MemoryOnCard.PROPERTY_GROUPCOMPONENT_CIM_CARD.NAME,
                new CIMDataType(CIM_Card.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_MemoryOnCard.PROPERTY_PARTCOMPONENT_CIM_PHYSICALMEMORY.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_MemoryOnCard createInstance(WBEMClient client,
            CIM_MemoryOnCard dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MemoryOnCard newDataInstance = CIM_MemoryOnCardHelper
     ...
     */
    public final static CIM_MemoryOnCard modifyInstance(WBEMClient client,
            CIM_MemoryOnCard dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MemoryOnCard dataInstance2 = CIM_MemoryOnCardHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MemoryOnCard dataInstance)
            throws WbemsmtException {
