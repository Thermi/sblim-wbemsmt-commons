...
public class CIM_HostedJobDestination extends CIM_HostedDependency {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_JOBDESTINATION {
        /**
    ...
    public CIM_HostedJobDestination(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HostedJobDestination(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_HostedJobDestination() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_System(WBEMClient client, String namespace,
        ...
        CIM_HostedJobDestination fco = new CIM_HostedJobDestination(client, namespace);
    ...
    public CIM_JobDestination get_Dependent_CIM_JobDestination(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_JOBDESTINATION.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_JOBDESTINATION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Dependent_CIM_JobDestination(CIM_JobDestination newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_JOBDESTINATION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_JobDestination(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_Dependent_CIM_JobDestination(WBEMClient client,
            String namespace, CIM_JobDestination newValue) throws WbemsmtException {
        CIM_HostedJobDestination fco = new CIM_HostedJobDestination(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_JOBDESTINATION.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_JobDestination(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_JOBDESTINATION.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_JobDestination(
    ...
    public String getObjectName() {
        return CIM_HostedJobDestination.CIM_CLASS_NAME;
    }
