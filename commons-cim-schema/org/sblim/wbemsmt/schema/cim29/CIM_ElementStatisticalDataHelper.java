 ...
 * 
 * Description: Helper class for CIM_ElementStatisticalData
 *    
 * 
 * generated Class
 * @see CIM_ElementStatisticalData
 */
...
public class CIM_ElementStatisticalDataHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ElementStatisticalData or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementStatisticalData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ElementStatisticalData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ElementStatisticalData or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ElementStatisticalData(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ElementStatisticalDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ElementStatisticalData.");
                        resultArrayList.add(new CIM_ElementStatisticalData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementStatisticalData.");
                        resultArrayList.add(new CIM_ElementStatisticalData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementStatisticalData.");
                        resultArrayList.add(new CIM_ElementStatisticalData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementStatisticalData getInstance(WBEMClient client,
    ...
    public final static CIM_ElementStatisticalData getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ElementStatisticalData) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ElementStatisticalData(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ElementStatisticalData getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement ManagedElement, CIM_StatisticalData Stats
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementStatisticalData.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ElementStatisticalData.PROPERTY_STATS_CIM_STATISTICALDATA.NAME,
     ...
     *
     */
    public final static CIM_ElementStatisticalData createInstance(WBEMClient client,
            CIM_ElementStatisticalData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ElementStatisticalData newDataInstance = CIM_ElementStatisticalDataHelper.getInstance(
     ...
     */
    public final static CIM_ElementStatisticalData modifyInstance(WBEMClient client,
            CIM_ElementStatisticalData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementStatisticalData dataInstance2 = CIM_ElementStatisticalDataHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ElementStatisticalData dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementStatisticalData.getPackages());
    }
