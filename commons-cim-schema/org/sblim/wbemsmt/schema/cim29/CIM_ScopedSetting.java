...
public class CIM_ScopedSetting extends CIM_HostedDependency {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_SCOPEDSETTINGDATA {
        /**
     ...
     * 
     *       *   <br>
     *   ScopedSetting defines a setting in the context of the Managed Element which it resides.
     *   @param client the CIM Client
     *   @param namespace the target namespace
     */

    public CIM_ScopedSetting(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ScopedSetting(CIMInstance cimInstance) throws WbemsmtException {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("Dependent", new CIMProperty("Dependent", new CIMDataType(
                CIM_ScopedSettingData.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_Antecedent_CIM_ManagedElement(WBEMClient client,
        ...
        CIM_ScopedSetting fco = new CIM_ScopedSetting(client, namespace);
    ...
    public CIM_ScopedSettingData get_Dependent_CIM_ScopedSettingData(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SCOPEDSETTINGDATA.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SCOPEDSETTINGDATA.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return CIM_ScopedSettingDataHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_Dependent_CIM_ScopedSettingData(CIM_ScopedSettingData newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SCOPEDSETTINGDATA.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_ScopedSettingData(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_Dependent_CIM_ScopedSettingData(WBEMClient client,
            String namespace, CIM_ScopedSettingData newValue) throws WbemsmtException {
        CIM_ScopedSetting fco = new CIM_ScopedSetting(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_SCOPEDSETTINGDATA.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_ScopedSettingData(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SCOPEDSETTINGDATA.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_ScopedSettingData(
            CIMProperty currentProperty, CIM_ScopedSettingData newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return CIM_ScopedSetting.CIM_CLASS_NAME;
    }
