 ...
 * 
 * Description: Helper class for CIM_DeviceStatisticalInformation
 *    
 * 
 * generated Class
 * @see CIM_DeviceStatisticalInformation
 */
...
public class CIM_DeviceStatisticalInformationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DeviceStatisticalInformation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DeviceStatisticalInformation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_DeviceStatisticalInformation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DeviceStatisticalInformation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_DeviceStatisticalInformation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DeviceStatisticalInformationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DeviceStatisticalInformation.");
                        resultArrayList.add(new CIM_DeviceStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DeviceStatisticalInformation.");
                        resultArrayList.add(new CIM_DeviceStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DeviceStatisticalInformation.");
                        resultArrayList.add(new CIM_DeviceStatisticalInformation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DeviceStatisticalInformation getInstance(WBEMClient client,
    ...
    public final static CIM_DeviceStatisticalInformation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_DeviceStatisticalInformationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DeviceStatisticalInformation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DeviceStatisticalInformation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DeviceStatisticalInformation getInstance(WBEMClient client,
            String namespace, String CreationClassName, String DeviceCreationClassName,
            String DeviceID, String Name, String SystemCreationClassName, String SystemName
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DeviceStatisticalInformation.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_DeviceStatisticalInformation.CIM_CLASS_NAME);

        setThis = DeviceCreationClassName;

        keyProperties[1] = new CIMProperty(
                CIM_DeviceStatisticalInformation.PROPERTY_DEVICECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_DeviceStatisticalInformation.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[2] = new CIMProperty(CIM_DeviceStatisticalInformation.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_DeviceStatisticalInformation.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_DeviceStatisticalInformation.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_DeviceStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[4] = new CIMProperty(
                CIM_DeviceStatisticalInformation.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_DeviceStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[5] = new CIMProperty(
                CIM_DeviceStatisticalInformation.PROPERTY_SYSTEMNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_DeviceStatisticalInformation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_DeviceStatisticalInformation createInstance(WBEMClient client,
            CIM_DeviceStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_DeviceStatisticalInformation newDataInstance = CIM_DeviceStatisticalInformationHelper
     ...
     */
    public final static CIM_DeviceStatisticalInformation modifyInstance(WBEMClient client,
            CIM_DeviceStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DeviceStatisticalInformation dataInstance2 = CIM_DeviceStatisticalInformationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_DeviceStatisticalInformation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DeviceStatisticalInformation.getPackages());
    }
