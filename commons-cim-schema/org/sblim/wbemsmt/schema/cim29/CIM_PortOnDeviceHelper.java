 ...
 * 
 * Description: Helper class for CIM_PortOnDevice
 *    
 * 
 * generated Class
 * @see CIM_PortOnDevice
 */
...
public class CIM_PortOnDeviceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PortOnDevice or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PortOnDevice.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_PortOnDevice.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PortOnDevice or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_PortOnDevice.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_PortOnDevice(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PortOnDeviceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PortOnDevice.");
                        resultArrayList.add(new CIM_PortOnDevice(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PortOnDevice.");
                        resultArrayList.add(new CIM_PortOnDevice(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PortOnDevice.");
                        resultArrayList.add(new CIM_PortOnDevice(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PortOnDevice getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_PortOnDevice getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PortOnDevice) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PortOnDevice(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PortOnDevice getInstance(WBEMClient client, String namespace,
            CIM_LogicalDevice Antecedent, CIM_LogicalPort Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PortOnDevice.PROPERTY_ANTECEDENT_CIM_LOGICALDEVICE.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_PortOnDevice.PROPERTY_DEPENDENT_CIM_LOGICALPORT.NAME, new CIMDataType(
                        CIM_LogicalPort.CIM_CLASS_NAME), setThis, false, false,
                CIM_PortOnDevice.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PortOnDevice createInstance(WBEMClient client,
            CIM_PortOnDevice dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_PortOnDevice newDataInstance = CIM_PortOnDeviceHelper
     ...
     */
    public final static CIM_PortOnDevice modifyInstance(WBEMClient client,
            CIM_PortOnDevice dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PortOnDevice dataInstance2 = CIM_PortOnDeviceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PortOnDevice dataInstance)
            throws WbemsmtException {
