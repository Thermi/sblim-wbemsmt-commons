 ...
 * 
 * Description: Helper class for CIM_BootServiceAccessBySAP
 *    
 * 
 * generated Class
 * @see CIM_BootServiceAccessBySAP
 */
...
public class CIM_BootServiceAccessBySAPHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BootServiceAccessBySAP or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BootServiceAccessBySAP.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_BootServiceAccessBySAP.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BootServiceAccessBySAP or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_BootServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BootServiceAccessBySAPHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BootServiceAccessBySAP.");
                        resultArrayList.add(new CIM_BootServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BootServiceAccessBySAP.");
                        resultArrayList.add(new CIM_BootServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BootServiceAccessBySAP.");
                        resultArrayList.add(new CIM_BootServiceAccessBySAP(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BootServiceAccessBySAP getInstance(WBEMClient client,
    ...
    public final static CIM_BootServiceAccessBySAP getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BootServiceAccessBySAP) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BootServiceAccessBySAP(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BootServiceAccessBySAP getInstance(WBEMClient client, String namespace,
            CIM_BootService Antecedent, CIM_BootSAP Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_BootServiceAccessBySAP.PROPERTY_ANTECEDENT_CIM_BOOTSERVICE.NAME,
                new CIMDataType(CIM_BootService.CIM_CLASS_NAME), setThis, false, false,
                CIM_BootServiceAccessBySAP.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_BootServiceAccessBySAP.PROPERTY_DEPENDENT_CIM_BOOTSAP.NAME, new CIMDataType(
                        CIM_BootSAP.CIM_CLASS_NAME), setThis, false, false,
                CIM_BootServiceAccessBySAP.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BootServiceAccessBySAP createInstance(WBEMClient client,
            CIM_BootServiceAccessBySAP dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_BootServiceAccessBySAP newDataInstance = CIM_BootServiceAccessBySAPHelper.getInstance(
     ...
     */
    public final static CIM_BootServiceAccessBySAP modifyInstance(WBEMClient client,
            CIM_BootServiceAccessBySAP dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BootServiceAccessBySAP dataInstance2 = CIM_BootServiceAccessBySAPHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_BootServiceAccessBySAP dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_BootServiceAccessBySAP.getPackages());
    }
