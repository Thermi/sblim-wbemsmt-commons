 ...
 * 
 * Description: Helper class for CIM_Realizes
 *    
 * 
 * generated Class
 * @see CIM_Realizes
...
public class CIM_RealizesHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Realizes or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Realizes.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Realizes.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Realizes or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Realizes.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Realizes(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RealizesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Realizes.");
                        resultArrayList.add(new CIM_Realizes(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Realizes.");
                        resultArrayList.add(new CIM_Realizes(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Realizes.");
                        resultArrayList.add(new CIM_Realizes(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Realizes getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Realizes getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Realizes) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Realizes(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Realizes getInstance(WBEMClient client, String namespace,
            CIM_PhysicalElement Antecedent, CIM_LogicalDevice Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_Realizes.PROPERTY_ANTECEDENT_CIM_PHYSICALELEMENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(CIM_Realizes.PROPERTY_DEPENDENT_CIM_LOGICALDEVICE.NAME,
     ...
     *
     */
    public final static CIM_Realizes createInstance(WBEMClient client, CIM_Realizes dataInstance,
        ...
        CIM_Realizes newDataInstance = CIM_RealizesHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Realizes modifyInstance(WBEMClient client, CIM_Realizes dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Realizes dataInstance2 = CIM_RealizesHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Realizes dataInstance)
            throws WbemsmtException {
