 ...
 * 
 * Description: Helper class for CIM_ProvidesServiceToElement
 *    
 * 
 * generated Class
 * @see CIM_ProvidesServiceToElement
 */
...
public class CIM_ProvidesServiceToElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProvidesServiceToElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProvidesServiceToElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProvidesServiceToElement.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProvidesServiceToElement or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProvidesServiceToElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProvidesServiceToElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProvidesServiceToElement.");
                        resultArrayList.add(new CIM_ProvidesServiceToElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProvidesServiceToElement.");
                        resultArrayList.add(new CIM_ProvidesServiceToElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProvidesServiceToElement.");
                        resultArrayList.add(new CIM_ProvidesServiceToElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProvidesServiceToElement getInstance(WBEMClient client,
    ...
    public final static CIM_ProvidesServiceToElement getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProvidesServiceToElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProvidesServiceToElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProvidesServiceToElement getInstance(WBEMClient client,
            String namespace, CIM_Service Antecedent, CIM_ManagedElement Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProvidesServiceToElement.PROPERTY_ANTECEDENT_CIM_SERVICE.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProvidesServiceToElement.PROPERTY_DEPENDENT_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ProvidesServiceToElement createInstance(WBEMClient client,
            CIM_ProvidesServiceToElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProvidesServiceToElement newDataInstance = CIM_ProvidesServiceToElementHelper
     ...
     */
    public final static CIM_ProvidesServiceToElement modifyInstance(WBEMClient client,
            CIM_ProvidesServiceToElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProvidesServiceToElement dataInstance2 = CIM_ProvidesServiceToElementHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProvidesServiceToElement dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProvidesServiceToElement.getPackages());
    }
