 ...
 * 
 * Description: Helper class for CIM_HostedCollection
 *    
 * 
 * generated Class
 * @see CIM_HostedCollection
 */
...
public class CIM_HostedCollectionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostedCollection or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedCollection.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_HostedCollection.CIM_CLASS_NAME
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostedCollection or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_HostedCollection.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostedCollection(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostedCollectionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HostedCollection.");
                        resultArrayList.add(new CIM_HostedCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedCollection.");
                        resultArrayList.add(new CIM_HostedCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedCollection.");
                        resultArrayList.add(new CIM_HostedCollection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedCollection getInstance(WBEMClient client,
     ...
     */
    public final static CIM_HostedCollection getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostedCollection) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostedCollection(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostedCollection getInstance(WBEMClient client, String namespace,
            CIM_System Antecedent, CIM_SystemSpecificCollection Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedCollection.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedCollection.PROPERTY_DEPENDENT_CIM_SYSTEMSPECIFICCOLLECTION.NAME,
                new CIMDataType(CIM_SystemSpecificCollection.CIM_CLASS_NAME), setThis, false,
                false, CIM_HostedCollection.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_HostedCollection createInstance(WBEMClient client,
            CIM_HostedCollection dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedCollection newDataInstance = CIM_HostedCollectionHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedCollection modifyInstance(WBEMClient client,
            CIM_HostedCollection dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedCollection dataInstance2 = CIM_HostedCollectionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedCollection dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedCollection.getPackages());
    }
