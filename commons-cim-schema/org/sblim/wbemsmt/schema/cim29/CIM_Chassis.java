...
An array of free-form strings providing more information on the ChassisTypes array entries. Note, each entry of this array is related to the entry in ChassisTypes that is located at the same index.
	*/
	...
	public final static String[] CIM_VALUEMAP_CHASSISPACKAGETYPE = {"Unknown","Other","SMBIOS Reserved","Desktop","Low Profile Desktop","Pizza Box","Mini Tower","Tower","Portable","LapTop","Notebook","Hand Held","Docking Station","All in One","Sub Notebook","Space-Saving","Lunch Box","Main System Chassis","Expansion Chassis","SubChassis","Bus Expansion Chassis","Peripheral Chassis","Storage Chassis","SMBIOS Reseved","Sealed-Case PC","SMBIOS Reserved","DMTF Reserved","Vendor Reserved"};
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_Chassis.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_Chassis.Java_Package_List.toArray(new String[CIM_Chassis.Java_Package_List.size()]);
    }
