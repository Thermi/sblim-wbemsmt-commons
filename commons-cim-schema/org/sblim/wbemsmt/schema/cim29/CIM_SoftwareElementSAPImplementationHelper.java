...
public final class CIM_SoftwareElementSAPImplementationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					Class clazz = CIM_SoftwareElementSAPImplementationHelper.findClass(cimClient, cimInstance);
					if (clazz == null) {
	...
	*/	
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_SoftwareElementSAPImplementation.getPackages();
