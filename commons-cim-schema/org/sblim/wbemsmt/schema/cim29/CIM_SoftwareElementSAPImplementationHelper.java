 ...
 * 
 * Description: Helper class for CIM_SoftwareElementSAPImplementation
 *    
 * 
 * generated Class
 * @see CIM_SoftwareElementSAPImplementation
 */
...
public class CIM_SoftwareElementSAPImplementationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareElementSAPImplementation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareElementSAPImplementation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SoftwareElementSAPImplementation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareElementSAPImplementation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SoftwareElementSAPImplementation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareElementSAPImplementationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareElementSAPImplementation.");
                        resultArrayList.add(new CIM_SoftwareElementSAPImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareElementSAPImplementation.");
                        resultArrayList.add(new CIM_SoftwareElementSAPImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareElementSAPImplementation.");
                        resultArrayList.add(new CIM_SoftwareElementSAPImplementation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareElementSAPImplementation getInstance(WBEMClient client,
    ...
    public final static CIM_SoftwareElementSAPImplementation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_SoftwareElementSAPImplementationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareElementSAPImplementation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareElementSAPImplementation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareElementSAPImplementation getInstance(WBEMClient client,
            String namespace, CIM_SoftwareElement Antecedent, CIM_ServiceAccessPoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SoftwareElementSAPImplementation.PROPERTY_ANTECEDENT_CIM_SOFTWAREELEMENT.NAME,
                new CIMDataType(CIM_SoftwareElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_SoftwareElementSAPImplementation.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_SoftwareElementSAPImplementation.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,
     ...
     *
     */
    public final static CIM_SoftwareElementSAPImplementation createInstance(WBEMClient client,
            CIM_SoftwareElementSAPImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SoftwareElementSAPImplementation newDataInstance = CIM_SoftwareElementSAPImplementationHelper
     ...
     */
    public final static CIM_SoftwareElementSAPImplementation modifyInstance(WBEMClient client,
            CIM_SoftwareElementSAPImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareElementSAPImplementation dataInstance2 = CIM_SoftwareElementSAPImplementationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SoftwareElementSAPImplementation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareElementSAPImplementation.getPackages());
    }
