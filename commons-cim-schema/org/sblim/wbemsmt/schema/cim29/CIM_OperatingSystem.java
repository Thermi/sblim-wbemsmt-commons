...
public class CIM_OperatingSystem extends CIM_EnabledLogicalElement {
    ...
    public static class PROPERTY_OSTYPE {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@50ac50ac
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("CreationClassName", new CIMProperty("CreationClassName",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("CurrentTimeZone", new CIMProperty("CurrentTimeZone",
                CIMDataType.SINT16_T, null));
        propertiesToCheck.put("Distributed", new CIMProperty("Distributed", CIMDataType.BOOLEAN_T,
                null));
        propertiesToCheck.put("FreePhysicalMemory", new CIMProperty("FreePhysicalMemory",
                CIMDataType.UINT64_T, null));
        propertiesToCheck.put("FreeSpaceInPagingFiles", new CIMProperty("FreeSpaceInPagingFiles",
                CIMDataType.UINT64_T, null));
        propertiesToCheck.put("FreeVirtualMemory", new CIMProperty("FreeVirtualMemory",
                CIMDataType.UINT64_T, null));
        propertiesToCheck.put("LastBootUpTime", new CIMProperty("LastBootUpTime",
                CIMDataType.DATETIME_T, null));
        propertiesToCheck.put("LocalDateTime", new CIMProperty("LocalDateTime",
                CIMDataType.DATETIME_T, null));
        propertiesToCheck.put("MaxNumberOfProcesses", new CIMProperty("MaxNumberOfProcesses",
                CIMDataType.UINT32_T, null));
        propertiesToCheck.put("MaxProcessMemorySize", new CIMProperty("MaxProcessMemorySize",
                CIMDataType.UINT64_T, null));
        propertiesToCheck.put("MaxProcessesPerUser", new CIMProperty("MaxProcessesPerUser",
                CIMDataType.UINT32_T, null));
        propertiesToCheck.put("Name", new CIMProperty("Name", CIMDataType.STRING_T, null));
        propertiesToCheck.put("NumberOfLicensedUsers", new CIMProperty("NumberOfLicensedUsers",
                CIMDataType.UINT32_T, null));
        propertiesToCheck.put("NumberOfProcesses", new CIMProperty("NumberOfProcesses",
                CIMDataType.UINT32_T, null));
        propertiesToCheck.put("NumberOfUsers", new CIMProperty("NumberOfUsers",
                CIMDataType.UINT32_T, null));
        ...
        propertiesToCheck.put("OtherTypeDescription", new CIMProperty("OtherTypeDescription",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("SizeStoredInPagingFiles", new CIMProperty("SizeStoredInPagingFiles",
                CIMDataType.UINT64_T, null));
        propertiesToCheck.put("TotalSwapSpaceSize", new CIMProperty("TotalSwapSpaceSize",
                CIMDataType.UINT64_T, null));
        propertiesToCheck.put("TotalVirtualMemorySize", new CIMProperty("TotalVirtualMemorySize",
                CIMDataType.UINT64_T, null));
        propertiesToCheck.put("TotalVisibleMemorySize", new CIMProperty("TotalVisibleMemorySize",
                CIMDataType.UINT64_T, null));
    ...
    public Short get_CurrentTimeZone() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CURRENTTIMEZONE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_CurrentTimeZone(Short newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_CURRENTTIMEZONE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_CurrentTimeZone(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_CurrentTimeZone(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_CurrentTimeZone(CIMProperty currentProperty,
            Short newValue) {
        Object setThis = null;
    ...
    public Boolean get_Distributed() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DISTRIBUTED.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Distributed(Boolean newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DISTRIBUTED.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Distributed(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_Distributed(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_Distributed(CIMProperty currentProperty,
            Boolean newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger64 get_FreePhysicalMemory() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_FREEPHYSICALMEMORY.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_FreePhysicalMemory(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_FREEPHYSICALMEMORY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_FreePhysicalMemory(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_FreePhysicalMemory(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_FreePhysicalMemory(CIMProperty currentProperty,
    ...
    public javax.cim.UnsignedInteger64 get_FreeSpaceInPagingFiles() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_FREESPACEINPAGINGFILES.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_FreeSpaceInPagingFiles(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_FREESPACEINPAGINGFILES.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_FreeSpaceInPagingFiles(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_FreeSpaceInPagingFiles(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_FreeSpaceInPagingFiles(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger64 get_FreeVirtualMemory() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_FREEVIRTUALMEMORY.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_FreeVirtualMemory(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_FREEVIRTUALMEMORY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_FreeVirtualMemory(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_FreeVirtualMemory(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_FreeVirtualMemory(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public javax.cim.CIMDateTime get_LastBootUpTime() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_LASTBOOTUPTIME.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_LastBootUpTime(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_LASTBOOTUPTIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_LastBootUpTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_LastBootUpTime(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_LastBootUpTime(CIMProperty currentProperty,
    ...
    public javax.cim.CIMDateTime get_LocalDateTime() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_LOCALDATETIME.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_LocalDateTime(javax.cim.CIMDateTime newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_LOCALDATETIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_LocalDateTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_LocalDateTime(WBEMClient client, String namespace,
            javax.cim.CIMDateTime newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_LocalDateTime(CIMProperty currentProperty,
            javax.cim.CIMDateTime newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger32 get_MaxNumberOfProcesses() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MAXNUMBEROFPROCESSES.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_MaxNumberOfProcesses(javax.cim.UnsignedInteger32 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_MAXNUMBEROFPROCESSES.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_MaxNumberOfProcesses(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_MaxNumberOfProcesses(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_MaxNumberOfProcesses(CIMProperty currentProperty,
    ...
    public javax.cim.UnsignedInteger64 get_MaxProcessMemorySize() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MAXPROCESSMEMORYSIZE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_MaxProcessMemorySize(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_MAXPROCESSMEMORYSIZE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_MaxProcessMemorySize(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_MaxProcessMemorySize(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_MaxProcessMemorySize(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger32 get_MaxProcessesPerUser() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MAXPROCESSESPERUSER.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_MaxProcessesPerUser(javax.cim.UnsignedInteger32 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_MAXPROCESSESPERUSER.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_MaxProcessesPerUser(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_MaxProcessesPerUser(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger32 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_MaxProcessesPerUser(CIMProperty currentProperty,
            javax.cim.UnsignedInteger32 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger32 get_NumberOfLicensedUsers() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_NUMBEROFLICENSEDUSERS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_NumberOfLicensedUsers(javax.cim.UnsignedInteger32 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_NUMBEROFLICENSEDUSERS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_NumberOfLicensedUsers(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_NumberOfLicensedUsers(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger32 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_NumberOfLicensedUsers(CIMProperty currentProperty,
            javax.cim.UnsignedInteger32 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger32 get_NumberOfProcesses() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_NUMBEROFPROCESSES.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_NumberOfProcesses(javax.cim.UnsignedInteger32 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_NUMBEROFPROCESSES.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_NumberOfProcesses(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_NumberOfProcesses(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger32 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_NumberOfProcesses(CIMProperty currentProperty,
            javax.cim.UnsignedInteger32 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger32 get_NumberOfUsers() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_NUMBEROFUSERS.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_NumberOfUsers(javax.cim.UnsignedInteger32 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_NUMBEROFUSERS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_NumberOfUsers(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_NumberOfUsers(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger32 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_NumberOfUsers(CIMProperty currentProperty,
            javax.cim.UnsignedInteger32 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger16 get_OSType() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_OSTYPE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_OSType(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_OSTYPE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_OSType(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_OSType(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_OSType(CIMProperty currentProperty,
    ...
    public javax.cim.UnsignedInteger64 get_SizeStoredInPagingFiles() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_SIZESTOREDINPAGINGFILES.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_SizeStoredInPagingFiles(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SIZESTOREDINPAGINGFILES.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_SizeStoredInPagingFiles(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_SizeStoredInPagingFiles(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_SizeStoredInPagingFiles(
    ...
    public javax.cim.UnsignedInteger64 get_TotalSwapSpaceSize() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_TOTALSWAPSPACESIZE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_TotalSwapSpaceSize(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_TOTALSWAPSPACESIZE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_TotalSwapSpaceSize(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_TotalSwapSpaceSize(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_TotalSwapSpaceSize(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger64 get_TotalVirtualMemorySize() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_TOTALVIRTUALMEMORYSIZE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_TotalVirtualMemorySize(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_TOTALVIRTUALMEMORYSIZE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_TotalVirtualMemorySize(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_TotalVirtualMemorySize(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_TotalVirtualMemorySize(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger64 get_TotalVisibleMemorySize() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_TOTALVISIBLEMEMORYSIZE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_TotalVisibleMemorySize(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_TOTALVISIBLEMEMORYSIZE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_TotalVisibleMemorySize(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_TotalVisibleMemorySize(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger64 newValue) throws WbemsmtException {
        CIM_OperatingSystem fco = new CIM_OperatingSystem(client, namespace);
    ...
    private static CIMProperty setPropertyValue_TotalVisibleMemorySize(CIMProperty currentProperty,
            javax.cim.UnsignedInteger64 newValue) {
        Object setThis = null;
    ...
    /**
     * Get the list with CIM_ComputerSystem objects associated by the association CIM_InstalledOS
     * 
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_InstalledOSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_InstalledOSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_InstalledOSNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_InstalledOSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_INSTALLEDOS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_InstalledOSNames(
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_RunningOSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_RunningOSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_RUNNINGOS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
                null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_ComputerSystem_CIM_RunningOSNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ComputerSystem_CIM_RunningOSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_RUNNINGOS, CIM_ComputerSystem.CIM_CLASS_NAME, null,
                null);
    }
    ...
    /**
     * Get the list with CIM_FileSystem objects associated by the association CIM_BootOSFromFS
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_FileSystem_CIM_BootOSFromFSs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_FileSystem_CIM_BootOSFromFSs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_BOOTOSFROMFS, CIM_FileSystem.CIM_CLASS_NAME, null,
                null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_FileSystem_CIM_BootOSFromFSNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_FileSystem_CIM_BootOSFromFSNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_BOOTOSFROMFS, CIM_FileSystem.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_Process_CIM_OSProcesss(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Process_CIM_OSProcesss(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_OSPROCESS, CIM_Process.CIM_CLASS_NAME, null, null,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_Process_CIM_OSProcessNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Process_CIM_OSProcessNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_OSPROCESS, CIM_Process.CIM_CLASS_NAME, null, null);
    }
    ...
    public RebootResult invoke_Reboot(WBEMClient cimClient) throws WbemsmtException {
        ...
        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(), METHOD_REBOOT.NAME,
            ...
            throw new InvokeMethodException(e, new InvokeMethodUserObject(this.getCimObjectPath(),
                    METHOD_REBOOT.NAME, inParameter, outParameter));
        }
    ...
    public ShutdownResult invoke_Shutdown(WBEMClient cimClient) throws WbemsmtException {
        ...
        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(), METHOD_SHUTDOWN.NAME,
                    inParameter, outParameter);
            if (oResult != null) {
            ...
            throw new InvokeMethodException(e, new InvokeMethodUserObject(this.getCimObjectPath(),
                    METHOD_SHUTDOWN.NAME, inParameter, outParameter));
        }
