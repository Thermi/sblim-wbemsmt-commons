/** 
 * CIM_VideoBIOSFeatureHelper.java
 *
...
public final class CIM_VideoBIOSFeatureHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_VideoBIOSFeature.Java_Package_List.size(); i++) {
						if (!((String)(CIM_VideoBIOSFeature.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_VideoBIOSFeature.Java_Package_List.get(i))).endsWith(".")) {
							CIM_VideoBIOSFeature.Java_Package_List.setElementAt((String)(CIM_VideoBIOSFeature.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VideoBIOSFeature.");
						resultArrayList.add(new CIM_VideoBIOSFeature(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VideoBIOSFeature.");
						resultArrayList.add(new CIM_VideoBIOSFeature(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VideoBIOSFeature.");
						resultArrayList.add(new CIM_VideoBIOSFeature(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_VideoBIOSFeature getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_VideoBIOSFeatureHelper.getInstance(cimClient, new CIM_VideoBIOSFeature(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_VideoBIOSFeature getInstance(CIMClient cimClient, CIM_VideoBIOSFeature dataInstance) {
		...
		return CIM_VideoBIOSFeatureHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_VideoBIOSFeature getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_VideoBIOSFeature dataInstance = null;
		try {
			dataInstance = new CIM_VideoBIOSFeature(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_VideoBIOSFeature createInstance(CIMClient cimClient, CIM_VideoBIOSFeature dataInstance, boolean notifyDifferencies){ 
		...
		CIM_VideoBIOSFeature newDataInstance = null;
		try {
			newDataInstance = CIM_VideoBIOSFeatureHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_VideoBIOSFeature modifyInstance(CIMClient cimClient, CIM_VideoBIOSFeature dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_VideoBIOSFeatureHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_VideoBIOSFeature dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_VideoBIOSFeature dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_VideoBIOSFeature.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_VideoBIOSFeature.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_VideoBIOSFeature.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_VideoBIOSFeature.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_VideoBIOSFeature.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
