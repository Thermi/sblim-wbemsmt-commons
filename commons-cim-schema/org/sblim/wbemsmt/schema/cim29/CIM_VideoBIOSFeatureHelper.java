 ...
 * 
 * Description: Helper class for CIM_VideoBIOSFeature
 *    
 * 
 * generated Class
 * @see CIM_VideoBIOSFeature
 */
...
public class CIM_VideoBIOSFeatureHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_VideoBIOSFeature or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_VideoBIOSFeature.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_VideoBIOSFeature or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_VideoBIOSFeature.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VideoBIOSFeature(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_VideoBIOSFeatureHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_VideoBIOSFeature.");
                        resultArrayList.add(new CIM_VideoBIOSFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_VideoBIOSFeature.");
                        resultArrayList.add(new CIM_VideoBIOSFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_VideoBIOSFeature.");
                        resultArrayList.add(new CIM_VideoBIOSFeature(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_VideoBIOSFeature getInstance(WBEMClient client,
     ...
     */
    public final static CIM_VideoBIOSFeature getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_VideoBIOSFeature) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_VideoBIOSFeature(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_VideoBIOSFeature getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_VideoBIOSFeature.PROPERTY_IDENTIFYINGNUMBER.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VideoBIOSFeature.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_VideoBIOSFeature.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VideoBIOSFeature.CIM_CLASS_NAME);

        setThis = ProductName;

        keyProperties[2] = new CIMProperty(CIM_VideoBIOSFeature.PROPERTY_PRODUCTNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VideoBIOSFeature.CIM_CLASS_NAME);

        setThis = Vendor;

        keyProperties[3] = new CIMProperty(CIM_VideoBIOSFeature.PROPERTY_VENDOR.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VideoBIOSFeature.CIM_CLASS_NAME);

        setThis = Version;

        keyProperties[4] = new CIMProperty(CIM_VideoBIOSFeature.PROPERTY_VERSION.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_VideoBIOSFeature.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_VideoBIOSFeature createInstance(WBEMClient client,
            CIM_VideoBIOSFeature dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_VideoBIOSFeature newDataInstance = CIM_VideoBIOSFeatureHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_VideoBIOSFeature modifyInstance(WBEMClient client,
            CIM_VideoBIOSFeature dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_VideoBIOSFeature dataInstance2 = CIM_VideoBIOSFeatureHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_VideoBIOSFeature dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_VideoBIOSFeature.getPackages());
    }
