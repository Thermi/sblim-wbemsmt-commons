 ...
 * 
 * Description: Helper class for CIM_DefaultSetting
 *    
 * 
 * generated Class
 * @see CIM_DefaultSetting
 */
...
public class CIM_DefaultSettingHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DefaultSetting or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DefaultSetting.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_DefaultSetting.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DefaultSetting or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_DefaultSetting.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_DefaultSetting(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DefaultSettingHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DefaultSetting.");
                        resultArrayList.add(new CIM_DefaultSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DefaultSetting.");
                        resultArrayList.add(new CIM_DefaultSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DefaultSetting.");
                        resultArrayList.add(new CIM_DefaultSetting(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DefaultSetting getInstance(WBEMClient client,
     ...
     */
    public final static CIM_DefaultSetting getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DefaultSetting) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DefaultSetting(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_DefaultSetting createInstance(WBEMClient client,
            CIM_DefaultSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_DefaultSetting newDataInstance = CIM_DefaultSettingHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_DefaultSetting modifyInstance(WBEMClient client,
            CIM_DefaultSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DefaultSetting dataInstance2 = CIM_DefaultSettingHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_DefaultSetting dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DefaultSetting.getPackages());
    }
