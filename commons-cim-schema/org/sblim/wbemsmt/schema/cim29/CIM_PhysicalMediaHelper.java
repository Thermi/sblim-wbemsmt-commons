 ...
 * 
 * Description: Helper class for CIM_PhysicalMedia
 *    
 * 
 * generated Class
 * @see CIM_PhysicalMedia
 */
...
public class CIM_PhysicalMediaHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PhysicalMedia or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PhysicalMedia.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_PhysicalMedia.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PhysicalMedia or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_PhysicalMedia.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_PhysicalMedia(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PhysicalMediaHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PhysicalMedia.");
                        resultArrayList.add(new CIM_PhysicalMedia(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PhysicalMedia.");
                        resultArrayList.add(new CIM_PhysicalMedia(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PhysicalMedia.");
                        resultArrayList.add(new CIM_PhysicalMedia(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PhysicalMedia getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_PhysicalMedia getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PhysicalMedia) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PhysicalMedia(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PhysicalMedia getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_PhysicalMedia.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_PhysicalMedia.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[1] = new CIMProperty(CIM_PhysicalMedia.PROPERTY_TAG.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_PhysicalMedia.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PhysicalMedia createInstance(WBEMClient client,
            CIM_PhysicalMedia dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_PhysicalMedia newDataInstance = CIM_PhysicalMediaHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_PhysicalMedia modifyInstance(WBEMClient client,
            CIM_PhysicalMedia dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PhysicalMedia dataInstance2 = CIM_PhysicalMediaHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PhysicalMedia dataInstance)
            throws WbemsmtException {
