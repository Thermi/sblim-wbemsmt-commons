 ...
 * 
 * Description: Helper class for CIM_PowerManagementService
 *    
 * 
 * generated Class
 * @see CIM_PowerManagementService
 */
...
public class CIM_PowerManagementServiceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PowerManagementService or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PowerManagementService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PowerManagementService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PowerManagementService or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_PowerManagementService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_PowerManagementService(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PowerManagementServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PowerManagementService.");
                        resultArrayList.add(new CIM_PowerManagementService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PowerManagementService.");
                        resultArrayList.add(new CIM_PowerManagementService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PowerManagementService.");
                        resultArrayList.add(new CIM_PowerManagementService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PowerManagementService getInstance(WBEMClient client,
    ...
    public final static CIM_PowerManagementService getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PowerManagementService) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PowerManagementService(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PowerManagementService getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PowerManagementService.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_PowerManagementService.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_PowerManagementService.PROPERTY_NAME.NAME,
        ...
        keyProperties[2] = new CIMProperty(
                CIM_PowerManagementService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_PowerManagementService.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_PowerManagementService.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_PowerManagementService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PowerManagementService createInstance(WBEMClient client,
            CIM_PowerManagementService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PowerManagementService newDataInstance = CIM_PowerManagementServiceHelper.getInstance(
     ...
     */
    public final static CIM_PowerManagementService modifyInstance(WBEMClient client,
            CIM_PowerManagementService dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PowerManagementService dataInstance2 = CIM_PowerManagementServiceHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_PowerManagementService dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PowerManagementService.getPackages());
    }
