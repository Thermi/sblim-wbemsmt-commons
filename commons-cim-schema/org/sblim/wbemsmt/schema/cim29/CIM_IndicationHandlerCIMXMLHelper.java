 ...
 * 
 * Description: Helper class for CIM_IndicationHandlerCIMXML
 *    
 * 
 * generated Class
 * @see CIM_IndicationHandlerCIMXML
 */
...
public class CIM_IndicationHandlerCIMXMLHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_IndicationHandlerCIMXML or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_IndicationHandlerCIMXML or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_IndicationHandlerCIMXML(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_IndicationHandlerCIMXMLHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_IndicationHandlerCIMXML.");
                        resultArrayList.add(new CIM_IndicationHandlerCIMXML(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_IndicationHandlerCIMXML.");
                        resultArrayList.add(new CIM_IndicationHandlerCIMXML(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_IndicationHandlerCIMXML.");
                        resultArrayList.add(new CIM_IndicationHandlerCIMXML(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_IndicationHandlerCIMXML getInstance(WBEMClient client,
    ...
    public final static CIM_IndicationHandlerCIMXML getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_IndicationHandlerCIMXML) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_IndicationHandlerCIMXML(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_IndicationHandlerCIMXML getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_IndicationHandlerCIMXML.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_IndicationHandlerCIMXML.PROPERTY_NAME.NAME,
        ...
        keyProperties[2] = new CIMProperty(
                CIM_IndicationHandlerCIMXML.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_IndicationHandlerCIMXML.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_IndicationHandlerCIMXML.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_IndicationHandlerCIMXML createInstance(WBEMClient client,
            CIM_IndicationHandlerCIMXML dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_IndicationHandlerCIMXML newDataInstance = CIM_IndicationHandlerCIMXMLHelper
     ...
     */
    public final static CIM_IndicationHandlerCIMXML modifyInstance(WBEMClient client,
            CIM_IndicationHandlerCIMXML dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_IndicationHandlerCIMXML dataInstance2 = CIM_IndicationHandlerCIMXMLHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_IndicationHandlerCIMXML dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_IndicationHandlerCIMXML.getPackages());
    }
