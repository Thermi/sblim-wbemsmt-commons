 ...
 * 
 * Description: Helper class for CIM_SystemInNamespace
 *    
 * 
 * generated Class
 * @see CIM_SystemInNamespace
 */
...
public class CIM_SystemInNamespaceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemInNamespace or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemInNamespace.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemInNamespace.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemInNamespace or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SystemInNamespace(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemInNamespaceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemInNamespace.");
                        resultArrayList.add(new CIM_SystemInNamespace(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemInNamespace.");
                        resultArrayList.add(new CIM_SystemInNamespace(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemInNamespace.");
                        resultArrayList.add(new CIM_SystemInNamespace(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemInNamespace getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SystemInNamespace getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemInNamespace) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemInNamespace(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemInNamespace getInstance(WBEMClient client, String namespace,
            CIM_Namespace ManagedNamespace, CIM_SystemIdentification Identification
        ...
        setThis = ManagedNamespace != null ? ManagedNamespace.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_SystemInNamespace.PROPERTY_MANAGEDNAMESPACE_CIM_NAMESPACE.NAME,
                new CIMDataType(CIM_Namespace.CIM_CLASS_NAME), setThis, false, false,
                CIM_SystemInNamespace.CIM_CLASS_NAME);

        setThis = Identification != null ? Identification.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_SystemInNamespace.PROPERTY_IDENTIFICATION_CIM_SYSTEMIDENTIFICATION.NAME,
                new CIMDataType(CIM_SystemIdentification.CIM_CLASS_NAME), setThis, false, false,
                CIM_SystemInNamespace.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemInNamespace createInstance(WBEMClient client,
            CIM_SystemInNamespace dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemInNamespace newDataInstance = CIM_SystemInNamespaceHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SystemInNamespace modifyInstance(WBEMClient client,
            CIM_SystemInNamespace dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemInNamespace dataInstance2 = CIM_SystemInNamespaceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemInNamespace dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemInNamespace.getPackages());
    }
