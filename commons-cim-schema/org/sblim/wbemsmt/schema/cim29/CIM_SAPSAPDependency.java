...
public class CIM_SAPSAPDependency extends CIM_Dependency {
     ...
     * 
     *       *   <br>
     *   CIM_SAPSAPDependency is an association between a Service AccessPoint and another ServiceAccessPoint indicating that the latter is required in order for the former ServiceAccess Point to utilize or connect with its Service. For example, to print at a network printer, local Print Access Points must utilize underlying network-related SAPs, or ProtocolEndpoints, in order to send the print request.
     *   @param client the CIM Client
     *   @param namespace the target namespace
     */

    public CIM_SAPSAPDependency(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_SAPSAPDependency(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SAPSAPDependency() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_ServiceAccessPoint(WBEMClient client,
        ...
        CIM_SAPSAPDependency fco = new CIM_SAPSAPDependency(client, namespace);
    ...
    public String getObjectName() {
        return CIM_SAPSAPDependency.CIM_CLASS_NAME;
    }
