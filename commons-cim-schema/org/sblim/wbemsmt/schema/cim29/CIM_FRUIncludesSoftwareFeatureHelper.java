 ...
 * 
 * Description: Helper class for CIM_FRUIncludesSoftwareFeature
 *    
 * 
 * generated Class
 * @see CIM_FRUIncludesSoftwareFeature
 */
...
public class CIM_FRUIncludesSoftwareFeatureHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FRUIncludesSoftwareFeature or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FRUIncludesSoftwareFeature.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FRUIncludesSoftwareFeature.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FRUIncludesSoftwareFeature or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_FRUIncludesSoftwareFeature(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FRUIncludesSoftwareFeatureHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FRUIncludesSoftwareFeature.");
                        resultArrayList.add(new CIM_FRUIncludesSoftwareFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FRUIncludesSoftwareFeature.");
                        resultArrayList.add(new CIM_FRUIncludesSoftwareFeature(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FRUIncludesSoftwareFeature.");
                        resultArrayList.add(new CIM_FRUIncludesSoftwareFeature(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FRUIncludesSoftwareFeature getInstance(WBEMClient client,
    ...
    public final static CIM_FRUIncludesSoftwareFeature getInstance(WBEMClient client,
        ...
        Class clazz = CIM_FRUIncludesSoftwareFeatureHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FRUIncludesSoftwareFeature) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FRUIncludesSoftwareFeature(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FRUIncludesSoftwareFeature getInstance(WBEMClient client,
            String namespace, CIM_FRU FRU, CIM_SoftwareFeature Component
        ...
        setThis = FRU != null ? FRU.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_FRUIncludesSoftwareFeature.PROPERTY_FRU_CIM_FRU.NAME, new CIMDataType(
                        CIM_FRU.CIM_CLASS_NAME), setThis, false, false,
                CIM_FRUIncludesSoftwareFeature.CIM_CLASS_NAME);

        setThis = Component != null ? Component.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_FRUIncludesSoftwareFeature.PROPERTY_COMPONENT_CIM_SOFTWAREFEATURE.NAME,
     ...
     *
     */
    public final static CIM_FRUIncludesSoftwareFeature createInstance(WBEMClient client,
            CIM_FRUIncludesSoftwareFeature dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FRUIncludesSoftwareFeature newDataInstance = CIM_FRUIncludesSoftwareFeatureHelper
     ...
     */
    public final static CIM_FRUIncludesSoftwareFeature modifyInstance(WBEMClient client,
            CIM_FRUIncludesSoftwareFeature dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FRUIncludesSoftwareFeature dataInstance2 = CIM_FRUIncludesSoftwareFeatureHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_FRUIncludesSoftwareFeature dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FRUIncludesSoftwareFeature.getPackages());
    }
