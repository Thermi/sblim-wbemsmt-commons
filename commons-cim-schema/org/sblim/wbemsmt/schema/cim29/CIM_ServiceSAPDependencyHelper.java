 ...
 * 
 * Description: Helper class for CIM_ServiceSAPDependency
 *    
 * 
 * generated Class
 * @see CIM_ServiceSAPDependency
 */
...
public class CIM_ServiceSAPDependencyHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceSAPDependency or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceSAPDependency.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ServiceSAPDependency.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceSAPDependency or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ServiceSAPDependency(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceSAPDependencyHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceSAPDependency.");
                        resultArrayList.add(new CIM_ServiceSAPDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceSAPDependency.");
                        resultArrayList.add(new CIM_ServiceSAPDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceSAPDependency.");
                        resultArrayList.add(new CIM_ServiceSAPDependency(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceSAPDependency getInstance(WBEMClient client,
    ...
    public final static CIM_ServiceSAPDependency getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceSAPDependency) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceSAPDependency(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceSAPDependency getInstance(WBEMClient client, String namespace,
            CIM_ServiceAccessPoint Antecedent, CIM_Service Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ServiceSAPDependency.PROPERTY_ANTECEDENT_CIM_SERVICEACCESSPOINT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ServiceSAPDependency.PROPERTY_DEPENDENT_CIM_SERVICE.NAME, new CIMDataType(
                        CIM_Service.CIM_CLASS_NAME), setThis, false, false,
                CIM_ServiceSAPDependency.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ServiceSAPDependency createInstance(WBEMClient client,
            CIM_ServiceSAPDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ServiceSAPDependency newDataInstance = CIM_ServiceSAPDependencyHelper.getInstance(
     ...
     */
    public final static CIM_ServiceSAPDependency modifyInstance(WBEMClient client,
            CIM_ServiceSAPDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceSAPDependency dataInstance2 = CIM_ServiceSAPDependencyHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ServiceSAPDependency dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceSAPDependency.getPackages());
    }
