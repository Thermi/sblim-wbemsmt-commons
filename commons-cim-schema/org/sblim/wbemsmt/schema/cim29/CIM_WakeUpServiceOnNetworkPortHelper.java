 ...
 * 
 * Description: Helper class for CIM_WakeUpServiceOnNetworkPort
 *    
 * 
 * generated Class
 * @see CIM_WakeUpServiceOnNetworkPort
 */
...
public class CIM_WakeUpServiceOnNetworkPortHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_WakeUpServiceOnNetworkPort or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_WakeUpServiceOnNetworkPort.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_WakeUpServiceOnNetworkPort.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_WakeUpServiceOnNetworkPort or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_WakeUpServiceOnNetworkPort(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_WakeUpServiceOnNetworkPortHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_WakeUpServiceOnNetworkPort.");
                        resultArrayList.add(new CIM_WakeUpServiceOnNetworkPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_WakeUpServiceOnNetworkPort.");
                        resultArrayList.add(new CIM_WakeUpServiceOnNetworkPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_WakeUpServiceOnNetworkPort.");
                        resultArrayList.add(new CIM_WakeUpServiceOnNetworkPort(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_WakeUpServiceOnNetworkPort getInstance(WBEMClient client,
    ...
    public final static CIM_WakeUpServiceOnNetworkPort getInstance(WBEMClient client,
        ...
        Class clazz = CIM_WakeUpServiceOnNetworkPortHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_WakeUpServiceOnNetworkPort) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_WakeUpServiceOnNetworkPort(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_WakeUpServiceOnNetworkPort getInstance(WBEMClient client,
            String namespace, CIM_NetworkPort Antecedent, CIM_WakeUpService Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_WakeUpServiceOnNetworkPort.PROPERTY_ANTECEDENT_CIM_NETWORKPORT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_WakeUpServiceOnNetworkPort.PROPERTY_DEPENDENT_CIM_WAKEUPSERVICE.NAME,
     ...
     *
     */
    public final static CIM_WakeUpServiceOnNetworkPort createInstance(WBEMClient client,
            CIM_WakeUpServiceOnNetworkPort dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_WakeUpServiceOnNetworkPort newDataInstance = CIM_WakeUpServiceOnNetworkPortHelper
     ...
     */
    public final static CIM_WakeUpServiceOnNetworkPort modifyInstance(WBEMClient client,
            CIM_WakeUpServiceOnNetworkPort dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_WakeUpServiceOnNetworkPort dataInstance2 = CIM_WakeUpServiceOnNetworkPortHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_WakeUpServiceOnNetworkPort dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_WakeUpServiceOnNetworkPort.getPackages());
    }
