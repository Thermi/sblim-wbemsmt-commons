...
public class CIM_UnixProcess extends CIM_Process  {
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_UnixProcess.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_UnixProcess.Java_Package_List.toArray(new String[CIM_UnixProcess.Java_Package_List.size()]);
    }
	...
	*/	
	...
	public ArrayList getAssociated_CIM_UnixProcessStatisticalInformation_CIM_UnixProcessStatisticss(CIMClient cimClient,
	...
	public ArrayList getAssociated_CIM_UnixProcessStatisticalInformation_CIM_UnixProcessStatistics_Names(CIMClient cimClient, boolean deep) {
		...
		try {		
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMObjectPath) {
					if (deep || ((CIMObjectPath)obj).getObjectName().equals(CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME)) {
