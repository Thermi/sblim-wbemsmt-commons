 ...
 * 
 * Description: Helper class for CIM_DeviceServiceImplementation
 *    
 * 
 * generated Class
 * @see CIM_DeviceServiceImplementation
 */
...
public class CIM_DeviceServiceImplementationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DeviceServiceImplementation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DeviceServiceImplementation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_DeviceServiceImplementation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DeviceServiceImplementation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_DeviceServiceImplementation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DeviceServiceImplementationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DeviceServiceImplementation.");
                        resultArrayList.add(new CIM_DeviceServiceImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DeviceServiceImplementation.");
                        resultArrayList.add(new CIM_DeviceServiceImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DeviceServiceImplementation.");
                        resultArrayList.add(new CIM_DeviceServiceImplementation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DeviceServiceImplementation getInstance(WBEMClient client,
    ...
    public final static CIM_DeviceServiceImplementation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_DeviceServiceImplementationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DeviceServiceImplementation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DeviceServiceImplementation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DeviceServiceImplementation getInstance(WBEMClient client,
            String namespace, CIM_LogicalDevice Antecedent, CIM_Service Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DeviceServiceImplementation.PROPERTY_ANTECEDENT_CIM_LOGICALDEVICE.NAME,
                new CIMDataType(CIM_LogicalDevice.CIM_CLASS_NAME), setThis, false, false,
                CIM_DeviceServiceImplementation.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_DeviceServiceImplementation.PROPERTY_DEPENDENT_CIM_SERVICE.NAME,
     ...
     *
     */
    public final static CIM_DeviceServiceImplementation createInstance(WBEMClient client,
            CIM_DeviceServiceImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_DeviceServiceImplementation newDataInstance = CIM_DeviceServiceImplementationHelper
     ...
     */
    public final static CIM_DeviceServiceImplementation modifyInstance(WBEMClient client,
            CIM_DeviceServiceImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DeviceServiceImplementation dataInstance2 = CIM_DeviceServiceImplementationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_DeviceServiceImplementation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DeviceServiceImplementation.getPackages());
    }
