 ...
 *
 *
 * Description: SNMPTrapTarget contains information describing a remote system, to which Informs and Traps are sent. An SNMPService is related via a ServiceSAPDependency association to one or more instances of this class.
 * 
 */
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_RemotePort.Java_Package_List.size(); i++) {
			if (((String)CIM_RemotePort.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim29")){
				continue;
			}
