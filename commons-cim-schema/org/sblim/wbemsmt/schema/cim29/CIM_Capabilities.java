...
public class CIM_Capabilities extends CIM_ManagedElement {
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementCapabilitiess(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_ElementCapabilitiess(cimClient,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementCapabilitiess(
        ...
        return getAssociated_CIM_ManagedElement_CIM_ElementCapabilitiess(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTCAPABILITIES, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementCapabilitiesNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_ElementCapabilitiesNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTCAPABILITIES,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementCapabilitiesNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTCAPABILITIES,
                    CIM_ManagedElement.CIM_CLASS_NAME, null, null));
        }
    ...
    public java.util.List getAssociations_CIM_ElementCapabilities(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTCAPABILITIES, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
    ...
    public java.util.List getAssociationNames_CIM_ElementCapabilities(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTCAPABILITIES, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTCAPABILITIES, role));
        }
