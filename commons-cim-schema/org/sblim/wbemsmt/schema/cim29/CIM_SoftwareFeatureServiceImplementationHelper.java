 ...
 * 
 * Description: Helper class for CIM_SoftwareFeatureServiceImplementation
 *    
 * 
 * generated Class
 * @see CIM_SoftwareFeatureServiceImplementation
 */
...
public class CIM_SoftwareFeatureServiceImplementationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareFeatureServiceImplementation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_SoftwareFeatureServiceImplementation.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareFeatureServiceImplementation or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_SoftwareFeatureServiceImplementation.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SoftwareFeatureServiceImplementation(
                                cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareFeatureServiceImplementationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareFeatureServiceImplementation.");
                        resultArrayList.add(new CIM_SoftwareFeatureServiceImplementation(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareFeatureServiceImplementation.");
                        resultArrayList.add(new CIM_SoftwareFeatureServiceImplementation(
                                cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareFeatureServiceImplementation.");
                        resultArrayList.add(new CIM_SoftwareFeatureServiceImplementation(
                                cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareFeatureServiceImplementation getInstance(WBEMClient client,
    ...
    public final static CIM_SoftwareFeatureServiceImplementation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_SoftwareFeatureServiceImplementationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareFeatureServiceImplementation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareFeatureServiceImplementation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareFeatureServiceImplementation getInstance(WBEMClient client,
            String namespace, CIM_SoftwareFeature Antecedent, CIM_Service Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SoftwareFeatureServiceImplementation.PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SoftwareFeatureServiceImplementation.PROPERTY_DEPENDENT_CIM_SERVICE.NAME,
                new CIMDataType(CIM_Service.CIM_CLASS_NAME), setThis, false, false,
                CIM_SoftwareFeatureServiceImplementation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SoftwareFeatureServiceImplementation createInstance(WBEMClient client,
            CIM_SoftwareFeatureServiceImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SoftwareFeatureServiceImplementation newDataInstance = CIM_SoftwareFeatureServiceImplementationHelper
     ...
     */
    public final static CIM_SoftwareFeatureServiceImplementation modifyInstance(WBEMClient client,
            CIM_SoftwareFeatureServiceImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareFeatureServiceImplementation dataInstance2 = CIM_SoftwareFeatureServiceImplementationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SoftwareFeatureServiceImplementation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareFeatureServiceImplementation.getPackages());
    }
