...
public final class CIM_SoftwareFeatureServiceImplementationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					Class clazz = CIM_SoftwareFeatureServiceImplementationHelper.findClass(cimClient, cimInstance);
					if (clazz == null) {
	...
	*/	
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_SoftwareFeatureServiceImplementation.getPackages();
