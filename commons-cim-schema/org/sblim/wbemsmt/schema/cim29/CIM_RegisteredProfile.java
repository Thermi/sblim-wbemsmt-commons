...
public class CIM_RegisteredProfile extends CIM_ManagedElement {
    ...
    public static class PROPERTY_ADVERTISETYPES {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_Not_Advertised = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry Not Advertised (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_Not_Advertised = "Not Advertised";

        /**
         * constant for value map entry 3
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_SLP = new javax.cim.UnsignedInteger16(
                "3");

        /**
         * constant for value entry SLP (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_SLP = "SLP";
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@7cb27cb2
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Other,
                VALUE_ENTRY_Not_Advertised, VALUE_ENTRY_SLP };
    ...
    public static class PROPERTY_REGISTEREDORGANIZATION {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_DMTF = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry DMTF (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_DMTF = "DMTF";

        /**
         * constant for value map entry 3
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_CompTIA = new javax.cim.UnsignedInteger16(
                "3");

        /**
         * constant for value entry CompTIA (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_CompTIA = "CompTIA";

        /**
         * constant for value map entry 4
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Consortium_for_Service_Innovation = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry Consortium for Service Innovation (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_Consortium_for_Service_Innovation = "Consortium for Service Innovation";

        /**
         * constant for value map entry 5
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_FAST = new javax.cim.UnsignedInteger16(
                "5");

        /**
         * constant for value entry FAST (corresponds to mapEntry 5 )
         */
        public final static String VALUE_ENTRY_FAST = "FAST";

        /**
         * constant for value map entry 6
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_GGF = new javax.cim.UnsignedInteger16(
                "6");

        /**
         * constant for value entry GGF (corresponds to mapEntry 6 )
         */
        public final static String VALUE_ENTRY_GGF = "GGF";

        /**
         * constant for value map entry 7
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_7_FOR_VALUE_ENTRY_INTAP = new javax.cim.UnsignedInteger16(
                "7");

        /**
         * constant for value entry INTAP (corresponds to mapEntry 7 )
         */
        public final static String VALUE_ENTRY_INTAP = "INTAP";

        /**
         * constant for value map entry 8
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_8_FOR_VALUE_ENTRY_itSMF = new javax.cim.UnsignedInteger16(
                "8");

        /**
         * constant for value entry itSMF (corresponds to mapEntry 8 )
         */
        public final static String VALUE_ENTRY_itSMF = "itSMF";

        /**
         * constant for value map entry 9
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_9_FOR_VALUE_ENTRY_NAC = new javax.cim.UnsignedInteger16(
                "9");

        /**
         * constant for value entry NAC (corresponds to mapEntry 9 )
         */
        public final static String VALUE_ENTRY_NAC = "NAC";

        /**
         * constant for value map entry 10
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_10_FOR_VALUE_ENTRY_Northwest_Energy_Efficiency_Alliance = new javax.cim.UnsignedInteger16(
                "10");

        /**
         * constant for value entry Northwest Energy Efficiency Alliance (corresponds to mapEntry 10 )
         */
        public final static String VALUE_ENTRY_Northwest_Energy_Efficiency_Alliance = "Northwest Energy Efficiency Alliance";

        /**
         * constant for value map entry 11
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_11_FOR_VALUE_ENTRY_SNIA = new javax.cim.UnsignedInteger16(
                "11");

        /**
         * constant for value entry SNIA (corresponds to mapEntry 11 )
         */
        public final static String VALUE_ENTRY_SNIA = "SNIA";

        /**
         * constant for value map entry 12
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_12_FOR_VALUE_ENTRY_TM_Forum = new javax.cim.UnsignedInteger16(
                "12");

        /**
         * constant for value entry TM Forum (corresponds to mapEntry 12 )
         */
        public final static String VALUE_ENTRY_TM_Forum = "TM Forum";

        /**
         * constant for value map entry 13
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_13_FOR_VALUE_ENTRY_The_Open_Group = new javax.cim.UnsignedInteger16(
                "13");

        /**
         * constant for value entry The Open Group (corresponds to mapEntry 13 )
         */
        public final static String VALUE_ENTRY_The_Open_Group = "The Open Group";

        /**
         * constant for value map entry 14
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_14_FOR_VALUE_ENTRY_ANSI = new javax.cim.UnsignedInteger16(
                "14");

        /**
         * constant for value entry ANSI (corresponds to mapEntry 14 )
         */
        public final static String VALUE_ENTRY_ANSI = "ANSI";

        /**
         * constant for value map entry 15
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_15_FOR_VALUE_ENTRY_IEEE = new javax.cim.UnsignedInteger16(
                "15");

        /**
         * constant for value entry IEEE (corresponds to mapEntry 15 )
         */
        public final static String VALUE_ENTRY_IEEE = "IEEE";

        /**
         * constant for value map entry 16
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_16_FOR_VALUE_ENTRY_IETF = new javax.cim.UnsignedInteger16(
                "16");

        /**
         * constant for value entry IETF (corresponds to mapEntry 16 )
         */
        public final static String VALUE_ENTRY_IETF = "IETF";

        /**
         * constant for value map entry 17
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_17_FOR_VALUE_ENTRY_INCITS = new javax.cim.UnsignedInteger16(
                "17");

        /**
         * constant for value entry INCITS (corresponds to mapEntry 17 )
         */
        public final static String VALUE_ENTRY_INCITS = "INCITS";

        /**
         * constant for value map entry 18
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_18_FOR_VALUE_ENTRY_ISO = new javax.cim.UnsignedInteger16(
                "18");

        /**
         * constant for value entry ISO (corresponds to mapEntry 18 )
         */
        public final static String VALUE_ENTRY_ISO = "ISO";

        /**
         * constant for value map entry 19
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_19_FOR_VALUE_ENTRY_W3C = new javax.cim.UnsignedInteger16(
                "19");

        /**
         * constant for value entry W3C (corresponds to mapEntry 19 )
         */
        public final static String VALUE_ENTRY_W3C = "W3C";
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@758c758c
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
        ...
        public static String getValueEntry(javax.cim.UnsignedInteger16 value) {
            ...
            if (iValue == VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Consortium_for_Service_Innovation
                    .intValue()) {
            ...
            if (iValue == VALUE_MAP_ENTRY_10_FOR_VALUE_ENTRY_Northwest_Energy_Efficiency_Alliance
                    .intValue()) {
         ...
         */
        public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = {
                VALUE_MAP_ENTRY_1_FOR_VALUE_ENTRY_Other, VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_DMTF,
                VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_CompTIA,
                VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Consortium_for_Service_Innovation,
                VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_FAST, VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_GGF,
                VALUE_MAP_ENTRY_7_FOR_VALUE_ENTRY_INTAP, VALUE_MAP_ENTRY_8_FOR_VALUE_ENTRY_itSMF,
                ...
                VALUE_MAP_ENTRY_14_FOR_VALUE_ENTRY_ANSI, VALUE_MAP_ENTRY_15_FOR_VALUE_ENTRY_IEEE,
                VALUE_MAP_ENTRY_16_FOR_VALUE_ENTRY_IETF, VALUE_MAP_ENTRY_17_FOR_VALUE_ENTRY_INCITS,
                VALUE_MAP_ENTRY_18_FOR_VALUE_ENTRY_ISO, VALUE_MAP_ENTRY_19_FOR_VALUE_ENTRY_W3C };
         ...
         * Value Map for the property RegisteredOrganization   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Other, VALUE_ENTRY_DMTF,
                VALUE_ENTRY_CompTIA, VALUE_ENTRY_Consortium_for_Service_Innovation,
                VALUE_ENTRY_FAST, VALUE_ENTRY_GGF, VALUE_ENTRY_INTAP, VALUE_ENTRY_itSMF,
                VALUE_ENTRY_NAC, VALUE_ENTRY_Northwest_Energy_Efficiency_Alliance,
                VALUE_ENTRY_SNIA, VALUE_ENTRY_TM_Forum, VALUE_ENTRY_The_Open_Group,
                VALUE_ENTRY_ANSI, VALUE_ENTRY_IEEE, VALUE_ENTRY_IETF, VALUE_ENTRY_INCITS,
                VALUE_ENTRY_ISO, VALUE_ENTRY_W3C };
         ...
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Other,
                VALUE_ENTRY_DMTF, VALUE_ENTRY_CompTIA,
                VALUE_ENTRY_Consortium_for_Service_Innovation, VALUE_ENTRY_FAST, VALUE_ENTRY_GGF,
                VALUE_ENTRY_INTAP, VALUE_ENTRY_itSMF, VALUE_ENTRY_NAC,
                VALUE_ENTRY_Northwest_Energy_Efficiency_Alliance, VALUE_ENTRY_SNIA,
                VALUE_ENTRY_TM_Forum, VALUE_ENTRY_The_Open_Group, VALUE_ENTRY_ANSI,
                VALUE_ENTRY_IEEE, VALUE_ENTRY_IETF, VALUE_ENTRY_INCITS, VALUE_ENTRY_ISO,
                VALUE_ENTRY_W3C };
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("AdvertiseTypeDescriptions", new CIMProperty(
                "AdvertiseTypeDescriptions", CIMDataType.STRING_ARRAY_T, null));
        propertiesToCheck.put("AdvertiseTypes", new CIMProperty("AdvertiseTypes",
                CIMDataType.UINT16_ARRAY_T, null));
        propertiesToCheck.put("InstanceID", new CIMProperty("InstanceID", CIMDataType.STRING_T,
                null));
        propertiesToCheck.put("OtherRegisteredOrganization", new CIMProperty(
                "OtherRegisteredOrganization", CIMDataType.STRING_T, null));
        propertiesToCheck.put("RegisteredName", new CIMProperty("RegisteredName",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("RegisteredOrganization", new CIMProperty("RegisteredOrganization",
                CIMDataType.UINT16_T, null));
        propertiesToCheck.put("RegisteredVersion", new CIMProperty("RegisteredVersion",
                CIMDataType.STRING_T, null));
    ...
    public String[] get_AdvertiseTypeDescriptions() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ADVERTISETYPEDESCRIPTIONS.NAME
    ...
    public boolean set_AdvertiseTypeDescriptions(String[] newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_AdvertiseTypeDescriptions(currentProperty, newValue);
    ...
    public static CIMProperty create_AdvertiseTypeDescriptions(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_AdvertiseTypeDescriptions(
    ...
    public javax.cim.UnsignedInteger16[] get_AdvertiseTypes() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ADVERTISETYPES.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_AdvertiseTypes(javax.cim.UnsignedInteger16[] newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ADVERTISETYPES.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_AdvertiseTypes(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_AdvertiseTypes(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_AdvertiseTypes(CIMProperty currentProperty,
    ...
    public String get_OtherRegisteredOrganization() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_OTHERREGISTEREDORGANIZATION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_OtherRegisteredOrganization(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_OTHERREGISTEREDORGANIZATION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_OtherRegisteredOrganization(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_OtherRegisteredOrganization(WBEMClient client,
    ...
    private static CIMProperty setPropertyValue_OtherRegisteredOrganization(
            CIMProperty currentProperty, String newValue) {
        Object setThis = null;
    ...
    public String get_RegisteredName() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_REGISTEREDNAME.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_RegisteredName(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_REGISTEREDNAME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_RegisteredName(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_RegisteredName(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_RegisteredProfile fco = new CIM_RegisteredProfile(client, namespace);
    ...
    private static CIMProperty setPropertyValue_RegisteredName(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public javax.cim.UnsignedInteger16 get_RegisteredOrganization() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_REGISTEREDORGANIZATION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_RegisteredOrganization(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_REGISTEREDORGANIZATION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_RegisteredOrganization(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_RegisteredOrganization(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        CIM_RegisteredProfile fco = new CIM_RegisteredProfile(client, namespace);
    ...
    private static CIMProperty setPropertyValue_RegisteredOrganization(CIMProperty currentProperty,
            javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public String get_RegisteredVersion() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_REGISTEREDVERSION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_RegisteredVersion(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_REGISTEREDVERSION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_RegisteredVersion(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_RegisteredVersion(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_RegisteredProfile fco = new CIM_RegisteredProfile(client, namespace);
    ...
    private static CIMProperty setPropertyValue_RegisteredVersion(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_CIM_RegisteredProfile_CIM_ReferencedProfiles(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_RegisteredProfile_CIM_ReferencedProfiles(cimClient,
    ...
    public java.util.List getAssociated_CIM_RegisteredProfile_CIM_ReferencedProfiles(
        ...
        return getAssociated_CIM_RegisteredProfile_CIM_ReferencedProfiles(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REFERENCEDPROFILE, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_RegisteredProfile_CIM_ReferencedProfileNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_RegisteredProfile_CIM_ReferencedProfileNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REFERENCEDPROFILE,
    ...
    public java.util.List getAssociated_CIM_RegisteredProfile_CIM_ReferencedProfileNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_REFERENCEDPROFILE,
                    CIM_RegisteredProfile.CIM_CLASS_NAME, null, null));
        }
    ...
    public java.util.List getAssociations_CIM_ReferencedProfile(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_REFERENCEDPROFILE, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
    ...
    public java.util.List getAssociationNames_CIM_ReferencedProfile(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_REFERENCEDPROFILE, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_REFERENCEDPROFILE, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_ReferencedProfile.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_RegisteredSubProfile objects associated by the association CIM_SubProfileRequiresProfile
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE,
                CIM_RegisteredSubProfile.CIM_CLASS_NAME, null, null, false, false, null);
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(
        ...
        return getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE, resultClass, role,
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_SubProfileRequiresProfile
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE,
                CIM_RegisteredSubProfile.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(
        ...
        return getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE, resultClass, role,
                resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE,
                    CIM_RegisteredSubProfile.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_SubProfileRequiresProfile associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_SubProfileRequiresProfile(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE, role,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_SubProfileRequiresProfileHelper.findClass(cimClient,
                            cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_SubProfileRequiresProfile
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_SubProfileRequiresProfile(WBEMClient cimClient,
            String role, boolean deep) throws WbemsmtException {
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_SubProfileRequiresProfile.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementConformsToProfiles(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_ElementConformsToProfiles(cimClient,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementConformsToProfileNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_ElementConformsToProfileNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTCONFORMSTOPROFILE,
