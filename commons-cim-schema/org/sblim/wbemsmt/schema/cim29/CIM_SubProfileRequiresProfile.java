...
public class CIM_SubProfileRequiresProfile extends CIM_ReferencedProfile {
    ...
    public boolean set_Antecedent_CIM_RegisteredProfile(CIM_RegisteredProfile newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Antecedent_CIM_RegisteredProfile(currentProperty,
                    newValue);
    ...
    public boolean set_Dependent_CIM_RegisteredSubProfile(CIM_RegisteredSubProfile newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_RegisteredSubProfile(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
