 ...
 * 
 * Description: Helper class for CIM_InstalledOS
 *    
 * 
 * generated Class
 * @see CIM_InstalledOS
...
public class CIM_InstalledOSHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_InstalledOS or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_InstalledOS.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_InstalledOS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_InstalledOS or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_InstalledOS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_InstalledOS(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_InstalledOSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_InstalledOS.");
                        resultArrayList.add(new CIM_InstalledOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_InstalledOS.");
                        resultArrayList.add(new CIM_InstalledOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_InstalledOS.");
                        resultArrayList.add(new CIM_InstalledOS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_InstalledOS getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_InstalledOS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_InstalledOS) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_InstalledOS(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_InstalledOS getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem GroupComponent, CIM_OperatingSystem PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_InstalledOS.PROPERTY_GROUPCOMPONENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_InstalledOS.PROPERTY_PARTCOMPONENT_CIM_OPERATINGSYSTEM.NAME, new CIMDataType(
                        CIM_OperatingSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_InstalledOS.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_InstalledOS createInstance(WBEMClient client,
            CIM_InstalledOS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_InstalledOS newDataInstance = CIM_InstalledOSHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_InstalledOS modifyInstance(WBEMClient client,
            CIM_InstalledOS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_InstalledOS dataInstance2 = CIM_InstalledOSHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_InstalledOS dataInstance)
            throws WbemsmtException {
