...
public final class CIM_SettingDataHelper {
	...
	*/	
	public final static CIM_SettingData getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SettingDataHelper.getInstance(cimClient, new CIM_SettingData(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SettingData getInstance(CIMClient cimClient, CIM_SettingData dataInstance) {
		...
		return CIM_SettingDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SettingData getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_SettingData(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SettingData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SettingData.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SettingData.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SettingData.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
