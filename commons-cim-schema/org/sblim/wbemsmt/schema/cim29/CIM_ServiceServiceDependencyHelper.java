 ...
 * 
 * Description: Helper class for CIM_ServiceServiceDependency
 *    
 * 
 * generated Class
 * @see CIM_ServiceServiceDependency
 */
...
public class CIM_ServiceServiceDependencyHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceServiceDependency or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceServiceDependency.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ServiceServiceDependency.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceServiceDependency or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ServiceServiceDependency(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceServiceDependencyHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceServiceDependency.");
                        resultArrayList.add(new CIM_ServiceServiceDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceServiceDependency.");
                        resultArrayList.add(new CIM_ServiceServiceDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceServiceDependency.");
                        resultArrayList.add(new CIM_ServiceServiceDependency(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceServiceDependency getInstance(WBEMClient client,
    ...
    public final static CIM_ServiceServiceDependency getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceServiceDependency) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceServiceDependency(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceServiceDependency getInstance(WBEMClient client,
            String namespace, CIM_Service Antecedent, CIM_Service Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ServiceServiceDependency.PROPERTY_ANTECEDENT_CIM_SERVICE.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ServiceServiceDependency.PROPERTY_DEPENDENT_CIM_SERVICE.NAME, new CIMDataType(
                        CIM_Service.CIM_CLASS_NAME), setThis, false, false,
                CIM_ServiceServiceDependency.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ServiceServiceDependency createInstance(WBEMClient client,
            CIM_ServiceServiceDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ServiceServiceDependency newDataInstance = CIM_ServiceServiceDependencyHelper
     ...
     */
    public final static CIM_ServiceServiceDependency modifyInstance(WBEMClient client,
            CIM_ServiceServiceDependency dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceServiceDependency dataInstance2 = CIM_ServiceServiceDependencyHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ServiceServiceDependency dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceServiceDependency.getPackages());
    }
