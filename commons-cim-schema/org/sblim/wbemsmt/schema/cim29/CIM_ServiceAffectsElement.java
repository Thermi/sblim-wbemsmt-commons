 ...
 * 
 * Description: ServiceAffectsElement represents an association between a Service and the ManagedElement(s) that may be affected by its execution. Instantiating this association indicates that running the service will pose some burden on the ManagedElement that may affect performance, throughput, availability, etc.
 * 
 * generated Class
 */
...
public class CIM_ServiceAffectsElement extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
    ...
    public static class PROPERTY_ELEMENTEFFECTS {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@390c390c
    ...
    public boolean set_ElementEffects(javax.cim.UnsignedInteger16[] newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ElementEffects(currentProperty, newValue);
    ...
    public boolean set_OtherElementEffectsDescriptions(String[] newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_OTHERELEMENTEFFECTSDESCRIPTIONS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_OtherElementEffectsDescriptions(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public boolean set_AffectedElement_CIM_ManagedElement(CIM_ManagedElement newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_AFFECTEDELEMENT_CIM_MANAGEDELEMENT.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_AffectedElement_CIM_ManagedElement(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public boolean set_AffectingElement_CIM_Service(CIM_Service newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_AFFECTINGELEMENT_CIM_SERVICE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_AffectingElement_CIM_Service(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
