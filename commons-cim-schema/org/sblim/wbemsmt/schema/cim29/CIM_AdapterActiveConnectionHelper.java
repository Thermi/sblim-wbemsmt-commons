 ...
 * 
 * Description: Helper class for CIM_AdapterActiveConnection
 *    
 * 
 * generated Class
 * @see CIM_AdapterActiveConnection
 */
...
public class CIM_AdapterActiveConnectionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_AdapterActiveConnection or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AdapterActiveConnection.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AdapterActiveConnection.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_AdapterActiveConnection or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_AdapterActiveConnection(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_AdapterActiveConnectionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AdapterActiveConnection.");
                        resultArrayList.add(new CIM_AdapterActiveConnection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AdapterActiveConnection.");
                        resultArrayList.add(new CIM_AdapterActiveConnection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AdapterActiveConnection.");
                        resultArrayList.add(new CIM_AdapterActiveConnection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AdapterActiveConnection getInstance(WBEMClient client,
    ...
    public final static CIM_AdapterActiveConnection getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_AdapterActiveConnection) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_AdapterActiveConnection(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_AdapterActiveConnection getInstance(WBEMClient client,
            String namespace, CIM_PhysicalConnector Antecedent, CIM_NetworkAdapter Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_AdapterActiveConnection.PROPERTY_ANTECEDENT_CIM_PHYSICALCONNECTOR.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_AdapterActiveConnection.PROPERTY_DEPENDENT_CIM_NETWORKADAPTER.NAME,
     ...
     *
     */
    public final static CIM_AdapterActiveConnection createInstance(WBEMClient client,
            CIM_AdapterActiveConnection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_AdapterActiveConnection newDataInstance = CIM_AdapterActiveConnectionHelper
     ...
     */
    public final static CIM_AdapterActiveConnection modifyInstance(WBEMClient client,
            CIM_AdapterActiveConnection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AdapterActiveConnection dataInstance2 = CIM_AdapterActiveConnectionHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_AdapterActiveConnection dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AdapterActiveConnection.getPackages());
    }
