...
public class CIM_ConcreteJobHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ConcreteJob.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ConcreteJob.");
                        resultArrayList.add(new CIM_ConcreteJob(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ConcreteJob.");
                        resultArrayList.add(new CIM_ConcreteJob(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ConcreteJob.");
                        resultArrayList.add(new CIM_ConcreteJob(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ConcreteJob getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ConcreteJob getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ConcreteJob getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ConcreteJob.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ConcreteJob.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ConcreteJob createInstance(WBEMClient client,
            CIM_ConcreteJob dataInstance, boolean notifyDifferencies) throws WbemsmtException {
     ...
     */
    public final static CIM_ConcreteJob modifyInstance(WBEMClient client,
            CIM_ConcreteJob dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ConcreteJob dataInstance2 = CIM_ConcreteJobHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ConcreteJob dataInstance)
            throws WbemsmtException {
