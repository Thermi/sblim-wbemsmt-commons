 ...
 * 
 * Description: Helper class for CIM_HostedBootService
 *    
 * 
 * generated Class
 * @see CIM_HostedBootService
 */
...
public class CIM_HostedBootServiceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_HostedBootService or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedBootService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_HostedBootService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_HostedBootService or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_HostedBootService(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_HostedBootServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_HostedBootService.");
                        resultArrayList.add(new CIM_HostedBootService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedBootService.");
                        resultArrayList.add(new CIM_HostedBootService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedBootService.");
                        resultArrayList.add(new CIM_HostedBootService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedBootService getInstance(WBEMClient client,
     ...
     */
    public final static CIM_HostedBootService getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_HostedBootService) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_HostedBootService(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_HostedBootService getInstance(WBEMClient client, String namespace,
            CIM_System Antecedent, CIM_BootService Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedBootService.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedBootService.PROPERTY_DEPENDENT_CIM_BOOTSERVICE.NAME, new CIMDataType(
                        CIM_BootService.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostedBootService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_HostedBootService createInstance(WBEMClient client,
            CIM_HostedBootService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedBootService newDataInstance = CIM_HostedBootServiceHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedBootService modifyInstance(WBEMClient client,
            CIM_HostedBootService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedBootService dataInstance2 = CIM_HostedBootServiceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedBootService dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedBootService.getPackages());
    }
