/** 
 * CIM_SoftwareIdentityHelper.java
 *
...
public final class CIM_SoftwareIdentityHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SoftwareIdentity.");
						resultArrayList.add(new CIM_SoftwareIdentity(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SoftwareIdentity.");
						resultArrayList.add(new CIM_SoftwareIdentity(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SoftwareIdentity.");
						resultArrayList.add(new CIM_SoftwareIdentity(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SoftwareIdentity getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SoftwareIdentityHelper.getInstance(cimClient, new CIM_SoftwareIdentity(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SoftwareIdentity getInstance(CIMClient cimClient, CIM_SoftwareIdentity dataInstance) {
		...
		return CIM_SoftwareIdentityHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SoftwareIdentity getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SoftwareIdentity dataInstance = null;
		try {
			dataInstance = new CIM_SoftwareIdentity(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_SoftwareIdentity.getPackages();
	...
	*/	
	public final static CIM_SoftwareIdentity createInstance(CIMClient cimClient, CIM_SoftwareIdentity dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SoftwareIdentity newDataInstance = null;
		try {
			newDataInstance = CIM_SoftwareIdentityHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SoftwareIdentity modifyInstance(CIMClient cimClient, CIM_SoftwareIdentity dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SoftwareIdentityHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SoftwareIdentity dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SoftwareIdentity dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SoftwareIdentity.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SoftwareIdentity.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SoftwareIdentity.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SoftwareIdentity.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SoftwareIdentity.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BuildNumber(UnsignedInt16 BuildNumber) {
		return true;
	}

	public static boolean isValid_ClassificationDescriptions(String[] ClassificationDescriptions) {
		return true;
	}

	public static boolean isValid_Classifications(UnsignedInt16[] Classifications) {
		return true;
	}
	...
	public static boolean isValid_Languages(String[] Languages) {
		return true;
	}

	public static boolean isValid_MajorVersion(UnsignedInt16 MajorVersion) {
		return true;
	}

	public static boolean isValid_Manufacturer(String Manufacturer) {
		return true;
	}

	public static boolean isValid_MinorVersion(UnsignedInt16 MinorVersion) {
		return true;
	}

	public static boolean isValid_ReleaseDate(Calendar ReleaseDate) {
		return true;
	}

	public static boolean isValid_RevisionNumber(UnsignedInt16 RevisionNumber) {
		return true;
	}
	...
	public static boolean isValid_TargetOperatingSystems(String[] TargetOperatingSystems) {
		return true;
	}

	public static boolean isValid_VersionString(String VersionString) {
		return true;
	}
