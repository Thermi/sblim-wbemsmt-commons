...
public class CIM_SoftwareIdentityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareIdentity.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_SoftwareIdentity.");
                        resultArrayList.add(new CIM_SoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareIdentity.");
                        resultArrayList.add(new CIM_SoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareIdentity.");
                        resultArrayList.add(new CIM_SoftwareIdentity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareIdentity getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SoftwareIdentity getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_SoftwareIdentity getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_SoftwareIdentity.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SoftwareIdentity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SoftwareIdentity createInstance(WBEMClient client,
            CIM_SoftwareIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SoftwareIdentity newDataInstance = CIM_SoftwareIdentityHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SoftwareIdentity modifyInstance(WBEMClient client,
            CIM_SoftwareIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareIdentity dataInstance2 = CIM_SoftwareIdentityHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SoftwareIdentity dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareIdentity.getPackages());
    }
