...
public class CIM_ConfigurationHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Configuration.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_Configuration.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_Configuration.");
                        resultArrayList.add(new CIM_Configuration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_Configuration.");
                        resultArrayList.add(new CIM_Configuration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Configuration.");
                        resultArrayList.add(new CIM_Configuration(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Configuration getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Configuration getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_Configuration getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_Configuration.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Configuration.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Configuration createInstance(WBEMClient client,
            CIM_Configuration dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_Configuration newDataInstance = CIM_ConfigurationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_Configuration modifyInstance(WBEMClient client,
            CIM_Configuration dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Configuration dataInstance2 = CIM_ConfigurationHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Configuration dataInstance)
            throws WbemsmtException {
