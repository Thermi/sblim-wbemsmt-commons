...
public class CIM_AssociatedMemory extends CIM_Dependency {
    ...
    public CIM_AssociatedMemory(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_AssociatedMemory(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_AssociatedMemory() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_Memory(WBEMClient client, String namespace,
        ...
        CIM_AssociatedMemory fco = new CIM_AssociatedMemory(client, namespace);
    ...
    public boolean set_Dependent_CIM_LogicalElement(CIM_LogicalElement newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_LOGICALELEMENT.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_LogicalElement(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public String getObjectName() {
        return CIM_AssociatedMemory.CIM_CLASS_NAME;
    }
