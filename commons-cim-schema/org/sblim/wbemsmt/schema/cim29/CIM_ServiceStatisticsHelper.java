 ...
 * 
 * Description: Helper class for CIM_ServiceStatistics
 *    
 * 
 * generated Class
 * @see CIM_ServiceStatistics
 */
...
public class CIM_ServiceStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceStatistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ServiceStatistics.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceStatistics or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ServiceStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceStatistics.");
                        resultArrayList.add(new CIM_ServiceStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceStatistics.");
                        resultArrayList.add(new CIM_ServiceStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceStatistics.");
                        resultArrayList.add(new CIM_ServiceStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceStatistics getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ServiceStatistics getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceStatistics getInstance(WBEMClient client, String namespace,
            CIM_ServiceStatisticalInformation Stats, CIM_Service Element
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ServiceStatistics.PROPERTY_STATS_CIM_SERVICESTATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_ServiceStatisticalInformation.CIM_CLASS_NAME), setThis, false,
                false, CIM_ServiceStatistics.CIM_CLASS_NAME);

        setThis = Element != null ? Element.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_ServiceStatistics.PROPERTY_ELEMENT_CIM_SERVICE.NAME,
     ...
     *
     */
    public final static CIM_ServiceStatistics createInstance(WBEMClient client,
            CIM_ServiceStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ServiceStatistics newDataInstance = CIM_ServiceStatisticsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ServiceStatistics modifyInstance(WBEMClient client,
            CIM_ServiceStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceStatistics dataInstance2 = CIM_ServiceStatisticsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ServiceStatistics dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceStatistics.getPackages());
    }
