...
public class CIM_FRUPhysicalElements extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
     ...
     * 
     */
    public static class PROPERTY_COMPONENT_CIM_PHYSICALELEMENT {
        /**
    ...
    public CIM_FRUPhysicalElements(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_FRUPhysicalElements(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_FRUPhysicalElements() {
    }
    ...
    public static CIMProperty create_FRU_CIM_FRU(WBEMClient client, String namespace,
        ...
        CIM_FRUPhysicalElements fco = new CIM_FRUPhysicalElements(client, namespace);
    ...
    public CIM_PhysicalElement get_Component_CIM_PhysicalElement(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_COMPONENT_CIM_PHYSICALELEMENT.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_COMPONENT_CIM_PHYSICALELEMENT.NAME
    ...
    public boolean set_Component_CIM_PhysicalElement(CIM_PhysicalElement newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_COMPONENT_CIM_PHYSICALELEMENT.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Component_CIM_PhysicalElement(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_Component_CIM_PhysicalElement(WBEMClient client,
            String namespace, CIM_PhysicalElement newValue) throws WbemsmtException {
        CIM_FRUPhysicalElements fco = new CIM_FRUPhysicalElements(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_COMPONENT_CIM_PHYSICALELEMENT.NAME);
        if (property != null) {
            property = setPropertyValue_Component_CIM_PhysicalElement(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_COMPONENT_CIM_PHYSICALELEMENT.NAME
    ...
    private static CIMProperty setPropertyValue_Component_CIM_PhysicalElement(
    ...
    public String getObjectName() {
        return CIM_FRUPhysicalElements.CIM_CLASS_NAME;
    }
