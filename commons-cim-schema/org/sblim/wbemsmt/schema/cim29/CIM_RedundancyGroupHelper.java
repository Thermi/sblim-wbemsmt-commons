/** 
 * CIM_RedundancyGroupHelper.java
 *
...
public final class CIM_RedundancyGroupHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RedundancyGroup.");
						resultArrayList.add(new CIM_RedundancyGroup(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RedundancyGroup.");
						resultArrayList.add(new CIM_RedundancyGroup(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RedundancyGroup.");
						resultArrayList.add(new CIM_RedundancyGroup(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_RedundancyGroup getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_RedundancyGroupHelper.getInstance(cimClient, new CIM_RedundancyGroup(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RedundancyGroup getInstance(CIMClient cimClient, CIM_RedundancyGroup dataInstance) {
		...
		return CIM_RedundancyGroupHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RedundancyGroup getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_RedundancyGroup dataInstance = null;
		try {
			dataInstance = new CIM_RedundancyGroup(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_RedundancyGroup.getPackages();
	...
	*/	
	public final static CIM_RedundancyGroup createInstance(CIMClient cimClient, CIM_RedundancyGroup dataInstance, boolean notifyDifferencies){ 
		...
		CIM_RedundancyGroup newDataInstance = null;
		try {
			newDataInstance = CIM_RedundancyGroupHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RedundancyGroup modifyInstance(CIMClient cimClient, CIM_RedundancyGroup dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_RedundancyGroupHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_RedundancyGroup dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_RedundancyGroup dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_RedundancyGroup.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_RedundancyGroup.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_RedundancyGroup.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_RedundancyGroup.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_RedundancyGroup.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
