 ...
 * 
 * Description: Helper class for CIM_RedundancyGroup
 *    
 * 
 * generated Class
 * @see CIM_RedundancyGroup
 */
...
public class CIM_RedundancyGroupHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RedundancyGroup or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RedundancyGroup.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RedundancyGroup.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RedundancyGroup or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_RedundancyGroup.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RedundancyGroup(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RedundancyGroupHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RedundancyGroup.");
                        resultArrayList.add(new CIM_RedundancyGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RedundancyGroup.");
                        resultArrayList.add(new CIM_RedundancyGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RedundancyGroup.");
                        resultArrayList.add(new CIM_RedundancyGroup(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RedundancyGroup getInstance(WBEMClient client,
     ...
     */
    public final static CIM_RedundancyGroup getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RedundancyGroup) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RedundancyGroup(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RedundancyGroup getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_RedundancyGroup.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RedundancyGroup.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_RedundancyGroup.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RedundancyGroup.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_RedundancyGroup createInstance(WBEMClient client,
            CIM_RedundancyGroup dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_RedundancyGroup newDataInstance = CIM_RedundancyGroupHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_RedundancyGroup modifyInstance(WBEMClient client,
            CIM_RedundancyGroup dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RedundancyGroup dataInstance2 = CIM_RedundancyGroupHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RedundancyGroup dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RedundancyGroup.getPackages());
    }
