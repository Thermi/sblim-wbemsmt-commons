 ...
 * 
 * Description: Helper class for CIM_UnixThread
 *    
 * 
 * generated Class
 * @see CIM_UnixThread
...
public class CIM_UnixThreadHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_UnixThread or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_UnixThread.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_UnixThread.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_UnixThread or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_UnixThread.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_UnixThread(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_UnixThreadHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_UnixThread.");
                        resultArrayList.add(new CIM_UnixThread(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_UnixThread.");
                        resultArrayList.add(new CIM_UnixThread(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_UnixThread.");
                        resultArrayList.add(new CIM_UnixThread(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_UnixThread getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_UnixThread getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_UnixThread) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_UnixThread(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_UnixThread getInstance(WBEMClient client, String namespace,
            String CSCreationClassName, String CSName, String CreationClassName, String Handle,
            String OSCreationClassName, String OSName, String ProcessCreationClassName,
        ...
        keyProperties[0] = new CIMProperty(CIM_UnixThread.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_UnixThread.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_UnixThread.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);

        setThis = Handle;

        keyProperties[3] = new CIMProperty(CIM_UnixThread.PROPERTY_HANDLE.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);

        setThis = OSCreationClassName;

        keyProperties[4] = new CIMProperty(CIM_UnixThread.PROPERTY_OSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);

        setThis = OSName;

        keyProperties[5] = new CIMProperty(CIM_UnixThread.PROPERTY_OSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);

        setThis = ProcessCreationClassName;

        keyProperties[6] = new CIMProperty(CIM_UnixThread.PROPERTY_PROCESSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);

        setThis = ProcessHandle;

        keyProperties[7] = new CIMProperty(CIM_UnixThread.PROPERTY_PROCESSHANDLE.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_UnixThread.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_UnixThread createInstance(WBEMClient client,
            CIM_UnixThread dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_UnixThread newDataInstance = CIM_UnixThreadHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_UnixThread modifyInstance(WBEMClient client,
            CIM_UnixThread dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_UnixThread dataInstance2 = CIM_UnixThreadHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_UnixThread dataInstance)
            throws WbemsmtException {
