 ...
 * 
 * Description: Helper class for CIM_DirectoryContainsFile
 *    
 * 
 * generated Class
 * @see CIM_DirectoryContainsFile
 */
...
public class CIM_DirectoryContainsFileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DirectoryContainsFile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DirectoryContainsFile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_DirectoryContainsFile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DirectoryContainsFile or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_DirectoryContainsFile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DirectoryContainsFileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DirectoryContainsFile.");
                        resultArrayList.add(new CIM_DirectoryContainsFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DirectoryContainsFile.");
                        resultArrayList.add(new CIM_DirectoryContainsFile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DirectoryContainsFile.");
                        resultArrayList.add(new CIM_DirectoryContainsFile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DirectoryContainsFile getInstance(WBEMClient client,
    ...
    public final static CIM_DirectoryContainsFile getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DirectoryContainsFile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DirectoryContainsFile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DirectoryContainsFile getInstance(WBEMClient client, String namespace,
            CIM_Directory GroupComponent, CIM_LogicalFile PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DirectoryContainsFile.PROPERTY_GROUPCOMPONENT_CIM_DIRECTORY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_DirectoryContainsFile.PROPERTY_PARTCOMPONENT_CIM_LOGICALFILE.NAME,
                new CIMDataType(CIM_LogicalFile.CIM_CLASS_NAME), setThis, false, false,
                CIM_DirectoryContainsFile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_DirectoryContainsFile createInstance(WBEMClient client,
            CIM_DirectoryContainsFile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_DirectoryContainsFile newDataInstance = CIM_DirectoryContainsFileHelper.getInstance(
     ...
     */
    public final static CIM_DirectoryContainsFile modifyInstance(WBEMClient client,
            CIM_DirectoryContainsFile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DirectoryContainsFile dataInstance2 = CIM_DirectoryContainsFileHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_DirectoryContainsFile dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DirectoryContainsFile.getPackages());
    }
