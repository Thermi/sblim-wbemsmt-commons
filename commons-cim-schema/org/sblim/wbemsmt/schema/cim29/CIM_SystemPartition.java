...
public class CIM_SystemPartition extends CIM_ComponentCS {
     ...
     * 
     */
    public static class PROPERTY_PARTCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM {
        /**
    ...
    public CIM_SystemPartition(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_SystemPartition(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_GroupComponent_CIM_ComputerSystem(WBEMClient client,
        ...
        CIM_SystemPartition fco = new CIM_SystemPartition(client, namespace);
    ...
    public CIM_UnitaryComputerSystem get_PartComponent_CIM_UnitaryComputerSystem(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_PartComponent_CIM_UnitaryComputerSystem(CIM_UnitaryComputerSystem newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_PARTCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_PartComponent_CIM_UnitaryComputerSystem(
    ...
    public static CIMProperty create_PartComponent_CIM_UnitaryComputerSystem(WBEMClient client,
            String namespace, CIM_UnitaryComputerSystem newValue) throws WbemsmtException {
        CIM_SystemPartition fco = new CIM_SystemPartition(client, namespace);
        CIMProperty property = fco
                .getProperty(PROPERTY_PARTCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME);
        if (property != null) {
            property = setPropertyValue_PartComponent_CIM_UnitaryComputerSystem(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_PARTCOMPONENT_CIM_UNITARYCOMPUTERSYSTEM.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_PartComponent_CIM_UnitaryComputerSystem(
    ...
    public String getObjectName() {
        return CIM_SystemPartition.CIM_CLASS_NAME;
    }
