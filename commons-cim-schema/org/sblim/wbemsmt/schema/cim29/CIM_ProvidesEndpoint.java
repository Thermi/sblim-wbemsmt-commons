...
public class CIM_ProvidesEndpoint extends CIM_ServiceAccessBySAP {
    ...
    public CIM_ProvidesEndpoint(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ProvidesEndpoint(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ProvidesEndpoint() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_Service(WBEMClient client, String namespace,
        ...
        CIM_ProvidesEndpoint fco = new CIM_ProvidesEndpoint(client, namespace);
    ...
    public String getObjectName() {
        return CIM_ProvidesEndpoint.CIM_CLASS_NAME;
    }
