...
public class CIM_CommMechanismForObjectManagerAdapter extends CIM_Dependency {
     ...
     * 
     */
    public static class PROPERTY_ANTECEDENT_CIM_OBJECTMANAGERADAPTER {
        /**
    ...
    public CIM_CommMechanismForObjectManagerAdapter(WBEMClient client, String namespace)
    ...
    public CIM_CommMechanismForObjectManagerAdapter(CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_CommMechanismForObjectManagerAdapter() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("Antecedent", new CIMProperty("Antecedent", new CIMDataType(
                CIM_ObjectManagerAdapter.CIM_CLASS_NAME), null));
    ...
    public CIM_ObjectManagerAdapter get_Antecedent_CIM_ObjectManagerAdapter(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_OBJECTMANAGERADAPTER.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_OBJECTMANAGERADAPTER.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return CIM_ObjectManagerAdapterHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_Antecedent_CIM_ObjectManagerAdapter(CIM_ObjectManagerAdapter newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_OBJECTMANAGERADAPTER.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Antecedent_CIM_ObjectManagerAdapter(currentProperty,
                    newValue);
    ...
    public static CIMProperty create_Antecedent_CIM_ObjectManagerAdapter(WBEMClient client,
            String namespace, CIM_ObjectManagerAdapter newValue) throws WbemsmtException {
        CIM_CommMechanismForObjectManagerAdapter fco = new CIM_CommMechanismForObjectManagerAdapter(
                client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_ANTECEDENT_CIM_OBJECTMANAGERADAPTER.NAME);
        if (property != null) {
            property = setPropertyValue_Antecedent_CIM_ObjectManagerAdapter(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_OBJECTMANAGERADAPTER.NAME
    ...
    private static CIMProperty setPropertyValue_Antecedent_CIM_ObjectManagerAdapter(
            CIMProperty currentProperty, CIM_ObjectManagerAdapter newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return CIM_CommMechanismForObjectManagerAdapter.CIM_CLASS_NAME;
    }
