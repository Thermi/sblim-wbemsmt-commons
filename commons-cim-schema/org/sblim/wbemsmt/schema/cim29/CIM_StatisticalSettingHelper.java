 ...
 * 
 * Description: Helper class for CIM_StatisticalSetting
 *    
 * 
 * generated Class
 * @see CIM_StatisticalSetting
 */
...
public class CIM_StatisticalSettingHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_StatisticalSetting or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_StatisticalSetting.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_StatisticalSetting.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_StatisticalSetting or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_StatisticalSetting.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_StatisticalSetting(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_StatisticalSettingHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_StatisticalSetting.");
                        resultArrayList.add(new CIM_StatisticalSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_StatisticalSetting.");
                        resultArrayList.add(new CIM_StatisticalSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_StatisticalSetting.");
                        resultArrayList.add(new CIM_StatisticalSetting(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_StatisticalSetting getInstance(WBEMClient client,
    ...
    public final static CIM_StatisticalSetting getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_StatisticalSetting) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_StatisticalSetting(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_StatisticalSetting getInstance(WBEMClient client, String namespace,
            String InstanceID
        ...
        keyProperties[0] = new CIMProperty(CIM_StatisticalSetting.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_StatisticalSetting.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_StatisticalSetting createInstance(WBEMClient client,
            CIM_StatisticalSetting dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_StatisticalSetting newDataInstance = CIM_StatisticalSettingHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_StatisticalSetting modifyInstance(WBEMClient client,
            CIM_StatisticalSetting dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_StatisticalSetting dataInstance2 = CIM_StatisticalSettingHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_StatisticalSetting dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_StatisticalSetting.getPackages());
    }
