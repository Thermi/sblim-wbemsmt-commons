...
public class CIM_LogicalPortHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalPort.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_LogicalPort.");
                        resultArrayList.add(new CIM_LogicalPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LogicalPort.");
                        resultArrayList.add(new CIM_LogicalPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LogicalPort.");
                        resultArrayList.add(new CIM_LogicalPort(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LogicalPort getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_LogicalPort getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_LogicalPort getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_LogicalPort.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LogicalPort.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[1] = new CIMProperty(CIM_LogicalPort.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LogicalPort.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(CIM_LogicalPort.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LogicalPort.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_LogicalPort.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LogicalPort.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_LogicalPort createInstance(WBEMClient client,
            CIM_LogicalPort dataInstance, boolean notifyDifferencies) throws WbemsmtException {
     ...
     */
    public final static CIM_LogicalPort modifyInstance(WBEMClient client,
            CIM_LogicalPort dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LogicalPort dataInstance2 = CIM_LogicalPortHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_LogicalPort dataInstance)
            throws WbemsmtException {
