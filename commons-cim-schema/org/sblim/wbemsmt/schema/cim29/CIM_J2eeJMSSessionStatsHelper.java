/** 
 * CIM_J2eeJMSSessionStatsHelper.java
 *
...
public final class CIM_J2eeJMSSessionStatsHelper {

	public final static String CIM_CLASS_NAME = "CIM_J2eeJMSSessionStats";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_J2eeJMSSessionStats.Java_Package_List.size(); i++) {
						if (!((String)(CIM_J2eeJMSSessionStats.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_J2eeJMSSessionStats.Java_Package_List.get(i))).endsWith(".")) {
							CIM_J2eeJMSSessionStats.Java_Package_List.setElementAt((String)(CIM_J2eeJMSSessionStats.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_J2eeJMSSessionStats.");
						resultArrayList.add(new CIM_J2eeJMSSessionStats(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_J2eeJMSSessionStats.");
						resultArrayList.add(new CIM_J2eeJMSSessionStats(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_J2eeJMSSessionStats.");
						resultArrayList.add(new CIM_J2eeJMSSessionStats(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_J2eeJMSSessionStats getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_J2eeJMSSessionStatsHelper.getInstance(cimClient, new CIM_J2eeJMSSessionStats(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_J2eeJMSSessionStats getInstance(CIMClient cimClient, CIM_J2eeJMSSessionStats dataInstance) {
		...
		return CIM_J2eeJMSSessionStatsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_J2eeJMSSessionStats getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_J2eeJMSSessionStats dataInstance = null;
		try {
			dataInstance = new CIM_J2eeJMSSessionStats(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_J2eeJMSSessionStats createInstance(CIMClient cimClient, CIM_J2eeJMSSessionStats dataInstance, boolean notifyDifferencies){ 
		...
		CIM_J2eeJMSSessionStats newDataInstance = null;
		try {
			newDataInstance = CIM_J2eeJMSSessionStatsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_J2eeJMSSessionStats modifyInstance(CIMClient cimClient, CIM_J2eeJMSSessionStats dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_J2eeJMSSessionStatsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_J2eeJMSSessionStats dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_J2eeJMSSessionStats dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_J2eeJMSSessionStats.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_J2eeJMSSessionStats.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_J2eeJMSSessionStats.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_J2eeJMSSessionStats.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_J2eeJMSSessionStats.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DurableSubscriptionCount(UnsignedInt64 DurableSubscriptionCount) {
		return true;
	}

	public static boolean isValid_ExpiredMessageCount(UnsignedInt64 ExpiredMessageCount) {
		return true;
	}

	public static boolean isValid_MessageCount(UnsignedInt64 MessageCount) {
		return true;
	}

	public static boolean isValid_MessageWaitTime(Calendar MessageWaitTime) {
		return true;
	}

	public static boolean isValid_MessageWaitTimeMaxTime(Calendar MessageWaitTimeMaxTime) {
		return true;
	}

	public static boolean isValid_MessageWaitTimeMinTime(Calendar MessageWaitTimeMinTime) {
		return true;
	}

	public static boolean isValid_MessageWaitTimeTotalTime(Calendar MessageWaitTimeTotalTime) {
		return true;
	}

	public static boolean isValid_PendingMessageCount(UnsignedInt64 PendingMessageCount) {
		return true;
	}
