 ...
 * 
 * Description: Helper class for CIM_Thread
 *    
 * 
 * generated Class
 * @see CIM_Thread
...
public class CIM_ThreadHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Thread or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Thread.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Thread.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Thread or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Thread.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Thread(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ThreadHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Thread.");
                        resultArrayList.add(new CIM_Thread(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Thread.");
                        resultArrayList.add(new CIM_Thread(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Thread.");
                        resultArrayList.add(new CIM_Thread(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Thread getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Thread getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {

        CIM_Thread dataInstance = null;
        Class clazz = CIM_ThreadHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Thread) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Thread(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Thread getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_Thread.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Thread.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_Thread.PROPERTY_CSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Thread.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_Thread.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Thread.CIM_CLASS_NAME);

        setThis = Handle;

        keyProperties[3] = new CIMProperty(CIM_Thread.PROPERTY_HANDLE.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Thread.CIM_CLASS_NAME);

        setThis = OSCreationClassName;

        keyProperties[4] = new CIMProperty(CIM_Thread.PROPERTY_OSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Thread.CIM_CLASS_NAME);

        setThis = OSName;

        keyProperties[5] = new CIMProperty(CIM_Thread.PROPERTY_OSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Thread.CIM_CLASS_NAME);

        setThis = ProcessCreationClassName;

        keyProperties[6] = new CIMProperty(CIM_Thread.PROPERTY_PROCESSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Thread.CIM_CLASS_NAME);

        setThis = ProcessHandle;

        keyProperties[7] = new CIMProperty(CIM_Thread.PROPERTY_PROCESSHANDLE.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Thread.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Thread createInstance(WBEMClient client, CIM_Thread dataInstance,
        ...
        CIM_Thread newDataInstance = CIM_ThreadHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Thread modifyInstance(WBEMClient client, CIM_Thread dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Thread dataInstance2 = CIM_ThreadHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Thread dataInstance)
            throws WbemsmtException {
