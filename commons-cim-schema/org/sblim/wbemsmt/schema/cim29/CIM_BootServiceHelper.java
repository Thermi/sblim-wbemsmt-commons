 ...
 * 
 * Description: Helper class for CIM_BootService
 *    
 * 
 * generated Class
 * @see CIM_BootService
...
public class CIM_BootServiceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BootService or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BootService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_BootService.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BootService or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BootService.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BootService(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BootServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BootService.");
                        resultArrayList.add(new CIM_BootService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BootService.");
                        resultArrayList.add(new CIM_BootService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BootService.");
                        resultArrayList.add(new CIM_BootService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BootService getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_BootService getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {

        CIM_BootService dataInstance = null;
        Class clazz = CIM_BootServiceHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BootService) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BootService(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BootService getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_BootService.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BootService.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_BootService.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BootService.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(CIM_BootService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BootService.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_BootService.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BootService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BootService createInstance(WBEMClient client,
            CIM_BootService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_BootService newDataInstance = CIM_BootServiceHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_BootService modifyInstance(WBEMClient client,
            CIM_BootService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BootService dataInstance2 = CIM_BootServiceHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BootService dataInstance)
            throws WbemsmtException {
