 ...
 * 
 * Description: Helper class for CIM_AlertInstIndication
 *    
 * 
 * generated Class
 * @see CIM_AlertInstIndication
 */
...
public class CIM_AlertInstIndicationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_AlertInstIndication or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AlertInstIndication.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_AlertInstIndication.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_AlertInstIndication or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_AlertInstIndication.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_AlertInstIndication(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_AlertInstIndicationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AlertInstIndication.");
                        resultArrayList.add(new CIM_AlertInstIndication(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AlertInstIndication.");
                        resultArrayList.add(new CIM_AlertInstIndication(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AlertInstIndication.");
                        resultArrayList.add(new CIM_AlertInstIndication(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AlertInstIndication getInstance(WBEMClient client,
    ...
    public final static CIM_AlertInstIndication getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_AlertInstIndication) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_AlertInstIndication(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_AlertInstIndication createInstance(WBEMClient client,
            CIM_AlertInstIndication dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_AlertInstIndication newDataInstance = CIM_AlertInstIndicationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_AlertInstIndication modifyInstance(WBEMClient client,
            CIM_AlertInstIndication dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AlertInstIndication dataInstance2 = CIM_AlertInstIndicationHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_AlertInstIndication dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_AlertInstIndication.getPackages());
    }
