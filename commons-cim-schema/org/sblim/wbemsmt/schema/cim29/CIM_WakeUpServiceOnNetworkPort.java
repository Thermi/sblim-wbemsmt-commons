...
public class CIM_WakeUpServiceOnNetworkPort extends CIM_DeviceServiceImplementation {
    ...
    public CIM_WakeUpServiceOnNetworkPort(WBEMClient client, String namespace)
    ...
    public CIM_WakeUpServiceOnNetworkPort(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_WakeUpServiceOnNetworkPort() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_NetworkPort(WBEMClient client,
        ...
        CIM_WakeUpServiceOnNetworkPort fco = new CIM_WakeUpServiceOnNetworkPort(client, namespace);
    ...
    public String getObjectName() {
        return CIM_WakeUpServiceOnNetworkPort.CIM_CLASS_NAME;
    }
