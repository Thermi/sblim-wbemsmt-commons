...
public class CIM_Namespace extends CIM_ManagedElement {
    ...
    public static class PROPERTY_CLASSINFO {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_CIM_1_0 = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry CIM 1.0 (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_CIM_1_0 = "CIM 1.0";

        /**
         * constant for value map entry 3
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_CIM_2_0 = new javax.cim.UnsignedInteger16(
                "3");

        /**
         * constant for value entry CIM 2.0 (corresponds to mapEntry 3 )
         */
        public final static String VALUE_ENTRY_CIM_2_0 = "CIM 2.0";

        /**
         * constant for value map entry 4
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_CIM_2_1 = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry CIM 2.1 (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_CIM_2_1 = "CIM 2.1";

        /**
         * constant for value map entry 5
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_CIM_2_2 = new javax.cim.UnsignedInteger16(
                "5");

        /**
         * constant for value entry CIM 2.2 (corresponds to mapEntry 5 )
         */
        public final static String VALUE_ENTRY_CIM_2_2 = "CIM 2.2";

        /**
         * constant for value map entry 6
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_CIM_2_3 = new javax.cim.UnsignedInteger16(
                "6");

        /**
         * constant for value entry CIM 2.3 (corresponds to mapEntry 6 )
         */
        public final static String VALUE_ENTRY_CIM_2_3 = "CIM 2.3";

        /**
         * constant for value map entry 7
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_7_FOR_VALUE_ENTRY_CIM_2_4 = new javax.cim.UnsignedInteger16(
                "7");

        /**
         * constant for value entry CIM 2.4 (corresponds to mapEntry 7 )
         */
        public final static String VALUE_ENTRY_CIM_2_4 = "CIM 2.4";

        /**
         * constant for value map entry 8
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_8_FOR_VALUE_ENTRY_CIM_2_5 = new javax.cim.UnsignedInteger16(
                "8");

        /**
         * constant for value entry CIM 2.5 (corresponds to mapEntry 8 )
         */
        public final static String VALUE_ENTRY_CIM_2_5 = "CIM 2.5";

        /**
         * constant for value map entry 9
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_9_FOR_VALUE_ENTRY_CIM_2_6 = new javax.cim.UnsignedInteger16(
                "9");

        /**
         * constant for value entry CIM 2.6 (corresponds to mapEntry 9 )
         */
        public final static String VALUE_ENTRY_CIM_2_6 = "CIM 2.6";

        /**
         * constant for value map entry 10
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_10_FOR_VALUE_ENTRY_CIM_2_7 = new javax.cim.UnsignedInteger16(
                "10");

        /**
         * constant for value entry CIM 2.7 (corresponds to mapEntry 10 )
         */
        public final static String VALUE_ENTRY_CIM_2_7 = "CIM 2.7";

        /**
         * constant for value map entry 11
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_11_FOR_VALUE_ENTRY_CIM_2_8 = new javax.cim.UnsignedInteger16(
                "11");

        /**
         * constant for value entry CIM 2.8 (corresponds to mapEntry 11 )
         */
        public final static String VALUE_ENTRY_CIM_2_8 = "CIM 2.8";

        /**
         * constant for value map entry 200
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_200_FOR_VALUE_ENTRY_DMI_Recast = new javax.cim.UnsignedInteger16(
                "200");

        /**
         * constant for value entry DMI Recast (corresponds to mapEntry 200 )
         */
        public final static String VALUE_ENTRY_DMI_Recast = "DMI Recast";

        /**
         * constant for value map entry 201
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_201_FOR_VALUE_ENTRY_SNMP_Recast = new javax.cim.UnsignedInteger16(
                "201");

        /**
         * constant for value entry SNMP Recast (corresponds to mapEntry 201 )
         */
        public final static String VALUE_ENTRY_SNMP_Recast = "SNMP Recast";

        /**
         * constant for value map entry 202
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_202_FOR_VALUE_ENTRY_CMIP_Recast = new javax.cim.UnsignedInteger16(
                "202");

        /**
         * constant for value entry CMIP Recast (corresponds to mapEntry 202 )
         */
        public final static String VALUE_ENTRY_CMIP_Recast = "CMIP Recast";
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@4f444f44
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown, VALUE_ENTRY_Other,
                VALUE_ENTRY_CIM_1_0, VALUE_ENTRY_CIM_2_0, VALUE_ENTRY_CIM_2_1, VALUE_ENTRY_CIM_2_2,
                VALUE_ENTRY_CIM_2_3, VALUE_ENTRY_CIM_2_4, VALUE_ENTRY_CIM_2_5, VALUE_ENTRY_CIM_2_6,
                VALUE_ENTRY_CIM_2_7, VALUE_ENTRY_CIM_2_8, VALUE_ENTRY_DMI_Recast,
                VALUE_ENTRY_SNMP_Recast, VALUE_ENTRY_CMIP_Recast };
        ...
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_Other, VALUE_ENTRY_CIM_1_0, VALUE_ENTRY_CIM_2_0, VALUE_ENTRY_CIM_2_1,
                VALUE_ENTRY_CIM_2_2, VALUE_ENTRY_CIM_2_3, VALUE_ENTRY_CIM_2_4, VALUE_ENTRY_CIM_2_5,
                VALUE_ENTRY_CIM_2_6, VALUE_ENTRY_CIM_2_7, VALUE_ENTRY_CIM_2_8,
                VALUE_ENTRY_DMI_Recast, VALUE_ENTRY_SNMP_Recast, VALUE_ENTRY_CMIP_Recast };
    ...
    public static class PROPERTY_CLASSTYPE {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_CIM = new javax.cim.UnsignedInteger16(
                "2");

        /**
         * constant for value entry CIM (corresponds to mapEntry 2 )
         */
        public final static String VALUE_ENTRY_CIM = "CIM";
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@70b470b4
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
         ...
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown, VALUE_ENTRY_Other,
                VALUE_ENTRY_CIM, VALUE_ENTRY_DMI_Recast, VALUE_ENTRY_SNMP_Recast,
         ...
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_Other, VALUE_ENTRY_CIM, VALUE_ENTRY_DMI_Recast,
                VALUE_ENTRY_SNMP_Recast, VALUE_ENTRY_CMIP_Recast };
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck
                .put("ClassInfo", new CIMProperty("ClassInfo", CIMDataType.UINT16_T, null));
        propertiesToCheck
                .put("ClassType", new CIMProperty("ClassType", CIMDataType.UINT16_T, null));
        propertiesToCheck.put("ClassTypeVersion", new CIMProperty("ClassTypeVersion",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("CreationClassName", new CIMProperty("CreationClassName",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("DescriptionOfClassInfo", new CIMProperty("DescriptionOfClassInfo",
                CIMDataType.STRING_T, null));
        propertiesToCheck.put("DescriptionOfClassType", new CIMProperty("DescriptionOfClassType",
                CIMDataType.STRING_T, null));
    ...
    public javax.cim.UnsignedInteger16 get_ClassInfo() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CLASSINFO.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_ClassInfo(javax.cim.UnsignedInteger16 newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ClassInfo(currentProperty, newValue);
    ...
    public static CIMProperty create_ClassInfo(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_ClassInfo(CIMProperty currentProperty,
    ...
    public javax.cim.UnsignedInteger16 get_ClassType() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CLASSTYPE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_ClassType(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_CLASSTYPE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ClassType(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_ClassType(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        CIM_Namespace fco = new CIM_Namespace(client, namespace);
    ...
    private static CIMProperty setPropertyValue_ClassType(CIMProperty currentProperty,
            javax.cim.UnsignedInteger16 newValue) {
        Object setThis = null;
    ...
    public String get_ClassTypeVersion() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_CLASSTYPEVERSION.NAME
    ...
    public boolean set_ClassTypeVersion(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_CLASSTYPEVERSION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ClassTypeVersion(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_ClassTypeVersion(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_ClassTypeVersion(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_DescriptionOfClassInfo() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DESCRIPTIONOFCLASSINFO.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_DescriptionOfClassInfo(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DESCRIPTIONOFCLASSINFO.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_DescriptionOfClassInfo(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_DescriptionOfClassInfo(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_Namespace fco = new CIM_Namespace(client, namespace);
    ...
    private static CIMProperty setPropertyValue_DescriptionOfClassInfo(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public String get_DescriptionOfClassType() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DESCRIPTIONOFCLASSTYPE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_DescriptionOfClassType(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DESCRIPTIONOFCLASSTYPE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_DescriptionOfClassType(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_DescriptionOfClassType(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_Namespace fco = new CIM_Namespace(client, namespace);
    ...
    private static CIMProperty setPropertyValue_DescriptionOfClassType(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    public java.util.List getAssociated_CIM_ObjectManager_CIM_NamespaceInManagers(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ObjectManager_CIM_NamespaceInManagers(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, CIM_ObjectManager.CIM_CLASS_NAME,
    ...
    public java.util.List getAssociated_CIM_ObjectManager_CIM_NamespaceInManagers(
        ...
        return getAssociated_CIM_ObjectManager_CIM_NamespaceInManagers(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_ObjectManager_CIM_NamespaceInManagerNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ObjectManager_CIM_NamespaceInManagerNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, CIM_ObjectManager.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_ObjectManager_CIM_NamespaceInManagerNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER,
    ...
    public java.util.List getAssociations_CIM_NamespaceInManager(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
    ...
    public java.util.List getAssociationNames_CIM_NamespaceInManager(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_NAMESPACEINMANAGER, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_NamespaceInManager.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_SystemIdentification objects associated by the association CIM_SystemInNamespace
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_SystemIdentification_CIM_SystemInNamespaces(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_SystemIdentification_CIM_SystemInNamespaces(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMINNAMESPACE,
                CIM_SystemIdentification.CIM_CLASS_NAME, null, null, false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_SystemIdentification(cimInstance));
                        continue;
                    }
    ...
    public java.util.List getAssociated_CIM_SystemIdentification_CIM_SystemInNamespaceNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_SystemIdentification_CIM_SystemInNamespaceNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMINNAMESPACE,
                CIM_SystemIdentification.CIM_CLASS_NAME, null, null);
    }
