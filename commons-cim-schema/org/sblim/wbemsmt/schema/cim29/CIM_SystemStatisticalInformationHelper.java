 ...
 * 
 * Description: Helper class for CIM_SystemStatisticalInformation
 *    
 * 
 * generated Class
 * @see CIM_SystemStatisticalInformation
 */
...
public class CIM_SystemStatisticalInformationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemStatisticalInformation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemStatisticalInformation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemStatisticalInformation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemStatisticalInformation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SystemStatisticalInformation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemStatisticalInformationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemStatisticalInformation.");
                        resultArrayList.add(new CIM_SystemStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemStatisticalInformation.");
                        resultArrayList.add(new CIM_SystemStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemStatisticalInformation.");
                        resultArrayList.add(new CIM_SystemStatisticalInformation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemStatisticalInformation getInstance(WBEMClient client,
    ...
    public final static CIM_SystemStatisticalInformation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_SystemStatisticalInformationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemStatisticalInformation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemStatisticalInformation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_SystemStatisticalInformation getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemStatisticalInformation.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SystemStatisticalInformation.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_SystemStatisticalInformation.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SystemStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[2] = new CIMProperty(
                CIM_SystemStatisticalInformation.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SystemStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[3] = new CIMProperty(
                CIM_SystemStatisticalInformation.PROPERTY_SYSTEMNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_SystemStatisticalInformation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemStatisticalInformation createInstance(WBEMClient client,
            CIM_SystemStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SystemStatisticalInformation newDataInstance = CIM_SystemStatisticalInformationHelper
     ...
     */
    public final static CIM_SystemStatisticalInformation modifyInstance(WBEMClient client,
            CIM_SystemStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemStatisticalInformation dataInstance2 = CIM_SystemStatisticalInformationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SystemStatisticalInformation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemStatisticalInformation.getPackages());
    }
