...
public class CIM_MediaAccessDeviceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MediaAccessDevice.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_MediaAccessDevice.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_MediaAccessDevice.");
                        resultArrayList.add(new CIM_MediaAccessDevice(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MediaAccessDevice.");
                        resultArrayList.add(new CIM_MediaAccessDevice(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MediaAccessDevice.");
                        resultArrayList.add(new CIM_MediaAccessDevice(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MediaAccessDevice getInstance(WBEMClient client,
     ...
     */
    public final static CIM_MediaAccessDevice getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_MediaAccessDevice getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_MediaAccessDevice.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessDevice.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[1] = new CIMProperty(CIM_MediaAccessDevice.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessDevice.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_MediaAccessDevice.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_MediaAccessDevice.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_MediaAccessDevice.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_MediaAccessDevice.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MediaAccessDevice createInstance(WBEMClient client,
            CIM_MediaAccessDevice dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MediaAccessDevice newDataInstance = CIM_MediaAccessDeviceHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_MediaAccessDevice modifyInstance(WBEMClient client,
            CIM_MediaAccessDevice dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MediaAccessDevice dataInstance2 = CIM_MediaAccessDeviceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MediaAccessDevice dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MediaAccessDevice.getPackages());
    }
