 ...
 * 
 * Description: Helper class for CIM_TokenRingPortStatistics
 *    
 * 
 * generated Class
 * @see CIM_TokenRingPortStatistics
 */
...
public class CIM_TokenRingPortStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_TokenRingPortStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_TokenRingPortStatistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_TokenRingPortStatistics.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_TokenRingPortStatistics or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_TokenRingPortStatistics.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_TokenRingPortStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_TokenRingPortStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_TokenRingPortStatistics.");
                        resultArrayList.add(new CIM_TokenRingPortStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_TokenRingPortStatistics.");
                        resultArrayList.add(new CIM_TokenRingPortStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_TokenRingPortStatistics.");
                        resultArrayList.add(new CIM_TokenRingPortStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_TokenRingPortStatistics getInstance(WBEMClient client,
    ...
    public final static CIM_TokenRingPortStatistics getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_TokenRingPortStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_TokenRingPortStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_TokenRingPortStatistics getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(CIM_TokenRingPortStatistics.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_TokenRingPortStatistics createInstance(WBEMClient client,
            CIM_TokenRingPortStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_TokenRingPortStatistics newDataInstance = CIM_TokenRingPortStatisticsHelper
     ...
     */
    public final static CIM_TokenRingPortStatistics modifyInstance(WBEMClient client,
            CIM_TokenRingPortStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_TokenRingPortStatistics dataInstance2 = CIM_TokenRingPortStatisticsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_TokenRingPortStatistics dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_TokenRingPortStatistics.getPackages());
    }
