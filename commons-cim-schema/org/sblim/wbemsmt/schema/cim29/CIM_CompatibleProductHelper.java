 ...
 * 
 * Description: Helper class for CIM_CompatibleProduct
 *    
 * 
 * generated Class
 * @see CIM_CompatibleProduct
 */
...
public class CIM_CompatibleProductHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CompatibleProduct or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CompatibleProduct.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CompatibleProduct.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CompatibleProduct or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_CompatibleProduct.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CompatibleProduct(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CompatibleProductHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CompatibleProduct.");
                        resultArrayList.add(new CIM_CompatibleProduct(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CompatibleProduct.");
                        resultArrayList.add(new CIM_CompatibleProduct(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CompatibleProduct.");
                        resultArrayList.add(new CIM_CompatibleProduct(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CompatibleProduct getInstance(WBEMClient client,
     ...
     */
    public final static CIM_CompatibleProduct getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CompatibleProduct) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CompatibleProduct(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CompatibleProduct getInstance(WBEMClient client, String namespace,
            CIM_Product Product, CIM_Product CompatibleProduct
        ...
        setThis = Product != null ? Product.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(CIM_CompatibleProduct.PROPERTY_PRODUCT_CIM_PRODUCT.NAME,
                new CIMDataType(CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_CompatibleProduct.CIM_CLASS_NAME);

        setThis = CompatibleProduct != null ? CompatibleProduct.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_CompatibleProduct.PROPERTY_COMPATIBLEPRODUCT_CIM_PRODUCT.NAME, new CIMDataType(
                        CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_CompatibleProduct.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CompatibleProduct createInstance(WBEMClient client,
            CIM_CompatibleProduct dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_CompatibleProduct newDataInstance = CIM_CompatibleProductHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_CompatibleProduct modifyInstance(WBEMClient client,
            CIM_CompatibleProduct dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CompatibleProduct dataInstance2 = CIM_CompatibleProductHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_CompatibleProduct dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CompatibleProduct.getPackages());
    }
