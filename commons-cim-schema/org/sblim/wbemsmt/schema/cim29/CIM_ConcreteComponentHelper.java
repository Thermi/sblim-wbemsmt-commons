...
public class CIM_ConcreteComponentHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ConcreteComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ConcreteComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ConcreteComponent.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ConcreteComponent.");
                        resultArrayList.add(new CIM_ConcreteComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ConcreteComponent.");
                        resultArrayList.add(new CIM_ConcreteComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ConcreteComponent.");
                        resultArrayList.add(new CIM_ConcreteComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ConcreteComponent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ConcreteComponent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ConcreteComponent getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement GroupComponent, CIM_ManagedElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ConcreteComponent.PROPERTY_GROUPCOMPONENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ConcreteComponent.PROPERTY_PARTCOMPONENT_CIM_MANAGEDELEMENT.NAME,
                new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_ConcreteComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ConcreteComponent createInstance(WBEMClient client,
            CIM_ConcreteComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ConcreteComponent newDataInstance = CIM_ConcreteComponentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ConcreteComponent modifyInstance(WBEMClient client,
            CIM_ConcreteComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ConcreteComponent dataInstance2 = CIM_ConcreteComponentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ConcreteComponent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ConcreteComponent.getPackages());
    }
