 ...
 * 
 * Description: VideoBIOSFeature represents the capabilities of the low-level software that is used to bring up, configure and use a ComputerSystem's VideoController and Display.
 * 
 * generated Class
 */
...
public class CIM_VideoBIOSFeature extends CIM_SoftwareFeature {
    ...
    public final static String CIM_CLASS_NAME = "CIM_VideoBIOSFeature";
    ...
    public static class PROPERTY_CHARACTERISTICS {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Standard_Video_BIOS = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry Standard Video BIOS (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_Standard_Video_BIOS = "Standard Video BIOS";

        /**
         * constant for value map entry 5
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_VESA_BIOS_Extensions_Supported = new javax.cim.UnsignedInteger16(
                "5");

        /**
         * constant for value entry VESA BIOS Extensions Supported (corresponds to mapEntry 5 )
         */
        public final static String VALUE_ENTRY_VESA_BIOS_Extensions_Supported = "VESA BIOS Extensions Supported";

        /**
         * constant for value map entry 6
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_VESA_Power_Management_Supported = new javax.cim.UnsignedInteger16(
                "6");

        /**
         * constant for value entry VESA Power Management Supported (corresponds to mapEntry 6 )
         */
        public final static String VALUE_ENTRY_VESA_Power_Management_Supported = "VESA Power Management Supported";

        /**
         * constant for value map entry 7
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_7_FOR_VALUE_ENTRY_VESA_Display_Data_Channel_Supported = new javax.cim.UnsignedInteger16(
                "7");

        /**
         * constant for value entry VESA Display Data Channel Supported (corresponds to mapEntry 7 )
         */
        public final static String VALUE_ENTRY_VESA_Display_Data_Channel_Supported = "VESA Display Data Channel Supported";

        /**
         * constant for value map entry 8
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_8_FOR_VALUE_ENTRY_Video_BIOS_Shadowing_Allowed = new javax.cim.UnsignedInteger16(
                "8");

        /**
         * constant for value entry Video BIOS Shadowing Allowed (corresponds to mapEntry 8 )
         */
        public final static String VALUE_ENTRY_Video_BIOS_Shadowing_Allowed = "Video BIOS Shadowing Allowed";

        /**
         * constant for value map entry 9
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_9_FOR_VALUE_ENTRY_Video_BIOS_Upgradeable = new javax.cim.UnsignedInteger16(
                "9");

        /**
         * constant for value entry Video BIOS Upgradeable (corresponds to mapEntry 9 )
         */
        public final static String VALUE_ENTRY_Video_BIOS_Upgradeable = "Video BIOS Upgradeable";
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@1d001d00
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
            ...
            if (VALUE_ENTRY_Standard_Video_BIOS.equals(value)) {
                return VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Standard_Video_BIOS;
            }

            if (VALUE_ENTRY_VESA_BIOS_Extensions_Supported.equals(value)) {
                return VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_VESA_BIOS_Extensions_Supported;
            }

            if (VALUE_ENTRY_VESA_Power_Management_Supported.equals(value)) {
                return VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_VESA_Power_Management_Supported;
            }

            if (VALUE_ENTRY_VESA_Display_Data_Channel_Supported.equals(value)) {
                return VALUE_MAP_ENTRY_7_FOR_VALUE_ENTRY_VESA_Display_Data_Channel_Supported;
            }

            if (VALUE_ENTRY_Video_BIOS_Shadowing_Allowed.equals(value)) {
                return VALUE_MAP_ENTRY_8_FOR_VALUE_ENTRY_Video_BIOS_Shadowing_Allowed;
            }

            if (VALUE_ENTRY_Video_BIOS_Upgradeable.equals(value)) {
                return VALUE_MAP_ENTRY_9_FOR_VALUE_ENTRY_Video_BIOS_Upgradeable;
            }
            return null;
        ...
        public static String getValueEntry(javax.cim.UnsignedInteger16 value) {
            ...
            if (iValue == VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Standard_Video_BIOS.intValue()) {
                return VALUE_ENTRY_Standard_Video_BIOS;
            }

            if (iValue == VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_VESA_BIOS_Extensions_Supported
                    .intValue()) {
                return VALUE_ENTRY_VESA_BIOS_Extensions_Supported;
            }

            if (iValue == VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_VESA_Power_Management_Supported
                    .intValue()) {
                return VALUE_ENTRY_VESA_Power_Management_Supported;
            }

            if (iValue == VALUE_MAP_ENTRY_7_FOR_VALUE_ENTRY_VESA_Display_Data_Channel_Supported
                    .intValue()) {
                return VALUE_ENTRY_VESA_Display_Data_Channel_Supported;
            }

            if (iValue == VALUE_MAP_ENTRY_8_FOR_VALUE_ENTRY_Video_BIOS_Shadowing_Allowed.intValue()) {
                return VALUE_ENTRY_Video_BIOS_Shadowing_Allowed;
            }

            if (iValue == VALUE_MAP_ENTRY_9_FOR_VALUE_ENTRY_Video_BIOS_Upgradeable.intValue()) {
                return VALUE_ENTRY_Video_BIOS_Upgradeable;
            }
            return null;
        ...
        public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = {
                ...
                VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_Standard_Video_BIOS,
                VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_VESA_BIOS_Extensions_Supported,
                VALUE_MAP_ENTRY_6_FOR_VALUE_ENTRY_VESA_Power_Management_Supported,
                VALUE_MAP_ENTRY_7_FOR_VALUE_ENTRY_VESA_Display_Data_Channel_Supported,
                VALUE_MAP_ENTRY_8_FOR_VALUE_ENTRY_Video_BIOS_Shadowing_Allowed,
                VALUE_MAP_ENTRY_9_FOR_VALUE_ENTRY_Video_BIOS_Upgradeable };
        ...
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Other, VALUE_ENTRY_Unknown,
                VALUE_ENTRY_Undefined, VALUE_ENTRY_Standard_Video_BIOS,
                VALUE_ENTRY_VESA_BIOS_Extensions_Supported,
                VALUE_ENTRY_VESA_Power_Management_Supported,
                VALUE_ENTRY_VESA_Display_Data_Channel_Supported,
                VALUE_ENTRY_Video_BIOS_Shadowing_Allowed, VALUE_ENTRY_Video_BIOS_Upgradeable };
        ...
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Other,
                VALUE_ENTRY_Unknown, VALUE_ENTRY_Undefined, VALUE_ENTRY_Standard_Video_BIOS,
                VALUE_ENTRY_VESA_BIOS_Extensions_Supported,
                VALUE_ENTRY_VESA_Power_Management_Supported,
                VALUE_ENTRY_VESA_Display_Data_Channel_Supported,
                VALUE_ENTRY_Video_BIOS_Shadowing_Allowed, VALUE_ENTRY_Video_BIOS_Upgradeable };
    ...
    public CIM_VideoBIOSFeature(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_VideoBIOSFeature(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_VideoBIOSFeature() {
    }
    ...
    public static CIMProperty create_CharacteristicDescriptions(WBEMClient client,
        ...
        CIM_VideoBIOSFeature fco = new CIM_VideoBIOSFeature(client, namespace);
    ...
    /**
     * Get the list with CIM_VideoBIOSElement objects associated by the association CIM_VideoBIOSFeatureVideoBIOSElements
     * 
    ...
    public java.util.List getAssociated_CIM_VideoBIOSElement_CIM_VideoBIOSFeatureVideoBIOSElementss(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_VideoBIOSElement_CIM_VideoBIOSFeatureVideoBIOSElementss(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_VIDEOBIOSFEATUREVIDEOBIOSELEMENTS,
                CIM_VideoBIOSElement.CIM_CLASS_NAME, null, null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_VideoBIOSElement_CIM_VideoBIOSFeatureVideoBIOSElementss(
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_VideoBIOSFeatureHelper.checkException(enumeration);
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_VideoBIOSFeatureHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_VideoBIOSElement(cimInstance));
                        continue;
                    }
    ...
    public java.util.List getAssociated_CIM_VideoBIOSElement_CIM_VideoBIOSFeatureVideoBIOSElementsNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_VideoBIOSElement_CIM_VideoBIOSFeatureVideoBIOSElementsNames(
                cimClient, true, CIM_ASSOCIATOR_CLASS_NAME_CIM_VIDEOBIOSFEATUREVIDEOBIOSELEMENTS,
                CIM_VideoBIOSElement.CIM_CLASS_NAME, null, null);
    }
    ...
    public String getObjectName() {
        return CIM_VideoBIOSFeature.CIM_CLASS_NAME;
    }
