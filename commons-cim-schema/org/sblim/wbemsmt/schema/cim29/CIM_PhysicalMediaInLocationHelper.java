 ...
 * 
 * Description: Helper class for CIM_PhysicalMediaInLocation
 *    
 * 
 * generated Class
 * @see CIM_PhysicalMediaInLocation
 */
...
public class CIM_PhysicalMediaInLocationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PhysicalMediaInLocation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PhysicalMediaInLocation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PhysicalMediaInLocation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PhysicalMediaInLocation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PhysicalMediaInLocation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PhysicalMediaInLocationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PhysicalMediaInLocation.");
                        resultArrayList.add(new CIM_PhysicalMediaInLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PhysicalMediaInLocation.");
                        resultArrayList.add(new CIM_PhysicalMediaInLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PhysicalMediaInLocation.");
                        resultArrayList.add(new CIM_PhysicalMediaInLocation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PhysicalMediaInLocation getInstance(WBEMClient client,
    ...
    public final static CIM_PhysicalMediaInLocation getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PhysicalMediaInLocation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PhysicalMediaInLocation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PhysicalMediaInLocation getInstance(WBEMClient client,
            String namespace, CIM_StorageMediaLocation Antecedent, CIM_PhysicalMedia Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PhysicalMediaInLocation.PROPERTY_ANTECEDENT_CIM_STORAGEMEDIALOCATION.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_PhysicalMediaInLocation.PROPERTY_DEPENDENT_CIM_PHYSICALMEDIA.NAME,
     ...
     *
     */
    public final static CIM_PhysicalMediaInLocation createInstance(WBEMClient client,
            CIM_PhysicalMediaInLocation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PhysicalMediaInLocation newDataInstance = CIM_PhysicalMediaInLocationHelper
     ...
     */
    public final static CIM_PhysicalMediaInLocation modifyInstance(WBEMClient client,
            CIM_PhysicalMediaInLocation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PhysicalMediaInLocation dataInstance2 = CIM_PhysicalMediaInLocationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_PhysicalMediaInLocation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PhysicalMediaInLocation.getPackages());
    }
