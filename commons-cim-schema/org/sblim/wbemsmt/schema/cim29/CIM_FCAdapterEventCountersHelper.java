/** 
 * CIM_FCAdapterEventCountersHelper.java
 *
...
public final class CIM_FCAdapterEventCountersHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_FCAdapterEventCounters.Java_Package_List.size(); i++) {
						if (!((String)(CIM_FCAdapterEventCounters.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_FCAdapterEventCounters.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_FCAdapterEventCounters.Java_Package_List.setElementAt((String)(CIM_FCAdapterEventCounters.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_FCAdapterEventCounters.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_FCAdapterEventCounters.");
						resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_FCAdapterEventCounters.");
						resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_FCAdapterEventCounters.");
						resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_FCAdapterEventCounters getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_FCAdapterEventCountersHelper.getInstance(cimClient, new CIM_FCAdapterEventCounters(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_FCAdapterEventCounters getInstance(CIMClient cimClient, CIM_FCAdapterEventCounters dataInstance) {
		...
		return CIM_FCAdapterEventCountersHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_FCAdapterEventCounters getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_FCAdapterEventCounters dataInstance = null;
		try {
			dataInstance = new CIM_FCAdapterEventCounters(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_FCAdapterEventCounters createInstance(CIMClient cimClient, CIM_FCAdapterEventCounters dataInstance, boolean notifyDifferencies){ 
		...
		CIM_FCAdapterEventCounters newDataInstance = null;
		try {
			newDataInstance = CIM_FCAdapterEventCountersHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_FCAdapterEventCounters modifyInstance(CIMClient cimClient, CIM_FCAdapterEventCounters dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_FCAdapterEventCountersHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_FCAdapterEventCounters dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_FCAdapterEventCounters dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_FCAdapterEventCounters.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_FCAdapterEventCounters.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_FCAdapterEventCounters.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_FCAdapterEventCounters.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_FCAdapterEventCounters.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ABTSFramesReceived(UnsignedInt64 ABTSFramesReceived) {
		return true;
	}

	public static boolean isValid_ABTSFramesRejected(UnsignedInt64 ABTSFramesRejected) {
		return true;
	}

	public static boolean isValid_ABTSFramesSent(UnsignedInt64 ABTSFramesSent) {
		return true;
	}

	public static boolean isValid_FBSYsReceived(UnsignedInt64 FBSYsReceived) {
		return true;
	}

	public static boolean isValid_FRJTsReceived(UnsignedInt64 FRJTsReceived) {
		return true;
	}

	public static boolean isValid_PBSYsReceived(UnsignedInt64 PBSYsReceived) {
		return true;
	}

	public static boolean isValid_PBSYsSent(UnsignedInt64 PBSYsSent) {
		return true;
	}

	public static boolean isValid_PRJTsReceived(UnsignedInt64 PRJTsReceived) {
		return true;
	}

	public static boolean isValid_PRJTsSent(UnsignedInt64 PRJTsSent) {
		return true;
	}

	public static boolean isValid_PRLIsRejected(UnsignedInt64 PRLIsRejected) {
		return true;
	}

	public static boolean isValid_PRLOsRejected(UnsignedInt64 PRLOsRejected) {
		return true;
	}
