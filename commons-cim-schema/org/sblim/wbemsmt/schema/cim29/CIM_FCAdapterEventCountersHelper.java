 ...
 * 
 * Description: Helper class for CIM_FCAdapterEventCounters
 *    
 * 
 * generated Class
 * @see CIM_FCAdapterEventCounters
 */
...
public class CIM_FCAdapterEventCountersHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FCAdapterEventCounters or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FCAdapterEventCounters.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_FCAdapterEventCounters.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FCAdapterEventCounters or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_FCAdapterEventCounters.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FCAdapterEventCountersHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FCAdapterEventCounters.");
                        resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FCAdapterEventCounters.");
                        resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FCAdapterEventCounters.");
                        resultArrayList.add(new CIM_FCAdapterEventCounters(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FCAdapterEventCounters getInstance(WBEMClient client,
    ...
    public final static CIM_FCAdapterEventCounters getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FCAdapterEventCounters) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FCAdapterEventCounters(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FCAdapterEventCounters getInstance(WBEMClient client, String namespace,
            String CreationClassName, String DeviceCreationClassName, String DeviceID, String Name,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_FCAdapterEventCounters.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_FCAdapterEventCounters.CIM_CLASS_NAME);

        setThis = DeviceCreationClassName;

        keyProperties[1] = new CIMProperty(
                CIM_FCAdapterEventCounters.PROPERTY_DEVICECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FCAdapterEventCounters.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[2] = new CIMProperty(CIM_FCAdapterEventCounters.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FCAdapterEventCounters.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_FCAdapterEventCounters.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FCAdapterEventCounters.CIM_CLASS_NAME);
        ...
        keyProperties[4] = new CIMProperty(
                CIM_FCAdapterEventCounters.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FCAdapterEventCounters.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[5] = new CIMProperty(CIM_FCAdapterEventCounters.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_FCAdapterEventCounters.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FCAdapterEventCounters createInstance(WBEMClient client,
            CIM_FCAdapterEventCounters dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_FCAdapterEventCounters newDataInstance = CIM_FCAdapterEventCountersHelper.getInstance(
     ...
     */
    public final static CIM_FCAdapterEventCounters modifyInstance(WBEMClient client,
            CIM_FCAdapterEventCounters dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FCAdapterEventCounters dataInstance2 = CIM_FCAdapterEventCountersHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_FCAdapterEventCounters dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_FCAdapterEventCounters.getPackages());
    }
