...
public final class CIM_StorageVolumeHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StorageVolume.");
						resultArrayList.add(new CIM_StorageVolume(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StorageVolume.");
						resultArrayList.add(new CIM_StorageVolume(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StorageVolume.");
						resultArrayList.add(new CIM_StorageVolume(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StorageVolume getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StorageVolumeHelper.getInstance(cimClient, new CIM_StorageVolume(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageVolume getInstance(CIMClient cimClient, CIM_StorageVolume dataInstance) {
		...
		return CIM_StorageVolumeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageVolume getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StorageVolume dataInstance = null;
		try {
			dataInstance = new CIM_StorageVolume(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_StorageVolume.getPackages();
	...
	*/	
	public final static CIM_StorageVolume createInstance(CIMClient cimClient, CIM_StorageVolume dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StorageVolume newDataInstance = null;
		try {
			newDataInstance = CIM_StorageVolumeHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StorageVolume modifyInstance(CIMClient cimClient, CIM_StorageVolume dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StorageVolumeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StorageVolume dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StorageVolume dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StorageVolume.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StorageVolume.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StorageVolume.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StorageVolume.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StorageVolume.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_NameNamespace(UnsignedInt16 NameNamespace) {
		return true;
	}
	...
	public static boolean isValid_OtherNameNamespace(String OtherNameNamespace) {
		return true;
	}
