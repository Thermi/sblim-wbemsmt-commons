...
public class CIM_SoftwareElementServiceImplementation extends CIM_Dependency {
    ...
    public CIM_SoftwareElementServiceImplementation(WBEMClient client, String namespace)
    ...
    public CIM_SoftwareElementServiceImplementation(CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SoftwareElementServiceImplementation() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_SoftwareElement(WBEMClient client,
        ...
        CIM_SoftwareElementServiceImplementation fco = new CIM_SoftwareElementServiceImplementation(
                client, namespace);
    ...
    public String getObjectName() {
        return CIM_SoftwareElementServiceImplementation.CIM_CLASS_NAME;
    }
