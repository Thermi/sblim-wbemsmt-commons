 ...
 * 
 * Description: Helper class for CIM_SystemBusCard
 *    
 * 
 * generated Class
 * @see CIM_SystemBusCard
 */
...
public class CIM_SystemBusCardHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemBusCard or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemBusCard.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_SystemBusCard.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemBusCard or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_SystemBusCard.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemBusCard(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemBusCardHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemBusCard.");
                        resultArrayList.add(new CIM_SystemBusCard(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemBusCard.");
                        resultArrayList.add(new CIM_SystemBusCard(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemBusCard.");
                        resultArrayList.add(new CIM_SystemBusCard(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemBusCard getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_SystemBusCard getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemBusCard) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemBusCard(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemBusCard getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_SystemBusCard.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemBusCard.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[1] = new CIMProperty(CIM_SystemBusCard.PROPERTY_TAG.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemBusCard.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemBusCard createInstance(WBEMClient client,
            CIM_SystemBusCard dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemBusCard newDataInstance = CIM_SystemBusCardHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SystemBusCard modifyInstance(WBEMClient client,
            CIM_SystemBusCard dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemBusCard dataInstance2 = CIM_SystemBusCardHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemBusCard dataInstance)
            throws WbemsmtException {
