 ...
 * 
 * Description: Helper class for CIM_CollectedMSEs
 *    
 * 
 * generated Class
 * @see CIM_CollectedMSEs
 */
...
public class CIM_CollectedMSEsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CollectedMSEs or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CollectedMSEs.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_CollectedMSEs.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CollectedMSEs or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_CollectedMSEs.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CollectedMSEs(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CollectedMSEsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CollectedMSEs.");
                        resultArrayList.add(new CIM_CollectedMSEs(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CollectedMSEs.");
                        resultArrayList.add(new CIM_CollectedMSEs(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CollectedMSEs.");
                        resultArrayList.add(new CIM_CollectedMSEs(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CollectedMSEs getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_CollectedMSEs getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CollectedMSEs) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CollectedMSEs(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CollectedMSEs getInstance(WBEMClient client, String namespace,
            CIM_CollectionOfMSEs Collection, CIM_ManagedSystemElement Member
        ...
        setThis = Collection != null ? Collection.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_CollectedMSEs.PROPERTY_COLLECTION_CIM_COLLECTIONOFMSES.NAME, new CIMDataType(
                        CIM_CollectionOfMSEs.CIM_CLASS_NAME), setThis, false, false,
                CIM_CollectedMSEs.CIM_CLASS_NAME);

        setThis = Member != null ? Member.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_CollectedMSEs.PROPERTY_MEMBER_CIM_MANAGEDSYSTEMELEMENT.NAME, new CIMDataType(
                        CIM_ManagedSystemElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_CollectedMSEs.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CollectedMSEs createInstance(WBEMClient client,
            CIM_CollectedMSEs dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_CollectedMSEs newDataInstance = CIM_CollectedMSEsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_CollectedMSEs modifyInstance(WBEMClient client,
            CIM_CollectedMSEs dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CollectedMSEs dataInstance2 = CIM_CollectedMSEsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_CollectedMSEs dataInstance)
            throws WbemsmtException {
