 ...
 * 
 * Description: Helper class for CIM_ParticipatingCS
 *    
 * 
 * generated Class
 * @see CIM_ParticipatingCS
 */
...
public class CIM_ParticipatingCSHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ParticipatingCS or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ParticipatingCS.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ParticipatingCS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ParticipatingCS or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_ParticipatingCS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ParticipatingCS(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ParticipatingCSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ParticipatingCS.");
                        resultArrayList.add(new CIM_ParticipatingCS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ParticipatingCS.");
                        resultArrayList.add(new CIM_ParticipatingCS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ParticipatingCS.");
                        resultArrayList.add(new CIM_ParticipatingCS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ParticipatingCS getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ParticipatingCS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ParticipatingCS) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ParticipatingCS(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ParticipatingCS getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem Antecedent, CIM_Cluster Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ParticipatingCS.PROPERTY_ANTECEDENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(CIM_ParticipatingCS.PROPERTY_DEPENDENT_CIM_CLUSTER.NAME,
                new CIMDataType(CIM_Cluster.CIM_CLASS_NAME), setThis, false, false,
                CIM_ParticipatingCS.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ParticipatingCS createInstance(WBEMClient client,
            CIM_ParticipatingCS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ParticipatingCS newDataInstance = CIM_ParticipatingCSHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ParticipatingCS modifyInstance(WBEMClient client,
            CIM_ParticipatingCS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ParticipatingCS dataInstance2 = CIM_ParticipatingCSHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ParticipatingCS dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ParticipatingCS.getPackages());
    }
