...
public class CIM_Profile extends CIM_Collection {
    ...
    /**
     * Get the list with CIM_ManagedElement objects associated by the association CIM_ElementProfile
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementProfiles(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_ElementProfiles(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE, CIM_ManagedElement.CIM_CLASS_NAME,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE or a subclass 
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementProfiles(
            WBEMClient cimClient, String resultClass, String role, String resultRole)
            throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_ElementProfiles(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE, resultClass, role, resultRole, false,
                false, null);
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementProfiles(
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_ProfileHelper.checkException(enumeration);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_ElementProfile
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementProfileNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_ElementProfileNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE, CIM_ManagedElement.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementProfileNames(
        ...
        return getAssociated_CIM_ManagedElement_CIM_ElementProfileNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE, resultClass, role, resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_ElementProfileNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE,
    ...
    /**
     * Get the list with CIM_ElementProfile associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_ElementProfile(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_ElementProfile(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_ElementProfile
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_ElementProfile(WBEMClient cimClient, String role,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTPROFILE, role));
        }
