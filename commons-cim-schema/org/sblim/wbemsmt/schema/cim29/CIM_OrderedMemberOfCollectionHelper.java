 ...
 * 
 * Description: Helper class for CIM_OrderedMemberOfCollection
 *    
 * 
 * generated Class
 * @see CIM_OrderedMemberOfCollection
 */
...
public class CIM_OrderedMemberOfCollectionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_OrderedMemberOfCollection or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_OrderedMemberOfCollection.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_OrderedMemberOfCollection.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_OrderedMemberOfCollection or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_OrderedMemberOfCollection.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_OrderedMemberOfCollection(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_OrderedMemberOfCollectionHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_OrderedMemberOfCollection.");
                        resultArrayList.add(new CIM_OrderedMemberOfCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_OrderedMemberOfCollection.");
                        resultArrayList.add(new CIM_OrderedMemberOfCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_OrderedMemberOfCollection.");
                        resultArrayList.add(new CIM_OrderedMemberOfCollection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_OrderedMemberOfCollection getInstance(WBEMClient client,
    ...
    public final static CIM_OrderedMemberOfCollection getInstance(WBEMClient client,
        ...
        Class clazz = CIM_OrderedMemberOfCollectionHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_OrderedMemberOfCollection) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_OrderedMemberOfCollection(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     *
     */
    public final static CIM_OrderedMemberOfCollection createInstance(WBEMClient client,
            CIM_OrderedMemberOfCollection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_OrderedMemberOfCollection newDataInstance = CIM_OrderedMemberOfCollectionHelper
     ...
     */
    public final static CIM_OrderedMemberOfCollection modifyInstance(WBEMClient client,
            CIM_OrderedMemberOfCollection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_OrderedMemberOfCollection dataInstance2 = CIM_OrderedMemberOfCollectionHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_OrderedMemberOfCollection dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_OrderedMemberOfCollection.getPackages());
    }
