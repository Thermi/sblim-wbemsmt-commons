...
public class CIM_ProductSoftwareFeatures extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
    ...
    public CIM_ProductSoftwareFeatures(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ProductSoftwareFeatures(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ProductSoftwareFeatures() {
    }
    ...
    public static CIMProperty create_Product_CIM_Product(WBEMClient client, String namespace,
        ...
        CIM_ProductSoftwareFeatures fco = new CIM_ProductSoftwareFeatures(client, namespace);
    ...
    public String getObjectName() {
        return CIM_ProductSoftwareFeatures.CIM_CLASS_NAME;
    }
