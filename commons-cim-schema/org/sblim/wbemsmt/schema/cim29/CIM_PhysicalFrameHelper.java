 ...
 * 
 * Description: Helper class for CIM_PhysicalFrame
 *    
 * 
 * generated Class
 * @see CIM_PhysicalFrame
 */
...
public class CIM_PhysicalFrameHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PhysicalFrame or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PhysicalFrame.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_PhysicalFrame.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PhysicalFrame or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_PhysicalFrame.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_PhysicalFrame(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PhysicalFrameHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PhysicalFrame.");
                        resultArrayList.add(new CIM_PhysicalFrame(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PhysicalFrame.");
                        resultArrayList.add(new CIM_PhysicalFrame(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PhysicalFrame.");
                        resultArrayList.add(new CIM_PhysicalFrame(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PhysicalFrame getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_PhysicalFrame getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PhysicalFrame) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PhysicalFrame(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PhysicalFrame getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_PhysicalFrame.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_PhysicalFrame.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[1] = new CIMProperty(CIM_PhysicalFrame.PROPERTY_TAG.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_PhysicalFrame.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PhysicalFrame createInstance(WBEMClient client,
            CIM_PhysicalFrame dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_PhysicalFrame newDataInstance = CIM_PhysicalFrameHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_PhysicalFrame modifyInstance(WBEMClient client,
            CIM_PhysicalFrame dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PhysicalFrame dataInstance2 = CIM_PhysicalFrameHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PhysicalFrame dataInstance)
            throws WbemsmtException {
