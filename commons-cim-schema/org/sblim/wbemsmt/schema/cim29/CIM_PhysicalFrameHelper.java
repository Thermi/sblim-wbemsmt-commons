...
public final class CIM_PhysicalFrameHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_PhysicalFrame(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_PhysicalFrame.Java_Package_List.size(); i++) {
						if (!((String)(CIM_PhysicalFrame.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_PhysicalFrame.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_PhysicalFrame.Java_Package_List.setElementAt((String)(CIM_PhysicalFrame.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_PhysicalFrame.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PhysicalFrame.");
						resultArrayList.add(new CIM_PhysicalFrame(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PhysicalFrame.");
						resultArrayList.add(new CIM_PhysicalFrame(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PhysicalFrame.");
						resultArrayList.add(new CIM_PhysicalFrame(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PhysicalFrame getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PhysicalFrameHelper.getInstance(cimClient, new CIM_PhysicalFrame(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalFrame getInstance(CIMClient cimClient, CIM_PhysicalFrame dataInstance) {
		...
		return CIM_PhysicalFrameHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalFrame getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PhysicalFrame dataInstance = null;
		try {
			dataInstance = new CIM_PhysicalFrame(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalFrame createInstance(CIMClient cimClient, CIM_PhysicalFrame dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PhysicalFrame newDataInstance = null;
		try {
			newDataInstance = CIM_PhysicalFrameHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalFrame modifyInstance(CIMClient cimClient, CIM_PhysicalFrame dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PhysicalFrameHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PhysicalFrame dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PhysicalFrame dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PhysicalFrame.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PhysicalFrame.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PhysicalFrame.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PhysicalFrame.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PhysicalFrame.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AudibleAlarm(Boolean AudibleAlarm) {
		return true;
	}

	public static boolean isValid_BreachDescription(String BreachDescription) {
		return true;
	}

	public static boolean isValid_CableManagementStrategy(String CableManagementStrategy) {
		return true;
	}

	public static boolean isValid_IsLocked(Boolean IsLocked) {
		return true;
	}

	public static boolean isValid_LockPresent(Boolean LockPresent) {
		return true;
	}

	public static boolean isValid_SecurityBreach(UnsignedInt16 SecurityBreach) {
		return true;
	}

	public static boolean isValid_ServiceDescriptions(String[] ServiceDescriptions) {
		return true;
	}

	public static boolean isValid_ServicePhilosophy(UnsignedInt16[] ServicePhilosophy) {
		return true;
	}

	public static boolean isValid_VisibleAlarm(Boolean VisibleAlarm) {
		return true;
	}
