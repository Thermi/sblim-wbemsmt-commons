 ...
 * 
 * Description: Helper class for CIM_ProductSoftwareFeatures
 *    
 * 
 * generated Class
 * @see CIM_ProductSoftwareFeatures
 */
...
public class CIM_ProductSoftwareFeaturesHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductSoftwareFeatures or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductSoftwareFeatures.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductSoftwareFeatures.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductSoftwareFeatures or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProductSoftwareFeatures(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductSoftwareFeaturesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductSoftwareFeatures.");
                        resultArrayList.add(new CIM_ProductSoftwareFeatures(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductSoftwareFeatures.");
                        resultArrayList.add(new CIM_ProductSoftwareFeatures(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductSoftwareFeatures.");
                        resultArrayList.add(new CIM_ProductSoftwareFeatures(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductSoftwareFeatures getInstance(WBEMClient client,
    ...
    public final static CIM_ProductSoftwareFeatures getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductSoftwareFeatures) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductSoftwareFeatures(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductSoftwareFeatures getInstance(WBEMClient client,
            String namespace, CIM_Product Product, CIM_SoftwareFeature Component
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProductSoftwareFeatures.PROPERTY_PRODUCT_CIM_PRODUCT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProductSoftwareFeatures.PROPERTY_COMPONENT_CIM_SOFTWAREFEATURE.NAME,
     ...
     *
     */
    public final static CIM_ProductSoftwareFeatures createInstance(WBEMClient client,
            CIM_ProductSoftwareFeatures dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProductSoftwareFeatures newDataInstance = CIM_ProductSoftwareFeaturesHelper
     ...
     */
    public final static CIM_ProductSoftwareFeatures modifyInstance(WBEMClient client,
            CIM_ProductSoftwareFeatures dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductSoftwareFeatures dataInstance2 = CIM_ProductSoftwareFeaturesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProductSoftwareFeatures dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductSoftwareFeatures.getPackages());
    }
