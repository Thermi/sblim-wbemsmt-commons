 ...
 * 
 * Description: Helper class for CIM_ProductPhysicalElements
 *    
 * 
 * generated Class
 * @see CIM_ProductPhysicalElements
 */
...
public class CIM_ProductPhysicalElementsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductPhysicalElements or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductPhysicalElements.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductPhysicalElements.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductPhysicalElements or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProductPhysicalElements(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductPhysicalElementsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductPhysicalElements.");
                        resultArrayList.add(new CIM_ProductPhysicalElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductPhysicalElements.");
                        resultArrayList.add(new CIM_ProductPhysicalElements(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductPhysicalElements.");
                        resultArrayList.add(new CIM_ProductPhysicalElements(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductPhysicalElements getInstance(WBEMClient client,
    ...
    public final static CIM_ProductPhysicalElements getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductPhysicalElements) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductPhysicalElements(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductPhysicalElements getInstance(WBEMClient client,
            String namespace, CIM_Product Product, CIM_PhysicalElement Component
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProductPhysicalElements.PROPERTY_PRODUCT_CIM_PRODUCT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProductPhysicalElements.PROPERTY_COMPONENT_CIM_PHYSICALELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ProductPhysicalElements createInstance(WBEMClient client,
            CIM_ProductPhysicalElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProductPhysicalElements newDataInstance = CIM_ProductPhysicalElementsHelper
     ...
     */
    public final static CIM_ProductPhysicalElements modifyInstance(WBEMClient client,
            CIM_ProductPhysicalElements dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductPhysicalElements dataInstance2 = CIM_ProductPhysicalElementsHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProductPhysicalElements dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductPhysicalElements.getPackages());
    }
