/** 
 * CIM_OOBAlertServiceHelper.java
 *
...
public final class CIM_OOBAlertServiceHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_OOBAlertService.Java_Package_List.size(); i++) {
						if (!((String)(CIM_OOBAlertService.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_OOBAlertService.Java_Package_List.get(i))).endsWith(".")) {
							CIM_OOBAlertService.Java_Package_List.setElementAt((String)(CIM_OOBAlertService.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_OOBAlertService.");
						resultArrayList.add(new CIM_OOBAlertService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_OOBAlertService.");
						resultArrayList.add(new CIM_OOBAlertService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OOBAlertService.");
						resultArrayList.add(new CIM_OOBAlertService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_OOBAlertService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_OOBAlertServiceHelper.getInstance(cimClient, new CIM_OOBAlertService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OOBAlertService getInstance(CIMClient cimClient, CIM_OOBAlertService dataInstance) {
		...
		return CIM_OOBAlertServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OOBAlertService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_OOBAlertService dataInstance = null;
		try {
			dataInstance = new CIM_OOBAlertService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OOBAlertService createInstance(CIMClient cimClient, CIM_OOBAlertService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_OOBAlertService newDataInstance = null;
		try {
			newDataInstance = CIM_OOBAlertServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OOBAlertService modifyInstance(CIMClient cimClient, CIM_OOBAlertService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_OOBAlertServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_OOBAlertService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_OOBAlertService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_OOBAlertService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_OOBAlertService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_OOBAlertService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_OOBAlertService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_OOBAlertService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DestinationIsAckCapable(Boolean DestinationIsAckCapable) {
		return true;
	}

	public static boolean isValid_DestinationType(UnsignedInt16 DestinationType) {
		return true;
	}

	public static boolean isValid_EnablePresenceHeartbeats(Boolean EnablePresenceHeartbeats) {
		return true;
	}

	public static boolean isValid_FixedPartOfMessage(String FixedPartOfMessage) {
		return true;
	}

	public static boolean isValid_MessageFormat(UnsignedInt16 MessageFormat) {
		return true;
	}

	public static boolean isValid_OnlySendsFixedMessage(Boolean OnlySendsFixedMessage) {
		return true;
	}

	public static boolean isValid_OtherDestinationTypeDescription(String OtherDestinationTypeDescription) {
		return true;
	}

	public static boolean isValid_OtherMessageFormatDescription(String OtherMessageFormatDescription) {
		return true;
	}

	public static boolean isValid_PresenceHeartbeatCapable(Boolean PresenceHeartbeatCapable) {
		return true;
	}

	public static boolean isValid_RetryCount(UnsignedInt16 RetryCount) {
		return true;
	}

	public static boolean isValid_RetryInterval(UnsignedInt16 RetryInterval) {
		return true;
	}
