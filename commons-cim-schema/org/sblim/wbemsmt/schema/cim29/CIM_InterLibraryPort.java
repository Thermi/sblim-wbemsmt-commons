 ...
 *
 *
 * Description: InterLibraryPorts represent hardware that transports Physical Media between connected StorageLibraries. The LibraryExchange association identifies the connected Libraries, by identifying the connected InterLibraryPorts.
 * 
 */
...
public class CIM_InterLibraryPort extends CIM_MediaTransferDevice  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_LIBRARYEXCHANGE = "CIM_LibraryExchange";
