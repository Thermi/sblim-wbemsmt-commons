/** 
 * CIM_IPsecTunnelActionHelper.java
 *
...
public final class CIM_IPsecTunnelActionHelper {

	public final static String CIM_CLASS_NAME = "CIM_IPsecTunnelAction";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_IPsecTunnelAction.Java_Package_List.size(); i++) {
						if (!((String)(CIM_IPsecTunnelAction.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_IPsecTunnelAction.Java_Package_List.get(i))).endsWith(".")) {
							CIM_IPsecTunnelAction.Java_Package_List.setElementAt((String)(CIM_IPsecTunnelAction.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_IPsecTunnelAction.");
						resultArrayList.add(new CIM_IPsecTunnelAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_IPsecTunnelAction.");
						resultArrayList.add(new CIM_IPsecTunnelAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IPsecTunnelAction.");
						resultArrayList.add(new CIM_IPsecTunnelAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_IPsecTunnelAction getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_IPsecTunnelActionHelper.getInstance(cimClient, new CIM_IPsecTunnelAction(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IPsecTunnelAction getInstance(CIMClient cimClient, CIM_IPsecTunnelAction dataInstance) {
		...
		return CIM_IPsecTunnelActionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IPsecTunnelAction getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_IPsecTunnelAction dataInstance = null;
		try {
			dataInstance = new CIM_IPsecTunnelAction(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IPsecTunnelAction createInstance(CIMClient cimClient, CIM_IPsecTunnelAction dataInstance, boolean notifyDifferencies){ 
		...
		CIM_IPsecTunnelAction newDataInstance = null;
		try {
			newDataInstance = CIM_IPsecTunnelActionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IPsecTunnelAction modifyInstance(CIMClient cimClient, CIM_IPsecTunnelAction dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_IPsecTunnelActionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_IPsecTunnelAction dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_IPsecTunnelAction dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_IPsecTunnelAction.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_IPsecTunnelAction.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_IPsecTunnelAction.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_IPsecTunnelAction.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_IPsecTunnelAction.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
