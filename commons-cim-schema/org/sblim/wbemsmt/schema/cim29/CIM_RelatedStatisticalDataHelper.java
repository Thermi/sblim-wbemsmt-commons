 ...
 * 
 * Description: Helper class for CIM_RelatedStatisticalData
 *    
 * 
 * generated Class
 * @see CIM_RelatedStatisticalData
 */
...
public class CIM_RelatedStatisticalDataHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RelatedStatisticalData or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RelatedStatisticalData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RelatedStatisticalData.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RelatedStatisticalData or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_RelatedStatisticalData(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RelatedStatisticalDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RelatedStatisticalData.");
                        resultArrayList.add(new CIM_RelatedStatisticalData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RelatedStatisticalData.");
                        resultArrayList.add(new CIM_RelatedStatisticalData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RelatedStatisticalData.");
                        resultArrayList.add(new CIM_RelatedStatisticalData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RelatedStatisticalData getInstance(WBEMClient client,
    ...
    public final static CIM_RelatedStatisticalData getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RelatedStatisticalData) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RelatedStatisticalData(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RelatedStatisticalData getInstance(WBEMClient client, String namespace,
            CIM_StatisticalData Stats, CIM_StatisticalData RelatedStats
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RelatedStatisticalData.PROPERTY_STATS_CIM_STATISTICALDATA.NAME,
                new CIMDataType(CIM_StatisticalData.CIM_CLASS_NAME), setThis, false, false,
                CIM_RelatedStatisticalData.CIM_CLASS_NAME);

        setThis = RelatedStats != null ? RelatedStats.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_RelatedStatisticalData.PROPERTY_RELATEDSTATS_CIM_STATISTICALDATA.NAME,
                new CIMDataType(CIM_StatisticalData.CIM_CLASS_NAME), setThis, false, false,
                CIM_RelatedStatisticalData.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_RelatedStatisticalData createInstance(WBEMClient client,
            CIM_RelatedStatisticalData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_RelatedStatisticalData newDataInstance = CIM_RelatedStatisticalDataHelper.getInstance(
     ...
     */
    public final static CIM_RelatedStatisticalData modifyInstance(WBEMClient client,
            CIM_RelatedStatisticalData dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RelatedStatisticalData dataInstance2 = CIM_RelatedStatisticalDataHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_RelatedStatisticalData dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RelatedStatisticalData.getPackages());
    }
