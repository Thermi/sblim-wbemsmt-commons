...
public class CIM_InstMethodCallHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_InstMethodCall.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_InstMethodCall.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_InstMethodCall.");
                        resultArrayList.add(new CIM_InstMethodCall(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_InstMethodCall.");
                        resultArrayList.add(new CIM_InstMethodCall(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_InstMethodCall.");
                        resultArrayList.add(new CIM_InstMethodCall(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_InstMethodCall getInstance(WBEMClient client,
     ...
     */
    public final static CIM_InstMethodCall getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static CIM_InstMethodCall createInstance(WBEMClient client,
            CIM_InstMethodCall dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_InstMethodCall newDataInstance = CIM_InstMethodCallHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_InstMethodCall modifyInstance(WBEMClient client,
            CIM_InstMethodCall dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_InstMethodCall dataInstance2 = CIM_InstMethodCallHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_InstMethodCall dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_InstMethodCall.getPackages());
    }
