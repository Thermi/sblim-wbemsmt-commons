...
public class CIM_Collection extends CIM_ManagedElement {
    ...
    protected CIM_Collection(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    protected CIM_Collection(CIMInstance cimInstance) throws WbemsmtException {
    ...
    /**
     * Get the list with CIM_ManagedElement objects associated by the association CIM_MemberOfCollection
     * 
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_MemberOfCollections(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_MemberOfCollections(cimClient,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_MemberOfCollections(
        ...
        return getAssociated_CIM_ManagedElement_CIM_MemberOfCollections(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_MEMBEROFCOLLECTION, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_MemberOfCollections(
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_CollectionHelper.checkException(enumeration);
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_CollectionHelper.findClass(cimClient, cimInstance);
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_MemberOfCollectionNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ManagedElement_CIM_MemberOfCollectionNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_MEMBEROFCOLLECTION,
    ...
    public java.util.List getAssociated_CIM_ManagedElement_CIM_MemberOfCollectionNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_MEMBEROFCOLLECTION,
                    CIM_ManagedElement.CIM_CLASS_NAME, null, null));
        }
    ...
    public java.util.List getAssociations_CIM_MemberOfCollection(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_MEMBEROFCOLLECTION, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
    ...
    public java.util.List getAssociationNames_CIM_MemberOfCollection(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_MEMBEROFCOLLECTION, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_MEMBEROFCOLLECTION, role));
        }
    ...
    public String getObjectName() {
        return CIM_Collection.CIM_CLASS_NAME;
    }
