 ...
 *
 *
 * Description: Collection is an abstract class that provides a common superclass for data elements that represent collections of ManagedElements and its subclasses.
 * 
 */
...
public class CIM_Collection extends CIM_ManagedElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_Collection";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i = 0; clazz == null && i < CIM_Collection.Java_Package_List.size(); i++) {
						if (!((String)(CIM_Collection.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_Collection.Java_Package_List.get(i))).endsWith(".")) {
							CIM_Collection.Java_Package_List.setElementAt((String)(CIM_Collection.Java_Package_List.get(i)) + ("."), i);
						}
