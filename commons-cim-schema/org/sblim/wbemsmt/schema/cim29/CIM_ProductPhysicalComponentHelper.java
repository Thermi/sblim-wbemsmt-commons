 ...
 * 
 * Description: Helper class for CIM_ProductPhysicalComponent
 *    
 * 
 * generated Class
 * @see CIM_ProductPhysicalComponent
 */
...
public class CIM_ProductPhysicalComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductPhysicalComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductPhysicalComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProductPhysicalComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductPhysicalComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProductPhysicalComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductPhysicalComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductPhysicalComponent.");
                        resultArrayList.add(new CIM_ProductPhysicalComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductPhysicalComponent.");
                        resultArrayList.add(new CIM_ProductPhysicalComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductPhysicalComponent.");
                        resultArrayList.add(new CIM_ProductPhysicalComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductPhysicalComponent getInstance(WBEMClient client,
    ...
    public final static CIM_ProductPhysicalComponent getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductPhysicalComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductPhysicalComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductPhysicalComponent getInstance(WBEMClient client,
            String namespace, CIM_Product GroupComponent, CIM_PhysicalElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProductPhysicalComponent.PROPERTY_GROUPCOMPONENT_CIM_PRODUCT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProductPhysicalComponent.PROPERTY_PARTCOMPONENT_CIM_PHYSICALELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ProductPhysicalComponent createInstance(WBEMClient client,
            CIM_ProductPhysicalComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProductPhysicalComponent newDataInstance = CIM_ProductPhysicalComponentHelper
     ...
     */
    public final static CIM_ProductPhysicalComponent modifyInstance(WBEMClient client,
            CIM_ProductPhysicalComponent dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductPhysicalComponent dataInstance2 = CIM_ProductPhysicalComponentHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProductPhysicalComponent dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductPhysicalComponent.getPackages());
    }
