 ...
 * 
 * Description: Helper class for CIM_JobDestinationJobs
 *    
 * 
 * generated Class
 * @see CIM_JobDestinationJobs
 */
...
public class CIM_JobDestinationJobsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_JobDestinationJobs or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_JobDestinationJobs.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_JobDestinationJobs.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_JobDestinationJobs or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_JobDestinationJobs(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_JobDestinationJobsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_JobDestinationJobs.");
                        resultArrayList.add(new CIM_JobDestinationJobs(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_JobDestinationJobs.");
                        resultArrayList.add(new CIM_JobDestinationJobs(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_JobDestinationJobs.");
                        resultArrayList.add(new CIM_JobDestinationJobs(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_JobDestinationJobs getInstance(WBEMClient client,
    ...
    public final static CIM_JobDestinationJobs getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_JobDestinationJobs) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_JobDestinationJobs(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_JobDestinationJobs getInstance(WBEMClient client, String namespace,
            CIM_JobDestination Antecedent, CIM_Job Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_JobDestinationJobs.PROPERTY_ANTECEDENT_CIM_JOBDESTINATION.NAME,
        ...
        keyProperties[1] = new CIMProperty(CIM_JobDestinationJobs.PROPERTY_DEPENDENT_CIM_JOB.NAME,
     ...
     *
     */
    public final static CIM_JobDestinationJobs createInstance(WBEMClient client,
            CIM_JobDestinationJobs dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_JobDestinationJobs newDataInstance = CIM_JobDestinationJobsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_JobDestinationJobs modifyInstance(WBEMClient client,
            CIM_JobDestinationJobs dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_JobDestinationJobs dataInstance2 = CIM_JobDestinationJobsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_JobDestinationJobs dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_JobDestinationJobs.getPackages());
    }
