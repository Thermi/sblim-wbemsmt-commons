...
public class CIM_BIOSLoadedInNV extends CIM_Dependency {
     ...
     * 
     */
    public static class PROPERTY_ANTECEDENT_CIM_MEMORY {
        /**
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_BIOSELEMENT {
        /**
    ...
    public CIM_BIOSLoadedInNV(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_BIOSLoadedInNV(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_EndingAddress(WBEMClient client, String namespace,
        ...
        CIM_BIOSLoadedInNV fco = new CIM_BIOSLoadedInNV(client, namespace);
    ...
    public CIM_Memory get_Antecedent_CIM_Memory(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_MEMORY.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_MEMORY.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Antecedent_CIM_Memory(CIM_Memory newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ANTECEDENT_CIM_MEMORY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Antecedent_CIM_Memory(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_Antecedent_CIM_Memory(WBEMClient client, String namespace,
            CIM_Memory newValue) throws WbemsmtException {
        CIM_BIOSLoadedInNV fco = new CIM_BIOSLoadedInNV(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_ANTECEDENT_CIM_MEMORY.NAME);
        if (property != null) {
            property = setPropertyValue_Antecedent_CIM_Memory(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_ANTECEDENT_CIM_MEMORY.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Antecedent_CIM_Memory(CIMProperty currentProperty,
            CIM_Memory newValue) {
        Object setThis = null;
    ...
    public CIM_BIOSElement get_Dependent_CIM_BIOSElement(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_BIOSELEMENT.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_BIOSELEMENT.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Dependent_CIM_BIOSElement(CIM_BIOSElement newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_BIOSELEMENT.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_BIOSElement(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_Dependent_CIM_BIOSElement(WBEMClient client, String namespace,
            CIM_BIOSElement newValue) throws WbemsmtException {
        CIM_BIOSLoadedInNV fco = new CIM_BIOSLoadedInNV(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_BIOSELEMENT.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_BIOSElement(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_BIOSELEMENT.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_BIOSElement(
    ...
    public String getObjectName() {
        return CIM_BIOSLoadedInNV.CIM_CLASS_NAME;
    }
