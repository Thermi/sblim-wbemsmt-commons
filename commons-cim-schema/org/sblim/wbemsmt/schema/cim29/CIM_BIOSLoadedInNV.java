...
public class CIM_BIOSLoadedInNV extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BIOSLoadedInNV"; //$NON-NLS-1$
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_BIOSLoadedInNV.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_BIOSLoadedInNV.Java_Package_List.toArray(new String[CIM_BIOSLoadedInNV.Java_Package_List.size()]);
    }
