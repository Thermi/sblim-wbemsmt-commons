...
public class CIM_LogicalDevice extends CIM_EnabledLogicalElement {
    ...
    public static class METHOD_SETPOWERSTATE {
        ...
        public static class PARAMETER_POWERSTATE {
             ...
             */
            //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@4ffe4ffe
    ...
    public static class PROPERTY_ADDITIONALAVAILABILITY {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@4ede4ede
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public static class PROPERTY_AVAILABILITY {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@2fcc2fcc
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public static class PROPERTY_POWERMANAGEMENTCAPABILITIES {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@4f204f2
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public static class PROPERTY_STATUSINFO {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@5ee25ee2
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public boolean set_AdditionalAvailability(javax.cim.UnsignedInteger16[] newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_AdditionalAvailability(currentProperty, newValue);
    ...
    public boolean set_Availability(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_AVAILABILITY.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Availability(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_ErrorCleared(Boolean newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ERRORCLEARED.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ErrorCleared(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_ErrorDescription(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_ERRORDESCRIPTION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ErrorDescription(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_LastErrorCode(javax.cim.UnsignedInteger32 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_LASTERRORCODE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_LastErrorCode(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_MaxQuiesceTime(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_MAXQUIESCETIME.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_MaxQuiesceTime(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_PowerOnHours(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_POWERONHOURS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_PowerOnHours(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_StatusInfo(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_STATUSINFO.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_StatusInfo(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public boolean set_TotalPowerOnHours(javax.cim.UnsignedInteger64 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_TOTALPOWERONHOURS.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_TotalPowerOnHours(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    /**
     * Get the list with CIM_PhysicalElement objects associated by the association CIM_Realizes
     * 
    ...
    public java.util.List getAssociated_CIM_PhysicalElement_CIM_Realizess(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_PhysicalElement_CIM_Realizess(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REALIZES, CIM_PhysicalElement.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_PhysicalElement_CIM_RealizesNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_PhysicalElement_CIM_RealizesNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_REALIZES, CIM_PhysicalElement.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_System_CIM_SystemDevices(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_SystemDevices(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE, CIM_System.CIM_CLASS_NAME, null, null,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_System_CIM_SystemDevices(WBEMClient cimClient,
        ...
        return getAssociated_CIM_System_CIM_SystemDevices(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE, resultClass, role, resultRole, false,
                false, null);
    ...
    public java.util.List getAssociated_CIM_System_CIM_SystemDeviceNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_SystemDeviceNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE, CIM_System.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_System_CIM_SystemDeviceNames(WBEMClient cimClient,
        ...
        return getAssociated_CIM_System_CIM_SystemDeviceNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE, resultClass, role, resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_System_CIM_SystemDeviceNames(WBEMClient cimClient,
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE,
    ...
    public java.util.List getAssociations_CIM_SystemDevice(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
    ...
    public java.util.List getAssociationNames_CIM_SystemDevice(WBEMClient cimClient, String role,
            boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMDEVICE, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_SystemDevice.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_Service objects associated by the association CIM_DeviceServiceImplementation
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_Service_CIM_DeviceServiceImplementations(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_Service_CIM_DeviceServiceImplementations(cimClient,
    ...
    public java.util.List getAssociated_CIM_Service_CIM_DeviceServiceImplementationNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_Service_CIM_DeviceServiceImplementationNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESERVICEIMPLEMENTATION,
    ...
    /**
     * Get the list with CIM_ServiceAccessPoint objects associated by the association CIM_DeviceSAPImplementation
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementations(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementations(cimClient,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementations(
        ...
        return getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementations(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION, resultClass, role,
                resultRole, false, false, null);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_DeviceSAPImplementation
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementationNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementationNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION,
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementationNames(
        ...
        return getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementationNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION, resultClass, role,
                resultRole);
    }
    ...
    public java.util.List getAssociated_CIM_ServiceAccessPoint_CIM_DeviceSAPImplementationNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION,
                    CIM_ServiceAccessPoint.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_DeviceSAPImplementation associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_DeviceSAPImplementation(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_DeviceSAPImplementationHelper.findClass(cimClient,
                            cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_DeviceSAPImplementation(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_DeviceSAPImplementation
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_DeviceSAPImplementation(WBEMClient cimClient,
            String role, boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESAPIMPLEMENTATION,
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_DeviceSAPImplementation.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_DeviceStatisticalInformation objects associated by the association CIM_DeviceStatistics
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_DeviceStatisticalInformation_CIM_DeviceStatisticss(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_DeviceStatisticalInformation_CIM_DeviceStatisticss(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESTATISTICS,
                CIM_DeviceStatisticalInformation.CIM_CLASS_NAME, null, null, false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_DeviceStatisticalInformation(cimInstance));
                        continue;
                    }
    ...
    public java.util.List getAssociated_CIM_DeviceStatisticalInformation_CIM_DeviceStatisticsNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_DeviceStatisticalInformation_CIM_DeviceStatisticsNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESTATISTICS,
                CIM_DeviceStatisticalInformation.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_DeviceStatisticalInformation_CIM_DeviceStatisticsNames(
        ...
        return getAssociated_CIM_DeviceStatisticalInformation_CIM_DeviceStatisticsNames(cimClient,
                true, CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICESTATISTICS, resultClass, role, resultRole);
    }
    ...
    /**
     * Get the list with CIM_LogicalPort objects associated by the association CIM_PortOnDevice
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_LogicalPort_CIM_PortOnDevices(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_LogicalPort_CIM_PortOnDevices(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PORTONDEVICE, CIM_LogicalPort.CIM_CLASS_NAME, null,
                null, false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_LogicalPort(cimInstance));
                        continue;
                    }
    ...
    public java.util.List getAssociated_CIM_LogicalPort_CIM_PortOnDeviceNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_LogicalPort_CIM_PortOnDeviceNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_PORTONDEVICE, CIM_LogicalPort.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_LogicalPort_CIM_PortOnDeviceNames(WBEMClient cimClient,
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    ...
                    CIM_LogicalPort.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_DeviceFile objects associated by the association CIM_DeviceAccessedByFile
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_DeviceFile_CIM_DeviceAccessedByFiles(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_DeviceFile_CIM_DeviceAccessedByFiles(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE, CIM_DeviceFile.CIM_CLASS_NAME,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_DeviceFile_CIM_DeviceAccessedByFiles(
        ...
        return getAssociated_CIM_DeviceFile_CIM_DeviceAccessedByFiles(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE, resultClass, role, resultRole,
                false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_DeviceFile(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_DeviceAccessedByFile
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_DeviceFile_CIM_DeviceAccessedByFileNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_DeviceFile_CIM_DeviceAccessedByFileNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE, CIM_DeviceFile.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_DeviceFile_CIM_DeviceAccessedByFileNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE,
                    CIM_DeviceFile.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_DeviceAccessedByFile associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_DeviceAccessedByFile(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_DeviceAccessedByFileHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_DeviceAccessedByFile(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_DeviceAccessedByFile
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_DeviceAccessedByFile(WBEMClient cimClient,
            String role, boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_DEVICEACCESSEDBYFILE, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_DeviceAccessedByFile.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    public EnableDeviceResult invoke_EnableDevice(WBEMClient cimClient, Boolean Enabled)
            throws WbemsmtException {

        CIMArgument[] inParameter = new CIMArgument[1];
        CIMArgument[] outParameter = new CIMArgument[0];

        inParameter[0] = new CIMArgument("Enabled", CIMDataType.BOOLEAN_T, Enabled);

        javax.cim.UnsignedInteger32 resultObject = null;

        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(),
                    METHOD_ENABLEDEVICE.NAME, inParameter, outParameter);
            if (oResult != null) {
    ...
    public OnlineDeviceResult invoke_OnlineDevice(WBEMClient cimClient, Boolean Online)
            throws WbemsmtException {

        CIMArgument[] inParameter = new CIMArgument[1];
        CIMArgument[] outParameter = new CIMArgument[0];

        inParameter[0] = new CIMArgument("Online", CIMDataType.BOOLEAN_T, Online);

        javax.cim.UnsignedInteger32 resultObject = null;

        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(),
                    METHOD_ONLINEDEVICE.NAME, inParameter, outParameter);
            if (oResult != null) {
    ...
    public QuiesceDeviceResult invoke_QuiesceDevice(WBEMClient cimClient, Boolean Quiesce)
            throws WbemsmtException {

        CIMArgument[] inParameter = new CIMArgument[1];
        CIMArgument[] outParameter = new CIMArgument[0];

        inParameter[0] = new CIMArgument("Quiesce", CIMDataType.BOOLEAN_T, Quiesce);

        javax.cim.UnsignedInteger32 resultObject = null;

        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(),
                    METHOD_QUIESCEDEVICE.NAME, inParameter, outParameter);
            if (oResult != null) {
    ...
    public ResetResult invoke_Reset(WBEMClient cimClient) throws WbemsmtException {
        ...
        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(), METHOD_RESET.NAME,
            ...
            throw new InvokeMethodException(e, new InvokeMethodUserObject(this.getCimObjectPath(),
                    METHOD_RESET.NAME, inParameter, outParameter));
        }
    ...
    public RestorePropertiesResult invoke_RestoreProperties(WBEMClient cimClient)
        ...
        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(),
                    METHOD_RESTOREPROPERTIES.NAME, inParameter, outParameter);
            if (oResult != null) {
    ...
    public SavePropertiesResult invoke_SaveProperties(WBEMClient cimClient) throws WbemsmtException {
        ...
        try {
            Object oResult = cimClient.invokeMethod(this.getCimObjectPath(),
                    METHOD_SAVEPROPERTIES.NAME, inParameter, outParameter);
            if (oResult != null) {
    ...
    public SetPowerStateResult invoke_SetPowerState(WBEMClient cimClient,
            javax.cim.UnsignedInteger16 PowerState, javax.cim.CIMDateTime Time)
            throws WbemsmtException {
