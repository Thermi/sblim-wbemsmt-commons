 ...
 *
 *
 * Description: A zone is a group of Ports, Endpoints, Nodes, Zones, and/or NamedAddressCollections that are managed collectively by the same domain. The managing domain is indicated by the HostedCollection association. For Fibre Channel, a zone indicates a set of members that are participating together in the fabric.
 * 
 */
...
public class CIM_Zone extends CIM_ConnectivityCollection  {
	...
	/**
	*	Indicates that this Zone is currently active (i.e. under enforcement of a fabric). This property can be used to distinguish between a Zone that is currently active and a snapshot of a Zone (with the same InstanceName) that is for "offline" editing.
	*/
	...
	*/
	...
	/**
	*	A string describing the ZoneSubType when the ZoneSubType value is 1 "Other".
	*/
	public final static String CIM_PROPERTY_OTHERZONESUBTYPEDESCRIPTION = "OtherZoneSubTypeDescription"; //$NON-NLS-1$
	/**
	*	A string describing the ZoneType when the ZoneType value is 1 "Other".
	*/
	public final static String CIM_PROPERTY_OTHERZONETYPEDESCRIPTION = "OtherZoneTypeDescription"; //$NON-NLS-1$
	/**
	*	Specific clarification when necessary when the ProtocolType has an enumeration that requires it. Specifically, if ProtocolType is "Protocol", then SubType the Fibre Channel FC4 type.
	*/
