/** 
 * CIM_VideoControllerHelper.java
 *
...
public final class CIM_VideoControllerHelper {

	public final static String CIM_CLASS_NAME = "CIM_VideoController";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_VideoController.Java_Package_List.size(); i++) {
						if (!((String)(CIM_VideoController.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_VideoController.Java_Package_List.get(i))).endsWith(".")) {
							CIM_VideoController.Java_Package_List.setElementAt((String)(CIM_VideoController.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VideoController.");
						resultArrayList.add(new CIM_VideoController(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VideoController.");
						resultArrayList.add(new CIM_VideoController(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VideoController.");
						resultArrayList.add(new CIM_VideoController(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_VideoController getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_VideoControllerHelper.getInstance(cimClient, new CIM_VideoController(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_VideoController getInstance(CIMClient cimClient, CIM_VideoController dataInstance) {
		...
		return CIM_VideoControllerHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_VideoController getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_VideoController dataInstance = null;
		try {
			dataInstance = new CIM_VideoController(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_VideoController createInstance(CIMClient cimClient, CIM_VideoController dataInstance, boolean notifyDifferencies){ 
		...
		CIM_VideoController newDataInstance = null;
		try {
			newDataInstance = CIM_VideoControllerHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_VideoController modifyInstance(CIMClient cimClient, CIM_VideoController dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_VideoControllerHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_VideoController dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_VideoController dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_VideoController.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_VideoController.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_VideoController.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_VideoController.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_VideoController.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AcceleratorCapabilities(UnsignedInt16[] AcceleratorCapabilities) {
		return true;
	}
	...
	public static boolean isValid_CurrentBitsPerPixel(UnsignedInt32 CurrentBitsPerPixel) {
		return true;
	}

	public static boolean isValid_CurrentHorizontalResolution(UnsignedInt32 CurrentHorizontalResolution) {
		return true;
	}

	public static boolean isValid_CurrentNumberOfColors(UnsignedInt64 CurrentNumberOfColors) {
		return true;
	}

	public static boolean isValid_CurrentNumberOfColumns(UnsignedInt32 CurrentNumberOfColumns) {
		return true;
	}

	public static boolean isValid_CurrentNumberOfRows(UnsignedInt32 CurrentNumberOfRows) {
		return true;
	}

	public static boolean isValid_CurrentRefreshRate(UnsignedInt32 CurrentRefreshRate) {
		return true;
	}

	public static boolean isValid_CurrentScanMode(UnsignedInt16 CurrentScanMode) {
		return true;
	}

	public static boolean isValid_CurrentVerticalResolution(UnsignedInt32 CurrentVerticalResolution) {
		return true;
	}

	public static boolean isValid_Description(String Description) {
		return true;
	}

	public static boolean isValid_MaxMemorySupported(UnsignedInt32 MaxMemorySupported) {
		return true;
	}

	public static boolean isValid_MaxRefreshRate(UnsignedInt32 MaxRefreshRate) {
		return true;
	}

	public static boolean isValid_MinRefreshRate(UnsignedInt32 MinRefreshRate) {
		return true;
	}

	public static boolean isValid_NumberOfVideoPages(UnsignedInt32 NumberOfVideoPages) {
		return true;
	}

	public static boolean isValid_VideoMemoryType(UnsignedInt16 VideoMemoryType) {
		return true;
	}

	public static boolean isValid_VideoProcessor(String VideoProcessor) {
		return true;
	}
