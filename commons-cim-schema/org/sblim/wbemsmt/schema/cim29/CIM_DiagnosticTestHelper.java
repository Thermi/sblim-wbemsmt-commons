...
public final class CIM_DiagnosticTestHelper {

	public final static String CIM_CLASS_NAME = "CIM_DiagnosticTest";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_DiagnosticTest.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DiagnosticTest.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_DiagnosticTest.Java_Package_List.get(i))).endsWith(".")) {
							CIM_DiagnosticTest.Java_Package_List.setElementAt((String)(CIM_DiagnosticTest.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DiagnosticTest.");
						resultArrayList.add(new CIM_DiagnosticTest(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DiagnosticTest.");
						resultArrayList.add(new CIM_DiagnosticTest(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DiagnosticTest.");
						resultArrayList.add(new CIM_DiagnosticTest(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DiagnosticTest getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DiagnosticTestHelper.getInstance(cimClient, new CIM_DiagnosticTest(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticTest getInstance(CIMClient cimClient, CIM_DiagnosticTest dataInstance) {
		...
		return CIM_DiagnosticTestHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticTest getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DiagnosticTest dataInstance = null;
		try {
			dataInstance = new CIM_DiagnosticTest(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticTest createInstance(CIMClient cimClient, CIM_DiagnosticTest dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DiagnosticTest newDataInstance = null;
		try {
			newDataInstance = CIM_DiagnosticTestHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticTest modifyInstance(CIMClient cimClient, CIM_DiagnosticTest dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DiagnosticTestHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DiagnosticTest dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DiagnosticTest dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DiagnosticTest.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DiagnosticTest.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DiagnosticTest.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DiagnosticTest.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DiagnosticTest.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_IsInUse(Boolean IsInUse) {
		return true;
	}

	public static boolean isValid_OtherCharacteristicDescription(String OtherCharacteristicDescription) {
		return true;
	}

	public static boolean isValid_OtherCharacteristicsDescriptions(String[] OtherCharacteristicsDescriptions) {
		return true;
	}

	public static boolean isValid_ResourcesUsed(UnsignedInt16[] ResourcesUsed) {
		return true;
	}
