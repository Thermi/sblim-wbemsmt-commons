 ...
 * 
 * Description: Helper class for CIM_LogicalPortGroup
 *    
 * 
 * generated Class
 * @see CIM_LogicalPortGroup
 */
...
public class CIM_LogicalPortGroupHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_LogicalPortGroup or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalPortGroup.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_LogicalPortGroup.CIM_CLASS_NAME
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_LogicalPortGroup or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_LogicalPortGroup.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_LogicalPortGroup(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_LogicalPortGroupHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_LogicalPortGroup.");
                        resultArrayList.add(new CIM_LogicalPortGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LogicalPortGroup.");
                        resultArrayList.add(new CIM_LogicalPortGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LogicalPortGroup.");
                        resultArrayList.add(new CIM_LogicalPortGroup(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LogicalPortGroup getInstance(WBEMClient client,
     ...
     */
    public final static CIM_LogicalPortGroup getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_LogicalPortGroup) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_LogicalPortGroup(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_LogicalPortGroup getInstance(WBEMClient client, String namespace,
            String InstanceID
        ...
        keyProperties[0] = new CIMProperty(CIM_LogicalPortGroup.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LogicalPortGroup.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_LogicalPortGroup createInstance(WBEMClient client,
            CIM_LogicalPortGroup dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_LogicalPortGroup newDataInstance = CIM_LogicalPortGroupHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_LogicalPortGroup modifyInstance(WBEMClient client,
            CIM_LogicalPortGroup dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LogicalPortGroup dataInstance2 = CIM_LogicalPortGroupHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_LogicalPortGroup dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LogicalPortGroup.getPackages());
    }
