 ...
 * 
 * Description: Helper class for CIM_CardOnCard
 *    
 * 
 * generated Class
 * @see CIM_CardOnCard
...
public class CIM_CardOnCardHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CardOnCard or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CardOnCard.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_CardOnCard.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CardOnCard or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_CardOnCard.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CardOnCard(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CardOnCardHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_CardOnCard.");
                        resultArrayList.add(new CIM_CardOnCard(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_CardOnCard.");
                        resultArrayList.add(new CIM_CardOnCard(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CardOnCard.");
                        resultArrayList.add(new CIM_CardOnCard(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CardOnCard getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_CardOnCard getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CardOnCard) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CardOnCard(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CardOnCard getInstance(WBEMClient client, String namespace,
            CIM_Card GroupComponent, CIM_Card PartComponent
        ...
        keyProperties[0] = new CIMProperty(CIM_CardOnCard.PROPERTY_GROUPCOMPONENT_CIM_CARD.NAME,
        ...
        keyProperties[1] = new CIMProperty(CIM_CardOnCard.PROPERTY_PARTCOMPONENT_CIM_CARD.NAME,
                new CIMDataType(CIM_Card.CIM_CLASS_NAME), setThis, false, false,
                CIM_CardOnCard.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CardOnCard createInstance(WBEMClient client,
            CIM_CardOnCard dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_CardOnCard newDataInstance = CIM_CardOnCardHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_CardOnCard modifyInstance(WBEMClient client,
            CIM_CardOnCard dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CardOnCard dataInstance2 = CIM_CardOnCardHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_CardOnCard dataInstance)
            throws WbemsmtException {
