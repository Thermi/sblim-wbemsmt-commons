/** 
 * CIM_PhysicalConnectorHelper.java
 *
...
public final class CIM_PhysicalConnectorHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_PhysicalConnector.Java_Package_List.size(); i++) {
						if (!((String)(CIM_PhysicalConnector.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_PhysicalConnector.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_PhysicalConnector.Java_Package_List.setElementAt((String)(CIM_PhysicalConnector.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_PhysicalConnector.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PhysicalConnector.");
						resultArrayList.add(new CIM_PhysicalConnector(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PhysicalConnector.");
						resultArrayList.add(new CIM_PhysicalConnector(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PhysicalConnector.");
						resultArrayList.add(new CIM_PhysicalConnector(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PhysicalConnector getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PhysicalConnectorHelper.getInstance(cimClient, new CIM_PhysicalConnector(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalConnector getInstance(CIMClient cimClient, CIM_PhysicalConnector dataInstance) {
		...
		return CIM_PhysicalConnectorHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalConnector getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PhysicalConnector dataInstance = null;
		try {
			dataInstance = new CIM_PhysicalConnector(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalConnector createInstance(CIMClient cimClient, CIM_PhysicalConnector dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PhysicalConnector newDataInstance = null;
		try {
			newDataInstance = CIM_PhysicalConnectorHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalConnector modifyInstance(CIMClient cimClient, CIM_PhysicalConnector dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PhysicalConnectorHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PhysicalConnector dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PhysicalConnector dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PhysicalConnector.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PhysicalConnector.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PhysicalConnector.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PhysicalConnector.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PhysicalConnector.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ConnectorDescription(String ConnectorDescription) {
		return true;
	}

	public static boolean isValid_ConnectorElectricalCharacteristics(UnsignedInt16[] ConnectorElectricalCharacteristics) {
		return true;
	}

	public static boolean isValid_ConnectorGender(UnsignedInt16 ConnectorGender) {
		return true;
	}

	public static boolean isValid_ConnectorLayout(UnsignedInt16 ConnectorLayout) {
		return true;
	}

	public static boolean isValid_ConnectorPinout(String ConnectorPinout) {
		return true;
	}

	public static boolean isValid_ConnectorType(UnsignedInt16[] ConnectorType) {
		return true;
	}

	public static boolean isValid_NumPhysicalPins(UnsignedInt32 NumPhysicalPins) {
		return true;
	}

	public static boolean isValid_OtherElectricalCharacteristics(String[] OtherElectricalCharacteristics) {
		return true;
	}
