/** 
 * CIM_ObjectManagerAdapterHelper.java
 *
...
public final class CIM_ObjectManagerAdapterHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_ObjectManagerAdapter.Java_Package_List.size(); i++) {
						if (!((String)(CIM_ObjectManagerAdapter.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_ObjectManagerAdapter.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_ObjectManagerAdapter.Java_Package_List.setElementAt((String)(CIM_ObjectManagerAdapter.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_ObjectManagerAdapter.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ObjectManagerAdapter.");
						resultArrayList.add(new CIM_ObjectManagerAdapter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ObjectManagerAdapter.");
						resultArrayList.add(new CIM_ObjectManagerAdapter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ObjectManagerAdapter.");
						resultArrayList.add(new CIM_ObjectManagerAdapter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ObjectManagerAdapter getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ObjectManagerAdapterHelper.getInstance(cimClient, new CIM_ObjectManagerAdapter(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ObjectManagerAdapter getInstance(CIMClient cimClient, CIM_ObjectManagerAdapter dataInstance) {
		...
		return CIM_ObjectManagerAdapterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ObjectManagerAdapter getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ObjectManagerAdapter dataInstance = null;
		try {
			dataInstance = new CIM_ObjectManagerAdapter(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ObjectManagerAdapter createInstance(CIMClient cimClient, CIM_ObjectManagerAdapter dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ObjectManagerAdapter newDataInstance = null;
		try {
			newDataInstance = CIM_ObjectManagerAdapterHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ObjectManagerAdapter modifyInstance(CIMClient cimClient, CIM_ObjectManagerAdapter dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ObjectManagerAdapterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ObjectManagerAdapter dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ObjectManagerAdapter dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ObjectManagerAdapter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ObjectManagerAdapter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ObjectManagerAdapter.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ObjectManagerAdapter.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ObjectManagerAdapter.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AdapterType(UnsignedInt16 AdapterType) {
		return true;
	}
	...
	public static boolean isValid_OtherAdapterTypeDescription(String OtherAdapterTypeDescription) {
		return true;
	}
