 ...
 * 
 * Description: Helper class for CIM_Statistics
 *    
 * 
 * generated Class
 * @see CIM_Statistics
...
public class CIM_StatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Statistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Statistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Statistics.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Statistics or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Statistics.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Statistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_StatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Statistics.");
                        resultArrayList.add(new CIM_Statistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Statistics.");
                        resultArrayList.add(new CIM_Statistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Statistics.");
                        resultArrayList.add(new CIM_Statistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Statistics getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Statistics getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Statistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Statistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Statistics getInstance(WBEMClient client, String namespace,
            CIM_StatisticalInformation Stats, CIM_ManagedElement Element
        ...
        keyProperties[0] = new CIMProperty(
                CIM_Statistics.PROPERTY_STATS_CIM_STATISTICALINFORMATION.NAME, new CIMDataType(
                        CIM_StatisticalInformation.CIM_CLASS_NAME), setThis, false, false,
                CIM_Statistics.CIM_CLASS_NAME);

        setThis = Element != null ? Element.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_Statistics.PROPERTY_ELEMENT_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_Statistics createInstance(WBEMClient client,
            CIM_Statistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_Statistics newDataInstance = CIM_StatisticsHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Statistics modifyInstance(WBEMClient client,
            CIM_Statistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Statistics dataInstance2 = CIM_StatisticsHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Statistics dataInstance)
            throws WbemsmtException {
