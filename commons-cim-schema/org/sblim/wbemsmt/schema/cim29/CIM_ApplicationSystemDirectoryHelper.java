 ...
 * 
 * Description: Helper class for CIM_ApplicationSystemDirectory
 *    
 * 
 * generated Class
 * @see CIM_ApplicationSystemDirectory
 */
...
public class CIM_ApplicationSystemDirectoryHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ApplicationSystemDirectory or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ApplicationSystemDirectory.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ApplicationSystemDirectory.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ApplicationSystemDirectory or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ApplicationSystemDirectory(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ApplicationSystemDirectoryHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ApplicationSystemDirectory.");
                        resultArrayList.add(new CIM_ApplicationSystemDirectory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ApplicationSystemDirectory.");
                        resultArrayList.add(new CIM_ApplicationSystemDirectory(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ApplicationSystemDirectory.");
                        resultArrayList.add(new CIM_ApplicationSystemDirectory(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ApplicationSystemDirectory getInstance(WBEMClient client,
    ...
    public final static CIM_ApplicationSystemDirectory getInstance(WBEMClient client,
        ...
        Class clazz = CIM_ApplicationSystemDirectoryHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ApplicationSystemDirectory) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ApplicationSystemDirectory(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ApplicationSystemDirectory getInstance(WBEMClient client,
            String namespace, String Name, CIM_Directory Antecedent, CIM_ApplicationSystem Dependent
        ...
        keyProperties[0] = new CIMProperty(CIM_ApplicationSystemDirectory.PROPERTY_NAME.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ApplicationSystemDirectory.PROPERTY_ANTECEDENT_CIM_DIRECTORY.NAME,
                new CIMDataType(CIM_Directory.CIM_CLASS_NAME), setThis, false, false,
                CIM_ApplicationSystemDirectory.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[2] = new CIMProperty(
                CIM_ApplicationSystemDirectory.PROPERTY_DEPENDENT_CIM_APPLICATIONSYSTEM.NAME,
     ...
     *
     */
    public final static CIM_ApplicationSystemDirectory createInstance(WBEMClient client,
            CIM_ApplicationSystemDirectory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ApplicationSystemDirectory newDataInstance = CIM_ApplicationSystemDirectoryHelper
     ...
     */
    public final static CIM_ApplicationSystemDirectory modifyInstance(WBEMClient client,
            CIM_ApplicationSystemDirectory dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ApplicationSystemDirectory dataInstance2 = CIM_ApplicationSystemDirectoryHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ApplicationSystemDirectory dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ApplicationSystemDirectory.getPackages());
    }
