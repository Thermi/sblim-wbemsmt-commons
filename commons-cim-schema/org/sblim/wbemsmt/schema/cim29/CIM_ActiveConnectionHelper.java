 ...
 * 
 * Description: Helper class for CIM_ActiveConnection
 *    
 * 
 * generated Class
 * @see CIM_ActiveConnection
 */
...
public class CIM_ActiveConnectionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ActiveConnection or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ActiveConnection.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ActiveConnection.CIM_CLASS_NAME
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ActiveConnection or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ActiveConnection.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ActiveConnection(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ActiveConnectionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ActiveConnection.");
                        resultArrayList.add(new CIM_ActiveConnection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ActiveConnection.");
                        resultArrayList.add(new CIM_ActiveConnection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ActiveConnection.");
                        resultArrayList.add(new CIM_ActiveConnection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ActiveConnection getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ActiveConnection getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ActiveConnection) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ActiveConnection(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ActiveConnection getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ActiveConnection.PROPERTY_ANTECEDENT_CIM_SERVICEACCESSPOINT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ActiveConnection.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,
                new CIMDataType(CIM_ServiceAccessPoint.CIM_CLASS_NAME), setThis, false, false,
                CIM_ActiveConnection.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ActiveConnection createInstance(WBEMClient client,
            CIM_ActiveConnection dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ActiveConnection newDataInstance = CIM_ActiveConnectionHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ActiveConnection modifyInstance(WBEMClient client,
            CIM_ActiveConnection dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ActiveConnection dataInstance2 = CIM_ActiveConnectionHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ActiveConnection dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ActiveConnection.getPackages());
    }
