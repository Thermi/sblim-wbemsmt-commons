 ...
 * 
 * Description: CIM_ConfigurationForSystem defines a Configuration in the context of the System on which it resides.
 * 
 * generated Class
 */
...
public class CIM_ConfigurationForSystem extends CIM_HostedDependency {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_SYSTEMCONFIGURATION {
        /**
    ...
    public CIM_ConfigurationForSystem(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ConfigurationForSystem(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ConfigurationForSystem() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_System(WBEMClient client, String namespace,
        ...
        CIM_ConfigurationForSystem fco = new CIM_ConfigurationForSystem(client, namespace);
    ...
    public CIM_SystemConfiguration get_Dependent_CIM_SystemConfiguration(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMCONFIGURATION.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SYSTEMCONFIGURATION.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_Dependent_CIM_SystemConfiguration(CIM_SystemConfiguration newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMCONFIGURATION.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_SystemConfiguration(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_Dependent_CIM_SystemConfiguration(WBEMClient client,
            String namespace, CIM_SystemConfiguration newValue) throws WbemsmtException {
        CIM_ConfigurationForSystem fco = new CIM_ConfigurationForSystem(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_SYSTEMCONFIGURATION.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_SystemConfiguration(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_SYSTEMCONFIGURATION.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_SystemConfiguration(
    ...
    public String getObjectName() {
        return CIM_ConfigurationForSystem.CIM_CLASS_NAME;
    }
