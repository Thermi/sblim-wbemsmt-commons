...
11 (Hung) indicates that a process is not responding and should therefore not be given further execution time.
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_Process.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_Process.Java_Package_List.toArray(new String[CIM_Process.Java_Package_List.size()]);
    }
	...
	*/	
	...
	public ArrayList getAssociated_CIM_DataFile_CIM_ProcessExecutables(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_DataFile_CIM_ProcessExecutable_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_Job_CIM_ProcessOfJobs(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_Job_CIM_ProcessOfJob_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_Thread_CIM_ProcessThreads(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_Thread_CIM_ProcessThread_Names(CIMClient cimClient, boolean deep) {
		...
		try {		
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMObjectPath) {
					if (deep || ((CIMObjectPath)obj).getObjectName().equals(CIM_Thread.CIM_CLASS_NAME)) {
						resultArrayList.add(obj);
					}
				}
			}
	...
	public ArrayList getAssociated_CIM_Service_CIM_ServiceProcesss(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_Service_CIM_ServiceProcess_Names(CIMClient cimClient, boolean deep) {
