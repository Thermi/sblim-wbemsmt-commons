	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_MediaPartition.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_MediaPartition.Java_Package_List.toArray(new String[CIM_MediaPartition.Java_Package_List.size()]);
    }
