...
public class CIM_HostedBootSAP extends CIM_HostedAccessPoint {
    ...
    public CIM_HostedBootSAP(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HostedBootSAP(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_Antecedent_CIM_ComputerSystem(WBEMClient client,
        ...
        CIM_HostedBootSAP fco = new CIM_HostedBootSAP(client, namespace);
    ...
    public String getObjectName() {
        return CIM_HostedBootSAP.CIM_CLASS_NAME;
    }
