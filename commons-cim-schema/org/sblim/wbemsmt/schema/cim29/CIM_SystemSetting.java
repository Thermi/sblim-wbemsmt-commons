...
public class CIM_SystemSetting extends CIM_Setting {
    ...
    protected CIM_SystemSetting(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    protected CIM_SystemSetting(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_key_CreationClassName(WBEMClient client, String namespace,
        ...
        CIM_SystemSetting fco = new CIM_SystemSetting(client, namespace);
    ...
    public String get_key_SettingID() {
    ...
    public boolean set_key_SettingID(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_SETTINGID.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_key_SettingID(currentProperty, newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
        else {
    ...
    public static CIMProperty create_key_SettingID(WBEMClient client, String namespace,
            String newValue) throws WbemsmtException {
        CIM_SystemSetting fco = new CIM_SystemSetting(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_SETTINGID.NAME);
        if (property != null) {
            property = setPropertyValue_key_SettingID(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_SETTINGID.NAME + " was not found in instance "
    ...
    private static CIMProperty setPropertyValue_key_SettingID(CIMProperty currentProperty,
            String newValue) {
        Object setThis = null;
    ...
    /**
     * Get the list with CIM_System objects associated by the association CIM_SettingForSystem
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_System_CIM_SettingForSystems(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_SettingForSystems(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM, CIM_System.CIM_CLASS_NAME, null,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM or a subclass 
    ...
    public java.util.List getAssociated_CIM_System_CIM_SettingForSystems(WBEMClient cimClient,
        ...
        return getAssociated_CIM_System_CIM_SettingForSystems(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_System_CIM_SettingForSystems(WBEMClient cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_SystemSettingHelper.checkException(enumeration);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_SettingForSystem
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_System_CIM_SettingForSystemNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_SettingForSystemNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM, CIM_System.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_System_CIM_SettingForSystemNames(WBEMClient cimClient,
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM,
    ...
    /**
     * Get the list with CIM_SettingForSystem associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_SettingForSystem(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_SettingForSystemHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_SettingForSystem(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_SettingForSystem
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_SettingForSystem(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGFORSYSTEM, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_SettingForSystem.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_SystemConfiguration objects associated by the association CIM_SystemSettingContext
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
     * uses null for resultClass, role, resultRole<br>
     * <br>
     * @see javax.wbem.client.WBEMClient#associators(CIMObjectPath, String, String, String, String, boolean, boolean, String[])
    ...
    public java.util.List getAssociated_CIM_SystemConfiguration_CIM_SystemSettingContexts(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_SystemConfiguration_CIM_SystemSettingContexts(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT,
                CIM_SystemConfiguration.CIM_CLASS_NAME, null, null, false, false, null);
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT or a subclass 
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the source Object plays the specified role. (i.e. the Property name in the Association class that refers to the source Object matches this value) If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are examined.
     * @param resultRole This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects associated to the source Object via an Association class in which the Object returned plays the specified role. (i.e. the Property name in the Association class that refers to the Object returned matches this value) If "Dependent" is specified, then only Associations in which the Object returned is the "Dependent" reference are examined. 
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_SystemConfiguration_CIM_SystemSettingContexts(
        ...
        return getAssociated_CIM_SystemConfiguration_CIM_SystemSettingContexts(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT, resultClass, role, resultRole,
                false, false, null);
            ...
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_SystemConfiguration(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_SystemSettingContext
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_SystemConfiguration_CIM_SystemSettingContextNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_SystemConfiguration_CIM_SystemSettingContextNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT,
                CIM_SystemConfiguration.CIM_CLASS_NAME, null, null);
    }
    ...
    public java.util.List getAssociated_CIM_SystemConfiguration_CIM_SystemSettingContextNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT,
                    CIM_SystemConfiguration.CIM_CLASS_NAME, null, null));
        }
    ...
    /**
     * Get the list with CIM_SystemSettingContext associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_SystemSettingContext(WBEMClient cimClient,
            boolean includeQualifiers, boolean includeClassOrigin, String role,
            java.lang.String[] propertyList) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
            throw new ReferencesException(e, new ReferencesUserObject(this.getCimObjectPath(),
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_SystemSettingContextHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_SystemSettingContext(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_SystemSettingContext
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_SystemSettingContext(WBEMClient cimClient,
            String role, boolean deep) throws WbemsmtException {
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_SYSTEMSETTINGCONTEXT, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_SystemSettingContext.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    public String getObjectName() {
        return CIM_SystemSetting.CIM_CLASS_NAME;
    }
