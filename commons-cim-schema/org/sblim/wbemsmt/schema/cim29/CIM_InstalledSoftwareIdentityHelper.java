 ...
 * 
 * Description: Helper class for CIM_InstalledSoftwareIdentity
 *    
 * 
 * generated Class
 * @see CIM_InstalledSoftwareIdentity
 */
...
public class CIM_InstalledSoftwareIdentityHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_InstalledSoftwareIdentity or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_InstalledSoftwareIdentity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_InstalledSoftwareIdentity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_InstalledSoftwareIdentity or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_InstalledSoftwareIdentity(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_InstalledSoftwareIdentityHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_InstalledSoftwareIdentity.");
                        resultArrayList.add(new CIM_InstalledSoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_InstalledSoftwareIdentity.");
                        resultArrayList.add(new CIM_InstalledSoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_InstalledSoftwareIdentity.");
                        resultArrayList.add(new CIM_InstalledSoftwareIdentity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_InstalledSoftwareIdentity getInstance(WBEMClient client,
    ...
    public final static CIM_InstalledSoftwareIdentity getInstance(WBEMClient client,
        ...
        Class clazz = CIM_InstalledSoftwareIdentityHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_InstalledSoftwareIdentity) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_InstalledSoftwareIdentity(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_InstalledSoftwareIdentity getInstance(WBEMClient client,
            String namespace, CIM_System System, CIM_SoftwareIdentity InstalledSoftware
        ...
        setThis = System != null ? System.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_InstalledSoftwareIdentity.PROPERTY_SYSTEM_CIM_SYSTEM.NAME, new CIMDataType(
                        CIM_System.CIM_CLASS_NAME), setThis, false, false,
                CIM_InstalledSoftwareIdentity.CIM_CLASS_NAME);

        setThis = InstalledSoftware != null ? InstalledSoftware.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_InstalledSoftwareIdentity.PROPERTY_INSTALLEDSOFTWARE_CIM_SOFTWAREIDENTITY.NAME,
                new CIMDataType(CIM_SoftwareIdentity.CIM_CLASS_NAME), setThis, false, false,
                CIM_InstalledSoftwareIdentity.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_InstalledSoftwareIdentity createInstance(WBEMClient client,
            CIM_InstalledSoftwareIdentity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_InstalledSoftwareIdentity newDataInstance = CIM_InstalledSoftwareIdentityHelper
     ...
     */
    public final static CIM_InstalledSoftwareIdentity modifyInstance(WBEMClient client,
            CIM_InstalledSoftwareIdentity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_InstalledSoftwareIdentity dataInstance2 = CIM_InstalledSoftwareIdentityHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_InstalledSoftwareIdentity dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_InstalledSoftwareIdentity.getPackages());
    }
