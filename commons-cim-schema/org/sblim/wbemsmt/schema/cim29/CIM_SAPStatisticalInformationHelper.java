 ...
 * 
 * Description: Helper class for CIM_SAPStatisticalInformation
 *    
 * 
 * generated Class
 * @see CIM_SAPStatisticalInformation
 */
...
public class CIM_SAPStatisticalInformationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SAPStatisticalInformation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SAPStatisticalInformation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SAPStatisticalInformation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SAPStatisticalInformation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SAPStatisticalInformation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SAPStatisticalInformationHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SAPStatisticalInformation.");
                        resultArrayList.add(new CIM_SAPStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SAPStatisticalInformation.");
                        resultArrayList.add(new CIM_SAPStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SAPStatisticalInformation.");
                        resultArrayList.add(new CIM_SAPStatisticalInformation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SAPStatisticalInformation getInstance(WBEMClient client,
    ...
    public final static CIM_SAPStatisticalInformation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_SAPStatisticalInformationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SAPStatisticalInformation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SAPStatisticalInformation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SAPStatisticalInformation getInstance(WBEMClient client,
            String namespace, String CreationClassName, String Name, String SAPCreationClassName,
            String SAPName, String SystemCreationClassName, String SystemName
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SAPStatisticalInformation.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SAPStatisticalInformation.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_SAPStatisticalInformation.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SAPStatisticalInformation.CIM_CLASS_NAME);

        setThis = SAPCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_SAPStatisticalInformation.PROPERTY_SAPCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SAPStatisticalInformation.CIM_CLASS_NAME);

        setThis = SAPName;

        keyProperties[3] = new CIMProperty(CIM_SAPStatisticalInformation.PROPERTY_SAPNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SAPStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[4] = new CIMProperty(
                CIM_SAPStatisticalInformation.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SAPStatisticalInformation.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[5] = new CIMProperty(CIM_SAPStatisticalInformation.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_SAPStatisticalInformation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SAPStatisticalInformation createInstance(WBEMClient client,
            CIM_SAPStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SAPStatisticalInformation newDataInstance = CIM_SAPStatisticalInformationHelper
     ...
     */
    public final static CIM_SAPStatisticalInformation modifyInstance(WBEMClient client,
            CIM_SAPStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SAPStatisticalInformation dataInstance2 = CIM_SAPStatisticalInformationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SAPStatisticalInformation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SAPStatisticalInformation.getPackages());
    }
