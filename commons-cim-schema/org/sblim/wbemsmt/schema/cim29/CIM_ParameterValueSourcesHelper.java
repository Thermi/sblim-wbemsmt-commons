 ...
 * 
 * Description: Helper class for CIM_ParameterValueSources
 *    
 * 
 * generated Class
 * @see CIM_ParameterValueSources
 */
...
public class CIM_ParameterValueSourcesHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ParameterValueSources or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ParameterValueSources.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ParameterValueSources.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ParameterValueSources or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ParameterValueSources(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ParameterValueSourcesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ParameterValueSources.");
                        resultArrayList.add(new CIM_ParameterValueSources(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ParameterValueSources.");
                        resultArrayList.add(new CIM_ParameterValueSources(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ParameterValueSources.");
                        resultArrayList.add(new CIM_ParameterValueSources(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ParameterValueSources getInstance(WBEMClient client,
    ...
    public final static CIM_ParameterValueSources getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ParameterValueSources) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ParameterValueSources(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ParameterValueSources getInstance(WBEMClient client, String namespace,
            CIM_MethodParameters Parameters, CIM_ManagedElement ValueSource
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ParameterValueSources.PROPERTY_PARAMETERS_CIM_METHODPARAMETERS.NAME,
                new CIMDataType(CIM_MethodParameters.CIM_CLASS_NAME), setThis, false, false,
                CIM_ParameterValueSources.CIM_CLASS_NAME);

        setThis = ValueSource != null ? ValueSource.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ParameterValueSources.PROPERTY_VALUESOURCE_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ParameterValueSources createInstance(WBEMClient client,
            CIM_ParameterValueSources dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ParameterValueSources newDataInstance = CIM_ParameterValueSourcesHelper.getInstance(
     ...
     */
    public final static CIM_ParameterValueSources modifyInstance(WBEMClient client,
            CIM_ParameterValueSources dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ParameterValueSources dataInstance2 = CIM_ParameterValueSourcesHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ParameterValueSources dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ParameterValueSources.getPackages());
    }
