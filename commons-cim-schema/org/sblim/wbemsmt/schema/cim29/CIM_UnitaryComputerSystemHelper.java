/** 
 * CIM_UnitaryComputerSystemHelper.java
 *
...
public final class CIM_UnitaryComputerSystemHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_UnitaryComputerSystem.");
						resultArrayList.add(new CIM_UnitaryComputerSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_UnitaryComputerSystem.");
						resultArrayList.add(new CIM_UnitaryComputerSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_UnitaryComputerSystem.");
						resultArrayList.add(new CIM_UnitaryComputerSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_UnitaryComputerSystem getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_UnitaryComputerSystemHelper.getInstance(cimClient, new CIM_UnitaryComputerSystem(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UnitaryComputerSystem getInstance(CIMClient cimClient, CIM_UnitaryComputerSystem dataInstance) {
		...
		return CIM_UnitaryComputerSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UnitaryComputerSystem getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_UnitaryComputerSystem dataInstance = null;
		try {
			dataInstance = new CIM_UnitaryComputerSystem(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_UnitaryComputerSystem.getPackages();
	...
	*/	
	public final static CIM_UnitaryComputerSystem createInstance(CIMClient cimClient, CIM_UnitaryComputerSystem dataInstance, boolean notifyDifferencies){ 
		...
		CIM_UnitaryComputerSystem newDataInstance = null;
		try {
			newDataInstance = CIM_UnitaryComputerSystemHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_UnitaryComputerSystem modifyInstance(CIMClient cimClient, CIM_UnitaryComputerSystem dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_UnitaryComputerSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_UnitaryComputerSystem dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_UnitaryComputerSystem dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_UnitaryComputerSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_UnitaryComputerSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_UnitaryComputerSystem.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_UnitaryComputerSystem.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_UnitaryComputerSystem.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_InitialLoadInfo(String[] InitialLoadInfo) {
		return true;
	}

	public static boolean isValid_LastLoadInfo(String LastLoadInfo) {
		return true;
	}

	public static boolean isValid_PowerManagementSupported(Boolean PowerManagementSupported) {
		return true;
	}

	public static boolean isValid_PowerState(UnsignedInt16 PowerState) {
		return true;
	}

	public static boolean isValid_WakeUpType(UnsignedInt16 WakeUpType) {
		return true;
	}
