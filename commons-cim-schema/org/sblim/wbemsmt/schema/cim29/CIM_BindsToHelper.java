 ...
 * 
 * Description: Helper class for CIM_BindsTo
 *    
 * 
 * generated Class
 * @see CIM_BindsTo
...
public class CIM_BindsToHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BindsTo or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BindsTo.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_BindsTo.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BindsTo or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BindsTo.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BindsTo(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BindsToHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_BindsTo.");
                        resultArrayList.add(new CIM_BindsTo(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_BindsTo.");
                        resultArrayList.add(new CIM_BindsTo(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BindsTo.");
                        resultArrayList.add(new CIM_BindsTo(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BindsTo getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_BindsTo getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BindsTo) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BindsTo(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BindsTo getInstance(WBEMClient client, String namespace,
            CIM_ProtocolEndpoint Antecedent, CIM_ServiceAccessPoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_BindsTo.PROPERTY_ANTECEDENT_CIM_PROTOCOLENDPOINT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_BindsTo.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_BindsTo createInstance(WBEMClient client, CIM_BindsTo dataInstance,
        ...
        CIM_BindsTo newDataInstance = CIM_BindsToHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_BindsTo modifyInstance(WBEMClient client, CIM_BindsTo dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BindsTo dataInstance2 = CIM_BindsToHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BindsTo dataInstance)
            throws WbemsmtException {
