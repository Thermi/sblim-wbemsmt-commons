 ...
 * 
 * Description: Helper class for CIM_ClusteringService
 *    
 * 
 * generated Class
 * @see CIM_ClusteringService
 */
...
public class CIM_ClusteringServiceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ClusteringService or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ClusteringService.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ClusteringService.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ClusteringService or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ClusteringService(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ClusteringServiceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ClusteringService.");
                        resultArrayList.add(new CIM_ClusteringService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ClusteringService.");
                        resultArrayList.add(new CIM_ClusteringService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ClusteringService.");
                        resultArrayList.add(new CIM_ClusteringService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ClusteringService getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ClusteringService getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ClusteringService) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ClusteringService(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ClusteringService getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ClusteringService.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ClusteringService.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_ClusteringService.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ClusteringService.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_ClusteringService.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_ClusteringService.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_ClusteringService.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ClusteringService.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ClusteringService createInstance(WBEMClient client,
            CIM_ClusteringService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ClusteringService newDataInstance = CIM_ClusteringServiceHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ClusteringService modifyInstance(WBEMClient client,
            CIM_ClusteringService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ClusteringService dataInstance2 = CIM_ClusteringServiceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ClusteringService dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ClusteringService.getPackages());
    }
