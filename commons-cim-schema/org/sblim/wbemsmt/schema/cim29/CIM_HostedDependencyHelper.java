...
public class CIM_HostedDependencyHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedDependency.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_HostedDependency.CIM_CLASS_NAME
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_HostedDependency.");
                        resultArrayList.add(new CIM_HostedDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedDependency.");
                        resultArrayList.add(new CIM_HostedDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedDependency.");
                        resultArrayList.add(new CIM_HostedDependency(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedDependency getInstance(WBEMClient client,
     ...
     */
    public final static CIM_HostedDependency getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_HostedDependency getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement Antecedent, CIM_ManagedElement Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedDependency.PROPERTY_ANTECEDENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedDependency.PROPERTY_DEPENDENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
                        CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_HostedDependency.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_HostedDependency createInstance(WBEMClient client,
            CIM_HostedDependency dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedDependency newDataInstance = CIM_HostedDependencyHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedDependency modifyInstance(WBEMClient client,
            CIM_HostedDependency dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedDependency dataInstance2 = CIM_HostedDependencyHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedDependency dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedDependency.getPackages());
    }
