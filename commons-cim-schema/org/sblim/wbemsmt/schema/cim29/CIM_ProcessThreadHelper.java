 ...
 * 
 * Description: Helper class for CIM_ProcessThread
 *    
 * 
 * generated Class
 * @see CIM_ProcessThread
 */
...
public class CIM_ProcessThreadHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProcessThread or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProcessThread.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ProcessThread.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProcessThread or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ProcessThread.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProcessThread(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProcessThreadHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProcessThread.");
                        resultArrayList.add(new CIM_ProcessThread(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProcessThread.");
                        resultArrayList.add(new CIM_ProcessThread(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProcessThread.");
                        resultArrayList.add(new CIM_ProcessThread(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProcessThread getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ProcessThread getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProcessThread) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProcessThread(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProcessThread getInstance(WBEMClient client, String namespace,
            CIM_Process GroupComponent, CIM_Thread PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProcessThread.PROPERTY_GROUPCOMPONENT_CIM_PROCESS.NAME, new CIMDataType(
                        CIM_Process.CIM_CLASS_NAME), setThis, false, false,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProcessThread.PROPERTY_PARTCOMPONENT_CIM_THREAD.NAME, new CIMDataType(
                        CIM_Thread.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProcessThread.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProcessThread createInstance(WBEMClient client,
            CIM_ProcessThread dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProcessThread newDataInstance = CIM_ProcessThreadHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProcessThread modifyInstance(WBEMClient client,
            CIM_ProcessThread dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProcessThread dataInstance2 = CIM_ProcessThreadHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProcessThread dataInstance)
            throws WbemsmtException {
