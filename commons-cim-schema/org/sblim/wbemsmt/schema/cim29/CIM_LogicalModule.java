...
public class CIM_LogicalModule extends CIM_LogicalDevice {
    ...
    /**
     * Constants of property ModuleNumber
     ...
     */
    public static class PROPERTY_MODULENUMBER {
        /**
         * name of the property ModuleNumber
         */
        public final static String NAME = "ModuleNumber";
     ...
     * 
     *       *   <br>
     *   LogicalModule is the logical device corresponding to a line card/blade in a device. For example, a line card in a switch is an instance of LogicalModule, associated with the the switch itself. A logical module is not necessarily independently managed.
     *   @param client the CIM Client
     *   @param namespace the target namespace
     */

    public CIM_LogicalModule(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_LogicalModule(CIMInstance cimInstance) throws WbemsmtException {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("ModuleNumber", new CIMProperty("ModuleNumber", CIMDataType.UINT16_T,
                null));
    ...
    /**
     * Get the property ModuleNumber
     *     * <br>
     * Logical modules are often named by the physical or logical slot that they occupy within the containing device. ModuleNumber is the number assigned to the module by its parent.
     *     */

    public javax.cim.UnsignedInteger16 get_ModuleNumber() {
        CIMProperty currentProperty = getProperty(PROPERTY_MODULENUMBER.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_MODULENUMBER.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public boolean set_ModuleNumber(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_MODULENUMBER.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_ModuleNumber(currentProperty, newValue);
    ...
    /**
     * Get the property ModuleNumber by getting the class from the server<br>
    ...
    public static CIMProperty create_ModuleNumber(WBEMClient client, String namespace,
            javax.cim.UnsignedInteger16 newValue) throws WbemsmtException {
        CIM_LogicalModule fco = new CIM_LogicalModule(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_MODULENUMBER.NAME);
        if (property != null) {
            property = setPropertyValue_ModuleNumber(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_MODULENUMBER.NAME + " was not found in instance "
    ...
    private static CIMProperty setPropertyValue_ModuleNumber(CIMProperty currentProperty,
    ...
    /**
     * Get the list with CIM_NetworkPort objects associated by the association CIM_ModulePort
     * 
    ...
    public java.util.List getAssociated_CIM_NetworkPort_CIM_ModulePorts(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_NetworkPort_CIM_ModulePorts(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_MODULEPORT, CIM_NetworkPort.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_NetworkPort_CIM_ModulePorts(WBEMClient cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_LogicalModuleHelper.checkException(enumeration);
    ...
    public java.util.List getAssociated_CIM_NetworkPort_CIM_ModulePortNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_NetworkPort_CIM_ModulePortNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_MODULEPORT, CIM_NetworkPort.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public String getObjectName() {
        return CIM_LogicalModule.CIM_CLASS_NAME;
    }
