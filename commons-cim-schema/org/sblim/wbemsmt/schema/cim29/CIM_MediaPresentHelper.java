 ...
 * 
 * Description: Helper class for CIM_MediaPresent
 *    
 * 
 * generated Class
 * @see CIM_MediaPresent
 */
...
public class CIM_MediaPresentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MediaPresent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MediaPresent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_MediaPresent.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MediaPresent or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_MediaPresent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MediaPresent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MediaPresentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MediaPresent.");
                        resultArrayList.add(new CIM_MediaPresent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MediaPresent.");
                        resultArrayList.add(new CIM_MediaPresent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MediaPresent.");
                        resultArrayList.add(new CIM_MediaPresent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MediaPresent getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_MediaPresent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MediaPresent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MediaPresent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_MediaPresent getInstance(WBEMClient client, String namespace,
            CIM_MediaAccessDevice Antecedent, CIM_StorageExtent Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_MediaPresent.PROPERTY_ANTECEDENT_CIM_MEDIAACCESSDEVICE.NAME, new CIMDataType(
                        CIM_MediaAccessDevice.CIM_CLASS_NAME), setThis, false, false,
                CIM_MediaPresent.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_MediaPresent.PROPERTY_DEPENDENT_CIM_STORAGEEXTENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_MediaPresent createInstance(WBEMClient client,
            CIM_MediaPresent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_MediaPresent newDataInstance = CIM_MediaPresentHelper
     ...
     */
    public final static CIM_MediaPresent modifyInstance(WBEMClient client,
            CIM_MediaPresent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MediaPresent dataInstance2 = CIM_MediaPresentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_MediaPresent dataInstance)
            throws WbemsmtException {
