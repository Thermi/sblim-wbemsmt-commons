 ...
 * 
 * Description: Helper class for CIM_PhysicalComponent
 *    
 * 
 * generated Class
 * @see CIM_PhysicalComponent
 */
...
public class CIM_PhysicalComponentHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PhysicalComponent or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PhysicalComponent.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PhysicalComponent.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PhysicalComponent or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PhysicalComponent(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PhysicalComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PhysicalComponent.");
                        resultArrayList.add(new CIM_PhysicalComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PhysicalComponent.");
                        resultArrayList.add(new CIM_PhysicalComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PhysicalComponent.");
                        resultArrayList.add(new CIM_PhysicalComponent(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PhysicalComponent getInstance(WBEMClient client,
     ...
     */
    public final static CIM_PhysicalComponent getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PhysicalComponent) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PhysicalComponent(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PhysicalComponent getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_PhysicalComponent.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_PhysicalComponent.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[1] = new CIMProperty(CIM_PhysicalComponent.PROPERTY_TAG.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_PhysicalComponent.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PhysicalComponent createInstance(WBEMClient client,
            CIM_PhysicalComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_PhysicalComponent newDataInstance = CIM_PhysicalComponentHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_PhysicalComponent modifyInstance(WBEMClient client,
            CIM_PhysicalComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PhysicalComponent dataInstance2 = CIM_PhysicalComponentHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PhysicalComponent dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PhysicalComponent.getPackages());
    }
