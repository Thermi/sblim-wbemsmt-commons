 ...
 * 
 * Description: Helper class for CIM_JobSettingData
 *    
 * 
 * generated Class
 * @see CIM_JobSettingData
 */
...
public class CIM_JobSettingDataHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_JobSettingData or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_JobSettingData.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_JobSettingData.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_JobSettingData or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_JobSettingData.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_JobSettingData(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_JobSettingDataHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_JobSettingData.");
                        resultArrayList.add(new CIM_JobSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_JobSettingData.");
                        resultArrayList.add(new CIM_JobSettingData(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_JobSettingData.");
                        resultArrayList.add(new CIM_JobSettingData(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_JobSettingData getInstance(WBEMClient client,
     ...
     */
    public final static CIM_JobSettingData getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_JobSettingData) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_JobSettingData(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_JobSettingData getInstance(WBEMClient client, String namespace,
            String InstanceID
        ...
        keyProperties[0] = new CIMProperty(CIM_JobSettingData.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_JobSettingData.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_JobSettingData createInstance(WBEMClient client,
            CIM_JobSettingData dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_JobSettingData newDataInstance = CIM_JobSettingDataHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_JobSettingData modifyInstance(WBEMClient client,
            CIM_JobSettingData dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_JobSettingData dataInstance2 = CIM_JobSettingDataHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_JobSettingData dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_JobSettingData.getPackages());
    }
