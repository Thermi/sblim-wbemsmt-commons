...
public class CIM_RealizesDiskPartition extends CIM_RealizesExtent {
    ...
    public CIM_RealizesDiskPartition(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_RealizesDiskPartition(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_RealizesDiskPartition() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_PhysicalMedia(WBEMClient client,
        ...
        CIM_RealizesDiskPartition fco = new CIM_RealizesDiskPartition(client, namespace);
    ...
    public String getObjectName() {
        return CIM_RealizesDiskPartition.CIM_CLASS_NAME;
    }
