...
public class CIM_LogicalIdentityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalIdentity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_LogicalIdentity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_LogicalIdentity.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_LogicalIdentity.");
                        resultArrayList.add(new CIM_LogicalIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LogicalIdentity.");
                        resultArrayList.add(new CIM_LogicalIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LogicalIdentity.");
                        resultArrayList.add(new CIM_LogicalIdentity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LogicalIdentity getInstance(WBEMClient client,
     ...
     */
    public final static CIM_LogicalIdentity getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_LogicalIdentity getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_LogicalIdentity.PROPERTY_SYSTEMELEMENT_CIM_MANAGEDELEMENT.NAME,
                new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_LogicalIdentity.CIM_CLASS_NAME);

        setThis = SameElement != null ? SameElement.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_LogicalIdentity.PROPERTY_SAMEELEMENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
     ...
     */
    public final static void deleteInstance(WBEMClient client, CIM_LogicalIdentity dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_LogicalIdentity.getPackages());
    }
