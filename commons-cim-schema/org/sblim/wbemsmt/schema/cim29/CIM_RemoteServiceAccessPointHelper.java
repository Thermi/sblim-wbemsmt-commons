 ...
 * 
 * Description: Helper class for CIM_RemoteServiceAccessPoint
 *    
 * 
 * generated Class
 * @see CIM_RemoteServiceAccessPoint
 */
...
public class CIM_RemoteServiceAccessPointHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RemoteServiceAccessPoint or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RemoteServiceAccessPoint.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RemoteServiceAccessPoint.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RemoteServiceAccessPoint or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_RemoteServiceAccessPoint(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RemoteServiceAccessPointHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RemoteServiceAccessPoint.");
                        resultArrayList.add(new CIM_RemoteServiceAccessPoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RemoteServiceAccessPoint.");
                        resultArrayList.add(new CIM_RemoteServiceAccessPoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RemoteServiceAccessPoint.");
                        resultArrayList.add(new CIM_RemoteServiceAccessPoint(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RemoteServiceAccessPoint getInstance(WBEMClient client,
    ...
    public final static CIM_RemoteServiceAccessPoint getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RemoteServiceAccessPoint) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RemoteServiceAccessPoint(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_RemoteServiceAccessPoint getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RemoteServiceAccessPoint.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_RemoteServiceAccessPoint.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_RemoteServiceAccessPoint.PROPERTY_NAME.NAME,
        ...
        keyProperties[2] = new CIMProperty(
                CIM_RemoteServiceAccessPoint.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_RemoteServiceAccessPoint.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_RemoteServiceAccessPoint.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_RemoteServiceAccessPoint.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_RemoteServiceAccessPoint createInstance(WBEMClient client,
            CIM_RemoteServiceAccessPoint dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_RemoteServiceAccessPoint newDataInstance = CIM_RemoteServiceAccessPointHelper
     ...
     */
    public final static CIM_RemoteServiceAccessPoint modifyInstance(WBEMClient client,
            CIM_RemoteServiceAccessPoint dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RemoteServiceAccessPoint dataInstance2 = CIM_RemoteServiceAccessPointHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_RemoteServiceAccessPoint dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RemoteServiceAccessPoint.getPackages());
    }
