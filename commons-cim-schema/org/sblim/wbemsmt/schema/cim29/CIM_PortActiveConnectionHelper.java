 ...
 * 
 * Description: Helper class for CIM_PortActiveConnection
 *    
 * 
 * generated Class
 * @see CIM_PortActiveConnection
 */
...
public class CIM_PortActiveConnectionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PortActiveConnection or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PortActiveConnection.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PortActiveConnection.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PortActiveConnection or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_PortActiveConnection(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PortActiveConnectionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PortActiveConnection.");
                        resultArrayList.add(new CIM_PortActiveConnection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PortActiveConnection.");
                        resultArrayList.add(new CIM_PortActiveConnection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PortActiveConnection.");
                        resultArrayList.add(new CIM_PortActiveConnection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PortActiveConnection getInstance(WBEMClient client,
    ...
    public final static CIM_PortActiveConnection getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PortActiveConnection) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PortActiveConnection(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_PortActiveConnection getInstance(WBEMClient client, String namespace,
            CIM_PhysicalConnector Antecedent, CIM_NetworkPort Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PortActiveConnection.PROPERTY_ANTECEDENT_CIM_PHYSICALCONNECTOR.NAME,
                new CIMDataType(CIM_PhysicalConnector.CIM_CLASS_NAME), setThis, false, false,
                CIM_PortActiveConnection.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_PortActiveConnection.PROPERTY_DEPENDENT_CIM_NETWORKPORT.NAME, new CIMDataType(
                        CIM_NetworkPort.CIM_CLASS_NAME), setThis, false, false,
                CIM_PortActiveConnection.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PortActiveConnection createInstance(WBEMClient client,
            CIM_PortActiveConnection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PortActiveConnection newDataInstance = CIM_PortActiveConnectionHelper.getInstance(
     ...
     */
    public final static CIM_PortActiveConnection modifyInstance(WBEMClient client,
            CIM_PortActiveConnection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PortActiveConnection dataInstance2 = CIM_PortActiveConnectionHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_PortActiveConnection dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PortActiveConnection.getPackages());
    }
