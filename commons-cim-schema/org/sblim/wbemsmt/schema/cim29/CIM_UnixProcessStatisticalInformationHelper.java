 ...
 * 
 * Description: Helper class for CIM_UnixProcessStatisticalInformation
 *    
 * 
 * generated Class
 * @see CIM_UnixProcessStatisticalInformation
 */
...
public class CIM_UnixProcessStatisticalInformationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_UnixProcessStatisticalInformation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_UnixProcessStatisticalInformation or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_UnixProcessStatisticalInformation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_UnixProcessStatisticalInformationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_UnixProcessStatisticalInformation.");
                        resultArrayList.add(new CIM_UnixProcessStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_UnixProcessStatisticalInformation.");
                        resultArrayList.add(new CIM_UnixProcessStatisticalInformation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_UnixProcessStatisticalInformation.");
                        resultArrayList.add(new CIM_UnixProcessStatisticalInformation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_UnixProcessStatisticalInformation getInstance(WBEMClient client,
    ...
    public final static CIM_UnixProcessStatisticalInformation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_UnixProcessStatisticalInformationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_UnixProcessStatisticalInformation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_UnixProcessStatisticalInformation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_UnixProcessStatisticalInformation getInstance(WBEMClient client,
            String namespace, String CSCreationClassName, String CSName, String Handle,
            String Name, String OSCreationClassName, String OSName, String ProcessCreationClassName
        ...
        CIMProperty[] keyProperties = new CIMProperty[7];
        ...
        keyProperties[0] = new CIMProperty(
                CIM_UnixProcessStatisticalInformation.PROPERTY_CSCREATIONCLASSNAME.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_UnixProcessStatisticalInformation.PROPERTY_CSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME);

        setThis = Handle;

        keyProperties[2] = new CIMProperty(
                CIM_UnixProcessStatisticalInformation.PROPERTY_HANDLE.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(
                CIM_UnixProcessStatisticalInformation.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME);

        setThis = OSCreationClassName;

        keyProperties[4] = new CIMProperty(
                CIM_UnixProcessStatisticalInformation.PROPERTY_OSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME);
        ...
        keyProperties[5] = new CIMProperty(
                CIM_UnixProcessStatisticalInformation.PROPERTY_OSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME);

        setThis = ProcessCreationClassName;

        keyProperties[6] = new CIMProperty(
                CIM_UnixProcessStatisticalInformation.PROPERTY_PROCESSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_UnixProcessStatisticalInformation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_UnixProcessStatisticalInformation createInstance(WBEMClient client,
            CIM_UnixProcessStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_UnixProcessStatisticalInformation newDataInstance = CIM_UnixProcessStatisticalInformationHelper
     ...
     */
    public final static CIM_UnixProcessStatisticalInformation modifyInstance(WBEMClient client,
            CIM_UnixProcessStatisticalInformation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_UnixProcessStatisticalInformation dataInstance2 = CIM_UnixProcessStatisticalInformationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_UnixProcessStatisticalInformation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_UnixProcessStatisticalInformation.getPackages());
    }
