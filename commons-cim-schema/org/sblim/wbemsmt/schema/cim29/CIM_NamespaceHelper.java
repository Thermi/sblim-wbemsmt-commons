...
public class CIM_NamespaceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Namespace.CIM_CLASS_NAME,
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Namespace.");
                        resultArrayList.add(new CIM_Namespace(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Namespace.");
                        resultArrayList.add(new CIM_Namespace(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Namespace.");
                        resultArrayList.add(new CIM_Namespace(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Namespace getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Namespace getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_Namespace getInstance(WBEMClient client, String namespace,
            String CreationClassName, String Name, String ObjectManagerCreationClassName,
            String ObjectManagerName, String SystemCreationClassName, String SystemName
        ...
        keyProperties[0] = new CIMProperty(CIM_Namespace.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Namespace.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_Namespace.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Namespace.CIM_CLASS_NAME);

        setThis = ObjectManagerCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_Namespace.PROPERTY_OBJECTMANAGERCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Namespace.CIM_CLASS_NAME);

        setThis = ObjectManagerName;

        keyProperties[3] = new CIMProperty(CIM_Namespace.PROPERTY_OBJECTMANAGERNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Namespace.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[4] = new CIMProperty(CIM_Namespace.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Namespace.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[5] = new CIMProperty(CIM_Namespace.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Namespace.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Namespace createInstance(WBEMClient client, CIM_Namespace dataInstance,
     ...
     */
    public final static CIM_Namespace modifyInstance(WBEMClient client, CIM_Namespace dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Namespace dataInstance2 = CIM_NamespaceHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Namespace dataInstance)
            throws WbemsmtException {
