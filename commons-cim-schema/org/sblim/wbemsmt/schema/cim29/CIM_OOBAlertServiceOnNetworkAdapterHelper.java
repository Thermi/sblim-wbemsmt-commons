 ...
 * 
 * Description: Helper class for CIM_OOBAlertServiceOnNetworkAdapter
 *    
 * 
 * generated Class
 * @see CIM_OOBAlertServiceOnNetworkAdapter
 */
...
public class CIM_OOBAlertServiceOnNetworkAdapterHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_OOBAlertServiceOnNetworkAdapter or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_OOBAlertServiceOnNetworkAdapter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_OOBAlertServiceOnNetworkAdapter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_OOBAlertServiceOnNetworkAdapter or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkAdapter(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_OOBAlertServiceOnNetworkAdapterHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_OOBAlertServiceOnNetworkAdapter.");
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_OOBAlertServiceOnNetworkAdapter.");
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_OOBAlertServiceOnNetworkAdapter.");
                        resultArrayList.add(new CIM_OOBAlertServiceOnNetworkAdapter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_OOBAlertServiceOnNetworkAdapter getInstance(WBEMClient client,
    ...
    public final static CIM_OOBAlertServiceOnNetworkAdapter getInstance(WBEMClient client,
        ...
        Class clazz = CIM_OOBAlertServiceOnNetworkAdapterHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_OOBAlertServiceOnNetworkAdapter) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_OOBAlertServiceOnNetworkAdapter(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_OOBAlertServiceOnNetworkAdapter getInstance(WBEMClient client,
            String namespace, CIM_NetworkAdapter Antecedent, CIM_OOBAlertService Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_OOBAlertServiceOnNetworkAdapter.PROPERTY_ANTECEDENT_CIM_NETWORKADAPTER.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_OOBAlertServiceOnNetworkAdapter.PROPERTY_DEPENDENT_CIM_OOBALERTSERVICE.NAME,
                new CIMDataType(CIM_OOBAlertService.CIM_CLASS_NAME), setThis, false, false,
                CIM_OOBAlertServiceOnNetworkAdapter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_OOBAlertServiceOnNetworkAdapter createInstance(WBEMClient client,
            CIM_OOBAlertServiceOnNetworkAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_OOBAlertServiceOnNetworkAdapter newDataInstance = CIM_OOBAlertServiceOnNetworkAdapterHelper
     ...
     */
    public final static CIM_OOBAlertServiceOnNetworkAdapter modifyInstance(WBEMClient client,
            CIM_OOBAlertServiceOnNetworkAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_OOBAlertServiceOnNetworkAdapter dataInstance2 = CIM_OOBAlertServiceOnNetworkAdapterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_OOBAlertServiceOnNetworkAdapter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_OOBAlertServiceOnNetworkAdapter.getPackages());
    }
