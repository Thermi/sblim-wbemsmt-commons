...
public final class CIM_OOBAlertServiceOnNetworkAdapterHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					Class clazz = CIM_OOBAlertServiceOnNetworkAdapterHelper.findClass(cimClient, cimInstance);
					if (clazz == null) {
	...
	*/	
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_OOBAlertServiceOnNetworkAdapter.getPackages();
