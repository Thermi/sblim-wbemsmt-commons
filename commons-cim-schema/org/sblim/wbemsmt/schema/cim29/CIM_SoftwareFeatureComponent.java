...
public class CIM_SoftwareFeatureComponent extends CIM_Component {
    ...
    public CIM_SoftwareFeatureComponent(WBEMClient client, String namespace)
    ...
    public CIM_SoftwareFeatureComponent(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SoftwareFeatureComponent() {
    }
    ...
    public static CIMProperty create_GroupComponent_CIM_SoftwareFeature(WBEMClient client,
        ...
        CIM_SoftwareFeatureComponent fco = new CIM_SoftwareFeatureComponent(client, namespace);
    ...
    public String getObjectName() {
        return CIM_SoftwareFeatureComponent.CIM_CLASS_NAME;
    }
