 ...
 * 
 * Description: Helper class for CIM_RealizesDiskPartition
 *    
 * 
 * generated Class
 * @see CIM_RealizesDiskPartition
 */
...
public class CIM_RealizesDiskPartitionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RealizesDiskPartition or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RealizesDiskPartition.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RealizesDiskPartition.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RealizesDiskPartition or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_RealizesDiskPartition(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RealizesDiskPartitionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RealizesDiskPartition.");
                        resultArrayList.add(new CIM_RealizesDiskPartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RealizesDiskPartition.");
                        resultArrayList.add(new CIM_RealizesDiskPartition(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RealizesDiskPartition.");
                        resultArrayList.add(new CIM_RealizesDiskPartition(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RealizesDiskPartition getInstance(WBEMClient client,
    ...
    public final static CIM_RealizesDiskPartition getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RealizesDiskPartition) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RealizesDiskPartition(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RealizesDiskPartition getInstance(WBEMClient client, String namespace,
            CIM_PhysicalMedia Antecedent, CIM_DiskPartition Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RealizesDiskPartition.PROPERTY_ANTECEDENT_CIM_PHYSICALMEDIA.NAME,
                new CIMDataType(CIM_PhysicalMedia.CIM_CLASS_NAME), setThis, false, false,
                CIM_RealizesDiskPartition.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_RealizesDiskPartition.PROPERTY_DEPENDENT_CIM_DISKPARTITION.NAME,
     ...
     *
     */
    public final static CIM_RealizesDiskPartition createInstance(WBEMClient client,
            CIM_RealizesDiskPartition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_RealizesDiskPartition newDataInstance = CIM_RealizesDiskPartitionHelper.getInstance(
     ...
     */
    public final static CIM_RealizesDiskPartition modifyInstance(WBEMClient client,
            CIM_RealizesDiskPartition dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RealizesDiskPartition dataInstance2 = CIM_RealizesDiskPartitionHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_RealizesDiskPartition dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RealizesDiskPartition.getPackages());
    }
