 ...
 * 
 * Description: Helper class for CIM_SystemDevice
 *    
 * 
 * generated Class
 * @see CIM_SystemDevice
 */
...
public class CIM_SystemDeviceHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemDevice or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemDevice.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_SystemDevice.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemDevice or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SystemDevice.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemDevice(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemDeviceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemDevice.");
                        resultArrayList.add(new CIM_SystemDevice(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemDevice.");
                        resultArrayList.add(new CIM_SystemDevice(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemDevice.");
                        resultArrayList.add(new CIM_SystemDevice(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemDevice getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_SystemDevice getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemDevice) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemDevice(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemDevice getInstance(WBEMClient client, String namespace,
            CIM_System GroupComponent, CIM_LogicalDevice PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemDevice.PROPERTY_GROUPCOMPONENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SystemDevice.PROPERTY_PARTCOMPONENT_CIM_LOGICALDEVICE.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_SystemDevice createInstance(WBEMClient client,
            CIM_SystemDevice dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemDevice newDataInstance = CIM_SystemDeviceHelper
     ...
     */
    public final static CIM_SystemDevice modifyInstance(WBEMClient client,
            CIM_SystemDevice dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemDevice dataInstance2 = CIM_SystemDeviceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemDevice dataInstance)
            throws WbemsmtException {
