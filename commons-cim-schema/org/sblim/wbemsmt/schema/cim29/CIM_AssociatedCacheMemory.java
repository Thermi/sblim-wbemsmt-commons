...
public class CIM_AssociatedCacheMemory extends CIM_AssociatedMemory  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AssociatedCacheMemory"; //$NON-NLS-1$
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_AssociatedCacheMemory.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_AssociatedCacheMemory.Java_Package_List.toArray(new String[CIM_AssociatedCacheMemory.Java_Package_List.size()]);
    }
