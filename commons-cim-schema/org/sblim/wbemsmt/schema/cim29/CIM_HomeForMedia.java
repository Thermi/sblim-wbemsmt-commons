...
public class CIM_HomeForMedia extends CIM_Dependency {
    ...
    public CIM_HomeForMedia(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HomeForMedia(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_Antecedent_CIM_StorageMediaLocation(WBEMClient client,
        ...
        CIM_HomeForMedia fco = new CIM_HomeForMedia(client, namespace);
    ...
    public String getObjectName() {
        return CIM_HomeForMedia.CIM_CLASS_NAME;
    }
