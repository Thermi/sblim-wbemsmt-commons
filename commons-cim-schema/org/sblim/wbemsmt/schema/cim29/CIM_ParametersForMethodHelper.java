 ...
 * 
 * Description: Helper class for CIM_ParametersForMethod
 *    
 * 
 * generated Class
 * @see CIM_ParametersForMethod
 */
...
public class CIM_ParametersForMethodHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ParametersForMethod or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ParametersForMethod.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ParametersForMethod.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ParametersForMethod or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ParametersForMethod(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ParametersForMethodHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ParametersForMethod.");
                        resultArrayList.add(new CIM_ParametersForMethod(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ParametersForMethod.");
                        resultArrayList.add(new CIM_ParametersForMethod(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ParametersForMethod.");
                        resultArrayList.add(new CIM_ParametersForMethod(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ParametersForMethod getInstance(WBEMClient client,
    ...
    public final static CIM_ParametersForMethod getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ParametersForMethod) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ParametersForMethod(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ParametersForMethod getInstance(WBEMClient client, String namespace,
            String MethodName, CIM_MethodParameters Parameters, CIM_ManagedElement TheMethod
        ...
        keyProperties[0] = new CIMProperty(CIM_ParametersForMethod.PROPERTY_METHODNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ParametersForMethod.CIM_CLASS_NAME);

        setThis = Parameters != null ? Parameters.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ParametersForMethod.PROPERTY_PARAMETERS_CIM_METHODPARAMETERS.NAME,
                new CIMDataType(CIM_MethodParameters.CIM_CLASS_NAME), setThis, false, false,
                CIM_ParametersForMethod.CIM_CLASS_NAME);

        setThis = TheMethod != null ? TheMethod.getCimObjectPath() : null;

        keyProperties[2] = new CIMProperty(
                CIM_ParametersForMethod.PROPERTY_THEMETHOD_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ParametersForMethod createInstance(WBEMClient client,
            CIM_ParametersForMethod dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ParametersForMethod newDataInstance = CIM_ParametersForMethodHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ParametersForMethod modifyInstance(WBEMClient client,
            CIM_ParametersForMethod dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ParametersForMethod dataInstance2 = CIM_ParametersForMethodHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ParametersForMethod dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ParametersForMethod.getPackages());
    }
