 ...
 * 
 * Description: Helper class for CIM_SystemSetting
 *    
 * 
 * generated Class
 * @see CIM_SystemSetting
 */
...
public class CIM_SystemSettingHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemSetting or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemSetting.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_SystemSetting.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemSetting or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_SystemSetting.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemSetting(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemSettingHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemSetting.");
                        resultArrayList.add(new CIM_SystemSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemSetting.");
                        resultArrayList.add(new CIM_SystemSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemSetting.");
                        resultArrayList.add(new CIM_SystemSetting(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemSetting getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_SystemSetting getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {

        CIM_SystemSetting dataInstance = null;
        Class clazz = CIM_SystemSettingHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemSetting) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemSetting(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemSetting getInstance(WBEMClient client, String namespace,
            String CreationClassName, String SettingID, String SystemCreationClassName,
            String SystemName
        ...
        keyProperties[0] = new CIMProperty(CIM_SystemSetting.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemSetting.CIM_CLASS_NAME);

        setThis = SettingID;

        keyProperties[1] = new CIMProperty(CIM_SystemSetting.PROPERTY_SETTINGID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemSetting.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(CIM_SystemSetting.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemSetting.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_SystemSetting.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemSetting.CIM_CLASS_NAME);
     ...
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemSetting dataInstance)
            throws WbemsmtException {
