 ...
 * 
 * Description: Helper class for CIM_ConcreteIdentity
 *    
 * 
 * generated Class
 * @see CIM_ConcreteIdentity
 */
...
public class CIM_ConcreteIdentityHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ConcreteIdentity or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ConcreteIdentity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ConcreteIdentity.CIM_CLASS_NAME
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ConcreteIdentity or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ConcreteIdentity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ConcreteIdentity(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ConcreteIdentityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ConcreteIdentity.");
                        resultArrayList.add(new CIM_ConcreteIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ConcreteIdentity.");
                        resultArrayList.add(new CIM_ConcreteIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ConcreteIdentity.");
                        resultArrayList.add(new CIM_ConcreteIdentity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ConcreteIdentity getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ConcreteIdentity getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ConcreteIdentity) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ConcreteIdentity(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ConcreteIdentity getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement SystemElement, CIM_ManagedElement SameElement
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ConcreteIdentity.PROPERTY_SYSTEMELEMENT_CIM_MANAGEDELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ConcreteIdentity.PROPERTY_SAMEELEMENT_CIM_MANAGEDELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_ConcreteIdentity createInstance(WBEMClient client,
            CIM_ConcreteIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ConcreteIdentity newDataInstance = CIM_ConcreteIdentityHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ConcreteIdentity modifyInstance(WBEMClient client,
            CIM_ConcreteIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ConcreteIdentity dataInstance2 = CIM_ConcreteIdentityHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ConcreteIdentity dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ConcreteIdentity.getPackages());
    }
