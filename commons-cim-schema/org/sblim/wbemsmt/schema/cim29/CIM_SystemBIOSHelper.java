 ...
 * 
 * Description: Helper class for CIM_SystemBIOS
 *    
 * 
 * generated Class
 * @see CIM_SystemBIOS
...
public class CIM_SystemBIOSHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemBIOS or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemBIOS.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_SystemBIOS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemBIOS or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SystemBIOS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SystemBIOS(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemBIOSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_SystemBIOS.");
                        resultArrayList.add(new CIM_SystemBIOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_SystemBIOS.");
                        resultArrayList.add(new CIM_SystemBIOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemBIOS.");
                        resultArrayList.add(new CIM_SystemBIOS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemBIOS getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_SystemBIOS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemBIOS) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemBIOS(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemBIOS getInstance(WBEMClient client, String namespace,
            CIM_ComputerSystem GroupComponent, CIM_BIOSElement PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemBIOS.PROPERTY_GROUPCOMPONENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SystemBIOS.PROPERTY_PARTCOMPONENT_CIM_BIOSELEMENT.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_SystemBIOS createInstance(WBEMClient client,
            CIM_SystemBIOS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SystemBIOS newDataInstance = CIM_SystemBIOSHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_SystemBIOS modifyInstance(WBEMClient client,
            CIM_SystemBIOS dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemBIOS dataInstance2 = CIM_SystemBIOSHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemBIOS dataInstance)
            throws WbemsmtException {
