 ...
 * 
 * Description: Helper class for CIM_AdminDomain
 *    
 * 
 * generated Class
 * @see CIM_AdminDomain
...
public class CIM_AdminDomainHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_AdminDomain or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_AdminDomain.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_AdminDomain.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_AdminDomain or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_AdminDomain.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_AdminDomain(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_AdminDomainHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_AdminDomain.");
                        resultArrayList.add(new CIM_AdminDomain(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_AdminDomain.");
                        resultArrayList.add(new CIM_AdminDomain(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_AdminDomain.");
                        resultArrayList.add(new CIM_AdminDomain(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_AdminDomain getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_AdminDomain getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_AdminDomain) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_AdminDomain(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_AdminDomain getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_AdminDomain.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_AdminDomain.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_AdminDomain.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_AdminDomain.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_AdminDomain createInstance(WBEMClient client,
            CIM_AdminDomain dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_AdminDomain newDataInstance = CIM_AdminDomainHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_AdminDomain modifyInstance(WBEMClient client,
            CIM_AdminDomain dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_AdminDomain dataInstance2 = CIM_AdminDomainHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_AdminDomain dataInstance)
            throws WbemsmtException {
