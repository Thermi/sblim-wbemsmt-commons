 ...
 * 
 * Description: Helper class for CIM_StorageError
 *    
 * 
 * generated Class
 * @see CIM_StorageError
 */
...
public class CIM_StorageErrorHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_StorageError or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_StorageError.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_StorageError.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_StorageError or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_StorageError.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_StorageError(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_StorageErrorHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_StorageError.");
                        resultArrayList.add(new CIM_StorageError(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_StorageError.");
                        resultArrayList.add(new CIM_StorageError(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_StorageError.");
                        resultArrayList.add(new CIM_StorageError(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_StorageError getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_StorageError getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {

        CIM_StorageError dataInstance = null;
        Class clazz = CIM_StorageErrorHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_StorageError) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_StorageError(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_StorageError getInstance(WBEMClient client, String namespace,
            String DeviceCreationClassName, String DeviceID,
            javax.cim.UnsignedInteger64 StartingAddress, String SystemCreationClassName,
            String SystemName
        ...
        keyProperties[0] = new CIMProperty(CIM_StorageError.PROPERTY_DEVICECREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_StorageError.CIM_CLASS_NAME);

        setThis = DeviceID;

        keyProperties[1] = new CIMProperty(CIM_StorageError.PROPERTY_DEVICEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_StorageError.CIM_CLASS_NAME);

        setThis = StartingAddress;

        keyProperties[2] = new CIMProperty(CIM_StorageError.PROPERTY_STARTINGADDRESS.NAME,
                CIMDataType.UINT64_T, setThis, true, false, CIM_StorageError.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[3] = new CIMProperty(CIM_StorageError.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_StorageError.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[4] = new CIMProperty(CIM_StorageError.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_StorageError.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_StorageError createInstance(WBEMClient client,
            CIM_StorageError dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_StorageError newDataInstance = CIM_StorageErrorHelper
     ...
     */
    public final static CIM_StorageError modifyInstance(WBEMClient client,
            CIM_StorageError dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_StorageError dataInstance2 = CIM_StorageErrorHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_StorageError dataInstance)
            throws WbemsmtException {
