 ...
 * 
 * Description: Helper class for CIM_SoftwareFeatureSAPImplementation
 *    
 * 
 * generated Class
 * @see CIM_SoftwareFeatureSAPImplementation
 */
...
public class CIM_SoftwareFeatureSAPImplementationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SoftwareFeatureSAPImplementation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareFeatureSAPImplementation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SoftwareFeatureSAPImplementation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SoftwareFeatureSAPImplementation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SoftwareFeatureSAPImplementation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SoftwareFeatureSAPImplementationHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SoftwareFeatureSAPImplementation.");
                        resultArrayList.add(new CIM_SoftwareFeatureSAPImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SoftwareFeatureSAPImplementation.");
                        resultArrayList.add(new CIM_SoftwareFeatureSAPImplementation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SoftwareFeatureSAPImplementation.");
                        resultArrayList.add(new CIM_SoftwareFeatureSAPImplementation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SoftwareFeatureSAPImplementation getInstance(WBEMClient client,
    ...
    public final static CIM_SoftwareFeatureSAPImplementation getInstance(WBEMClient client,
        ...
        Class clazz = CIM_SoftwareFeatureSAPImplementationHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SoftwareFeatureSAPImplementation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SoftwareFeatureSAPImplementation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SoftwareFeatureSAPImplementation getInstance(WBEMClient client,
            String namespace, CIM_SoftwareFeature Antecedent, CIM_ServiceAccessPoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SoftwareFeatureSAPImplementation.PROPERTY_ANTECEDENT_CIM_SOFTWAREFEATURE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SoftwareFeatureSAPImplementation.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,
                new CIMDataType(CIM_ServiceAccessPoint.CIM_CLASS_NAME), setThis, false, false,
                CIM_SoftwareFeatureSAPImplementation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SoftwareFeatureSAPImplementation createInstance(WBEMClient client,
            CIM_SoftwareFeatureSAPImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SoftwareFeatureSAPImplementation newDataInstance = CIM_SoftwareFeatureSAPImplementationHelper
     ...
     */
    public final static CIM_SoftwareFeatureSAPImplementation modifyInstance(WBEMClient client,
            CIM_SoftwareFeatureSAPImplementation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SoftwareFeatureSAPImplementation dataInstance2 = CIM_SoftwareFeatureSAPImplementationHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SoftwareFeatureSAPImplementation dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SoftwareFeatureSAPImplementation.getPackages());
    }
