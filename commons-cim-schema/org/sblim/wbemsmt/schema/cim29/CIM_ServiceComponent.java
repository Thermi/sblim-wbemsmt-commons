...
public class CIM_ServiceComponent extends CIM_Component {
     ...
     * 
     */
    public static class PROPERTY_GROUPCOMPONENT_CIM_SERVICE {
        /**
    ...
    public CIM_ServiceComponent(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_ServiceComponent(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ServiceComponent() {
    }
    ...
    public CIM_Service get_GroupComponent_CIM_Service(javax.wbem.client.WBEMClient client)
            throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_GROUPCOMPONENT_CIM_SERVICE.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_GROUPCOMPONENT_CIM_SERVICE.NAME
    ...
    public boolean set_GroupComponent_CIM_Service(CIM_Service newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_GROUPCOMPONENT_CIM_SERVICE.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_GroupComponent_CIM_Service(currentProperty, newValue);
    ...
    public static CIMProperty create_GroupComponent_CIM_Service(WBEMClient client,
            String namespace, CIM_Service newValue) throws WbemsmtException {
        CIM_ServiceComponent fco = new CIM_ServiceComponent(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_GROUPCOMPONENT_CIM_SERVICE.NAME);
        if (property != null) {
            property = setPropertyValue_GroupComponent_CIM_Service(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_GROUPCOMPONENT_CIM_SERVICE.NAME
    ...
    private static CIMProperty setPropertyValue_GroupComponent_CIM_Service(
    ...
    public String getObjectName() {
        return CIM_ServiceComponent.CIM_CLASS_NAME;
    }
