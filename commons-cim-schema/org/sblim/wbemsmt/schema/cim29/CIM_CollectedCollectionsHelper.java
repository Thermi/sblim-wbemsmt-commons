 ...
 * 
 * Description: Helper class for CIM_CollectedCollections
 *    
 * 
 * generated Class
 * @see CIM_CollectedCollections
 */
...
public class CIM_CollectedCollectionsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CollectedCollections or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CollectedCollections.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CollectedCollections.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CollectedCollections or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_CollectedCollections.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CollectedCollections(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CollectedCollectionsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CollectedCollections.");
                        resultArrayList.add(new CIM_CollectedCollections(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CollectedCollections.");
                        resultArrayList.add(new CIM_CollectedCollections(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CollectedCollections.");
                        resultArrayList.add(new CIM_CollectedCollections(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CollectedCollections getInstance(WBEMClient client,
    ...
    public final static CIM_CollectedCollections getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CollectedCollections) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CollectedCollections(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CollectedCollections getInstance(WBEMClient client, String namespace,
            CIM_CollectionOfMSEs Collection, CIM_CollectionOfMSEs CollectionInCollection
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CollectedCollections.PROPERTY_COLLECTION_CIM_COLLECTIONOFMSES.NAME,
                new CIMDataType(CIM_CollectionOfMSEs.CIM_CLASS_NAME), setThis, false, false,
                CIM_CollectedCollections.CIM_CLASS_NAME);

        setThis = CollectionInCollection != null ? CollectionInCollection.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_CollectedCollections.PROPERTY_COLLECTIONINCOLLECTION_CIM_COLLECTIONOFMSES.NAME,
                new CIMDataType(CIM_CollectionOfMSEs.CIM_CLASS_NAME), setThis, false, false,
                CIM_CollectedCollections.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CollectedCollections createInstance(WBEMClient client,
            CIM_CollectedCollections dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CollectedCollections newDataInstance = CIM_CollectedCollectionsHelper.getInstance(
     ...
     */
    public final static CIM_CollectedCollections modifyInstance(WBEMClient client,
            CIM_CollectedCollections dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CollectedCollections dataInstance2 = CIM_CollectedCollectionsHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_CollectedCollections dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CollectedCollections.getPackages());
    }
