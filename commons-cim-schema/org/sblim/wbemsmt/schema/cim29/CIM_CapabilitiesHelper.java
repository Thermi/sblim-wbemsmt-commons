...
public final class CIM_CapabilitiesHelper {
	...
	*/	
	public final static CIM_Capabilities getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CapabilitiesHelper.getInstance(cimClient, new CIM_Capabilities(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Capabilities getInstance(CIMClient cimClient, CIM_Capabilities dataInstance) {
		...
		return CIM_CapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Capabilities getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_Capabilities(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_Capabilities.getPackages();
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_Capabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_Capabilities.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_Capabilities.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_Capabilities.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
