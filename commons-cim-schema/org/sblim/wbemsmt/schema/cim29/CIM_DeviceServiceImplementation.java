...
public class CIM_DeviceServiceImplementation extends CIM_Dependency {
    ...
    public CIM_DeviceServiceImplementation(WBEMClient client, String namespace)
    ...
    public CIM_DeviceServiceImplementation(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_DeviceServiceImplementation() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_LogicalDevice(WBEMClient client,
        ...
        CIM_DeviceServiceImplementation fco = new CIM_DeviceServiceImplementation(client, namespace);
    ...
    public String getObjectName() {
        return CIM_DeviceServiceImplementation.CIM_CLASS_NAME;
    }
