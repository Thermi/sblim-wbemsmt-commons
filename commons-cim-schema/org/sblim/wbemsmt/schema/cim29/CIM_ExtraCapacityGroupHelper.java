 ...
 * 
 * Description: Helper class for CIM_ExtraCapacityGroup
 *    
 * 
 * generated Class
 * @see CIM_ExtraCapacityGroup
 */
...
public class CIM_ExtraCapacityGroupHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ExtraCapacityGroup or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ExtraCapacityGroup.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ExtraCapacityGroup.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ExtraCapacityGroup or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ExtraCapacityGroup(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ExtraCapacityGroupHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ExtraCapacityGroup.");
                        resultArrayList.add(new CIM_ExtraCapacityGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ExtraCapacityGroup.");
                        resultArrayList.add(new CIM_ExtraCapacityGroup(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ExtraCapacityGroup.");
                        resultArrayList.add(new CIM_ExtraCapacityGroup(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ExtraCapacityGroup getInstance(WBEMClient client,
    ...
    public final static CIM_ExtraCapacityGroup getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ExtraCapacityGroup) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ExtraCapacityGroup(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ExtraCapacityGroup getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ExtraCapacityGroup.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ExtraCapacityGroup.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_ExtraCapacityGroup.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ExtraCapacityGroup.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ExtraCapacityGroup createInstance(WBEMClient client,
            CIM_ExtraCapacityGroup dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ExtraCapacityGroup newDataInstance = CIM_ExtraCapacityGroupHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ExtraCapacityGroup modifyInstance(WBEMClient client,
            CIM_ExtraCapacityGroup dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ExtraCapacityGroup dataInstance2 = CIM_ExtraCapacityGroupHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ExtraCapacityGroup dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ExtraCapacityGroup.getPackages());
    }
