 ...
 * 
 * Description: Helper class for CIM_PowerManagementCapabilities
 *    
 * 
 * generated Class
 * @see CIM_PowerManagementCapabilities
 */
...
public class CIM_PowerManagementCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_PowerManagementCapabilities or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_PowerManagementCapabilities.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_PowerManagementCapabilities.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_PowerManagementCapabilities or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_PowerManagementCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_PowerManagementCapabilities(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_PowerManagementCapabilitiesHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_PowerManagementCapabilities.");
                        resultArrayList.add(new CIM_PowerManagementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_PowerManagementCapabilities.");
                        resultArrayList.add(new CIM_PowerManagementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_PowerManagementCapabilities.");
                        resultArrayList.add(new CIM_PowerManagementCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_PowerManagementCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_PowerManagementCapabilities getInstance(WBEMClient client,
        ...
        Class clazz = CIM_PowerManagementCapabilitiesHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_PowerManagementCapabilities) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_PowerManagementCapabilities(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_PowerManagementCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_PowerManagementCapabilities.PROPERTY_INSTANCEID.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_PowerManagementCapabilities.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_PowerManagementCapabilities createInstance(WBEMClient client,
            CIM_PowerManagementCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_PowerManagementCapabilities newDataInstance = CIM_PowerManagementCapabilitiesHelper
     ...
     */
    public final static CIM_PowerManagementCapabilities modifyInstance(WBEMClient client,
            CIM_PowerManagementCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_PowerManagementCapabilities dataInstance2 = CIM_PowerManagementCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_PowerManagementCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_PowerManagementCapabilities.getPackages());
    }
