 ...
 * 
 * Description: Helper class for CIM_ProvidesEndpoint
 *    
 * 
 * generated Class
 * @see CIM_ProvidesEndpoint
 */
...
public class CIM_ProvidesEndpointHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProvidesEndpoint or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProvidesEndpoint.CIM_CLASS_NAME,
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProvidesEndpoint or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ProvidesEndpoint.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProvidesEndpoint(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProvidesEndpointHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProvidesEndpoint.");
                        resultArrayList.add(new CIM_ProvidesEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProvidesEndpoint.");
                        resultArrayList.add(new CIM_ProvidesEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProvidesEndpoint.");
                        resultArrayList.add(new CIM_ProvidesEndpoint(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProvidesEndpoint getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ProvidesEndpoint getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProvidesEndpoint) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProvidesEndpoint(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProvidesEndpoint getInstance(WBEMClient client, String namespace,
            CIM_Service Antecedent, CIM_ProtocolEndpoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProvidesEndpoint.PROPERTY_ANTECEDENT_CIM_SERVICE.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProvidesEndpoint.PROPERTY_DEPENDENT_CIM_PROTOCOLENDPOINT.NAME, new CIMDataType(
                        CIM_ProtocolEndpoint.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProvidesEndpoint.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProvidesEndpoint createInstance(WBEMClient client,
            CIM_ProvidesEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProvidesEndpoint newDataInstance = CIM_ProvidesEndpointHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProvidesEndpoint modifyInstance(WBEMClient client,
            CIM_ProvidesEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProvidesEndpoint dataInstance2 = CIM_ProvidesEndpointHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProvidesEndpoint dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProvidesEndpoint.getPackages());
    }
