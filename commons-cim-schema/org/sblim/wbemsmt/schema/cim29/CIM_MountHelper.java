 ...
 * 
 * Description: Helper class for CIM_Mount
 *    
 * 
 * generated Class
 * @see CIM_Mount
...
public class CIM_MountHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_Mount or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Mount.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_Mount.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_Mount or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Mount.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Mount(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MountHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Mount.");
                        resultArrayList.add(new CIM_Mount(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class "
                                ...
                                + " could not be found. Constructing instance of class CIM_Mount.");
                        resultArrayList.add(new CIM_Mount(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Mount.");
                        resultArrayList.add(new CIM_Mount(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Mount getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Mount getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_Mount) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_Mount(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_Mount getInstance(WBEMClient client, String namespace,
            CIM_Directory Antecedent, CIM_FileSystem Dependent
        ...
        keyProperties[0] = new CIMProperty(CIM_Mount.PROPERTY_ANTECEDENT_CIM_DIRECTORY.NAME,
        ...
        keyProperties[1] = new CIMProperty(CIM_Mount.PROPERTY_DEPENDENT_CIM_FILESYSTEM.NAME,
                new CIMDataType(CIM_FileSystem.CIM_CLASS_NAME), setThis, false, false,
                CIM_Mount.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Mount createInstance(WBEMClient client, CIM_Mount dataInstance,
        ...
        CIM_Mount newDataInstance = CIM_MountHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_Mount modifyInstance(WBEMClient client, CIM_Mount dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Mount dataInstance2 = CIM_MountHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Mount dataInstance)
            throws WbemsmtException {
