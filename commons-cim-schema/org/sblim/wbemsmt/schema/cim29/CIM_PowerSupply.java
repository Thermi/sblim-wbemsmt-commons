...
public class CIM_PowerSupply extends CIM_LogicalDevice  {
	...
	*/
	...
	/**
	*	The frequency (in Hertz) at the high end of this Power Supply's Input Frequency Range 1. A value of zero implies DC.
	*/
	public final static String CIM_PROPERTY_RANGE1INPUTFREQUENCYHIGH = "Range1InputFrequencyHigh"; //$NON-NLS-1$
	/**
	*	The frequency (in Hertz) at the low end of this Power Supply's Input Frequency Range 1. A value of zero implies DC.
	*/
	...
	*/
	...
	/**
	*	The frequency (in Hertz) at the high end of this Power Supply's Input Frequency Range 2. A value of zero implies DC.
	*/
	public final static String CIM_PROPERTY_RANGE2INPUTFREQUENCYHIGH = "Range2InputFrequencyHigh"; //$NON-NLS-1$
	/**
	*	The frequency (in Hertz) at the low end of this Power Supply's Input Frequency Range 2. A value of zero implies DC.
	*/
