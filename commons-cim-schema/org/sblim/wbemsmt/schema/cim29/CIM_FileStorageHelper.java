 ...
 * 
 * Description: Helper class for CIM_FileStorage
 *    
 * 
 * generated Class
 * @see CIM_FileStorage
...
public class CIM_FileStorageHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FileStorage or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FileStorage.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_FileStorage.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FileStorage or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_FileStorage.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FileStorage(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FileStorageHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_FileStorage.");
                        resultArrayList.add(new CIM_FileStorage(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_FileStorage.");
                        resultArrayList.add(new CIM_FileStorage(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FileStorage.");
                        resultArrayList.add(new CIM_FileStorage(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FileStorage getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_FileStorage getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FileStorage) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FileStorage(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FileStorage getInstance(WBEMClient client, String namespace,
            CIM_FileSystem GroupComponent, CIM_LogicalFile PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_FileStorage.PROPERTY_GROUPCOMPONENT_CIM_FILESYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_FileStorage.PROPERTY_PARTCOMPONENT_CIM_LOGICALFILE.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_FileStorage createInstance(WBEMClient client,
            CIM_FileStorage dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_FileStorage newDataInstance = CIM_FileStorageHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_FileStorage modifyInstance(WBEMClient client,
            CIM_FileStorage dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FileStorage dataInstance2 = CIM_FileStorageHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FileStorage dataInstance)
            throws WbemsmtException {
