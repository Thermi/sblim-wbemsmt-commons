 ...
 * 
 * Description: Helper class for CIM_NetworkPortStatistics
 *    
 * 
 * generated Class
 * @see CIM_NetworkPortStatistics
 */
...
public class CIM_NetworkPortStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_NetworkPortStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_NetworkPortStatistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_NetworkPortStatistics.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_NetworkPortStatistics or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_NetworkPortStatistics.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_NetworkPortStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_NetworkPortStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_NetworkPortStatistics.");
                        resultArrayList.add(new CIM_NetworkPortStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_NetworkPortStatistics.");
                        resultArrayList.add(new CIM_NetworkPortStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_NetworkPortStatistics.");
                        resultArrayList.add(new CIM_NetworkPortStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_NetworkPortStatistics getInstance(WBEMClient client,
    ...
    public final static CIM_NetworkPortStatistics getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_NetworkPortStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_NetworkPortStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_NetworkPortStatistics getInstance(WBEMClient client, String namespace,
            String InstanceID
        ...
        keyProperties[0] = new CIMProperty(CIM_NetworkPortStatistics.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_NetworkPortStatistics createInstance(WBEMClient client,
            CIM_NetworkPortStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_NetworkPortStatistics newDataInstance = CIM_NetworkPortStatisticsHelper.getInstance(
     ...
     */
    public final static CIM_NetworkPortStatistics modifyInstance(WBEMClient client,
            CIM_NetworkPortStatistics dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_NetworkPortStatistics dataInstance2 = CIM_NetworkPortStatisticsHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_NetworkPortStatistics dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_NetworkPortStatistics.getPackages());
    }
