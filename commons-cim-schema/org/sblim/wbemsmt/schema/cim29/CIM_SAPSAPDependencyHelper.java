 ...
 * 
 * Description: Helper class for CIM_SAPSAPDependency
 *    
 * 
 * generated Class
 * @see CIM_SAPSAPDependency
 */
...
public class CIM_SAPSAPDependencyHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SAPSAPDependency or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SAPSAPDependency.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SAPSAPDependency.CIM_CLASS_NAME
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SAPSAPDependency or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_SAPSAPDependency.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SAPSAPDependency(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SAPSAPDependencyHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SAPSAPDependency.");
                        resultArrayList.add(new CIM_SAPSAPDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SAPSAPDependency.");
                        resultArrayList.add(new CIM_SAPSAPDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SAPSAPDependency.");
                        resultArrayList.add(new CIM_SAPSAPDependency(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SAPSAPDependency getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SAPSAPDependency getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SAPSAPDependency) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SAPSAPDependency(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SAPSAPDependency getInstance(WBEMClient client, String namespace,
            CIM_ServiceAccessPoint Antecedent, CIM_ServiceAccessPoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SAPSAPDependency.PROPERTY_ANTECEDENT_CIM_SERVICEACCESSPOINT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_SAPSAPDependency.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,
                new CIMDataType(CIM_ServiceAccessPoint.CIM_CLASS_NAME), setThis, false, false,
                CIM_SAPSAPDependency.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SAPSAPDependency createInstance(WBEMClient client,
            CIM_SAPSAPDependency dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SAPSAPDependency newDataInstance = CIM_SAPSAPDependencyHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SAPSAPDependency modifyInstance(WBEMClient client,
            CIM_SAPSAPDependency dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SAPSAPDependency dataInstance2 = CIM_SAPSAPDependencyHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SAPSAPDependency dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SAPSAPDependency.getPackages());
    }
