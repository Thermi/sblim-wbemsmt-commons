...
public class CIM_HostedServiceHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedService.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_HostedService.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_HostedService.");
                        resultArrayList.add(new CIM_HostedService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedService.");
                        resultArrayList.add(new CIM_HostedService(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedService.");
                        resultArrayList.add(new CIM_HostedService(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedService getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_HostedService getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_HostedService getInstance(WBEMClient client, String namespace,
            CIM_System Antecedent, CIM_Service Dependent
        ...
        keyProperties[0] = new CIMProperty(CIM_HostedService.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME,
        ...
        keyProperties[1] = new CIMProperty(CIM_HostedService.PROPERTY_DEPENDENT_CIM_SERVICE.NAME,
     ...
     *
     */
    public final static CIM_HostedService createInstance(WBEMClient client,
            CIM_HostedService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedService newDataInstance = CIM_HostedServiceHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedService modifyInstance(WBEMClient client,
            CIM_HostedService dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedService dataInstance2 = CIM_HostedServiceHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedService dataInstance)
            throws WbemsmtException {
