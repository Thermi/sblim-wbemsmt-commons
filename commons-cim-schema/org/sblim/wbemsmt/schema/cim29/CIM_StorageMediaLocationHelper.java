/** 
 * CIM_StorageMediaLocationHelper.java
 *
...
public final class CIM_StorageMediaLocationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StorageMediaLocation.");
						resultArrayList.add(new CIM_StorageMediaLocation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StorageMediaLocation.");
						resultArrayList.add(new CIM_StorageMediaLocation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StorageMediaLocation.");
						resultArrayList.add(new CIM_StorageMediaLocation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StorageMediaLocation getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StorageMediaLocationHelper.getInstance(cimClient, new CIM_StorageMediaLocation(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageMediaLocation getInstance(CIMClient cimClient, CIM_StorageMediaLocation dataInstance) {
		...
		return CIM_StorageMediaLocationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageMediaLocation getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StorageMediaLocation dataInstance = null;
		try {
			dataInstance = new CIM_StorageMediaLocation(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_StorageMediaLocation.getPackages();
	...
	*/	
	public final static CIM_StorageMediaLocation createInstance(CIMClient cimClient, CIM_StorageMediaLocation dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StorageMediaLocation newDataInstance = null;
		try {
			newDataInstance = CIM_StorageMediaLocationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StorageMediaLocation modifyInstance(CIMClient cimClient, CIM_StorageMediaLocation dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StorageMediaLocationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StorageMediaLocation dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StorageMediaLocation dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StorageMediaLocation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StorageMediaLocation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StorageMediaLocation.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StorageMediaLocation.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StorageMediaLocation.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_LocationType(UnsignedInt16 LocationType) {
		return true;
	}

	public static boolean isValid_MediaCapacity(UnsignedInt32 MediaCapacity) {
		return true;
	}

	public static boolean isValid_MediaSizesSupported(Float[] MediaSizesSupported) {
		return true;
	}

	public static boolean isValid_MediaTypesSupported(UnsignedInt16[] MediaTypesSupported) {
		return true;
	}
