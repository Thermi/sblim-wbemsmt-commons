 ...
 * 
 * Description: Helper class for CIM_StorageMediaLocation
 *    
 * 
 * generated Class
 * @see CIM_StorageMediaLocation
 */
...
public class CIM_StorageMediaLocationHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_StorageMediaLocation or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_StorageMediaLocation.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_StorageMediaLocation.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_StorageMediaLocation or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_StorageMediaLocation(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_StorageMediaLocationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_StorageMediaLocation.");
                        resultArrayList.add(new CIM_StorageMediaLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_StorageMediaLocation.");
                        resultArrayList.add(new CIM_StorageMediaLocation(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_StorageMediaLocation.");
                        resultArrayList.add(new CIM_StorageMediaLocation(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_StorageMediaLocation getInstance(WBEMClient client,
    ...
    public final static CIM_StorageMediaLocation getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_StorageMediaLocation) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_StorageMediaLocation(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_StorageMediaLocation getInstance(WBEMClient client, String namespace,
            String CreationClassName, String Tag
        ...
        keyProperties[0] = new CIMProperty(
                CIM_StorageMediaLocation.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_StorageMediaLocation.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[1] = new CIMProperty(CIM_StorageMediaLocation.PROPERTY_TAG.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_StorageMediaLocation.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_StorageMediaLocation createInstance(WBEMClient client,
            CIM_StorageMediaLocation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_StorageMediaLocation newDataInstance = CIM_StorageMediaLocationHelper.getInstance(
     ...
     */
    public final static CIM_StorageMediaLocation modifyInstance(WBEMClient client,
            CIM_StorageMediaLocation dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_StorageMediaLocation dataInstance2 = CIM_StorageMediaLocationHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_StorageMediaLocation dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_StorageMediaLocation.getPackages());
    }
