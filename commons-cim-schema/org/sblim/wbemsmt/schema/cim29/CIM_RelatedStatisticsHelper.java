 ...
 * 
 * Description: Helper class for CIM_RelatedStatistics
 *    
 * 
 * generated Class
 * @see CIM_RelatedStatistics
 */
...
public class CIM_RelatedStatisticsHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_RelatedStatistics or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RelatedStatistics.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RelatedStatistics.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_RelatedStatistics or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_RelatedStatistics.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RelatedStatistics(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_RelatedStatisticsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_RelatedStatistics.");
                        resultArrayList.add(new CIM_RelatedStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RelatedStatistics.");
                        resultArrayList.add(new CIM_RelatedStatistics(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RelatedStatistics.");
                        resultArrayList.add(new CIM_RelatedStatistics(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RelatedStatistics getInstance(WBEMClient client,
     ...
     */
    public final static CIM_RelatedStatistics getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_RelatedStatistics) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_RelatedStatistics(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_RelatedStatistics getInstance(WBEMClient client, String namespace,
            CIM_StatisticalInformation Stats, CIM_StatisticalInformation RelatedStats
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RelatedStatistics.PROPERTY_STATS_CIM_STATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_StatisticalInformation.CIM_CLASS_NAME), setThis, false, false,
                CIM_RelatedStatistics.CIM_CLASS_NAME);

        setThis = RelatedStats != null ? RelatedStats.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_RelatedStatistics.PROPERTY_RELATEDSTATS_CIM_STATISTICALINFORMATION.NAME,
                new CIMDataType(CIM_StatisticalInformation.CIM_CLASS_NAME), setThis, false, false,
                CIM_RelatedStatistics.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_RelatedStatistics createInstance(WBEMClient client,
            CIM_RelatedStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_RelatedStatistics newDataInstance = CIM_RelatedStatisticsHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_RelatedStatistics modifyInstance(WBEMClient client,
            CIM_RelatedStatistics dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RelatedStatistics dataInstance2 = CIM_RelatedStatisticsHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RelatedStatistics dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RelatedStatistics.getPackages());
    }
