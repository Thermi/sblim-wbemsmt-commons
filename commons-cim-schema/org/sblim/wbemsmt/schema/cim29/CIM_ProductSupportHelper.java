 ...
 * 
 * Description: Helper class for CIM_ProductSupport
 *    
 * 
 * generated Class
 * @see CIM_ProductSupport
 */
...
public class CIM_ProductSupportHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProductSupport or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProductSupport.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ProductSupport.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProductSupport or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ProductSupport.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProductSupport(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProductSupportHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProductSupport.");
                        resultArrayList.add(new CIM_ProductSupport(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProductSupport.");
                        resultArrayList.add(new CIM_ProductSupport(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProductSupport.");
                        resultArrayList.add(new CIM_ProductSupport(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProductSupport getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ProductSupport getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProductSupport) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProductSupport(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProductSupport getInstance(WBEMClient client, String namespace,
            CIM_Product Product, CIM_SupportAccess Support
        ...
        keyProperties[0] = new CIMProperty(CIM_ProductSupport.PROPERTY_PRODUCT_CIM_PRODUCT.NAME,
                new CIMDataType(CIM_Product.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductSupport.CIM_CLASS_NAME);

        setThis = Support != null ? Support.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ProductSupport.PROPERTY_SUPPORT_CIM_SUPPORTACCESS.NAME, new CIMDataType(
                        CIM_SupportAccess.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProductSupport.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProductSupport createInstance(WBEMClient client,
            CIM_ProductSupport dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProductSupport newDataInstance = CIM_ProductSupportHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProductSupport modifyInstance(WBEMClient client,
            CIM_ProductSupport dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProductSupport dataInstance2 = CIM_ProductSupportHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProductSupport dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProductSupport.getPackages());
    }
