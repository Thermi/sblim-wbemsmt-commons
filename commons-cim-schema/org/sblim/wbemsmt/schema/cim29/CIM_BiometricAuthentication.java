 ...
 *
 *
 * Description: A class describing a company's and/or administrator's credential requirements that should be authenticated in order to establish/trust a CIM_Identity. This class defines specific biometric data that should be authenticated.
 * 
 */
