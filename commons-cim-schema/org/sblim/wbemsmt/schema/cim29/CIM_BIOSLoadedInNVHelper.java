 ...
 * 
 * Description: Helper class for CIM_BIOSLoadedInNV
 *    
 * 
 * generated Class
 * @see CIM_BIOSLoadedInNV
 */
...
public class CIM_BIOSLoadedInNVHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BIOSLoadedInNV or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BIOSLoadedInNV.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_BIOSLoadedInNV.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BIOSLoadedInNV or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_BIOSLoadedInNV.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BIOSLoadedInNV(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BIOSLoadedInNVHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BIOSLoadedInNV.");
                        resultArrayList.add(new CIM_BIOSLoadedInNV(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BIOSLoadedInNV.");
                        resultArrayList.add(new CIM_BIOSLoadedInNV(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BIOSLoadedInNV.");
                        resultArrayList.add(new CIM_BIOSLoadedInNV(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BIOSLoadedInNV getInstance(WBEMClient client,
     ...
     */
    public final static CIM_BIOSLoadedInNV getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BIOSLoadedInNV) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BIOSLoadedInNV(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BIOSLoadedInNV getInstance(WBEMClient client, String namespace,
            CIM_Memory Antecedent, CIM_BIOSElement Dependent
        ...
        keyProperties[0] = new CIMProperty(CIM_BIOSLoadedInNV.PROPERTY_ANTECEDENT_CIM_MEMORY.NAME,
                new CIMDataType(CIM_Memory.CIM_CLASS_NAME), setThis, false, false,
                CIM_BIOSLoadedInNV.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_BIOSLoadedInNV.PROPERTY_DEPENDENT_CIM_BIOSELEMENT.NAME, new CIMDataType(
                        CIM_BIOSElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_BIOSLoadedInNV.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BIOSLoadedInNV createInstance(WBEMClient client,
            CIM_BIOSLoadedInNV dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_BIOSLoadedInNV newDataInstance = CIM_BIOSLoadedInNVHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_BIOSLoadedInNV modifyInstance(WBEMClient client,
            CIM_BIOSLoadedInNV dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BIOSLoadedInNV dataInstance2 = CIM_BIOSLoadedInNVHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BIOSLoadedInNV dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_BIOSLoadedInNV.getPackages());
    }
