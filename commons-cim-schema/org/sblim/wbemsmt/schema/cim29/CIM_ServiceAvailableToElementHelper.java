 ...
 * 
 * Description: Helper class for CIM_ServiceAvailableToElement
 *    
 * 
 * generated Class
 * @see CIM_ServiceAvailableToElement
 */
...
public class CIM_ServiceAvailableToElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceAvailableToElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceAvailableToElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ServiceAvailableToElement.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceAvailableToElement or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ServiceAvailableToElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceAvailableToElementHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceAvailableToElement.");
                        resultArrayList.add(new CIM_ServiceAvailableToElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceAvailableToElement.");
                        resultArrayList.add(new CIM_ServiceAvailableToElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceAvailableToElement.");
                        resultArrayList.add(new CIM_ServiceAvailableToElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceAvailableToElement getInstance(WBEMClient client,
    ...
    public final static CIM_ServiceAvailableToElement getInstance(WBEMClient client,
        ...
        Class clazz = CIM_ServiceAvailableToElementHelper.findClass(client, cimInstance);
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceAvailableToElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceAvailableToElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceAvailableToElement getInstance(WBEMClient client,
            String namespace, CIM_Service ServiceProvided, CIM_ManagedElement UserOfService
        ...
        setThis = ServiceProvided != null ? ServiceProvided.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(
                CIM_ServiceAvailableToElement.PROPERTY_SERVICEPROVIDED_CIM_SERVICE.NAME,
                new CIMDataType(CIM_Service.CIM_CLASS_NAME), setThis, false, false,
                CIM_ServiceAvailableToElement.CIM_CLASS_NAME);

        setThis = UserOfService != null ? UserOfService.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_ServiceAvailableToElement.PROPERTY_USEROFSERVICE_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ServiceAvailableToElement createInstance(WBEMClient client,
            CIM_ServiceAvailableToElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ServiceAvailableToElement newDataInstance = CIM_ServiceAvailableToElementHelper
     ...
     */
    public final static CIM_ServiceAvailableToElement modifyInstance(WBEMClient client,
            CIM_ServiceAvailableToElement dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceAvailableToElement dataInstance2 = CIM_ServiceAvailableToElementHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ServiceAvailableToElement dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceAvailableToElement.getPackages());
    }
