 ...
 * 
 * Description: Helper class for CIM_SystemSettingContext
 *    
 * 
 * generated Class
 * @see CIM_SystemSettingContext
 */
...
public class CIM_SystemSettingContextHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemSettingContext or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemSettingContext.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemSettingContext.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemSettingContext or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SystemSettingContext(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemSettingContextHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemSettingContext.");
                        resultArrayList.add(new CIM_SystemSettingContext(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemSettingContext.");
                        resultArrayList.add(new CIM_SystemSettingContext(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemSettingContext.");
                        resultArrayList.add(new CIM_SystemSettingContext(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemSettingContext getInstance(WBEMClient client,
    ...
    public final static CIM_SystemSettingContext getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemSettingContext) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemSettingContext(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SystemSettingContext getInstance(WBEMClient client, String namespace,
            CIM_SystemConfiguration Context, CIM_SystemSetting Setting
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SystemSettingContext.PROPERTY_CONTEXT_CIM_SYSTEMCONFIGURATION.NAME,
                new CIMDataType(CIM_SystemConfiguration.CIM_CLASS_NAME), setThis, false, false,
                CIM_SystemSettingContext.CIM_CLASS_NAME);

        setThis = Setting != null ? Setting.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_SystemSettingContext.PROPERTY_SETTING_CIM_SYSTEMSETTING.NAME, new CIMDataType(
                        CIM_SystemSetting.CIM_CLASS_NAME), setThis, false, false,
                CIM_SystemSettingContext.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemSettingContext createInstance(WBEMClient client,
            CIM_SystemSettingContext dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SystemSettingContext newDataInstance = CIM_SystemSettingContextHelper.getInstance(
     ...
     */
    public final static CIM_SystemSettingContext modifyInstance(WBEMClient client,
            CIM_SystemSettingContext dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemSettingContext dataInstance2 = CIM_SystemSettingContextHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemSettingContext dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemSettingContext.getPackages());
    }
