 ...
 *
 *
 * Description: An X509CredentialFilterEntry allows filtering on the attributes of an X.509 certificate. Each instance includes a value for MatchFieldName that specifies the particular X.509 attribute that is being matched.
 * 
 */
