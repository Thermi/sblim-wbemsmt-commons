...
public class CIM_JobDestination extends CIM_EnabledLogicalElement {
    ...
    public CIM_JobDestination(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_JobDestination(CIMInstance cimInstance) throws WbemsmtException {
    ...
    public static CIMProperty create_key_CreationClassName(WBEMClient client, String namespace,
        ...
        CIM_JobDestination fco = new CIM_JobDestination(client, namespace);
    ...
    /**
     * Get the list with CIM_System objects associated by the association CIM_HostedJobDestination
     * 
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION as associationClass<br>
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedJobDestinations(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_HostedJobDestinations(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION, CIM_System.CIM_CLASS_NAME,
     ...
     * 
     * @param cimClient the WBEMClient for the communication
     * @param resultClass This string MUST either contain a valid CIM Class name or be null. It filters the Objects returned to contain only the Objects of this Class name or one of its subclasses. The resultClass should be CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION or a subclass 
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedJobDestinations(WBEMClient cimClient,
        ...
        return getAssociated_CIM_System_CIM_HostedJobDestinations(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION, resultClass, role, resultRole,
                false, false, null);
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedJobDestinations(WBEMClient cimClient,
        ...
        try {
            while (enumeration.hasNext()) {
                CIM_JobDestinationHelper.checkException(enumeration);
    ...
    /**
     * Get the list of CIMObjectPath items of the objects associated by the association CIM_HostedJobDestination
     * @param cimClient the WBEMClient for the communication
     *
     * uses CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION as associationClass<br>
     * uses false for includeQualifiers and includeClassOrigin <br>
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedJobDestinationNames(
            WBEMClient cimClient) throws WbemsmtException {

        return getAssociated_CIM_System_CIM_HostedJobDestinationNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION, CIM_System.CIM_CLASS_NAME,
                null, null);
    }
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedJobDestinationNames(
        ...
        try {
            ...
            throw new AssociatorNamesException(e, new AssociatorNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION,
    ...
    /**
     * Get the list with CIM_HostedJobDestination associations
     *
     * @param cimClient the WBEMClient for the communication
     * @param includeQualifiers If true, all Qualifiers for each Object (including Qualifiers on the Object and on any returned Properties) MUST be included in the Objects returned. If false, no Qualifiers are present in each Object returned.
     * @param includeClassOrigin If true, the CLASSORIGIN attribute will be present on all appropriate elements in the Objects returned. If false, no CLASSORIGIN attributes are present in the Objects returned. CLASSORIGIN is attached to an element (properties, methods, references) to indicate the class in which it was first defined.
    ...
    public java.util.List getAssociations_CIM_HostedJobDestination(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.references(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION, role, includeQualifiers,
                    includeClassOrigin, propertyList);
        }
        catch (WBEMException e) {
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    CIMInstance cimInstance = (CIMInstance) obj;
                    Class clazz = CIM_HostedJobDestinationHelper.findClass(cimClient, cimInstance);

                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of the base class.");
                        result.add(new CIM_HostedJobDestination(cimInstance));
                        continue;
                    }
    ...
    /**
     * Get a list of CIMObjectPath items of the associations CIM_HostedJobDestination
     *
     * @param cimClient the WBEMClient for the communication
     * @param role This string MUST either contain a valid Property name or be null. It filters the Objects returned to contain only Objects referring to the source Object via a Property with the specified name. If "Antecedent" is specified, then only Associations in which the source Object is the "Antecedent" reference are returned.
     * @param deep if true the subclasses returned also
    ...
    public java.util.List getAssociationNames_CIM_HostedJobDestination(WBEMClient cimClient,
        ...
        try {
            enumeration = cimClient.referenceNames(this.getCimObjectPath(),
                    CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION, role);
        }
        catch (WBEMException e) {
            throw new ReferenceNamesException(e, new ReferenceNamesUserObject(this
                    .getCimObjectPath(), CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDJOBDESTINATION, role));
        }
        ...
        try {
            while (enumeration.hasNext()) {
                ...
                if (obj instanceof CIMObjectPath) {
                    if (deep
                            || ((CIMObjectPath) obj).getObjectName().equals(
                                    CIM_HostedJobDestination.CIM_CLASS_NAME)) {
                        result.add(obj);
                    }
                }
            }
    ...
    /**
     * Get the list with CIM_Job objects associated by the association CIM_JobDestinationJobs
     * 
     * @param cimClient the WBEMClient for the communication
     *
    ...
    public java.util.List getAssociated_CIM_Job_CIM_JobDestinationJobss(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Job_CIM_JobDestinationJobss(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS, CIM_Job.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_Job_CIM_JobDestinationJobsNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Job_CIM_JobDestinationJobsNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_JOBDESTINATIONJOBS, CIM_Job.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public String getObjectName() {
        return CIM_JobDestination.CIM_CLASS_NAME;
    }
