			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<PRS_RevisionContact.Java_Package_List.size(); i++) {
						if (!((String)(PRS_RevisionContact.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(PRS_RevisionContact.Java_Package_List.get(i))).endsWith(".")) {
							PRS_RevisionContact.Java_Package_List.setElementAt((String)(PRS_RevisionContact.Java_Package_List.get(i)) + ("."), i);
						}
