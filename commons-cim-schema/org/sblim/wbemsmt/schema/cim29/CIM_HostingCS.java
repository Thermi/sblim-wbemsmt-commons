...
public class CIM_HostingCS extends CIM_HostedDependency {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_VIRTUALCOMPUTERSYSTEM {
        /**
    ...
    public CIM_HostingCS(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HostingCS(CIMInstance cimInstance) throws WbemsmtException {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("Dependent", new CIMProperty("Dependent", new CIMDataType(
                CIM_VirtualComputerSystem.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_Antecedent_CIM_ComputerSystem(WBEMClient client,
        ...
        CIM_HostingCS fco = new CIM_HostingCS(client, namespace);
    ...
    public CIM_VirtualComputerSystem get_Dependent_CIM_VirtualComputerSystem(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_VIRTUALCOMPUTERSYSTEM.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_VIRTUALCOMPUTERSYSTEM.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return CIM_VirtualComputerSystemHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_Dependent_CIM_VirtualComputerSystem(CIM_VirtualComputerSystem newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_VIRTUALCOMPUTERSYSTEM.NAME);
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Dependent_CIM_VirtualComputerSystem(currentProperty,
                    newValue);
            this.instance = this.instance.deriveInstance(new CIMProperty[] { currentProperty });
            return true;
        }
    ...
    public static CIMProperty create_Dependent_CIM_VirtualComputerSystem(WBEMClient client,
            String namespace, CIM_VirtualComputerSystem newValue) throws WbemsmtException {
        CIM_HostingCS fco = new CIM_HostingCS(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_VIRTUALCOMPUTERSYSTEM.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_VirtualComputerSystem(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_VIRTUALCOMPUTERSYSTEM.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_VirtualComputerSystem(
            CIMProperty currentProperty, CIM_VirtualComputerSystem newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return CIM_HostingCS.CIM_CLASS_NAME;
    }
