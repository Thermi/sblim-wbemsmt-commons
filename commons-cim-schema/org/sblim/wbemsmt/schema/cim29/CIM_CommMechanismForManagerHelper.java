...
public class CIM_CommMechanismForManagerHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CommMechanismForManager.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CommMechanismForManager.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_CommMechanismForManager.");
                        resultArrayList.add(new CIM_CommMechanismForManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CommMechanismForManager.");
                        resultArrayList.add(new CIM_CommMechanismForManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CommMechanismForManager.");
                        resultArrayList.add(new CIM_CommMechanismForManager(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CommMechanismForManager getInstance(WBEMClient client,
     ...
     */
    public final static CIM_CommMechanismForManager getInstance(WBEMClient client,
            String namespace, CIM_ObjectManager Antecedent,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CommMechanismForManager.PROPERTY_ANTECEDENT_CIM_OBJECTMANAGER.NAME,
                new CIMDataType(CIM_ObjectManager.CIM_CLASS_NAME), setThis, false, false,
                CIM_CommMechanismForManager.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_CommMechanismForManager.PROPERTY_DEPENDENT_CIM_OBJECTMANAGERCOMMUNICATIONMECHANISM.NAME,
                new CIMDataType(CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME), setThis,
                false, false, CIM_CommMechanismForManager.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CommMechanismForManager createInstance(WBEMClient client,
            CIM_CommMechanismForManager dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CommMechanismForManager newDataInstance = CIM_CommMechanismForManagerHelper
     ...
     */
    public final static CIM_CommMechanismForManager modifyInstance(WBEMClient client,
            CIM_CommMechanismForManager dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CommMechanismForManager dataInstance2 = CIM_CommMechanismForManagerHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_CommMechanismForManager dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CommMechanismForManager.getPackages());
    }
