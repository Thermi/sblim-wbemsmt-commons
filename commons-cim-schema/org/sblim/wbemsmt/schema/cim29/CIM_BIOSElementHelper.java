 ...
 * 
 * Description: Helper class for CIM_BIOSElement
 *    
 * 
 * generated Class
 * @see CIM_BIOSElement
...
public class CIM_BIOSElementHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BIOSElement or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BIOSElement.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_BIOSElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BIOSElement or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BIOSElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BIOSElement(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BIOSElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_BIOSElement.");
                        resultArrayList.add(new CIM_BIOSElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_BIOSElement.");
                        resultArrayList.add(new CIM_BIOSElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BIOSElement.");
                        resultArrayList.add(new CIM_BIOSElement(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BIOSElement getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_BIOSElement getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BIOSElement) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BIOSElement(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BIOSElement getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_BIOSElement.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BIOSElement.CIM_CLASS_NAME);

        setThis = SoftwareElementID;

        keyProperties[1] = new CIMProperty(CIM_BIOSElement.PROPERTY_SOFTWAREELEMENTID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_BIOSElement.CIM_CLASS_NAME);

        setThis = SoftwareElementState;

        keyProperties[2] = new CIMProperty(CIM_BIOSElement.PROPERTY_SOFTWAREELEMENTSTATE.NAME,
                CIMDataType.UINT16_T, setThis, true, false, CIM_BIOSElement.CIM_CLASS_NAME);

        setThis = TargetOperatingSystem;

        keyProperties[3] = new CIMProperty(CIM_BIOSElement.PROPERTY_TARGETOPERATINGSYSTEM.NAME,
                CIMDataType.UINT16_T, setThis, true, false, CIM_BIOSElement.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BIOSElement createInstance(WBEMClient client,
            CIM_BIOSElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_BIOSElement newDataInstance = CIM_BIOSElementHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_BIOSElement modifyInstance(WBEMClient client,
            CIM_BIOSElement dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BIOSElement dataInstance2 = CIM_BIOSElementHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BIOSElement dataInstance)
            throws WbemsmtException {
