 ...
 * 
 * Description: Helper class for CIM_SymbolicLink
 *    
 * 
 * generated Class
 * @see CIM_SymbolicLink
 */
...
public class CIM_SymbolicLinkHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SymbolicLink or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SymbolicLink.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_SymbolicLink.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SymbolicLink or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SymbolicLink.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SymbolicLink(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SymbolicLinkHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SymbolicLink.");
                        resultArrayList.add(new CIM_SymbolicLink(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SymbolicLink.");
                        resultArrayList.add(new CIM_SymbolicLink(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SymbolicLink.");
                        resultArrayList.add(new CIM_SymbolicLink(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SymbolicLink getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_SymbolicLink getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SymbolicLink) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SymbolicLink(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_SymbolicLink getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_SymbolicLink.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SymbolicLink.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_SymbolicLink.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SymbolicLink.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_SymbolicLink.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SymbolicLink.CIM_CLASS_NAME);

        setThis = FSCreationClassName;

        keyProperties[3] = new CIMProperty(CIM_SymbolicLink.PROPERTY_FSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SymbolicLink.CIM_CLASS_NAME);

        setThis = FSName;

        keyProperties[4] = new CIMProperty(CIM_SymbolicLink.PROPERTY_FSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SymbolicLink.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[5] = new CIMProperty(CIM_SymbolicLink.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SymbolicLink.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SymbolicLink createInstance(WBEMClient client,
            CIM_SymbolicLink dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SymbolicLink newDataInstance = CIM_SymbolicLinkHelper
     ...
     */
    public final static CIM_SymbolicLink modifyInstance(WBEMClient client,
            CIM_SymbolicLink dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SymbolicLink dataInstance2 = CIM_SymbolicLinkHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SymbolicLink dataInstance)
            throws WbemsmtException {
