 ...
 * 
 * Description: Helper class for CIM_BasedOn
 *    
 * 
 * generated Class
 * @see CIM_BasedOn
...
public class CIM_BasedOnHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_BasedOn or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_BasedOn.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_BasedOn.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_BasedOn or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_BasedOn.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_BasedOn(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_BasedOnHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_BasedOn.");
                        resultArrayList.add(new CIM_BasedOn(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_BasedOn.");
                        resultArrayList.add(new CIM_BasedOn(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_BasedOn.");
                        resultArrayList.add(new CIM_BasedOn(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_BasedOn getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_BasedOn getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_BasedOn) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_BasedOn(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_BasedOn getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_BasedOn.PROPERTY_ANTECEDENT_CIM_STORAGEEXTENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(CIM_BasedOn.PROPERTY_DEPENDENT_CIM_STORAGEEXTENT.NAME,
                new CIMDataType(CIM_StorageExtent.CIM_CLASS_NAME), setThis, false, false,
                CIM_BasedOn.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_BasedOn createInstance(WBEMClient client, CIM_BasedOn dataInstance,
        ...
        CIM_BasedOn newDataInstance = CIM_BasedOnHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_BasedOn modifyInstance(WBEMClient client, CIM_BasedOn dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_BasedOn dataInstance2 = CIM_BasedOnHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_BasedOn dataInstance)
            throws WbemsmtException {
