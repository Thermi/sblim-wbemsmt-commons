 ...
 * 
 * Description: Helper class for CIM_ServiceProcess
 *    
 * 
 * generated Class
 * @see CIM_ServiceProcess
 */
...
public class CIM_ServiceProcessHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ServiceProcess or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceProcess.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ServiceProcess.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ServiceProcess or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ServiceProcess.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ServiceProcess(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ServiceProcessHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ServiceProcess.");
                        resultArrayList.add(new CIM_ServiceProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceProcess.");
                        resultArrayList.add(new CIM_ServiceProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceProcess.");
                        resultArrayList.add(new CIM_ServiceProcess(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceProcess getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ServiceProcess getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ServiceProcess) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ServiceProcess(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ServiceProcess getInstance(WBEMClient client, String namespace,
            CIM_Service Service, CIM_Process Process
        ...
        setThis = Service != null ? Service.getCimObjectPath() : null;

        keyProperties[0] = new CIMProperty(CIM_ServiceProcess.PROPERTY_SERVICE_CIM_SERVICE.NAME,
                new CIMDataType(CIM_Service.CIM_CLASS_NAME), setThis, false, false,
                CIM_ServiceProcess.CIM_CLASS_NAME);

        setThis = Process != null ? Process.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_ServiceProcess.PROPERTY_PROCESS_CIM_PROCESS.NAME,
                new CIMDataType(CIM_Process.CIM_CLASS_NAME), setThis, false, false,
                CIM_ServiceProcess.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ServiceProcess createInstance(WBEMClient client,
            CIM_ServiceProcess dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ServiceProcess newDataInstance = CIM_ServiceProcessHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ServiceProcess modifyInstance(WBEMClient client,
            CIM_ServiceProcess dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceProcess dataInstance2 = CIM_ServiceProcessHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ServiceProcess dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceProcess.getPackages());
    }
