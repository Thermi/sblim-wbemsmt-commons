 ...
 * 
 * Description: Helper class for CIM_FRU
 *    
 * 
 * generated Class
 * @see CIM_FRU
...
public class CIM_FRUHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_FRU or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_FRU.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_FRU.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_FRU or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_FRU.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_FRU(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_FRUHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_FRU.");
                        resultArrayList.add(new CIM_FRU(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class "
                                ...
                                + " could not be found. Constructing instance of class CIM_FRU.");
                        resultArrayList.add(new CIM_FRU(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_FRU.");
                        resultArrayList.add(new CIM_FRU(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_FRU getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_FRU getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_FRU) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_FRU(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_FRU getInstance(WBEMClient client, String namespace, String FRUNumber,
            String IdentifyingNumber, String Vendor
        ...
        keyProperties[0] = new CIMProperty(CIM_FRU.PROPERTY_FRUNUMBER.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_FRU.CIM_CLASS_NAME);

        setThis = IdentifyingNumber;

        keyProperties[1] = new CIMProperty(CIM_FRU.PROPERTY_IDENTIFYINGNUMBER.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_FRU.CIM_CLASS_NAME);

        setThis = Vendor;

        keyProperties[2] = new CIMProperty(CIM_FRU.PROPERTY_VENDOR.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_FRU.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_FRU createInstance(WBEMClient client, CIM_FRU dataInstance,
        ...
        CIM_FRU newDataInstance = CIM_FRUHelper.getInstance(client, cimObjectPath);
     ...
     */
    public final static CIM_FRU modifyInstance(WBEMClient client, CIM_FRU dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_FRU dataInstance2 = CIM_FRUHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_FRU dataInstance)
            throws WbemsmtException {
