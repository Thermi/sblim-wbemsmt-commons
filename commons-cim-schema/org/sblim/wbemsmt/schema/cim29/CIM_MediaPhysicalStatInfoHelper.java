 ...
 * 
 * Description: Helper class for CIM_MediaPhysicalStatInfo
 *    
 * 
 * generated Class
 * @see CIM_MediaPhysicalStatInfo
 */
...
public class CIM_MediaPhysicalStatInfoHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_MediaPhysicalStatInfo or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_MediaPhysicalStatInfo.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_MediaPhysicalStatInfo.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_MediaPhysicalStatInfo or the subclasses if deep == true
     */
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_MediaPhysicalStatInfo.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_MediaPhysicalStatInfo(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_MediaPhysicalStatInfoHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_MediaPhysicalStatInfo.");
                        resultArrayList.add(new CIM_MediaPhysicalStatInfo(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_MediaPhysicalStatInfo.");
                        resultArrayList.add(new CIM_MediaPhysicalStatInfo(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_MediaPhysicalStatInfo.");
                        resultArrayList.add(new CIM_MediaPhysicalStatInfo(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_MediaPhysicalStatInfo getInstance(WBEMClient client,
    ...
    public final static CIM_MediaPhysicalStatInfo getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_MediaPhysicalStatInfo) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_MediaPhysicalStatInfo(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_MediaPhysicalStatInfo getInstance(WBEMClient client, String namespace,
            String CreationClassName, String Name, String PhysicalCreationClassName, String Tag
        ...
        keyProperties[0] = new CIMProperty(
                CIM_MediaPhysicalStatInfo.PROPERTY_CREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_MediaPhysicalStatInfo.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_MediaPhysicalStatInfo.PROPERTY_NAME.NAME,
        ...
        keyProperties[2] = new CIMProperty(
                CIM_MediaPhysicalStatInfo.PROPERTY_PHYSICALCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_MediaPhysicalStatInfo.CIM_CLASS_NAME);

        setThis = Tag;

        keyProperties[3] = new CIMProperty(CIM_MediaPhysicalStatInfo.PROPERTY_TAG.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_MediaPhysicalStatInfo.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_MediaPhysicalStatInfo createInstance(WBEMClient client,
            CIM_MediaPhysicalStatInfo dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_MediaPhysicalStatInfo newDataInstance = CIM_MediaPhysicalStatInfoHelper.getInstance(
     ...
     */
    public final static CIM_MediaPhysicalStatInfo modifyInstance(WBEMClient client,
            CIM_MediaPhysicalStatInfo dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_MediaPhysicalStatInfo dataInstance2 = CIM_MediaPhysicalStatInfoHelper.getInstance(
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_MediaPhysicalStatInfo dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_MediaPhysicalStatInfo.getPackages());
    }
