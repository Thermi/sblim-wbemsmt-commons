 ...
 * 
 * Description: Helper class for CIM_ProtectedExtentBasedOn
 *    
 * 
 * generated Class
 * @see CIM_ProtectedExtentBasedOn
 */
...
public class CIM_ProtectedExtentBasedOnHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ProtectedExtentBasedOn or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProtectedExtentBasedOn.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ProtectedExtentBasedOn.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ProtectedExtentBasedOn or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_ProtectedExtentBasedOn(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ProtectedExtentBasedOnHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ProtectedExtentBasedOn.");
                        resultArrayList.add(new CIM_ProtectedExtentBasedOn(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProtectedExtentBasedOn.");
                        resultArrayList.add(new CIM_ProtectedExtentBasedOn(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProtectedExtentBasedOn.");
                        resultArrayList.add(new CIM_ProtectedExtentBasedOn(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProtectedExtentBasedOn getInstance(WBEMClient client,
    ...
    public final static CIM_ProtectedExtentBasedOn getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ProtectedExtentBasedOn) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ProtectedExtentBasedOn(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ProtectedExtentBasedOn getInstance(WBEMClient client, String namespace,
            CIM_StorageExtent Antecedent, CIM_StorageExtent Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ProtectedExtentBasedOn.PROPERTY_ANTECEDENT_CIM_STORAGEEXTENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ProtectedExtentBasedOn.PROPERTY_DEPENDENT_CIM_STORAGEEXTENT.NAME,
                new CIMDataType(CIM_StorageExtent.CIM_CLASS_NAME), setThis, false, false,
                CIM_ProtectedExtentBasedOn.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProtectedExtentBasedOn createInstance(WBEMClient client,
            CIM_ProtectedExtentBasedOn dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ProtectedExtentBasedOn newDataInstance = CIM_ProtectedExtentBasedOnHelper.getInstance(
     ...
     */
    public final static CIM_ProtectedExtentBasedOn modifyInstance(WBEMClient client,
            CIM_ProtectedExtentBasedOn dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProtectedExtentBasedOn dataInstance2 = CIM_ProtectedExtentBasedOnHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ProtectedExtentBasedOn dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProtectedExtentBasedOn.getPackages());
    }
