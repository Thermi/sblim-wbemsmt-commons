...
public class CIM_ElementConformsToProfileHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementConformsToProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ElementConformsToProfile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ElementConformsToProfile.");
                        resultArrayList.add(new CIM_ElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementConformsToProfile.");
                        resultArrayList.add(new CIM_ElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementConformsToProfile.");
                        resultArrayList.add(new CIM_ElementConformsToProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementConformsToProfile getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ElementConformsToProfile getInstance(WBEMClient client,
            String namespace, CIM_RegisteredProfile ConformantStandard,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementConformsToProfile.PROPERTY_CONFORMANTSTANDARD_CIM_REGISTEREDPROFILE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ElementConformsToProfile.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ElementConformsToProfile createInstance(WBEMClient client,
            CIM_ElementConformsToProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ElementConformsToProfile newDataInstance = CIM_ElementConformsToProfileHelper
     ...
     */
    public final static CIM_ElementConformsToProfile modifyInstance(WBEMClient client,
            CIM_ElementConformsToProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementConformsToProfile dataInstance2 = CIM_ElementConformsToProfileHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ElementConformsToProfile dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementConformsToProfile.getPackages());
    }
