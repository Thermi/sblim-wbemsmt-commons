/** 
 * CIM_BaseMetricValueHelper.java
 *
...
public final class CIM_BaseMetricValueHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_BaseMetricValue.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BaseMetricValue.Java_Package_List.get(i))).trim().equals("") &&
								!((String)(CIM_BaseMetricValue.Java_Package_List.get(i))).endsWith(".")) {
							CIM_BaseMetricValue.Java_Package_List.setElementAt((String)(CIM_BaseMetricValue.Java_Package_List.get(i)) + ("."), i);
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BaseMetricValue.");
						resultArrayList.add(new CIM_BaseMetricValue(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BaseMetricValue.");
						resultArrayList.add(new CIM_BaseMetricValue(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BaseMetricValue.");
						resultArrayList.add(new CIM_BaseMetricValue(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BaseMetricValue getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BaseMetricValueHelper.getInstance(cimClient, new CIM_BaseMetricValue(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BaseMetricValue getInstance(CIMClient cimClient, CIM_BaseMetricValue dataInstance) {
		...
		return CIM_BaseMetricValueHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BaseMetricValue getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BaseMetricValue dataInstance = null;
		try {
			dataInstance = new CIM_BaseMetricValue(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BaseMetricValue createInstance(CIMClient cimClient, CIM_BaseMetricValue dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BaseMetricValue newDataInstance = null;
		try {
			newDataInstance = CIM_BaseMetricValueHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BaseMetricValue modifyInstance(CIMClient cimClient, CIM_BaseMetricValue dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BaseMetricValueHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BaseMetricValue dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BaseMetricValue dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BaseMetricValue.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BaseMetricValue.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BaseMetricValue.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BaseMetricValue.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BaseMetricValue.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BreakdownDimension(String BreakdownDimension) {
		return true;
	}

	public static boolean isValid_BreakdownValue(String BreakdownValue) {
		return true;
	}

	public static boolean isValid_Duration(Calendar Duration) {
		return true;
	}
	...
	public static boolean isValid_MeasuredElementName(String MeasuredElementName) {
		return true;
	}

	public static boolean isValid_MetricDefinitionId(String MetricDefinitionId) {
		return true;
	}

	public static boolean isValid_MetricValue(String MetricValue) {
		return true;
	}
