 ...
 * 
 * Description: Helper class for CIM_DependencyContext
 *    
 * 
 * generated Class
 * @see CIM_DependencyContext
 */
...
public class CIM_DependencyContextHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_DependencyContext or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_DependencyContext.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_DependencyContext.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_DependencyContext or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_DependencyContext(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_DependencyContextHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_DependencyContext.");
                        resultArrayList.add(new CIM_DependencyContext(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_DependencyContext.");
                        resultArrayList.add(new CIM_DependencyContext(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_DependencyContext.");
                        resultArrayList.add(new CIM_DependencyContext(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_DependencyContext getInstance(WBEMClient client,
     ...
     */
    public final static CIM_DependencyContext getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_DependencyContext) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_DependencyContext(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_DependencyContext getInstance(WBEMClient client, String namespace,
            CIM_Configuration Context, CIM_Dependency Dependency
        ...
        keyProperties[0] = new CIMProperty(
                CIM_DependencyContext.PROPERTY_CONTEXT_CIM_CONFIGURATION.NAME, new CIMDataType(
                        CIM_Configuration.CIM_CLASS_NAME), setThis, false, false,
                CIM_DependencyContext.CIM_CLASS_NAME);

        setThis = Dependency != null ? Dependency.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_DependencyContext.PROPERTY_DEPENDENCY_CIM_DEPENDENCY.NAME, new CIMDataType(
                        CIM_Dependency.CIM_CLASS_NAME), setThis, false, false,
                CIM_DependencyContext.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_DependencyContext createInstance(WBEMClient client,
            CIM_DependencyContext dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_DependencyContext newDataInstance = CIM_DependencyContextHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_DependencyContext modifyInstance(WBEMClient client,
            CIM_DependencyContext dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_DependencyContext dataInstance2 = CIM_DependencyContextHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_DependencyContext dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_DependencyContext.getPackages());
    }
