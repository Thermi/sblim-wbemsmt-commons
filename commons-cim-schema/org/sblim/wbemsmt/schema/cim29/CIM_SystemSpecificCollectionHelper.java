 ...
 * 
 * Description: Helper class for CIM_SystemSpecificCollection
 *    
 * 
 * generated Class
 * @see CIM_SystemSpecificCollection
 */
...
public class CIM_SystemSpecificCollectionHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_SystemSpecificCollection or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemSpecificCollection.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemSpecificCollection.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_SystemSpecificCollection or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_SystemSpecificCollection(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_SystemSpecificCollectionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SystemSpecificCollection.");
                        resultArrayList.add(new CIM_SystemSpecificCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemSpecificCollection.");
                        resultArrayList.add(new CIM_SystemSpecificCollection(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemSpecificCollection.");
                        resultArrayList.add(new CIM_SystemSpecificCollection(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemSpecificCollection getInstance(WBEMClient client,
    ...
    public final static CIM_SystemSpecificCollection getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_SystemSpecificCollection) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_SystemSpecificCollection(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
    ...
    public final static CIM_SystemSpecificCollection getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(CIM_SystemSpecificCollection.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_SystemSpecificCollection createInstance(WBEMClient client,
            CIM_SystemSpecificCollection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SystemSpecificCollection newDataInstance = CIM_SystemSpecificCollectionHelper
     ...
     */
    public final static CIM_SystemSpecificCollection modifyInstance(WBEMClient client,
            CIM_SystemSpecificCollection dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemSpecificCollection dataInstance2 = CIM_SystemSpecificCollectionHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SystemSpecificCollection dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemSpecificCollection.getPackages());
    }
