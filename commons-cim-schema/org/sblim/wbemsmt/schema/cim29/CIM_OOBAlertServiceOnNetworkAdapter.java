...
public class CIM_OOBAlertServiceOnNetworkAdapter extends CIM_DeviceServiceImplementation {
    ...
    public CIM_OOBAlertServiceOnNetworkAdapter(WBEMClient client, String namespace)
    ...
    public CIM_OOBAlertServiceOnNetworkAdapter(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_OOBAlertServiceOnNetworkAdapter() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_NetworkAdapter(WBEMClient client,
        ...
        CIM_OOBAlertServiceOnNetworkAdapter fco = new CIM_OOBAlertServiceOnNetworkAdapter(client,
                namespace);
    ...
    public String getObjectName() {
        return CIM_OOBAlertServiceOnNetworkAdapter.CIM_CLASS_NAME;
    }
