 ...
 * 
 * Description: Helper class for CIM_ElementProfile
 *    
 * 
 * generated Class
 * @see CIM_ElementProfile
 */
...
public class CIM_ElementProfileHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_ElementProfile or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep || CIM_ElementProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_ElementProfile or the subclasses if deep == true
     */
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ElementProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementProfile(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ElementProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ElementProfile.");
                        resultArrayList.add(new CIM_ElementProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementProfile.");
                        resultArrayList.add(new CIM_ElementProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementProfile.");
                        resultArrayList.add(new CIM_ElementProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementProfile getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ElementProfile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_ElementProfile) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_ElementProfile(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_ElementProfile getInstance(WBEMClient client, String namespace,
            CIM_ManagedElement ManagedElement, CIM_Profile Profile
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementProfile.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,
                new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME), setThis, false, false,
                CIM_ElementProfile.CIM_CLASS_NAME);

        setThis = Profile != null ? Profile.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(CIM_ElementProfile.PROPERTY_PROFILE_CIM_PROFILE.NAME,
                new CIMDataType(CIM_Profile.CIM_CLASS_NAME), setThis, false, false,
                CIM_ElementProfile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ElementProfile createInstance(WBEMClient client,
            CIM_ElementProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ElementProfile newDataInstance = CIM_ElementProfileHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ElementProfile modifyInstance(WBEMClient client,
            CIM_ElementProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementProfile dataInstance2 = CIM_ElementProfileHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ElementProfile dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementProfile.getPackages());
    }
