 ...
 * 
 * Description: Helper class for CIM_CommMechanismForAdapter
 *    
 * 
 * generated Class
 * @see CIM_CommMechanismForAdapter
 */
...
public class CIM_CommMechanismForAdapterHelper extends AbstractWbemsmtFcoHelper {
     ...
     *
     * @return a list of CIMObjectPathes of instances of type CIM_CommMechanismForAdapter or the subclasses if deep == true
     */
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CommMechanismForAdapter.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CommMechanismForAdapter.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
     ...
     * @param deep set to true if the subclasses should be also included
     *
     * @return a list of instances of type CIM_CommMechanismForAdapter or the subclasses if deep == true
     */
            ...
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                        ...
                        resultArrayList.add(new CIM_CommMechanismForAdapter(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CommMechanismForAdapterHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CommMechanismForAdapter.");
                        resultArrayList.add(new CIM_CommMechanismForAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CommMechanismForAdapter.");
                        resultArrayList.add(new CIM_CommMechanismForAdapter(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CommMechanismForAdapter.");
                        resultArrayList.add(new CIM_CommMechanismForAdapter(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CommMechanismForAdapter getInstance(WBEMClient client,
    ...
    public final static CIM_CommMechanismForAdapter getInstance(WBEMClient client,
        ...
        if (clazz == null) {
            ...
            try {
                ...
                Object[] actargs = new Object[] { cimInstance };
                dataInstance = (CIM_CommMechanismForAdapter) cons.newInstance(actargs);
            }
            catch (Exception e) {
                System.err
                        .println("The instance of class "
        ...
        try {
            if (dataInstance == null) {
                dataInstance = new CIM_CommMechanismForAdapter(cimInstance);
            }
        }
        catch (Exception e) {
            throw new WbemsmtException(WbemsmtException.ERR_FAILED,
     ...
     */
    public final static CIM_CommMechanismForAdapter getInstance(WBEMClient client,
            String namespace, CIM_ProtocolAdapter Antecedent,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CommMechanismForAdapter.PROPERTY_ANTECEDENT_CIM_PROTOCOLADAPTER.NAME,
                new CIMDataType(CIM_ProtocolAdapter.CIM_CLASS_NAME), setThis, false, false,
                CIM_CommMechanismForAdapter.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_CommMechanismForAdapter.PROPERTY_DEPENDENT_CIM_OBJECTMANAGERCOMMUNICATIONMECHANISM.NAME,
                new CIMDataType(CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME), setThis,
                false, false, CIM_CommMechanismForAdapter.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CommMechanismForAdapter createInstance(WBEMClient client,
            CIM_CommMechanismForAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CommMechanismForAdapter newDataInstance = CIM_CommMechanismForAdapterHelper
     ...
     */
    public final static CIM_CommMechanismForAdapter modifyInstance(WBEMClient client,
            CIM_CommMechanismForAdapter dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CommMechanismForAdapter dataInstance2 = CIM_CommMechanismForAdapterHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_CommMechanismForAdapter dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CommMechanismForAdapter.getPackages());
    }
