 ...
 *
 *
 * Description:  ElementSetting represents the association between Managed SystemElements and
 * the Setting class(es) defined for them.
 * 
 */
...
/**
 *  ElementSetting represents the association between Managed SystemElements and
 * the Setting class(es) defined for them.
 */
