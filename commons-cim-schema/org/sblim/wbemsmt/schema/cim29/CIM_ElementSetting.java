 ...
 * 
 * Description: ElementSetting represents the association between Managed SystemElements and the Setting class(es) defined for them.
 * 
 * generated Class
 */
...
public class CIM_ElementSetting extends org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFco {
    ...
    public boolean set_Element_CIM_ManagedSystemElement(CIM_ManagedSystemElement newValue) {
        ...
        if (currentProperty != null) {
            currentProperty = setPropertyValue_Element_CIM_ManagedSystemElement(currentProperty,
                    newValue);
