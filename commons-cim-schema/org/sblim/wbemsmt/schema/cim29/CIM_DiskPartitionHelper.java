...
public final class CIM_DiskPartitionHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DiskPartition.");
						resultArrayList.add(new CIM_DiskPartition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DiskPartition.");
						resultArrayList.add(new CIM_DiskPartition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DiskPartition.");
						resultArrayList.add(new CIM_DiskPartition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DiskPartition getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DiskPartitionHelper.getInstance(cimClient, new CIM_DiskPartition(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiskPartition getInstance(CIMClient cimClient, CIM_DiskPartition dataInstance) {
		...
		return CIM_DiskPartitionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiskPartition getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DiskPartition dataInstance = null;
		try {
			dataInstance = new CIM_DiskPartition(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_DiskPartition.getPackages();
	...
	*/	
	public final static CIM_DiskPartition createInstance(CIMClient cimClient, CIM_DiskPartition dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DiskPartition newDataInstance = null;
		try {
			newDataInstance = CIM_DiskPartitionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiskPartition modifyInstance(CIMClient cimClient, CIM_DiskPartition dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DiskPartitionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DiskPartition dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DiskPartition dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DiskPartition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DiskPartition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DiskPartition.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DiskPartition.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DiskPartition.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_PartitionSubtype(UnsignedInt16 PartitionSubtype) {
		return true;
	}

	public static boolean isValid_PartitionType(UnsignedInt16 PartitionType) {
		return true;
	}

	public static boolean isValid_PrimaryPartition(Boolean PrimaryPartition) {
		return true;
	}
