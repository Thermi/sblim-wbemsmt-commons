 ...
 *
 *
 * Description:  An abstraction or emulation of a hardware entity, that may or may not be
...
public class CIM_LogicalDevice extends CIM_EnabledLogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_LogicalDevice"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.8.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ALLOCATEDDMA = "CIM_AllocatedDMA"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ALLOCATEDRESOURCE = "CIM_AllocatedResource"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ASSOCIATEDALARM = "CIM_AssociatedAlarm"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ASSOCIATEDBATTERY = "CIM_AssociatedBattery"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ASSOCIATEDCOOLING = "CIM_AssociatedCooling"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ASSOCIATEDLABELREADER = "CIM_AssociatedLabelReader"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ASSOCIATEDSENSOR = "CIM_AssociatedSensor"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_CONTROLLEDBY = "CIM_ControlledBy"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DOORACCESSTODEVICE = "CIM_DoorAccessToDevice"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ERRORCOUNTERSFORDEVICE = "CIM_ErrorCountersForDevice"; //$NON-NLS-1$
