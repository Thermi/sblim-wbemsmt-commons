...
public final class CIM_CollectionHelper {
	...
	*/	
	public final static CIM_Collection getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CollectionHelper.getInstance(cimClient, new CIM_Collection(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Collection getInstance(CIMClient cimClient, CIM_Collection dataInstance) {
		...
		return CIM_CollectionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_Collection getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_Collection(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_Collection.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_Collection.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_Collection.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_Collection.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
