 ...
 *
 *
 * Description:  ArchitectureCheck specifies the hardware platform on which a SoftwareElement
 * can run. The details of this Check are compared with the information found in
 * the CIM_Processor object, related to the CIM_ComputerSystem instance that
 * describes the environment (related by the association,
 * CIM_ComputerSystemProcessor). There should be at least one CIM_Processor that
 * satisfies the details of the Check. In other words, all the processors on the
 * relevant computer system do not need to satisfy the Check.
 * 
 */
...
/**
 *  ArchitectureCheck specifies the hardware platform on which a SoftwareElement
 * can run. The details of this Check are compared with the information found in
 * the CIM_Processor object, related to the CIM_ComputerSystem instance that
 * describes the environment (related by the association,
 * CIM_ComputerSystemProcessor). There should be at least one CIM_Processor that
...
public class CIM_ArchitectureCheck extends CIM_Check  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ArchitectureCheck"; //$NON-NLS-1$
	...
	*/
	...
	public final static int ARCHITECTURETYPE_EFFICEONTMTM8000FAMILY = 122;
	...
	public final static int ARCHITECTURETYPE_AMDSEMPRONTMPROCESSORFAMILY = 133;
	public final static int ARCHITECTURETYPE_AMDTURIONTM64MOBILETECHNOLOGY = 134;
