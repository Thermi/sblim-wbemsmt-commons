/** 
 * CIM_DiagnosticSettingHelper.java
 *
...
public final class CIM_DiagnosticSettingHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_DiagnosticSetting.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DiagnosticSetting.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_DiagnosticSetting.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_DiagnosticSetting.Java_Package_List.setElementAt((String)(CIM_DiagnosticSetting.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DiagnosticSetting.");
						resultArrayList.add(new CIM_DiagnosticSetting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DiagnosticSetting.");
						resultArrayList.add(new CIM_DiagnosticSetting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DiagnosticSetting.");
						resultArrayList.add(new CIM_DiagnosticSetting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DiagnosticSetting getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DiagnosticSettingHelper.getInstance(cimClient, new CIM_DiagnosticSetting(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticSetting getInstance(CIMClient cimClient, CIM_DiagnosticSetting dataInstance) {
		...
		return CIM_DiagnosticSettingHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticSetting getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DiagnosticSetting dataInstance = null;
		try {
			dataInstance = new CIM_DiagnosticSetting(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticSetting createInstance(CIMClient cimClient, CIM_DiagnosticSetting dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DiagnosticSetting newDataInstance = null;
		try {
			newDataInstance = CIM_DiagnosticSettingHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticSetting modifyInstance(CIMClient cimClient, CIM_DiagnosticSetting dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DiagnosticSettingHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DiagnosticSetting dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DiagnosticSetting dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DiagnosticSetting.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DiagnosticSetting.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DiagnosticSetting.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DiagnosticSetting.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DiagnosticSetting.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Locales(String[] Locales) {
		return true;
	}

	public static boolean isValid_LogOptions(UnsignedInt16[] LogOptions) {
		return true;
	}

	public static boolean isValid_LogStorage(UnsignedInt16[] LogStorage) {
		return true;
	}

	public static boolean isValid_LoopControlParameter(String[] LoopControlParameter) {
		return true;
	}

	public static boolean isValid_LoopControl(UnsignedInt16[] LoopControl) {
		return true;
	}

	public static boolean isValid_OtherLogOptionsDescriptions(String[] OtherLogOptionsDescriptions) {
		return true;
	}

	public static boolean isValid_OtherLogStorageDescriptions(String[] OtherLogStorageDescriptions) {
		return true;
	}

	public static boolean isValid_OtherLoopControlDescription(String OtherLoopControlDescription) {
		return true;
	}

	public static boolean isValid_OtherLoopControlDescriptions(String[] OtherLoopControlDescriptions) {
		return true;
	}
	...
	public static boolean isValid_ResultPersistence(UnsignedInt32 ResultPersistence) {
		return true;
	}

	public static boolean isValid_SettingID(String SettingID) {
		return true;
	}
	...
	public static boolean isValid_VerbosityLevel(UnsignedInt16[] VerbosityLevel) {
		return true;
	}
