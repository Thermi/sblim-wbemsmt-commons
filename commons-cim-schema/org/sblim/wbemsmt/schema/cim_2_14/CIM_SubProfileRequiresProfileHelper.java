...
public class CIM_SubProfileRequiresProfileHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SubProfileRequiresProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SubProfileRequiresProfile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_SubProfileRequiresProfileHelper
                            .findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_SubProfileRequiresProfile.");
                        resultArrayList.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SubProfileRequiresProfile.");
                        resultArrayList.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SubProfileRequiresProfile.");
                        resultArrayList.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SubProfileRequiresProfile getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SubProfileRequiresProfile getInstance(WBEMClient client,
            String namespace, CIM_RegisteredProfile Antecedent, CIM_RegisteredSubProfile Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SubProfileRequiresProfile.PROPERTY_ANTECEDENT_CIM_REGISTEREDPROFILE.NAME,
                new CIMDataType(CIM_RegisteredProfile.CIM_CLASS_NAME), setThis, false, false,
                CIM_SubProfileRequiresProfile.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_SubProfileRequiresProfile.PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME,
                new CIMDataType(CIM_RegisteredSubProfile.CIM_CLASS_NAME), setThis, false, false,
                CIM_SubProfileRequiresProfile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SubProfileRequiresProfile createInstance(WBEMClient client,
            CIM_SubProfileRequiresProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SubProfileRequiresProfile newDataInstance = CIM_SubProfileRequiresProfileHelper
     ...
     */
    public final static CIM_SubProfileRequiresProfile modifyInstance(WBEMClient client,
            CIM_SubProfileRequiresProfile dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SubProfileRequiresProfile dataInstance2 = CIM_SubProfileRequiresProfileHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_SubProfileRequiresProfile dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SubProfileRequiresProfile.getPackages());
    }
