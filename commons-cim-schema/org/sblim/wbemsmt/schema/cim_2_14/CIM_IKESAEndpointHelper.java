...
public final class CIM_IKESAEndpointHelper {

	public final static String CIM_CLASS_NAME = "CIM_IKESAEndpoint";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_IKESAEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_IKESAEndpoint.Java_Package_List.size(); i++) {
						if (!((String)(CIM_IKESAEndpoint.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_IKESAEndpoint.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_IKESAEndpoint.Java_Package_List.setElementAt((String)(CIM_IKESAEndpoint.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_IKESAEndpoint.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_IKESAEndpoint.");
						resultArrayList.add(new CIM_IKESAEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_IKESAEndpoint.");
						resultArrayList.add(new CIM_IKESAEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IKESAEndpoint.");
						resultArrayList.add(new CIM_IKESAEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_IKESAEndpoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_IKESAEndpointHelper.getInstance(cimClient, new CIM_IKESAEndpoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IKESAEndpoint getInstance(CIMClient cimClient, CIM_IKESAEndpoint dataInstance) {
		...
		return CIM_IKESAEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IKESAEndpoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_IKESAEndpoint dataInstance = null;
		try {
			dataInstance = new CIM_IKESAEndpoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IKESAEndpoint createInstance(CIMClient cimClient, CIM_IKESAEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		CIM_IKESAEndpoint newDataInstance = null;
		try {
			newDataInstance = CIM_IKESAEndpointHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IKESAEndpoint modifyInstance(CIMClient cimClient, CIM_IKESAEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_IKESAEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_IKESAEndpoint dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_IKESAEndpoint dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_IKESAEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_IKESAEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_IKESAEndpoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_IKESAEndpoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_IKESAEndpoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AuthenticationMethod(UnsignedInt16 AuthenticationMethod) {
		return true;
	}

	public static boolean isValid_CipherAlgorithm(UnsignedInt16 CipherAlgorithm) {
		return true;
	}

	public static boolean isValid_GroupId(UnsignedInt16 GroupId) {
		return true;
	}

	public static boolean isValid_HashAlgorithm(UnsignedInt16 HashAlgorithm) {
		return true;
	}

	public static boolean isValid_InitiatorCookie(UnsignedInt64 InitiatorCookie) {
		return true;
	}

	public static boolean isValid_OtherAuthenticationMethod(String OtherAuthenticationMethod) {
		return true;
	}

	public static boolean isValid_OtherCipherAlgorithm(String OtherCipherAlgorithm) {
		return true;
	}

	public static boolean isValid_OtherHashAlgorithm(String OtherHashAlgorithm) {
		return true;
	}

	public static boolean isValid_ResponderCookie(UnsignedInt64 ResponderCookie) {
		return true;
	}

	public static boolean isValid_VendorID(String VendorID) {
		return true;
	}
