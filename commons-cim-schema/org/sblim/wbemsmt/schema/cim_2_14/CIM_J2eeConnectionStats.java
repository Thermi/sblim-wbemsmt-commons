 ...
 *
 *
 * Description:  The J2eeConnectionStats class defines the performance statistics that are
 * provided by a connection. JCA and JDBC connection statistics are represented
 * by this class. The semantics are determined by the class to which the
 * ConnectionStats instance is associated via the CIM_ElementStatisticalData
 * association.
 * 
 */
...
/**
 *  The J2eeConnectionStats class defines the performance statistics that are
 * provided by a connection. JCA and JDBC connection statistics are represented
 * by this class. The semantics are determined by the class to which the
 * ConnectionStats instance is associated via the CIM_ElementStatisticalData
 * association.
...
public class CIM_J2eeConnectionStats extends CIM_J2eeStatistic  {
	...
	public final static String CIM_CLASS_NAME = "CIM_J2eeConnectionStats"; //$NON-NLS-1$
