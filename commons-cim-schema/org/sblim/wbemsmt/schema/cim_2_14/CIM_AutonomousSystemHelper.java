/** 
 * CIM_AutonomousSystemHelper.java
 *
...
public final class CIM_AutonomousSystemHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_AutonomousSystem.Java_Package_List.size(); i++) {
						if (!((String)(CIM_AutonomousSystem.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_AutonomousSystem.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_AutonomousSystem.Java_Package_List.setElementAt((String)(CIM_AutonomousSystem.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AutonomousSystem.");
						resultArrayList.add(new CIM_AutonomousSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AutonomousSystem.");
						resultArrayList.add(new CIM_AutonomousSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AutonomousSystem.");
						resultArrayList.add(new CIM_AutonomousSystem(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_AutonomousSystem getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_AutonomousSystemHelper.getInstance(cimClient, new CIM_AutonomousSystem(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AutonomousSystem getInstance(CIMClient cimClient, CIM_AutonomousSystem dataInstance) {
		...
		return CIM_AutonomousSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AutonomousSystem getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_AutonomousSystem dataInstance = null;
		try {
			dataInstance = new CIM_AutonomousSystem(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AutonomousSystem createInstance(CIMClient cimClient, CIM_AutonomousSystem dataInstance, boolean notifyDifferencies){ 
		...
		CIM_AutonomousSystem newDataInstance = null;
		try {
			newDataInstance = CIM_AutonomousSystemHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AutonomousSystem modifyInstance(CIMClient cimClient, CIM_AutonomousSystem dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_AutonomousSystemHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_AutonomousSystem dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_AutonomousSystem dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_AutonomousSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_AutonomousSystem.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_AutonomousSystem.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_AutonomousSystem.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_AutonomousSystem.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ASNumber(UnsignedInt16 ASNumber) {
		return true;
	}

	public static boolean isValid_AggregationType(UnsignedInt16 AggregationType) {
		return true;
	}

	public static boolean isValid_IsSingleHomed(Boolean IsSingleHomed) {
		return true;
	}

	public static boolean isValid_IsTransit(Boolean IsTransit) {
		return true;
	}

	public static boolean isValid_RequireIGPSync(Boolean RequireIGPSync) {
		return true;
	}

	public static boolean isValid_RoutingUpdateSource(UnsignedInt16 RoutingUpdateSource) {
		return true;
	}
