...
public class CIM_ElementSettingHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementSetting.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ElementSetting.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ElementSetting.");
                        resultArrayList.add(new CIM_ElementSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementSetting.");
                        resultArrayList.add(new CIM_ElementSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementSetting.");
                        resultArrayList.add(new CIM_ElementSetting(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementSetting getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ElementSetting getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ElementSetting getInstance(WBEMClient client, String namespace,
            CIM_ManagedSystemElement Element, CIM_Setting Setting
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementSetting.PROPERTY_ELEMENT_CIM_MANAGEDSYSTEMELEMENT.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(CIM_ElementSetting.PROPERTY_SETTING_CIM_SETTING.NAME,
     ...
     *
     */
    public final static CIM_ElementSetting createInstance(WBEMClient client,
            CIM_ElementSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ElementSetting newDataInstance = CIM_ElementSettingHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ElementSetting modifyInstance(WBEMClient client,
            CIM_ElementSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementSetting dataInstance2 = CIM_ElementSettingHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ElementSetting dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementSetting.getPackages());
    }
