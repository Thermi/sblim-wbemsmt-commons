/** 
 * CIM_iSCSILoginStatisticsHelper.java
 *
...
public final class CIM_iSCSILoginStatisticsHelper {

	public final static String CIM_CLASS_NAME = "CIM_iSCSILoginStatistics";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_iSCSILoginStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_iSCSILoginStatistics.Java_Package_List.size(); i++) {
						if (!((String)(CIM_iSCSILoginStatistics.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_iSCSILoginStatistics.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_iSCSILoginStatistics.Java_Package_List.setElementAt((String)(CIM_iSCSILoginStatistics.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_iSCSILoginStatistics.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_iSCSILoginStatistics.");
						resultArrayList.add(new CIM_iSCSILoginStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_iSCSILoginStatistics.");
						resultArrayList.add(new CIM_iSCSILoginStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_iSCSILoginStatistics.");
						resultArrayList.add(new CIM_iSCSILoginStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_iSCSILoginStatistics getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_iSCSILoginStatisticsHelper.getInstance(cimClient, new CIM_iSCSILoginStatistics(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSILoginStatistics getInstance(CIMClient cimClient, CIM_iSCSILoginStatistics dataInstance) {
		...
		return CIM_iSCSILoginStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSILoginStatistics getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_iSCSILoginStatistics dataInstance = null;
		try {
			dataInstance = new CIM_iSCSILoginStatistics(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSILoginStatistics createInstance(CIMClient cimClient, CIM_iSCSILoginStatistics dataInstance, boolean notifyDifferencies){ 
		...
		CIM_iSCSILoginStatistics newDataInstance = null;
		try {
			newDataInstance = CIM_iSCSILoginStatisticsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSILoginStatistics modifyInstance(CIMClient cimClient, CIM_iSCSILoginStatistics dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_iSCSILoginStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_iSCSILoginStatistics dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_iSCSILoginStatistics dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_iSCSILoginStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_iSCSILoginStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_iSCSILoginStatistics.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_iSCSILoginStatistics.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_iSCSILoginStatistics.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AuthenticationLoginFailures(UnsignedInt64 AuthenticationLoginFailures) {
		return true;
	}

	public static boolean isValid_AuthorizationLoginFailures(UnsignedInt64 AuthorizationLoginFailures) {
		return true;
	}

	public static boolean isValid_LastLoginFailureRemoteAddress(UnsignedInt32 LastLoginFailureRemoteAddress) {
		return true;
	}

	public static boolean isValid_LastLoginFailureRemoteAddressType(UnsignedInt16 LastLoginFailureRemoteAddressType) {
		return true;
	}

	public static boolean isValid_LastLoginFailureRemoteNodeName(String LastLoginFailureRemoteNodeName) {
		return true;
	}

	public static boolean isValid_LastLoginFailureTime(Calendar LastLoginFailureTime) {
		return true;
	}

	public static boolean isValid_LastLoginFailureType(UnsignedInt16 LastLoginFailureType) {
		return true;
	}

	public static boolean isValid_LoginFailures(UnsignedInt64 LoginFailures) {
		return true;
	}

	public static boolean isValid_LoginRedirects(UnsignedInt64 LoginRedirects) {
		return true;
	}

	public static boolean isValid_NegotiationLoginFailures(UnsignedInt64 NegotiationLoginFailures) {
		return true;
	}

	public static boolean isValid_NormalLogouts(UnsignedInt64 NormalLogouts) {
		return true;
	}

	public static boolean isValid_OtherLastLoginFailureType(String OtherLastLoginFailureType) {
		return true;
	}

	public static boolean isValid_OtherLoginFailures(UnsignedInt64 OtherLoginFailures) {
		return true;
	}

	public static boolean isValid_OtherLogouts(UnsignedInt64 OtherLogouts) {
		return true;
	}

	public static boolean isValid_SuccessfulLogins(UnsignedInt64 SuccessfulLogins) {
		return true;
	}
