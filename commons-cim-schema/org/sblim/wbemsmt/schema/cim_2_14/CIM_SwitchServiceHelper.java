...
public final class CIM_SwitchServiceHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_SwitchService.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SwitchService.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_SwitchService.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_SwitchService.Java_Package_List.setElementAt((String)(CIM_SwitchService.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SwitchService.");
						resultArrayList.add(new CIM_SwitchService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SwitchService.");
						resultArrayList.add(new CIM_SwitchService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SwitchService.");
						resultArrayList.add(new CIM_SwitchService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SwitchService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SwitchServiceHelper.getInstance(cimClient, new CIM_SwitchService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchService getInstance(CIMClient cimClient, CIM_SwitchService dataInstance) {
		...
		return CIM_SwitchServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SwitchService dataInstance = null;
		try {
			dataInstance = new CIM_SwitchService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchService createInstance(CIMClient cimClient, CIM_SwitchService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SwitchService newDataInstance = null;
		try {
			newDataInstance = CIM_SwitchServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchService modifyInstance(CIMClient cimClient, CIM_SwitchService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SwitchServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SwitchService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SwitchService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SwitchService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SwitchService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SwitchService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SwitchService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SwitchService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BridgeAddress(String BridgeAddress) {
		return true;
	}

	public static boolean isValid_BridgeAddressType(UnsignedInt16 BridgeAddressType) {
		return true;
	}

	public static boolean isValid_BridgeType(UnsignedInt8 BridgeType) {
		return true;
	}

	public static boolean isValid_NumPorts(UnsignedInt16 NumPorts) {
		return true;
	}
