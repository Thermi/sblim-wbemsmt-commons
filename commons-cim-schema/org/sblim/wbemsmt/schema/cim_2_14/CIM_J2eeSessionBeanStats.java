 ...
 *
 *
 * Description:  The J2eeSessionBeanStats class is a base class that defines the performance
 * statistics that are provided by both stateful and stateless session beans.
 * 
 */
...
/**
 *  The J2eeSessionBeanStats class is a base class that defines the performance
 * statistics that are provided by both stateful and stateless session beans.
 */
public class CIM_J2eeSessionBeanStats extends CIM_J2eeEJBStats  {
	
	public final static String CIM_CLASS_NAME = "CIM_J2eeSessionBeanStats"; //$NON-NLS-1$
