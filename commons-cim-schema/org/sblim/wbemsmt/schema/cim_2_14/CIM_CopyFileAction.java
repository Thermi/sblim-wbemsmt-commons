 ...
 *
 *
 * Description:  CopyFileAction specifies the files to be moved or copied to a new location. The
 * to/from information for the copy is specified using either the
 * ToDirectorySpecification/ FromDirectorySpecification or the
 * ToDirectoryAction/ FromDirectoryAction associations. The first set is used
 * when the source and/or the target are to exist before any Actions are taken.
 * The second set is used when the source and/or target are created as a part of
 * a previous Action (specified using the association, ActionSequence).
 * 
 */
...
/**
 *  CopyFileAction specifies the files to be moved or copied to a new location. The
 * to/from information for the copy is specified using either the
 * ToDirectorySpecification/ FromDirectorySpecification or the
 * ToDirectoryAction/ FromDirectoryAction associations. The first set is used
 * when the source and/or the target are to exist before any Actions are taken.
...
public class CIM_CopyFileAction extends CIM_FileAction  {
	...
	public final static String CIM_CLASS_NAME = "CIM_CopyFileAction"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_TODIRECTORYSPECIFICATION = "CIM_ToDirectorySpecification"; //$NON-NLS-1$
