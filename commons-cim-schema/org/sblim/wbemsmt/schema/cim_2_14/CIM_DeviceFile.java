...
public class CIM_DeviceFile extends CIM_LogicalFile  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_LOGINDEVICEFILE = "CIM_LogInDeviceFile"; //$NON-NLS-1$
	...
	static {
		...
		for (int i = 0; i < CIM_LogicalFile.CIM_PropertyNameList.size(); i++) {
			...
			CIM_DeviceFile.CIM_PropertyNameList.add(CIM_LogicalFile.CIM_PropertyNameList.elementAt(i));
		}
		
				
		for (int i = 0; i < CIM_LogicalFile.CIM_PropertyList.size(); i++) {
			
			CIM_DeviceFile.CIM_PropertyList.add(CIM_LogicalFile.CIM_PropertyList.elementAt(i));
		}
	...
	*	Class constructor
	*/	
	public CIM_DeviceFile(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_DeviceFile(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof CIM_DeviceFile)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((CIM_DeviceFile)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_DeviceFile)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_DeviceFile)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_DeviceFile)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_DeviceFile)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_DeviceFile)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_DeviceFile)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_DeviceFile)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_DeviceFile)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public ArrayList getAssociated_CIM_LogicalDevice_CIM_DeviceAccessedByFiles(CIMClient cimClient,
	...
	public ArrayList getAssociated_CIM_LogicalDevice_CIM_DeviceAccessedByFile_Names(CIMClient cimClient, boolean deep) {
