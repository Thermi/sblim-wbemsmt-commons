...
public final class CIM_UsersAccessHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_UsersAccess.Java_Package_List.size(); i++) {
						if (!((String)(CIM_UsersAccess.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_UsersAccess.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_UsersAccess.Java_Package_List.setElementAt((String)(CIM_UsersAccess.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_UsersAccess.");
						resultArrayList.add(new CIM_UsersAccess(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_UsersAccess.");
						resultArrayList.add(new CIM_UsersAccess(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_UsersAccess.");
						resultArrayList.add(new CIM_UsersAccess(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_UsersAccess getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_UsersAccessHelper.getInstance(cimClient, new CIM_UsersAccess(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UsersAccess getInstance(CIMClient cimClient, CIM_UsersAccess dataInstance) {
		...
		return CIM_UsersAccessHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UsersAccess getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_UsersAccess dataInstance = null;
		try {
			dataInstance = new CIM_UsersAccess(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_UsersAccess createInstance(CIMClient cimClient, CIM_UsersAccess dataInstance, boolean notifyDifferencies){ 
		...
		CIM_UsersAccess newDataInstance = null;
		try {
			newDataInstance = CIM_UsersAccessHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_UsersAccess modifyInstance(CIMClient cimClient, CIM_UsersAccess dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_UsersAccessHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_UsersAccess dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_UsersAccess dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_UsersAccess.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_UsersAccess.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_UsersAccess.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_UsersAccess.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_UsersAccess.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Biometric(UnsignedInt16[] Biometric) {
		return true;
	}
	...
	public static boolean isValid_ElementID(String ElementID) {
		return true;
	}
