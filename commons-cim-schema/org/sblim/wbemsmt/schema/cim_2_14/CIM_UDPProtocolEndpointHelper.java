/** 
 * CIM_UDPProtocolEndpointHelper.java
 *
...
public final class CIM_UDPProtocolEndpointHelper {

	public final static String CIM_CLASS_NAME = "CIM_UDPProtocolEndpoint";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_UDPProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_UDPProtocolEndpoint.Java_Package_List.size(); i++) {
						if (!((String)(CIM_UDPProtocolEndpoint.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_UDPProtocolEndpoint.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_UDPProtocolEndpoint.Java_Package_List.setElementAt((String)(CIM_UDPProtocolEndpoint.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_UDPProtocolEndpoint.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_UDPProtocolEndpoint.");
						resultArrayList.add(new CIM_UDPProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_UDPProtocolEndpoint.");
						resultArrayList.add(new CIM_UDPProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_UDPProtocolEndpoint.");
						resultArrayList.add(new CIM_UDPProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_UDPProtocolEndpoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_UDPProtocolEndpointHelper.getInstance(cimClient, new CIM_UDPProtocolEndpoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UDPProtocolEndpoint getInstance(CIMClient cimClient, CIM_UDPProtocolEndpoint dataInstance) {
		...
		return CIM_UDPProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UDPProtocolEndpoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_UDPProtocolEndpoint dataInstance = null;
		try {
			dataInstance = new CIM_UDPProtocolEndpoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_UDPProtocolEndpoint createInstance(CIMClient cimClient, CIM_UDPProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		CIM_UDPProtocolEndpoint newDataInstance = null;
		try {
			newDataInstance = CIM_UDPProtocolEndpointHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_UDPProtocolEndpoint modifyInstance(CIMClient cimClient, CIM_UDPProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_UDPProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_UDPProtocolEndpoint dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_UDPProtocolEndpoint dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_UDPProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_UDPProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_UDPProtocolEndpoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_UDPProtocolEndpoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_UDPProtocolEndpoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_PortNumber(UnsignedInt32 PortNumber) {
		return true;
	}
