 ...
 *
 *
 * Description:  LabelReaders represent hardware capable of scanning or reading a physical label
 * or the NonVolatileMemory on a PhysicalMedia. Examples of labels include
 * barcode and OCR tags.
 * 
 */
...
/**
 *  LabelReaders represent hardware capable of scanning or reading a physical label
 * or the NonVolatileMemory on a PhysicalMedia. Examples of labels include
 * barcode and OCR tags.
 */
public class CIM_LabelReader extends CIM_LogicalDevice  {
	
	public final static String CIM_CLASS_NAME = "CIM_LabelReader"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.6.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ACCESSLABELREADER = "CIM_AccessLabelReader"; //$NON-NLS-1$
