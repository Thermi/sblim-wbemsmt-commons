/** 
 * CIM_iSCSIConnectionSettingsHelper.java
 *
...
public final class CIM_iSCSIConnectionSettingsHelper {

	public final static String CIM_CLASS_NAME = "CIM_iSCSIConnectionSettings";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_iSCSIConnectionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_iSCSIConnectionSettings.Java_Package_List.size(); i++) {
						if (!((String)(CIM_iSCSIConnectionSettings.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_iSCSIConnectionSettings.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_iSCSIConnectionSettings.Java_Package_List.setElementAt((String)(CIM_iSCSIConnectionSettings.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_iSCSIConnectionSettings.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_iSCSIConnectionSettings.");
						resultArrayList.add(new CIM_iSCSIConnectionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_iSCSIConnectionSettings.");
						resultArrayList.add(new CIM_iSCSIConnectionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_iSCSIConnectionSettings.");
						resultArrayList.add(new CIM_iSCSIConnectionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_iSCSIConnectionSettings getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_iSCSIConnectionSettingsHelper.getInstance(cimClient, new CIM_iSCSIConnectionSettings(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSIConnectionSettings getInstance(CIMClient cimClient, CIM_iSCSIConnectionSettings dataInstance) {
		...
		return CIM_iSCSIConnectionSettingsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSIConnectionSettings getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_iSCSIConnectionSettings dataInstance = null;
		try {
			dataInstance = new CIM_iSCSIConnectionSettings(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSIConnectionSettings createInstance(CIMClient cimClient, CIM_iSCSIConnectionSettings dataInstance, boolean notifyDifferencies){ 
		...
		CIM_iSCSIConnectionSettings newDataInstance = null;
		try {
			newDataInstance = CIM_iSCSIConnectionSettingsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSIConnectionSettings modifyInstance(CIMClient cimClient, CIM_iSCSIConnectionSettings dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_iSCSIConnectionSettingsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_iSCSIConnectionSettings dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_iSCSIConnectionSettings dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_iSCSIConnectionSettings.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_iSCSIConnectionSettings.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_iSCSIConnectionSettings.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_iSCSIConnectionSettings.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_iSCSIConnectionSettings.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_MaxReceiveDataSegmentLength(UnsignedInt32 MaxReceiveDataSegmentLength) {
		return true;
	}

	public static boolean isValid_OtherPrimaryDataDigestMethod(String OtherPrimaryDataDigestMethod) {
		return true;
	}

	public static boolean isValid_OtherPrimaryHeaderDigestMethod(String OtherPrimaryHeaderDigestMethod) {
		return true;
	}

	public static boolean isValid_OtherSecondaryDataDigestMethod(String OtherSecondaryDataDigestMethod) {
		return true;
	}

	public static boolean isValid_OtherSecondaryHeaderDigestMethod(String OtherSecondaryHeaderDigestMethod) {
		return true;
	}

	public static boolean isValid_PrimaryAuthenticationMethod(UnsignedInt16 PrimaryAuthenticationMethod) {
		return true;
	}

	public static boolean isValid_PrimaryDataDigestMethod(UnsignedInt16 PrimaryDataDigestMethod) {
		return true;
	}

	public static boolean isValid_PrimaryHeaderDigestMethod(UnsignedInt16 PrimaryHeaderDigestMethod) {
		return true;
	}

	public static boolean isValid_RequestingMarkersOnReceive(Boolean RequestingMarkersOnReceive) {
		return true;
	}

	public static boolean isValid_SecondaryAuthenticationMethod(UnsignedInt16 SecondaryAuthenticationMethod) {
		return true;
	}

	public static boolean isValid_SecondaryDataDigestMethod(UnsignedInt16 SecondaryDataDigestMethod) {
		return true;
	}

	public static boolean isValid_SecondaryHeaderDigestMethod(UnsignedInt16 SecondaryHeaderDigestMethod) {
		return true;
	}
