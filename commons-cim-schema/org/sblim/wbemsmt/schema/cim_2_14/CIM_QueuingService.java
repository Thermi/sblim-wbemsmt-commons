 ...
 *
 *
 * Description:  QueuingService represents the ability to queue network traffic, and to specify
 * the characteristics for determining long-term congestion. It is modeled as a
 * ConditioningService so that it can be aggregated into a QoSService (using the
 * QoSConditioningSubService association). This indicates that its functionality
...
/**
 *  QueuingService represents the ability to queue network traffic, and to specify
 * the characteristics for determining long-term congestion. It is modeled as a
 * ConditioningService so that it can be aggregated into a QoSService (using the
 * QoSConditioningSubService association). This indicates that its functionality
 * underlies the QoSService.
...
public class CIM_QueuingService extends CIM_ConditioningService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_QueuingService"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_HEADTAILDROPQUEUEBINDING = "CIM_HeadTailDropQueueBinding"; //$NON-NLS-1$
