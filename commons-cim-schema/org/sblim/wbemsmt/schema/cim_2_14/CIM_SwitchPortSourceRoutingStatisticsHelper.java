/** 
 * CIM_SwitchPortSourceRoutingStatisticsHelper.java
 *
...
public final class CIM_SwitchPortSourceRoutingStatisticsHelper {

	public final static String CIM_CLASS_NAME = "CIM_SwitchPortSourceRoutingStatistics";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_SwitchPortSourceRoutingStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_SwitchPortSourceRoutingStatistics.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SwitchPortSourceRoutingStatistics.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_SwitchPortSourceRoutingStatistics.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_SwitchPortSourceRoutingStatistics.Java_Package_List.setElementAt((String)(CIM_SwitchPortSourceRoutingStatistics.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_SwitchPortSourceRoutingStatistics.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SwitchPortSourceRoutingStatistics.");
						resultArrayList.add(new CIM_SwitchPortSourceRoutingStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SwitchPortSourceRoutingStatistics.");
						resultArrayList.add(new CIM_SwitchPortSourceRoutingStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SwitchPortSourceRoutingStatistics.");
						resultArrayList.add(new CIM_SwitchPortSourceRoutingStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SwitchPortSourceRoutingStatistics getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SwitchPortSourceRoutingStatisticsHelper.getInstance(cimClient, new CIM_SwitchPortSourceRoutingStatistics(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchPortSourceRoutingStatistics getInstance(CIMClient cimClient, CIM_SwitchPortSourceRoutingStatistics dataInstance) {
		...
		return CIM_SwitchPortSourceRoutingStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchPortSourceRoutingStatistics getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SwitchPortSourceRoutingStatistics dataInstance = null;
		try {
			dataInstance = new CIM_SwitchPortSourceRoutingStatistics(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchPortSourceRoutingStatistics createInstance(CIMClient cimClient, CIM_SwitchPortSourceRoutingStatistics dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SwitchPortSourceRoutingStatistics newDataInstance = null;
		try {
			newDataInstance = CIM_SwitchPortSourceRoutingStatisticsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchPortSourceRoutingStatistics modifyInstance(CIMClient cimClient, CIM_SwitchPortSourceRoutingStatistics dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SwitchPortSourceRoutingStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SwitchPortSourceRoutingStatistics dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SwitchPortSourceRoutingStatistics dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SwitchPortSourceRoutingStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SwitchPortSourceRoutingStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SwitchPortSourceRoutingStatistics.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SwitchPortSourceRoutingStatistics.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SwitchPortSourceRoutingStatistics.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ApeInFrames(UnsignedInt32 ApeInFrames) {
		return true;
	}

	public static boolean isValid_ApeOutFrames(UnsignedInt32 ApeOutFrames) {
		return true;
	}

	public static boolean isValid_DupLanIdOrTreeErrors(UnsignedInt32 DupLanIdOrTreeErrors) {
		return true;
	}

	public static boolean isValid_DuplicateSegmentDiscards(UnsignedInt32 DuplicateSegmentDiscards) {
		return true;
	}

	public static boolean isValid_HopCountExceedsDiscards(UnsignedInt32 HopCountExceedsDiscards) {
		return true;
	}

	public static boolean isValid_LanIdMismatches(UnsignedInt32 LanIdMismatches) {
		return true;
	}

	public static boolean isValid_SegmentMismatchDiscards(UnsignedInt32 SegmentMismatchDiscards) {
		return true;
	}

	public static boolean isValid_SpecInFrames(UnsignedInt32 SpecInFrames) {
		return true;
	}

	public static boolean isValid_SpecOutFrames(UnsignedInt32 SpecOutFrames) {
		return true;
	}

	public static boolean isValid_SteInFrames(UnsignedInt32 SteInFrames) {
		return true;
	}

	public static boolean isValid_SteOutFrames(UnsignedInt32 SteOutFrames) {
		return true;
	}
