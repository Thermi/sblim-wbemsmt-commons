 ...
 *
 *
 * Description:  A Door is the abstraction of hardware providing access to the internal
 * componentry of a System. When a Door is 'opened', typically all accessible,
 * moving components are stopped or suspended to prevent physical harm.
 * 
 */
...
/**
 *  A Door is the abstraction of hardware providing access to the internal
 * componentry of a System. When a Door is 'opened', typically all accessible,
 * moving components are stopped or suspended to prevent physical harm.
 */
public class CIM_Door extends CIM_LogicalDevice  {
	
	public final static String CIM_CLASS_NAME = "CIM_Door"; //$NON-NLS-1$
