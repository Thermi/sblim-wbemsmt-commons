 ...
 *
 *
 * Description:  This association indicates a subclass of LogicalDevice (for example a Storage
 * Volume) is connected through a specific ProtocolController. In many
 * situations (for example storage LUN masking), there may be many of these
 * associations used to relate to different objects. Therefore subclasses have
 * been defined to optimize enumeration of the associations.
 * 
 */
...
/**
 *  This association indicates a subclass of LogicalDevice (for example a Storage
 * Volume) is connected through a specific ProtocolController. In many
 * situations (for example storage LUN masking), there may be many of these
 * associations used to relate to different objects. Therefore subclasses have
 * been defined to optimize enumeration of the associations.
...
public class CIM_ProtocolControllerForDevice extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ProtocolControllerForDevice"; //$NON-NLS-1$
