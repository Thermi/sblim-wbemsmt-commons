/** 
 * CIM_MediaTransferDeviceHelper.java
 *
...
public final class CIM_MediaTransferDeviceHelper {

	public final static String CIM_CLASS_NAME = "CIM_MediaTransferDevice";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_MediaTransferDevice.Java_Package_List.size(); i++) {
						if (!((String)(CIM_MediaTransferDevice.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_MediaTransferDevice.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_MediaTransferDevice.Java_Package_List.setElementAt((String)(CIM_MediaTransferDevice.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_MediaTransferDevice.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_MediaTransferDevice.");
						resultArrayList.add(new CIM_MediaTransferDevice(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_MediaTransferDevice.");
						resultArrayList.add(new CIM_MediaTransferDevice(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MediaTransferDevice.");
						resultArrayList.add(new CIM_MediaTransferDevice(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_MediaTransferDevice getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_MediaTransferDeviceHelper.getInstance(cimClient, new CIM_MediaTransferDevice(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_MediaTransferDevice getInstance(CIMClient cimClient, CIM_MediaTransferDevice dataInstance) {
		...
		return CIM_MediaTransferDeviceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_MediaTransferDevice getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_MediaTransferDevice dataInstance = null;
		try {
			dataInstance = new CIM_MediaTransferDevice(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_MediaTransferDevice createInstance(CIMClient cimClient, CIM_MediaTransferDevice dataInstance, boolean notifyDifferencies){ 
		...
		CIM_MediaTransferDevice newDataInstance = null;
		try {
			newDataInstance = CIM_MediaTransferDeviceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_MediaTransferDevice modifyInstance(CIMClient cimClient, CIM_MediaTransferDevice dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_MediaTransferDeviceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_MediaTransferDevice dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_MediaTransferDevice dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_MediaTransferDevice.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_MediaTransferDevice.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_MediaTransferDevice.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_MediaTransferDevice.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_MediaTransferDevice.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
