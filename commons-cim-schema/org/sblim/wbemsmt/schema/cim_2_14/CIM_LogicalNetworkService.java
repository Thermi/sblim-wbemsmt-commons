 ...
 *
 *
 * Description:  A LogicalNetworkService represents network services that either originate
...
public class CIM_LogicalNetworkService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_LogicalNetworkService"; //$NON-NLS-1$
