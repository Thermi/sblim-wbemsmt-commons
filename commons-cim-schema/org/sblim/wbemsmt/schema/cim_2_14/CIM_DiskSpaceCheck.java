 ...
 *
 *
 * Description:  DiskSpaceCheck describes the amount of disk space that needs to be available on
 * the computer system. The amount is specified in the AvailableDiskSpace
 * property. The details of this Check are compared with the value of the
 * CIM_FileSystem. AvailableSpace property - where the CIM_FileSystem object is
 * related (using HostedFileSystem) to the CIM_Computer System instance that
 * describes the environment. When the value of the AvailableSpace property is
 * greater than or equal to the value specified in AvailableDiskSpace, the Check
 * is satisfied.
 * 
 */
...
/**
 *  DiskSpaceCheck describes the amount of disk space that needs to be available on
 * the computer system. The amount is specified in the AvailableDiskSpace
 * property. The details of this Check are compared with the value of the
 * CIM_FileSystem. AvailableSpace property - where the CIM_FileSystem object is
 * related (using HostedFileSystem) to the CIM_Computer System instance that
...
public class CIM_DiskSpaceCheck extends CIM_Check  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DiskSpaceCheck"; //$NON-NLS-1$
