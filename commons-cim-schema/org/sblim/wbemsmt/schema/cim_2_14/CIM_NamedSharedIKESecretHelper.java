/** 
 * CIM_NamedSharedIKESecretHelper.java
 *
...
public final class CIM_NamedSharedIKESecretHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_NamedSharedIKESecret.Java_Package_List.size(); i++) {
						if (!((String)(CIM_NamedSharedIKESecret.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_NamedSharedIKESecret.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_NamedSharedIKESecret.Java_Package_List.setElementAt((String)(CIM_NamedSharedIKESecret.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_NamedSharedIKESecret.");
						resultArrayList.add(new CIM_NamedSharedIKESecret(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_NamedSharedIKESecret.");
						resultArrayList.add(new CIM_NamedSharedIKESecret(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_NamedSharedIKESecret.");
						resultArrayList.add(new CIM_NamedSharedIKESecret(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_NamedSharedIKESecret getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_NamedSharedIKESecretHelper.getInstance(cimClient, new CIM_NamedSharedIKESecret(keyProperties));
	}
	...
	*/	
	public final static CIM_NamedSharedIKESecret getInstance(CIMClient cimClient, CIM_NamedSharedIKESecret dataInstance) {
		...
		return CIM_NamedSharedIKESecretHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_NamedSharedIKESecret getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_NamedSharedIKESecret dataInstance = null;
		try {
			dataInstance = new CIM_NamedSharedIKESecret(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_NamedSharedIKESecret createInstance(CIMClient cimClient, CIM_NamedSharedIKESecret dataInstance, boolean notifyDifferencies){ 
		...
		CIM_NamedSharedIKESecret newDataInstance = null;
		try {
			newDataInstance = CIM_NamedSharedIKESecretHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_NamedSharedIKESecret modifyInstance(CIMClient cimClient, CIM_NamedSharedIKESecret dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_NamedSharedIKESecretHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_NamedSharedIKESecret dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_NamedSharedIKESecret dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_NamedSharedIKESecret.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_NamedSharedIKESecret.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_NamedSharedIKESecret.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_NamedSharedIKESecret.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_NamedSharedIKESecret.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_LocalIdentity(String LocalIdentity) {
		return true;
	}

	public static boolean isValid_LocalIdentityType(UnsignedInt16 LocalIdentityType) {
		return true;
	}

	public static boolean isValid_PeerIdentity(String PeerIdentity) {
		return true;
	}

	public static boolean isValid_PeerIdentityType(UnsignedInt16 PeerIdentityType) {
		return true;
	}
	...
	public static boolean isValid_SharedSecretName(String SharedSecretName) {
		return true;
	}
