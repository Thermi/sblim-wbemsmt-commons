/** 
 * CIM_BlockStatisticsManifestHelper.java
 *
...
public final class CIM_BlockStatisticsManifestHelper {

	public final static String CIM_CLASS_NAME = "CIM_BlockStatisticsManifest";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_BlockStatisticsManifest(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_BlockStatisticsManifest.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BlockStatisticsManifest.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_BlockStatisticsManifest.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_BlockStatisticsManifest.Java_Package_List.setElementAt((String)(CIM_BlockStatisticsManifest.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_BlockStatisticsManifest.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BlockStatisticsManifest.");
						resultArrayList.add(new CIM_BlockStatisticsManifest(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BlockStatisticsManifest.");
						resultArrayList.add(new CIM_BlockStatisticsManifest(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BlockStatisticsManifest.");
						resultArrayList.add(new CIM_BlockStatisticsManifest(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BlockStatisticsManifest getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BlockStatisticsManifestHelper.getInstance(cimClient, new CIM_BlockStatisticsManifest(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BlockStatisticsManifest getInstance(CIMClient cimClient, CIM_BlockStatisticsManifest dataInstance) {
		...
		return CIM_BlockStatisticsManifestHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BlockStatisticsManifest getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BlockStatisticsManifest dataInstance = null;
		try {
			dataInstance = new CIM_BlockStatisticsManifest(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BlockStatisticsManifest createInstance(CIMClient cimClient, CIM_BlockStatisticsManifest dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BlockStatisticsManifest newDataInstance = null;
		try {
			newDataInstance = CIM_BlockStatisticsManifestHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BlockStatisticsManifest modifyInstance(CIMClient cimClient, CIM_BlockStatisticsManifest dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BlockStatisticsManifestHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BlockStatisticsManifest dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BlockStatisticsManifest dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BlockStatisticsManifest.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BlockStatisticsManifest.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BlockStatisticsManifest.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BlockStatisticsManifest.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BlockStatisticsManifest.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ElementType(UnsignedInt16 ElementType) {
		return true;
	}

	public static boolean isValid_IncludeIOTimeCounter(Boolean IncludeIOTimeCounter) {
		return true;
	}

	public static boolean isValid_IncludeIdleTimeCounter(Boolean IncludeIdleTimeCounter) {
		return true;
	}

	public static boolean isValid_IncludeKBytesRead(Boolean IncludeKBytesRead) {
		return true;
	}

	public static boolean isValid_IncludeKBytesTransferred(Boolean IncludeKBytesTransferred) {
		return true;
	}

	public static boolean isValid_IncludeKBytesWritten(Boolean IncludeKBytesWritten) {
		return true;
	}

	public static boolean isValid_IncludeMaintOp(Boolean IncludeMaintOp) {
		return true;
	}

	public static boolean isValid_IncludeMaintTimeCounter(Boolean IncludeMaintTimeCounter) {
		return true;
	}

	public static boolean isValid_IncludeReadHitIOTimeCounter(Boolean IncludeReadHitIOTimeCounter) {
		return true;
	}

	public static boolean isValid_IncludeReadHitIOs(Boolean IncludeReadHitIOs) {
		return true;
	}

	public static boolean isValid_IncludeReadIOTimeCounter(Boolean IncludeReadIOTimeCounter) {
		return true;
	}

	public static boolean isValid_IncludeReadIOs(Boolean IncludeReadIOs) {
		return true;
	}

	public static boolean isValid_IncludeStartStatisticTime(Boolean IncludeStartStatisticTime) {
		return true;
	}

	public static boolean isValid_IncludeStatisticTime(Boolean IncludeStatisticTime) {
		return true;
	}

	public static boolean isValid_IncludeTotalIOs(Boolean IncludeTotalIOs) {
		return true;
	}

	public static boolean isValid_IncludeWriteHitIOTimeCounter(Boolean IncludeWriteHitIOTimeCounter) {
		return true;
	}

	public static boolean isValid_IncludeWriteHitIOs(Boolean IncludeWriteHitIOs) {
		return true;
	}

	public static boolean isValid_IncludeWriteIOTimeCounter(Boolean IncludeWriteIOTimeCounter) {
		return true;
	}

	public static boolean isValid_IncludeWriteIOs(Boolean IncludeWriteIOs) {
		return true;
	}
