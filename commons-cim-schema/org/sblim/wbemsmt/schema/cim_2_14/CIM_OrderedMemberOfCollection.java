...
Note that the non-zero sequence numbers do not need to start with '1', and they do not need to be consecutive. However, the sequence numbers must reflect their relative magnitude.
	*/
