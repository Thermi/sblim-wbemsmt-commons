/** 
 * CIM_FCSwitchCapabilitiesHelper.java
 *
...
public final class CIM_FCSwitchCapabilitiesHelper {

	public final static String CIM_CLASS_NAME = "CIM_FCSwitchCapabilities";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_FCSwitchCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_FCSwitchCapabilities.Java_Package_List.size(); i++) {
						if (!((String)(CIM_FCSwitchCapabilities.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_FCSwitchCapabilities.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_FCSwitchCapabilities.Java_Package_List.setElementAt((String)(CIM_FCSwitchCapabilities.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_FCSwitchCapabilities.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_FCSwitchCapabilities.");
						resultArrayList.add(new CIM_FCSwitchCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_FCSwitchCapabilities.");
						resultArrayList.add(new CIM_FCSwitchCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_FCSwitchCapabilities.");
						resultArrayList.add(new CIM_FCSwitchCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_FCSwitchCapabilities getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_FCSwitchCapabilitiesHelper.getInstance(cimClient, new CIM_FCSwitchCapabilities(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_FCSwitchCapabilities getInstance(CIMClient cimClient, CIM_FCSwitchCapabilities dataInstance) {
		...
		return CIM_FCSwitchCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_FCSwitchCapabilities getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_FCSwitchCapabilities dataInstance = null;
		try {
			dataInstance = new CIM_FCSwitchCapabilities(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_FCSwitchCapabilities createInstance(CIMClient cimClient, CIM_FCSwitchCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		CIM_FCSwitchCapabilities newDataInstance = null;
		try {
			newDataInstance = CIM_FCSwitchCapabilitiesHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_FCSwitchCapabilities modifyInstance(CIMClient cimClient, CIM_FCSwitchCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_FCSwitchCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_FCSwitchCapabilities dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_FCSwitchCapabilities dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_FCSwitchCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_FCSwitchCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_FCSwitchCapabilities.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_FCSwitchCapabilities.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_FCSwitchCapabilities.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DomainIDConfigureable(Boolean DomainIDConfigureable) {
		return true;
	}

	public static boolean isValid_DomainIDLockedSupported(Boolean DomainIDLockedSupported) {
		return true;
	}

	public static boolean isValid_MaxDomainID(UnsignedInt8 MaxDomainID) {
		return true;
	}

	public static boolean isValid_MinDomainID(UnsignedInt8 MinDomainID) {
		return true;
	}

	public static boolean isValid_PrincipalPrioritiesSupported(UnsignedInt16[] PrincipalPrioritiesSupported) {
		return true;
	}
