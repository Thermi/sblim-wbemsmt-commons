 ...
 *
 *
 * Description:  This aggregation represents the relationship between a ClassifierService and
 * the ClassifierElements that provide its fan-out function. ClassifierElements
 * represent the traffic selectors for the Service. A ClassifierService
 * typically aggregates multiple ClassifierElements. An individual Element,
...
/**
 *  This aggregation represents the relationship between a ClassifierService and
 * the ClassifierElements that provide its fan-out function. ClassifierElements
 * represent the traffic selectors for the Service. A ClassifierService
 * typically aggregates multiple ClassifierElements. An individual Element,
 * however, is aggregated only by a single ClassifierService.
...
public class CIM_ClassifierElementInClassifierService extends CIM_ServiceComponent  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ClassifierElementInClassifierService"; //$NON-NLS-1$
