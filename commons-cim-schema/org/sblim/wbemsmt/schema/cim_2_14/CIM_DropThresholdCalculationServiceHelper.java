/** 
 * CIM_DropThresholdCalculationServiceHelper.java
 *
...
public final class CIM_DropThresholdCalculationServiceHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DropThresholdCalculationService.");
						resultArrayList.add(new CIM_DropThresholdCalculationService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DropThresholdCalculationService.");
						resultArrayList.add(new CIM_DropThresholdCalculationService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DropThresholdCalculationService.");
						resultArrayList.add(new CIM_DropThresholdCalculationService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DropThresholdCalculationService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DropThresholdCalculationServiceHelper.getInstance(cimClient, new CIM_DropThresholdCalculationService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DropThresholdCalculationService getInstance(CIMClient cimClient, CIM_DropThresholdCalculationService dataInstance) {
		...
		return CIM_DropThresholdCalculationServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DropThresholdCalculationService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DropThresholdCalculationService dataInstance = null;
		try {
			dataInstance = new CIM_DropThresholdCalculationService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DropThresholdCalculationService createInstance(CIMClient cimClient, CIM_DropThresholdCalculationService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DropThresholdCalculationService newDataInstance = null;
		try {
			newDataInstance = CIM_DropThresholdCalculationServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DropThresholdCalculationService modifyInstance(CIMClient cimClient, CIM_DropThresholdCalculationService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DropThresholdCalculationServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DropThresholdCalculationService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DropThresholdCalculationService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DropThresholdCalculationService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DropThresholdCalculationService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DropThresholdCalculationService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DropThresholdCalculationService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DropThresholdCalculationService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_SmoothingWeight(UnsignedInt32 SmoothingWeight) {
		return true;
	}

	public static boolean isValid_TimeInterval(UnsignedInt32 TimeInterval) {
		return true;
	}
