/** 
 * PRS_ServiceIncidentHelper.java
 *
...
public final class PRS_ServiceIncidentHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<PRS_ServiceIncident.Java_Package_List.size(); i++) {
						if (!((String)(PRS_ServiceIncident.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(PRS_ServiceIncident.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							PRS_ServiceIncident.Java_Package_List.setElementAt((String)(PRS_ServiceIncident.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class PRS_ServiceIncident.");
						resultArrayList.add(new PRS_ServiceIncident(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class PRS_ServiceIncident.");
						resultArrayList.add(new PRS_ServiceIncident(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class PRS_ServiceIncident.");
						resultArrayList.add(new PRS_ServiceIncident(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static PRS_ServiceIncident getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return PRS_ServiceIncidentHelper.getInstance(cimClient, new PRS_ServiceIncident(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static PRS_ServiceIncident getInstance(CIMClient cimClient, PRS_ServiceIncident dataInstance) {
		...
		return PRS_ServiceIncidentHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static PRS_ServiceIncident getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		PRS_ServiceIncident dataInstance = null;
		try {
			dataInstance = new PRS_ServiceIncident(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static PRS_ServiceIncident createInstance(CIMClient cimClient, PRS_ServiceIncident dataInstance, boolean notifyDifferencies){ 
		...
		PRS_ServiceIncident newDataInstance = null;
		try {
			newDataInstance = PRS_ServiceIncidentHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static PRS_ServiceIncident modifyInstance(CIMClient cimClient, PRS_ServiceIncident dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = PRS_ServiceIncidentHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, PRS_ServiceIncident dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, PRS_ServiceIncident dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					PRS_ServiceIncident.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!PRS_ServiceIncident.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < PRS_ServiceIncident.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(PRS_ServiceIncident.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(PRS_ServiceIncident.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Acknowledge(UnsignedInt8 Acknowledge) {
		return true;
	}
	...
	public static boolean isValid_CurrentState(UnsignedInt8 CurrentState) {
		return true;
	}

	public static boolean isValid_Entitled(UnsignedInt8 Entitled) {
		return true;
	}

	public static boolean isValid_LastTransaction(UnsignedInt8 LastTransaction) {
		return true;
	}

	public static boolean isValid_ProviderID(String ProviderID) {
		return true;
	}

	public static boolean isValid_ProviderPriority(UnsignedInt8 ProviderPriority) {
		return true;
	}

	public static boolean isValid_RequesterID(String RequesterID) {
		return true;
	}

	public static boolean isValid_RequesterSeverity(UnsignedInt8 RequesterSeverity) {
		return true;
	}

	public static boolean isValid_ResponseTime(Calendar ResponseTime) {
		return true;
	}

	public static boolean isValid_TransactionName(String TransactionName) {
		return true;
	}

	public static boolean isValid_WorkflowStatus(String WorkflowStatus) {
		return true;
	}
