...
public class CIM_SystemConfigurationHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SystemConfiguration.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_SystemConfiguration.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_SystemConfiguration.");
                        resultArrayList.add(new CIM_SystemConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SystemConfiguration.");
                        resultArrayList.add(new CIM_SystemConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SystemConfiguration.");
                        resultArrayList.add(new CIM_SystemConfiguration(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SystemConfiguration getInstance(WBEMClient client,
    ...
    public final static CIM_SystemConfiguration getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_SystemConfiguration.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemConfiguration.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_SystemConfiguration.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemConfiguration.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_SystemConfiguration.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemConfiguration.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[3] = new CIMProperty(CIM_SystemConfiguration.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_SystemConfiguration.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_SystemConfiguration createInstance(WBEMClient client,
            CIM_SystemConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_SystemConfiguration newDataInstance = CIM_SystemConfigurationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SystemConfiguration modifyInstance(WBEMClient client,
            CIM_SystemConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SystemConfiguration dataInstance2 = CIM_SystemConfigurationHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SystemConfiguration dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SystemConfiguration.getPackages());
    }
