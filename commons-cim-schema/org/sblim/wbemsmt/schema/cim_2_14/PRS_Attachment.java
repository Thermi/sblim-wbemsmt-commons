 ...
 *
 *
 * Description:  PRS_Attachment describes file attachments. A PRS_Attachment may be associated
 * to any object derived from PRS_ExchangeElement. PRS_Attachment is used to
 * attach objects of any type including binary files, ASCII documents, or URLs.
 * Only one object may be attached per PRS_Attachment. The actual attachment
 * carried by the Attachment object is included by one of two methods: by
 * reference or by value as embedded data. A 'by reference' approach links
 * indirectly to the attachment through the use of a string identifier, e.g. a
 * file name. An 'embedded data' approach means the actual binary data is
 * included in PRS_Attachment.
 * 
 */
...
/**
 *  PRS_Attachment describes file attachments. A PRS_Attachment may be associated
 * to any object derived from PRS_ExchangeElement. PRS_Attachment is used to
 * attach objects of any type including binary files, ASCII documents, or URLs.
 * Only one object may be attached per PRS_Attachment. The actual attachment
 * carried by the Attachment object is included by one of two methods: by
...
public class PRS_Attachment extends PRS_ExchangeElement  {
	...
	public final static String CIM_CLASS_NAME = "PRS_Attachment"; //$NON-NLS-1$
