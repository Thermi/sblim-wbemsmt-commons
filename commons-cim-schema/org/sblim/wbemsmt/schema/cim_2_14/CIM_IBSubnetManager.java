 ...
 *
 *
 * Description:  An Infiniband Subnet Manager (SM) is an entity responsible for configuring and
 * managing an IB subnet. It uses Subnet Management Agents (SMA) to access and
 * manage individual nodes. The SM is hosted in the context of a specific
 * computer system (i.e., hosted by an instance of UnitaryComputerSystem), as
 * described by the HostedService association. Note that there may be multiple
 * SMs operating in a subnet, but only the elected master is allowed to perform
...
/**
 *  An Infiniband Subnet Manager (SM) is an entity responsible for configuring and
 * managing an IB subnet. It uses Subnet Management Agents (SMA) to access and
 * manage individual nodes. The SM is hosted in the context of a specific
 * computer system (i.e., hosted by an instance of UnitaryComputerSystem), as
 * described by the HostedService association. Note that there may be multiple
...
public class CIM_IBSubnetManager extends CIM_Service  {
	...
	public final static String CIM_CLASS_NAME = "CIM_IBSubnetManager"; //$NON-NLS-1$
