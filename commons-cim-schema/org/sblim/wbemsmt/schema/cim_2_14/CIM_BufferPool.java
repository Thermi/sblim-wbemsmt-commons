 ...
 *
 *
 * Description:  This class represents the use of buffers by a Queuing Service. The existence
 * and management of individual buffers will be modeled in a future release. At
 * the current level of abstraction, modeling the existence of the BufferPool is
 * necessary. Long term, it is not sufficient. In implementations where there
 * are multiple buffer sizes, an instance of BufferPool should be defined for
 * each set of buffers with identical or similar sizes. These instances of
 * buffer pools can then be grouped together using the CollectedBuffersPool
 * association. Note that this class is derived from CollectionOfMSEs, and not
 * from Forwarding or ConditioningService. BufferPool is only a collection of
...
/**
 *  This class represents the use of buffers by a Queuing Service. The existence
 * and management of individual buffers will be modeled in a future release. At
 * the current level of abstraction, modeling the existence of the BufferPool is
 * necessary. Long term, it is not sufficient. In implementations where there
 * are multiple buffer sizes, an instance of BufferPool should be defined for
...
public class CIM_BufferPool extends CIM_CollectionOfMSEs  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BufferPool"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.6.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_COLLECTEDBUFFERPOOL = "CIM_CollectedBufferPool"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_QUEUEALLOCATION = "CIM_QueueAllocation"; //$NON-NLS-1$
