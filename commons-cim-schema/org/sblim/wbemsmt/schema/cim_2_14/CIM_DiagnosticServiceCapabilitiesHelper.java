/** 
 * CIM_DiagnosticServiceCapabilitiesHelper.java
 *
...
public final class CIM_DiagnosticServiceCapabilitiesHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_DiagnosticServiceCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_DiagnosticServiceCapabilities.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DiagnosticServiceCapabilities.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_DiagnosticServiceCapabilities.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_DiagnosticServiceCapabilities.Java_Package_List.setElementAt((String)(CIM_DiagnosticServiceCapabilities.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_DiagnosticServiceCapabilities.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DiagnosticServiceCapabilities.");
						resultArrayList.add(new CIM_DiagnosticServiceCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DiagnosticServiceCapabilities.");
						resultArrayList.add(new CIM_DiagnosticServiceCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DiagnosticServiceCapabilities.");
						resultArrayList.add(new CIM_DiagnosticServiceCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DiagnosticServiceCapabilities getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DiagnosticServiceCapabilitiesHelper.getInstance(cimClient, new CIM_DiagnosticServiceCapabilities(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticServiceCapabilities getInstance(CIMClient cimClient, CIM_DiagnosticServiceCapabilities dataInstance) {
		...
		return CIM_DiagnosticServiceCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticServiceCapabilities getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DiagnosticServiceCapabilities dataInstance = null;
		try {
			dataInstance = new CIM_DiagnosticServiceCapabilities(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticServiceCapabilities createInstance(CIMClient cimClient, CIM_DiagnosticServiceCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DiagnosticServiceCapabilities newDataInstance = null;
		try {
			newDataInstance = CIM_DiagnosticServiceCapabilitiesHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticServiceCapabilities modifyInstance(CIMClient cimClient, CIM_DiagnosticServiceCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DiagnosticServiceCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DiagnosticServiceCapabilities dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DiagnosticServiceCapabilities dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DiagnosticServiceCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DiagnosticServiceCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DiagnosticServiceCapabilities.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DiagnosticServiceCapabilities.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DiagnosticServiceCapabilities.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_OtherSupportedExecutionControlsDescriptions(String[] OtherSupportedExecutionControlsDescriptions) {
		return true;
	}

	public static boolean isValid_OtherSupportedLogOptionsDescriptions(String[] OtherSupportedLogOptionsDescriptions) {
		return true;
	}

	public static boolean isValid_OtherSupportedLogStorageDescriptions(String[] OtherSupportedLogStorageDescriptions) {
		return true;
	}

	public static boolean isValid_OtherSupportedLoopControlDescriptions(String[] OtherSupportedLoopControlDescriptions) {
		return true;
	}

	public static boolean isValid_OtherSupportedServiceModesDescriptions(String[] OtherSupportedServiceModesDescriptions) {
		return true;
	}

	public static boolean isValid_SupportedExecutionControls(UnsignedInt16[] SupportedExecutionControls) {
		return true;
	}

	public static boolean isValid_SupportedLogOptions(UnsignedInt16[] SupportedLogOptions) {
		return true;
	}

	public static boolean isValid_SupportedLogStorage(UnsignedInt16[] SupportedLogStorage) {
		return true;
	}

	public static boolean isValid_SupportedLoopControl(UnsignedInt16[] SupportedLoopControl) {
		return true;
	}

	public static boolean isValid_SupportedServiceModes(UnsignedInt16[] SupportedServiceModes) {
		return true;
	}

	public static boolean isValid_SupportedTestWarnings(UnsignedInt16 SupportedTestWarnings) {
		return true;
	}
