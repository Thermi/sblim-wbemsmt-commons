/** 
 * CIM_AssociatedCacheMemoryHelper.java
 *
...
public final class CIM_AssociatedCacheMemoryHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_AssociatedCacheMemory.Java_Package_List.size(); i++) {
						if (!((String)(CIM_AssociatedCacheMemory.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_AssociatedCacheMemory.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_AssociatedCacheMemory.Java_Package_List.setElementAt((String)(CIM_AssociatedCacheMemory.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_AssociatedCacheMemory.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AssociatedCacheMemory.");
						resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AssociatedCacheMemory.");
						resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AssociatedCacheMemory.");
						resultArrayList.add(new CIM_AssociatedCacheMemory(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_AssociatedCacheMemory getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_AssociatedCacheMemoryHelper.getInstance(cimClient, new CIM_AssociatedCacheMemory(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AssociatedCacheMemory getInstance(CIMClient cimClient, CIM_AssociatedCacheMemory dataInstance) {
		...
		return CIM_AssociatedCacheMemoryHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AssociatedCacheMemory getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_AssociatedCacheMemory dataInstance = null;
		try {
			dataInstance = new CIM_AssociatedCacheMemory(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AssociatedCacheMemory createInstance(CIMClient cimClient, CIM_AssociatedCacheMemory dataInstance, boolean notifyDifferencies){ 
		...
		CIM_AssociatedCacheMemory newDataInstance = null;
		try {
			newDataInstance = CIM_AssociatedCacheMemoryHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AssociatedCacheMemory modifyInstance(CIMClient cimClient, CIM_AssociatedCacheMemory dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_AssociatedCacheMemoryHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_AssociatedCacheMemory dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_AssociatedCacheMemory dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_AssociatedCacheMemory.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_AssociatedCacheMemory.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_AssociatedCacheMemory.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_AssociatedCacheMemory.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_AssociatedCacheMemory.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Associativity(UnsignedInt16 Associativity) {
		return true;
	}

	public static boolean isValid_CacheType(UnsignedInt16 CacheType) {
		return true;
	}

	public static boolean isValid_FlushTimer(UnsignedInt32 FlushTimer) {
		return true;
	}

	public static boolean isValid_Level(UnsignedInt16 Level) {
		return true;
	}

	public static boolean isValid_LineSize(UnsignedInt32 LineSize) {
		return true;
	}

	public static boolean isValid_OtherAssociativityDescription(String OtherAssociativityDescription) {
		return true;
	}

	public static boolean isValid_OtherCacheTypeDescription(String OtherCacheTypeDescription) {
		return true;
	}

	public static boolean isValid_OtherLevelDescription(String OtherLevelDescription) {
		return true;
	}

	public static boolean isValid_OtherReadPolicyDescription(String OtherReadPolicyDescription) {
		return true;
	}

	public static boolean isValid_OtherReplacementPolicyDescription(String OtherReplacementPolicyDescription) {
		return true;
	}

	public static boolean isValid_OtherWritePolicyDescription(String OtherWritePolicyDescription) {
		return true;
	}

	public static boolean isValid_ReadPolicy(UnsignedInt16 ReadPolicy) {
		return true;
	}

	public static boolean isValid_ReplacementPolicy(UnsignedInt16 ReplacementPolicy) {
		return true;
	}

	public static boolean isValid_WritePolicy(UnsignedInt16 WritePolicy) {
		return true;
	}
