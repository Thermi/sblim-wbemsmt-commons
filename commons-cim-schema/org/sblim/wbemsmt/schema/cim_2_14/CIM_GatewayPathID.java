 ...
 *
 *
 * Description:  GatewayPathID extends StorageHardwareID to name a path segment defined by the
 * end identities, HardwareID and GatewayID. The purpose is to describe Identity
 * to allow access control to be applied to a particular path segment. Think of
 * the element identified by GatewayPathID as a Gateway between a non-trusted
...
/**
 *  GatewayPathID extends StorageHardwareID to name a path segment defined by the
 * end identities, HardwareID and GatewayID. The purpose is to describe Identity
 * to allow access control to be applied to a particular path segment. Think of
 * the element identified by GatewayPathID as a Gateway between a non-trusted
 * world and a trusted world.
...
public class CIM_GatewayPathID extends CIM_StorageHardwareID  {
	...
	public final static String CIM_CLASS_NAME = "CIM_GatewayPathID"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_StorageHardwareID.Java_Package_List.size(); i++) {
			if (((String)CIM_StorageHardwareID.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
	...
	public final static String[] CIM_VALUEMAP_GATEWAYIDTYPE = {"Other","PortWWN","NodeWWN","Hostname","iSCSI Name"};
	...
	public final static int GATEWAYIDTYPE_ISCSINAME = 5;
