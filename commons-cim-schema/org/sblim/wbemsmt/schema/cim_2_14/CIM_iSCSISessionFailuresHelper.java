/** 
 * CIM_iSCSISessionFailuresHelper.java
 *
...
public final class CIM_iSCSISessionFailuresHelper {

	public final static String CIM_CLASS_NAME = "CIM_iSCSISessionFailures";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_iSCSISessionFailures(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_iSCSISessionFailures.Java_Package_List.size(); i++) {
						if (!((String)(CIM_iSCSISessionFailures.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_iSCSISessionFailures.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_iSCSISessionFailures.Java_Package_List.setElementAt((String)(CIM_iSCSISessionFailures.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_iSCSISessionFailures.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_iSCSISessionFailures.");
						resultArrayList.add(new CIM_iSCSISessionFailures(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_iSCSISessionFailures.");
						resultArrayList.add(new CIM_iSCSISessionFailures(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_iSCSISessionFailures.");
						resultArrayList.add(new CIM_iSCSISessionFailures(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_iSCSISessionFailures getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_iSCSISessionFailuresHelper.getInstance(cimClient, new CIM_iSCSISessionFailures(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSISessionFailures getInstance(CIMClient cimClient, CIM_iSCSISessionFailures dataInstance) {
		...
		return CIM_iSCSISessionFailuresHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSISessionFailures getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_iSCSISessionFailures dataInstance = null;
		try {
			dataInstance = new CIM_iSCSISessionFailures(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSISessionFailures createInstance(CIMClient cimClient, CIM_iSCSISessionFailures dataInstance, boolean notifyDifferencies){ 
		...
		CIM_iSCSISessionFailures newDataInstance = null;
		try {
			newDataInstance = CIM_iSCSISessionFailuresHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSISessionFailures modifyInstance(CIMClient cimClient, CIM_iSCSISessionFailures dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_iSCSISessionFailuresHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_iSCSISessionFailures dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_iSCSISessionFailures dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_iSCSISessionFailures.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_iSCSISessionFailures.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_iSCSISessionFailures.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_iSCSISessionFailures.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_iSCSISessionFailures.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_LastSessionFailureRemoteNodeName(String LastSessionFailureRemoteNodeName) {
		return true;
	}

	public static boolean isValid_LastSessionFailureType(UnsignedInt16 LastSessionFailureType) {
		return true;
	}

	public static boolean isValid_OtherLastSessionFailureType(String OtherLastSessionFailureType) {
		return true;
	}

	public static boolean isValid_SessionConnectionTimeoutFailures(UnsignedInt64 SessionConnectionTimeoutFailures) {
		return true;
	}

	public static boolean isValid_SessionDigestFailures(UnsignedInt64 SessionDigestFailures) {
		return true;
	}

	public static boolean isValid_SessionFailures(UnsignedInt64 SessionFailures) {
		return true;
	}

	public static boolean isValid_SessionFormatErrors(UnsignedInt64 SessionFormatErrors) {
		return true;
	}
