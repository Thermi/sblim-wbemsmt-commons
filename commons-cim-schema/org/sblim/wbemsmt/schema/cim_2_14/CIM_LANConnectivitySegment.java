 ...
 *
 *
 * Description:  A collection of LAN Endpoints of a particular type (i.e., Ethernet or Token
 * Ring), that are able to intercommunicate without the assistance of bridging
 * or routing services.
 * 
 */
...
public class CIM_LANConnectivitySegment extends CIM_ConnectivityCollection  {
	...
	public final static String CIM_CLASS_NAME = "CIM_LANConnectivitySegment"; //$NON-NLS-1$
