/** 
 * CIM_StorageCapabilitiesHelper.java
 *
...
public final class CIM_StorageCapabilitiesHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StorageCapabilities.");
						resultArrayList.add(new CIM_StorageCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StorageCapabilities.");
						resultArrayList.add(new CIM_StorageCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StorageCapabilities.");
						resultArrayList.add(new CIM_StorageCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StorageCapabilities getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StorageCapabilitiesHelper.getInstance(cimClient, new CIM_StorageCapabilities(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageCapabilities getInstance(CIMClient cimClient, CIM_StorageCapabilities dataInstance) {
		...
		return CIM_StorageCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageCapabilities getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StorageCapabilities dataInstance = null;
		try {
			dataInstance = new CIM_StorageCapabilities(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StorageCapabilities createInstance(CIMClient cimClient, CIM_StorageCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StorageCapabilities newDataInstance = null;
		try {
			newDataInstance = CIM_StorageCapabilitiesHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StorageCapabilities modifyInstance(CIMClient cimClient, CIM_StorageCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StorageCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StorageCapabilities dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StorageCapabilities dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StorageCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StorageCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StorageCapabilities.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StorageCapabilities.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StorageCapabilities.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DataRedundancyDefault(UnsignedInt16 DataRedundancyDefault) {
		return true;
	}

	public static boolean isValid_DataRedundancyMax(UnsignedInt16 DataRedundancyMax) {
		return true;
	}

	public static boolean isValid_DataRedundancyMin(UnsignedInt16 DataRedundancyMin) {
		return true;
	}

	public static boolean isValid_DeltaReservationDefault(UnsignedInt16 DeltaReservationDefault) {
		return true;
	}

	public static boolean isValid_DeltaReservationMax(UnsignedInt16 DeltaReservationMax) {
		return true;
	}

	public static boolean isValid_DeltaReservationMin(UnsignedInt16 DeltaReservationMin) {
		return true;
	}
	...
	public static boolean isValid_ExtentStripeLengthDefault(UnsignedInt16 ExtentStripeLengthDefault) {
		return true;
	}

	public static boolean isValid_NoSinglePointOfFailure(Boolean NoSinglePointOfFailure) {
		return true;
	}

	public static boolean isValid_NoSinglePointOfFailureDefault(Boolean NoSinglePointOfFailureDefault) {
		return true;
	}

	public static boolean isValid_PackageRedundancyDefault(UnsignedInt16 PackageRedundancyDefault) {
		return true;
	}

	public static boolean isValid_PackageRedundancyMax(UnsignedInt16 PackageRedundancyMax) {
		return true;
	}

	public static boolean isValid_PackageRedundancyMin(UnsignedInt16 PackageRedundancyMin) {
		return true;
	}

	public static boolean isValid_ParityLayoutDefault(UnsignedInt16 ParityLayoutDefault) {
		return true;
	}

	public static boolean isValid_UserDataStripeDepthDefault(UnsignedInt64 UserDataStripeDepthDefault) {
		return true;
	}
