/** 
 * CIM_SwitchPortSourceRoutingHelper.java
 *
...
public final class CIM_SwitchPortSourceRoutingHelper {

	public final static String CIM_CLASS_NAME = "CIM_SwitchPortSourceRouting";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_SwitchPortSourceRouting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_SwitchPortSourceRouting.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SwitchPortSourceRouting.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_SwitchPortSourceRouting.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_SwitchPortSourceRouting.Java_Package_List.setElementAt((String)(CIM_SwitchPortSourceRouting.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_SwitchPortSourceRouting.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SwitchPortSourceRouting.");
						resultArrayList.add(new CIM_SwitchPortSourceRouting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SwitchPortSourceRouting.");
						resultArrayList.add(new CIM_SwitchPortSourceRouting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SwitchPortSourceRouting.");
						resultArrayList.add(new CIM_SwitchPortSourceRouting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SwitchPortSourceRouting getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SwitchPortSourceRoutingHelper.getInstance(cimClient, new CIM_SwitchPortSourceRouting(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchPortSourceRouting getInstance(CIMClient cimClient, CIM_SwitchPortSourceRouting dataInstance) {
		...
		return CIM_SwitchPortSourceRoutingHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchPortSourceRouting getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SwitchPortSourceRouting dataInstance = null;
		try {
			dataInstance = new CIM_SwitchPortSourceRouting(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchPortSourceRouting createInstance(CIMClient cimClient, CIM_SwitchPortSourceRouting dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SwitchPortSourceRouting newDataInstance = null;
		try {
			newDataInstance = CIM_SwitchPortSourceRoutingHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchPortSourceRouting modifyInstance(CIMClient cimClient, CIM_SwitchPortSourceRouting dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SwitchPortSourceRoutingHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SwitchPortSourceRouting dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SwitchPortSourceRouting dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SwitchPortSourceRouting.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SwitchPortSourceRouting.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SwitchPortSourceRouting.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SwitchPortSourceRouting.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SwitchPortSourceRouting.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BridgeNum(UnsignedInt16 BridgeNum) {
		return true;
	}

	public static boolean isValid_HopCount(UnsignedInt16 HopCount) {
		return true;
	}

	public static boolean isValid_LocalSegment(UnsignedInt16 LocalSegment) {
		return true;
	}

	public static boolean isValid_STESpanMode(UnsignedInt16 STESpanMode) {
		return true;
	}

	public static boolean isValid_TargetSegment(UnsignedInt16 TargetSegment) {
		return true;
	}
	...
	public static boolean isValid_CIM_SourceRoutingService(CIM_SourceRoutingService CIM_SourceRoutingService) {
		return true;
	}
