 ...
 * PolicyActions that have not been modeled with specific properties. Instead,
 * the two properties ActionData and ActionEncoding are used to define the
 * content and format of the Action, as explained below. As its name suggests,
 * VendorPolicyAction is intended for vendor-specific extensions to the Policy
 * Core Information Model. Standardized extensions are not expected to use this
 * class.
 * 
 */
...
public class CIM_VendorPolicyAction extends CIM_PolicyAction  {
	...
	public final static String CIM_CLASS_NAME = "CIM_VendorPolicyAction"; //$NON-NLS-1$
