 ...
 *
 *
 * Description:  This is a specialization of the Component aggregation. This aggregation defines
 * the set of BGPPathAttributes that are transmitted in per-path UPDATE
 * messages. The association is deprecated since it is incorrectly defined as a
 * Component relationship, and since the properties of BGPPathAttribute are
 * path/endpoint-specific (not defined at the level of the Service).
 * 
 */
...
/**
 *  This is a specialization of the Component aggregation. This aggregation defines
 * the set of BGPPathAttributes that are transmitted in per-path UPDATE
 * messages. The association is deprecated since it is incorrectly defined as a
 * Component relationship, and since the properties of BGPPathAttribute are
 * path/endpoint-specific (not defined at the level of the Service).
...
public class CIM_BGPServiceAttributes extends CIM_Component  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BGPServiceAttributes"; //$NON-NLS-1$
