/** 
 * CIM_AccessControlInformationHelper.java
 *
...
public final class CIM_AccessControlInformationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AccessControlInformation.");
						resultArrayList.add(new CIM_AccessControlInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AccessControlInformation.");
						resultArrayList.add(new CIM_AccessControlInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AccessControlInformation.");
						resultArrayList.add(new CIM_AccessControlInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_AccessControlInformation getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_AccessControlInformationHelper.getInstance(cimClient, new CIM_AccessControlInformation(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AccessControlInformation getInstance(CIMClient cimClient, CIM_AccessControlInformation dataInstance) {
		...
		return CIM_AccessControlInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AccessControlInformation getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_AccessControlInformation dataInstance = null;
		try {
			dataInstance = new CIM_AccessControlInformation(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AccessControlInformation createInstance(CIMClient cimClient, CIM_AccessControlInformation dataInstance, boolean notifyDifferencies){ 
		...
		CIM_AccessControlInformation newDataInstance = null;
		try {
			newDataInstance = CIM_AccessControlInformationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AccessControlInformation modifyInstance(CIMClient cimClient, CIM_AccessControlInformation dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_AccessControlInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_AccessControlInformation dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_AccessControlInformation dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_AccessControlInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_AccessControlInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_AccessControlInformation.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_AccessControlInformation.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_AccessControlInformation.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AccessQualifier(String[] AccessQualifier) {
		return true;
	}

	public static boolean isValid_AccessType(String[] AccessType) {
		return true;
	}
	...
	public static boolean isValid_Permission(String[] Permission) {
		return true;
	}

	public static boolean isValid_SecurityClassification(String SecurityClassification) {
		return true;
	}
