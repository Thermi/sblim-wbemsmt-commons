/** 
 * CIM_StatisticsCollectionHelper.java
 *
...
public final class CIM_StatisticsCollectionHelper {

	public final static String CIM_CLASS_NAME = "CIM_StatisticsCollection";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StatisticsCollection.");
						resultArrayList.add(new CIM_StatisticsCollection(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StatisticsCollection.");
						resultArrayList.add(new CIM_StatisticsCollection(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StatisticsCollection.");
						resultArrayList.add(new CIM_StatisticsCollection(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StatisticsCollection getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StatisticsCollectionHelper.getInstance(cimClient, new CIM_StatisticsCollection(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StatisticsCollection getInstance(CIMClient cimClient, CIM_StatisticsCollection dataInstance) {
		...
		return CIM_StatisticsCollectionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StatisticsCollection getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StatisticsCollection dataInstance = null;
		try {
			dataInstance = new CIM_StatisticsCollection(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StatisticsCollection createInstance(CIMClient cimClient, CIM_StatisticsCollection dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StatisticsCollection newDataInstance = null;
		try {
			newDataInstance = CIM_StatisticsCollectionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StatisticsCollection modifyInstance(CIMClient cimClient, CIM_StatisticsCollection dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StatisticsCollectionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StatisticsCollection dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StatisticsCollection dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StatisticsCollection.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StatisticsCollection.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StatisticsCollection.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StatisticsCollection.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StatisticsCollection.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_SampleInterval(Calendar SampleInterval) {
		return true;
	}

	public static boolean isValid_TimeLastSampled(Calendar TimeLastSampled) {
		return true;
	}
