/** 
 * CIM_BGPServiceStatisticsHelper.java
 *
...
public final class CIM_BGPServiceStatisticsHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_BGPServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_BGPServiceStatistics.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BGPServiceStatistics.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_BGPServiceStatistics.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_BGPServiceStatistics.Java_Package_List.setElementAt((String)(CIM_BGPServiceStatistics.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_BGPServiceStatistics.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BGPServiceStatistics.");
						resultArrayList.add(new CIM_BGPServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BGPServiceStatistics.");
						resultArrayList.add(new CIM_BGPServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BGPServiceStatistics.");
						resultArrayList.add(new CIM_BGPServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BGPServiceStatistics getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BGPServiceStatisticsHelper.getInstance(cimClient, new CIM_BGPServiceStatistics(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPServiceStatistics getInstance(CIMClient cimClient, CIM_BGPServiceStatistics dataInstance) {
		...
		return CIM_BGPServiceStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPServiceStatistics getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BGPServiceStatistics dataInstance = null;
		try {
			dataInstance = new CIM_BGPServiceStatistics(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPServiceStatistics createInstance(CIMClient cimClient, CIM_BGPServiceStatistics dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BGPServiceStatistics newDataInstance = null;
		try {
			newDataInstance = CIM_BGPServiceStatisticsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPServiceStatistics modifyInstance(CIMClient cimClient, CIM_BGPServiceStatistics dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BGPServiceStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BGPServiceStatistics dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BGPServiceStatistics dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BGPServiceStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BGPServiceStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BGPServiceStatistics.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BGPServiceStatistics.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BGPServiceStatistics.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CIM_BGPStatistics(CIM_BGPStatistics CIM_BGPStatistics) {
		return true;
	}
