...
public final class CIM_PickerElementHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PickerElement.");
						resultArrayList.add(new CIM_PickerElement(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PickerElement.");
						resultArrayList.add(new CIM_PickerElement(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PickerElement.");
						resultArrayList.add(new CIM_PickerElement(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PickerElement getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PickerElementHelper.getInstance(cimClient, new CIM_PickerElement(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PickerElement getInstance(CIMClient cimClient, CIM_PickerElement dataInstance) {
		...
		return CIM_PickerElementHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PickerElement getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PickerElement dataInstance = null;
		try {
			dataInstance = new CIM_PickerElement(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PickerElement createInstance(CIMClient cimClient, CIM_PickerElement dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PickerElement newDataInstance = null;
		try {
			newDataInstance = CIM_PickerElementHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PickerElement modifyInstance(CIMClient cimClient, CIM_PickerElement dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PickerElementHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PickerElement dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PickerElement dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PickerElement.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PickerElement.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PickerElement.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PickerElement.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PickerElement.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CellLocation(String CellLocation) {
		return true;
	}

	public static boolean isValid_MaxPickTime(UnsignedInt32 MaxPickTime) {
		return true;
	}

	public static boolean isValid_MaxPutTime(UnsignedInt32 MaxPutTime) {
		return true;
	}
