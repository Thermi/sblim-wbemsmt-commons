 ...
 *
 *
 * Description:  PointingDevice represents those Devices used to 'point' to regions of a
 * Display.
 * 
 */
...
/**
 *  PointingDevice represents those Devices used to 'point' to regions of a
 * Display.
 */
public class CIM_PointingDevice extends CIM_UserDevice  {
	
	public final static String CIM_CLASS_NAME = "CIM_PointingDevice"; //$NON-NLS-1$
