 ...
 *
 *
 * Description:  Specific diagnostic test parameters and execution instructions are defined by
 * this class. To provide more detailed Settings for a type of test (i.e.,
 * additional properties), subclassing is appropriate.
 * 
 */
...
/**
 *  Specific diagnostic test parameters and execution instructions are defined by
 * this class. To provide more detailed Settings for a type of test (i.e.,
 * additional properties), subclassing is appropriate.
 */
public class CIM_DiagnosticSetting extends CIM_Setting  {
	
	public final static String CIM_CLASS_NAME = "CIM_DiagnosticSetting"; //$NON-NLS-1$
