 ...
 *
 *
 * Description:  CIM_MoreGroupInfo is an association used to extend the information in a
 * CIM_Group class instance.
 * 
 */
...
/**
 *  CIM_MoreGroupInfo is an association used to extend the information in a
 * CIM_Group class instance.
 */
public class CIM_MoreGroupInfo extends CIM_Dependency  {
	
	public final static String CIM_CLASS_NAME = "CIM_MoreGroupInfo"; //$NON-NLS-1$
