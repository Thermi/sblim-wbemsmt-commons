 ...
 * and NumericSensor. A CurrentSensor can be defined by setting the SensorType
 * property, inherited from Sensor, to 4 ("Current").
 * 
 */
...
public class CIM_CurrentSensor extends CIM_NumericSensor  {
	...
	public final static String CIM_CLASS_NAME = "CIM_CurrentSensor"; //$NON-NLS-1$
