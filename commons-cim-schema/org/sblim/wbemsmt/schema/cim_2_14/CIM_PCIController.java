 ...
 *
 *
 * Description:  PCIController is a superclass for the PCIBridge and PCIDevice classes. These
 * classes model adapters and bridges on a PCI bus. The properties in
 * PCIController and its subclasses are defined in the various PCI
 * Specifications that are published by the PCI SIG.
 * 
 */
...
/**
 *  PCIController is a superclass for the PCIBridge and PCIDevice classes. These
 * classes model adapters and bridges on a PCI bus. The properties in
 * PCIController and its subclasses are defined in the various PCI
 * Specifications that are published by the PCI SIG.
 */
public class CIM_PCIController extends CIM_Controller  {
	...
	public final static String CIM_CLASS_NAME = "CIM_PCIController"; //$NON-NLS-1$
