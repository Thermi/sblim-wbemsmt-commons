...
public class CIM_RunningOSHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RunningOS.CIM_CLASS_NAME,
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_RunningOS.");
                        resultArrayList.add(new CIM_RunningOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_RunningOS.");
                        resultArrayList.add(new CIM_RunningOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RunningOS.");
                        resultArrayList.add(new CIM_RunningOS(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RunningOS getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_RunningOS getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_RunningOS getInstance(WBEMClient client, String namespace,
            CIM_OperatingSystem Antecedent, CIM_ComputerSystem Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_RunningOS.PROPERTY_ANTECEDENT_CIM_OPERATINGSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_RunningOS.PROPERTY_DEPENDENT_CIM_COMPUTERSYSTEM.NAME, new CIMDataType(
     ...
     *
     */
    public final static CIM_RunningOS createInstance(WBEMClient client, CIM_RunningOS dataInstance,
     ...
     */
    public final static CIM_RunningOS modifyInstance(WBEMClient client, CIM_RunningOS dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RunningOS dataInstance2 = CIM_RunningOSHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RunningOS dataInstance)
            throws WbemsmtException {
