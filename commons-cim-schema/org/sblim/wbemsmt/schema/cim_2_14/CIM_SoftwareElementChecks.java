 ...
 *
 *
 * Description:  This association ties a SoftwareElement to a specific Check to validate its
 * state or its movement to the next state. Note that SoftwareElements in a
 * running state cannot transition to another state. Therefore, the value of the
 * Phase property is restricted to 0 ("In-State") for SoftwareElements in the
 * running state.
 * 
 */
...
/**
 *  This association ties a SoftwareElement to a specific Check to validate its
 * state or its movement to the next state. Note that SoftwareElements in a
 * running state cannot transition to another state. Therefore, the value of the
 * Phase property is restricted to 0 ("In-State") for SoftwareElements in the
 * running state.
...
public class CIM_SoftwareElementChecks  {
	...
	public final static String CIM_CLASS_NAME = "CIM_SoftwareElementChecks"; //$NON-NLS-1$
