 ...
 *
 *
 * Description:  IPAddressRange represents a grouping of specific addresses, and provides
 * additional semantics for this group if appropriate. The class is deprecated
 * in lieu of the concrete class RangeOfIPAddresses since there is sufficient
 * information for the class to be instantiated. In addition, an address range
 * should be defined in the context of a System (for example, a network element
 * or an admin domain). These semantics are incorporated in the
...
public class CIM_IPAddressRange extends CIM_CollectionOfMSEs  {
	...
	public final static String CIM_CLASS_NAME = "CIM_IPAddressRange"; //$NON-NLS-1$
