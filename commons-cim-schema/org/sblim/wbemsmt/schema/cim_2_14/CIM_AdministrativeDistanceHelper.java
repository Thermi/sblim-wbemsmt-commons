/** 
 * CIM_AdministrativeDistanceHelper.java
 *
...
public final class CIM_AdministrativeDistanceHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_AdministrativeDistance.Java_Package_List.size(); i++) {
						if (!((String)(CIM_AdministrativeDistance.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_AdministrativeDistance.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_AdministrativeDistance.Java_Package_List.setElementAt((String)(CIM_AdministrativeDistance.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AdministrativeDistance.");
						resultArrayList.add(new CIM_AdministrativeDistance(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AdministrativeDistance.");
						resultArrayList.add(new CIM_AdministrativeDistance(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AdministrativeDistance.");
						resultArrayList.add(new CIM_AdministrativeDistance(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_AdministrativeDistance getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_AdministrativeDistanceHelper.getInstance(cimClient, new CIM_AdministrativeDistance(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AdministrativeDistance getInstance(CIMClient cimClient, CIM_AdministrativeDistance dataInstance) {
		...
		return CIM_AdministrativeDistanceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AdministrativeDistance getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_AdministrativeDistance dataInstance = null;
		try {
			dataInstance = new CIM_AdministrativeDistance(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AdministrativeDistance createInstance(CIMClient cimClient, CIM_AdministrativeDistance dataInstance, boolean notifyDifferencies){ 
		...
		CIM_AdministrativeDistance newDataInstance = null;
		try {
			newDataInstance = CIM_AdministrativeDistanceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AdministrativeDistance modifyInstance(CIMClient cimClient, CIM_AdministrativeDistance dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_AdministrativeDistanceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_AdministrativeDistance dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_AdministrativeDistance dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_AdministrativeDistance.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_AdministrativeDistance.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_AdministrativeDistance.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_AdministrativeDistance.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_AdministrativeDistance.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BGPLocal(UnsignedInt8 BGPLocal) {
		return true;
	}
	...
	public static boolean isValid_DirectConnect(UnsignedInt8 DirectConnect) {
		return true;
	}

	public static boolean isValid_EBGP(UnsignedInt8 EBGP) {
		return true;
	}

	public static boolean isValid_EGP(UnsignedInt8 EGP) {
		return true;
	}

	public static boolean isValid_EIGRPExternal(UnsignedInt8 EIGRPExternal) {
		return true;
	}

	public static boolean isValid_EIGRPInternal(UnsignedInt8 EIGRPInternal) {
		return true;
	}

	public static boolean isValid_IBGP(UnsignedInt8 IBGP) {
		return true;
	}

	public static boolean isValid_IGRP(UnsignedInt8 IGRP) {
		return true;
	}

	public static boolean isValid_ISIS(UnsignedInt8 ISIS) {
		return true;
	}
	...
	public static boolean isValid_OSPF(UnsignedInt8 OSPF) {
		return true;
	}

	public static boolean isValid_RIP(UnsignedInt8 RIP) {
		return true;
	}

	public static boolean isValid_Static(UnsignedInt8 Static) {
		return true;
	}
	...
	public static boolean isValid_Unknown(UnsignedInt8 Unknown) {
		return true;
	}
