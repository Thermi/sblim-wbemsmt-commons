 ...
 *
 *
 * Description:  MessageLog represents any type of event, error or informational register or
 * chronicle. The object describes the existence of the log and its
 * characteristics. Several methods are defined for retrieving, writing and
 * deleting log entries, and maintaining the log. This type of log uses
 * iterators to access the log records, whereas its peer class, RecordLog, uses
 * more abstracted access mechanisms.
 * 
 */
...
/**
 *  MessageLog represents any type of event, error or informational register or
 * chronicle. The object describes the existence of the log and its
 * characteristics. Several methods are defined for retrieving, writing and
 * deleting log entries, and maintaining the log. This type of log uses
 * iterators to access the log records, whereas its peer class, RecordLog, uses
...
public class CIM_MessageLog extends CIM_Log  {
	...
	public final static String CIM_CLASS_NAME = "CIM_MessageLog"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_LOGINSTORAGE = "CIM_LogInStorage"; //$NON-NLS-1$
