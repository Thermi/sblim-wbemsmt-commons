/** 
 * CIM_CASignsPublicKeyCertificateHelper.java
 *
...
public final class CIM_CASignsPublicKeyCertificateHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_CASignsPublicKeyCertificate(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_CASignsPublicKeyCertificate.Java_Package_List.size(); i++) {
						if (!((String)(CIM_CASignsPublicKeyCertificate.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_CASignsPublicKeyCertificate.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_CASignsPublicKeyCertificate.Java_Package_List.setElementAt((String)(CIM_CASignsPublicKeyCertificate.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_CASignsPublicKeyCertificate.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CASignsPublicKeyCertificate.");
						resultArrayList.add(new CIM_CASignsPublicKeyCertificate(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CASignsPublicKeyCertificate.");
						resultArrayList.add(new CIM_CASignsPublicKeyCertificate(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CASignsPublicKeyCertificate.");
						resultArrayList.add(new CIM_CASignsPublicKeyCertificate(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_CASignsPublicKeyCertificate getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CASignsPublicKeyCertificateHelper.getInstance(cimClient, new CIM_CASignsPublicKeyCertificate(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CASignsPublicKeyCertificate getInstance(CIMClient cimClient, CIM_CASignsPublicKeyCertificate dataInstance) {
		...
		return CIM_CASignsPublicKeyCertificateHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CASignsPublicKeyCertificate getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_CASignsPublicKeyCertificate dataInstance = null;
		try {
			dataInstance = new CIM_CASignsPublicKeyCertificate(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CASignsPublicKeyCertificate createInstance(CIMClient cimClient, CIM_CASignsPublicKeyCertificate dataInstance, boolean notifyDifferencies){ 
		...
		CIM_CASignsPublicKeyCertificate newDataInstance = null;
		try {
			newDataInstance = CIM_CASignsPublicKeyCertificateHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CASignsPublicKeyCertificate modifyInstance(CIMClient cimClient, CIM_CASignsPublicKeyCertificate dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_CASignsPublicKeyCertificateHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_CASignsPublicKeyCertificate dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_CASignsPublicKeyCertificate dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_CASignsPublicKeyCertificate.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_CASignsPublicKeyCertificate.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_CASignsPublicKeyCertificate.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_CASignsPublicKeyCertificate.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_CASignsPublicKeyCertificate.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CRLDistributionPoint(String[] CRLDistributionPoint) {
		return true;
	}

	public static boolean isValid_Expires(Calendar Expires) {
		return true;
	}

	public static boolean isValid_SerialNumber(String SerialNumber) {
		return true;
	}

	public static boolean isValid_Signature(UnsignedInt8[] Signature) {
		return true;
	}

	public static boolean isValid_CIM_CertificateAuthority(CIM_CertificateAuthority CIM_CertificateAuthority) {
		return true;
	}

	public static boolean isValid_CIM_PublicKeyCertificate(CIM_PublicKeyCertificate CIM_PublicKeyCertificate) {
		return true;
	}
