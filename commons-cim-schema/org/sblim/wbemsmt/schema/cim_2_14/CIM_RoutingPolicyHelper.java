...
public final class CIM_RoutingPolicyHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_RoutingPolicy.Java_Package_List.size(); i++) {
						if (!((String)(CIM_RoutingPolicy.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_RoutingPolicy.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_RoutingPolicy.Java_Package_List.setElementAt((String)(CIM_RoutingPolicy.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RoutingPolicy.");
						resultArrayList.add(new CIM_RoutingPolicy(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RoutingPolicy.");
						resultArrayList.add(new CIM_RoutingPolicy(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RoutingPolicy.");
						resultArrayList.add(new CIM_RoutingPolicy(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_RoutingPolicy getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_RoutingPolicyHelper.getInstance(cimClient, new CIM_RoutingPolicy(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RoutingPolicy getInstance(CIMClient cimClient, CIM_RoutingPolicy dataInstance) {
		...
		return CIM_RoutingPolicyHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RoutingPolicy getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_RoutingPolicy dataInstance = null;
		try {
			dataInstance = new CIM_RoutingPolicy(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RoutingPolicy createInstance(CIMClient cimClient, CIM_RoutingPolicy dataInstance, boolean notifyDifferencies){ 
		...
		CIM_RoutingPolicy newDataInstance = null;
		try {
			newDataInstance = CIM_RoutingPolicyHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RoutingPolicy modifyInstance(CIMClient cimClient, CIM_RoutingPolicy dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_RoutingPolicyHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_RoutingPolicy dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_RoutingPolicy dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_RoutingPolicy.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_RoutingPolicy.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_RoutingPolicy.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_RoutingPolicy.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_RoutingPolicy.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AttributeAction(UnsignedInt16 AttributeAction) {
		return true;
	}

	public static boolean isValid_BGPAction(UnsignedInt16 BGPAction) {
		return true;
	}

	public static boolean isValid_BGPValue(String BGPValue) {
		return true;
	}

	public static boolean isValid_ConditioningAction(UnsignedInt16 ConditioningAction) {
		return true;
	}

	public static boolean isValid_ConditioningValue(String ConditioningValue) {
		return true;
	}
	...
	public static boolean isValid_OtherConditioningAction(String OtherConditioningAction) {
		return true;
	}

	public static boolean isValid_RemarkAction(UnsignedInt16 RemarkAction) {
		return true;
	}

	public static boolean isValid_RemarkValue(String RemarkValue) {
		return true;
	}
