 ...
 *
 *
 * Description:  PRS_Transaction represents a single transaction of the Service Incident
 * workflow. A PRS_Transaction instance is created by the PRS_SISService
...
/**
 *  PRS_Transaction represents a single transaction of the Service Incident
 * workflow. A PRS_Transaction instance is created by the PRS_SISService
 * StartSISTransaction method.
 */
public class PRS_Transaction extends PRS_ExchangeElement  {
	
	public final static String CIM_CLASS_NAME = "PRS_Transaction"; //$NON-NLS-1$
