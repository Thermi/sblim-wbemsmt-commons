...
public final class CIM_RegisteredProfileHelper {
	...
	*/	
	public final static CIM_RegisteredProfile getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_RegisteredProfileHelper.getInstance(cimClient, new CIM_RegisteredProfile(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RegisteredProfile getInstance(CIMClient cimClient, CIM_RegisteredProfile dataInstance) {
		...
		return CIM_RegisteredProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RegisteredProfile getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_RegisteredProfile(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RegisteredProfile createInstance(CIMClient cimClient, CIM_RegisteredProfile dataInstance, boolean notifyDifferencies){ 
		...
		CIM_RegisteredProfile newDataInstance = null;
		try {
			newDataInstance = CIM_RegisteredProfileHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RegisteredProfile modifyInstance(CIMClient cimClient, CIM_RegisteredProfile dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_RegisteredProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_RegisteredProfile dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_RegisteredProfile dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_RegisteredProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_RegisteredProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_RegisteredProfile.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_RegisteredProfile.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_RegisteredProfile.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_OtherRegisteredOrganization(String OtherRegisteredOrganization) {
		return true;
	}

	public static boolean isValid_RegisteredName(String RegisteredName) {
		return true;
	}

	public static boolean isValid_RegisteredOrganization(UnsignedInt16 RegisteredOrganization) {
		return true;
	}

	public static boolean isValid_RegisteredVersion(String RegisteredVersion) {
		return true;
	}
