...
public class CIM_RegisteredProfileHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_RegisteredProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_RegisteredProfile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_RegisteredProfile.");
                        resultArrayList.add(new CIM_RegisteredProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_RegisteredProfile.");
                        resultArrayList.add(new CIM_RegisteredProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_RegisteredProfile.");
                        resultArrayList.add(new CIM_RegisteredProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_RegisteredProfile getInstance(WBEMClient client,
     ...
     */
    public final static CIM_RegisteredProfile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_RegisteredProfile getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_RegisteredProfile.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_RegisteredProfile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_RegisteredProfile createInstance(WBEMClient client,
            CIM_RegisteredProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_RegisteredProfile newDataInstance = CIM_RegisteredProfileHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_RegisteredProfile modifyInstance(WBEMClient client,
            CIM_RegisteredProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_RegisteredProfile dataInstance2 = CIM_RegisteredProfileHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_RegisteredProfile dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_RegisteredProfile.getPackages());
    }
