 ...
 *
 *
 * Description:  This class represents statistical data and metrics that characterize the
 * application as a whole. It exists only once per application system instance
 * and provides primarily raw data for the monitoring of service levels.
 * Therefore, the metrics presented are only a summary or overview of the
 * application system behavior at a certain point of time. Instances are only
 * available if the concerned application is running. Therefore, an instance of
 * ApplicationSystem MUST exist when the instance of this class is created.
 * 
 */
...
/**
 *  This class represents statistical data and metrics that characterize the
 * application as a whole. It exists only once per application system instance
 * and provides primarily raw data for the monitoring of service levels.
 * Therefore, the metrics presented are only a summary or overview of the
 * application system behavior at a certain point of time. Instances are only
...
public class CIM_StatisticalRuntimeOverview extends CIM_StatisticalData  {
	...
	public final static String CIM_CLASS_NAME = "CIM_StatisticalRuntimeOverview"; //$NON-NLS-1$
