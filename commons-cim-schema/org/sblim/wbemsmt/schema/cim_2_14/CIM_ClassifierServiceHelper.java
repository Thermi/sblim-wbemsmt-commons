/** 
 * CIM_ClassifierServiceHelper.java
 *
...
public final class CIM_ClassifierServiceHelper {

	public final static String CIM_CLASS_NAME = "CIM_ClassifierService";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ClassifierService.");
						resultArrayList.add(new CIM_ClassifierService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ClassifierService.");
						resultArrayList.add(new CIM_ClassifierService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ClassifierService.");
						resultArrayList.add(new CIM_ClassifierService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ClassifierService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ClassifierServiceHelper.getInstance(cimClient, new CIM_ClassifierService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ClassifierService getInstance(CIMClient cimClient, CIM_ClassifierService dataInstance) {
		...
		return CIM_ClassifierServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ClassifierService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ClassifierService dataInstance = null;
		try {
			dataInstance = new CIM_ClassifierService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ClassifierService createInstance(CIMClient cimClient, CIM_ClassifierService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ClassifierService newDataInstance = null;
		try {
			newDataInstance = CIM_ClassifierServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ClassifierService modifyInstance(CIMClient cimClient, CIM_ClassifierService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ClassifierServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ClassifierService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ClassifierService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ClassifierService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ClassifierService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ClassifierService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ClassifierService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ClassifierService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
