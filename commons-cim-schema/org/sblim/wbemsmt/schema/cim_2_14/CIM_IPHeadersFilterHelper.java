/** 
 * CIM_IPHeadersFilterHelper.java
 *
...
public final class CIM_IPHeadersFilterHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_IPHeadersFilter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_IPHeadersFilter.Java_Package_List.size(); i++) {
						if (!((String)(CIM_IPHeadersFilter.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_IPHeadersFilter.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_IPHeadersFilter.Java_Package_List.setElementAt((String)(CIM_IPHeadersFilter.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_IPHeadersFilter.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_IPHeadersFilter.");
						resultArrayList.add(new CIM_IPHeadersFilter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_IPHeadersFilter.");
						resultArrayList.add(new CIM_IPHeadersFilter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IPHeadersFilter.");
						resultArrayList.add(new CIM_IPHeadersFilter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_IPHeadersFilter getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_IPHeadersFilterHelper.getInstance(cimClient, new CIM_IPHeadersFilter(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IPHeadersFilter getInstance(CIMClient cimClient, CIM_IPHeadersFilter dataInstance) {
		...
		return CIM_IPHeadersFilterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_IPHeadersFilter getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_IPHeadersFilter dataInstance = null;
		try {
			dataInstance = new CIM_IPHeadersFilter(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IPHeadersFilter createInstance(CIMClient cimClient, CIM_IPHeadersFilter dataInstance, boolean notifyDifferencies){ 
		...
		CIM_IPHeadersFilter newDataInstance = null;
		try {
			newDataInstance = CIM_IPHeadersFilterHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_IPHeadersFilter modifyInstance(CIMClient cimClient, CIM_IPHeadersFilter dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_IPHeadersFilterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_IPHeadersFilter dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_IPHeadersFilter dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_IPHeadersFilter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_IPHeadersFilter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_IPHeadersFilter.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_IPHeadersFilter.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_IPHeadersFilter.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_HdrDSCP(UnsignedInt8[] HdrDSCP) {
		return true;
	}

	public static boolean isValid_HdrDestAddressEndOfRange(UnsignedInt8[] HdrDestAddressEndOfRange) {
		return true;
	}

	public static boolean isValid_HdrDestAddress(UnsignedInt8[] HdrDestAddress) {
		return true;
	}

	public static boolean isValid_HdrDestMask(UnsignedInt8[] HdrDestMask) {
		return true;
	}

	public static boolean isValid_HdrDestPortEnd(UnsignedInt16 HdrDestPortEnd) {
		return true;
	}

	public static boolean isValid_HdrDestPortStart(UnsignedInt16 HdrDestPortStart) {
		return true;
	}

	public static boolean isValid_HdrFlowLabel(UnsignedInt8[] HdrFlowLabel) {
		return true;
	}

	public static boolean isValid_HdrIPVersion(UnsignedInt8 HdrIPVersion) {
		return true;
	}

	public static boolean isValid_HdrProtocolID(UnsignedInt8 HdrProtocolID) {
		return true;
	}

	public static boolean isValid_HdrSrcAddressEndOfRange(UnsignedInt8[] HdrSrcAddressEndOfRange) {
		return true;
	}

	public static boolean isValid_HdrSrcAddress(UnsignedInt8[] HdrSrcAddress) {
		return true;
	}

	public static boolean isValid_HdrSrcMask(UnsignedInt8[] HdrSrcMask) {
		return true;
	}

	public static boolean isValid_HdrSrcPortEnd(UnsignedInt16 HdrSrcPortEnd) {
		return true;
	}

	public static boolean isValid_HdrSrcPortStart(UnsignedInt16 HdrSrcPortStart) {
		return true;
	}
