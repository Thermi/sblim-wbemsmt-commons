 ...
 *
 *
 * Description:  This relationship associates the AccountManagement security service to the
...
/**
 *  This relationship associates the AccountManagement security service to the
 * Accounts for which it is responsible.
 */
public class CIM_ManagesAccount extends CIM_Dependency  {
	
	public final static String CIM_CLASS_NAME = "CIM_ManagesAccount"; //$NON-NLS-1$
