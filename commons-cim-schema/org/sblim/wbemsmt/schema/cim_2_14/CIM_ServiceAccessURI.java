 ...
 *
 *
 * Description:  CIM_ServiceAccessURI represents the ability to utilize or invoke a Service
 ...
 * describes the broader, inclusive URI. The following explanation is from the
 * RFC: "A Uniform Resource Identifier (URI) is a compact string of characters
 * for identifying an abstract or physical resource." In the context of a
 * ServiceAccessPoint, a URI contains the information necessary to access an
 * associated service (associated through ServiceAccessBySAP), using a syntax
 * that is specific to that service.
 * 
 */
