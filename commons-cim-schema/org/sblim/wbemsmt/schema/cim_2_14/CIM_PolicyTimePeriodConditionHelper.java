/** 
 * CIM_PolicyTimePeriodConditionHelper.java
 *
...
public final class CIM_PolicyTimePeriodConditionHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PolicyTimePeriodCondition.");
						resultArrayList.add(new CIM_PolicyTimePeriodCondition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PolicyTimePeriodCondition.");
						resultArrayList.add(new CIM_PolicyTimePeriodCondition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PolicyTimePeriodCondition.");
						resultArrayList.add(new CIM_PolicyTimePeriodCondition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PolicyTimePeriodCondition getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PolicyTimePeriodConditionHelper.getInstance(cimClient, new CIM_PolicyTimePeriodCondition(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PolicyTimePeriodCondition getInstance(CIMClient cimClient, CIM_PolicyTimePeriodCondition dataInstance) {
		...
		return CIM_PolicyTimePeriodConditionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PolicyTimePeriodCondition getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PolicyTimePeriodCondition dataInstance = null;
		try {
			dataInstance = new CIM_PolicyTimePeriodCondition(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PolicyTimePeriodCondition createInstance(CIMClient cimClient, CIM_PolicyTimePeriodCondition dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PolicyTimePeriodCondition newDataInstance = null;
		try {
			newDataInstance = CIM_PolicyTimePeriodConditionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PolicyTimePeriodCondition modifyInstance(CIMClient cimClient, CIM_PolicyTimePeriodCondition dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PolicyTimePeriodConditionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PolicyTimePeriodCondition dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PolicyTimePeriodCondition dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PolicyTimePeriodCondition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PolicyTimePeriodCondition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PolicyTimePeriodCondition.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PolicyTimePeriodCondition.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PolicyTimePeriodCondition.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DayOfMonthMask(UnsignedInt8[] DayOfMonthMask) {
		return true;
	}

	public static boolean isValid_DayOfWeekMask(UnsignedInt8[] DayOfWeekMask) {
		return true;
	}

	public static boolean isValid_LocalOrUtcTime(UnsignedInt16 LocalOrUtcTime) {
		return true;
	}

	public static boolean isValid_MonthOfYearMask(UnsignedInt8[] MonthOfYearMask) {
		return true;
	}

	public static boolean isValid_TimeOfDayMask(String TimeOfDayMask) {
		return true;
	}

	public static boolean isValid_TimePeriod(String TimePeriod) {
		return true;
	}
