/** 
 * CIM_J2eeEntityBeanStatsHelper.java
 *
...
public final class CIM_J2eeEntityBeanStatsHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_J2eeEntityBeanStats(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_J2eeEntityBeanStats.Java_Package_List.size(); i++) {
						if (!((String)(CIM_J2eeEntityBeanStats.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_J2eeEntityBeanStats.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_J2eeEntityBeanStats.Java_Package_List.setElementAt((String)(CIM_J2eeEntityBeanStats.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_J2eeEntityBeanStats.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_J2eeEntityBeanStats.");
						resultArrayList.add(new CIM_J2eeEntityBeanStats(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_J2eeEntityBeanStats.");
						resultArrayList.add(new CIM_J2eeEntityBeanStats(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_J2eeEntityBeanStats.");
						resultArrayList.add(new CIM_J2eeEntityBeanStats(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_J2eeEntityBeanStats getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_J2eeEntityBeanStatsHelper.getInstance(cimClient, new CIM_J2eeEntityBeanStats(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_J2eeEntityBeanStats getInstance(CIMClient cimClient, CIM_J2eeEntityBeanStats dataInstance) {
		...
		return CIM_J2eeEntityBeanStatsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_J2eeEntityBeanStats getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_J2eeEntityBeanStats dataInstance = null;
		try {
			dataInstance = new CIM_J2eeEntityBeanStats(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_J2eeEntityBeanStats createInstance(CIMClient cimClient, CIM_J2eeEntityBeanStats dataInstance, boolean notifyDifferencies){ 
		...
		CIM_J2eeEntityBeanStats newDataInstance = null;
		try {
			newDataInstance = CIM_J2eeEntityBeanStatsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_J2eeEntityBeanStats modifyInstance(CIMClient cimClient, CIM_J2eeEntityBeanStats dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_J2eeEntityBeanStatsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_J2eeEntityBeanStats dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_J2eeEntityBeanStats dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_J2eeEntityBeanStats.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_J2eeEntityBeanStats.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_J2eeEntityBeanStats.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_J2eeEntityBeanStats.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_J2eeEntityBeanStats.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_PooledCount(UnsignedInt64 PooledCount) {
		return true;
	}

	public static boolean isValid_PooledHighWaterMark(UnsignedInt64 PooledHighWaterMark) {
		return true;
	}

	public static boolean isValid_PooledLowWaterMark(UnsignedInt64 PooledLowWaterMark) {
		return true;
	}

	public static boolean isValid_ReadyCount(UnsignedInt64 ReadyCount) {
		return true;
	}

	public static boolean isValid_ReadyHighWaterMark(UnsignedInt64 ReadyHighWaterMark) {
		return true;
	}

	public static boolean isValid_ReadyLowWaterMark(UnsignedInt64 ReadyLowWaterMark) {
		return true;
	}
