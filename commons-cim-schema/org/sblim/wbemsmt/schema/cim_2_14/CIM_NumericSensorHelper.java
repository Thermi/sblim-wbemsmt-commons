...
public final class CIM_NumericSensorHelper {

	public final static String CIM_CLASS_NAME = "CIM_NumericSensor";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_NumericSensor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_NumericSensor.Java_Package_List.size(); i++) {
						if (!((String)(CIM_NumericSensor.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_NumericSensor.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_NumericSensor.Java_Package_List.setElementAt((String)(CIM_NumericSensor.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_NumericSensor.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_NumericSensor.");
						resultArrayList.add(new CIM_NumericSensor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_NumericSensor.");
						resultArrayList.add(new CIM_NumericSensor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_NumericSensor.");
						resultArrayList.add(new CIM_NumericSensor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_NumericSensor getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_NumericSensorHelper.getInstance(cimClient, new CIM_NumericSensor(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_NumericSensor getInstance(CIMClient cimClient, CIM_NumericSensor dataInstance) {
		...
		return CIM_NumericSensorHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_NumericSensor getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_NumericSensor dataInstance = null;
		try {
			dataInstance = new CIM_NumericSensor(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_NumericSensor createInstance(CIMClient cimClient, CIM_NumericSensor dataInstance, boolean notifyDifferencies){ 
		...
		CIM_NumericSensor newDataInstance = null;
		try {
			newDataInstance = CIM_NumericSensorHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_NumericSensor modifyInstance(CIMClient cimClient, CIM_NumericSensor dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_NumericSensorHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_NumericSensor dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_NumericSensor dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_NumericSensor.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_NumericSensor.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_NumericSensor.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_NumericSensor.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_NumericSensor.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Accuracy(Integer Accuracy) {
		return true;
	}

	public static boolean isValid_BaseUnits(UnsignedInt16 BaseUnits) {
		return true;
	}

	public static boolean isValid_CurrentReading(Integer CurrentReading) {
		return true;
	}

	public static boolean isValid_EnabledThresholds(UnsignedInt16[] EnabledThresholds) {
		return true;
	}

	public static boolean isValid_Hysteresis(UnsignedInt32 Hysteresis) {
		return true;
	}

	public static boolean isValid_IsLinear(Boolean IsLinear) {
		return true;
	}

	public static boolean isValid_LowerThresholdCritical(Integer LowerThresholdCritical) {
		return true;
	}

	public static boolean isValid_LowerThresholdFatal(Integer LowerThresholdFatal) {
		return true;
	}

	public static boolean isValid_LowerThresholdNonCritical(Integer LowerThresholdNonCritical) {
		return true;
	}

	public static boolean isValid_MaxReadable(Integer MaxReadable) {
		return true;
	}

	public static boolean isValid_MinReadable(Integer MinReadable) {
		return true;
	}

	public static boolean isValid_NominalReading(Integer NominalReading) {
		return true;
	}

	public static boolean isValid_NormalMax(Integer NormalMax) {
		return true;
	}

	public static boolean isValid_NormalMin(Integer NormalMin) {
		return true;
	}

	public static boolean isValid_RateUnits(UnsignedInt16 RateUnits) {
		return true;
	}

	public static boolean isValid_Resolution(UnsignedInt32 Resolution) {
		return true;
	}

	public static boolean isValid_SettableThresholds(UnsignedInt16[] SettableThresholds) {
		return true;
	}

	public static boolean isValid_SupportedThresholds(UnsignedInt16[] SupportedThresholds) {
		return true;
	}

	public static boolean isValid_Tolerance(Integer Tolerance) {
		return true;
	}

	public static boolean isValid_UnitModifier(Integer UnitModifier) {
		return true;
	}

	public static boolean isValid_UpperThresholdCritical(Integer UpperThresholdCritical) {
		return true;
	}

	public static boolean isValid_UpperThresholdFatal(Integer UpperThresholdFatal) {
		return true;
	}

	public static boolean isValid_UpperThresholdNonCritical(Integer UpperThresholdNonCritical) {
		return true;
	}
