 ...
 *
 *
 * Description:  The InstalledProduct object allows the grouping of SoftwareFeatures and
 * SoftwareElements that represent the result of the installation of a purchased
 * Product. InstalledProduct is defined to be Weak to a Product. Often, Products
 * are purchased once but may be installed several times in different locations
 * on one or more systems. All of the SoftwareElements and SoftwareFeatures of a
 * single install are grouped by an instance of InstalledProduct. These are
 * defined using the associations, CollectedSoftwareFeatures and Collected
 * SoftwareElements.
 * 
 */
...
/**
 *  The InstalledProduct object allows the grouping of SoftwareFeatures and
 * SoftwareElements that represent the result of the installation of a purchased
 * Product. InstalledProduct is defined to be Weak to a Product. Often, Products
 * are purchased once but may be installed several times in different locations
 * on one or more systems. All of the SoftwareElements and SoftwareFeatures of a
...
public class CIM_InstalledProduct extends CIM_Collection  {
	...
	public final static String CIM_CLASS_NAME = "CIM_InstalledProduct"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_COLLECTEDSOFTWAREFEATURES = "CIM_CollectedSoftwareFeatures"; //$NON-NLS-1$
