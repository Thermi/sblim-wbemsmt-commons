/** 
 * CIM_BGPEndpointStatisticsHelper.java
 *
...
public final class CIM_BGPEndpointStatisticsHelper {

	public final static String CIM_CLASS_NAME = "CIM_BGPEndpointStatistics";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_BGPEndpointStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_BGPEndpointStatistics.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BGPEndpointStatistics.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_BGPEndpointStatistics.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_BGPEndpointStatistics.Java_Package_List.setElementAt((String)(CIM_BGPEndpointStatistics.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_BGPEndpointStatistics.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BGPEndpointStatistics.");
						resultArrayList.add(new CIM_BGPEndpointStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BGPEndpointStatistics.");
						resultArrayList.add(new CIM_BGPEndpointStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BGPEndpointStatistics.");
						resultArrayList.add(new CIM_BGPEndpointStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BGPEndpointStatistics getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BGPEndpointStatisticsHelper.getInstance(cimClient, new CIM_BGPEndpointStatistics(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPEndpointStatistics getInstance(CIMClient cimClient, CIM_BGPEndpointStatistics dataInstance) {
		...
		return CIM_BGPEndpointStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPEndpointStatistics getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BGPEndpointStatistics dataInstance = null;
		try {
			dataInstance = new CIM_BGPEndpointStatistics(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPEndpointStatistics createInstance(CIMClient cimClient, CIM_BGPEndpointStatistics dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BGPEndpointStatistics newDataInstance = null;
		try {
			newDataInstance = CIM_BGPEndpointStatisticsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPEndpointStatistics modifyInstance(CIMClient cimClient, CIM_BGPEndpointStatistics dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BGPEndpointStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BGPEndpointStatistics dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BGPEndpointStatistics dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BGPEndpointStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BGPEndpointStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BGPEndpointStatistics.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BGPEndpointStatistics.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BGPEndpointStatistics.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_FsmEstablishedTime(UnsignedInt32 FsmEstablishedTime) {
		return true;
	}

	public static boolean isValid_FsmEstablishedTransitions(UnsignedInt32 FsmEstablishedTransitions) {
		return true;
	}

	public static boolean isValid_InTotalMessages(UnsignedInt32 InTotalMessages) {
		return true;
	}

	public static boolean isValid_InUpdateElapsedTime(UnsignedInt32 InUpdateElapsedTime) {
		return true;
	}

	public static boolean isValid_InUpdates(UnsignedInt32 InUpdates) {
		return true;
	}

	public static boolean isValid_LastError(UnsignedInt8 LastError) {
		return true;
	}

	public static boolean isValid_OutTotalMessages(UnsignedInt32 OutTotalMessages) {
		return true;
	}

	public static boolean isValid_OutUpdates(UnsignedInt32 OutUpdates) {
		return true;
	}
