/** 
 * CIM_CIMOMStatisticalDataHelper.java
 *
...
public final class CIM_CIMOMStatisticalDataHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_CIMOMStatisticalData.Java_Package_List.size(); i++) {
						if (!((String)(CIM_CIMOMStatisticalData.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_CIMOMStatisticalData.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_CIMOMStatisticalData.Java_Package_List.setElementAt((String)(CIM_CIMOMStatisticalData.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_CIMOMStatisticalData.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CIMOMStatisticalData.");
						resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CIMOMStatisticalData.");
						resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CIMOMStatisticalData.");
						resultArrayList.add(new CIM_CIMOMStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_CIMOMStatisticalData getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CIMOMStatisticalDataHelper.getInstance(cimClient, new CIM_CIMOMStatisticalData(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CIMOMStatisticalData getInstance(CIMClient cimClient, CIM_CIMOMStatisticalData dataInstance) {
		...
		return CIM_CIMOMStatisticalDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CIMOMStatisticalData getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_CIMOMStatisticalData dataInstance = null;
		try {
			dataInstance = new CIM_CIMOMStatisticalData(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CIMOMStatisticalData createInstance(CIMClient cimClient, CIM_CIMOMStatisticalData dataInstance, boolean notifyDifferencies){ 
		...
		CIM_CIMOMStatisticalData newDataInstance = null;
		try {
			newDataInstance = CIM_CIMOMStatisticalDataHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CIMOMStatisticalData modifyInstance(CIMClient cimClient, CIM_CIMOMStatisticalData dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_CIMOMStatisticalDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_CIMOMStatisticalData dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_CIMOMStatisticalData dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_CIMOMStatisticalData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_CIMOMStatisticalData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_CIMOMStatisticalData.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_CIMOMStatisticalData.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_CIMOMStatisticalData.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CimomElapsedTime(Calendar CimomElapsedTime) {
		return true;
	}
	...
	public static boolean isValid_NumberOfOperations(UnsignedInt64 NumberOfOperations) {
		return true;
	}

	public static boolean isValid_OperationType(UnsignedInt16 OperationType) {
		return true;
	}

	public static boolean isValid_OtherOperationType(String OtherOperationType) {
		return true;
	}

	public static boolean isValid_ProviderElapsedTime(Calendar ProviderElapsedTime) {
		return true;
	}

	public static boolean isValid_RequestSize(UnsignedInt64 RequestSize) {
		return true;
	}

	public static boolean isValid_ResponseSize(UnsignedInt64 ResponseSize) {
		return true;
	}
