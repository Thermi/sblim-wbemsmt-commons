 ...
 *
 *
 * Description:  MemoryCapacity describes the type of Memory that can be installed on a
 * PhysicalElement and its minimum/maximum configurations. Information on what
 * memory is currently 'installed', versus an Element's min/max requirements, is
...
/**
 *  MemoryCapacity describes the type of Memory that can be installed on a
 * PhysicalElement and its minimum/maximum configurations. Information on what
 * memory is currently 'installed', versus an Element's min/max requirements, is
 * located in instances of the PhysicalMemory class.
 */
public class CIM_MemoryCapacity extends CIM_PhysicalCapacity  {
	...
	public final static String CIM_CLASS_NAME = "CIM_MemoryCapacity"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_PhysicalCapacity.Java_Package_List.size(); i++) {
			if (((String)CIM_PhysicalCapacity.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
	...
	public final static String[] CIM_VALUEMAP_MEMORYTYPE = {"Unknown","Other","DRAM","Synchronous DRAM","Cache DRAM","EDO","EDRAM","VRAM","SRAM","RAM","ROM","Flash","EEPROM","FEPROM","EPROM","CDRAM","3DRAM","SDRAM","SGRAM","RDRAM","DDR","DDR2","BRAM","FB-DIMM","DMTF Reserved","Vendor Reserved"};
	
	
	public final static String MEMORYTYPE_UNKNOWN = "0";
	public final static String MEMORYTYPE_OTHER = "1";
	public final static String MEMORYTYPE_DRAM = "2";
	public final static String MEMORYTYPE_SYNCHRONOUSDRAM = "3";
	public final static String MEMORYTYPE_CACHEDRAM = "4";
	public final static String MEMORYTYPE_EDO = "5";
	public final static String MEMORYTYPE_EDRAM = "6";
	public final static String MEMORYTYPE_VRAM = "7";
	public final static String MEMORYTYPE_SRAM = "8";
	public final static String MEMORYTYPE_RAM = "9";
	public final static String MEMORYTYPE_ROM = "10";
	public final static String MEMORYTYPE_FLASH = "11";
	public final static String MEMORYTYPE_EEPROM = "12";
	public final static String MEMORYTYPE_FEPROM = "13";
	public final static String MEMORYTYPE_EPROM = "14";
	public final static String MEMORYTYPE_CDRAM = "15";
	public final static String MEMORYTYPE_3DRAM = "16";
	public final static String MEMORYTYPE_SDRAM = "17";
	public final static String MEMORYTYPE_SGRAM = "18";
	public final static String MEMORYTYPE_RDRAM = "19";
	public final static String MEMORYTYPE_DDR = "20";
	public final static String MEMORYTYPE_DDR2 = "21";
	public final static String MEMORYTYPE_BRAM = "22";
	public final static String MEMORYTYPE_FB_DIMM = "23";
	public final static String MEMORYTYPE_DMTFRESERVED = "24..32567";
	public final static String MEMORYTYPE_VENDORRESERVED = "32568..65535";
