 ...
 *
 *
 * Description:  The CIM_DirectorySpecification class captures the major directory structure of
 * a SoftwareElement. This class is used to organize the files of a
 * SoftwareElement into manageable units that can be relocated on a computer
 * system.
 * 
 */
...
/**
 *  The CIM_DirectorySpecification class captures the major directory structure of
 * a SoftwareElement. This class is used to organize the files of a
 * SoftwareElement into manageable units that can be relocated on a computer
 * system.
 */
public class CIM_DirectorySpecification extends CIM_Check  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DirectorySpecification"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.6.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DIRECTORYSPECIFICATIONFILE = "CIM_DirectorySpecificationFile"; //$NON-NLS-1$
	...
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
		...
		try {
			enumeration = cimClient.associators(
					...
					"DirectorySpecification", //$NON-NLS-1$
					"FileSpecification", //$NON-NLS-1$
					includeQualifiers,
					includeClassOrigin,
					propertyList);
