/** 
 * CIM_BlockStorageStatisticalDataHelper.java
 *
...
public final class CIM_BlockStorageStatisticalDataHelper {

	public final static String CIM_CLASS_NAME = "CIM_BlockStorageStatisticalData";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_BlockStorageStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_BlockStorageStatisticalData.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BlockStorageStatisticalData.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_BlockStorageStatisticalData.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_BlockStorageStatisticalData.Java_Package_List.setElementAt((String)(CIM_BlockStorageStatisticalData.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_BlockStorageStatisticalData.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BlockStorageStatisticalData.");
						resultArrayList.add(new CIM_BlockStorageStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BlockStorageStatisticalData.");
						resultArrayList.add(new CIM_BlockStorageStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BlockStorageStatisticalData.");
						resultArrayList.add(new CIM_BlockStorageStatisticalData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BlockStorageStatisticalData getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BlockStorageStatisticalDataHelper.getInstance(cimClient, new CIM_BlockStorageStatisticalData(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BlockStorageStatisticalData getInstance(CIMClient cimClient, CIM_BlockStorageStatisticalData dataInstance) {
		...
		return CIM_BlockStorageStatisticalDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BlockStorageStatisticalData getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BlockStorageStatisticalData dataInstance = null;
		try {
			dataInstance = new CIM_BlockStorageStatisticalData(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BlockStorageStatisticalData createInstance(CIMClient cimClient, CIM_BlockStorageStatisticalData dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BlockStorageStatisticalData newDataInstance = null;
		try {
			newDataInstance = CIM_BlockStorageStatisticalDataHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BlockStorageStatisticalData modifyInstance(CIMClient cimClient, CIM_BlockStorageStatisticalData dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BlockStorageStatisticalDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BlockStorageStatisticalData dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BlockStorageStatisticalData dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BlockStorageStatisticalData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BlockStorageStatisticalData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BlockStorageStatisticalData.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BlockStorageStatisticalData.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BlockStorageStatisticalData.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_IOTimeCounter(UnsignedInt64 IOTimeCounter) {
		return true;
	}

	public static boolean isValid_IdleTimeCounter(UnsignedInt64 IdleTimeCounter) {
		return true;
	}

	public static boolean isValid_KBytesRead(UnsignedInt64 KBytesRead) {
		return true;
	}

	public static boolean isValid_KBytesTransferred(UnsignedInt64 KBytesTransferred) {
		return true;
	}

	public static boolean isValid_KBytesWritten(UnsignedInt64 KBytesWritten) {
		return true;
	}

	public static boolean isValid_MaintOp(UnsignedInt64 MaintOp) {
		return true;
	}

	public static boolean isValid_MaintTimeCounter(UnsignedInt64 MaintTimeCounter) {
		return true;
	}

	public static boolean isValid_ReadHitIOTimeCounter(UnsignedInt64 ReadHitIOTimeCounter) {
		return true;
	}

	public static boolean isValid_ReadHitIOs(UnsignedInt64 ReadHitIOs) {
		return true;
	}

	public static boolean isValid_ReadIOTimeCounter(UnsignedInt64 ReadIOTimeCounter) {
		return true;
	}

	public static boolean isValid_ReadIOs(UnsignedInt64 ReadIOs) {
		return true;
	}

	public static boolean isValid_TotalIOs(UnsignedInt64 TotalIOs) {
		return true;
	}

	public static boolean isValid_WriteHitIOTimeCounter(UnsignedInt64 WriteHitIOTimeCounter) {
		return true;
	}

	public static boolean isValid_WriteHitIOs(UnsignedInt64 WriteHitIOs) {
		return true;
	}

	public static boolean isValid_WriteIOTimeCounter(UnsignedInt64 WriteIOTimeCounter) {
		return true;
	}

	public static boolean isValid_WriteIOs(UnsignedInt64 WriteIOs) {
		return true;
	}
