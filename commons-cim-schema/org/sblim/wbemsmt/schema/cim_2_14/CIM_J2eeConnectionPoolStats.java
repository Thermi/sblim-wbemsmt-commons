 ...
 *
 *
 * Description:  The J2eeConnectionPoolStats class defines the performance statistics that are
 * provided by a connection pool. JCA and JDBC connection pool statistics are
 * represented by this class. The semantics are determined by the class to which
 * the ConnectionStats instance is associated via the CIM_ElementStatisticalData
 * association.
 * 
 */
...
/**
 *  The J2eeConnectionPoolStats class defines the performance statistics that are
 * provided by a connection pool. JCA and JDBC connection pool statistics are
 * represented by this class. The semantics are determined by the class to which
 * the ConnectionStats instance is associated via the CIM_ElementStatisticalData
 * association.
...
public class CIM_J2eeConnectionPoolStats extends CIM_J2eeConnectionStats  {
	...
	public final static String CIM_CLASS_NAME = "CIM_J2eeConnectionPoolStats"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_J2eeConnectionStats.Java_Package_List.size(); i++) {
			if (((String)CIM_J2eeConnectionStats.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
