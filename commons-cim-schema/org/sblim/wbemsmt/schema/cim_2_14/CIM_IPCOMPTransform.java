 ...
 *
 *
 * Description:  The IPCOMPTransform specifies the IP compression algorithm to use for payload
...
/**
 *  The IPCOMPTransform specifies the IP compression algorithm to use for payload
 * of the Security Association.
 */
public class CIM_IPCOMPTransform extends CIM_SATransform  {
	
	public final static String CIM_CLASS_NAME = "CIM_IPCOMPTransform"; //$NON-NLS-1$
