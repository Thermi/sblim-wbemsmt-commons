 ...
 *
 *
 * Description:  A database is a collection of interrelated data, treated as a unit, which is
 * organized into one or more schemas. The CIM_CommonDatabase class defines the
 * properties that are common across database model and vendor implementations
 * for the database entity that is represented by the unit of interrelated data.
 * Databases are manipulated through one or more database services. More
 * detailed information on database services is provided in the description of
 * the CIM_DatabaseService class.
 * 
 */
...
/**
 *  A database is a collection of interrelated data, treated as a unit, which is
 * organized into one or more schemas. The CIM_CommonDatabase class defines the
 * properties that are common across database model and vendor implementations
 * for the database entity that is represented by the unit of interrelated data.
 * Databases are manipulated through one or more database services. More
...
public class CIM_CommonDatabase extends CIM_EnabledLogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_CommonDatabase"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.7.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ASSOCIATEDDATABASESYSTEM = "CIM_AssociatedDatabaseSystem"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DATABASEADMINISTRATOR = "CIM_DatabaseAdministrator"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DATABASECONTROLFILE = "CIM_DatabaseControlFile"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DATABASEFILE = "CIM_DatabaseFile"; //$NON-NLS-1$
