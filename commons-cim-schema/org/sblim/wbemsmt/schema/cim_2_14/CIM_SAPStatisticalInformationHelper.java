/** 
 * CIM_SAPStatisticalInformationHelper.java
 *
...
public final class CIM_SAPStatisticalInformationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SAPStatisticalInformation.");
						resultArrayList.add(new CIM_SAPStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SAPStatisticalInformation.");
						resultArrayList.add(new CIM_SAPStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SAPStatisticalInformation.");
						resultArrayList.add(new CIM_SAPStatisticalInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SAPStatisticalInformation getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SAPStatisticalInformationHelper.getInstance(cimClient, new CIM_SAPStatisticalInformation(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SAPStatisticalInformation getInstance(CIMClient cimClient, CIM_SAPStatisticalInformation dataInstance) {
		...
		return CIM_SAPStatisticalInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SAPStatisticalInformation getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SAPStatisticalInformation dataInstance = null;
		try {
			dataInstance = new CIM_SAPStatisticalInformation(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SAPStatisticalInformation createInstance(CIMClient cimClient, CIM_SAPStatisticalInformation dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SAPStatisticalInformation newDataInstance = null;
		try {
			newDataInstance = CIM_SAPStatisticalInformationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SAPStatisticalInformation modifyInstance(CIMClient cimClient, CIM_SAPStatisticalInformation dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SAPStatisticalInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SAPStatisticalInformation dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SAPStatisticalInformation dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SAPStatisticalInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SAPStatisticalInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SAPStatisticalInformation.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SAPStatisticalInformation.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SAPStatisticalInformation.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_SAPCreationClassName(String SAPCreationClassName) {
		return true;
	}

	public static boolean isValid_SAPName(String SAPName) {
		return true;
	}
