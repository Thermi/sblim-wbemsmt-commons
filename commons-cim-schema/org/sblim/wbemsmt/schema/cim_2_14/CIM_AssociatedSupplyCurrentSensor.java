 ...
 *
 *
 * Description:  The use of this association is being deprecated in lieu of using
 * AssociatedSensor, since the use of the referenced class CurrentSensor is
 * deprecated. A PowerSupply may have an associated CurrentSensor, monitoring
...
/**
 *  The use of this association is being deprecated in lieu of using
 * AssociatedSensor, since the use of the referenced class CurrentSensor is
 * deprecated. A PowerSupply may have an associated CurrentSensor, monitoring
 * its input frequency. This is described by this association.
 */
public class CIM_AssociatedSupplyCurrentSensor extends CIM_AssociatedSensor  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AssociatedSupplyCurrentSensor"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_AssociatedSensor.Java_Package_List.size(); i++) {
			if (((String)CIM_AssociatedSensor.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
