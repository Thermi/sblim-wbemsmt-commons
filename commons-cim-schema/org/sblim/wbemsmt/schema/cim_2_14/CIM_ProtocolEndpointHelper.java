...
public final class CIM_ProtocolEndpointHelper {
	...
	*/	
	public final static CIM_ProtocolEndpoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ProtocolEndpointHelper.getInstance(cimClient, new CIM_ProtocolEndpoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ProtocolEndpoint getInstance(CIMClient cimClient, CIM_ProtocolEndpoint dataInstance) {
		...
		return CIM_ProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ProtocolEndpoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_ProtocolEndpoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ProtocolEndpoint createInstance(CIMClient cimClient, CIM_ProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ProtocolEndpoint newDataInstance = null;
		try {
			newDataInstance = CIM_ProtocolEndpointHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ProtocolEndpoint modifyInstance(CIMClient cimClient, CIM_ProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ProtocolEndpoint dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ProtocolEndpoint dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ProtocolEndpoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ProtocolEndpoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ProtocolEndpoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_NameFormat(String NameFormat) {
		return true;
	}

	public static boolean isValid_OperationalStatus(UnsignedInt16[] OperationalStatus) {
		return true;
	}
	...
	public static boolean isValid_ProtocolType(UnsignedInt16 ProtocolType) {
		return true;
	}
