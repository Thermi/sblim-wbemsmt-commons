...
public class CIM_ProtocolEndpointHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ProtocolEndpoint.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ProtocolEndpoint.");
                        resultArrayList.add(new CIM_ProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ProtocolEndpoint.");
                        resultArrayList.add(new CIM_ProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ProtocolEndpoint.");
                        resultArrayList.add(new CIM_ProtocolEndpoint(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ProtocolEndpoint getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ProtocolEndpoint getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ProtocolEndpoint getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ProtocolEndpoint.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ProtocolEndpoint.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[1] = new CIMProperty(
                CIM_ProtocolEndpoint.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_ProtocolEndpoint.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[2] = new CIMProperty(CIM_ProtocolEndpoint.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ProtocolEndpoint.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ProtocolEndpoint createInstance(WBEMClient client,
            CIM_ProtocolEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ProtocolEndpoint newDataInstance = CIM_ProtocolEndpointHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ProtocolEndpoint modifyInstance(WBEMClient client,
            CIM_ProtocolEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ProtocolEndpoint dataInstance2 = CIM_ProtocolEndpointHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ProtocolEndpoint dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ProtocolEndpoint.getPackages());
    }
