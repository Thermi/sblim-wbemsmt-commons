 ...
 *
 *
 * Description:  This relationship associates a CertificateAuthority with the certificates it
 * signs.
 * 
 */
...
/**
 *  This relationship associates a CertificateAuthority with the certificates it
 * signs.
 */
public class CIM_CASignsPublicKeyCertificate extends CIM_ManagedCredential  {
	
	public final static String CIM_CLASS_NAME = "CIM_CASignsPublicKeyCertificate"; //$NON-NLS-1$
