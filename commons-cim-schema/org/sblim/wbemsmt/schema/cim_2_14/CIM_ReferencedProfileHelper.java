...
public class CIM_ReferencedProfileHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ReferencedProfile.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ReferencedProfile.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ReferencedProfile.");
                        resultArrayList.add(new CIM_ReferencedProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ReferencedProfile.");
                        resultArrayList.add(new CIM_ReferencedProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ReferencedProfile.");
                        resultArrayList.add(new CIM_ReferencedProfile(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ReferencedProfile getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ReferencedProfile getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ReferencedProfile getInstance(WBEMClient client, String namespace,
            CIM_RegisteredProfile Antecedent, CIM_RegisteredProfile Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ReferencedProfile.PROPERTY_ANTECEDENT_CIM_REGISTEREDPROFILE.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ReferencedProfile.PROPERTY_DEPENDENT_CIM_REGISTEREDPROFILE.NAME,
                new CIMDataType(CIM_RegisteredProfile.CIM_CLASS_NAME), setThis, false, false,
                CIM_ReferencedProfile.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ReferencedProfile createInstance(WBEMClient client,
            CIM_ReferencedProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ReferencedProfile newDataInstance = CIM_ReferencedProfileHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ReferencedProfile modifyInstance(WBEMClient client,
            CIM_ReferencedProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ReferencedProfile dataInstance2 = CIM_ReferencedProfileHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ReferencedProfile dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ReferencedProfile.getPackages());
    }
