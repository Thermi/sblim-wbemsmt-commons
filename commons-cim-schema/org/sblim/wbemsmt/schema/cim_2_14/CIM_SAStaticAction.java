 ...
 *
 *
 * Description:  SAStaticAction is the base class for both key exchange as well as IPsec actions
 * that require no negotiation. It is a concrete class that can be aggregated
 * with other subclasses of PolicyAction (such as NetworkPacketAction) into a
 * PolicyRule, to describe how packets are handled throughout the lifetime of
...
/**
 *  SAStaticAction is the base class for both key exchange as well as IPsec actions
 * that require no negotiation. It is a concrete class that can be aggregated
 * with other subclasses of PolicyAction (such as NetworkPacketAction) into a
 * PolicyRule, to describe how packets are handled throughout the lifetime of
 * the Security Association.
...
public class CIM_SAStaticAction extends CIM_SAAction  {
	...
	public final static String CIM_CLASS_NAME = "CIM_SAStaticAction"; //$NON-NLS-1$
