/** 
 * CIM_KerberosKeyDistributionCenterHelper.java
 *
...
public final class CIM_KerberosKeyDistributionCenterHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_KerberosKeyDistributionCenter.");
						resultArrayList.add(new CIM_KerberosKeyDistributionCenter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_KerberosKeyDistributionCenter.");
						resultArrayList.add(new CIM_KerberosKeyDistributionCenter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_KerberosKeyDistributionCenter.");
						resultArrayList.add(new CIM_KerberosKeyDistributionCenter(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_KerberosKeyDistributionCenter getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_KerberosKeyDistributionCenterHelper.getInstance(cimClient, new CIM_KerberosKeyDistributionCenter(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_KerberosKeyDistributionCenter getInstance(CIMClient cimClient, CIM_KerberosKeyDistributionCenter dataInstance) {
		...
		return CIM_KerberosKeyDistributionCenterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_KerberosKeyDistributionCenter getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_KerberosKeyDistributionCenter dataInstance = null;
		try {
			dataInstance = new CIM_KerberosKeyDistributionCenter(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_KerberosKeyDistributionCenter createInstance(CIMClient cimClient, CIM_KerberosKeyDistributionCenter dataInstance, boolean notifyDifferencies){ 
		...
		CIM_KerberosKeyDistributionCenter newDataInstance = null;
		try {
			newDataInstance = CIM_KerberosKeyDistributionCenterHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_KerberosKeyDistributionCenter modifyInstance(CIMClient cimClient, CIM_KerberosKeyDistributionCenter dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_KerberosKeyDistributionCenterHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_KerberosKeyDistributionCenter dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_KerberosKeyDistributionCenter dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_KerberosKeyDistributionCenter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_KerberosKeyDistributionCenter.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_KerberosKeyDistributionCenter.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_KerberosKeyDistributionCenter.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_KerberosKeyDistributionCenter.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Protocol(UnsignedInt16[] Protocol) {
		return true;
	}
