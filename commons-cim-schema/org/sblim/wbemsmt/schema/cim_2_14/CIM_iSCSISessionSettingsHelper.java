/** 
 * CIM_iSCSISessionSettingsHelper.java
 *
...
public final class CIM_iSCSISessionSettingsHelper {

	public final static String CIM_CLASS_NAME = "CIM_iSCSISessionSettings";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_iSCSISessionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_iSCSISessionSettings.Java_Package_List.size(); i++) {
						if (!((String)(CIM_iSCSISessionSettings.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_iSCSISessionSettings.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_iSCSISessionSettings.Java_Package_List.setElementAt((String)(CIM_iSCSISessionSettings.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_iSCSISessionSettings.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_iSCSISessionSettings.");
						resultArrayList.add(new CIM_iSCSISessionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_iSCSISessionSettings.");
						resultArrayList.add(new CIM_iSCSISessionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_iSCSISessionSettings.");
						resultArrayList.add(new CIM_iSCSISessionSettings(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_iSCSISessionSettings getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_iSCSISessionSettingsHelper.getInstance(cimClient, new CIM_iSCSISessionSettings(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSISessionSettings getInstance(CIMClient cimClient, CIM_iSCSISessionSettings dataInstance) {
		...
		return CIM_iSCSISessionSettingsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_iSCSISessionSettings getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_iSCSISessionSettings dataInstance = null;
		try {
			dataInstance = new CIM_iSCSISessionSettings(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSISessionSettings createInstance(CIMClient cimClient, CIM_iSCSISessionSettings dataInstance, boolean notifyDifferencies){ 
		...
		CIM_iSCSISessionSettings newDataInstance = null;
		try {
			newDataInstance = CIM_iSCSISessionSettingsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_iSCSISessionSettings modifyInstance(CIMClient cimClient, CIM_iSCSISessionSettings dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_iSCSISessionSettingsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_iSCSISessionSettings dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_iSCSISessionSettings dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_iSCSISessionSettings.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_iSCSISessionSettings.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_iSCSISessionSettings.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_iSCSISessionSettings.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_iSCSISessionSettings.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DataPDUInOrderPreference(Boolean DataPDUInOrderPreference) {
		return true;
	}

	public static boolean isValid_DataSequenceInOrderPreference(Boolean DataSequenceInOrderPreference) {
		return true;
	}

	public static boolean isValid_DefaultTimeToRetainPreference(UnsignedInt32 DefaultTimeToRetainPreference) {
		return true;
	}

	public static boolean isValid_DefaultTimeToWaitPreference(UnsignedInt32 DefaultTimeToWaitPreference) {
		return true;
	}

	public static boolean isValid_ErrorRecoveryLevelPreference(UnsignedInt32 ErrorRecoveryLevelPreference) {
		return true;
	}

	public static boolean isValid_ImmediateDataPreference(Boolean ImmediateDataPreference) {
		return true;
	}

	public static boolean isValid_InitialR2TPreference(Boolean InitialR2TPreference) {
		return true;
	}

	public static boolean isValid_MaxConnectionsPerSession(UnsignedInt32 MaxConnectionsPerSession) {
		return true;
	}

	public static boolean isValid_MaxDataBurstLength(UnsignedInt32 MaxDataBurstLength) {
		return true;
	}

	public static boolean isValid_MaxOutstandingR2T(UnsignedInt32 MaxOutstandingR2T) {
		return true;
	}

	public static boolean isValid_MaxUnsolicitedFirstDataBurstLength(UnsignedInt32 MaxUnsolicitedFirstDataBurstLength) {
		return true;
	}
