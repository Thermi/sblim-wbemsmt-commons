 ...
 *
 *
 * Description:  AdjacentSlots describes the layout of Slots on a HostingBoard or adapter Card.
 * Information like the distance between the Slots and whether they are 'shared'
 * (if one is populated, then the other Slot can not be used), is conveyed as
...
/**
 *  AdjacentSlots describes the layout of Slots on a HostingBoard or adapter Card.
 * Information like the distance between the Slots and whether they are 'shared'
 * (if one is populated, then the other Slot can not be used), is conveyed as
 * properties of the association.
 */
public class CIM_AdjacentSlots  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AdjacentSlots"; //$NON-NLS-1$
