...
public class CIM_ServiceAccessBySAPHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceAccessBySAP.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ServiceAccessBySAP.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ServiceAccessBySAP(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ServiceAccessBySAP getInstance(WBEMClient client,
    ...
    public final static CIM_ServiceAccessBySAP getInstance(WBEMClient client, String namespace,
            CIM_Service Antecedent, CIM_ServiceAccessPoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ServiceAccessBySAP.PROPERTY_ANTECEDENT_CIM_SERVICE.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ServiceAccessBySAP.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,
     ...
     *
     */
    public final static CIM_ServiceAccessBySAP createInstance(WBEMClient client,
            CIM_ServiceAccessBySAP dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ServiceAccessBySAP newDataInstance = CIM_ServiceAccessBySAPHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ServiceAccessBySAP modifyInstance(WBEMClient client,
            CIM_ServiceAccessBySAP dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ServiceAccessBySAP dataInstance2 = CIM_ServiceAccessBySAPHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ServiceAccessBySAP dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ServiceAccessBySAP.getPackages());
    }
