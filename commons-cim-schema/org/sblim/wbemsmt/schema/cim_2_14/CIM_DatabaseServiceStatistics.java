 ...
 * database service. These statistics are counters that are relative to the
 * start of the service or from the time when a reset was issued.
 * 
 */
...
public class CIM_DatabaseServiceStatistics extends CIM_StatisticalData  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DatabaseServiceStatistics"; //$NON-NLS-1$
