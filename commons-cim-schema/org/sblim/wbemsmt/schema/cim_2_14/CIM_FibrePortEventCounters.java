 ...
 *
 *
 * Description:  Note: The use of the FibrePortEventCounters class is deprecated because
 * FibrePort is deprecated. FCPortStatistics should be used instead, but it
 * redefines the level at which data is collected. Therefore, there is no direct
 * translation of the individual counters between the two classes. Deprecated
 * description: This object defines error counters that are specific to a
 * FibrePort.
 * 
 */
