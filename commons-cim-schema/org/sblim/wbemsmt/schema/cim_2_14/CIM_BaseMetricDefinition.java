 ...
 *
 *
 * Description:  CIM_BaseMetricDefinition represents the definitional aspects of a metric, i.e.,
 * a definition template containing meta data about a new metric. Since
 * CIM_BaseMetricDefinition does not capture metric instance information, it
 * does not contain the value of the metric. The associated class
 * CIM_BaseMetricValue holds the metric value and encapsulates its runtime
 * behavior. The purpose of CIM_BaseMetricDefinition is to provide a convenient
 * mechanism for introducing a new metric definition at runtime and capturing
 * its instance values in a separate class. This mechanism is targeted
 * specifically at CIM users who would like to enhance existing CIM schemas by
 * introducing domain-specific metrics that are not captured in the existing CIM
 * schemas. In addition, vendors of managed resources may make use of this
 * mechanism if a small subset of a potentially large and heterogeneous amount
 * of performance-related data needs to be exposed, based on the context in
 * which the data is captured. Additional meta data for a metric can be provided
 * by subclassing from CIM_BaseMetricDefinition. The CIM_BaseMetricDefinition
 * should be associated with the CIM_ManagedElement(s) to which it applies.
 * 
 */
...
/**
 *  CIM_BaseMetricDefinition represents the definitional aspects of a metric, i.e.,
 * a definition template containing meta data about a new metric. Since
 * CIM_BaseMetricDefinition does not capture metric instance information, it
 * does not contain the value of the metric. The associated class
 * CIM_BaseMetricValue holds the metric value and encapsulates its runtime
...
public class CIM_BaseMetricDefinition extends CIM_ManagedElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BaseMetricDefinition"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.9.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_METRICDEFFORME = "CIM_MetricDefForME"; //$NON-NLS-1$
