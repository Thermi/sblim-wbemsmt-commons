 ...
 *
 *
 * Description:  A LogicalElement that describes units of work (e.g. transactions). This class
 * represents the definitional components of a unit of work, and not the unit
 * itself.
 * 
 */
...
/**
 *  A LogicalElement that describes units of work (e.g. transactions). This class
 * represents the definitional components of a unit of work, and not the unit
 * itself.
 */
public class CIM_UnitOfWorkDefinition extends CIM_LogicalElement  {
	
	public final static String CIM_CLASS_NAME = "CIM_UnitOfWorkDefinition"; //$NON-NLS-1$
