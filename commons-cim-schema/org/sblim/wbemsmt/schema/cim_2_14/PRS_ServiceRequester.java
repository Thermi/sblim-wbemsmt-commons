 ...
 *
 *
 * Description:  PRS_ServiceRequester associates a PRS_ServiceIncident with a PRS_Contact
 * representing the entity requesting service. Note that the Contact class is
 * used for both Requesters and Providers, the context is determined by which
 * association exists.
 * 
 */
...
/**
 *  PRS_ServiceRequester associates a PRS_ServiceIncident with a PRS_Contact
 * representing the entity requesting service. Note that the Contact class is
 * used for both Requesters and Providers, the context is determined by which
 * association exists.
 */
public class PRS_ServiceRequester extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "PRS_ServiceRequester"; //$NON-NLS-1$
