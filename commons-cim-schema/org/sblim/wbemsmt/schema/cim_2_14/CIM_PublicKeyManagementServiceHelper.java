/** 
 * CIM_PublicKeyManagementServiceHelper.java
 *
...
public final class CIM_PublicKeyManagementServiceHelper {

	public final static String CIM_CLASS_NAME = "CIM_PublicKeyManagementService";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_PublicKeyManagementService.Java_Package_List.size(); i++) {
						if (!((String)(CIM_PublicKeyManagementService.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_PublicKeyManagementService.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_PublicKeyManagementService.Java_Package_List.setElementAt((String)(CIM_PublicKeyManagementService.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_PublicKeyManagementService.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PublicKeyManagementService.");
						resultArrayList.add(new CIM_PublicKeyManagementService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PublicKeyManagementService.");
						resultArrayList.add(new CIM_PublicKeyManagementService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PublicKeyManagementService.");
						resultArrayList.add(new CIM_PublicKeyManagementService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PublicKeyManagementService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PublicKeyManagementServiceHelper.getInstance(cimClient, new CIM_PublicKeyManagementService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PublicKeyManagementService getInstance(CIMClient cimClient, CIM_PublicKeyManagementService dataInstance) {
		...
		return CIM_PublicKeyManagementServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PublicKeyManagementService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PublicKeyManagementService dataInstance = null;
		try {
			dataInstance = new CIM_PublicKeyManagementService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PublicKeyManagementService createInstance(CIMClient cimClient, CIM_PublicKeyManagementService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PublicKeyManagementService newDataInstance = null;
		try {
			newDataInstance = CIM_PublicKeyManagementServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PublicKeyManagementService modifyInstance(CIMClient cimClient, CIM_PublicKeyManagementService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PublicKeyManagementServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PublicKeyManagementService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PublicKeyManagementService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PublicKeyManagementService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PublicKeyManagementService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PublicKeyManagementService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PublicKeyManagementService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PublicKeyManagementService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
