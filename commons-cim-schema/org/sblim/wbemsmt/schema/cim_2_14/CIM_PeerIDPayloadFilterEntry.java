 ...
 *
 *
 * Description:  PeerIDPayloadFilterEntry defines filters used to match the Identification Type
 * field in the ID Payload of the IKE protocol exchange. It permits the
...
/**
 *  PeerIDPayloadFilterEntry defines filters used to match the Identification Type
 * field in the ID Payload of the IKE protocol exchange. It permits the
 * specification of ID values such as "*@example.com" or "192.0.2.0/24".
 */
public class CIM_PeerIDPayloadFilterEntry extends CIM_FilterEntryBase  {
	
	public final static String CIM_CLASS_NAME = "CIM_PeerIDPayloadFilterEntry"; //$NON-NLS-1$
