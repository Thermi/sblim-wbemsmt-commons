 ...
 *
 *
 * Description:  An AlarmDevice is a type of Device that emits audible or visible indications
...
/**
 *  An AlarmDevice is a type of Device that emits audible or visible indications
 * related to a problem situation.
 */
public class CIM_AlarmDevice extends CIM_LogicalDevice  {
	
	public final static String CIM_CLASS_NAME = "CIM_AlarmDevice"; //$NON-NLS-1$
