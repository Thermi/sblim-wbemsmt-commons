...
If 0 is returned, then the task completed successfully and the use of ConcreteJob was not required. If 4096 (0x1000) is returned, then the task will take some time to complete, ConcreteJob will be created, and its reference returned in the output parameter Job. Any other return code indicates an error condition.
	*/
	...
	static {
		...
		CIM_PropertyList.add(new CIMProperty(CIM_PROPERTY_REQUESTEDSTATE, new CIMValue(new UnsignedInt16("12"), new CIMDataType(CIMDataType.UINT16))));
	...
	public final static String[] CIM_VALUEMAP_ENABLEDDEFAULT = {"Enabled","Disabled","Not Applicable","Enabled but Offline","No Default","Quiesce","DMTF Reserved","Vendor Reserved"};
	...
	public final static String[] CIM_VALUEMAP_REQUESTEDSTATE = {"Enabled","Disabled","Shut Down","No Change","Offline","Test","Deferred","Quiesce","Reboot","Reset","Not Applicable","DMTF Reserved","Vendor Reserved"};
	...
	public final static String ENABLEDDEFAULT_QUIESCE = "9";
	public final static String ENABLEDDEFAULT_DMTFRESERVED = "..";
	...
	public final static String REQUESTEDSTATE_NOTAPPLICABLE = "12";
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_EnabledLogicalElement.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_EnabledLogicalElement.Java_Package_List.toArray(new String[CIM_EnabledLogicalElement.Java_Package_List.size()]);
    }
