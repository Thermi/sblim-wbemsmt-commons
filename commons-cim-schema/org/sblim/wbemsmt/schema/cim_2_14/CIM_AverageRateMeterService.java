 ...
 *
 *
 * Description:  This is a concrete subclass of MeterService that represents a simple meter,
 * called an Average Rate Meter. This type of meter measures the average rate at
 * which packets are submitted to it over a specified time. Packets are defined
 * as conformant if their average arrival rate does not exceed the specified
 * measuring rate of the meter. Any packet that causes the specified measuring
 * rate to be exceeded is defined to be non-conforming.
 * 
 */
...
public class CIM_AverageRateMeterService extends CIM_MeterService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AverageRateMeterService"; //$NON-NLS-1$
