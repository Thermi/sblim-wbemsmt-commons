 ...
 *
 *
 * Description:  A Certificate Authority (CA) is a credential management service that issues and
 * cryptographically signs certificates. It acts as an trusted third-party
 * intermediary in establishing trust relationships. The CA authenticates the
 * identity of the holder of the 'private' key, related to the certificate's
 * 'public' key.
 * 
 */
...
/**
 *  A Certificate Authority (CA) is a credential management service that issues and
 * cryptographically signs certificates. It acts as an trusted third-party
 * intermediary in establishing trust relationships. The CA authenticates the
 * identity of the holder of the 'private' key, related to the certificate's
 * 'public' key.
...
public class CIM_CertificateAuthority extends CIM_CredentialManagementService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_CertificateAuthority"; //$NON-NLS-1$
