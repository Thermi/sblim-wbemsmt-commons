 ...
 *
 *
 * Description:  A StorageLibrary is a collection of ManagedSystemElements that operate together
 * to provide cartridge library capabilities. This object serves as an
 * aggregation point to group the following elements: MediaTransferDevices, a
 * Label Reader, a library Door, MediaAccessDevices, and other Library
 * components.
 * 
 */
...
/**
 *  A StorageLibrary is a collection of ManagedSystemElements that operate together
 * to provide cartridge library capabilities. This object serves as an
 * aggregation point to group the following elements: MediaTransferDevices, a
 * Label Reader, a library Door, MediaAccessDevices, and other Library
 * components.
...
public class CIM_StorageLibrary extends CIM_System  {
	...
	public final static String CIM_CLASS_NAME = "CIM_StorageLibrary"; //$NON-NLS-1$
