 ...
 * parameters for one or more ManagedElements. A ManagedElement can have
 * multiple SettingData objects associated with it. The current operational
 * values for the parameters of the element are reflected by properties in the
 * Element itself or by properties in its associations. These properties do not
 * have to be the same values that are present in the SettingData object. For
 * example, a modem might have a SettingData baud rate of 56Kb/sec but be
 * operating at 19.2Kb/sec. Note: The CIM_SettingData class is very similar to
 ...
 * until a new major release occurs, both classes will exist in the model. Refer
 * to the Core White Paper for additional information. SettingData instances can
 * be aggregated together into higher- level SettingData objects using
...
For DMTF-defined instances, the "preferred" algorithm must be used with the <OrgID> set to CIM.
	...
	*/	
	...
	public ArrayList getAssociated_CIM_Capabilities_CIM_SettingAssociatedToCapabilitiess(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_Capabilities_CIM_SettingAssociatedToCapabilities_Names(CIMClient cimClient, boolean deep) {
