...
public class CIM_InstModificationHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_InstModification.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_InstModification.CIM_CLASS_NAME
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_InstModification.");
                        resultArrayList.add(new CIM_InstModification(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_InstModification.");
                        resultArrayList.add(new CIM_InstModification(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_InstModification.");
                        resultArrayList.add(new CIM_InstModification(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_InstModification getInstance(WBEMClient client,
     ...
     */
    public final static CIM_InstModification getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
     ...
     *
     */
    public final static CIM_InstModification createInstance(WBEMClient client,
            CIM_InstModification dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_InstModification newDataInstance = CIM_InstModificationHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_InstModification modifyInstance(WBEMClient client,
            CIM_InstModification dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_InstModification dataInstance2 = CIM_InstModificationHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_InstModification dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_InstModification.getPackages());
    }
