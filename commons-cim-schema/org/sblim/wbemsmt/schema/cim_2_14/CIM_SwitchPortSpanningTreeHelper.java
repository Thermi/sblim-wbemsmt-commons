/** 
 * CIM_SwitchPortSpanningTreeHelper.java
 *
...
public final class CIM_SwitchPortSpanningTreeHelper {

	public final static String CIM_CLASS_NAME = "CIM_SwitchPortSpanningTree";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_SwitchPortSpanningTree(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_SwitchPortSpanningTree.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SwitchPortSpanningTree.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_SwitchPortSpanningTree.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_SwitchPortSpanningTree.Java_Package_List.setElementAt((String)(CIM_SwitchPortSpanningTree.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_SwitchPortSpanningTree.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SwitchPortSpanningTree.");
						resultArrayList.add(new CIM_SwitchPortSpanningTree(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SwitchPortSpanningTree.");
						resultArrayList.add(new CIM_SwitchPortSpanningTree(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SwitchPortSpanningTree.");
						resultArrayList.add(new CIM_SwitchPortSpanningTree(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SwitchPortSpanningTree getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SwitchPortSpanningTreeHelper.getInstance(cimClient, new CIM_SwitchPortSpanningTree(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchPortSpanningTree getInstance(CIMClient cimClient, CIM_SwitchPortSpanningTree dataInstance) {
		...
		return CIM_SwitchPortSpanningTreeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SwitchPortSpanningTree getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SwitchPortSpanningTree dataInstance = null;
		try {
			dataInstance = new CIM_SwitchPortSpanningTree(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchPortSpanningTree createInstance(CIMClient cimClient, CIM_SwitchPortSpanningTree dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SwitchPortSpanningTree newDataInstance = null;
		try {
			newDataInstance = CIM_SwitchPortSpanningTreeHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SwitchPortSpanningTree modifyInstance(CIMClient cimClient, CIM_SwitchPortSpanningTree dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SwitchPortSpanningTreeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SwitchPortSpanningTree dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SwitchPortSpanningTree dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SwitchPortSpanningTree.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SwitchPortSpanningTree.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SwitchPortSpanningTree.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SwitchPortSpanningTree.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SwitchPortSpanningTree.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DesignatedBridge(String DesignatedBridge) {
		return true;
	}

	public static boolean isValid_DesignatedCost(UnsignedInt16 DesignatedCost) {
		return true;
	}

	public static boolean isValid_DesignatedPort(UnsignedInt16 DesignatedPort) {
		return true;
	}

	public static boolean isValid_DesignatedRoot(String DesignatedRoot) {
		return true;
	}

	public static boolean isValid_Enable(UnsignedInt16 Enable) {
		return true;
	}

	public static boolean isValid_PathCost(UnsignedInt16 PathCost) {
		return true;
	}

	public static boolean isValid_Priority(UnsignedInt8 Priority) {
		return true;
	}
	...
	public static boolean isValid_CIM_SwitchPort(CIM_SwitchPort CIM_SwitchPort) {
		return true;
	}

	public static boolean isValid_CIM_SpanningTreeService(CIM_SpanningTreeService CIM_SpanningTreeService) {
		return true;
	}
