 ...
 *
 *
 * Description:  IPHeadersFilter contains the most commonly required properties for performing
 * filtering on IP, TCP or UDP headers. Properties not present in an instance of
 * the IPHeadersFilter are treated as 'all values'.
 * 
 */
...
/**
 *  IPHeadersFilter contains the most commonly required properties for performing
 * filtering on IP, TCP or UDP headers. Properties not present in an instance of
 * the IPHeadersFilter are treated as 'all values'.
 */
public class CIM_IPHeadersFilter extends CIM_FilterEntryBase  {
	
	public final static String CIM_CLASS_NAME = "CIM_IPHeadersFilter"; //$NON-NLS-1$
