/** 
 * CIM_BlockStatisticsManifestCollectionHelper.java
 *
...
public final class CIM_BlockStatisticsManifestCollectionHelper {

	public final static String CIM_CLASS_NAME = "CIM_BlockStatisticsManifestCollection";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BlockStatisticsManifestCollection.");
						resultArrayList.add(new CIM_BlockStatisticsManifestCollection(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BlockStatisticsManifestCollection.");
						resultArrayList.add(new CIM_BlockStatisticsManifestCollection(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BlockStatisticsManifestCollection.");
						resultArrayList.add(new CIM_BlockStatisticsManifestCollection(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BlockStatisticsManifestCollection getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BlockStatisticsManifestCollectionHelper.getInstance(cimClient, new CIM_BlockStatisticsManifestCollection(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BlockStatisticsManifestCollection getInstance(CIMClient cimClient, CIM_BlockStatisticsManifestCollection dataInstance) {
		...
		return CIM_BlockStatisticsManifestCollectionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BlockStatisticsManifestCollection getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BlockStatisticsManifestCollection dataInstance = null;
		try {
			dataInstance = new CIM_BlockStatisticsManifestCollection(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BlockStatisticsManifestCollection createInstance(CIMClient cimClient, CIM_BlockStatisticsManifestCollection dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BlockStatisticsManifestCollection newDataInstance = null;
		try {
			newDataInstance = CIM_BlockStatisticsManifestCollectionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BlockStatisticsManifestCollection modifyInstance(CIMClient cimClient, CIM_BlockStatisticsManifestCollection dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BlockStatisticsManifestCollectionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BlockStatisticsManifestCollection dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BlockStatisticsManifestCollection dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BlockStatisticsManifestCollection.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BlockStatisticsManifestCollection.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BlockStatisticsManifestCollection.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BlockStatisticsManifestCollection.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BlockStatisticsManifestCollection.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ElementName(String ElementName) {
		return true;
	}

	public static boolean isValid_IsDefault(Boolean IsDefault) {
		return true;
	}
