 ...
 *
 *
 * Description:  AssociatedNextHop depicts the relationship between a route and the
 ...
 * relationship is independent of RouteUsesEndpoint (the local Endpoint used to
...
public class CIM_AssociatedNextHop extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AssociatedNextHop"; //$NON-NLS-1$
