...
public final class CIM_BGPAttributesHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_BGPAttributes.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BGPAttributes.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_BGPAttributes.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_BGPAttributes.Java_Package_List.setElementAt((String)(CIM_BGPAttributes.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BGPAttributes.");
						resultArrayList.add(new CIM_BGPAttributes(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BGPAttributes.");
						resultArrayList.add(new CIM_BGPAttributes(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BGPAttributes.");
						resultArrayList.add(new CIM_BGPAttributes(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BGPAttributes getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BGPAttributesHelper.getInstance(cimClient, new CIM_BGPAttributes(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPAttributes getInstance(CIMClient cimClient, CIM_BGPAttributes dataInstance) {
		...
		return CIM_BGPAttributesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BGPAttributes getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BGPAttributes dataInstance = null;
		try {
			dataInstance = new CIM_BGPAttributes(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPAttributes createInstance(CIMClient cimClient, CIM_BGPAttributes dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BGPAttributes newDataInstance = null;
		try {
			newDataInstance = CIM_BGPAttributesHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BGPAttributes modifyInstance(CIMClient cimClient, CIM_BGPAttributes dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BGPAttributesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BGPAttributes dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BGPAttributes dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BGPAttributes.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BGPAttributes.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BGPAttributes.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BGPAttributes.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BGPAttributes.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ASPath(String ASPath) {
		return true;
	}

	public static boolean isValid_Aggregator(String Aggregator) {
		return true;
	}

	public static boolean isValid_AsSet(String AsSet) {
		return true;
	}

	public static boolean isValid_AtomicAggregate(Boolean AtomicAggregate) {
		return true;
	}

	public static boolean isValid_BGPCommunityValue(UnsignedInt32 BGPCommunityValue) {
		return true;
	}

	public static boolean isValid_LocalPreference(UnsignedInt16 LocalPreference) {
		return true;
	}

	public static boolean isValid_MED(UnsignedInt32 MED) {
		return true;
	}

	public static boolean isValid_NextHop(String NextHop) {
		return true;
	}

	public static boolean isValid_NextHopSelf(String NextHopSelf) {
		return true;
	}

	public static boolean isValid_Origin(UnsignedInt16 Origin) {
		return true;
	}

	public static boolean isValid_OriginatorID(String OriginatorID) {
		return true;
	}
