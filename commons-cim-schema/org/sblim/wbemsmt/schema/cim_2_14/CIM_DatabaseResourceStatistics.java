 ...
 *
 *
 * Description:  The CIM_DatabaseServiceStatistics class contains the current statistics for a
 * database resource. This class maps to the database and server-limited
 * resource tables in the SNMP RDBMS MIB as defined in RFC 1697.
 * 
 */
...
/**
 *  The CIM_DatabaseServiceStatistics class contains the current statistics for a
 * database resource. This class maps to the database and server-limited
 * resource tables in the SNMP RDBMS MIB as defined in RFC 1697.
 */
public class CIM_DatabaseResourceStatistics extends CIM_StatisticalData  {
	
	public final static String CIM_CLASS_NAME = "CIM_DatabaseResourceStatistics"; //$NON-NLS-1$
	...
	*/
	...
	/**
	*	The number of times that the system wanted to exceed the database resource limit that is measured from the time when the first service was started for the database.
	*/
	public final static String CIM_PROPERTY_FAILURES = "Failures"; //$NON-NLS-1$
	/**
	*	The number of database resources used, as measured from the time when the first service was started for the database. 
Other external factors, such as an explicit reset of the statistics might cause this measurement to begin at a later point in time.
	*/
