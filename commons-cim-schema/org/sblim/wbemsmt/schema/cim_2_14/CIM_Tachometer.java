 ...
 *
 *
 * Description:  The use of this class is deprecated in lieu of the additions to Sensor and
 * NumericSensor. A Tachometer can be defined by setting the SensorType
 * property. inherited from Sensor, to 5 ("Tachometer").
 * 
 */
...
/**
 *  The use of this class is deprecated in lieu of the additions to Sensor and
 * NumericSensor. A Tachometer can be defined by setting the SensorType
 * property. inherited from Sensor, to 5 ("Tachometer").
 */
public class CIM_Tachometer extends CIM_NumericSensor  {
	
	public final static String CIM_CLASS_NAME = "CIM_Tachometer"; //$NON-NLS-1$
