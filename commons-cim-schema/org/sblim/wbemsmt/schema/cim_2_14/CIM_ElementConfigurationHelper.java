...
public class CIM_ElementConfigurationHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementConfiguration.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ElementConfiguration.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ElementConfiguration.");
                        resultArrayList.add(new CIM_ElementConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementConfiguration.");
                        resultArrayList.add(new CIM_ElementConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementConfiguration.");
                        resultArrayList.add(new CIM_ElementConfiguration(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementConfiguration getInstance(WBEMClient client,
    ...
    public final static CIM_ElementConfiguration getInstance(WBEMClient client, String namespace,
            CIM_ManagedSystemElement Element, CIM_Configuration Configuration
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementConfiguration.PROPERTY_ELEMENT_CIM_MANAGEDSYSTEMELEMENT.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ElementConfiguration.PROPERTY_CONFIGURATION_CIM_CONFIGURATION.NAME,
     ...
     *
     */
    public final static CIM_ElementConfiguration createInstance(WBEMClient client,
            CIM_ElementConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ElementConfiguration newDataInstance = CIM_ElementConfigurationHelper.getInstance(
     ...
     */
    public final static CIM_ElementConfiguration modifyInstance(WBEMClient client,
            CIM_ElementConfiguration dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementConfiguration dataInstance2 = CIM_ElementConfigurationHelper.getInstance(
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ElementConfiguration dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementConfiguration.getPackages());
    }
