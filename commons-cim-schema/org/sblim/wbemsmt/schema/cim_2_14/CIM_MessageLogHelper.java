...
public final class CIM_MessageLogHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_MessageLog.Java_Package_List.size(); i++) {
						if (!((String)(CIM_MessageLog.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_MessageLog.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_MessageLog.Java_Package_List.setElementAt((String)(CIM_MessageLog.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_MessageLog.");
						resultArrayList.add(new CIM_MessageLog(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_MessageLog.");
						resultArrayList.add(new CIM_MessageLog(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_MessageLog.");
						resultArrayList.add(new CIM_MessageLog(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_MessageLog getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_MessageLogHelper.getInstance(cimClient, new CIM_MessageLog(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_MessageLog getInstance(CIMClient cimClient, CIM_MessageLog dataInstance) {
		...
		return CIM_MessageLogHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_MessageLog getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_MessageLog dataInstance = null;
		try {
			dataInstance = new CIM_MessageLog(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_MessageLog createInstance(CIMClient cimClient, CIM_MessageLog dataInstance, boolean notifyDifferencies){ 
		...
		CIM_MessageLog newDataInstance = null;
		try {
			newDataInstance = CIM_MessageLogHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_MessageLog modifyInstance(CIMClient cimClient, CIM_MessageLog dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_MessageLogHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_MessageLog dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_MessageLog dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_MessageLog.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_MessageLog.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_MessageLog.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_MessageLog.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_MessageLog.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CapabilitiesDescriptions(String[] CapabilitiesDescriptions) {
		return true;
	}
	...
	public static boolean isValid_CharacterSet(UnsignedInt16 CharacterSet) {
		return true;
	}
	...
	public static boolean isValid_HeaderFormat(String HeaderFormat) {
		return true;
	}

	public static boolean isValid_IsFrozen(Boolean IsFrozen) {
		return true;
	}

	public static boolean isValid_LastChange(UnsignedInt16 LastChange) {
		return true;
	}

	public static boolean isValid_MaxLogSize(UnsignedInt64 MaxLogSize) {
		return true;
	}

	public static boolean isValid_MaxRecordSize(UnsignedInt64 MaxRecordSize) {
		return true;
	}
	...
	public static boolean isValid_OtherPolicyDescription(String OtherPolicyDescription) {
		return true;
	}

	public static boolean isValid_OverwritePolicy(UnsignedInt16 OverwritePolicy) {
		return true;
	}

	public static boolean isValid_PercentageNearFull(UnsignedInt8 PercentageNearFull) {
		return true;
	}

	public static boolean isValid_RecordHeaderFormat(String RecordHeaderFormat) {
		return true;
	}

	public static boolean isValid_RecordLastChanged(UnsignedInt64 RecordLastChanged) {
		return true;
	}

	public static boolean isValid_SizeOfHeader(UnsignedInt64 SizeOfHeader) {
		return true;
	}

	public static boolean isValid_SizeOfRecordHeader(UnsignedInt64 SizeOfRecordHeader) {
		return true;
	}

	public static boolean isValid_TimeOfLastChange(Calendar TimeOfLastChange) {
		return true;
	}

	public static boolean isValid_TimeWhenOutdated(Calendar TimeWhenOutdated) {
		return true;
	}
