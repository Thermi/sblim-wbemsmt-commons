 ...
 *
 *
 * Description:  This subclass of StorageSetting allows a client to specify 'hint's for
 * optimization of the volume performance. The effect of these hints is
...
/**
 *  This subclass of StorageSetting allows a client to specify 'hint's for
 * optimization of the volume performance. The effect of these hints is
 * implementation dependent.
 */
public class CIM_StorageSettingWithHints extends CIM_StorageSetting  {
	
	public final static String CIM_CLASS_NAME = "CIM_StorageSettingWithHints"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_StorageSetting.Java_Package_List.size(); i++) {
			if (((String)CIM_StorageSetting.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
