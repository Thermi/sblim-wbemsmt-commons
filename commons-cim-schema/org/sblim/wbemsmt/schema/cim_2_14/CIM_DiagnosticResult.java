 ...
 *
 *
 * Description:  When a DiagnosticTest Service is running, test results are reported using a
 * DiagnosticResult object, or one of its subclasses. A DiagnosticTest may be
 * running because its Service is Started or due to an invocation of the RunTest
 * method. Diagnostic Results are related to their Test via an instance of the
 * DiagnosticResultsForMSE association. For every running of DiagnosticTest, a
 * new instance of DiagnosticResult, or one of it's subclasses should be
 * created.
 * 
 */
...
/**
 *  When a DiagnosticTest Service is running, test results are reported using a
 * DiagnosticResult object, or one of its subclasses. A DiagnosticTest may be
 * running because its Service is Started or due to an invocation of the RunTest
 * method. Diagnostic Results are related to their Test via an instance of the
 * DiagnosticResultsForMSE association. For every running of DiagnosticTest, a
...
public class CIM_DiagnosticResult  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DiagnosticResult"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DIAGNOSTICRESULTINPACKAGE = "CIM_DiagnosticResultInPackage"; //$NON-NLS-1$
