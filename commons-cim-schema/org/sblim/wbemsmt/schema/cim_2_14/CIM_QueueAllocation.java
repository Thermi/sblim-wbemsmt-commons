 ...
 *
 *
 * Description:  Describes the reliance of a QueuingService on the availability of space in a
 * BufferPool.
 * 
 */
...
/**
 *  Describes the reliance of a QueuingService on the availability of space in a
 * BufferPool.
 */
public class CIM_QueueAllocation extends CIM_Dependency  {
	
	public final static String CIM_CLASS_NAME = "CIM_QueueAllocation"; //$NON-NLS-1$
