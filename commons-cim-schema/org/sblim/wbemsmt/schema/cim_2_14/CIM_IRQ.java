...
public class CIM_IRQ extends CIM_SystemResource  {
	...
	public final static String CIM_CLASS_NAME = "CIM_IRQ"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.6.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPUTERSYSTEMIRQ = "CIM_ComputerSystemIRQ"; //$NON-NLS-1$
