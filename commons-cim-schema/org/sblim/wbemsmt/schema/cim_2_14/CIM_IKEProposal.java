 ...
 *
 *
 * Description:  IKEProposal contains the parameters necessary to drive the phase 1 IKE
 * negotiation.
 * 
 */
...
/**
 *  IKEProposal contains the parameters necessary to drive the phase 1 IKE
 * negotiation.
 */
public class CIM_IKEProposal extends CIM_SAProposal  {
	
	public final static String CIM_CLASS_NAME = "CIM_IKEProposal"; //$NON-NLS-1$
