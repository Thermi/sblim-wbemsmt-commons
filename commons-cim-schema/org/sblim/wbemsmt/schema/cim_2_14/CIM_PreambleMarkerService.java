 ...
 *
 *
 * Description:  PreambleMarkerService models the storing of traffic- conditioning results in a
 * packet preamble. An instance appends a two-part string of the form
 * '<type>,<value>' to the packet preamble. The concept of 'type's is discussed
 * more fully in the Description of the class' FilterItemList property.
 * 
 */
...
/**
 *  PreambleMarkerService models the storing of traffic- conditioning results in a
 * packet preamble. An instance appends a two-part string of the form
 * '<type>,<value>' to the packet preamble. The concept of 'type's is discussed
 * more fully in the Description of the class' FilterItemList property.
 */
public class CIM_PreambleMarkerService extends CIM_MarkerService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_PreambleMarkerService"; //$NON-NLS-1$
