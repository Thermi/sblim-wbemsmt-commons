 ...
 *
 *
 * Description:  DSCPMarkerService marks the differentiated services codepoint (DSCP) within the
 * DS field in the IPv4 and IPv6 packet headers, as defined in [R2474]. It is
 * marked with the specific value defined in the property, DSCPValue. Following
 * common practice, the value to be written into the field is represented as an
...
/**
 *  DSCPMarkerService marks the differentiated services codepoint (DSCP) within the
 * DS field in the IPv4 and IPv6 packet headers, as defined in [R2474]. It is
 * marked with the specific value defined in the property, DSCPValue. Following
 * common practice, the value to be written into the field is represented as an
 * unsigned 8-bit integer.
...
public class CIM_DSCPMarkerService extends CIM_MarkerService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DSCPMarkerService"; //$NON-NLS-1$
