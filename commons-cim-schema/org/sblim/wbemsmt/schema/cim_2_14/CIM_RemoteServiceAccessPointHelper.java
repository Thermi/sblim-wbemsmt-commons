/** 
 * CIM_RemoteServiceAccessPointHelper.java
 *
...
public final class CIM_RemoteServiceAccessPointHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_RemoteServiceAccessPoint.Java_Package_List.size(); i++) {
						if (!((String)(CIM_RemoteServiceAccessPoint.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_RemoteServiceAccessPoint.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_RemoteServiceAccessPoint.Java_Package_List.setElementAt((String)(CIM_RemoteServiceAccessPoint.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RemoteServiceAccessPoint.");
						resultArrayList.add(new CIM_RemoteServiceAccessPoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RemoteServiceAccessPoint.");
						resultArrayList.add(new CIM_RemoteServiceAccessPoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RemoteServiceAccessPoint.");
						resultArrayList.add(new CIM_RemoteServiceAccessPoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_RemoteServiceAccessPoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_RemoteServiceAccessPointHelper.getInstance(cimClient, new CIM_RemoteServiceAccessPoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RemoteServiceAccessPoint getInstance(CIMClient cimClient, CIM_RemoteServiceAccessPoint dataInstance) {
		...
		return CIM_RemoteServiceAccessPointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RemoteServiceAccessPoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_RemoteServiceAccessPoint dataInstance = null;
		try {
			dataInstance = new CIM_RemoteServiceAccessPoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RemoteServiceAccessPoint createInstance(CIMClient cimClient, CIM_RemoteServiceAccessPoint dataInstance, boolean notifyDifferencies){ 
		...
		CIM_RemoteServiceAccessPoint newDataInstance = null;
		try {
			newDataInstance = CIM_RemoteServiceAccessPointHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RemoteServiceAccessPoint modifyInstance(CIMClient cimClient, CIM_RemoteServiceAccessPoint dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_RemoteServiceAccessPointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_RemoteServiceAccessPoint dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_RemoteServiceAccessPoint dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_RemoteServiceAccessPoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_RemoteServiceAccessPoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_RemoteServiceAccessPoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_RemoteServiceAccessPoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_RemoteServiceAccessPoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_InfoFormat(UnsignedInt16 InfoFormat) {
		return true;
	}

	public static boolean isValid_OtherInfoFormatDescription(String OtherInfoFormatDescription) {
		return true;
	}
