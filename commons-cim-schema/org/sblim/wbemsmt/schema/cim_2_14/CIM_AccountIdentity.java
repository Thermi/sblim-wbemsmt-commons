 ...
 *
 *
 * Description:  CIM_AccountIdentity relates a system Account with the Identity that is
 * established. Since Account also carries Identity semantics, the
 * LogicalIdentity association is defined as the superclass of this association.
 * 
 */
...
/**
 *  CIM_AccountIdentity relates a system Account with the Identity that is
 * established. Since Account also carries Identity semantics, the
 * LogicalIdentity association is defined as the superclass of this association.
 */
public class CIM_AccountIdentity extends CIM_LogicalIdentity  {
	
	public final static String CIM_CLASS_NAME = "CIM_AccountIdentity"; //$NON-NLS-1$
