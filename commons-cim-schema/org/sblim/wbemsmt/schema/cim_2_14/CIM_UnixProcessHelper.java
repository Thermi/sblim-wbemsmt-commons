...
public final class CIM_UnixProcessHelper {
	...
	*/	
	public final static CIM_UnixProcess getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_UnixProcessHelper.getInstance(cimClient, new CIM_UnixProcess(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UnixProcess getInstance(CIMClient cimClient, CIM_UnixProcess dataInstance) {
		...
		return CIM_UnixProcessHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_UnixProcess getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_UnixProcess(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_UnixProcess.getPackages();
	...
	*/	
	public final static CIM_UnixProcess createInstance(CIMClient cimClient, CIM_UnixProcess dataInstance, boolean notifyDifferencies){ 
		...
		CIM_UnixProcess newDataInstance = null;
		try {
			newDataInstance = CIM_UnixProcessHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_UnixProcess modifyInstance(CIMClient cimClient, CIM_UnixProcess dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_UnixProcessHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_UnixProcess dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_UnixProcess dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_UnixProcess.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_UnixProcess.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_UnixProcess.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_UnixProcess.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_UnixProcess.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ModulePath(String ModulePath) {
		return true;
	}

	public static boolean isValid_Parameters(String[] Parameters) {
		return true;
	}

	public static boolean isValid_ParentProcessID(String ParentProcessID) {
		return true;
	}

	public static boolean isValid_ProcessGroupID(UnsignedInt64 ProcessGroupID) {
		return true;
	}

	public static boolean isValid_ProcessNiceValue(UnsignedInt32 ProcessNiceValue) {
		return true;
	}

	public static boolean isValid_ProcessSessionID(UnsignedInt64 ProcessSessionID) {
		return true;
	}

	public static boolean isValid_ProcessTTY(String ProcessTTY) {
		return true;
	}

	public static boolean isValid_ProcessWaitingForEvent(String ProcessWaitingForEvent) {
		return true;
	}

	public static boolean isValid_RealUserID(UnsignedInt64 RealUserID) {
		return true;
	}
