...
public class CIM_ObjectManagerHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ObjectManager.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_ObjectManager.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ObjectManager.");
                        resultArrayList.add(new CIM_ObjectManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ObjectManager.");
                        resultArrayList.add(new CIM_ObjectManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ObjectManager.");
                        resultArrayList.add(new CIM_ObjectManager(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ObjectManager getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_ObjectManager getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_ObjectManager getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_ObjectManager.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ObjectManager.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[1] = new CIMProperty(CIM_ObjectManager.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ObjectManager.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[2] = new CIMProperty(CIM_ObjectManager.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_ObjectManager.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ObjectManager createInstance(WBEMClient client,
            CIM_ObjectManager dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_ObjectManager newDataInstance = CIM_ObjectManagerHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_ObjectManager modifyInstance(WBEMClient client,
            CIM_ObjectManager dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ObjectManager dataInstance2 = CIM_ObjectManagerHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_ObjectManager dataInstance)
            throws WbemsmtException {
