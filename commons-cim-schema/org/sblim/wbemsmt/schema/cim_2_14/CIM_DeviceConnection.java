 ...
 *
 *
 * Description:  The DeviceConnection relationship indicates that two or more Devices are
 * connected together.
 * 
 */
...
public class CIM_DeviceConnection extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DeviceConnection"; //$NON-NLS-1$
