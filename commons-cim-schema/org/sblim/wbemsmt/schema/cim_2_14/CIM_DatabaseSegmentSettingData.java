 ...
 *
 *
 * Description:  This class defines the attributes that affect the growth of a DatabaseSegment.
 * The attributes are tied to the DatabaseSegment through an ElementSettingData
 * association. This class can also be used to specify the default settings for
 * all DatabaseSegment instances that are created within a CommonDatabase
 * through an ElementSettingData association to the CommonDatabase. Processes
 * that create new instances of DatabaseSegment and the associated setting data
 * should check for a DatabaseSegmentSettingData instance that is associated
 * with the CommonDatabase and should create a new instance of
 * DatabaseSegmentSettingData that is specific to the DatabaseSegment only if
 * the default settings need to be overridden or frozen for the specific
 * DatabaseSegment instance.
 * 
 */
...
/**
 *  This class defines the attributes that affect the growth of a DatabaseSegment.
 * The attributes are tied to the DatabaseSegment through an ElementSettingData
 * association. This class can also be used to specify the default settings for
 * all DatabaseSegment instances that are created within a CommonDatabase
 * through an ElementSettingData association to the CommonDatabase. Processes
...
public class CIM_DatabaseSegmentSettingData extends CIM_ScopedSettingData  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DatabaseSegmentSettingData"; //$NON-NLS-1$
