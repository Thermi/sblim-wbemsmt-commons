/** 
 * CIM_BaseMetricDefinitionHelper.java
 *
...
public final class CIM_BaseMetricDefinitionHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_BaseMetricDefinition.Java_Package_List.size(); i++) {
						if (!((String)(CIM_BaseMetricDefinition.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_BaseMetricDefinition.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_BaseMetricDefinition.Java_Package_List.setElementAt((String)(CIM_BaseMetricDefinition.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_BaseMetricDefinition.");
						resultArrayList.add(new CIM_BaseMetricDefinition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_BaseMetricDefinition.");
						resultArrayList.add(new CIM_BaseMetricDefinition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_BaseMetricDefinition.");
						resultArrayList.add(new CIM_BaseMetricDefinition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_BaseMetricDefinition getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_BaseMetricDefinitionHelper.getInstance(cimClient, new CIM_BaseMetricDefinition(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BaseMetricDefinition getInstance(CIMClient cimClient, CIM_BaseMetricDefinition dataInstance) {
		...
		return CIM_BaseMetricDefinitionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_BaseMetricDefinition getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_BaseMetricDefinition dataInstance = null;
		try {
			dataInstance = new CIM_BaseMetricDefinition(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BaseMetricDefinition createInstance(CIMClient cimClient, CIM_BaseMetricDefinition dataInstance, boolean notifyDifferencies){ 
		...
		CIM_BaseMetricDefinition newDataInstance = null;
		try {
			newDataInstance = CIM_BaseMetricDefinitionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_BaseMetricDefinition modifyInstance(CIMClient cimClient, CIM_BaseMetricDefinition dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_BaseMetricDefinitionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_BaseMetricDefinition dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_BaseMetricDefinition dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_BaseMetricDefinition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_BaseMetricDefinition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_BaseMetricDefinition.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_BaseMetricDefinition.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_BaseMetricDefinition.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BreakdownDimensions(String[] BreakdownDimensions) {
		return true;
	}

	public static boolean isValid_Calculable(UnsignedInt16 Calculable) {
		return true;
	}

	public static boolean isValid_ChangeType(UnsignedInt16 ChangeType) {
		return true;
	}

	public static boolean isValid_DataType(UnsignedInt16 DataType) {
		return true;
	}

	public static boolean isValid_GatheringType(UnsignedInt16 GatheringType) {
		return true;
	}

	public static boolean isValid_Id(String Id) {
		return true;
	}

	public static boolean isValid_IsContinuous(Boolean IsContinuous) {
		return true;
	}
	...
	public static boolean isValid_TimeScope(UnsignedInt16 TimeScope) {
		return true;
	}

	public static boolean isValid_Units(String Units) {
		return true;
	}
