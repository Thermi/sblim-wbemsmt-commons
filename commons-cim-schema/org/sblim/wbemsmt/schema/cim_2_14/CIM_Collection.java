...
public class CIM_Collection extends CIM_ManagedElement  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_MEMBERPRINCIPAL = "CIM_MemberPrincipal"; //$NON-NLS-1$
	...
	*/	
	...
	public ArrayList getAssociated_CIM_OrganizationalEntity_CIM_CollectionInOrganizations(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
		...
		try {
			enumeration = cimClient.associators(
					...
					CIM_OrganizationalEntity.CIM_CLASS_NAME, 
					"Child", //$NON-NLS-1$
					"Parent", //$NON-NLS-1$
					includeQualifiers,
					includeClassOrigin,
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i = 0; clazz == null && i < CIM_Collection.Java_Package_List.size(); i++) {
						if (!((String)(CIM_Collection.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_Collection.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_Collection.Java_Package_List.setElementAt((String)(CIM_Collection.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_Collection.Java_Package_List.get(i)) + cimClassName;
	...
	public ArrayList getAssociated_CIM_OrganizationalEntity_CIM_CollectionInOrganization_Names(CIMClient cimClient, boolean deep) {
		...
		try {		
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMObjectPath) {
					if (deep || ((CIMObjectPath)obj).getObjectName().equals(CIM_OrganizationalEntity.CIM_CLASS_NAME)) {
	...
	public ArrayList getAssociated_CIM_System_CIM_CollectionInSystems(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_System_CIM_CollectionInSystem_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_ManagedElement_CIM_MemberOfCollections(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_ManagedElement_CIM_MemberOfCollection_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_ManagedElement_CIM_MemberPrincipals(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_ManagedElement_CIM_MemberPrincipal_Names(CIMClient cimClient, boolean deep) {
