...
public class CIM_SettingContextHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_SettingContext.CIM_CLASS_NAME,
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(CIM_SettingContext.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_SettingContext.");
                        resultArrayList.add(new CIM_SettingContext(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_SettingContext.");
                        resultArrayList.add(new CIM_SettingContext(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_SettingContext.");
                        resultArrayList.add(new CIM_SettingContext(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_SettingContext getInstance(WBEMClient client,
     ...
     */
    public final static CIM_SettingContext getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_SettingContext getInstance(WBEMClient client, String namespace,
            CIM_Configuration Context, CIM_Setting Setting
        ...
        keyProperties[0] = new CIMProperty(
                CIM_SettingContext.PROPERTY_CONTEXT_CIM_CONFIGURATION.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(CIM_SettingContext.PROPERTY_SETTING_CIM_SETTING.NAME,
     ...
     *
     */
    public final static CIM_SettingContext createInstance(WBEMClient client,
            CIM_SettingContext dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_SettingContext newDataInstance = CIM_SettingContextHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_SettingContext modifyInstance(WBEMClient client,
            CIM_SettingContext dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_SettingContext dataInstance2 = CIM_SettingContextHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_SettingContext dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_SettingContext.getPackages());
    }
