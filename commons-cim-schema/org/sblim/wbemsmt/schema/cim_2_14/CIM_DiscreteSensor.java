 ...
 *
 *
 * Description:  A DiscreteSensor has a set of legal string values, that it can report. These
 * values are enumerated in the Sensor's PossibleValues property. A
 * DiscreteSensor will always have a 'current reading' that corresponds to one
 * of the enumerated values. The use of this class is being deprecated in lieu
 * of CIM_Sensor. Information in the CurrentReading and PossibleValues
 * properties will typically have the same values and semantics as for the
 * CurrentState and PossibleStates properties, inherited from Sensor.
 * 
 */
...
/**
 *  A DiscreteSensor has a set of legal string values, that it can report. These
 * values are enumerated in the Sensor's PossibleValues property. A
 * DiscreteSensor will always have a 'current reading' that corresponds to one
 * of the enumerated values. The use of this class is being deprecated in lieu
 * of CIM_Sensor. Information in the CurrentReading and PossibleValues
...
public class CIM_DiscreteSensor extends CIM_Sensor  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DiscreteSensor"; //$NON-NLS-1$
