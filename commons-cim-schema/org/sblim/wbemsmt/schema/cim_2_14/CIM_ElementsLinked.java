 ...
 *
 *
 * Description:  The ElementsLinked association indicates which Physical Elements are cabled
 * together by a PhysicalLink.
 * 
 */
...
/**
 *  The ElementsLinked association indicates which Physical Elements are cabled
 * together by a PhysicalLink.
 */
public class CIM_ElementsLinked extends CIM_Dependency  {
	
	public final static String CIM_CLASS_NAME = "CIM_ElementsLinked"; //$NON-NLS-1$
