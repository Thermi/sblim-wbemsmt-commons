 ...
 *
 *
 * Description:  CIM_J2eeManagedObject is a class for defining operations that may supported by
 * all J2EE managed objects. It contains the attributes and methods that are
 * common to all J2EE managed objects. The J2EE Managed objects - for eg.
 * J2eeServer should participate in instances of the CIM_LogicalIdentity
 * association with the corresponding instance of the J2eeManagedObject class.
 * The start and stop methods of JSR77's J2eeManagedObject find an equivalent in
 * the RequestStateChange method inherited from EnabledLogicalElement. Using
 * Enabled/Disabled as inputs to RequestStateChange, one can effect start and
 * stop.
 * 
 */
...
/**
 *  CIM_J2eeManagedObject is a class for defining operations that may supported by
 * all J2EE managed objects. It contains the attributes and methods that are
 * common to all J2EE managed objects. The J2EE Managed objects - for eg.
 * J2eeServer should participate in instances of the CIM_LogicalIdentity
 * association with the corresponding instance of the J2eeManagedObject class.
...
public class CIM_J2eeManagedObject extends CIM_EnabledLogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_J2eeManagedObject"; //$NON-NLS-1$
