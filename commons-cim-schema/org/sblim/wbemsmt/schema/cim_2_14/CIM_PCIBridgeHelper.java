...
public final class CIM_PCIBridgeHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_PCIBridge(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_PCIBridge.Java_Package_List.size(); i++) {
						if (!((String)(CIM_PCIBridge.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_PCIBridge.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_PCIBridge.Java_Package_List.setElementAt((String)(CIM_PCIBridge.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_PCIBridge.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PCIBridge.");
						resultArrayList.add(new CIM_PCIBridge(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PCIBridge.");
						resultArrayList.add(new CIM_PCIBridge(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PCIBridge.");
						resultArrayList.add(new CIM_PCIBridge(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PCIBridge getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PCIBridgeHelper.getInstance(cimClient, new CIM_PCIBridge(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PCIBridge getInstance(CIMClient cimClient, CIM_PCIBridge dataInstance) {
		...
		return CIM_PCIBridgeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PCIBridge getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PCIBridge dataInstance = null;
		try {
			dataInstance = new CIM_PCIBridge(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PCIBridge createInstance(CIMClient cimClient, CIM_PCIBridge dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PCIBridge newDataInstance = null;
		try {
			newDataInstance = CIM_PCIBridgeHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PCIBridge modifyInstance(CIMClient cimClient, CIM_PCIBridge dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PCIBridgeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PCIBridge dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PCIBridge dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PCIBridge.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PCIBridge.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PCIBridge.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PCIBridge.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PCIBridge.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BaseAddress(UnsignedInt32 BaseAddress) {
		return true;
	}

	public static boolean isValid_BridgeType(UnsignedInt16 BridgeType) {
		return true;
	}

	public static boolean isValid_IOBase(UnsignedInt8 IOBase) {
		return true;
	}

	public static boolean isValid_IOBaseUpper16(UnsignedInt16 IOBaseUpper16) {
		return true;
	}

	public static boolean isValid_IOLimit(UnsignedInt8 IOLimit) {
		return true;
	}

	public static boolean isValid_IOLimitUpper16(UnsignedInt16 IOLimitUpper16) {
		return true;
	}

	public static boolean isValid_MemoryBase(UnsignedInt16 MemoryBase) {
		return true;
	}

	public static boolean isValid_MemoryLimit(UnsignedInt16 MemoryLimit) {
		return true;
	}

	public static boolean isValid_PrefetchBaseUpper32(UnsignedInt32 PrefetchBaseUpper32) {
		return true;
	}

	public static boolean isValid_PrefetchLimitUpper32(UnsignedInt32 PrefetchLimitUpper32) {
		return true;
	}

	public static boolean isValid_PrefetchMemoryBase(UnsignedInt16 PrefetchMemoryBase) {
		return true;
	}

	public static boolean isValid_PrefetchMemoryLimit(UnsignedInt16 PrefetchMemoryLimit) {
		return true;
	}

	public static boolean isValid_PrimaryBusNumber(UnsignedInt8 PrimaryBusNumber) {
		return true;
	}

	public static boolean isValid_SecondaryBusDeviceSelectTiming(UnsignedInt16 SecondaryBusDeviceSelectTiming) {
		return true;
	}

	public static boolean isValid_SecondaryLatencyTimer(UnsignedInt8 SecondaryLatencyTimer) {
		return true;
	}

	public static boolean isValid_SecondaryStatusRegister(UnsignedInt16 SecondaryStatusRegister) {
		return true;
	}

	public static boolean isValid_SecondayBusNumber(UnsignedInt8 SecondayBusNumber) {
		return true;
	}

	public static boolean isValid_SubordinateBusNumber(UnsignedInt8 SubordinateBusNumber) {
		return true;
	}
