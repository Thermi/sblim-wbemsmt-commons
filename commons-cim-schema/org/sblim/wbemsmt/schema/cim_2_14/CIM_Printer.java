 ...
 *
 *
 * Description:  Capabilities and management of the Printer LogicalDevice. The ABNF for CIM
...
/**
 *  Capabilities and management of the Printer LogicalDevice. The ABNF for CIM
 * references to PWG Standards and MIBs is in the directory
 * 'ftp://ftp.pwg.org/pub/pwg/general/process' in the file
 * 'pwg-cim-references-format-20060309.txt'. An example for a MappingStrings
 * reference to a PWG Standard is 'PWG5101-1.PWG|Section 4 Media Color Names'.
...
public class CIM_Printer extends CIM_LogicalDevice  {
	...
	public final static String CIM_CLASS_NAME = "CIM_Printer"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_PRINTERSERVICINGQUEUE = "CIM_PrinterServicingQueue"; //$NON-NLS-1$
	...
	*/
	...
	/**
	*	An integer array that indicates the types of paper supported.
	*/
	...
	*/
	...
	/**
	*	Status information for a Printer, beyond that specified in the LogicalDevice Availability property. Values include "Idle" (value=3) and an indication that the Device is currently printing (value=4).
	*/
	...
	*/
	...
	public final static String[] CIM_VALUEMAP_DETECTEDERRORSTATE = {"Unknown","Other","No Error","Low Paper","No Paper","Low Toner","No Toner","Door Open","Jammed","Offline","Service Requested","Output Bin Full","Input Tray Missing","Output Tray Missing","Marker Supply Missing","Output Near Full","Input Tray Empty","Overdue Prevent Maint"};
	...
	public final static int CURRENTLANGUAGE_ART = 61;
	public final static int CURRENTLANGUAGE_CGM = 62;
	public final static int CURRENTLANGUAGE_JPEG = 63;
	public final static int CURRENTLANGUAGE_CALS1 = 64;
	public final static int CURRENTLANGUAGE_CALS2 = 65;
	public final static int CURRENTLANGUAGE_NIRS = 66;
	public final static int CURRENTLANGUAGE_C4 = 67;
	...
	public final static int DEFAULTLANGUAGE_ART = 61;
	public final static int DEFAULTLANGUAGE_CGM = 62;
	public final static int DEFAULTLANGUAGE_JPEG = 63;
	public final static int DEFAULTLANGUAGE_CALS1 = 64;
	public final static int DEFAULTLANGUAGE_CALS2 = 65;
	public final static int DEFAULTLANGUAGE_NIRS = 66;
	public final static int DEFAULTLANGUAGE_C4 = 67;
	...
	public final static int DETECTEDERRORSTATE_INPUTTRAYMISSING = 12;
	public final static int DETECTEDERRORSTATE_OUTPUTTRAYMISSING = 13;
	public final static int DETECTEDERRORSTATE_MARKERSUPPLYMISSING = 14;
	public final static int DETECTEDERRORSTATE_OUTPUTNEARFULL = 15;
	public final static int DETECTEDERRORSTATE_INPUTTRAYEMPTY = 16;
	public final static int DETECTEDERRORSTATE_OVERDUEPREVENTMAINT = 17;
