 ...
 *
 *
 * Description:  The OtherPersonInformation class is used to provide additional information
 * about an associated Person instance. This class is defined so as to
...
/**
 *  The OtherPersonInformation class is used to provide additional information
 * about an associated Person instance. This class is defined so as to
 * incorporate commonly-used LDAP attributes to permit implementations to easily
 * derive this information from LDAP-accessible directories.
 */
public class CIM_OtherPersonInformation extends CIM_ManagedElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_OtherPersonInformation"; //$NON-NLS-1$
