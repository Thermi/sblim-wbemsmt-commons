 ...
 *
 *
 * Description:  Note: The use of the CIM_NetworkAdpater class has been deprecated in lieu of
 * CIM_NetworkPort. CIM_NetworkPort better reflects that the hardware of a
 * single port is described and managed. Deprecated description: NetworkAdapter
 * is an Abstract class that defines general networking hardware concepts (for
...
/**
 *  Note: The use of the CIM_NetworkAdpater class has been deprecated in lieu of
 * CIM_NetworkPort. CIM_NetworkPort better reflects that the hardware of a
 * single port is described and managed. Deprecated description: NetworkAdapter
 * is an Abstract class that defines general networking hardware concepts (for
 * example, PermanentAddress or Speed of operation).
