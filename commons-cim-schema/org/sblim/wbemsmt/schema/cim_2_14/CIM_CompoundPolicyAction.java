 ...
 *
 *
 * Description:  CompoundPolicyAction is used to represent an expression consisting of an
 * ordered sequence of action terms. Each action term is represented as a
 * subclass of the PolicyAction class. Compound actions are constructed by
 * associating dependent action terms together using the
...
/**
 *  CompoundPolicyAction is used to represent an expression consisting of an
 * ordered sequence of action terms. Each action term is represented as a
 * subclass of the PolicyAction class. Compound actions are constructed by
 * associating dependent action terms together using the
 * PolicyActionInPolicyAction aggregation.
...
public class CIM_CompoundPolicyAction extends CIM_PolicyAction  {
	...
	public final static String CIM_CLASS_NAME = "CIM_CompoundPolicyAction"; //$NON-NLS-1$
