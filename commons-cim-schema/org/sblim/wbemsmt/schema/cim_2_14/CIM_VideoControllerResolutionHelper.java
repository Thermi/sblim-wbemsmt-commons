/** 
 * CIM_VideoControllerResolutionHelper.java
 *
...
public final class CIM_VideoControllerResolutionHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_VideoControllerResolution.Java_Package_List.size(); i++) {
						if (!((String)(CIM_VideoControllerResolution.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_VideoControllerResolution.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_VideoControllerResolution.Java_Package_List.setElementAt((String)(CIM_VideoControllerResolution.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VideoControllerResolution.");
						resultArrayList.add(new CIM_VideoControllerResolution(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VideoControllerResolution.");
						resultArrayList.add(new CIM_VideoControllerResolution(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VideoControllerResolution.");
						resultArrayList.add(new CIM_VideoControllerResolution(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_VideoControllerResolution getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_VideoControllerResolutionHelper.getInstance(cimClient, new CIM_VideoControllerResolution(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_VideoControllerResolution getInstance(CIMClient cimClient, CIM_VideoControllerResolution dataInstance) {
		...
		return CIM_VideoControllerResolutionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_VideoControllerResolution getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_VideoControllerResolution dataInstance = null;
		try {
			dataInstance = new CIM_VideoControllerResolution(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_VideoControllerResolution createInstance(CIMClient cimClient, CIM_VideoControllerResolution dataInstance, boolean notifyDifferencies){ 
		...
		CIM_VideoControllerResolution newDataInstance = null;
		try {
			newDataInstance = CIM_VideoControllerResolutionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_VideoControllerResolution modifyInstance(CIMClient cimClient, CIM_VideoControllerResolution dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_VideoControllerResolutionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_VideoControllerResolution dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_VideoControllerResolution dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_VideoControllerResolution.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_VideoControllerResolution.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_VideoControllerResolution.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_VideoControllerResolution.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_VideoControllerResolution.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_NumberOfColors(UnsignedInt64 NumberOfColors) {
		return true;
	}

	public static boolean isValid_RefreshRate(UnsignedInt32 RefreshRate) {
		return true;
	}

	public static boolean isValid_ScanMode(UnsignedInt16 ScanMode) {
		return true;
	}
