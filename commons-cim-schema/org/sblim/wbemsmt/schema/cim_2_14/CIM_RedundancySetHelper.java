...
public final class CIM_RedundancySetHelper {

	public final static String CIM_CLASS_NAME = "CIM_RedundancySet";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_RedundancySet(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RedundancySet.");
						resultArrayList.add(new CIM_RedundancySet(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RedundancySet.");
						resultArrayList.add(new CIM_RedundancySet(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RedundancySet.");
						resultArrayList.add(new CIM_RedundancySet(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_RedundancySet getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_RedundancySetHelper.getInstance(cimClient, new CIM_RedundancySet(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RedundancySet getInstance(CIMClient cimClient, CIM_RedundancySet dataInstance) {
		...
		return CIM_RedundancySetHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RedundancySet getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_RedundancySet dataInstance = null;
		try {
			dataInstance = new CIM_RedundancySet(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RedundancySet createInstance(CIMClient cimClient, CIM_RedundancySet dataInstance, boolean notifyDifferencies){ 
		...
		CIM_RedundancySet newDataInstance = null;
		try {
			newDataInstance = CIM_RedundancySetHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RedundancySet modifyInstance(CIMClient cimClient, CIM_RedundancySet dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_RedundancySetHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_RedundancySet dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_RedundancySet dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_RedundancySet.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_RedundancySet.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_RedundancySet.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_RedundancySet.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_RedundancySet.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_LoadBalanceAlgorithm(UnsignedInt16 LoadBalanceAlgorithm) {
		return true;
	}

	public static boolean isValid_MaxNumberSupported(UnsignedInt32 MaxNumberSupported) {
		return true;
	}

	public static boolean isValid_MinNumberNeeded(UnsignedInt32 MinNumberNeeded) {
		return true;
	}

	public static boolean isValid_OtherLoadBalanceAlgorithm(String OtherLoadBalanceAlgorithm) {
		return true;
	}

	public static boolean isValid_OtherTypeOfSet(String[] OtherTypeOfSet) {
		return true;
	}

	public static boolean isValid_RedundancyStatus(UnsignedInt16 RedundancyStatus) {
		return true;
	}

	public static boolean isValid_TypeOfSet(UnsignedInt16[] TypeOfSet) {
		return true;
	}

	public static boolean isValid_VendorIdentifyingInfo(String VendorIdentifyingInfo) {
		return true;
	}
