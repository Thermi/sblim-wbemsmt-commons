 ...
 *
 *
 * Description:  The Organization class is used to represent an organization such as a
 * corporation or other autonomous entity. The class is defined so as to
 * incorporate commonly-used LDAP attributes to permit implementations to easily
 * derive this information from LDAP-accessible directories. This class's
 * properties are a subset of a related class, OtherOrganizationInformation,
 * which defines all the group properties and in array form for directory
 * compatibility.
 * 
 */
...
/**
 *  The Organization class is used to represent an organization such as a
 * corporation or other autonomous entity. The class is defined so as to
 * incorporate commonly-used LDAP attributes to permit implementations to easily
 * derive this information from LDAP-accessible directories. This class's
 * properties are a subset of a related class, OtherOrganizationInformation,
...
public class CIM_Organization extends CIM_OrganizationalEntity  {
	...
	public final static String CIM_CLASS_NAME = "CIM_Organization"; //$NON-NLS-1$
