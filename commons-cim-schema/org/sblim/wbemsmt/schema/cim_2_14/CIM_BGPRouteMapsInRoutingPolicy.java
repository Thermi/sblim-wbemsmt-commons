 ...
 *
 *
 * Description:  This aggregation defines the BGPRouteMaps that are used by a particular
 * RoutingPolicy object. Multiple instances of the same RouteMap may be used in
 * the same RoutingPolicy instance. If this is desired, then the Sequence
...
public class CIM_BGPRouteMapsInRoutingPolicy extends CIM_Component  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BGPRouteMapsInRoutingPolicy"; //$NON-NLS-1$
