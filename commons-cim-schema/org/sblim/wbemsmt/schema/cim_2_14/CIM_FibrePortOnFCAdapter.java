 ...
 *
 *
 * Description:  Note: The use of this method has been deprecated. Deprecated description: The
 * use of FibrePortOnFCAdapter is deprecated because both FibrePort and
 * FibreChannelAdapter have been deprecated. No replacement is needed because
 * the 2 classes are combined into a single class. FibrePortOnFCAdapter
...
/**
 *  Note: The use of this method has been deprecated. Deprecated description: The
 * use of FibrePortOnFCAdapter is deprecated because both FibrePort and
 * FibreChannelAdapter have been deprecated. No replacement is needed because
 * the 2 classes are combined into a single class. FibrePortOnFCAdapter
 * associates a FibrePort with a FibreChannelAdapter.
