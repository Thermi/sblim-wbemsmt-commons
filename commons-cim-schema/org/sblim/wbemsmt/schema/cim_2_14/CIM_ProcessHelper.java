...
public class CIM_ProcessHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Process.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_Process.");
                        resultArrayList.add(new CIM_Process(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_Process.");
                        resultArrayList.add(new CIM_Process(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Process.");
                        resultArrayList.add(new CIM_Process(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Process getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Process getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_Process getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_Process.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Process.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_Process.PROPERTY_CSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Process.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_Process.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Process.CIM_CLASS_NAME);

        setThis = Handle;

        keyProperties[3] = new CIMProperty(CIM_Process.PROPERTY_HANDLE.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Process.CIM_CLASS_NAME);

        setThis = OSCreationClassName;

        keyProperties[4] = new CIMProperty(CIM_Process.PROPERTY_OSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Process.CIM_CLASS_NAME);

        setThis = OSName;

        keyProperties[5] = new CIMProperty(CIM_Process.PROPERTY_OSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_Process.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_Process createInstance(WBEMClient client, CIM_Process dataInstance,
     ...
     */
    public final static CIM_Process modifyInstance(WBEMClient client, CIM_Process dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_Process dataInstance2 = CIM_ProcessHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_Process dataInstance)
            throws WbemsmtException {
