...
public final class CIM_ManagedSystemElementHelper {
	...
	*/	
	public final static CIM_ManagedSystemElement getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ManagedSystemElementHelper.getInstance(cimClient, new CIM_ManagedSystemElement(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ManagedSystemElement getInstance(CIMClient cimClient, CIM_ManagedSystemElement dataInstance) {
		...
		return CIM_ManagedSystemElementHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ManagedSystemElement getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_ManagedSystemElement(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ManagedSystemElement.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ManagedSystemElement.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ManagedSystemElement.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ManagedSystemElement.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_HealthState(UnsignedInt16 HealthState) {
		return true;
	}
	...
	public static boolean isValid_Status(String Status) {
		return true;
	}

	public static boolean isValid_StatusDescriptions(String[] StatusDescriptions) {
		return true;
	}
