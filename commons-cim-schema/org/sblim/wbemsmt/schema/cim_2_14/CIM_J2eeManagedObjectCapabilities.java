 ...
 *
 *
 * Description:  CIM_J2eeManagedObjectCapabilities is a class for defining additional
 * capabilities of J2EE managed objects. It contains the attributes that are
 * common to all J2EE managed objects. These common attributes are mapped to the
 * corresponding J2EE classes using the CIM_ElementCapabilities association.
 * 
 */
...
/**
 *  CIM_J2eeManagedObjectCapabilities is a class for defining additional
 * capabilities of J2EE managed objects. It contains the attributes that are
 * common to all J2EE managed objects. These common attributes are mapped to the
 * corresponding J2EE classes using the CIM_ElementCapabilities association.
 */
public class CIM_J2eeManagedObjectCapabilities extends CIM_Capabilities  {
	...
	public final static String CIM_CLASS_NAME = "CIM_J2eeManagedObjectCapabilities"; //$NON-NLS-1$
