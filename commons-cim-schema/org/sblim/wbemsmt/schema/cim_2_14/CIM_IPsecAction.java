...
public class CIM_IPsecAction extends CIM_SANegotiationAction  {
	...
	public final static String CIM_CLASS_NAME = "CIM_IPsecAction"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_SANegotiationAction.Java_Package_List.size(); i++) {
			if (((String)CIM_SANegotiationAction.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
