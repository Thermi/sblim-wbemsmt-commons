 ...
 *
 *
 * Description:  The J2eeNotification class specifies the properties that must be included in
 * every event that is generated by a J2EE managed object that supports the
 * event model. All management systems that support event notification must
 * support all of the properties in this class.
 * 
 */
...
/**
 *  The J2eeNotification class specifies the properties that must be included in
 * every event that is generated by a J2EE managed object that supports the
 * event model. All management systems that support event notification must
 * support all of the properties in this class.
 */
public class CIM_J2eeNotification extends CIM_ProcessIndication  {
	...
	public final static String CIM_CLASS_NAME = "CIM_J2eeNotification"; //$NON-NLS-1$
