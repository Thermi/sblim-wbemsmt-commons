 ...
 *
 *
 * Description:  ExecuteProgram causes programs to be executed on the computer system that
...
/**
 *  ExecuteProgram causes programs to be executed on the computer system that
 * defines the Action's environment.
 */
public class CIM_ExecuteProgram extends CIM_Action  {
	
	public final static String CIM_CLASS_NAME = "CIM_ExecuteProgram"; //$NON-NLS-1$
