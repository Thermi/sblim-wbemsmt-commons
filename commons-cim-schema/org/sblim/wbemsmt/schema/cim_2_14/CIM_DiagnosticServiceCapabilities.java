 ...
 *
 *
 * Description:  DiagnosticServiceCapabilities is a class that describes the capabilities of the
 * diagnostic service. This provides the means for the diagnostic service to
 * describe its abilities, limitations, and/or potential for use of various
 * diagnostic service parameters. For example, what types of settings the
...
/**
 *  DiagnosticServiceCapabilities is a class that describes the capabilities of the
 * diagnostic service. This provides the means for the diagnostic service to
 * describe its abilities, limitations, and/or potential for use of various
 * diagnostic service parameters. For example, what types of settings the
 * diagnostic service supports.
...
public class CIM_DiagnosticServiceCapabilities extends CIM_Capabilities  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DiagnosticServiceCapabilities"; //$NON-NLS-1$
