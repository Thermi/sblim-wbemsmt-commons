/** 
 * CIM_OSPFProtocolEndpointBaseHelper.java
 *
...
public final class CIM_OSPFProtocolEndpointBaseHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_OSPFProtocolEndpointBase.");
						resultArrayList.add(new CIM_OSPFProtocolEndpointBase(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_OSPFProtocolEndpointBase.");
						resultArrayList.add(new CIM_OSPFProtocolEndpointBase(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OSPFProtocolEndpointBase.");
						resultArrayList.add(new CIM_OSPFProtocolEndpointBase(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_OSPFProtocolEndpointBase getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_OSPFProtocolEndpointBaseHelper.getInstance(cimClient, new CIM_OSPFProtocolEndpointBase(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OSPFProtocolEndpointBase getInstance(CIMClient cimClient, CIM_OSPFProtocolEndpointBase dataInstance) {
		...
		return CIM_OSPFProtocolEndpointBaseHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OSPFProtocolEndpointBase getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_OSPFProtocolEndpointBase dataInstance = null;
		try {
			dataInstance = new CIM_OSPFProtocolEndpointBase(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OSPFProtocolEndpointBase createInstance(CIMClient cimClient, CIM_OSPFProtocolEndpointBase dataInstance, boolean notifyDifferencies){ 
		...
		CIM_OSPFProtocolEndpointBase newDataInstance = null;
		try {
			newDataInstance = CIM_OSPFProtocolEndpointBaseHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OSPFProtocolEndpointBase modifyInstance(CIMClient cimClient, CIM_OSPFProtocolEndpointBase dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_OSPFProtocolEndpointBaseHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_OSPFProtocolEndpointBase dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_OSPFProtocolEndpointBase dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_OSPFProtocolEndpointBase.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_OSPFProtocolEndpointBase.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_OSPFProtocolEndpointBase.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_OSPFProtocolEndpointBase.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_OSPFProtocolEndpointBase.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AuthKey(String AuthKey) {
		return true;
	}

	public static boolean isValid_AuthType(UnsignedInt16 AuthType) {
		return true;
	}

	public static boolean isValid_EnabledState(UnsignedInt16 EnabledState) {
		return true;
	}

	public static boolean isValid_OtherAuthType(String OtherAuthType) {
		return true;
	}
	...
	public static boolean isValid_RetransmitInterval(UnsignedInt16 RetransmitInterval) {
		return true;
	}

	public static boolean isValid_TransitDelay(UnsignedInt16 TransitDelay) {
		return true;
	}
