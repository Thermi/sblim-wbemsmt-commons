 ...
 *
 *
 * Description:  DeviceErrorData is a statistical class that contains error- related counters
 * for a LogicalDevice. The types of errors are defined by CCITT (Rec X.733) and
 * ISO (IEC 10164-4). The element, whose statistics are described, is associated
 * using the relationship, ElementStatisticalData. Note that this class uses a
 * simplified identity or naming algorithm over CIM_DeviceErrorCounts.
 * 
 */
...
/**
 *  DeviceErrorData is a statistical class that contains error- related counters
 * for a LogicalDevice. The types of errors are defined by CCITT (Rec X.733) and
 * ISO (IEC 10164-4). The element, whose statistics are described, is associated
 * using the relationship, ElementStatisticalData. Note that this class uses a
 * simplified identity or naming algorithm over CIM_DeviceErrorCounts.
...
public class CIM_DeviceErrorData extends CIM_StatisticalData  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DeviceErrorData"; //$NON-NLS-1$
