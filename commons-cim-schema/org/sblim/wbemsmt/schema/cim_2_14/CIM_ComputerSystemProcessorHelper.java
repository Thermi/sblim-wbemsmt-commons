/** 
 * CIM_ComputerSystemProcessorHelper.java
 *
...
public final class CIM_ComputerSystemProcessorHelper {

	public final static String CIM_CLASS_NAME = "CIM_ComputerSystemProcessor";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_ComputerSystemProcessor.Java_Package_List.size(); i++) {
						if (!((String)(CIM_ComputerSystemProcessor.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_ComputerSystemProcessor.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_ComputerSystemProcessor.Java_Package_List.setElementAt((String)(CIM_ComputerSystemProcessor.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_ComputerSystemProcessor.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ComputerSystemProcessor.");
						resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ComputerSystemProcessor.");
						resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ComputerSystemProcessor.");
						resultArrayList.add(new CIM_ComputerSystemProcessor(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ComputerSystemProcessor getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ComputerSystemProcessorHelper.getInstance(cimClient, new CIM_ComputerSystemProcessor(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ComputerSystemProcessor getInstance(CIMClient cimClient, CIM_ComputerSystemProcessor dataInstance) {
		...
		return CIM_ComputerSystemProcessorHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ComputerSystemProcessor getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ComputerSystemProcessor dataInstance = null;
		try {
			dataInstance = new CIM_ComputerSystemProcessor(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ComputerSystemProcessor createInstance(CIMClient cimClient, CIM_ComputerSystemProcessor dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ComputerSystemProcessor newDataInstance = null;
		try {
			newDataInstance = CIM_ComputerSystemProcessorHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ComputerSystemProcessor modifyInstance(CIMClient cimClient, CIM_ComputerSystemProcessor dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ComputerSystemProcessorHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ComputerSystemProcessor dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ComputerSystemProcessor dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ComputerSystemProcessor.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ComputerSystemProcessor.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ComputerSystemProcessor.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ComputerSystemProcessor.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ComputerSystemProcessor.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CIM_UnitaryComputerSystem(CIM_UnitaryComputerSystem CIM_UnitaryComputerSystem) {
		return true;
	}

	public static boolean isValid_CIM_Processor(CIM_Processor CIM_Processor) {
		return true;
	}
