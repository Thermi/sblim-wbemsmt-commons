 ...
 *
 *
 * Description:  The Slot class represents Connectors into which Packages are inserted. For
 * example, a PhysicalPackage that is a DiskDrive may be inserted into an SCA
 * 'Slot'. As another example, a Card (subclass of PhysicalPackage) may be
 * inserted into a 16-, 32-, or 64-bit expansion 'Slot' on a HostingBoard. PCI
 * or PCMCIA Type III Slots are examples of the latter.
 * 
 */
...
/**
 *  The Slot class represents Connectors into which Packages are inserted. For
 * example, a PhysicalPackage that is a DiskDrive may be inserted into an SCA
 * 'Slot'. As another example, a Card (subclass of PhysicalPackage) may be
 * inserted into a 16-, 32-, or 64-bit expansion 'Slot' on a HostingBoard. PCI
 * or PCMCIA Type III Slots are examples of the latter.
...
public class CIM_Slot extends CIM_PhysicalConnector  {
	...
	public final static String CIM_CLASS_NAME = "CIM_Slot"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.7.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_CARDINSLOT = "CIM_CardInSlot"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_PACKAGEINSLOT = "CIM_PackageInSlot"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_SLOTINSLOT = "CIM_SlotInSlot"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_PhysicalConnector.Java_Package_List.size(); i++) {
			if (((String)CIM_PhysicalConnector.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
