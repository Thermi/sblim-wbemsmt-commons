...
public class CIM_BIOSFeatureBIOSElements extends CIM_SoftwareFeatureSoftwareElements  {
	...
	static {
		...
		for (int i = 0; i < CIM_SoftwareFeatureSoftwareElements.Java_Package_List.size(); i++) {
			if (((String)CIM_SoftwareFeatureSoftwareElements.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
	...
	*/	
	...
	public CIMObjectPath get_CIM_BIOSFeature() {
		...
		} else if (currentProperty.getType() == null || !currentProperty.getType().getRefClassName().equals(CIM_BIOSFeature.CIM_CLASS_NAME)) {
