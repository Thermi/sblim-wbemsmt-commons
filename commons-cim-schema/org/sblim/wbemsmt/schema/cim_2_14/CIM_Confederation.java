 ...
 * partitions one AS into a group of 'sub-ASs'. This enables all of the benefits
 * of IBGP to be applied inside the confederation, while enabling EBGP to be run
 * between each confederation. It also enables certain BGP attribute values to
 * be preserved between confederations. However, to the outside world, the AS
 * with its confederations appear to be a single AS.
 * 
 */
...
public class CIM_Confederation extends CIM_SystemComponent  {
	...
	public final static String CIM_CLASS_NAME = "CIM_Confederation"; //$NON-NLS-1$
