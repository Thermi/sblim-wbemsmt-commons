 ...
 *
 *
 * Description:  SANegotiationAction is the base class for negotiated SAs. It is abstract,
 * specifying the common parameters that control the IPsec phase 1 and phase 2
 * negotiations.
 * 
 */
...
/**
 *  SANegotiationAction is the base class for negotiated SAs. It is abstract,
 * specifying the common parameters that control the IPsec phase 1 and phase 2
 * negotiations.
 */
public class CIM_SANegotiationAction extends CIM_SAAction  {
	
	public final static String CIM_CLASS_NAME = "CIM_SANegotiationAction"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_SAAction.Java_Package_List.size(); i++) {
			if (((String)CIM_SAAction.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
