 ...
 *
 *
 * Description:  A CIM_Action is an operation that is part of a process to either create a
 * SoftwareElement in its next state or to eliminate the SoftwareElement in its
 * current state. A CIM_ComputerSystem object represents the environment in
 * which CIM_SoftwareElements are already deployed/installed or into which the
 ...
 * system is the target of the Action and is identified using the TargetSystem
...
/**
 *  A CIM_Action is an operation that is part of a process to either create a
 * SoftwareElement in its next state or to eliminate the SoftwareElement in its
 * current state. A CIM_ComputerSystem object represents the environment in
 * which CIM_SoftwareElements are already deployed/installed or into which the
 * elements will be deployed/installed. For the case in which an element is
...
public class CIM_Action extends CIM_ManagedElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_Action"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.7.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ACTIONSEQUENCE = "CIM_ActionSequence"; //$NON-NLS-1$
