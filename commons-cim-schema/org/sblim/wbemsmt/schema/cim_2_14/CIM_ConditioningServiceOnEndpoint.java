 ...
 *
 *
 * Description:  The QoS Model describes the traffic conditioning functions in place for a
 ...
 * defined by the ConditioningServiceOn Endpoint association. A property of the
 * association, ServiceType, indicates whether the ConditioningService handles
 * incoming ("Ingress") or out-going ("Egress") packets. This association is
 * deprecated since different cardinalities are needed on the ingress and egress
...
public class CIM_ConditioningServiceOnEndpoint extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ConditioningServiceOnEndpoint"; //$NON-NLS-1$
