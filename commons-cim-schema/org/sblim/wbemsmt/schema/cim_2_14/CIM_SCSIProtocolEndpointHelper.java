/** 
 * CIM_SCSIProtocolEndpointHelper.java
 *
...
public final class CIM_SCSIProtocolEndpointHelper {

	public final static String CIM_CLASS_NAME = "CIM_SCSIProtocolEndpoint";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_SCSIProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_SCSIProtocolEndpoint.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SCSIProtocolEndpoint.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_SCSIProtocolEndpoint.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_SCSIProtocolEndpoint.Java_Package_List.setElementAt((String)(CIM_SCSIProtocolEndpoint.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_SCSIProtocolEndpoint.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SCSIProtocolEndpoint.");
						resultArrayList.add(new CIM_SCSIProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SCSIProtocolEndpoint.");
						resultArrayList.add(new CIM_SCSIProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SCSIProtocolEndpoint.");
						resultArrayList.add(new CIM_SCSIProtocolEndpoint(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SCSIProtocolEndpoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SCSIProtocolEndpointHelper.getInstance(cimClient, new CIM_SCSIProtocolEndpoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SCSIProtocolEndpoint getInstance(CIMClient cimClient, CIM_SCSIProtocolEndpoint dataInstance) {
		...
		return CIM_SCSIProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SCSIProtocolEndpoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SCSIProtocolEndpoint dataInstance = null;
		try {
			dataInstance = new CIM_SCSIProtocolEndpoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SCSIProtocolEndpoint createInstance(CIMClient cimClient, CIM_SCSIProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SCSIProtocolEndpoint newDataInstance = null;
		try {
			newDataInstance = CIM_SCSIProtocolEndpointHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SCSIProtocolEndpoint modifyInstance(CIMClient cimClient, CIM_SCSIProtocolEndpoint dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SCSIProtocolEndpointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SCSIProtocolEndpoint dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SCSIProtocolEndpoint dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SCSIProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SCSIProtocolEndpoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SCSIProtocolEndpoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SCSIProtocolEndpoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SCSIProtocolEndpoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ConnectionType(UnsignedInt16 ConnectionType) {
		return true;
	}
	...
	public static boolean isValid_OtherConnectionType(String OtherConnectionType) {
		return true;
	}

	public static boolean isValid_Role(UnsignedInt16 Role) {
		return true;
	}

	public static boolean isValid_TargetRelativePortNumber(UnsignedInt32 TargetRelativePortNumber) {
		return true;
	}
