 ...
 *
 *
 * Description:  Data related to Diagnostics may be recorded in various DiagnosticRecord
 * objects. The type of information that is recorded in a log is specified via
 * the LogOptions property in DiagnosticSetting.
 * 
 */
...
/**
 *  Data related to Diagnostics may be recorded in various DiagnosticRecord
 * objects. The type of information that is recorded in a log is specified via
 * the LogOptions property in DiagnosticSetting.
 */
public class CIM_DiagnosticRecord extends CIM_RecordForLog  {
	
	public final static String CIM_CLASS_NAME = "CIM_DiagnosticRecord"; //$NON-NLS-1$
