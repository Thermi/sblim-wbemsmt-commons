...
public class CIM_OperatingSystemHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_OperatingSystem.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_OperatingSystem.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName()
                                    .equals(CIM_OperatingSystem.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_OperatingSystem.");
                        resultArrayList.add(new CIM_OperatingSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_OperatingSystem.");
                        resultArrayList.add(new CIM_OperatingSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_OperatingSystem.");
                        resultArrayList.add(new CIM_OperatingSystem(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_OperatingSystem getInstance(WBEMClient client,
     ...
     */
    public final static CIM_OperatingSystem getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_OperatingSystem getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_OperatingSystem.PROPERTY_CSCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_OperatingSystem.CIM_CLASS_NAME);

        setThis = CSName;

        keyProperties[1] = new CIMProperty(CIM_OperatingSystem.PROPERTY_CSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_OperatingSystem.CIM_CLASS_NAME);

        setThis = CreationClassName;

        keyProperties[2] = new CIMProperty(CIM_OperatingSystem.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_OperatingSystem.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[3] = new CIMProperty(CIM_OperatingSystem.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_OperatingSystem.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_OperatingSystem createInstance(WBEMClient client,
            CIM_OperatingSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_OperatingSystem newDataInstance = CIM_OperatingSystemHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_OperatingSystem modifyInstance(WBEMClient client,
            CIM_OperatingSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_OperatingSystem dataInstance2 = CIM_OperatingSystemHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_OperatingSystem dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_OperatingSystem.getPackages());
    }
