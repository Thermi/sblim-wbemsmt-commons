 ...
 *
 *
 * Description:  A route map is used to control and modify routing information as well as to
 * define when a route is redistributed between routing domains. Route maps are
 * placed in router configuration files, and several instances of the same route
 * map may be used to implement different actions. RouteMaps MAY use FilterLists
 * to identify the route. A BGPRouteMap is specific to a given AutonomousSystem
 * that contains it. Hence, the keys of the AutonomousSystem are propagated to
 * this class.
 * 
 */
...
public class CIM_BGPRouteMap extends CIM_LogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BGPRouteMap"; //$NON-NLS-1$
