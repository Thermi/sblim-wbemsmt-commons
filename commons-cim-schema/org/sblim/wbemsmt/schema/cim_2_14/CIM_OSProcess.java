 ...
 *
 *
 * Description:  A link between the OperatingSystem and Process(es) running in the context of
...
/**
 *  A link between the OperatingSystem and Process(es) running in the context of
 * this OperatingSystem.
 */
public class CIM_OSProcess extends CIM_Component  {
	
	public final static String CIM_CLASS_NAME = "CIM_OSProcess"; //$NON-NLS-1$
	...
	static {
		...
		for (int i = 0; i < CIM_Component.CIM_PropertyNameList.size(); i++) {
			...
			CIM_OSProcess.CIM_PropertyNameList.add(CIM_Component.CIM_PropertyNameList.elementAt(i));
		}
	...
	*	Class constructor
	*/	
	public CIM_OSProcess(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_OSProcess(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof CIM_OSProcess)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((CIM_OSProcess)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_OSProcess)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_OSProcess)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_OSProcess)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_OSProcess)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_OSProcess)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_OSProcess)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_OSProcess)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_OSProcess)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public CIMObjectPath get_CIM_OperatingSystem() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_OSProcess.CIM_PROPERTY_CIM_OPERATINGSYSTEM);
	...
	public CIMObjectPath get_CIM_Process() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_OSProcess.CIM_PROPERTY_CIM_PROCESS);
