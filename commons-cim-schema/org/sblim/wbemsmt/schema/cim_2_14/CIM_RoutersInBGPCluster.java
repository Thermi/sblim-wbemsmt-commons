 ...
 *
 *
 * Description:  This aggregation establishes the routers (ComputerSystems) in a BGPCluster. At
 * least three routers are required to form a cluster - a reflector and two
 * clients. The routers that form a cluster share common configuration
 * information.
 * 
 */
...
/**
 *  This aggregation establishes the routers (ComputerSystems) in a BGPCluster. At
 * least three routers are required to form a cluster - a reflector and two
 * clients. The routers that form a cluster share common configuration
 * information.
 */
public class CIM_RoutersInBGPCluster extends CIM_CollectedMSEs  {
	...
	public final static String CIM_CLASS_NAME = "CIM_RoutersInBGPCluster"; //$NON-NLS-1$
