 ...
 *
 *
 * Description:  PolicySet is an abstract class that represents a set of policies that form a
 * coherent set. The set of contained policies has a common decision strategy
 * and a common set of policy roles (defined via the PolicySetInRole Collection
...
/**
 *  PolicySet is an abstract class that represents a set of policies that form a
 * coherent set. The set of contained policies has a common decision strategy
 * and a common set of policy roles (defined via the PolicySetInRole Collection
 * association). Subclasses include PolicyGroup and PolicyRule.
 */
public class CIM_PolicySet extends CIM_Policy  {
	...
	public final static String CIM_CLASS_NAME = "CIM_PolicySet"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.8.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_POLICYSETAPPLIESTOELEMENT = "CIM_PolicySetAppliesToElement"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_POLICYSETCOMPONENT = "CIM_PolicySetComponent"; //$NON-NLS-1$
