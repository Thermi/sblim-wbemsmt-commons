 ...
 *
 *
 * Description:  This is an association class that relates a DiagnosticService to a
 * ManagedElement. Consumers wishing to 'diagnose' a particular Element could
 * query this association to determine what services are available.
 * 
 */
...
/**
 *  This is an association class that relates a DiagnosticService to a
 * ManagedElement. Consumers wishing to 'diagnose' a particular Element could
 * query this association to determine what services are available.
 */
public class CIM_AvailableDiagnosticService extends CIM_ServiceAvailableToElement  {
	
	public final static String CIM_CLASS_NAME = "CIM_AvailableDiagnosticService"; //$NON-NLS-1$
