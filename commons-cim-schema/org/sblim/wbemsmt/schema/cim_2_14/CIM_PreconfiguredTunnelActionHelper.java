/** 
 * CIM_PreconfiguredTunnelActionHelper.java
 *
...
public final class CIM_PreconfiguredTunnelActionHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PreconfiguredTunnelAction.");
						resultArrayList.add(new CIM_PreconfiguredTunnelAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PreconfiguredTunnelAction.");
						resultArrayList.add(new CIM_PreconfiguredTunnelAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PreconfiguredTunnelAction.");
						resultArrayList.add(new CIM_PreconfiguredTunnelAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PreconfiguredTunnelAction getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PreconfiguredTunnelActionHelper.getInstance(cimClient, new CIM_PreconfiguredTunnelAction(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PreconfiguredTunnelAction getInstance(CIMClient cimClient, CIM_PreconfiguredTunnelAction dataInstance) {
		...
		return CIM_PreconfiguredTunnelActionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PreconfiguredTunnelAction getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PreconfiguredTunnelAction dataInstance = null;
		try {
			dataInstance = new CIM_PreconfiguredTunnelAction(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PreconfiguredTunnelAction createInstance(CIMClient cimClient, CIM_PreconfiguredTunnelAction dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PreconfiguredTunnelAction newDataInstance = null;
		try {
			newDataInstance = CIM_PreconfiguredTunnelActionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PreconfiguredTunnelAction modifyInstance(CIMClient cimClient, CIM_PreconfiguredTunnelAction dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PreconfiguredTunnelActionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PreconfiguredTunnelAction dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PreconfiguredTunnelAction dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PreconfiguredTunnelAction.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PreconfiguredTunnelAction.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PreconfiguredTunnelAction.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PreconfiguredTunnelAction.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PreconfiguredTunnelAction.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DFHandling(UnsignedInt16 DFHandling) {
		return true;
	}
