 ...
 *
 *
 * Description:  CIM_SharedSecretService is a service which ascertains whether messages received
 * are from the Principal with whom a secret is shared. Examples include a login
 * service that proves identity on the basis of knowledge of the shared secret,
 * or a transport integrity service (like Kerberos provides) that includes a
 * message authenticity code that proves each message in the messsage stream
 * came from someone who knows the shared secret session key.
 * 
 */
...
/**
 *  CIM_SharedSecretService is a service which ascertains whether messages received
 * are from the Principal with whom a secret is shared. Examples include a login
 * service that proves identity on the basis of knowledge of the shared secret,
 * or a transport integrity service (like Kerberos provides) that includes a
 * message authenticity code that proves each message in the messsage stream
...
public class CIM_SharedSecretService extends CIM_LocalCredentialManagementService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_SharedSecretService"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.6.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_IKESECRETISNAMED = "CIM_IKESecretIsNamed"; //$NON-NLS-1$
