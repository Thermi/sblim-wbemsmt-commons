 ...
 *
 *
 * Description:  This defines the relationship between a BGPService and a specific BGPPeerGroup
...
/**
 *  This defines the relationship between a BGPService and a specific BGPPeerGroup
 * in which it is executing.
 */
public class CIM_BGPPeerGroupService extends CIM_Dependency  {
	
	public final static String CIM_CLASS_NAME = "CIM_BGPPeerGroupService"; //$NON-NLS-1$
