...
public final class CIM_PhysicalMediaHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_PhysicalMedia.Java_Package_List.size(); i++) {
						if (!((String)(CIM_PhysicalMedia.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_PhysicalMedia.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_PhysicalMedia.Java_Package_List.setElementAt((String)(CIM_PhysicalMedia.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PhysicalMedia.");
						resultArrayList.add(new CIM_PhysicalMedia(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PhysicalMedia.");
						resultArrayList.add(new CIM_PhysicalMedia(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PhysicalMedia.");
						resultArrayList.add(new CIM_PhysicalMedia(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PhysicalMedia getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PhysicalMediaHelper.getInstance(cimClient, new CIM_PhysicalMedia(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalMedia getInstance(CIMClient cimClient, CIM_PhysicalMedia dataInstance) {
		...
		return CIM_PhysicalMediaHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PhysicalMedia getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PhysicalMedia dataInstance = null;
		try {
			dataInstance = new CIM_PhysicalMedia(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalMedia createInstance(CIMClient cimClient, CIM_PhysicalMedia dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PhysicalMedia newDataInstance = null;
		try {
			newDataInstance = CIM_PhysicalMediaHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PhysicalMedia modifyInstance(CIMClient cimClient, CIM_PhysicalMedia dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PhysicalMediaHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PhysicalMedia dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PhysicalMedia dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PhysicalMedia.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PhysicalMedia.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PhysicalMedia.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PhysicalMedia.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PhysicalMedia.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_Capacity(UnsignedInt64 Capacity) {
		return true;
	}

	public static boolean isValid_CleanerMedia(Boolean CleanerMedia) {
		return true;
	}

	public static boolean isValid_DualSided(Boolean DualSided) {
		return true;
	}

	public static boolean isValid_LabelFormats(UnsignedInt16[] LabelFormats) {
		return true;
	}

	public static boolean isValid_LabelStates(UnsignedInt16[] LabelStates) {
		return true;
	}

	public static boolean isValid_MaxMounts(UnsignedInt64 MaxMounts) {
		return true;
	}

	public static boolean isValid_MediaDescription(String MediaDescription) {
		return true;
	}

	public static boolean isValid_MediaSize(Float MediaSize) {
		return true;
	}

	public static boolean isValid_MediaType(UnsignedInt16 MediaType) {
		return true;
	}

	public static boolean isValid_MountCount(UnsignedInt64 MountCount) {
		return true;
	}

	public static boolean isValid_PhysicalLabels(String[] PhysicalLabels) {
		return true;
	}

	public static boolean isValid_TimeOfLastMount(Calendar TimeOfLastMount) {
		return true;
	}

	public static boolean isValid_TotalMountTime(UnsignedInt64 TotalMountTime) {
		return true;
	}

	public static boolean isValid_WriteProtectOn(Boolean WriteProtectOn) {
		return true;
	}
