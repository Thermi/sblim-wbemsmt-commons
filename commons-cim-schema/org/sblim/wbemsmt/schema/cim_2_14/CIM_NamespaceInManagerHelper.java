...
public class CIM_NamespaceInManagerHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_NamespaceInManager.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_NamespaceInManager.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_NamespaceInManager.");
                        resultArrayList.add(new CIM_NamespaceInManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_NamespaceInManager.");
                        resultArrayList.add(new CIM_NamespaceInManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_NamespaceInManager.");
                        resultArrayList.add(new CIM_NamespaceInManager(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_NamespaceInManager getInstance(WBEMClient client,
    ...
    public final static CIM_NamespaceInManager getInstance(WBEMClient client, String namespace,
            CIM_ObjectManager Antecedent, CIM_Namespace Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_NamespaceInManager.PROPERTY_ANTECEDENT_CIM_OBJECTMANAGER.NAME, new CIMDataType(
                        CIM_ObjectManager.CIM_CLASS_NAME), setThis, false, false,
                CIM_NamespaceInManager.CIM_CLASS_NAME);

        setThis = Dependent != null ? Dependent.getCimObjectPath() : null;

        keyProperties[1] = new CIMProperty(
                CIM_NamespaceInManager.PROPERTY_DEPENDENT_CIM_NAMESPACE.NAME, new CIMDataType(
                        CIM_Namespace.CIM_CLASS_NAME), setThis, false, false,
                CIM_NamespaceInManager.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_NamespaceInManager createInstance(WBEMClient client,
            CIM_NamespaceInManager dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_NamespaceInManager newDataInstance = CIM_NamespaceInManagerHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_NamespaceInManager modifyInstance(WBEMClient client,
            CIM_NamespaceInManager dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_NamespaceInManager dataInstance2 = CIM_NamespaceInManagerHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_NamespaceInManager dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_NamespaceInManager.getPackages());
    }
