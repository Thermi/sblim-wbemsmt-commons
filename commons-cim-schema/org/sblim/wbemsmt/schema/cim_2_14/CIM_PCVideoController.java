 ...
 *
 *
 * Description:  Capabilities and management of a PCVideoController, a subtype of
 * VideoController.
 * 
 */
...
/**
 *  Capabilities and management of a PCVideoController, a subtype of
 * VideoController.
 */
public class CIM_PCVideoController extends CIM_VideoController  {
	
	public final static String CIM_CLASS_NAME = "CIM_PCVideoController"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_VideoController.Java_Package_List.size(); i++) {
			if (((String)CIM_VideoController.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
