/** 
 * CIM_DeviceErrorDataHelper.java
 *
...
public final class CIM_DeviceErrorDataHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_DeviceErrorData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_DeviceErrorData.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DeviceErrorData.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_DeviceErrorData.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_DeviceErrorData.Java_Package_List.setElementAt((String)(CIM_DeviceErrorData.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_DeviceErrorData.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DeviceErrorData.");
						resultArrayList.add(new CIM_DeviceErrorData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DeviceErrorData.");
						resultArrayList.add(new CIM_DeviceErrorData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DeviceErrorData.");
						resultArrayList.add(new CIM_DeviceErrorData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DeviceErrorData getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DeviceErrorDataHelper.getInstance(cimClient, new CIM_DeviceErrorData(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DeviceErrorData getInstance(CIMClient cimClient, CIM_DeviceErrorData dataInstance) {
		...
		return CIM_DeviceErrorDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DeviceErrorData getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DeviceErrorData dataInstance = null;
		try {
			dataInstance = new CIM_DeviceErrorData(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DeviceErrorData createInstance(CIMClient cimClient, CIM_DeviceErrorData dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DeviceErrorData newDataInstance = null;
		try {
			newDataInstance = CIM_DeviceErrorDataHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DeviceErrorData modifyInstance(CIMClient cimClient, CIM_DeviceErrorData dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DeviceErrorDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DeviceErrorData dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DeviceErrorData dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DeviceErrorData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DeviceErrorData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DeviceErrorData.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DeviceErrorData.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DeviceErrorData.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CriticalErrorCount(UnsignedInt64 CriticalErrorCount) {
		return true;
	}

	public static boolean isValid_ErrorDescription(String ErrorDescription) {
		return true;
	}

	public static boolean isValid_IndeterminateErrorCount(UnsignedInt64 IndeterminateErrorCount) {
		return true;
	}

	public static boolean isValid_LastErrorCode(String LastErrorCode) {
		return true;
	}

	public static boolean isValid_MajorErrorCount(UnsignedInt64 MajorErrorCount) {
		return true;
	}

	public static boolean isValid_MinorErrorCount(UnsignedInt64 MinorErrorCount) {
		return true;
	}

	public static boolean isValid_WarningCount(UnsignedInt64 WarningCount) {
		return true;
	}
