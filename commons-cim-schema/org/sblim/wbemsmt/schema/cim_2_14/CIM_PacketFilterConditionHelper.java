/** 
 * CIM_PacketFilterConditionHelper.java
 *
...
public final class CIM_PacketFilterConditionHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PacketFilterCondition.");
						resultArrayList.add(new CIM_PacketFilterCondition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PacketFilterCondition.");
						resultArrayList.add(new CIM_PacketFilterCondition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PacketFilterCondition.");
						resultArrayList.add(new CIM_PacketFilterCondition(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PacketFilterCondition getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PacketFilterConditionHelper.getInstance(cimClient, new CIM_PacketFilterCondition(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PacketFilterCondition getInstance(CIMClient cimClient, CIM_PacketFilterCondition dataInstance) {
		...
		return CIM_PacketFilterConditionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PacketFilterCondition getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PacketFilterCondition dataInstance = null;
		try {
			dataInstance = new CIM_PacketFilterCondition(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PacketFilterCondition createInstance(CIMClient cimClient, CIM_PacketFilterCondition dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PacketFilterCondition newDataInstance = null;
		try {
			newDataInstance = CIM_PacketFilterConditionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PacketFilterCondition modifyInstance(CIMClient cimClient, CIM_PacketFilterCondition dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PacketFilterConditionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PacketFilterCondition dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PacketFilterCondition dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PacketFilterCondition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PacketFilterCondition.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PacketFilterCondition.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PacketFilterCondition.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PacketFilterCondition.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
