...
public class CIM_OSProcessHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_OSProcess.CIM_CLASS_NAME,
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName()
                                + " was not found. Constructing instance of class CIM_OSProcess.");
                        resultArrayList.add(new CIM_OSProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        ...
                                        + " could not be found. Constructing instance of class CIM_OSProcess.");
                        resultArrayList.add(new CIM_OSProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_OSProcess.");
                        resultArrayList.add(new CIM_OSProcess(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_OSProcess getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_OSProcess getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_OSProcess getInstance(WBEMClient client, String namespace,
            CIM_OperatingSystem GroupComponent, CIM_Process PartComponent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_OSProcess.PROPERTY_GROUPCOMPONENT_CIM_OPERATINGSYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(CIM_OSProcess.PROPERTY_PARTCOMPONENT_CIM_PROCESS.NAME,
     ...
     *
     */
    public final static CIM_OSProcess createInstance(WBEMClient client, CIM_OSProcess dataInstance,
     ...
     */
    public final static CIM_OSProcess modifyInstance(WBEMClient client, CIM_OSProcess dataInstance,
            boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_OSProcess dataInstance2 = CIM_OSProcessHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_OSProcess dataInstance)
            throws WbemsmtException {
