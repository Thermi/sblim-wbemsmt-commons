 ...
 *
 *
 * Description:  The RecordForLog class is used to instantiate records to be aggregated to a
 * Log.
 * 
 */
...
/**
 *  The RecordForLog class is used to instantiate records to be aggregated to a
 * Log.
 */
public class CIM_RecordForLog extends CIM_ManagedElement  {
	
	public final static String CIM_CLASS_NAME = "CIM_RecordForLog"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_RECORDAPPLIESTOELEMENT = "CIM_RecordAppliesToElement"; //$NON-NLS-1$
