...
public class CIM_LANEndpointHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_LANEndpoint.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_LANEndpoint.");
                        resultArrayList.add(new CIM_LANEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_LANEndpoint.");
                        resultArrayList.add(new CIM_LANEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_LANEndpoint.");
                        resultArrayList.add(new CIM_LANEndpoint(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_LANEndpoint getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_LANEndpoint getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_LANEndpoint getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_LANEndpoint.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LANEndpoint.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[1] = new CIMProperty(CIM_LANEndpoint.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LANEndpoint.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[2] = new CIMProperty(CIM_LANEndpoint.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_LANEndpoint.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_LANEndpoint createInstance(WBEMClient client,
            CIM_LANEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
     ...
     */
    public final static CIM_LANEndpoint modifyInstance(WBEMClient client,
            CIM_LANEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_LANEndpoint dataInstance2 = CIM_LANEndpointHelper.getInstance(client, dataInstance
                    .getCimObjectPath());
            if (notifyDifferencies) {
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_LANEndpoint dataInstance)
            throws WbemsmtException {
