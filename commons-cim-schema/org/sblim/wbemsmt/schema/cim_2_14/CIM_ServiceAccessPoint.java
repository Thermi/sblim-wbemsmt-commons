...
public class CIM_ServiceAccessPoint extends CIM_EnabledLogicalElement {
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedAccessPoints(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_HostedAccessPoints(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDACCESSPOINT, CIM_System.CIM_CLASS_NAME, null,
    ...
    public java.util.List getAssociated_CIM_System_CIM_HostedAccessPointNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_System_CIM_HostedAccessPointNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDACCESSPOINT, CIM_System.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_Service_CIM_ServiceAccessBySAPs(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Service_CIM_ServiceAccessBySAPs(cimClient,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SERVICEACCESSBYSAP, CIM_Service.CIM_CLASS_NAME, null,
                null, false, false, null);
    ...
    public java.util.List getAssociated_CIM_Service_CIM_ServiceAccessBySAPNames(WBEMClient cimClient)
            throws WbemsmtException {

        return getAssociated_CIM_Service_CIM_ServiceAccessBySAPNames(cimClient, true,
                CIM_ASSOCIATOR_CLASS_NAME_CIM_SERVICEACCESSBYSAP, CIM_Service.CIM_CLASS_NAME, null,
                null);
    }
    ...
    public java.util.List getAssociated_CIM_Service_CIM_ServiceAccessBySAPNames(
