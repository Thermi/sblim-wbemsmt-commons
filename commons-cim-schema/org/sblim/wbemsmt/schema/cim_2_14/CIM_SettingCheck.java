 ...
 *
 *
 * Description:  This class specifies information needed to verify a particular 'setting' file,
 * for a specific entry in the file. The file entry is checked whether it
 * contains or matches the value defined in EntryValue. All compares are assumed
...
/**
 *  This class specifies information needed to verify a particular 'setting' file,
 * for a specific entry in the file. The file entry is checked whether it
 * contains or matches the value defined in EntryValue. All compares are assumed
 * to be case insensitive.
 */
public class CIM_SettingCheck extends CIM_Check  {
	...
	public final static String CIM_CLASS_NAME = "CIM_SettingCheck"; //$NON-NLS-1$
