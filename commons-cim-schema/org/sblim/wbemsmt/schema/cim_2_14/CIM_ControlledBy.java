 ...
 *
 *
 * Description:  The ControlledBy relationship indicates which Devices are controlled by a
 * CIM_Controller.
 * 
 */
...
/**
 *  The ControlledBy relationship indicates which Devices are controlled by a
 * CIM_Controller.
 */
public class CIM_ControlledBy extends CIM_DeviceConnection  {
	
	public final static String CIM_CLASS_NAME = "CIM_ControlledBy"; //$NON-NLS-1$
