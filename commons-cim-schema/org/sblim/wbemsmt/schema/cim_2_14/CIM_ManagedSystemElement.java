...
public class CIM_ManagedSystemElement extends CIM_ManagedElement {
    ...
    public static class PROPERTY_HEALTHSTATE {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_OK = new javax.cim.UnsignedInteger16(
                "5");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_10_FOR_VALUE_ENTRY_Degraded_Warning = new javax.cim.UnsignedInteger16(
                "10");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_15_FOR_VALUE_ENTRY_Minor_failure = new javax.cim.UnsignedInteger16(
                "15");

        /**
         * constant for value entry Minor failure (corresponds to mapEntry 15 )
         */
        public final static String VALUE_ENTRY_Minor_failure = "Minor failure";

        /**
         * constant for value map entry 20
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_20_FOR_VALUE_ENTRY_Major_failure = new javax.cim.UnsignedInteger16(
                "20");

        /**
         * constant for value entry Major failure (corresponds to mapEntry 20 )
         */
        public final static String VALUE_ENTRY_Major_failure = "Major failure";

        /**
         * constant for value map entry 25
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_25_FOR_VALUE_ENTRY_Critical_failure = new javax.cim.UnsignedInteger16(
                "25");

        /**
         * constant for value entry Critical failure (corresponds to mapEntry 25 )
         */
        public final static String VALUE_ENTRY_Critical_failure = "Critical failure";

        /**
         * constant for value map entry 30
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_30_FOR_VALUE_ENTRY_Non_recoverable_error = new javax.cim.UnsignedInteger16(
                "30");
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@17d217d2
        ...
        public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = {
                VALUE_MAP_ENTRY_0_FOR_VALUE_ENTRY_Unknown, VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_OK,
         ...
         * Value Map for the property HealthState   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown, VALUE_ENTRY_OK,
                VALUE_ENTRY_Degraded_Warning, VALUE_ENTRY_Minor_failure, VALUE_ENTRY_Major_failure,
                VALUE_ENTRY_Critical_failure, VALUE_ENTRY_Non_recoverable_error,
        ...
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_OK, VALUE_ENTRY_Degraded_Warning, VALUE_ENTRY_Minor_failure,
                VALUE_ENTRY_Major_failure, VALUE_ENTRY_Critical_failure,
    ...
    public static class PROPERTY_OPERATIONALSTATUS {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@24cc24cc
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        propertiesToCheck.put("HealthState", new CIMProperty("HealthState", CIMDataType.UINT16_T,
                null));
    ...
    public javax.cim.UnsignedInteger16 get_HealthState() {
        ...
        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_HEALTHSTATE.NAME + " was not found in instance "
                    + getCimObjectPath());
            return null;
        }
    ...
    public static CIMProperty create_HealthState(WBEMClient client, String namespace,
    ...
    private static CIMProperty setPropertyValue_HealthState(CIMProperty currentProperty,
