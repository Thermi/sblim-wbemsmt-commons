			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_Unimodem.Java_Package_List.size(); i++) {
						if (!((String)(CIM_Unimodem.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_Unimodem.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_Unimodem.Java_Package_List.setElementAt((String)(CIM_Unimodem.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
