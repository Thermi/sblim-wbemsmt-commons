 ...
 *
 *
 * Description:  Note: The use of FibrePortActiveLogin is deprecated because FibrePort is
 * deprecated. Deprecated description: Information for FibrePortActiveLogin is
 * found by examining the individual FCPorts, and an ActiveConnection between
 * the FCProtocolEndpoints that are associated with the ports.
 * FibrePortActiveLogin indicates that two FibrePorts are connected through a
 * login and have negotiated their Class Of Service, frame size, and other link
