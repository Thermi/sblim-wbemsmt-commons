 ...
 *
 *
 * Description:  Note: The use of the FibrePort class is deprecated because FibreChannel Adapter
 * has been deprecated in lieu of FCPort and this class overlaps with FCPort.
 * The new FCPort class should be used in lieu of both FibreChannelAdapter and
 * FibrePort. Deprecated description: FibrePort describes the capabilities and
 * management aspects of a Fibre Channel Port Device.
 * 
 */
...
/**
 *  Note: The use of the FibrePort class is deprecated because FibreChannel Adapter
 * has been deprecated in lieu of FCPort and this class overlaps with FCPort.
 * The new FCPort class should be used in lieu of both FibreChannelAdapter and
 * FibrePort. Deprecated description: FibrePort describes the capabilities and
 * management aspects of a Fibre Channel Port Device.
