 ...
 *
 *
 * Description:  The J2eeStatefulSessionBeanStats class defines the performance statistics that
 * are provided by a stateful session bean.
 * 
 */
...
/**
 *  The J2eeStatefulSessionBeanStats class defines the performance statistics that
 * are provided by a stateful session bean.
 */
public class CIM_J2eeStatefulSessionBeanStats extends CIM_J2eeSessionBeanStats  {
	
	public final static String CIM_CLASS_NAME = "CIM_J2eeStatefulSessionBeanStats"; //$NON-NLS-1$
