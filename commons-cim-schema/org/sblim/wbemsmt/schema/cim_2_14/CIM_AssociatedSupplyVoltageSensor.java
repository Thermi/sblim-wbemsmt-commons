 ...
 * AssociatedSensor, since the use of the referenced class VoltageSensor is
 * deprecated. A PowerSupply may have an associated VoltageSensor, monitoring
...
public class CIM_AssociatedSupplyVoltageSensor extends CIM_AssociatedSensor  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AssociatedSupplyVoltageSensor"; //$NON-NLS-1$
