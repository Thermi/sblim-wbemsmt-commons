 ...
 *
 *
 * Description:  ContainedProposal holds an ordered list of SAProposals that make up an
 * SANegotiationAction. If the referenced NegotiationAction is an IKEAction,
 * then the SAProposal objects MUST be IKEProposals. If the referenced
 * NegotiationAction object is an IPsecTransport/TunnelAction, then the
 * referenced SAProposal objects MUST be IPsecProposals.
 * 
 */
...
/**
 *  ContainedProposal holds an ordered list of SAProposals that make up an
 * SANegotiationAction. If the referenced NegotiationAction is an IKEAction,
 * then the SAProposal objects MUST be IKEProposals. If the referenced
 * NegotiationAction object is an IPsecTransport/TunnelAction, then the
 * referenced SAProposal objects MUST be IPsecProposals.
...
public class CIM_ContainedProposal extends CIM_Component  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ContainedProposal"; //$NON-NLS-1$
