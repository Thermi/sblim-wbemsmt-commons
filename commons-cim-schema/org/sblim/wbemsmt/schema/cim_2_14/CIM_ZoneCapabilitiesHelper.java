/** 
 * CIM_ZoneCapabilitiesHelper.java
 *
...
public final class CIM_ZoneCapabilitiesHelper {

	public final static String CIM_CLASS_NAME = "CIM_ZoneCapabilities";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_ZoneCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_ZoneCapabilities.Java_Package_List.size(); i++) {
						if (!((String)(CIM_ZoneCapabilities.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_ZoneCapabilities.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_ZoneCapabilities.Java_Package_List.setElementAt((String)(CIM_ZoneCapabilities.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_ZoneCapabilities.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ZoneCapabilities.");
						resultArrayList.add(new CIM_ZoneCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ZoneCapabilities.");
						resultArrayList.add(new CIM_ZoneCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ZoneCapabilities.");
						resultArrayList.add(new CIM_ZoneCapabilities(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ZoneCapabilities getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ZoneCapabilitiesHelper.getInstance(cimClient, new CIM_ZoneCapabilities(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ZoneCapabilities getInstance(CIMClient cimClient, CIM_ZoneCapabilities dataInstance) {
		...
		return CIM_ZoneCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ZoneCapabilities getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ZoneCapabilities dataInstance = null;
		try {
			dataInstance = new CIM_ZoneCapabilities(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ZoneCapabilities createInstance(CIMClient cimClient, CIM_ZoneCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ZoneCapabilities newDataInstance = null;
		try {
			newDataInstance = CIM_ZoneCapabilitiesHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ZoneCapabilities modifyInstance(CIMClient cimClient, CIM_ZoneCapabilities dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ZoneCapabilitiesHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ZoneCapabilities dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ZoneCapabilities dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ZoneCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ZoneCapabilities.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ZoneCapabilities.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ZoneCapabilities.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ZoneCapabilities.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_MaxNumZone(UnsignedInt32 MaxNumZone) {
		return true;
	}

	public static boolean isValid_MaxNumZoneAliases(UnsignedInt32 MaxNumZoneAliases) {
		return true;
	}

	public static boolean isValid_MaxNumZoneMembers(UnsignedInt32 MaxNumZoneMembers) {
		return true;
	}

	public static boolean isValid_MaxNumZoneSets(UnsignedInt32 MaxNumZoneSets) {
		return true;
	}

	public static boolean isValid_MaxNumZonesPerZoneSet(UnsignedInt32 MaxNumZonesPerZoneSet) {
		return true;
	}

	public static boolean isValid_ZoneNameFormat(UnsignedInt16 ZoneNameFormat) {
		return true;
	}

	public static boolean isValid_ZoneNameMaxLen(UnsignedInt32 ZoneNameMaxLen) {
		return true;
	}
