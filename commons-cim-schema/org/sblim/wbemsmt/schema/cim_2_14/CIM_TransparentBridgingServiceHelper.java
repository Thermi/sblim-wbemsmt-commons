/** 
 * CIM_TransparentBridgingServiceHelper.java
 *
...
public final class CIM_TransparentBridgingServiceHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_TransparentBridgingService.");
						resultArrayList.add(new CIM_TransparentBridgingService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_TransparentBridgingService.");
						resultArrayList.add(new CIM_TransparentBridgingService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_TransparentBridgingService.");
						resultArrayList.add(new CIM_TransparentBridgingService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_TransparentBridgingService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_TransparentBridgingServiceHelper.getInstance(cimClient, new CIM_TransparentBridgingService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_TransparentBridgingService getInstance(CIMClient cimClient, CIM_TransparentBridgingService dataInstance) {
		...
		return CIM_TransparentBridgingServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_TransparentBridgingService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_TransparentBridgingService dataInstance = null;
		try {
			dataInstance = new CIM_TransparentBridgingService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_TransparentBridgingService createInstance(CIMClient cimClient, CIM_TransparentBridgingService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_TransparentBridgingService newDataInstance = null;
		try {
			newDataInstance = CIM_TransparentBridgingServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_TransparentBridgingService modifyInstance(CIMClient cimClient, CIM_TransparentBridgingService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_TransparentBridgingServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_TransparentBridgingService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_TransparentBridgingService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_TransparentBridgingService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_TransparentBridgingService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_TransparentBridgingService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_TransparentBridgingService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_TransparentBridgingService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AgingTime(UnsignedInt32 AgingTime) {
		return true;
	}

	public static boolean isValid_FID(UnsignedInt32 FID) {
		return true;
	}
