...
public class CIM_MediaPhysicalStatInfo extends CIM_PhysicalStatisticalInformation  {
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_PhysicalStatisticalInformation.Java_Package_List.size(); i++) {
			if (((String)CIM_PhysicalStatisticalInformation.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
			
			Java_Package_List.add(CIM_PhysicalStatisticalInformation.Java_Package_List.elementAt(i));
		}
	};
