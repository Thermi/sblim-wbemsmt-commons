 ...
 *
 *
 * Description:  SerialInterface is a ControlledBy relationship that indicates which Devices are
 * accessed through the SerialController and describes the characteristics of
 * this access.
 * 
 */
...
/**
 *  SerialInterface is a ControlledBy relationship that indicates which Devices are
 * accessed through the SerialController and describes the characteristics of
 * this access.
 */
public class CIM_SerialInterface extends CIM_ControlledBy  {
	
	public final static String CIM_CLASS_NAME = "CIM_SerialInterface"; //$NON-NLS-1$
