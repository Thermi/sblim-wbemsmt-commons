 ...
 *
 *
 * Description:  This class defines the per-path information used to process specific BGP
...
public class CIM_BGPPathAttributes extends CIM_LogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BGPPathAttributes"; //$NON-NLS-1$
