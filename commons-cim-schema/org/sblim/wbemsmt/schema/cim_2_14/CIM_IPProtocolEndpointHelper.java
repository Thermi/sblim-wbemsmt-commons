...
public class CIM_IPProtocolEndpointHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_IPProtocolEndpoint.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_IPProtocolEndpoint.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_IPProtocolEndpoint.");
                        resultArrayList.add(new CIM_IPProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_IPProtocolEndpoint.");
                        resultArrayList.add(new CIM_IPProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_IPProtocolEndpoint.");
                        resultArrayList.add(new CIM_IPProtocolEndpoint(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_IPProtocolEndpoint getInstance(WBEMClient client,
    ...
    public final static CIM_IPProtocolEndpoint getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_IPProtocolEndpoint.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_IPProtocolEndpoint.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[1] = new CIMProperty(
                CIM_IPProtocolEndpoint.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_IPProtocolEndpoint.CIM_CLASS_NAME);

        setThis = SystemName;

        keyProperties[2] = new CIMProperty(CIM_IPProtocolEndpoint.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_IPProtocolEndpoint.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_IPProtocolEndpoint createInstance(WBEMClient client,
            CIM_IPProtocolEndpoint dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_IPProtocolEndpoint newDataInstance = CIM_IPProtocolEndpointHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_IPProtocolEndpoint modifyInstance(WBEMClient client,
            CIM_IPProtocolEndpoint dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_IPProtocolEndpoint dataInstance2 = CIM_IPProtocolEndpointHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_IPProtocolEndpoint dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_IPProtocolEndpoint.getPackages());
    }
