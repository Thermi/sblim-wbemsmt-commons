 ...
 *
 *
 * Description:  NetworkPacketAction standardizes different processing options that can be taken
 * at the network packet level. The specific action is defined in the
 * PacketAction enumerated property. Note that this property can be used in
 * conjunction with other actions aggregated into a Rule, to fully define its
 * effects. For example, when aggregated with the SAStaticAction class,
 * NetworkPacketAction indicates whether a specific packet will be encrypted,
...
/**
 *  NetworkPacketAction standardizes different processing options that can be taken
 * at the network packet level. The specific action is defined in the
 * PacketAction enumerated property. Note that this property can be used in
 * conjunction with other actions aggregated into a Rule, to fully define its
 * effects. For example, when aggregated with the SAStaticAction class,
...
public class CIM_NetworkPacketAction extends CIM_PolicyAction  {
	...
	public final static String CIM_CLASS_NAME = "CIM_NetworkPacketAction"; //$NON-NLS-1$
