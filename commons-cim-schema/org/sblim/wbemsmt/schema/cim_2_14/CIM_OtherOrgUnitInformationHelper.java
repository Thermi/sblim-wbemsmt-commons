/** 
 * CIM_OtherOrgUnitInformationHelper.java
 *
...
public final class CIM_OtherOrgUnitInformationHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_OtherOrgUnitInformation.");
						resultArrayList.add(new CIM_OtherOrgUnitInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_OtherOrgUnitInformation.");
						resultArrayList.add(new CIM_OtherOrgUnitInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OtherOrgUnitInformation.");
						resultArrayList.add(new CIM_OtherOrgUnitInformation(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_OtherOrgUnitInformation getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_OtherOrgUnitInformationHelper.getInstance(cimClient, new CIM_OtherOrgUnitInformation(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OtherOrgUnitInformation getInstance(CIMClient cimClient, CIM_OtherOrgUnitInformation dataInstance) {
		...
		return CIM_OtherOrgUnitInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_OtherOrgUnitInformation getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_OtherOrgUnitInformation dataInstance = null;
		try {
			dataInstance = new CIM_OtherOrgUnitInformation(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OtherOrgUnitInformation createInstance(CIMClient cimClient, CIM_OtherOrgUnitInformation dataInstance, boolean notifyDifferencies){ 
		...
		CIM_OtherOrgUnitInformation newDataInstance = null;
		try {
			newDataInstance = CIM_OtherOrgUnitInformationHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_OtherOrgUnitInformation modifyInstance(CIMClient cimClient, CIM_OtherOrgUnitInformation dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_OtherOrgUnitInformationHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_OtherOrgUnitInformation dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_OtherOrgUnitInformation dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_OtherOrgUnitInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_OtherOrgUnitInformation.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_OtherOrgUnitInformation.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_OtherOrgUnitInformation.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_OtherOrgUnitInformation.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
