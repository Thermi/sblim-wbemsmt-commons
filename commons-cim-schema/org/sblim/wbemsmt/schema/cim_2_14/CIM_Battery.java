 ...
 *
 *
 * Description:  Capabilities and management of the Battery LogicalDevice. This class applies to
 * both batteries in Laptop Systems and other internal or external batteries,
...
/**
 *  Capabilities and management of the Battery LogicalDevice. This class applies to
 * both batteries in Laptop Systems and other internal or external batteries,
 * such as an uninterruptible power supply (UPS).
 */
public class CIM_Battery extends CIM_LogicalDevice  {
	
	public final static String CIM_CLASS_NAME = "CIM_Battery"; //$NON-NLS-1$
	...
	/**
	*	Description of the charge status of the Battery. Values such as "Fully Charged" (value=3) or "Partially Charged" (value=11) can be specified. The value, 10, is not valid in the CIM Schema because in DMI it represents that no battery is installed. In this case, this object should not be instantiated.
	*/
