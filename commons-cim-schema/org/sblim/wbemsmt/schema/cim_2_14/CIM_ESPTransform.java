 ...
 *
 *
 * Description:  ESPTransform defines the parameters used for a phase 2 ESP (Encapsulating
...
public class CIM_ESPTransform extends CIM_SATransform  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ESPTransform"; //$NON-NLS-1$
