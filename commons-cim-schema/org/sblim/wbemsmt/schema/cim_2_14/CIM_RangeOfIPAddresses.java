 ...
 *
 *
 * Description:  The class RangeOfIPAddresses represents an implicit grouping (or 'pool') of IP
 * addresses specified by the properties, Start and EndAddress. It is defined as
 * scoped/contained by a system such as an individual network element or an
 * admin domain.
 * 
 */
...
/**
 *  The class RangeOfIPAddresses represents an implicit grouping (or 'pool') of IP
 * addresses specified by the properties, Start and EndAddress. It is defined as
 * scoped/contained by a system such as an individual network element or an
 * admin domain.
 */
public class CIM_RangeOfIPAddresses extends CIM_SystemSpecificCollection  {
	...
	public final static String CIM_CLASS_NAME = "CIM_RangeOfIPAddresses"; //$NON-NLS-1$
