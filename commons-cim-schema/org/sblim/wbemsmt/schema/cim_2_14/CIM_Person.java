 ...
 *
 *
 * Description:  The Person class is used to represent people, and holds their white and yellow
 * pages data. The class is defined so as to incorporate commonly-used LDAP
 ...
 * related class, OtherPersonInformation, which defines all the group properties
...
/**
 *  The Person class is used to represent people, and holds their white and yellow
 * pages data. The class is defined so as to incorporate commonly-used LDAP
 * attributes to permit implementations to easily derive this information from
 * LDAP-accessible directories. This class's properties are a subset of a
 * related class, OtherPersonInformation, which defines all the group properties
...
public class CIM_Person extends CIM_UserContact  {
	...
	public final static String CIM_CLASS_NAME = "CIM_Person"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.8.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_MOREPERSONINFO = "CIM_MorePersonInfo"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_UserContact.Java_Package_List.size(); i++) {
			if (((String)CIM_UserContact.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
