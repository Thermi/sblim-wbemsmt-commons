 ...
 *
 *
 * Description:  This class contains statistical information for a Service's sessions. It is
 * deprecated since the statistics are defined in the BGP4 MIB at the level of
 * individual peers/ endpoints.
 * 
 */
...
public class CIM_BGPStatistics extends CIM_ServiceStatisticalInformation  {
	...
	public final static String CIM_CLASS_NAME = "CIM_BGPStatistics"; //$NON-NLS-1$
