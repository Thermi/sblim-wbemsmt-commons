...
public class CIM_ObjectManagerCommunicationMechanismHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME)) {
                        resultArrayList
                                .add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_ObjectManagerCommunicationMechanismHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_ObjectManagerCommunicationMechanism.");
                        resultArrayList
                                .add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ObjectManagerCommunicationMechanism.");
                        resultArrayList
                                .add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ObjectManagerCommunicationMechanism.");
                        resultArrayList
                                .add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ObjectManagerCommunicationMechanism getInstance(WBEMClient client,
    ...
    public final static CIM_ObjectManagerCommunicationMechanism getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ObjectManagerCommunicationMechanism.PROPERTY_CREATIONCLASSNAME.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ObjectManagerCommunicationMechanism.PROPERTY_NAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME);

        setThis = SystemCreationClassName;

        keyProperties[2] = new CIMProperty(
                CIM_ObjectManagerCommunicationMechanism.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME);
        ...
        keyProperties[3] = new CIMProperty(
                CIM_ObjectManagerCommunicationMechanism.PROPERTY_SYSTEMNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_ObjectManagerCommunicationMechanism createInstance(WBEMClient client,
            CIM_ObjectManagerCommunicationMechanism dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ObjectManagerCommunicationMechanism newDataInstance = CIM_ObjectManagerCommunicationMechanismHelper
     ...
     */
    public final static CIM_ObjectManagerCommunicationMechanism modifyInstance(WBEMClient client,
            CIM_ObjectManagerCommunicationMechanism dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ObjectManagerCommunicationMechanism dataInstance2 = CIM_ObjectManagerCommunicationMechanismHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ObjectManagerCommunicationMechanism dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ObjectManagerCommunicationMechanism.getPackages());
    }
