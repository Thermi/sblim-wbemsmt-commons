...
public final class CIM_ObjectManagerCommunicationMechanismHelper {
	...
	*/	
	public final static CIM_ObjectManagerCommunicationMechanism getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ObjectManagerCommunicationMechanismHelper.getInstance(cimClient, new CIM_ObjectManagerCommunicationMechanism(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ObjectManagerCommunicationMechanism getInstance(CIMClient cimClient, CIM_ObjectManagerCommunicationMechanism dataInstance) {
		...
		return CIM_ObjectManagerCommunicationMechanismHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ObjectManagerCommunicationMechanism getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_ObjectManagerCommunicationMechanism(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_ObjectManagerCommunicationMechanism.getPackages();
	...
	*/	
	public final static CIM_ObjectManagerCommunicationMechanism createInstance(CIMClient cimClient, CIM_ObjectManagerCommunicationMechanism dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ObjectManagerCommunicationMechanism newDataInstance = null;
		try {
			newDataInstance = CIM_ObjectManagerCommunicationMechanismHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ObjectManagerCommunicationMechanism modifyInstance(CIMClient cimClient, CIM_ObjectManagerCommunicationMechanism dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ObjectManagerCommunicationMechanismHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ObjectManagerCommunicationMechanism dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ObjectManagerCommunicationMechanism dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ObjectManagerCommunicationMechanism.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ObjectManagerCommunicationMechanism.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ObjectManagerCommunicationMechanism.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ObjectManagerCommunicationMechanism.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ObjectManagerCommunicationMechanism.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AdvertiseTypeDescriptions(String[] AdvertiseTypeDescriptions) {
		return true;
	}

	public static boolean isValid_AdvertiseTypes(UnsignedInt16[] AdvertiseTypes) {
		return true;
	}

	public static boolean isValid_AuthenticationMechanismDescriptions(String[] AuthenticationMechanismDescriptions) {
		return true;
	}

	public static boolean isValid_AuthenticationMechanismsSupported(UnsignedInt16[] AuthenticationMechanismsSupported) {
		return true;
	}

	public static boolean isValid_CommunicationMechanism(UnsignedInt16 CommunicationMechanism) {
		return true;
	}

	public static boolean isValid_FunctionalProfileDescriptions(String[] FunctionalProfileDescriptions) {
		return true;
	}

	public static boolean isValid_FunctionalProfilesSupported(UnsignedInt16[] FunctionalProfilesSupported) {
		return true;
	}

	public static boolean isValid_MultipleOperationsSupported(Boolean MultipleOperationsSupported) {
		return true;
	}

	public static boolean isValid_OtherCommunicationMechanismDescription(String OtherCommunicationMechanismDescription) {
		return true;
	}
