 ...
 *
 *
 * Description:  DeviceErrorCounts is a statistical class containing error- related counters for
 * a LogicalDevice. The types of errors are defined by CCITT (Rec X.733) and ISO
 * (IEC 10164-4). Note that the CIM_DeviceErrorCountData class uses a simplified
 * naming or identity algorithm as compared to this class. DeviceErrorCounts is
 * not deprecated because its naming algorithm is still in use in various
 * implementations.
 * 
 */
...
/**
 *  DeviceErrorCounts is a statistical class containing error- related counters for
 * a LogicalDevice. The types of errors are defined by CCITT (Rec X.733) and ISO
 * (IEC 10164-4). Note that the CIM_DeviceErrorCountData class uses a simplified
 * naming or identity algorithm as compared to this class. DeviceErrorCounts is
 * not deprecated because its naming algorithm is still in use in various
...
public class CIM_DeviceErrorCounts extends CIM_StatisticalInformation  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DeviceErrorCounts"; //$NON-NLS-1$
