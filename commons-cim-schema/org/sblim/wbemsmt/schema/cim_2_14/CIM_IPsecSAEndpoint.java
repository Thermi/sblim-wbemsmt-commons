 ...
 *
 *
 * Description:  IPsecSAEndpoints are types of SecurityAssociationEndpoints representing both
 * negotiated and static SAs that correspond to AH, ESP, or IPCOMP transforms.
 * 
 */
...
/**
 *  IPsecSAEndpoints are types of SecurityAssociationEndpoints representing both
 * negotiated and static SAs that correspond to AH, ESP, or IPCOMP transforms.
 */
public class CIM_IPsecSAEndpoint extends CIM_SecurityAssociationEndpoint  {
	
	public final static String CIM_CLASS_NAME = "CIM_IPsecSAEndpoint"; //$NON-NLS-1$
