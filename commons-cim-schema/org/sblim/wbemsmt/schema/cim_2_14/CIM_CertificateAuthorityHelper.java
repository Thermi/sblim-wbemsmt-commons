/** 
 * CIM_CertificateAuthorityHelper.java
 *
...
public final class CIM_CertificateAuthorityHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_CertificateAuthority.Java_Package_List.size(); i++) {
						if (!((String)(CIM_CertificateAuthority.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_CertificateAuthority.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_CertificateAuthority.Java_Package_List.setElementAt((String)(CIM_CertificateAuthority.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CertificateAuthority.");
						resultArrayList.add(new CIM_CertificateAuthority(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CertificateAuthority.");
						resultArrayList.add(new CIM_CertificateAuthority(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CertificateAuthority.");
						resultArrayList.add(new CIM_CertificateAuthority(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_CertificateAuthority getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CertificateAuthorityHelper.getInstance(cimClient, new CIM_CertificateAuthority(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CertificateAuthority getInstance(CIMClient cimClient, CIM_CertificateAuthority dataInstance) {
		...
		return CIM_CertificateAuthorityHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CertificateAuthority getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_CertificateAuthority dataInstance = null;
		try {
			dataInstance = new CIM_CertificateAuthority(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CertificateAuthority createInstance(CIMClient cimClient, CIM_CertificateAuthority dataInstance, boolean notifyDifferencies){ 
		...
		CIM_CertificateAuthority newDataInstance = null;
		try {
			newDataInstance = CIM_CertificateAuthorityHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CertificateAuthority modifyInstance(CIMClient cimClient, CIM_CertificateAuthority dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_CertificateAuthorityHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_CertificateAuthority dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_CertificateAuthority dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_CertificateAuthority.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_CertificateAuthority.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_CertificateAuthority.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_CertificateAuthority.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_CertificateAuthority.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CADistinguishedName(String CADistinguishedName) {
		return true;
	}

	public static boolean isValid_CAPolicyStatement(String CAPolicyStatement) {
		return true;
	}
	...
	public static boolean isValid_CRLRefreshFrequency(UnsignedInt8 CRLRefreshFrequency) {
		return true;
	}

	public static boolean isValid_CRL(String[] CRL) {
		return true;
	}

	public static boolean isValid_MaxChainLength(UnsignedInt8 MaxChainLength) {
		return true;
	}
