/** 
 * CIM_AGPVideoControllerHelper.java
 *
...
public final class CIM_AGPVideoControllerHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_AGPVideoController(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_AGPVideoController.Java_Package_List.size(); i++) {
						if (!((String)(CIM_AGPVideoController.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_AGPVideoController.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_AGPVideoController.Java_Package_List.setElementAt((String)(CIM_AGPVideoController.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_AGPVideoController.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AGPVideoController.");
						resultArrayList.add(new CIM_AGPVideoController(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AGPVideoController.");
						resultArrayList.add(new CIM_AGPVideoController(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AGPVideoController.");
						resultArrayList.add(new CIM_AGPVideoController(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_AGPVideoController getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_AGPVideoControllerHelper.getInstance(cimClient, new CIM_AGPVideoController(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AGPVideoController getInstance(CIMClient cimClient, CIM_AGPVideoController dataInstance) {
		...
		return CIM_AGPVideoControllerHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AGPVideoController getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_AGPVideoController dataInstance = null;
		try {
			dataInstance = new CIM_AGPVideoController(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AGPVideoController createInstance(CIMClient cimClient, CIM_AGPVideoController dataInstance, boolean notifyDifferencies){ 
		...
		CIM_AGPVideoController newDataInstance = null;
		try {
			newDataInstance = CIM_AGPVideoControllerHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AGPVideoController modifyInstance(CIMClient cimClient, CIM_AGPVideoController dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_AGPVideoControllerHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_AGPVideoController dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_AGPVideoController dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_AGPVideoController.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_AGPVideoController.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_AGPVideoController.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_AGPVideoController.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_AGPVideoController.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AGPSpecificationVersionConformance(String AGPSpecificationVersionConformance) {
		return true;
	}

	public static boolean isValid_AddressingMode(UnsignedInt16 AddressingMode) {
		return true;
	}
	...
	public static boolean isValid_DataTransferRate(UnsignedInt16 DataTransferRate) {
		return true;
	}

	public static boolean isValid_GraphicsApertureSize(UnsignedInt32 GraphicsApertureSize) {
		return true;
	}

	public static boolean isValid_LocalBusWidth(UnsignedInt32 LocalBusWidth) {
		return true;
	}

	public static boolean isValid_MaxNumberOfPipelinedAGPTransactions(UnsignedInt32 MaxNumberOfPipelinedAGPTransactions) {
		return true;
	}

	public static boolean isValid_MaximumAGPCommandQueuePath(UnsignedInt32 MaximumAGPCommandQueuePath) {
		return true;
	}

	public static boolean isValid_NonlocalVideoMemorySize(UnsignedInt32 NonlocalVideoMemorySize) {
		return true;
	}

	public static boolean isValid_UsageModel(UnsignedInt16 UsageModel) {
		return true;
	}
