 ...
 *
 *
 * Description:  The CIM_J2eeJTAStats class defines the performance statistics that are provided
 * by a JTA resource.
 * 
 */
...
/**
 *  The CIM_J2eeJTAStats class defines the performance statistics that are provided
 * by a JTA resource.
 */
public class CIM_J2eeJTAStats extends CIM_J2eeStatistic  {
	
	public final static String CIM_CLASS_NAME = "CIM_J2eeJTAStats"; //$NON-NLS-1$
