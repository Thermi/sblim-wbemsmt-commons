 ...
 *
 *
 * Description:  PolicySetAppliesToElement makes explicit which PolicySets (i.e., policy rules
 * and groups of rules) ARE CURRENTLY applied to a particular Element. This
 * association indicates that the PolicySets that are appropriate for a
 * ManagedElement (specified using the PolicyRoleCollection aggregation) have
 * actually been deployed in the policy management infrastructure. Note that if
 * the named Element refers to a Collection, then the PolicySet is assumed to be
 * applied to all the members of the Collection.
 * 
 */
...
/**
 *  PolicySetAppliesToElement makes explicit which PolicySets (i.e., policy rules
 * and groups of rules) ARE CURRENTLY applied to a particular Element. This
 * association indicates that the PolicySets that are appropriate for a
 * ManagedElement (specified using the PolicyRoleCollection aggregation) have
 * actually been deployed in the policy management infrastructure. Note that if
...
public class CIM_PolicySetAppliesToElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_PolicySetAppliesToElement"; //$NON-NLS-1$
