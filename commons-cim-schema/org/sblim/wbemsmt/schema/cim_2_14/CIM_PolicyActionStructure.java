 ...
 *
 *
 * Description:  PolicyActions may be aggregated into rules and into compound actions.
 * PolicyActionStructure is the abstract aggregation class for the structuring
 * of policy actions.
 * 
 */
...
/**
 *  PolicyActions may be aggregated into rules and into compound actions.
 * PolicyActionStructure is the abstract aggregation class for the structuring
 * of policy actions.
 */
public class CIM_PolicyActionStructure extends CIM_PolicyComponent  {
	
	public final static String CIM_CLASS_NAME = "CIM_PolicyActionStructure"; //$NON-NLS-1$
