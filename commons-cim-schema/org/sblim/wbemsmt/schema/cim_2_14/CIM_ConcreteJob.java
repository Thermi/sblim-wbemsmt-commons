...
If 0 is returned, then the task completed successfully. Any other return code indicates an error condition.
	*/
	...
	public final static String[] CIM_VALUEMAP_JOBSTATE = {"New","Starting","Running","Suspended","Shutting Down","Completed","Terminated","Killed","Exception","Service","Query Pending","DMTF Reserved","Vendor Reserved"};
	...
	public final static String JOBSTATE_QUERYPENDING = "12";
	public final static String JOBSTATE_DMTFRESERVED = "13..32767";
