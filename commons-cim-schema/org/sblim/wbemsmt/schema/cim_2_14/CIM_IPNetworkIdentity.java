 ...
 *
 *
 * Description:  IPNetworkIdentity is used to represent the various network identities that may
 * be used for an IPProtocolEndpoint. The relationship between the
 * NetworkIdentity and the IPProtocolEndpoint is modeled by the AssignedIdentity
 * association, inherited from CIM_Identity. This association could also be used
 * to relate an address range or other endpoint collection with the Identity.
 * 
 */
...
/**
 *  IPNetworkIdentity is used to represent the various network identities that may
 * be used for an IPProtocolEndpoint. The relationship between the
 * NetworkIdentity and the IPProtocolEndpoint is modeled by the AssignedIdentity
 * association, inherited from CIM_Identity. This association could also be used
 * to relate an address range or other endpoint collection with the Identity.
...
public class CIM_IPNetworkIdentity extends CIM_Identity  {
	...
	public final static String CIM_CLASS_NAME = "CIM_IPNetworkIdentity"; //$NON-NLS-1$
