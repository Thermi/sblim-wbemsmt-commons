/** 
 * CIM_DatabaseServiceStatisticsHelper.java
 *
...
public final class CIM_DatabaseServiceStatisticsHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_DatabaseServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_DatabaseServiceStatistics.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DatabaseServiceStatistics.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_DatabaseServiceStatistics.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_DatabaseServiceStatistics.Java_Package_List.setElementAt((String)(CIM_DatabaseServiceStatistics.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_DatabaseServiceStatistics.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DatabaseServiceStatistics.");
						resultArrayList.add(new CIM_DatabaseServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DatabaseServiceStatistics.");
						resultArrayList.add(new CIM_DatabaseServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DatabaseServiceStatistics.");
						resultArrayList.add(new CIM_DatabaseServiceStatistics(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DatabaseServiceStatistics getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DatabaseServiceStatisticsHelper.getInstance(cimClient, new CIM_DatabaseServiceStatistics(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DatabaseServiceStatistics getInstance(CIMClient cimClient, CIM_DatabaseServiceStatistics dataInstance) {
		...
		return CIM_DatabaseServiceStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DatabaseServiceStatistics getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DatabaseServiceStatistics dataInstance = null;
		try {
			dataInstance = new CIM_DatabaseServiceStatistics(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DatabaseServiceStatistics createInstance(CIMClient cimClient, CIM_DatabaseServiceStatistics dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DatabaseServiceStatistics newDataInstance = null;
		try {
			newDataInstance = CIM_DatabaseServiceStatisticsHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DatabaseServiceStatistics modifyInstance(CIMClient cimClient, CIM_DatabaseServiceStatistics dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DatabaseServiceStatisticsHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DatabaseServiceStatistics dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DatabaseServiceStatistics dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DatabaseServiceStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DatabaseServiceStatistics.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DatabaseServiceStatistics.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DatabaseServiceStatistics.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DatabaseServiceStatistics.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ActiveConnections(UnsignedInt64 ActiveConnections) {
		return true;
	}

	public static boolean isValid_CompletedTransactions(UnsignedInt64 CompletedTransactions) {
		return true;
	}

	public static boolean isValid_CumulativeConnections(UnsignedInt64 CumulativeConnections) {
		return true;
	}

	public static boolean isValid_DiskReads(UnsignedInt64 DiskReads) {
		return true;
	}

	public static boolean isValid_DiskSpaceUnavailable(UnsignedInt64 DiskSpaceUnavailable) {
		return true;
	}

	public static boolean isValid_DiskWrites(UnsignedInt64 DiskWrites) {
		return true;
	}

	public static boolean isValid_HighwaterConnections(UnsignedInt64 HighwaterConnections) {
		return true;
	}

	public static boolean isValid_LastActivity(Calendar LastActivity) {
		return true;
	}

	public static boolean isValid_LogicalReads(UnsignedInt64 LogicalReads) {
		return true;
	}

	public static boolean isValid_LogicalWrites(UnsignedInt64 LogicalWrites) {
		return true;
	}

	public static boolean isValid_PageReads(UnsignedInt64 PageReads) {
		return true;
	}

	public static boolean isValid_PageWrites(UnsignedInt64 PageWrites) {
		return true;
	}

	public static boolean isValid_RejectedConnections(UnsignedInt64 RejectedConnections) {
		return true;
	}

	public static boolean isValid_RequestsHandled(UnsignedInt64 RequestsHandled) {
		return true;
	}

	public static boolean isValid_RequestsReceived(UnsignedInt64 RequestsReceived) {
		return true;
	}

	public static boolean isValid_RequestsSent(UnsignedInt64 RequestsSent) {
		return true;
	}
