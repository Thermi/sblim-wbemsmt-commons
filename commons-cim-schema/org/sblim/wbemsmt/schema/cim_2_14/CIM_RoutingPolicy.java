 ...
 *
 *
 * Description:  This class is used to implement routing policies. It aggregates a set of
 * FilterLists, along with other appropriate constructs, into a unit. One of the
 * most important uses of this class is to change the routing policy by changing
 * values of various attributes in a consistent manner. A RoutingPolicy is weak
 * to the network device (i.e., the ComputerSystem) that contains it. Hence, the
 * ComputerSystem keys are propagated to this class. Note that this class was
 * defined before the Policy Model and hence is not positioned in that
 * hierarchy. The class will be repositioned in a later release of the Network
 * Model.
 * 
 */
...
public class CIM_RoutingPolicy extends CIM_LogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_RoutingPolicy"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.7.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_BGPROUTEMAPSINROUTINGPOLICY = "CIM_BGPRouteMapsInRoutingPolicy"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_BGPROUTINGPOLICY = "CIM_BGPRoutingPolicy"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_FILTEREDBGPATTRIBUTES = "CIM_FilteredBGPAttributes"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDROUTINGPOLICY = "CIM_HostedRoutingPolicy"; //$NON-NLS-1$
