 ...
 *
 *
 * Description:  PRS_SolutionHasElement is an abstract base class for associating PRS_Solution
 * with objects derived from PRS_SolutionElement. This association class allows
 * all PRS_Reference, PRS_Problem and PRS_Resolution objects to be retrieved
 * with a single query.
 * 
 */
...
/**
 *  PRS_SolutionHasElement is an abstract base class for associating PRS_Solution
 * with objects derived from PRS_SolutionElement. This association class allows
 * all PRS_Reference, PRS_Problem and PRS_Resolution objects to be retrieved
 * with a single query.
 */
public class PRS_SolutionHasElement extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "PRS_SolutionHasElement"; //$NON-NLS-1$
