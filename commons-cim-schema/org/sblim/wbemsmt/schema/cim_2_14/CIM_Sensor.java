 ...
 *
 *
 * Description:  A Sensor is a hardware device capable of measuring the characteristics of some
 * physical property - for example, the temperature or voltage characteristics
 * of a UnitaryComputer System.
 * 
 */
...
/**
 *  A Sensor is a hardware device capable of measuring the characteristics of some
 * physical property - for example, the temperature or voltage characteristics
 * of a UnitaryComputer System.
 */
public class CIM_Sensor extends CIM_LogicalDevice  {
	
	public final static String CIM_CLASS_NAME = "CIM_Sensor"; //$NON-NLS-1$
