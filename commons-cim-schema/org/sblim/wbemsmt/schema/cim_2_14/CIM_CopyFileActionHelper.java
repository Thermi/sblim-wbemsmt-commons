...
public final class CIM_CopyFileActionHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_CopyFileAction.Java_Package_List.size(); i++) {
						if (!((String)(CIM_CopyFileAction.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_CopyFileAction.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_CopyFileAction.Java_Package_List.setElementAt((String)(CIM_CopyFileAction.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CopyFileAction.");
						resultArrayList.add(new CIM_CopyFileAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CopyFileAction.");
						resultArrayList.add(new CIM_CopyFileAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CopyFileAction.");
						resultArrayList.add(new CIM_CopyFileAction(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_CopyFileAction getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_CopyFileActionHelper.getInstance(cimClient, new CIM_CopyFileAction(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CopyFileAction getInstance(CIMClient cimClient, CIM_CopyFileAction dataInstance) {
		...
		return CIM_CopyFileActionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_CopyFileAction getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_CopyFileAction dataInstance = null;
		try {
			dataInstance = new CIM_CopyFileAction(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CopyFileAction createInstance(CIMClient cimClient, CIM_CopyFileAction dataInstance, boolean notifyDifferencies){ 
		...
		CIM_CopyFileAction newDataInstance = null;
		try {
			newDataInstance = CIM_CopyFileActionHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_CopyFileAction modifyInstance(CIMClient cimClient, CIM_CopyFileAction dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_CopyFileActionHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_CopyFileAction dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_CopyFileAction dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_CopyFileAction.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_CopyFileAction.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_CopyFileAction.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_CopyFileAction.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_CopyFileAction.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DeleteAfterCopy(Boolean DeleteAfterCopy) {
		return true;
	}
	...
	public static boolean isValid_Source(String Source) {
		return true;
	}
