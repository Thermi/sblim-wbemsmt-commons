 ...
 *
 *
 * Description:  A collection of LAN Endpoints of a particular type that are able to
 * intercommunicate directly without the assistance of bridging or routing
 * services. Since this class' superclass (LogicalNetwork) has been deprecated
 * (in order to define more consistent 'collection' semantics), this class is
 * also deprecated.
 * 
 */
...
public class CIM_LANSegment extends CIM_LogicalNetwork  {
	...
	public final static String CIM_CLASS_NAME = "CIM_LANSegment"; //$NON-NLS-1$
