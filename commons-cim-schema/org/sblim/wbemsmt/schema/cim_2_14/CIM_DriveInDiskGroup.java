 ...
 *
 *
 * Description:  CIM_DriveInDiskGroup defines the DiskDrives that participate in the Group.
 * 
 */
...
public class CIM_DriveInDiskGroup extends CIM_CollectedMSEs  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DriveInDiskGroup"; //$NON-NLS-1$
