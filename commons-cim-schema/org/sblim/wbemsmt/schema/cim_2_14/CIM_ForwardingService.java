 ...
 *
 *
 * Description:  This class represents the functions used in forwarding network traffic. Its
 ...
 * subclasses). Generally, the Endpoints are at the same protocol layer and are
 * usually of similar types, or of the same type. ForwardingService is different
 * than RouteCalculation Service in that it represents the function of
 * forwarding traffic independent of calculating routing information. Examining
 * the ForwardingService class definition, note that its superclass
 * NetworkService is deprecated. Therefore, NetworkService's properties need not
 * be implemented in an instance of ForwardingService. Unfortunately,
 ...
 * removed, and ForwardingService will subclass from CIM_Service directly. Also
 * note that there are a large number of additional protocols that are not
...
public class CIM_ForwardingService extends CIM_NetworkService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ForwardingService"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.7.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_FORWARDEDROUTES = "CIM_ForwardedRoutes"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_FORWARDSAMONG = "CIM_ForwardsAmong"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDFORWARDINGSERVICES = "CIM_HostedForwardingServices"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ROUTEFORWARDEDBYSERVICE = "CIM_RouteForwardedByService"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_NetworkService.Java_Package_List.size(); i++) {
			if (((String)CIM_NetworkService.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
