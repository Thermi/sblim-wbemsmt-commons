 ...
 *
 *
 * Description:  NetworkPipe is a subclass of EnabledLogicalElement, representing the state and
 * management of a connection or trail between endpoints. This object is
 * different than the association between the endpoints (CIM_ActiveConnection)
 * since the emphasis is NOT on the endpoints but on the management of the pipe
 * itself - its state, configuration, etc. NetworkPipes are defined in the
 * context of a CIM_Network and represent the 'transfer of information . . .
 * between . . . endpoints'. These concepts are aligned with the definition of
 * the Pipe object in ITU's M.3100 specification.
 * 
 */
...
/**
 *  NetworkPipe is a subclass of EnabledLogicalElement, representing the state and
 * management of a connection or trail between endpoints. This object is
 * different than the association between the endpoints (CIM_ActiveConnection)
 * since the emphasis is NOT on the endpoints but on the management of the pipe
 * itself - its state, configuration, etc. NetworkPipes are defined in the
...
public class CIM_NetworkPipe extends CIM_EnabledLogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_NetworkPipe"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_NETWORKPIPECOMPOSITION = "CIM_NetworkPipeComposition"; //$NON-NLS-1$
