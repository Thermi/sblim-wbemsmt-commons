/** 
 * CIM_StaticIPAssignmentSettingDataHelper.java
 *
...
public final class CIM_StaticIPAssignmentSettingDataHelper {

	public final static String CIM_CLASS_NAME = "CIM_StaticIPAssignmentSettingData";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_StaticIPAssignmentSettingData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_StaticIPAssignmentSettingData.Java_Package_List.size(); i++) {
						if (!((String)(CIM_StaticIPAssignmentSettingData.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_StaticIPAssignmentSettingData.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_StaticIPAssignmentSettingData.Java_Package_List.setElementAt((String)(CIM_StaticIPAssignmentSettingData.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_StaticIPAssignmentSettingData.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StaticIPAssignmentSettingData.");
						resultArrayList.add(new CIM_StaticIPAssignmentSettingData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StaticIPAssignmentSettingData.");
						resultArrayList.add(new CIM_StaticIPAssignmentSettingData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StaticIPAssignmentSettingData.");
						resultArrayList.add(new CIM_StaticIPAssignmentSettingData(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StaticIPAssignmentSettingData getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StaticIPAssignmentSettingDataHelper.getInstance(cimClient, new CIM_StaticIPAssignmentSettingData(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StaticIPAssignmentSettingData getInstance(CIMClient cimClient, CIM_StaticIPAssignmentSettingData dataInstance) {
		...
		return CIM_StaticIPAssignmentSettingDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StaticIPAssignmentSettingData getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StaticIPAssignmentSettingData dataInstance = null;
		try {
			dataInstance = new CIM_StaticIPAssignmentSettingData(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StaticIPAssignmentSettingData createInstance(CIMClient cimClient, CIM_StaticIPAssignmentSettingData dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StaticIPAssignmentSettingData newDataInstance = null;
		try {
			newDataInstance = CIM_StaticIPAssignmentSettingDataHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StaticIPAssignmentSettingData modifyInstance(CIMClient cimClient, CIM_StaticIPAssignmentSettingData dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StaticIPAssignmentSettingDataHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StaticIPAssignmentSettingData dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StaticIPAssignmentSettingData dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StaticIPAssignmentSettingData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StaticIPAssignmentSettingData.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StaticIPAssignmentSettingData.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StaticIPAssignmentSettingData.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StaticIPAssignmentSettingData.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AddressOrigin(UnsignedInt16 AddressOrigin) {
		return true;
	}

	public static boolean isValid_GatewayIPv4Address(String GatewayIPv4Address) {
		return true;
	}

	public static boolean isValid_IPv4Address(String IPv4Address) {
		return true;
	}

	public static boolean isValid_SubnetMask(String SubnetMask) {
		return true;
	}
