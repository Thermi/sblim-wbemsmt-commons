 ...
 *
 *
 * Description:  The VersionCompatibilityCheck class specifies whether it is permissible to
 * create the next state of a SoftwareElement.
 * 
 */
...
/**
 *  The VersionCompatibilityCheck class specifies whether it is permissible to
 * create the next state of a SoftwareElement.
 */
public class CIM_VersionCompatibilityCheck extends CIM_Check  {
	
	public final static String CIM_CLASS_NAME = "CIM_VersionCompatibilityCheck"; //$NON-NLS-1$
