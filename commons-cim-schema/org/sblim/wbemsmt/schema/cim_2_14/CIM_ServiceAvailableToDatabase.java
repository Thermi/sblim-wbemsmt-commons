 ...
 *
 *
 * Description:  The CIM_ServiceAvailableToDatabase association relates databases to the
 * database services that are available for database use.
 * 
 */
...
/**
 *  The CIM_ServiceAvailableToDatabase association relates databases to the
 * database services that are available for database use.
 */
public class CIM_ServiceAvailableToDatabase extends CIM_ServiceAvailableToElement  {
	
	public final static String CIM_CLASS_NAME = "CIM_ServiceAvailableToDatabase"; //$NON-NLS-1$
