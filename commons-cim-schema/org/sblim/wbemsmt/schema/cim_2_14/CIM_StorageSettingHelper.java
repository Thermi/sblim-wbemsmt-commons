...
public final class CIM_StorageSettingHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_StorageSetting.");
						resultArrayList.add(new CIM_StorageSetting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_StorageSetting.");
						resultArrayList.add(new CIM_StorageSetting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_StorageSetting.");
						resultArrayList.add(new CIM_StorageSetting(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_StorageSetting getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_StorageSettingHelper.getInstance(cimClient, new CIM_StorageSetting(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageSetting getInstance(CIMClient cimClient, CIM_StorageSetting dataInstance) {
		...
		return CIM_StorageSettingHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_StorageSetting getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_StorageSetting dataInstance = null;
		try {
			dataInstance = new CIM_StorageSetting(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StorageSetting createInstance(CIMClient cimClient, CIM_StorageSetting dataInstance, boolean notifyDifferencies){ 
		...
		CIM_StorageSetting newDataInstance = null;
		try {
			newDataInstance = CIM_StorageSettingHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_StorageSetting modifyInstance(CIMClient cimClient, CIM_StorageSetting dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_StorageSettingHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_StorageSetting dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_StorageSetting dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_StorageSetting.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_StorageSetting.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_StorageSetting.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_StorageSetting.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_StorageSetting.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_ChangeableType(UnsignedInt16 ChangeableType) {
		return true;
	}

	public static boolean isValid_DataRedundancyGoal(UnsignedInt16 DataRedundancyGoal) {
		return true;
	}
	...
	public static boolean isValid_DeltaReservationGoal(UnsignedInt8 DeltaReservationGoal) {
		return true;
	}

	public static boolean isValid_DeltaReservationMax(UnsignedInt8 DeltaReservationMax) {
		return true;
	}

	public static boolean isValid_DeltaReservationMin(UnsignedInt8 DeltaReservationMin) {
		return true;
	}

	public static boolean isValid_ExtentStripeLength(UnsignedInt16 ExtentStripeLength) {
		return true;
	}

	public static boolean isValid_ExtentStripeLengthMax(UnsignedInt16 ExtentStripeLengthMax) {
		return true;
	}

	public static boolean isValid_ExtentStripeLengthMin(UnsignedInt16 ExtentStripeLengthMin) {
		return true;
	}
	...
	public static boolean isValid_PackageRedundancyGoal(UnsignedInt16 PackageRedundancyGoal) {
		return true;
	}
	...
	public static boolean isValid_ParityLayout(UnsignedInt16 ParityLayout) {
		return true;
	}
	...
	public static boolean isValid_UserDataStripeDepthMax(UnsignedInt64 UserDataStripeDepthMax) {
		return true;
	}

	public static boolean isValid_UserDataStripeDepthMin(UnsignedInt64 UserDataStripeDepthMin) {
		return true;
	}
