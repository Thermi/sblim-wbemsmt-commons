 ...
 *
 *
 * Description:  The OtherRoleInformation class is used to provide additional information about
 * an associated Role instance. This class is defined so as to incorporate
...
/**
 *  The OtherRoleInformation class is used to provide additional information about
 * an associated Role instance. This class is defined so as to incorporate
 * commonly-used LDAP attributes to permit implementations to easily derive this
 * information from LDAP-accessible directories.
 */
public class CIM_OtherRoleInformation extends CIM_ManagedElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_OtherRoleInformation"; //$NON-NLS-1$
