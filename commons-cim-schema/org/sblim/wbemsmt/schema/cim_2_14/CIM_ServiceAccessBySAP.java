 ...
 * a Service. For example, a printer might be accessed by NetWare, MacIntosh or
 * Windows ServiceAccessPoints, which might all be hosted on different Systems.
 * 
 */
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_ServiceAccessBySAP.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_ServiceAccessBySAP.Java_Package_List.toArray(new String[CIM_ServiceAccessBySAP.Java_Package_List.size()]);
    }
