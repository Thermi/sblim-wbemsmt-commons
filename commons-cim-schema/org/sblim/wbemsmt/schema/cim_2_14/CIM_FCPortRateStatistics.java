 ...
 *
 *
 * Description:  FCPortRateStatistics is the performance rate for the FCPort. The Frame and Byte
 * rates report the average of a counter change per second and the maximum
 * counter change per second over a specified interval, the SampleInterval,
 * which is defined in the parent class, StatisticalData.
 * 
 */
...
/**
 *  FCPortRateStatistics is the performance rate for the FCPort. The Frame and Byte
 * rates report the average of a counter change per second and the maximum
 * counter change per second over a specified interval, the SampleInterval,
 * which is defined in the parent class, StatisticalData.
 */
public class CIM_FCPortRateStatistics extends CIM_StatisticalData  {
	...
	public final static String CIM_CLASS_NAME = "CIM_FCPortRateStatistics"; //$NON-NLS-1$
