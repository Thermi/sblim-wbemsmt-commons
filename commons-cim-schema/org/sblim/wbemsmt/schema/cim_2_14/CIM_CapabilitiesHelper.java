...
public class CIM_CapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_Capabilities.CIM_CLASS_NAME,
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_Capabilities.");
                        resultArrayList.add(new CIM_Capabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_Capabilities.");
                        resultArrayList.add(new CIM_Capabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_Capabilities.");
                        resultArrayList.add(new CIM_Capabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_Capabilities getInstance(WBEMClient client, CIMObjectPath cimObjectPath)
            throws WbemsmtException {
     ...
     */
    public final static CIM_Capabilities getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_Capabilities getInstance(WBEMClient client, String namespace,
        ...
        keyProperties[0] = new CIMProperty(CIM_Capabilities.PROPERTY_INSTANCEID.NAME,
                CIMDataType.STRING_T, setThis, true, false, CIM_Capabilities.CIM_CLASS_NAME);
     ...
     */
    public final static void deleteInstance(WBEMClient client, CIM_Capabilities dataInstance)
            throws WbemsmtException {
