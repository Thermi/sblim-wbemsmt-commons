/** 
 * CIM_RouteForwardedByServiceHelper.java
 *
...
public final class CIM_RouteForwardedByServiceHelper {

	public final static String CIM_CLASS_NAME = "CIM_RouteForwardedByService";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_RouteForwardedByService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_RouteForwardedByService.Java_Package_List.size(); i++) {
						if (!((String)(CIM_RouteForwardedByService.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_RouteForwardedByService.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_RouteForwardedByService.Java_Package_List.setElementAt((String)(CIM_RouteForwardedByService.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_RouteForwardedByService.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RouteForwardedByService.");
						resultArrayList.add(new CIM_RouteForwardedByService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RouteForwardedByService.");
						resultArrayList.add(new CIM_RouteForwardedByService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RouteForwardedByService.");
						resultArrayList.add(new CIM_RouteForwardedByService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_RouteForwardedByService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_RouteForwardedByServiceHelper.getInstance(cimClient, new CIM_RouteForwardedByService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RouteForwardedByService getInstance(CIMClient cimClient, CIM_RouteForwardedByService dataInstance) {
		...
		return CIM_RouteForwardedByServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RouteForwardedByService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_RouteForwardedByService dataInstance = null;
		try {
			dataInstance = new CIM_RouteForwardedByService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RouteForwardedByService createInstance(CIMClient cimClient, CIM_RouteForwardedByService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_RouteForwardedByService newDataInstance = null;
		try {
			newDataInstance = CIM_RouteForwardedByServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RouteForwardedByService modifyInstance(CIMClient cimClient, CIM_RouteForwardedByService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_RouteForwardedByServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_RouteForwardedByService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_RouteForwardedByService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_RouteForwardedByService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_RouteForwardedByService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_RouteForwardedByService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_RouteForwardedByService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_RouteForwardedByService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AdminDistance(UnsignedInt16 AdminDistance) {
		return true;
	}

	public static boolean isValid_PathMetric(UnsignedInt16 PathMetric) {
		return true;
	}

	public static boolean isValid_CIM_ForwardingService(CIM_ForwardingService CIM_ForwardingService) {
		return true;
	}

	public static boolean isValid_CIM_NextHopRouting(CIM_NextHopRouting CIM_NextHopRouting) {
		return true;
	}
