...
public class CIM_PhysicalConnector extends CIM_PhysicalElement  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_LINKHASCONNECTOR = "CIM_LinkHasConnector"; //$NON-NLS-1$
...
The use of this property is deprecated in lieu of Connector Description.
	*/
	...
	public final static String[] CIM_VALUEMAP_CONNECTORLAYOUT = {"Unknown","Other","RS232","BNC","RJ11","RJ45","DB9","Slot","SCSI High Density","SCSI Low Density","Ribbon","AUI","Fiber SC","Fiber ST","FDDI-MIC","Fiber-RTMJ","DMTF Reserved","Vendor Reserved"};
	...
	public final static String CONNECTORLAYOUT_UNKNOWN = "0";
	public final static String CONNECTORLAYOUT_OTHER = "1";
	public final static String CONNECTORLAYOUT_RS232 = "2";
	public final static String CONNECTORLAYOUT_BNC = "3";
	public final static String CONNECTORLAYOUT_RJ11 = "4";
	public final static String CONNECTORLAYOUT_RJ45 = "5";
	public final static String CONNECTORLAYOUT_DB9 = "6";
	public final static String CONNECTORLAYOUT_SLOT = "7";
	public final static String CONNECTORLAYOUT_SCSIHIGHDENSITY = "8";
	public final static String CONNECTORLAYOUT_SCSILOWDENSITY = "9";
	public final static String CONNECTORLAYOUT_RIBBON = "10";
	public final static String CONNECTORLAYOUT_AUI = "11";
	public final static String CONNECTORLAYOUT_FIBERSC = "12";
	public final static String CONNECTORLAYOUT_FIBERST = "13";
	public final static String CONNECTORLAYOUT_FDDI_MIC = "14";
	public final static String CONNECTORLAYOUT_FIBER_RTMJ = "15";
	public final static String CONNECTORLAYOUT_DMTFRESERVED = "17..32567";
	public final static String CONNECTORLAYOUT_VENDORRESERVED = "32568..65535";
	...
	*/	
	...
	public ArrayList getAssociated_CIM_PhysicalPackage_CIM_ConnectorOnPackages(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_PhysicalPackage_CIM_ConnectorOnPackage_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_PhysicalLink_CIM_LinkHasConnectors(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_PhysicalLink_CIM_LinkHasConnector_Names(CIMClient cimClient, boolean deep) {
	...
	public ArrayList getAssociated_CIM_PhysicalPackage_CIM_PackageInConnectors(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
	...
	public ArrayList getAssociated_CIM_PhysicalPackage_CIM_PackageInConnector_Names(CIMClient cimClient, boolean deep) {
