/** 
 * CIM_SpanningTreeServiceHelper.java
 *
...
public final class CIM_SpanningTreeServiceHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_SpanningTreeService.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SpanningTreeService.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_SpanningTreeService.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_SpanningTreeService.Java_Package_List.setElementAt((String)(CIM_SpanningTreeService.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SpanningTreeService.");
						resultArrayList.add(new CIM_SpanningTreeService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SpanningTreeService.");
						resultArrayList.add(new CIM_SpanningTreeService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SpanningTreeService.");
						resultArrayList.add(new CIM_SpanningTreeService(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SpanningTreeService getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SpanningTreeServiceHelper.getInstance(cimClient, new CIM_SpanningTreeService(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SpanningTreeService getInstance(CIMClient cimClient, CIM_SpanningTreeService dataInstance) {
		...
		return CIM_SpanningTreeServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SpanningTreeService getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SpanningTreeService dataInstance = null;
		try {
			dataInstance = new CIM_SpanningTreeService(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SpanningTreeService createInstance(CIMClient cimClient, CIM_SpanningTreeService dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SpanningTreeService newDataInstance = null;
		try {
			newDataInstance = CIM_SpanningTreeServiceHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SpanningTreeService modifyInstance(CIMClient cimClient, CIM_SpanningTreeService dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SpanningTreeServiceHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SpanningTreeService dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SpanningTreeService dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SpanningTreeService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SpanningTreeService.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SpanningTreeService.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SpanningTreeService.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SpanningTreeService.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_BridgeForwardDelay(UnsignedInt32 BridgeForwardDelay) {
		return true;
	}

	public static boolean isValid_BridgeHelloTime(UnsignedInt32 BridgeHelloTime) {
		return true;
	}

	public static boolean isValid_BridgeMaxAge(UnsignedInt32 BridgeMaxAge) {
		return true;
	}
	...
	public static boolean isValid_ForwardDelay(UnsignedInt32 ForwardDelay) {
		return true;
	}

	public static boolean isValid_HelloTime(UnsignedInt32 HelloTime) {
		return true;
	}

	public static boolean isValid_HoldTime(UnsignedInt32 HoldTime) {
		return true;
	}

	public static boolean isValid_MaxAge(UnsignedInt32 MaxAge) {
		return true;
	}

	public static boolean isValid_Priority(UnsignedInt16 Priority) {
		return true;
	}

	public static boolean isValid_ProtocolSpec(UnsignedInt16 ProtocolSpec) {
		return true;
	}

	public static boolean isValid_RootCost(UnsignedInt16 RootCost) {
		return true;
	}

	public static boolean isValid_RootPort(UnsignedInt16 RootPort) {
		return true;
	}

	public static boolean isValid_SpanningTreeBridgeAddress(String SpanningTreeBridgeAddress) {
		return true;
	}
