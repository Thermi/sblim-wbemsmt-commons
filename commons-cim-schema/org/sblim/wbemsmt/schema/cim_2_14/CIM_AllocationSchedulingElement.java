 ...
 * five new properties to support bandwidth-based scheduling. As is the case
 * with all subclasses of SchedulingElement, the input associated with an
 * instance of AllocationSchedulingElement is of one of two types: either a
...
public class CIM_AllocationSchedulingElement extends CIM_SchedulingElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AllocationSchedulingElement"; //$NON-NLS-1$
