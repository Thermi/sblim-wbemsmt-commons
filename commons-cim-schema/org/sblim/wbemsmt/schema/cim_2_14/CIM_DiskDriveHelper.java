...
public final class CIM_DiskDriveHelper {

	public final static String CIM_CLASS_NAME = "CIM_DiskDrive";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_DiskDrive.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DiskDrive.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_DiskDrive.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_DiskDrive.Java_Package_List.setElementAt((String)(CIM_DiskDrive.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_DiskDrive.Java_Package_List.get(i)) + cimClassName;
	...
	*/	
	public final static CIM_DiskDrive getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DiskDriveHelper.getInstance(cimClient, new CIM_DiskDrive(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiskDrive getInstance(CIMClient cimClient, CIM_DiskDrive dataInstance) {
		...
		return CIM_DiskDriveHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiskDrive getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_DiskDrive(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiskDrive createInstance(CIMClient cimClient, CIM_DiskDrive dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DiskDrive newDataInstance = null;
		try {
			newDataInstance = CIM_DiskDriveHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiskDrive modifyInstance(CIMClient cimClient, CIM_DiskDrive dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DiskDriveHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DiskDrive dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DiskDrive dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DiskDrive.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DiskDrive.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DiskDrive.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DiskDrive.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DiskDrive.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
