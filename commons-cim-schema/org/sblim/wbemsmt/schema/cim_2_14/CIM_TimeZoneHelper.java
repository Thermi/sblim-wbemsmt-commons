...
public final class CIM_TimeZoneHelper {

	public final static String CIM_CLASS_NAME = "CIM_TimeZone";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_TimeZone(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_TimeZone.Java_Package_List.size(); i++) {
						if (!((String)(CIM_TimeZone.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_TimeZone.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_TimeZone.Java_Package_List.setElementAt((String)(CIM_TimeZone.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_TimeZone.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_TimeZone.");
						resultArrayList.add(new CIM_TimeZone(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_TimeZone.");
						resultArrayList.add(new CIM_TimeZone(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_TimeZone.");
						resultArrayList.add(new CIM_TimeZone(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_TimeZone getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_TimeZoneHelper.getInstance(cimClient, new CIM_TimeZone(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_TimeZone getInstance(CIMClient cimClient, CIM_TimeZone dataInstance) {
		...
		return CIM_TimeZoneHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_TimeZone getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_TimeZone dataInstance = null;
		try {
			dataInstance = new CIM_TimeZone(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_TimeZone createInstance(CIMClient cimClient, CIM_TimeZone dataInstance, boolean notifyDifferencies){ 
		...
		CIM_TimeZone newDataInstance = null;
		try {
			newDataInstance = CIM_TimeZoneHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_TimeZone modifyInstance(CIMClient cimClient, CIM_TimeZone dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_TimeZoneHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_TimeZone dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_TimeZone dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_TimeZone.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_TimeZone.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_TimeZone.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_TimeZone.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_TimeZone.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DaylightCaption(String DaylightCaption) {
		return true;
	}

	public static boolean isValid_DaylightDay(Byte DaylightDay) {
		return true;
	}

	public static boolean isValid_DaylightDayOfWeek(Byte DaylightDayOfWeek) {
		return true;
	}

	public static boolean isValid_DaylightMonth(UnsignedInt8 DaylightMonth) {
		return true;
	}

	public static boolean isValid_DaylightName(String DaylightName) {
		return true;
	}

	public static boolean isValid_DaylightOffset(Integer DaylightOffset) {
		return true;
	}

	public static boolean isValid_DaylightStartInterval(Calendar DaylightStartInterval) {
		return true;
	}

	public static boolean isValid_StandardCaption(String StandardCaption) {
		return true;
	}

	public static boolean isValid_StandardDay(Byte StandardDay) {
		return true;
	}

	public static boolean isValid_StandardDayOfWeek(Byte StandardDayOfWeek) {
		return true;
	}

	public static boolean isValid_StandardMonth(UnsignedInt8 StandardMonth) {
		return true;
	}

	public static boolean isValid_StandardName(String StandardName) {
		return true;
	}

	public static boolean isValid_StandardOffset(Integer StandardOffset) {
		return true;
	}

	public static boolean isValid_StandardStartInterval(Calendar StandardStartInterval) {
		return true;
	}

	public static boolean isValid_TimeZoneID(String TimeZoneID) {
		return true;
	}

	public static boolean isValid_TimeZoneStartDate(Calendar TimeZoneStartDate) {
		return true;
	}
