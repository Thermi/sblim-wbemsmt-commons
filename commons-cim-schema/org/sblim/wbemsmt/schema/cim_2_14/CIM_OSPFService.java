 ...
 *
 *
 * Description:  This class is used to represent the basic operation of OSPF. It is derived from
 * the RouteCalculationService, the superclass of all routing protocols.
 * 
 */
...
/**
 *  This class is used to represent the basic operation of OSPF. It is derived from
 * the RouteCalculationService, the superclass of all routing protocols.
 */
public class CIM_OSPFService extends CIM_RouteCalculationService  {
	
	public final static String CIM_CLASS_NAME = "CIM_OSPFService"; //$NON-NLS-1$
