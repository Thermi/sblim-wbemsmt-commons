 ...
 *
 *
 * Description:  Deprecated - use CIM_ProtectedExtentBasedOn or CIM_CompositeExtentBasedOn
 * instead. The information on check and user data is better expressed in the
 * association that layers the storage, than in the extent itself. A
 * ProtectedSpaceExtent is used to model an SCC RAID implementation.
 * ProtectedSpaceExtent defines addressable logical block addresses, treated as
 * a single Extent, located on one or more PhysicalExtents.
 * ProtectedSpaceExtents exclude any logical blocks mapped as check data and
 * contain user data stripe depth mapping information. An alternate possibility,
 * if automatic configuration is used, is to instantiate or extend the
 * AggregatePSExtent class.
 * 
 */
...
/**
 *  Deprecated - use CIM_ProtectedExtentBasedOn or CIM_CompositeExtentBasedOn
 * instead. The information on check and user data is better expressed in the
 * association that layers the storage, than in the extent itself. A
 * ProtectedSpaceExtent is used to model an SCC RAID implementation.
 * ProtectedSpaceExtent defines addressable logical block addresses, treated as
...
public class CIM_ProtectedSpaceExtent extends CIM_StorageExtent  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ProtectedSpaceExtent"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.7.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_PSEXTENTBASEDONPEXTENT = "CIM_PSExtentBasedOnPExtent"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_VOLUMESETBASEDONPSEXTENT = "CIM_VolumeSetBasedOnPSExtent"; //$NON-NLS-1$
