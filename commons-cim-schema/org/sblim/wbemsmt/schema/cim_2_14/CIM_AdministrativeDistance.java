 ...
 *
 *
 * Description:  Information in this class affects the choice of one protocol over another, when
 * two protocols learn the same route. Properties define the preference of a
 * protocol, called its distance. The lower the distance, the higher the
 * preference for that protocol. This class affects ALL routes and contains the
 * default distances. Specific administrative distances relative to an
 ...
 * that contains it. Hence, the AdminDomain keys are propagated to this class.
 * 
 */
...
/**
 *  Information in this class affects the choice of one protocol over another, when
 * two protocols learn the same route. Properties define the preference of a
 * protocol, called its distance. The lower the distance, the higher the
 * preference for that protocol. This class affects ALL routes and contains the
 * default distances. Specific administrative distances relative to an
...
public class CIM_AdministrativeDistance extends CIM_LogicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AdministrativeDistance"; //$NON-NLS-1$
