...
public class CIM_ElementCapabilities  {
	...
	public final static String CIM_PROPERTY_CIM_CAPABILITIES = "Capabilities"; //$NON-NLS-1$
	...
	*	Class constructor
	*/	
	public CIM_ElementCapabilities() {
	...
	*	Class constructor
	*/	
	public CIM_ElementCapabilities(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_ElementCapabilities(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_ElementCapabilities.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_ElementCapabilities.Java_Package_List.toArray(new String[CIM_ElementCapabilities.Java_Package_List.size()]);
    }
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (this.cimInstance == null && ((CIM_ElementCapabilities)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_ElementCapabilities)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_ElementCapabilities)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_ElementCapabilities)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_ElementCapabilities)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_ElementCapabilities)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_ElementCapabilities)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_ElementCapabilities)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_ElementCapabilities)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public CIMObjectPath get_CIM_ManagedElement() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_ElementCapabilities.CIM_PROPERTY_CIM_MANAGEDELEMENT);
	...
	public CIMObjectPath get_CIM_Capabilities() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_ElementCapabilities.CIM_PROPERTY_CIM_CAPABILITIES);
