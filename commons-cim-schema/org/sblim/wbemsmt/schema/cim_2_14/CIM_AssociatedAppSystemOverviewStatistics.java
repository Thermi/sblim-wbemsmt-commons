...
public class CIM_AssociatedAppSystemOverviewStatistics extends CIM_ElementStatisticalData  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AssociatedAppSystemOverviewStatistics"; //$NON-NLS-1$
	...
	static {
		...
		for (int i = 0; i < CIM_ElementStatisticalData.Java_Package_List.size(); i++) {
			if (((String)CIM_ElementStatisticalData.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
