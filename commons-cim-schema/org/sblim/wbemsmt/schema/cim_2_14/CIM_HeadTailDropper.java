 ...
 *
 *
 * Description:  HeadTailDropper describes the threshold information of a head or tail dropper.
 * The inherited property DropFrom indicates whether a particular instance of
 * this class is a head dropper or a tail dropper. A head dropper always
 * examines the same queue from which it drops packets, and this queue is always
...
/**
 *  HeadTailDropper describes the threshold information of a head or tail dropper.
 * The inherited property DropFrom indicates whether a particular instance of
 * this class is a head dropper or a tail dropper. A head dropper always
 * examines the same queue from which it drops packets, and this queue is always
 * related to the dropper as the following service in the NextService
...
public class CIM_HeadTailDropper extends CIM_DropperService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_HeadTailDropper"; //$NON-NLS-1$
