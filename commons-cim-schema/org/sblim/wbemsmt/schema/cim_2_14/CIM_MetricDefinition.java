 ...
 *
 *
 * Description:  The metrics that are associated with a UnitOfWork. These metrics usually
 * describe some aspect of a UnitOfWork such as how much work was done, or the
 * size of the UnitOfWork. For example, the size of a print job or the number of
 * pages printed could be metrics of a 'print' UnitOfWork.
 * 
 */
...
/**
 *  The metrics that are associated with a UnitOfWork. These metrics usually
 * describe some aspect of a UnitOfWork such as how much work was done, or the
 * size of the UnitOfWork. For example, the size of a print job or the number of
 * pages printed could be metrics of a 'print' UnitOfWork.
 */
public class CIM_MetricDefinition extends CIM_BaseMetricDefinition  {
	...
	public final static String CIM_CLASS_NAME = "CIM_MetricDefinition"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_UOWMETRICDEFINITION = "CIM_UoWMetricDefinition"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_BaseMetricDefinition.Java_Package_List.size(); i++) {
			if (((String)CIM_BaseMetricDefinition.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
