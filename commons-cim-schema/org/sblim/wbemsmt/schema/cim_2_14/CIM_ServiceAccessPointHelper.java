...
public final class CIM_ServiceAccessPointHelper {
	...
	*/	
	public final static CIM_ServiceAccessPoint getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ServiceAccessPointHelper.getInstance(cimClient, new CIM_ServiceAccessPoint(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ServiceAccessPoint getInstance(CIMClient cimClient, CIM_ServiceAccessPoint dataInstance) {
		...
		return CIM_ServiceAccessPointHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ServiceAccessPoint getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_ServiceAccessPoint(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ServiceAccessPoint.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ServiceAccessPoint.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ServiceAccessPoint.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ServiceAccessPoint.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
