 ...
 *
 *
 * Description:  PRS_ServiceIncident contains the fundamental information related to a specific
 * incident: its identity, status, priority, etc. The actual incident data,
 * including specific transactions and resolution information, is contained in
 * the objects associated with PRS_ServiceIncident. These include specific
 * Problem, Resolution and Activity related objects accrued through the
...
/**
 *  PRS_ServiceIncident contains the fundamental information related to a specific
 * incident: its identity, status, priority, etc. The actual incident data,
 * including specific transactions and resolution information, is contained in
 * the objects associated with PRS_ServiceIncident. These include specific
 * Problem, Resolution and Activity related objects accrued through the
...
public class PRS_ServiceIncident extends PRS_ExchangeElement  {
	...
	public final static String CIM_CLASS_NAME = "PRS_ServiceIncident"; //$NON-NLS-1$
