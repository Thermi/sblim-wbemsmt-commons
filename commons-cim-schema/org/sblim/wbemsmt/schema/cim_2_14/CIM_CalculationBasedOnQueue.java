 ...
 *
 *
 * Description:  This association establishes a dependency relationship between a QueuingService
 * and an instance of the DropThresholdCalculationService class. The queue's
 * current depth is used by the CalculationService in calculating an
...
/**
 *  This association establishes a dependency relationship between a QueuingService
 * and an instance of the DropThresholdCalculationService class. The queue's
 * current depth is used by the CalculationService in calculating an
 * average/smoothed queue depth.
 */
public class CIM_CalculationBasedOnQueue extends CIM_ServiceServiceDependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_CalculationBasedOnQueue"; //$NON-NLS-1$
