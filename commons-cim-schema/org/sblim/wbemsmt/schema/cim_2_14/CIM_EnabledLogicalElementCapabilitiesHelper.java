...
public class CIM_EnabledLogicalElementCapabilitiesHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(
                CIM_EnabledLogicalElementCapabilities.CIM_CLASS_NAME, AbstractWbemsmtFcoHelper
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_EnabledLogicalElementCapabilities.CIM_CLASS_NAME
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    Class clazz = CIM_EnabledLogicalElementCapabilitiesHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_EnabledLogicalElementCapabilities.");
                        resultArrayList.add(new CIM_EnabledLogicalElementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_EnabledLogicalElementCapabilities.");
                        resultArrayList.add(new CIM_EnabledLogicalElementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_EnabledLogicalElementCapabilities.");
                        resultArrayList.add(new CIM_EnabledLogicalElementCapabilities(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_EnabledLogicalElementCapabilities getInstance(WBEMClient client,
    ...
    public final static CIM_EnabledLogicalElementCapabilities getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_EnabledLogicalElementCapabilities.PROPERTY_INSTANCEID.NAME,
     ...
     *
     */
    public final static CIM_EnabledLogicalElementCapabilities createInstance(WBEMClient client,
            CIM_EnabledLogicalElementCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_EnabledLogicalElementCapabilities newDataInstance = CIM_EnabledLogicalElementCapabilitiesHelper
     ...
     */
    public final static CIM_EnabledLogicalElementCapabilities modifyInstance(WBEMClient client,
            CIM_EnabledLogicalElementCapabilities dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_EnabledLogicalElementCapabilities dataInstance2 = CIM_EnabledLogicalElementCapabilitiesHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_EnabledLogicalElementCapabilities dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_EnabledLogicalElementCapabilities.getPackages());
    }
