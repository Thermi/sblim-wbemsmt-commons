 ...
 *
 *
 * Description:  PRS_Product is used to describe a single product to associate with a
 * PRS_Expression.
 * 
 */
...
public class PRS_Product extends PRS_ExpressionElement  {
	...
	public final static String CIM_CLASS_NAME = "PRS_Product"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.6.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_PRS_PRODUCTASSET = "PRS_ProductAsset"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_PRS_PRODUCTCOMPONENT = "PRS_ProductComponent"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_PRS_PRODUCTPARENTCHILD = "PRS_ProductParentChild"; //$NON-NLS-1$
