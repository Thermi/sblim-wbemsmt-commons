 ...
 *
 *
 * Description:  CIM_CredentialManagementSAP represents the ability to utilize or invoke a
...
/**
 *  CIM_CredentialManagementSAP represents the ability to utilize or invoke a
 * CredentialManagementService.
 */
public class CIM_CredentialManagementSAP extends CIM_ServiceAccessPoint  {
	
	public final static String CIM_CLASS_NAME = "CIM_CredentialManagementSAP"; //$NON-NLS-1$
