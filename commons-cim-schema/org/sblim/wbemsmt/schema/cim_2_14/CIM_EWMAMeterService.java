 ...
 *
 *
 * Description:  This is a concrete subclass of the MeterService class that represents an
 * exponentially weighted moving average meter. This meter is a simple low-pass
 * filter that measures the rate of incoming packets over a small, fixed
 * sampling interval. Any admitted packet that pushes the average rate over a
...
public class CIM_EWMAMeterService extends CIM_MeterService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_EWMAMeterService"; //$NON-NLS-1$
