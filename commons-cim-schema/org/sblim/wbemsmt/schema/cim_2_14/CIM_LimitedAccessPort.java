 ...
 *
 *
 * Description:  LimitedAccessPorts represent hardware that transports Physical Media into or
 * out of a System, such as a StorageLibrary. They are identified as 'limited'
 * since these Ports do not provide access to ALL the PhysicalMedia or
 * StorageMediaLocations in a Library, but only to a subset.
 * 
 */
...
/**
 *  LimitedAccessPorts represent hardware that transports Physical Media into or
 * out of a System, such as a StorageLibrary. They are identified as 'limited'
 * since these Ports do not provide access to ALL the PhysicalMedia or
 * StorageMediaLocations in a Library, but only to a subset.
 */
public class CIM_LimitedAccessPort extends CIM_MediaTransferDevice  {
	...
	public final static String CIM_CLASS_NAME = "CIM_LimitedAccessPort"; //$NON-NLS-1$
