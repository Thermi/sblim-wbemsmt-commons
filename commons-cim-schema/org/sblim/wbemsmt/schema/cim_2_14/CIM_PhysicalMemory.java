...
BRAM is also known as Block RAM
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_Chip.Java_Package_List.size(); i++) {
			if (((String)CIM_Chip.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
			
			Java_Package_List.add(CIM_Chip.Java_Package_List.elementAt(i));
		}
	};
			
	public final static String[] CIM_VALUEMAP_MEMORYTYPE = {"Unknown","Other","DRAM","Synchronous DRAM","Cache DRAM","EDO","EDRAM","VRAM","SRAM","RAM","ROM","Flash","EEPROM","FEPROM","EPROM","CDRAM","3DRAM","SDRAM","SGRAM","RDRAM","DDR","DDR-2","BRAM","FB-DIMM","DMTF Reserved","Vendor Reserved"};
	...
	public final static String MEMORYTYPE_DDR_2 = "21";
