...
public class CIM_HostedAccessPointHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_HostedAccessPoint.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_HostedAccessPoint.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_HostedAccessPoint.CIM_CLASS_NAME)) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_HostedAccessPoint.");
                        resultArrayList.add(new CIM_HostedAccessPoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_HostedAccessPoint.");
                        resultArrayList.add(new CIM_HostedAccessPoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_HostedAccessPoint.");
                        resultArrayList.add(new CIM_HostedAccessPoint(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_HostedAccessPoint getInstance(WBEMClient client,
     ...
     */
    public final static CIM_HostedAccessPoint getInstance(WBEMClient client, CIMInstance cimInstance)
            throws WbemsmtException {
    ...
    public final static CIM_HostedAccessPoint getInstance(WBEMClient client, String namespace,
            CIM_System Antecedent, CIM_ServiceAccessPoint Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_HostedAccessPoint.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME, new CIMDataType(
        ...
        keyProperties[1] = new CIMProperty(
                CIM_HostedAccessPoint.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,
     ...
     *
     */
    public final static CIM_HostedAccessPoint createInstance(WBEMClient client,
            CIM_HostedAccessPoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        CIM_HostedAccessPoint newDataInstance = CIM_HostedAccessPointHelper.getInstance(client,
                cimObjectPath);
     ...
     */
    public final static CIM_HostedAccessPoint modifyInstance(WBEMClient client,
            CIM_HostedAccessPoint dataInstance, boolean notifyDifferencies) throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_HostedAccessPoint dataInstance2 = CIM_HostedAccessPointHelper.getInstance(client,
     ...
     * @param dataInstance the FCO to create
     */
    public final static void deleteInstance(WBEMClient client, CIM_HostedAccessPoint dataInstance)
            throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_HostedAccessPoint.getPackages());
    }
