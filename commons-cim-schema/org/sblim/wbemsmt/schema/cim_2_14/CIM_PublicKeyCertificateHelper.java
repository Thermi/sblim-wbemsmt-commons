/** 
 * CIM_PublicKeyCertificateHelper.java
 *
...
public final class CIM_PublicKeyCertificateHelper {
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_PublicKeyCertificate.");
						resultArrayList.add(new CIM_PublicKeyCertificate(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_PublicKeyCertificate.");
						resultArrayList.add(new CIM_PublicKeyCertificate(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_PublicKeyCertificate.");
						resultArrayList.add(new CIM_PublicKeyCertificate(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_PublicKeyCertificate getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_PublicKeyCertificateHelper.getInstance(cimClient, new CIM_PublicKeyCertificate(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PublicKeyCertificate getInstance(CIMClient cimClient, CIM_PublicKeyCertificate dataInstance) {
		...
		return CIM_PublicKeyCertificateHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_PublicKeyCertificate getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_PublicKeyCertificate dataInstance = null;
		try {
			dataInstance = new CIM_PublicKeyCertificate(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PublicKeyCertificate createInstance(CIMClient cimClient, CIM_PublicKeyCertificate dataInstance, boolean notifyDifferencies){ 
		...
		CIM_PublicKeyCertificate newDataInstance = null;
		try {
			newDataInstance = CIM_PublicKeyCertificateHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_PublicKeyCertificate modifyInstance(CIMClient cimClient, CIM_PublicKeyCertificate dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_PublicKeyCertificateHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_PublicKeyCertificate dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_PublicKeyCertificate dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_PublicKeyCertificate.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_PublicKeyCertificate.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_PublicKeyCertificate.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_PublicKeyCertificate.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_PublicKeyCertificate.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_AltSubject(String AltSubject) {
		return true;
	}

	public static boolean isValid_PublicKey(UnsignedInt8[] PublicKey) {
		return true;
	}
	...
	public static boolean isValid_Subject(String Subject) {
		return true;
	}
