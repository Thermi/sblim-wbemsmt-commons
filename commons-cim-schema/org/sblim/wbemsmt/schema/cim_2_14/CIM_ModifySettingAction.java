 ...
 *
 *
 * Description:  This class specifies the information used to modify a 'setting' file, for a
 * specific entry in the file. The new 'setting' value is created as a new entry
 * or appends to, replaces, removes from, or deletes the specified entry. All
 * additions are assumed to be case sensitive. Removes are assumed to be case
 * insensitive.
 * 
 */
...
/**
 *  This class specifies the information used to modify a 'setting' file, for a
 * specific entry in the file. The new 'setting' value is created as a new entry
 * or appends to, replaces, removes from, or deletes the specified entry. All
 * additions are assumed to be case sensitive. Removes are assumed to be case
 * insensitive.
...
public class CIM_ModifySettingAction extends CIM_Action  {
	...
	public final static String CIM_CLASS_NAME = "CIM_ModifySettingAction"; //$NON-NLS-1$
