...
public final class CIM_RegisteredSubProfileHelper {
	...
	*/	
	public final static CIM_RegisteredSubProfile getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_RegisteredSubProfileHelper.getInstance(cimClient, new CIM_RegisteredSubProfile(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RegisteredSubProfile getInstance(CIMClient cimClient, CIM_RegisteredSubProfile dataInstance) {
		...
		return CIM_RegisteredSubProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_RegisteredSubProfile getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		try {
			dataInstance = new CIM_RegisteredSubProfile(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	public static Class findClass(CIMClient cimClient, CIMInstance cimInstance) {
		...
		String[] packageList = CIM_RegisteredSubProfile.getPackages();
	...
	*/	
	public final static CIM_RegisteredSubProfile createInstance(CIMClient cimClient, CIM_RegisteredSubProfile dataInstance, boolean notifyDifferencies){ 
		...
		CIM_RegisteredSubProfile newDataInstance = null;
		try {
			newDataInstance = CIM_RegisteredSubProfileHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_RegisteredSubProfile modifyInstance(CIMClient cimClient, CIM_RegisteredSubProfile dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_RegisteredSubProfileHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_RegisteredSubProfile dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_RegisteredSubProfile dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_RegisteredSubProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_RegisteredSubProfile.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_RegisteredSubProfile.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_RegisteredSubProfile.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_RegisteredSubProfile.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
