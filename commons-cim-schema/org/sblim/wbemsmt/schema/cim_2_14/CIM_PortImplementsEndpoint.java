...
public class CIM_PortImplementsEndpoint extends CIM_DeviceSAPImplementation  {
	...
	static {
		...
		for (int i = 0; i < CIM_DeviceSAPImplementation.Java_Package_List.size(); i++) {
			if (((String)CIM_DeviceSAPImplementation.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
			
			Java_Package_List.add(CIM_DeviceSAPImplementation.Java_Package_List.elementAt(i));
		}
	};
