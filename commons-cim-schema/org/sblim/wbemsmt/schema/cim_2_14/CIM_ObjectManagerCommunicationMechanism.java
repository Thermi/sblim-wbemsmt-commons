...
public class CIM_ObjectManagerCommunicationMechanism extends CIM_ServiceAccessPoint {
    ...
    public static class PROPERTY_ADVERTISETYPES {
         ...
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@4dca4dca
    ...
    public static class PROPERTY_AUTHENTICATIONMECHANISMSSUPPORTED {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@1920192
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public static class PROPERTY_COMMUNICATIONMECHANISM {
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_3_FOR_VALUE_ENTRY_SM_CLP = new javax.cim.UnsignedInteger16(
                "3");
        ...
        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_4_FOR_VALUE_ENTRY_WS_Management = new javax.cim.UnsignedInteger16(
                "4");

        /**
         * constant for value entry WS-Management (corresponds to mapEntry 4 )
         */
        public final static String VALUE_ENTRY_WS_Management = "WS-Management";

        /**
         * constant for value map entry 5
         */

        public final static javax.cim.UnsignedInteger16 VALUE_MAP_ENTRY_5_FOR_VALUE_ENTRY_WSDM = new javax.cim.UnsignedInteger16(
                "5");

        /**
         * constant for value entry WSDM (corresponds to mapEntry 5 )
         */
        public final static String VALUE_ENTRY_WSDM = "WSDM";
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@78b878b8
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
         ...
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_Unknown, VALUE_ENTRY_Other,
                VALUE_ENTRY_CIM_XML, VALUE_ENTRY_SM_CLP, VALUE_ENTRY_WS_Management,
                VALUE_ENTRY_WSDM };
         ...
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_Unknown,
                VALUE_ENTRY_Other, VALUE_ENTRY_CIM_XML, VALUE_ENTRY_SM_CLP,
                VALUE_ENTRY_WS_Management, VALUE_ENTRY_WSDM };
    ...
    public static class PROPERTY_FUNCTIONALPROFILESSUPPORTED {
         ...
         * @return the ValueMap entry or null if not found
         */
        //org.sblim.wbemsmt.dcg.generator.DCGContextUtil$Wrapper@3ee23ee2
        public static javax.cim.UnsignedInteger16 getValueMapEntry(String value) {
    ...
    public boolean set_AuthenticationMechanismDescriptions(String[] newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_AUTHENTICATIONMECHANISMDESCRIPTIONS.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_AuthenticationMechanismDescriptions(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public boolean set_AuthenticationMechanismsSupported(javax.cim.UnsignedInteger16[] newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_AUTHENTICATIONMECHANISMSSUPPORTED.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_AuthenticationMechanismsSupported(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public boolean set_OtherCommunicationMechanismDescription(String newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_OTHERCOMMUNICATIONMECHANISMDESCRIPTION.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_OtherCommunicationMechanismDescription(currentProperty,
                    newValue));
            return true;
        }
        else {
