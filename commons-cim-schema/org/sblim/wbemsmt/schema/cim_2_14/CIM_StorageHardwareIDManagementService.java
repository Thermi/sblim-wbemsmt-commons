 ...
 *
 *
 * Description:  StorageHardwareIDManagementService provides methods for manipulating instances
 * of StorageHardwareIDs and manipulating the trust of these IDs in the
...
/**
 *  StorageHardwareIDManagementService provides methods for manipulating instances
 * of StorageHardwareIDs and manipulating the trust of these IDs in the
 * underlying storage system.
 */
public class CIM_StorageHardwareIDManagementService extends CIM_AuthenticationService  {
	
	public final static String CIM_CLASS_NAME = "CIM_StorageHardwareIDManagementService"; //$NON-NLS-1$
