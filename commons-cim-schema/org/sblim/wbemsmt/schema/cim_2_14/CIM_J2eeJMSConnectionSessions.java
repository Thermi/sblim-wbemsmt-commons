 ...
 *
 *
 * Description:  CIM_J2eeJMSConnectionSessions identifies the JMS session statistics that are
 * associated with the referencing JMS connection statistics.
 * 
 */
...
/**
 *  CIM_J2eeJMSConnectionSessions identifies the JMS session statistics that are
 * associated with the referencing JMS connection statistics.
 */
public class CIM_J2eeJMSConnectionSessions extends CIM_RelatedStatisticalData  {
	
	public final static String CIM_CLASS_NAME = "CIM_J2eeJMSConnectionSessions"; //$NON-NLS-1$
