...
public final class CIM_DiagnosticTestHelper {
	...
	*/	
	...
	public static boolean isValid_OtherTestTypesDescriptions(String[] OtherTestTypesDescriptions) {
		return true;
	}
	...
	public static boolean isValid_TestTypes(UnsignedInt16[] TestTypes) {
		return true;
	}
