 ...
 *
 *
 * Description:  This is an abstract base class, derived from Service, that represents the route
 * calculation aspects of a system. This class also addresses functions
 * performed by the system when it exchanges routing information. Examining the
 * RouteCalculationService class definition, note that its superclass
 * NetworkService is deprecated. Therefore, NetworkService's properties need not
 * be implemented in an instance of RouteCalculationService. Unfortunately,
 ...
 * removed, and RouteCalculationService will subclass from CIM_Service directly.
 * Also note that there are a large number of additional routing protocols that
 * are not currently modeled. These will be added over time.
 * 
 */
...
/**
 *  This is an abstract base class, derived from Service, that represents the route
 * calculation aspects of a system. This class also addresses functions
 * performed by the system when it exchanges routing information. Examining the
 * RouteCalculationService class definition, note that its superclass
 * NetworkService is deprecated. Therefore, NetworkService's properties need not
...
public class CIM_RouteCalculationService extends CIM_NetworkService  {
	...
	public final static String CIM_CLASS_NAME = "CIM_RouteCalculationService"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDROUTINGSERVICES = "CIM_HostedRoutingServices"; //$NON-NLS-1$
