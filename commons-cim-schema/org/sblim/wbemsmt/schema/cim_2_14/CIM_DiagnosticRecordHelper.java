/** 
 * CIM_DiagnosticRecordHelper.java
 *
...
public final class CIM_DiagnosticRecordHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_DiagnosticRecord.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DiagnosticRecord.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_DiagnosticRecord.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_DiagnosticRecord.Java_Package_List.setElementAt((String)(CIM_DiagnosticRecord.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DiagnosticRecord.");
						resultArrayList.add(new CIM_DiagnosticRecord(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DiagnosticRecord.");
						resultArrayList.add(new CIM_DiagnosticRecord(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DiagnosticRecord.");
						resultArrayList.add(new CIM_DiagnosticRecord(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DiagnosticRecord getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DiagnosticRecordHelper.getInstance(cimClient, new CIM_DiagnosticRecord(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticRecord getInstance(CIMClient cimClient, CIM_DiagnosticRecord dataInstance) {
		...
		return CIM_DiagnosticRecordHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticRecord getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DiagnosticRecord dataInstance = null;
		try {
			dataInstance = new CIM_DiagnosticRecord(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticRecord createInstance(CIMClient cimClient, CIM_DiagnosticRecord dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DiagnosticRecord newDataInstance = null;
		try {
			newDataInstance = CIM_DiagnosticRecordHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticRecord modifyInstance(CIMClient cimClient, CIM_DiagnosticRecord dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DiagnosticRecordHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DiagnosticRecord dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DiagnosticRecord dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DiagnosticRecord.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DiagnosticRecord.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DiagnosticRecord.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DiagnosticRecord.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DiagnosticRecord.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_CreationTimeStamp(Calendar CreationTimeStamp) {
		return true;
	}

	public static boolean isValid_ExpirationDate(Calendar ExpirationDate) {
		return true;
	}
	...
	public static boolean isValid_ManagedElementName(String ManagedElementName) {
		return true;
	}

	public static boolean isValid_OtherRecordTypeDescription(String OtherRecordTypeDescription) {
		return true;
	}

	public static boolean isValid_RecordType(UnsignedInt16 RecordType) {
		return true;
	}
