...
public class CIM_ElementSoftwareIdentityHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_ElementSoftwareIdentity.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_ElementSoftwareIdentity.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                    ...
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        ...
                                        + " was not found. Constructing instance of class CIM_ElementSoftwareIdentity.");
                        resultArrayList.add(new CIM_ElementSoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_ElementSoftwareIdentity.");
                        resultArrayList.add(new CIM_ElementSoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_ElementSoftwareIdentity.");
                        resultArrayList.add(new CIM_ElementSoftwareIdentity(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_ElementSoftwareIdentity getInstance(WBEMClient client,
     ...
     */
    public final static CIM_ElementSoftwareIdentity getInstance(WBEMClient client,
            String namespace, CIM_SoftwareIdentity Antecedent, CIM_ManagedElement Dependent
        ...
        keyProperties[0] = new CIMProperty(
                CIM_ElementSoftwareIdentity.PROPERTY_ANTECEDENT_CIM_SOFTWAREIDENTITY.NAME,
        ...
        keyProperties[1] = new CIMProperty(
                CIM_ElementSoftwareIdentity.PROPERTY_DEPENDENT_CIM_MANAGEDELEMENT.NAME,
     ...
     *
     */
    public final static CIM_ElementSoftwareIdentity createInstance(WBEMClient client,
            CIM_ElementSoftwareIdentity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_ElementSoftwareIdentity newDataInstance = CIM_ElementSoftwareIdentityHelper
     ...
     */
    public final static CIM_ElementSoftwareIdentity modifyInstance(WBEMClient client,
            CIM_ElementSoftwareIdentity dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_ElementSoftwareIdentity dataInstance2 = CIM_ElementSoftwareIdentityHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_ElementSoftwareIdentity dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_ElementSoftwareIdentity.getPackages());
    }
