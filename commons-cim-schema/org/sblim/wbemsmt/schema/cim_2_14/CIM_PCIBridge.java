 ...
 *
 *
 * Description:  Capabilities and management of a PCI controller that provide bridge-to-bridge
 * capability.
 * 
 */
...
/**
 *  Capabilities and management of a PCI controller that provide bridge-to-bridge
 * capability.
 */
public class CIM_PCIBridge extends CIM_PCIController  {
	
	public final static String CIM_CLASS_NAME = "CIM_PCIBridge"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_PCIController.Java_Package_List.size(); i++) {
			if (((String)CIM_PCIController.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
