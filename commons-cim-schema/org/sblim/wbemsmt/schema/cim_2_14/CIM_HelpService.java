 ...
 *
 *
 * Description:  HelpService provides the ability for a managed element to describe and provide
 * access to its Help information. Support for various delivery mechanisms and
 * data formats can be specified so that the most suitable data representation
 * can be chosen. In adddition, a request can be made to launch a "Help"
...
/**
 *  HelpService provides the ability for a managed element to describe and provide
 * access to its Help information. Support for various delivery mechanisms and
 * data formats can be specified so that the most suitable data representation
 * can be chosen. In adddition, a request can be made to launch a "Help"
 * program, if available.
...
public class CIM_HelpService extends CIM_Service  {
	...
	public final static String CIM_CLASS_NAME = "CIM_HelpService"; //$NON-NLS-1$
