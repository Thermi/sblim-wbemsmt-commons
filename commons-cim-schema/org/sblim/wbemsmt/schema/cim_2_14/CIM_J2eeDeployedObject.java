 ...
 *
 *
 * Description:  The CIM_J2eeDeployedObject class is an abstract class that is used to define
 * CIM_J2eeModule objects that are deployed in the CIM_J2eeServer. The Deployed
 * Objects are hosted by a J2ee Server and should hence be associated to a
 * J2eeServer instance through the CIM_HostedService association. The scoping
 * keys in the instance are provided by the J2eeServer hosting the deployed
 * object.
 * 
 */
...
/**
 *  The CIM_J2eeDeployedObject class is an abstract class that is used to define
 * CIM_J2eeModule objects that are deployed in the CIM_J2eeServer. The Deployed
 * Objects are hosted by a J2ee Server and should hence be associated to a
 * J2eeServer instance through the CIM_HostedService association. The scoping
 * keys in the instance are provided by the J2eeServer hosting the deployed
...
public class CIM_J2eeDeployedObject extends CIM_Service  {
	...
	public final static String CIM_CLASS_NAME = "CIM_J2eeDeployedObject"; //$NON-NLS-1$
