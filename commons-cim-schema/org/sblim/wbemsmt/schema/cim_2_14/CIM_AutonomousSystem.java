 ...
 *
 *
 * Description:  An Autonomous System (AS) is a fundamental concept in networking. An AS
 * provides a structured view of routing by segregating the system that is using
 * routing (e.g., the Internet, or an extranet) into a set of separately
 * administered domains that each have their own independent routing policies.
 * These domains are called autonomous systems. The classic definition of an AS,
 ...
 * packets to other ASs'. The RFC continues: 'Since this classic definition was
 * developed, it has become common for a single AS to use several interior
 * gateway protocols and sometimes several sets of metrics within an AS. The use
 * of the term Autonomous System here stresses the fact that, even when multiple
 * IGPs and metrics are used, the administration of an AS appears to other ASs
 * to have a single coherent interior routing plan and presents a consistent
...
public class CIM_AutonomousSystem extends CIM_AdminDomain  {
	...
	public final static String CIM_CLASS_NAME = "CIM_AutonomousSystem"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_CONFEDERATION = "CIM_Confederation"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBGPATTRIBUTES = "CIM_HostedBGPAttributes"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBGPPEERGROUP = "CIM_HostedBGPPeerGroup"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_HOSTEDBGPROUTEMAP = "CIM_HostedBGPRouteMap"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ROUTERSINAS = "CIM_RoutersInAS"; //$NON-NLS-1$
