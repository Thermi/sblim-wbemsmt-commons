 ...
 *
 *
 * Description:  The CIM_DiagnosticService class provides the ability to start a service that
 * functions to participate in a problem determination process. Specific
 * diagnostic services SHOULD be defined by subclassing this class. Examples of
 * a diagnostic service are tests, information retrievers, exercisers, and ports
 * to external executives.
 * 
 */
...
/**
 *  The CIM_DiagnosticService class provides the ability to start a service that
 * functions to participate in a problem determination process. Specific
 * diagnostic services SHOULD be defined by subclassing this class. Examples of
 * a diagnostic service are tests, information retrievers, exercisers, and ports
 * to external executives.
...
public class CIM_DiagnosticService extends CIM_Service  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DiagnosticService"; //$NON-NLS-1$
