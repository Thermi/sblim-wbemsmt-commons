 ...
 *
 *
 * Description:  This class represents the OSPF configuration of an interface running OSPF. The
 * instance of this class should be connected to an IPProtocolEndpoint instance
 * via a BindsTo association. The IPProtocolEndpoint instance is the Antecedent
 * and the OSPFProtocolEndpoint instance is the Dependent in the BindsTo
 * association.
 * 
 */
...
/**
 *  This class represents the OSPF configuration of an interface running OSPF. The
 * instance of this class should be connected to an IPProtocolEndpoint instance
 * via a BindsTo association. The IPProtocolEndpoint instance is the Antecedent
 * and the OSPFProtocolEndpoint instance is the Dependent in the BindsTo
 * association.
...
public class CIM_OSPFProtocolEndpoint extends CIM_OSPFProtocolEndpointBase  {
	...
	public final static String CIM_CLASS_NAME = "CIM_OSPFProtocolEndpoint"; //$NON-NLS-1$
