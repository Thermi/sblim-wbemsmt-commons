 ...
 *
 *
 * Description:  PRS_Administrative defines administrative information about associated objects.
 * There must be at least one PRS_Administrative instance associated with a
 * PRS_Solution. Administrative information is inherited from a parent object.
 * If the administrative information among objects within a Solution is not the
 * same, additional PRS_Administrative instances may be associated with other
 * objects within the Solution. All instances under a specific parent inherit
 * their administrative information unless there is an PRS_Administrative
 * instance associated with that instance. For example, if there is a
 * PRS_Administrative instance associated with a PRS_Problem instance, all of
 * the PRS_Statement and PRS_ Product instances within the Problem use the same
 * Administrative information as the PRS_Problem instance.
 * 
 */
...
/**
 *  PRS_Administrative defines administrative information about associated objects.
 * There must be at least one PRS_Administrative instance associated with a
 * PRS_Solution. Administrative information is inherited from a parent object.
 * If the administrative information among objects within a Solution is not the
 * same, additional PRS_Administrative instances may be associated with other
...
public class PRS_Administrative extends PRS_ExchangeElement  {
	...
	public final static String CIM_CLASS_NAME = "PRS_Administrative"; //$NON-NLS-1$
