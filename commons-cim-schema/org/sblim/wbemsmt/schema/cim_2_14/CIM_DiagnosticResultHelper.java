/** 
 * CIM_DiagnosticResultHelper.java
 *
...
public final class CIM_DiagnosticResultHelper {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_DiagnosticResult.Java_Package_List.size(); i++) {
						if (!((String)(CIM_DiagnosticResult.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_DiagnosticResult.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_DiagnosticResult.Java_Package_List.setElementAt((String)(CIM_DiagnosticResult.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_DiagnosticResult.");
						resultArrayList.add(new CIM_DiagnosticResult(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_DiagnosticResult.");
						resultArrayList.add(new CIM_DiagnosticResult(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_DiagnosticResult.");
						resultArrayList.add(new CIM_DiagnosticResult(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_DiagnosticResult getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_DiagnosticResultHelper.getInstance(cimClient, new CIM_DiagnosticResult(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticResult getInstance(CIMClient cimClient, CIM_DiagnosticResult dataInstance) {
		...
		return CIM_DiagnosticResultHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_DiagnosticResult getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_DiagnosticResult dataInstance = null;
		try {
			dataInstance = new CIM_DiagnosticResult(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticResult createInstance(CIMClient cimClient, CIM_DiagnosticResult dataInstance, boolean notifyDifferencies){ 
		...
		CIM_DiagnosticResult newDataInstance = null;
		try {
			newDataInstance = CIM_DiagnosticResultHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_DiagnosticResult modifyInstance(CIMClient cimClient, CIM_DiagnosticResult dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_DiagnosticResultHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_DiagnosticResult dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_DiagnosticResult dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_DiagnosticResult.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_DiagnosticResult.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_DiagnosticResult.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_DiagnosticResult.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_DiagnosticResult.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_DiagSystemCreationClassName(String DiagSystemCreationClassName) {
		return true;
	}

	public static boolean isValid_DiagSystemName(String DiagSystemName) {
		return true;
	}

	public static boolean isValid_DiagnosticCreationClassName(String DiagnosticCreationClassName) {
		return true;
	}

	public static boolean isValid_DiagnosticName(String DiagnosticName) {
		return true;
	}

	public static boolean isValid_ErrorCode(String[] ErrorCode) {
		return true;
	}

	public static boolean isValid_ErrorCount(UnsignedInt32[] ErrorCount) {
		return true;
	}

	public static boolean isValid_EstimatedTimeOfPerforming(UnsignedInt32 EstimatedTimeOfPerforming) {
		return true;
	}

	public static boolean isValid_ExecutionID(String ExecutionID) {
		return true;
	}

	public static boolean isValid_HaltOnError(Boolean HaltOnError) {
		return true;
	}

	public static boolean isValid_IsPackage(Boolean IsPackage) {
		return true;
	}

	public static boolean isValid_LoopsFailed(UnsignedInt32 LoopsFailed) {
		return true;
	}

	public static boolean isValid_LoopsPassed(UnsignedInt32 LoopsPassed) {
		return true;
	}

	public static boolean isValid_OtherStateDescription(String OtherStateDescription) {
		return true;
	}

	public static boolean isValid_PercentComplete(UnsignedInt8 PercentComplete) {
		return true;
	}

	public static boolean isValid_PercentOfTestCoverage(UnsignedInt8 PercentOfTestCoverage) {
		return true;
	}

	public static boolean isValid_QuickMode(Boolean QuickMode) {
		return true;
	}

	public static boolean isValid_ReportSoftErrors(Boolean ReportSoftErrors) {
		return true;
	}

	public static boolean isValid_ReportStatusMessages(Boolean ReportStatusMessages) {
		return true;
	}

	public static boolean isValid_TestCompletionTime(Calendar TestCompletionTime) {
		return true;
	}

	public static boolean isValid_TestResults(String[] TestResults) {
		return true;
	}

	public static boolean isValid_TestStartTime(Calendar TestStartTime) {
		return true;
	}

	public static boolean isValid_TestState(UnsignedInt16 TestState) {
		return true;
	}

	public static boolean isValid_TestWarningLevel(UnsignedInt16 TestWarningLevel) {
		return true;
	}

	public static boolean isValid_TimeStamp(Calendar TimeStamp) {
		return true;
	}
