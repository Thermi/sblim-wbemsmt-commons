 ...
 *
 *
 * Description:  CIM_J2eeJCAConnectionPools provides the list of statistics about the
 * connections pools that are associated with the referencing JCA resource
 * statistics.
 * 
 */
...
/**
 *  CIM_J2eeJCAConnectionPools provides the list of statistics about the
 * connections pools that are associated with the referencing JCA resource
 * statistics.
 */
public class CIM_J2eeJCAConnectionPools extends CIM_RelatedStatisticalData  {
	
	public final static String CIM_CLASS_NAME = "CIM_J2eeJCAConnectionPools"; //$NON-NLS-1$
