 ...
 *
 *
 * Description:  Associates PRS_ServiceIncident to PRS_Solution to describe the Resolutions
...
/**
 *  Associates PRS_ServiceIncident to PRS_Solution to describe the Resolutions
 * proposed by the Service Provider.
 */
public class PRS_ServiceResolutionSolution extends CIM_Dependency  {
	
	public final static String CIM_CLASS_NAME = "PRS_ServiceResolutionSolution"; //$NON-NLS-1$
