 ...
 *
 *
 * Description:  ZoneMembershipSettingData provides the identification criteria for possible
 * Zone and ZoneAlias members.
 * 
 */
...
/**
 *  ZoneMembershipSettingData provides the identification criteria for possible
 * Zone and ZoneAlias members.
 */
public class CIM_ZoneMembershipSettingData extends CIM_ConnectivityMembershipSettingData  {
	
	public final static String CIM_CLASS_NAME = "CIM_ZoneMembershipSettingData"; //$NON-NLS-1$
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_ConnectivityMembershipSettingData.Java_Package_List.size(); i++) {
			if (((String)CIM_ConnectivityMembershipSettingData.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
