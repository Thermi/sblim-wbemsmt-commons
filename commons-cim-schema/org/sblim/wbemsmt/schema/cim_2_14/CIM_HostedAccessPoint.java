 ...
 * one-to-many and is weak with respect to the System. Each System can host many
	...
	*/	
	...
	public static void addPackage(String packagename) {
        if (packagename != null) {
            ...
            CIM_HostedAccessPoint.Java_Package_List.add(packagename);
    ...
    public static String[] getPackages() {
        return (String[]) CIM_HostedAccessPoint.Java_Package_List.toArray(new String[CIM_HostedAccessPoint.Java_Package_List.size()]);
    }
