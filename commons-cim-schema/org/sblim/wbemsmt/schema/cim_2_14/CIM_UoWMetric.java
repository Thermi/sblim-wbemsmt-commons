 ...
 *
 *
 * Description:  This association ties a MetricDefinition to an instance of a UnitOfWork. Its
 * primary purpose is to specify the value of the Metric for the instance of
 * UnitOfWork. It is defined as a Dependency since the Metric value relies on
 * the specific UnitOfWork for context.
 * 
 */
...
/**
 *  This association ties a MetricDefinition to an instance of a UnitOfWork. Its
 * primary purpose is to specify the value of the Metric for the instance of
 * UnitOfWork. It is defined as a Dependency since the Metric value relies on
 * the specific UnitOfWork for context.
 */
public class CIM_UoWMetric extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_UoWMetric"; //$NON-NLS-1$
