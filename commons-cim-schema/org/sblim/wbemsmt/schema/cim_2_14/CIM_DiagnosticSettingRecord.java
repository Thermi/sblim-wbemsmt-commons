 ...
 *
 *
 * Description:  A snapshot of the properties in the DiagnosticSetting instance that was used
...
/**
 *  A snapshot of the properties in the DiagnosticSetting instance that was used
 * when the Diagnostic was run.
 */
public class CIM_DiagnosticSettingRecord extends CIM_DiagnosticRecord  {
	
	public final static String CIM_CLASS_NAME = "CIM_DiagnosticSettingRecord"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.11.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_CORRESPONDINGSETTINGSRECORD = "CIM_CorrespondingSettingsRecord"; //$NON-NLS-1$
...
Verbosity may not apply to all LogOptions values, in which case the default VerbosityLevel of "Standard" SHOULD be used.
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_DiagnosticRecord.CIM_PropertyNameList.size(); i++) {
			if (((String)CIM_DiagnosticRecord.CIM_PropertyNameList.elementAt(i)).equals(CIM_PROPERTY_HALTONERROR)||
				...
				((String)CIM_DiagnosticRecord.CIM_PropertyNameList.elementAt(i)).equals(CIM_PROPERTY_LOGSTORAGE)||
				...
				((String)CIM_DiagnosticRecord.CIM_PropertyNameList.elementAt(i)).equals(CIM_PROPERTY_OTHERLOGSTORAGEDESCRIPTIONS)||
		...
		for (int i = 0; i < CIM_DiagnosticRecord.CIM_PropertyList.size(); i++) {
			if (((CIMProperty)CIM_DiagnosticRecord.CIM_PropertyList.get(i)).getName().equals(CIM_PROPERTY_HALTONERROR)||
				...
				((CIMProperty)CIM_DiagnosticRecord.CIM_PropertyList.get(i)).getName().equals(CIM_PROPERTY_LOGSTORAGE)||
				...
				((CIMProperty)CIM_DiagnosticRecord.CIM_PropertyList.get(i)).getName().equals(CIM_PROPERTY_OTHERLOGSTORAGEDESCRIPTIONS)||
	...
	public final static String LOGOPTIONS_UNKNOWN = "0";
	public final static String LOGOPTIONS_OTHER = "1";
	public final static String LOGOPTIONS_RESULTS = "2";
	public final static String LOGOPTIONS_SUBTESTS = "3";
	public final static String LOGOPTIONS_ACTIONS = "4";
	public final static String LOGOPTIONS_WARNINGS = "5";
	public final static String LOGOPTIONS_STATUS = "6";
	public final static String LOGOPTIONS_DEVICEERRORS = "7";
	public final static String LOGOPTIONS_SERVICEERRORS = "8";
	public final static String LOGOPTIONS_SETTINGDATA = "9";
	public final static String LOGOPTIONS_STATISTICS = "10";
	public final static String LOGOPTIONS_HARDWARECONFIGURATION = "11";
	public final static String LOGOPTIONS_SOFTWARECONFIGURATION = "12";
	public final static String LOGOPTIONS_REFERENCES = "13";
	public final static String LOGOPTIONS_DEBUG = "14";
	public final static String LOGOPTIONS_NOLOGOPTIONS = "0x8000";
	...
	*/	
	...
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
		...
		try {
			enumeration = cimClient.associators(
					...
					"SettingsRecord", //$NON-NLS-1$
					"DataRecord", //$NON-NLS-1$
					includeQualifiers,
					includeClassOrigin,
					propertyList);
	...
	public UnsignedInt16[] get_LogStorage() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_DiagnosticSettingRecord.CIM_PROPERTY_LOGSTORAGE);
        
		if (currentProperty == null) {
			throw new CIMException(CIMException.CIM_ERR_NO_SUCH_PROPERTY, "The property " + CIM_DiagnosticSettingRecord.CIM_PROPERTY_LOGSTORAGE + " could not be found");
    		
		} else if (currentProperty.getType() == null || currentProperty.getType().getType() != CIMDataType.UINT16_ARRAY) {
			throw new CIMException(CIMException.CIM_ERR_TYPE_MISMATCH, "The property " + CIM_DiagnosticSettingRecord.CIM_PROPERTY_LOGSTORAGE + " is not of expected type " + CIMDataType.getPredefinedType(CIMDataType.UINT16_ARRAY) + ".");
		}
	...
	public void set_LogStorage(UnsignedInt16[] newValue) {
		...
		} else if (!CIM_DiagnosticSettingRecordHelper.isValid_LogStorage(newValue)) {
			throw new InvalidParameterException("The value " + newValue + " is not valid for property " + CIM_DiagnosticSettingRecord.CIM_PROPERTY_LOGSTORAGE);
	...
	public String[] get_OtherLogStorageDescriptions() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_DiagnosticSettingRecord.CIM_PROPERTY_OTHERLOGSTORAGEDESCRIPTIONS);
        
		if (currentProperty == null) {
			throw new CIMException(CIMException.CIM_ERR_NO_SUCH_PROPERTY, "The property " + CIM_DiagnosticSettingRecord.CIM_PROPERTY_OTHERLOGSTORAGEDESCRIPTIONS + " could not be found");
    		
		} else if (currentProperty.getType() == null || currentProperty.getType().getType() != CIMDataType.STRING_ARRAY) {
			throw new CIMException(CIMException.CIM_ERR_TYPE_MISMATCH, "The property " + CIM_DiagnosticSettingRecord.CIM_PROPERTY_OTHERLOGSTORAGEDESCRIPTIONS + " is not of expected type " + CIMDataType.getPredefinedType(CIMDataType.STRING_ARRAY) + ".");
		}
	...
	public void set_OtherLogStorageDescriptions(String[] newValue) {
		...
		} else if (!CIM_DiagnosticSettingRecordHelper.isValid_OtherLogStorageDescriptions(newValue)) {
			throw new InvalidParameterException("The value " + newValue + " is not valid for property " + CIM_DiagnosticSettingRecord.CIM_PROPERTY_OTHERLOGSTORAGEDESCRIPTIONS);
