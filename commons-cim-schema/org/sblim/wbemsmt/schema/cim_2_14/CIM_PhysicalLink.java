 ...
 *
 *
 * Description:  The PhysicalLink class represents the cabling of PhysicalElements together. For
 * example, serial or Ethernet cables would be subclasses (if additional
 * properties or associations are defined) or instances of PhysicalLink. In many
 * cases, the numerous physical cables within a PhysicalPackage or Network will
 * not be modeled. However, where these cables or Links are critical components,
 * or are tagged assets of the company, these objects can be instantiated using
...
/**
 *  The PhysicalLink class represents the cabling of PhysicalElements together. For
 * example, serial or Ethernet cables would be subclasses (if additional
 * properties or associations are defined) or instances of PhysicalLink. In many
 * cases, the numerous physical cables within a PhysicalPackage or Network will
 * not be modeled. However, where these cables or Links are critical components,
...
public class CIM_PhysicalLink extends CIM_PhysicalElement  {
	...
	public final static String CIM_CLASS_NAME = "CIM_PhysicalLink"; //$NON-NLS-1$
