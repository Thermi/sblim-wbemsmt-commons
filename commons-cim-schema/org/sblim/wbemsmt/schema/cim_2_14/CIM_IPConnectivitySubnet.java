 ...
 *
 *
 * Description:  An IPConnectivitySubnet represents a group of related IPProtocolEndpoints that
 * can communicate with each other, as members of a subnet. The class describes
 * the characteristics of the subnet.
 * 
 */
...
/**
 *  An IPConnectivitySubnet represents a group of related IPProtocolEndpoints that
 * can communicate with each other, as members of a subnet. The class describes
 * the characteristics of the subnet.
 */
public class CIM_IPConnectivitySubnet extends CIM_ConnectivityCollection  {
	
	public final static String CIM_CLASS_NAME = "CIM_IPConnectivitySubnet"; //$NON-NLS-1$
