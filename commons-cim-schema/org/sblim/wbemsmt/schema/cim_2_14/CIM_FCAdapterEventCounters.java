 ...
 *
 *
 * Description:  Note: The use of the FCAdapterEventCounters class is deprecated because
 * FibreChannelAdapter is deprecated. FCPortStatistics should be used instead,
 * but it redefines the level at which data is collected. Therefore, there is no
 * direct translation of the individual counters between the two classes. This
 * object describes event counters that were specific to a FibreChannelAdapter.
 * 
 */
...
/**
 *  Note: The use of the FCAdapterEventCounters class is deprecated because
 * FibreChannelAdapter is deprecated. FCPortStatistics should be used instead,
 * but it redefines the level at which data is collected. Therefore, there is no
 * direct translation of the individual counters between the two classes. This
 * object describes event counters that were specific to a FibreChannelAdapter.
