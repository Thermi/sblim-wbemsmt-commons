/** 
 * CIM_SoftwareElementVersionCheckHelper.java
 *
...
public final class CIM_SoftwareElementVersionCheckHelper {

	public final static String CIM_CLASS_NAME = "CIM_SoftwareElementVersionCheck";
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (!deep && cimInstance.getClassName().equals(CIM_CLASS_NAME)) {
						resultArrayList.add(new CIM_SoftwareElementVersionCheck(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					Class clazz = null;
					String cimClassName = cimInstance.getClassName();
				
					for (int i=0; clazz==null && i<CIM_SoftwareElementVersionCheck.Java_Package_List.size(); i++) {
						if (!((String)(CIM_SoftwareElementVersionCheck.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_SoftwareElementVersionCheck.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_SoftwareElementVersionCheck.Java_Package_List.setElementAt((String)(CIM_SoftwareElementVersionCheck.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_SoftwareElementVersionCheck.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SoftwareElementVersionCheck.");
						resultArrayList.add(new CIM_SoftwareElementVersionCheck(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SoftwareElementVersionCheck.");
						resultArrayList.add(new CIM_SoftwareElementVersionCheck(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SoftwareElementVersionCheck.");
						resultArrayList.add(new CIM_SoftwareElementVersionCheck(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_SoftwareElementVersionCheck getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_SoftwareElementVersionCheckHelper.getInstance(cimClient, new CIM_SoftwareElementVersionCheck(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SoftwareElementVersionCheck getInstance(CIMClient cimClient, CIM_SoftwareElementVersionCheck dataInstance) {
		...
		return CIM_SoftwareElementVersionCheckHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_SoftwareElementVersionCheck getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_SoftwareElementVersionCheck dataInstance = null;
		try {
			dataInstance = new CIM_SoftwareElementVersionCheck(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SoftwareElementVersionCheck createInstance(CIMClient cimClient, CIM_SoftwareElementVersionCheck dataInstance, boolean notifyDifferencies){ 
		...
		CIM_SoftwareElementVersionCheck newDataInstance = null;
		try {
			newDataInstance = CIM_SoftwareElementVersionCheckHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_SoftwareElementVersionCheck modifyInstance(CIMClient cimClient, CIM_SoftwareElementVersionCheck dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_SoftwareElementVersionCheckHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_SoftwareElementVersionCheck dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_SoftwareElementVersionCheck dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_SoftwareElementVersionCheck.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	*/	
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_SoftwareElementVersionCheck.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_SoftwareElementVersionCheck.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_SoftwareElementVersionCheck.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_SoftwareElementVersionCheck.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
	...
	public static boolean isValid_LowerSoftwareElementVersion(String LowerSoftwareElementVersion) {
		return true;
	}

	public static boolean isValid_SoftwareElementName(String SoftwareElementName) {
		return true;
	}

	public static boolean isValid_SoftwareElementStateDesired(UnsignedInt16 SoftwareElementStateDesired) {
		return true;
	}

	public static boolean isValid_TargetOperatingSystemDesired(UnsignedInt16 TargetOperatingSystemDesired) {
		return true;
	}

	public static boolean isValid_UpperSoftwareElementVersion(String UpperSoftwareElementVersion) {
		return true;
	}
