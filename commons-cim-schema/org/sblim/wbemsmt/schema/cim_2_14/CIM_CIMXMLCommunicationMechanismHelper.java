...
public class CIM_CIMXMLCommunicationMechanismHelper extends AbstractWbemsmtFcoHelper {
    ...
    public final static List enumerateInstanceNames(WBEMClient client, String namespace,
        ...
        CIMObjectPath path = new CIMObjectPath(CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME,
        ...
        try {
            ...
            while (iterator != null && iterator.hasNext()) {
                ...
                if (deep
                        || CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME.equals(cimObjectPath
                                .getObjectName())) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep
                            && cimInstance.getClassName().equals(
                                    CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
                    Class clazz = CIM_CIMXMLCommunicationMechanismHelper.findClass(client,
                            cimInstance);
                    if (clazz == null) {
                        System.err
                                .println("The class "
                                        + cimInstance.getClassName()
                                        + " was not found. Constructing instance of class CIM_CIMXMLCommunicationMechanism.");
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The required constructor of class "
                                        + cimInstance.getClassName()
                                        + " could not be found. Constructing instance of class CIM_CIMXMLCommunicationMechanism.");
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err
                                .println("The instance of class "
                                        + cimInstance.getClassName()
                                        + " could not be created successful. Constructing instance of class CIM_CIMXMLCommunicationMechanism.");
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
     ...
     * @return the instance
     */
    public final static CIM_CIMXMLCommunicationMechanism getInstance(WBEMClient client,
    ...
    public final static CIM_CIMXMLCommunicationMechanism getInstance(WBEMClient client,
        ...
        keyProperties[0] = new CIMProperty(
                CIM_CIMXMLCommunicationMechanism.PROPERTY_CREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME);

        setThis = Name;

        keyProperties[1] = new CIMProperty(CIM_CIMXMLCommunicationMechanism.PROPERTY_NAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME);
        ...
        keyProperties[2] = new CIMProperty(
                CIM_CIMXMLCommunicationMechanism.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,
                CIMDataType.STRING_T, setThis, true, false,
                CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME);
        ...
        keyProperties[3] = new CIMProperty(
                CIM_CIMXMLCommunicationMechanism.PROPERTY_SYSTEMNAME.NAME, CIMDataType.STRING_T,
                setThis, true, false, CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME);
     ...
     *
     */
    public final static CIM_CIMXMLCommunicationMechanism createInstance(WBEMClient client,
            CIM_CIMXMLCommunicationMechanism dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        CIM_CIMXMLCommunicationMechanism newDataInstance = CIM_CIMXMLCommunicationMechanismHelper
     ...
     */
    public final static CIM_CIMXMLCommunicationMechanism modifyInstance(WBEMClient client,
            CIM_CIMXMLCommunicationMechanism dataInstance, boolean notifyDifferencies)
            throws WbemsmtException {
        ...
        if (dataInstance.isModified()) {
            ...
            CIM_CIMXMLCommunicationMechanism dataInstance2 = CIM_CIMXMLCommunicationMechanismHelper
    ...
    public final static void deleteInstance(WBEMClient client,
            CIM_CIMXMLCommunicationMechanism dataInstance) throws WbemsmtException {
    ...
    public static Class findClass(WBEMClient client, CIMInstance cimInstance)
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client, cimInstance,
                CIM_CIMXMLCommunicationMechanism.getPackages());
    }
