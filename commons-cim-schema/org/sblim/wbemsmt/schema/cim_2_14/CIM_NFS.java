...
If set to false : Interrupts are ignored for hard mounts.
	...
	*/
	...
	static {
		...
		for (int i = 0; i < CIM_RemoteFileSystem.Java_Package_List.size(); i++) {
			if (((String)CIM_RemoteFileSystem.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
			
			Java_Package_List.add(CIM_RemoteFileSystem.Java_Package_List.elementAt(i));
		}
	};
