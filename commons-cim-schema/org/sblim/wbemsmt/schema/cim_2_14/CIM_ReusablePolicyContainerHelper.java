/** 
 * CIM_ReusablePolicyContainerHelper.java
 *
...
public final class CIM_ReusablePolicyContainerHelper {

	public final static String CIM_CLASS_NAME = "CIM_ReusablePolicyContainer";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					for (int i=0; clazz==null && i<CIM_ReusablePolicyContainer.Java_Package_List.size(); i++) {
						if (!((String)(CIM_ReusablePolicyContainer.Java_Package_List.get(i))).trim().equals("") && //$NON-NLS-1$
								!((String)(CIM_ReusablePolicyContainer.Java_Package_List.get(i))).endsWith(".")) { //$NON-NLS-1$
							CIM_ReusablePolicyContainer.Java_Package_List.setElementAt((String)(CIM_ReusablePolicyContainer.Java_Package_List.get(i)) + ("."), i); //$NON-NLS-1$
						}
						cimClassName = (CIM_ReusablePolicyContainer.Java_Package_List.get(i)) + cimClassName;
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ReusablePolicyContainer.");
						resultArrayList.add(new CIM_ReusablePolicyContainer(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ReusablePolicyContainer.");
						resultArrayList.add(new CIM_ReusablePolicyContainer(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ReusablePolicyContainer.");
						resultArrayList.add(new CIM_ReusablePolicyContainer(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_ReusablePolicyContainer getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_ReusablePolicyContainerHelper.getInstance(cimClient, new CIM_ReusablePolicyContainer(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ReusablePolicyContainer getInstance(CIMClient cimClient, CIM_ReusablePolicyContainer dataInstance) {
		...
		return CIM_ReusablePolicyContainerHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_ReusablePolicyContainer getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_ReusablePolicyContainer dataInstance = null;
		try {
			dataInstance = new CIM_ReusablePolicyContainer(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ReusablePolicyContainer createInstance(CIMClient cimClient, CIM_ReusablePolicyContainer dataInstance, boolean notifyDifferencies){ 
		...
		CIM_ReusablePolicyContainer newDataInstance = null;
		try {
			newDataInstance = CIM_ReusablePolicyContainerHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_ReusablePolicyContainer modifyInstance(CIMClient cimClient, CIM_ReusablePolicyContainer dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_ReusablePolicyContainerHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_ReusablePolicyContainer dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_ReusablePolicyContainer dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_ReusablePolicyContainer.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_ReusablePolicyContainer.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_ReusablePolicyContainer.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_ReusablePolicyContainer.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_ReusablePolicyContainer.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
