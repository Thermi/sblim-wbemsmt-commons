 ...
 *
 *
 * Description:  An IPSOFilterEntry is used to match traffic based on the IP Security Options
 * header values (ClassificationLevel and ProtectionAuthority) as defined in
 * RFC1108. This type of FilterEntry is used to adjust the IPsec encryption
 * level according to the IPSO classification of the traffic (e.g., secret,
 * confidential, restricted, etc.).
 * 
 */
...
/**
 *  An IPSOFilterEntry is used to match traffic based on the IP Security Options
 * header values (ClassificationLevel and ProtectionAuthority) as defined in
 * RFC1108. This type of FilterEntry is used to adjust the IPsec encryption
 * level according to the IPSO classification of the traffic (e.g., secret,
 * confidential, restricted, etc.).
...
public class CIM_IPSOFilterEntry extends CIM_FilterEntryBase  {
	...
	public final static String CIM_CLASS_NAME = "CIM_IPSOFilterEntry"; //$NON-NLS-1$
