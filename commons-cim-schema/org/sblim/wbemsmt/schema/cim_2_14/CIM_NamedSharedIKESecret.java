 ...
 *
 *
 * Description:  CIM_NamedSharedIKESecret indirectly represents a shared secret credential. The
 * local identity, IKEIdentity, and the remote peer identity share the secret
 * that is named by the SharedSecretName. The SharedSecretName is used by the
...
/**
 *  CIM_NamedSharedIKESecret indirectly represents a shared secret credential. The
 * local identity, IKEIdentity, and the remote peer identity share the secret
 * that is named by the SharedSecretName. The SharedSecretName is used by the
 * SharedSecretService to reference the secret.
 */
public class CIM_NamedSharedIKESecret extends CIM_Credential  {
	...
	public final static String CIM_CLASS_NAME = "CIM_NamedSharedIKESecret"; //$NON-NLS-1$
