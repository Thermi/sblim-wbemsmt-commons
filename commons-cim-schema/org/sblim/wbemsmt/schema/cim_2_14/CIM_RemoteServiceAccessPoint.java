 ...
 *
 *
 * Description:  RemoteServiceAccessPoint describes access or addressing information or a
 * combination of this information for a remote connection that is known to a
 * local network element. This information is scoped or contained by the local
 * network element, because this is the context in which the connection is
 * remote. The relevance of the remote access point and information on its use
 * are described by subclassing RemoteServiceAccessPoint or by associating to
 * it.
 * 
 */
...
public class CIM_RemoteServiceAccessPoint extends CIM_ServiceAccessPoint  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_PEEROFSAENDPOINT = "CIM_PeerOfSAEndpoint"; //$NON-NLS-1$
