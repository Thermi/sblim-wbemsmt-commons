 ...
 *
 *
 * Description:  Note: The use of this class is deprecated in lieu of ProtocolControllerForUnit,
 * because the SCSIController class involved in this association is itself
 * deprecated. The protocol-related aspects of SCSI are better reflected in the
 * new classes and associations. Deprecated description: SCSIInterface is a
 * ControlledBy relationship that indicates which Devices are accessed through a
 * SCSIController and describes the characteristics of this access.
 * 
 */
...
/**
 *  Note: The use of this class is deprecated in lieu of ProtocolControllerForUnit,
 * because the SCSIController class involved in this association is itself
 * deprecated. The protocol-related aspects of SCSI are better reflected in the
 * new classes and associations. Deprecated description: SCSIInterface is a
 * ControlledBy relationship that indicates which Devices are accessed through a
...
public class CIM_SCSIInterface extends CIM_ControlledBy  {
	...
	public final static String CIM_CLASS_NAME = "CIM_SCSIInterface"; //$NON-NLS-1$
