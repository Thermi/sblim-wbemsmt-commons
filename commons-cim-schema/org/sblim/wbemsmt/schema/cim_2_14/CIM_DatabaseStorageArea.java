 ...
 *
 *
 * Description:  Databases as modeled by instances of the CommonDatabase class are comprised of
 * a collection of logical storage areas that are represented by instances of
 * the DatabaseStorageArea class. Database storage areas allow the administrator
 * to logically organize the content of the database. This class extends from
 * FileSystem and uses the inherited associations to represent the internal
...
/**
 *  Databases as modeled by instances of the CommonDatabase class are comprised of
 * a collection of logical storage areas that are represented by instances of
 * the DatabaseStorageArea class. Database storage areas allow the administrator
 * to logically organize the content of the database. This class extends from
 * FileSystem and uses the inherited associations to represent the internal
...
public class CIM_DatabaseStorageArea extends CIM_FileSystem  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DatabaseStorageArea"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.8.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_DATABASESTORAGE = "CIM_DatabaseStorage"; //$NON-NLS-1$
	
	
	/**
	*	A Boolean value that indicates the ownership of this StorageArea. A value of true indicates that this StorageArea is owned by the DatabaseSystem and contains system information. A value of false indicates that this is a user StorageArea that contains data.
	*/
	public final static String CIM_PROPERTY_ISSYSTEMAREA = "IsSystemArea"; //$NON-NLS-1$
	/**
	*	A timestamp that represents the date and time of the last successful backup of the DatabaseStorageArea. This property should be set to a value of 0, in interval format (00000000000000.000000:000), if it is not known whether a backup has ever been completed.
	*/
