...
public class CIM_DMA extends CIM_SystemResource  {
	...
	public final static String CIM_CLASS_NAME = "CIM_DMA"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_COMPUTERSYSTEMDMA = "CIM_ComputerSystemDMA"; //$NON-NLS-1$
