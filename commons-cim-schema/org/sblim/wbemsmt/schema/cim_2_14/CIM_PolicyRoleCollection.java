 ...
 *
 *
 * Description:  PolicyRoleCollection is used to represent a collection of ManagedElements that
 * share a common policy role, and the PolicySets that CAN BE applied to those
 * elements. (Note that the PolicySets that are CURRENTLY applied are indicated
 * via instances of the association, PolicySetAppliesToElement.) The
 * PolicyRoleCollection always exists in the context of a System, specified
 * using the PolicyRoleCollectionInSystem aggregation. The value of the
 * PolicyRole property in this class specifies the role. It is defined as a
 * free-form string. ManagedElements that share the role defined in this
 * collection are aggregated into the Collection via the
...
/**
 *  PolicyRoleCollection is used to represent a collection of ManagedElements that
 * share a common policy role, and the PolicySets that CAN BE applied to those
 * elements. (Note that the PolicySets that are CURRENTLY applied are indicated
 * via instances of the association, PolicySetAppliesToElement.) The
 * PolicyRoleCollection always exists in the context of a System, specified
...
public class CIM_PolicyRoleCollection extends CIM_SystemSpecificCollection  {
	...
	public final static String CIM_CLASS_NAME = "CIM_PolicyRoleCollection"; //$NON-NLS-1$
	public final static String CIM_CLASS_DISPLAYNAME = CIM_CLASS_NAME;

	private boolean validCimInstance = false;
	
	public final static String CIM_CLASS_VERSION = "2.8.0";
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTINPOLICYROLECOLLECTION = "CIM_ElementInPolicyRoleCollection"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_POLICYSETINROLECOLLECTION = "CIM_PolicySetInRoleCollection"; //$NON-NLS-1$
