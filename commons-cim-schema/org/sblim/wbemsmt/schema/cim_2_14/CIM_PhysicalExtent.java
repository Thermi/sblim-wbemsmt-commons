 ...
 * PhysicalExtent is used to model an SCC RAID implementation. It defines the
 * consecutive addressable block addresses on a single storage device, that are
 * treated as a single StorageExtent and that are in the same
 * StorageRedundancyGroup. An alternate possibility, if automatic configuration
 * is used, is to instantiate or extend the AggregatePExtent class.
 * 
 */
...
public class CIM_PhysicalExtent extends CIM_StorageExtent  {
	...
	public final static String CIM_CLASS_NAME = "CIM_PhysicalExtent"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_PEXTENTREDUNDANCYCOMPONENT = "CIM_PExtentRedundancyComponent"; //$NON-NLS-1$
