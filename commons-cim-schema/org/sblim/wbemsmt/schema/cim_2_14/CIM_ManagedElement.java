...
public class CIM_ManagedElement  {
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTASUSER = "CIM_ElementAsUser"; //$NON-NLS-1$
	...
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_SPARED = "CIM_Spared"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_STATISTICS = "CIM_Statistics"; //$NON-NLS-1$
	public final static String CIM_ASSOCIATOR_CLASS_NAME_CIM_STORAGESYNCHRONIZED = "CIM_StorageSynchronized"; //$NON-NLS-1$
...
Note that the Name property of ManagedSystemElement is also defined as a user-friendly name. But, it is often subclassed to be a Key. It is not reasonable that the same property can convey both identity and a user-friendly name, without inconsistencies. Where Name exists and is not a Key (such as for instances of LogicalDevice), the same information can be present in both the Name and ElementName properties.
	...
	*/	
	...
	public ArrayList getAssociated_CIM_RedundancySet_CIM_IsSpares(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
		...
		try {
			enumeration = cimClient.associators(
					...
					CIM_RedundancySet.CIM_CLASS_NAME, 
					"Antecedent", //$NON-NLS-1$
					"Dependent", //$NON-NLS-1$
					includeQualifiers,
					includeClassOrigin,
	...
	public ArrayList getAssociated_CIM_RedundancySet_CIM_IsSpare_Names(CIMClient cimClient, boolean deep) {
		...
		try {		
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMObjectPath) {
					if (deep || ((CIMObjectPath)obj).getObjectName().equals(CIM_RedundancySet.CIM_CLASS_NAME)) {
						resultArrayList.add(obj);
					}
				}
			}
	...
	public ArrayList getAssociated_CIM_ManagedElement_CIM_Spareds(CIMClient cimClient,
	boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList){
		...
		try {
			enumeration = cimClient.associators(
					this.getCimObjectPath(),
					CIM_ASSOCIATOR_CLASS_NAME_CIM_SPARED, 
	...
	public ArrayList getAssociated_CIM_ManagedElement_CIM_Spared_Names(CIMClient cimClient, boolean deep) {
