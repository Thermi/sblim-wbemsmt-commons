...
public class CIM_SubProfileRequiresProfile extends CIM_ReferencedProfile  {
	...
	public final static String CIM_PROPERTY_CIM_REGISTEREDPROFILE = "Antecedent"; //$NON-NLS-1$
	public final static String CIM_PROPERTY_CIM_REGISTEREDSUBPROFILE = "Dependent"; //$NON-NLS-1$
	...
	static {
		...
		CIM_PropertyNameList.add(CIM_PROPERTY_CIM_REGISTEREDSUBPROFILE);
				
		for (int i = 0; i < CIM_ReferencedProfile.CIM_PropertyNameList.size(); i++) {
			
			CIM_SubProfileRequiresProfile.CIM_PropertyNameList.add(CIM_ReferencedProfile.CIM_PropertyNameList.elementAt(i));
		}
		...
		CIM_PropertyList.add(new CIMProperty(CIM_PROPERTY_CIM_REGISTEREDSUBPROFILE, new CIMValue(null, new CIMDataType(CIM_RegisteredSubProfile.CIM_CLASS_NAME))));
				
		for (int i = 0; i < CIM_ReferencedProfile.CIM_PropertyList.size(); i++) {
		...
		for (int i = 0; i < CIM_ReferencedProfile.Java_Package_List.size(); i++) {
			if (((String)CIM_ReferencedProfile.Java_Package_List.elementAt(i)).equals("org.sblim.wbemsmt.schema.cim_2_14")){
				continue;
			}
	...
	*	Class constructor
	*/	
	public CIM_SubProfileRequiresProfile() {
	...
	*	Class constructor
	*/	
	public CIM_SubProfileRequiresProfile(Vector keyProperties){ 
		this();
	...
	*	Class constructor
	*/	
	public CIM_SubProfileRequiresProfile(CIMObjectPath cimObjectPath, CIMInstance cimInstance){ 
	...
	*/	
	public boolean equals(Object object) {
	    ...
	    if (!(object instanceof CIM_SubProfileRequiresProfile)) {
	        return false;
	    }
	    
	    if (this.cimInstance == null && ((CIM_SubProfileRequiresProfile)object).cimInstance != null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && ((CIM_SubProfileRequiresProfile)object).cimInstance == null) {
	    	return false;
	    	
	    } else if (this.cimInstance != null && !this.cimInstance.equals(((CIM_SubProfileRequiresProfile)object).cimInstance)) {
	    	return false;
	    	
	    } else if (this.original_cimInstance == null && ((CIM_SubProfileRequiresProfile)object).original_cimInstance != null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && ((CIM_SubProfileRequiresProfile)object).original_cimInstance == null) {
	    	return false;
	    	
	    } else if (this.original_cimInstance != null && !this.original_cimInstance.equals(((CIM_SubProfileRequiresProfile)object).original_cimInstance)) {
	        return false;
	        
	    } else if (this.cimObjectPath == null && ((CIM_SubProfileRequiresProfile)object).cimObjectPath != null) {
	    	return false;
	    	
	    } else if (this.cimObjectPath != null && ((CIM_SubProfileRequiresProfile)object).cimObjectPath == null) {
	    	return false;
		    	
	    } else if (this.cimObjectPath != null && !this.cimObjectPath.equals(((CIM_SubProfileRequiresProfile)object).cimObjectPath)) {
	        return false;
	...
	*/	
	...
	public CIMObjectPath get_CIM_RegisteredProfile() {
		...
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_SubProfileRequiresProfile.CIM_PROPERTY_CIM_REGISTEREDPROFILE);
	...
	// Attribute CIM_RegisteredSubProfile
	
	public CIMObjectPath get_CIM_RegisteredSubProfile() {
		
		CIMProperty currentProperty = this.cimInstance.getProperty(CIM_SubProfileRequiresProfile.CIM_PROPERTY_CIM_REGISTEREDSUBPROFILE);
	...
	public void set_CIM_RegisteredSubProfile(CIM_RegisteredSubProfile newValue) {
		...
		CIMValue updatedValue = new CIMValue(newValue.getCimObjectPath(), new CIMDataType(CIM_RegisteredSubProfile.CIM_CLASS_NAME));
		currentProperty.setValue(updatedValue);
	}	
