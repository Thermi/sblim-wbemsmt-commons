 ...
 *
 *
 * Description:  IKERule contains the Conditions and Actions for IKE phase 1 negotiations or to
...
/**
 *  IKERule contains the Conditions and Actions for IKE phase 1 negotiations or to
 * specify static actions such as Discard.
 */
public class CIM_IKERule extends CIM_SARule  {
	
	public final static String CIM_CLASS_NAME = "CIM_IKERule"; //$NON-NLS-1$
