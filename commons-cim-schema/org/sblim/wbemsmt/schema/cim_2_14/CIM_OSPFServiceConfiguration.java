 ...
 *
 *
 * Description:  OSPFServiceConfiguration connects an OSPF service to its area configurations.
 * The configurations are defined for the OSPF Service, and so do not make sense
 * as stand alone objects. This is the reason for the Min (1), Max (1)
 * cardinalities on OSPFService. They mandate the instantiation of the service
 * and of this association for the referenced instance of OSPFAreaConfiguration.
 * The area configuration acts as a focal point to bring together the router
 * (indicated as a ComputerSystem with an instance of OSPFService, associated to
 * the AreaConfiguration using this relationship), the area (indicated as an
...
/**
 *  OSPFServiceConfiguration connects an OSPF service to its area configurations.
 * The configurations are defined for the OSPF Service, and so do not make sense
 * as stand alone objects. This is the reason for the Min (1), Max (1)
 * cardinalities on OSPFService. They mandate the instantiation of the service
 * and of this association for the referenced instance of OSPFAreaConfiguration.
...
public class CIM_OSPFServiceConfiguration extends CIM_Dependency  {
	...
	public final static String CIM_CLASS_NAME = "CIM_OSPFServiceConfiguration"; //$NON-NLS-1$
