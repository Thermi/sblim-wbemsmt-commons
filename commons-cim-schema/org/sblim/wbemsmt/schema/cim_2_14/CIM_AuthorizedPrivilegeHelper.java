/** 
 * CIM_AuthorizedPrivilegeHelper.java
 *
...
public final class CIM_AuthorizedPrivilegeHelper {

	public final static String CIM_CLASS_NAME = "CIM_AuthorizedPrivilege";
		...
		try {
			...
			while (enumeration.hasMoreElements()) {
				...
				if (obj instanceof CIMInstance) {
					...
					if (clazz == null) {
						System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_AuthorizedPrivilege.");
						resultArrayList.add(new CIM_AuthorizedPrivilege(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_AuthorizedPrivilege.");
						resultArrayList.add(new CIM_AuthorizedPrivilege(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
					...
					try {
						...
						System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_AuthorizedPrivilege.");
						resultArrayList.add(new CIM_AuthorizedPrivilege(cimInstance.getObjectPath(), cimInstance));
						continue;
					}
	...
	*/	
	public final static CIM_AuthorizedPrivilege getInstance(CIMClient cimClient, Vector keyProperties) {
		...
		return CIM_AuthorizedPrivilegeHelper.getInstance(cimClient, new CIM_AuthorizedPrivilege(keyProperties));
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AuthorizedPrivilege getInstance(CIMClient cimClient, CIM_AuthorizedPrivilege dataInstance) {
		...
		return CIM_AuthorizedPrivilegeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
	}
	...
	*	The method returns an instance of a given CIM client at a given path
	*/	
	public final static CIM_AuthorizedPrivilege getInstance(CIMClient cimClient, CIMObjectPath cimObjectPath) {
		...
		CIM_AuthorizedPrivilege dataInstance = null;
		try {
			dataInstance = new CIM_AuthorizedPrivilege(cimObjectPath, cimInstance);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AuthorizedPrivilege createInstance(CIMClient cimClient, CIM_AuthorizedPrivilege dataInstance, boolean notifyDifferencies){ 
		...
		CIM_AuthorizedPrivilege newDataInstance = null;
		try {
			newDataInstance = CIM_AuthorizedPrivilegeHelper.getInstance(cimClient, cimObjectPath);
		} catch (Exception e) {
	...
	*/	
	public final static CIM_AuthorizedPrivilege modifyInstance(CIMClient cimClient, CIM_AuthorizedPrivilege dataInstance, boolean notifyDifferencies){ 
		...
		if (dataInstance.isModified()) {
			...
			dataInstance = CIM_AuthorizedPrivilegeHelper.getInstance(cimClient, dataInstance.getCimObjectPath());
		}
	...
	*/	
	public final static void deleteInstance(CIMClient cimClient, CIM_AuthorizedPrivilege dataInstance){
	...
	*	no description
	*/
	private final static CIMInstance copyDataToServerInstance(CIMClient cimClient, CIM_AuthorizedPrivilege dataInstance, boolean notifyDifferencies) {
		...
		for (int i = 0; i < serverPropertyListVector.size(); i++) {
			if ((CIMProperty)serverPropertyListVector.get(i) != null && 
					CIM_AuthorizedPrivilege.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyListVector.get(i)).getName())) {
	...
	public static boolean testClientServerIntegrity(CIMClient cimClient, Vector missedProperties, Vector unrecognizedProperties) {
		...
		for (int i = 0; i < serverPropertyList.size(); i++) {
			if ((CIMProperty)serverPropertyList.get(i) == null ||
					!CIM_AuthorizedPrivilege.CIM_PropertyNameList.contains(((CIMProperty)serverPropertyList.get(i)).getName())) {
		...
		for (int i = 0; i < CIM_AuthorizedPrivilege.CIM_PropertyNameList.size(); i++) {
				if (!serverPropertyNameList.contains(CIM_AuthorizedPrivilege.CIM_PropertyNameList.get(i))) {
				unrecognizedProperties.add(CIM_AuthorizedPrivilege.CIM_PropertyNameList.get(i));
				result = false;
			}
		}
		return result;
