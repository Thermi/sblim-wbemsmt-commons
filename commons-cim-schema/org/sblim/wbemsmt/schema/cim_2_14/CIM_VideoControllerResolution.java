 ...
 *
 *
 * Description:  VideoControllerResolution describes the various video modes that a
 * VideoController can support. Video modes are defined by the possible
 ...
 * are in use, are the values specified in the VideoController object.
 * 
 */
...
/**
 *  VideoControllerResolution describes the various video modes that a
 * VideoController can support. Video modes are defined by the possible
 * horizontal and vertical resolutions, refresh rate, scan mode and number of
 * colors settings supported by a Controller. The actual resolutions, etc. that
 * are in use, are the values specified in the VideoController object.
...
public class CIM_VideoControllerResolution extends CIM_Setting  {
	...
	public final static String CIM_CLASS_NAME = "CIM_VideoControllerResolution"; //$NON-NLS-1$
