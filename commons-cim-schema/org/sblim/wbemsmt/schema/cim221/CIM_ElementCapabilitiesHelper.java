/** 
  * CIM_ElementCapabilitiesHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ElementCapabilities
  *    
  * 
  * generated Class
  * @see CIM_ElementCapabilities
  */
...
public class CIM_ElementCapabilitiesHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ElementCapabilities or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ElementCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ElementCapabilities.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ElementCapabilities or the subclasses if deep == true
    */        
    public final static List<CIM_ElementCapabilities> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ElementCapabilities> resultArrayList = new ArrayList<CIM_ElementCapabilities>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ElementCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementCapabilities(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ElementCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ElementCapabilities.");
                        resultArrayList.add(new CIM_ElementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ElementCapabilities.");
                        resultArrayList.add(new CIM_ElementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ElementCapabilities)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementCapabilities.");
                        resultArrayList.add(new CIM_ElementCapabilities(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ElementCapabilities getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ElementCapabilities getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ElementCapabilities dataInstance = null;
        Class<?> clazz = CIM_ElementCapabilitiesHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ElementCapabilities)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementCapabilities.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ElementCapabilities(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ElementCapabilities getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ElementCapabilities.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_ElementCapabilities.CIM_CLASS_NAME); 
                   
                                 setThis = Capabilities != null ? Capabilities.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ElementCapabilities.PROPERTY_CAPABILITIES_CIM_CAPABILITIES.NAME,new CIMDataType(CIM_Capabilities.CIM_CLASS_NAME),setThis,false,false,CIM_ElementCapabilities.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ElementCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ElementCapabilities createInstance(WBEMClient client, CIM_ElementCapabilities dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ElementCapabilities newDataInstance = CIM_ElementCapabilitiesHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ElementCapabilities modifyInstance(WBEMClient client, CIM_ElementCapabilities dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ElementCapabilities dataInstance2 = CIM_ElementCapabilitiesHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ElementCapabilities dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ElementCapabilities.getPackages());
    }
