/**
 * CIM_SubProfileRequiresProfile.java Â© Copyright IBM Corp.  2009,2005 THIS FILE IS PROVIDED UNDER
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: A subprofile requires another
 *            RegisteredProfile for context. This association mandates the scoping relationship
 *            between a subprofile and its scoping profile. generated Class
 */
...
public class CIM_SubProfileRequiresProfile extends CIM_ReferencedProfile {
     ...
     * 
     */
    public static class PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE {
        /**
    ...
    public CIM_SubProfileRequiresProfile(WBEMClient client, String namespace)
    ...
    public CIM_SubProfileRequiresProfile(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_SubProfileRequiresProfile() {
    }
    ...
    protected void init(CIMInstance cimInstance, boolean overwrite) throws WbemsmtException {
        ...
        propertiesToCheck.put("Dependent", new CIMProperty("Dependent", new CIMDataType(
                CIM_RegisteredSubProfile.CIM_CLASS_NAME), null));
    ...
    public static CIMProperty create_Antecedent_CIM_RegisteredProfile(WBEMClient client,
        ...
        CIM_SubProfileRequiresProfile fco = new CIM_SubProfileRequiresProfile(client, namespace);
    ...
    public CIM_RegisteredSubProfile get_Dependent_CIM_RegisteredSubProfile(
            javax.wbem.client.WBEMClient client) throws WbemsmtException {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME);

        if (currentProperty == null || currentProperty.getValue() == null) {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME
                    + " was not found in instance " + getCimObjectPath());
            return null;
        }

        return CIM_RegisteredSubProfileHelper.getInstance(client, (CIMObjectPath) currentProperty
                .getValue());
    ...
    public boolean set_Dependent_CIM_RegisteredSubProfile(CIM_RegisteredSubProfile newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_Dependent_CIM_RegisteredSubProfile(currentProperty,
                    newValue));
            return true;
        }
        else {
    ...
    public static CIMProperty create_Dependent_CIM_RegisteredSubProfile(WBEMClient client,
            String namespace, CIM_RegisteredSubProfile newValue) throws WbemsmtException {
        CIM_SubProfileRequiresProfile fco = new CIM_SubProfileRequiresProfile(client, namespace);
        CIMProperty property = fco.getProperty(PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME);
        if (property != null) {
            property = setPropertyValue_Dependent_CIM_RegisteredSubProfile(property, newValue);
        }
        else {
            logger.warning("Property " + PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME
                    + " was not found in instance " + fco.getCimObjectPath());
    ...
    private static CIMProperty setPropertyValue_Dependent_CIM_RegisteredSubProfile(
            CIMProperty currentProperty, CIM_RegisteredSubProfile newValue) {
        Object setThis = null;
    ...
    public String getObjectName() {
        return CIM_SubProfileRequiresProfile.CIM_CLASS_NAME;
    }
