/** 
  * CIM_ConcreteComponentHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ConcreteComponent
  *    
  * 
  * generated Class
  * @see CIM_ConcreteComponent
  */
...
public class CIM_ConcreteComponentHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ConcreteComponent or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ConcreteComponent.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ConcreteComponent.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ConcreteComponent or the subclasses if deep == true
    */        
    public final static List<CIM_ConcreteComponent> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ConcreteComponent> resultArrayList = new ArrayList<CIM_ConcreteComponent>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ConcreteComponent.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ConcreteComponent(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ConcreteComponentHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ConcreteComponent.");
                        resultArrayList.add(new CIM_ConcreteComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ConcreteComponent.");
                        resultArrayList.add(new CIM_ConcreteComponent(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ConcreteComponent)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ConcreteComponent.");
                        resultArrayList.add(new CIM_ConcreteComponent(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ConcreteComponent getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ConcreteComponent getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ConcreteComponent dataInstance = null;
        Class<?> clazz = CIM_ConcreteComponentHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ConcreteComponent)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ConcreteComponent.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ConcreteComponent(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ConcreteComponent getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ConcreteComponent.PROPERTY_GROUPCOMPONENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_ConcreteComponent.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ConcreteComponent.PROPERTY_PARTCOMPONENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_ConcreteComponent.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ConcreteComponent.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ConcreteComponent createInstance(WBEMClient client, CIM_ConcreteComponent dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ConcreteComponent newDataInstance = CIM_ConcreteComponentHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ConcreteComponent modifyInstance(WBEMClient client, CIM_ConcreteComponent dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ConcreteComponent dataInstance2 = CIM_ConcreteComponentHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ConcreteComponent dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ConcreteComponent.getPackages());
    }
