/** 
  ...
  * 
  * Description: Helper class for CIM_NetworkPort
  *    
  * 
  * generated Class
  * @see CIM_NetworkPort
...
public class CIM_NetworkPortHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_NetworkPort or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_NetworkPort.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_NetworkPort.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_NetworkPort or the subclasses if deep == true
    */        
    public final static List<CIM_NetworkPort> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_NetworkPort> resultArrayList = new ArrayList<CIM_NetworkPort>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_NetworkPort.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_NetworkPort(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_NetworkPortHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_NetworkPort.");
                        resultArrayList.add(new CIM_NetworkPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_NetworkPort.");
                        resultArrayList.add(new CIM_NetworkPort(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_NetworkPort)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_NetworkPort.");
                        resultArrayList.add(new CIM_NetworkPort(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_NetworkPort getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_NetworkPort getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_NetworkPort dataInstance = null;
        Class<?> clazz = CIM_NetworkPortHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_NetworkPort)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_NetworkPort.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_NetworkPort(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_NetworkPort getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_NetworkPort.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_NetworkPort.CIM_CLASS_NAME); 
                   
                   setThis = DeviceID;
                
           keyProperties[1]  = new CIMProperty(CIM_NetworkPort.PROPERTY_DEVICEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_NetworkPort.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_NetworkPort.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_NetworkPort.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(CIM_NetworkPort.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_NetworkPort.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_NetworkPort.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_NetworkPort createInstance(WBEMClient client, CIM_NetworkPort dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_NetworkPort newDataInstance = CIM_NetworkPortHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_NetworkPort modifyInstance(WBEMClient client, CIM_NetworkPort dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_NetworkPort dataInstance2 = CIM_NetworkPortHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_NetworkPort dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_NetworkPort.getPackages());
    }
