/** 
  * CIM_IPProtocolEndpointHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_IPProtocolEndpoint
  *    
  * 
  * generated Class
  * @see CIM_IPProtocolEndpoint
  */
...
public class CIM_IPProtocolEndpointHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_IPProtocolEndpoint or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_IPProtocolEndpoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_IPProtocolEndpoint.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_IPProtocolEndpoint or the subclasses if deep == true
    */        
    public final static List<CIM_IPProtocolEndpoint> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_IPProtocolEndpoint> resultArrayList = new ArrayList<CIM_IPProtocolEndpoint>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_IPProtocolEndpoint.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_IPProtocolEndpoint(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_IPProtocolEndpointHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_IPProtocolEndpoint.");
                        resultArrayList.add(new CIM_IPProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_IPProtocolEndpoint.");
                        resultArrayList.add(new CIM_IPProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_IPProtocolEndpoint)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IPProtocolEndpoint.");
                        resultArrayList.add(new CIM_IPProtocolEndpoint(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_IPProtocolEndpoint getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_IPProtocolEndpoint getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_IPProtocolEndpoint dataInstance = null;
        Class<?> clazz = CIM_IPProtocolEndpointHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_IPProtocolEndpoint)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IPProtocolEndpoint.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_IPProtocolEndpoint(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_IPProtocolEndpoint getInstance(WBEMClient client, String namespace
        ...
        CIMProperty[] keyProperties = new CIMProperty[3];
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_IPProtocolEndpoint.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_IPProtocolEndpoint.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[1]  = new CIMProperty(CIM_IPProtocolEndpoint.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_IPProtocolEndpoint.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[2]  = new CIMProperty(CIM_IPProtocolEndpoint.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_IPProtocolEndpoint.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_IPProtocolEndpoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_IPProtocolEndpoint createInstance(WBEMClient client, CIM_IPProtocolEndpoint dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_IPProtocolEndpoint newDataInstance = CIM_IPProtocolEndpointHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_IPProtocolEndpoint modifyInstance(WBEMClient client, CIM_IPProtocolEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_IPProtocolEndpoint dataInstance2 = CIM_IPProtocolEndpointHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_IPProtocolEndpoint dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_IPProtocolEndpoint.getPackages());
    }
