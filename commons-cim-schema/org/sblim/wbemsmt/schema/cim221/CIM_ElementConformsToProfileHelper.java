/** 
  * CIM_ElementConformsToProfileHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ElementConformsToProfile
  *    
  * 
  * generated Class
  * @see CIM_ElementConformsToProfile
  */
...
public class CIM_ElementConformsToProfileHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ElementConformsToProfile or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ElementConformsToProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ElementConformsToProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ElementConformsToProfile or the subclasses if deep == true
    */        
    public final static List<CIM_ElementConformsToProfile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ElementConformsToProfile> resultArrayList = new ArrayList<CIM_ElementConformsToProfile>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ElementConformsToProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementConformsToProfile(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ElementConformsToProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ElementConformsToProfile.");
                        resultArrayList.add(new CIM_ElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ElementConformsToProfile.");
                        resultArrayList.add(new CIM_ElementConformsToProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ElementConformsToProfile)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementConformsToProfile.");
                        resultArrayList.add(new CIM_ElementConformsToProfile(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ElementConformsToProfile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ElementConformsToProfile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ElementConformsToProfile dataInstance = null;
        Class<?> clazz = CIM_ElementConformsToProfileHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ElementConformsToProfile)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementConformsToProfile.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ElementConformsToProfile(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ElementConformsToProfile getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ElementConformsToProfile.PROPERTY_CONFORMANTSTANDARD_CIM_REGISTEREDPROFILE.NAME,new CIMDataType(CIM_RegisteredProfile.CIM_CLASS_NAME),setThis,false,false,CIM_ElementConformsToProfile.CIM_CLASS_NAME); 
                   
                                 setThis = ManagedElement != null ? ManagedElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ElementConformsToProfile.PROPERTY_MANAGEDELEMENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_ElementConformsToProfile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ElementConformsToProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ElementConformsToProfile createInstance(WBEMClient client, CIM_ElementConformsToProfile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ElementConformsToProfile newDataInstance = CIM_ElementConformsToProfileHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ElementConformsToProfile modifyInstance(WBEMClient client, CIM_ElementConformsToProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ElementConformsToProfile dataInstance2 = CIM_ElementConformsToProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ElementConformsToProfile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ElementConformsToProfile.getPackages());
    }
