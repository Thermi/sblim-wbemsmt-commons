/**
 * CIM_SystemConfiguration.java Â© Copyright IBM Corp.  2009,2005 THIS FILE IS PROVIDED UNDER THE TER
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: Note: Similar to the deprecation of
 *            CIM_Configuration, this peer class is also deprecated in favor of aggregating
 *            instances of Setting or SettingData into "higher-level" Settings or SettingData
 *            objects using the ConcreteComponent association. Deprecated description:
 *            CIM_SystemConfiguration represents the general concept of a CIM_Configuration that is
 *            scoped by a System. This class is a peer of CIM_Configuration because the key
 *            structure of Configuration is currently defined and cannot be modified with additional
 *            properties. generated Class
 */
...
public class CIM_SystemConfiguration extends CIM_ManagedElement {
     ...
     * Note: The use of this element is deprecated. Deprecated description: CreationClassName indicates the name of the class or the subclass used in the creation of an instance. When used with the other key properties of this class, this property allows all instances of this class and its subclasses to be uniquely identified.
     */
