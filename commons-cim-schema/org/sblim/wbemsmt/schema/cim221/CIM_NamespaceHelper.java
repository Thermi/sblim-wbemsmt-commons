/** 
  ...
  * 
  * Description: Helper class for CIM_Namespace
  *    
  * 
  * generated Class
  * @see CIM_Namespace
...
public class CIM_NamespaceHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_Namespace or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_Namespace.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_Namespace.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_Namespace or the subclasses if deep == true
    */        
    public final static List<CIM_Namespace> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_Namespace> resultArrayList = new ArrayList<CIM_Namespace>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Namespace.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Namespace(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_NamespaceHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_Namespace.");
                        resultArrayList.add(new CIM_Namespace(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_Namespace.");
                        resultArrayList.add(new CIM_Namespace(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_Namespace)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_Namespace.");
                        resultArrayList.add(new CIM_Namespace(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_Namespace getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_Namespace getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_Namespace dataInstance = null;
        Class<?> clazz = CIM_NamespaceHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_Namespace)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_Namespace.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_Namespace(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_Namespace getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_Namespace.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Namespace.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(CIM_Namespace.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Namespace.CIM_CLASS_NAME); 
                   
                   setThis = ObjectManagerCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_Namespace.PROPERTY_OBJECTMANAGERCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Namespace.CIM_CLASS_NAME); 
                   
                   setThis = ObjectManagerName;
                
           keyProperties[3]  = new CIMProperty(CIM_Namespace.PROPERTY_OBJECTMANAGERNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Namespace.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[4]  = new CIMProperty(CIM_Namespace.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Namespace.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[5]  = new CIMProperty(CIM_Namespace.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Namespace.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_Namespace.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_Namespace createInstance(WBEMClient client, CIM_Namespace dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_Namespace newDataInstance = CIM_NamespaceHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_Namespace modifyInstance(WBEMClient client, CIM_Namespace dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_Namespace dataInstance2 = CIM_NamespaceHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_Namespace dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_Namespace.getPackages());
    }
