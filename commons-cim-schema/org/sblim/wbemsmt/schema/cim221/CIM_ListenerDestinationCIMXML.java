/**
 * CIM_ListenerDestinationCIMXML.java Â© Copyright IBM Corp. 2006,2007 THIS FILE IS PROVIDED UNDER
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: CIM_ListenerDestinationCIMXML describes the
 *            destination for CIM Export Messages to be delivered via CIM-XML. generated Class
 */
...
public class CIM_ListenerDestinationCIMXML extends CIM_ListenerDestination {
    ...
    public CIM_ListenerDestinationCIMXML(WBEMClient client, String namespace)
    ...
    public CIM_ListenerDestinationCIMXML(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_ListenerDestinationCIMXML() {
    }
    ...
    public static CIMProperty create_Destination(WBEMClient client, String namespace,
        ...
        CIM_ListenerDestinationCIMXML fco = new CIM_ListenerDestinationCIMXML(client, namespace);
    ...
    public String getObjectName() {
        return CIM_ListenerDestinationCIMXML.CIM_CLASS_NAME;
    }
