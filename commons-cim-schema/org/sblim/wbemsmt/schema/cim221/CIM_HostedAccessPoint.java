/**
 * CIM_HostedAccessPoint.java Â© Copyright IBM Corp.  2009,2005 THIS FILE IS PROVIDED UNDER THE TER
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: CIM_HostedAccessPoint is an association
 *            between a Service AccessPoint and the System on which it is provided. The cardinality
 *            of this association is one-to-many and is weak with respect to the System. Each System
 *            can host many ServiceAccessPoints. Heuristic: If the implementation of the
 *            ServiceAccessPoint is modeled, it must be implemented by a Device or SoftwareFeature
 *            that is part of the System that is hosting the ServiceAccessPoint. generated Class
 */
...
public class CIM_HostedAccessPoint extends CIM_HostedDependency {
    ...
    public CIM_HostedAccessPoint(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HostedAccessPoint(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_HostedAccessPoint() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_System(WBEMClient client, String namespace,
        ...
        CIM_HostedAccessPoint fco = new CIM_HostedAccessPoint(client, namespace);
    ...
    public String getObjectName() {
        return CIM_HostedAccessPoint.CIM_CLASS_NAME;
    }
