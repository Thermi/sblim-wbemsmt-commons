/** 
  * CIM_RegisteredProfileHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_RegisteredProfile
  *    
  * 
  * generated Class
  * @see CIM_RegisteredProfile
  */
...
public class CIM_RegisteredProfileHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_RegisteredProfile or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_RegisteredProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_RegisteredProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_RegisteredProfile or the subclasses if deep == true
    */        
    public final static List<CIM_RegisteredProfile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_RegisteredProfile> resultArrayList = new ArrayList<CIM_RegisteredProfile>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_RegisteredProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RegisteredProfile(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_RegisteredProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RegisteredProfile.");
                        resultArrayList.add(new CIM_RegisteredProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RegisteredProfile.");
                        resultArrayList.add(new CIM_RegisteredProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_RegisteredProfile)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RegisteredProfile.");
                        resultArrayList.add(new CIM_RegisteredProfile(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_RegisteredProfile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_RegisteredProfile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_RegisteredProfile dataInstance = null;
        Class<?> clazz = CIM_RegisteredProfileHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_RegisteredProfile)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RegisteredProfile.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_RegisteredProfile(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_RegisteredProfile getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_RegisteredProfile.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_RegisteredProfile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_RegisteredProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_RegisteredProfile createInstance(WBEMClient client, CIM_RegisteredProfile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_RegisteredProfile newDataInstance = CIM_RegisteredProfileHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_RegisteredProfile modifyInstance(WBEMClient client, CIM_RegisteredProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_RegisteredProfile dataInstance2 = CIM_RegisteredProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_RegisteredProfile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_RegisteredProfile.getPackages());
    }
