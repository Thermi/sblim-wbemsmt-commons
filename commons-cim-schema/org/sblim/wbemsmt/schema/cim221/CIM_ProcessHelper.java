/** 
  ...
  * 
  * Description: Helper class for CIM_Process
  *    
  * 
  * generated Class
  * @see CIM_Process
...
public class CIM_ProcessHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_Process or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_Process.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_Process.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_Process or the subclasses if deep == true
    */        
    public final static List<CIM_Process> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_Process> resultArrayList = new ArrayList<CIM_Process>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_Process.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_Process(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ProcessHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_Process.");
                        resultArrayList.add(new CIM_Process(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_Process.");
                        resultArrayList.add(new CIM_Process(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_Process)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_Process.");
                        resultArrayList.add(new CIM_Process(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_Process getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_Process getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_Process dataInstance = null;
        Class<?> clazz = CIM_ProcessHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_Process)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_Process.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_Process(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_Process getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_Process.PROPERTY_CSCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Process.CIM_CLASS_NAME); 
                   
                   setThis = CSName;
                
           keyProperties[1]  = new CIMProperty(CIM_Process.PROPERTY_CSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Process.CIM_CLASS_NAME); 
                   
                   setThis = CreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_Process.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Process.CIM_CLASS_NAME); 
                   
                   setThis = Handle;
                
           keyProperties[3]  = new CIMProperty(CIM_Process.PROPERTY_HANDLE.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Process.CIM_CLASS_NAME); 
                   
                   setThis = OSCreationClassName;
                
           keyProperties[4]  = new CIMProperty(CIM_Process.PROPERTY_OSCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Process.CIM_CLASS_NAME); 
                   
                   setThis = OSName;
                
           keyProperties[5]  = new CIMProperty(CIM_Process.PROPERTY_OSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_Process.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_Process.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_Process createInstance(WBEMClient client, CIM_Process dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_Process newDataInstance = CIM_ProcessHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_Process modifyInstance(WBEMClient client, CIM_Process dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_Process dataInstance2 = CIM_ProcessHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_Process dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_Process.getPackages());
    }
