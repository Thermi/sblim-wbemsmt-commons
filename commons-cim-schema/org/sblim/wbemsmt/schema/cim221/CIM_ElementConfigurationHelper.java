/** 
  * CIM_ElementConfigurationHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ElementConfiguration
  *    
  * 
  * generated Class
  * @see CIM_ElementConfiguration
  */
...
public class CIM_ElementConfigurationHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ElementConfiguration or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ElementConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ElementConfiguration.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ElementConfiguration or the subclasses if deep == true
    */        
    public final static List<CIM_ElementConfiguration> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ElementConfiguration> resultArrayList = new ArrayList<CIM_ElementConfiguration>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ElementConfiguration.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementConfiguration(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ElementConfigurationHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ElementConfiguration.");
                        resultArrayList.add(new CIM_ElementConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ElementConfiguration.");
                        resultArrayList.add(new CIM_ElementConfiguration(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ElementConfiguration)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementConfiguration.");
                        resultArrayList.add(new CIM_ElementConfiguration(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ElementConfiguration getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ElementConfiguration getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ElementConfiguration dataInstance = null;
        Class<?> clazz = CIM_ElementConfigurationHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ElementConfiguration)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementConfiguration.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ElementConfiguration(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ElementConfiguration getInstance(WBEMClient client, String namespace
                                                       ,CIM_ManagedSystemElement Element
                                                       ,CIM_Configuration Configuration
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ElementConfiguration.PROPERTY_ELEMENT_CIM_MANAGEDSYSTEMELEMENT.NAME,new CIMDataType(CIM_ManagedSystemElement.CIM_CLASS_NAME),setThis,false,false,CIM_ElementConfiguration.CIM_CLASS_NAME); 
                   
                                 setThis = Configuration != null ? Configuration.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ElementConfiguration.PROPERTY_CONFIGURATION_CIM_CONFIGURATION.NAME,new CIMDataType(CIM_Configuration.CIM_CLASS_NAME),setThis,false,false,CIM_ElementConfiguration.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ElementConfiguration.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ElementConfiguration createInstance(WBEMClient client, CIM_ElementConfiguration dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ElementConfiguration newDataInstance = CIM_ElementConfigurationHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ElementConfiguration modifyInstance(WBEMClient client, CIM_ElementConfiguration dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ElementConfiguration dataInstance2 = CIM_ElementConfigurationHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ElementConfiguration dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ElementConfiguration.getPackages());
    }
