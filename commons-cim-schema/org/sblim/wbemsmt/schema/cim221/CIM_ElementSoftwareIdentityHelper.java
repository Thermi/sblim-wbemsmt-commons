/** 
  * CIM_ElementSoftwareIdentityHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ElementSoftwareIdentity
  *    
  * 
  * generated Class
  * @see CIM_ElementSoftwareIdentity
  */
...
public class CIM_ElementSoftwareIdentityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ElementSoftwareIdentity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ElementSoftwareIdentity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ElementSoftwareIdentity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ElementSoftwareIdentity or the subclasses if deep == true
    */        
    public final static List<CIM_ElementSoftwareIdentity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ElementSoftwareIdentity> resultArrayList = new ArrayList<CIM_ElementSoftwareIdentity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ElementSoftwareIdentity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementSoftwareIdentity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ElementSoftwareIdentityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ElementSoftwareIdentity.");
                        resultArrayList.add(new CIM_ElementSoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ElementSoftwareIdentity.");
                        resultArrayList.add(new CIM_ElementSoftwareIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ElementSoftwareIdentity)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementSoftwareIdentity.");
                        resultArrayList.add(new CIM_ElementSoftwareIdentity(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ElementSoftwareIdentity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ElementSoftwareIdentity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ElementSoftwareIdentity dataInstance = null;
        Class<?> clazz = CIM_ElementSoftwareIdentityHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ElementSoftwareIdentity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementSoftwareIdentity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ElementSoftwareIdentity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ElementSoftwareIdentity getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ElementSoftwareIdentity.PROPERTY_ANTECEDENT_CIM_SOFTWAREIDENTITY.NAME,new CIMDataType(CIM_SoftwareIdentity.CIM_CLASS_NAME),setThis,false,false,CIM_ElementSoftwareIdentity.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ElementSoftwareIdentity.PROPERTY_DEPENDENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_ElementSoftwareIdentity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ElementSoftwareIdentity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ElementSoftwareIdentity createInstance(WBEMClient client, CIM_ElementSoftwareIdentity dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ElementSoftwareIdentity newDataInstance = CIM_ElementSoftwareIdentityHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ElementSoftwareIdentity modifyInstance(WBEMClient client, CIM_ElementSoftwareIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ElementSoftwareIdentity dataInstance2 = CIM_ElementSoftwareIdentityHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ElementSoftwareIdentity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ElementSoftwareIdentity.getPackages());
    }
