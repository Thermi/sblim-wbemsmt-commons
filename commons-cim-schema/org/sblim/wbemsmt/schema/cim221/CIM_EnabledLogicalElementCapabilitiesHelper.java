/** 
  * CIM_EnabledLogicalElementCapabilitiesHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_EnabledLogicalElementCapabilities
  *    
  * 
  * generated Class
  * @see CIM_EnabledLogicalElementCapabilities
  */
...
public class CIM_EnabledLogicalElementCapabilitiesHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_EnabledLogicalElementCapabilities or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_EnabledLogicalElementCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_EnabledLogicalElementCapabilities.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_EnabledLogicalElementCapabilities or the subclasses if deep == true
    */        
    public final static List<CIM_EnabledLogicalElementCapabilities> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_EnabledLogicalElementCapabilities> resultArrayList = new ArrayList<CIM_EnabledLogicalElementCapabilities>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_EnabledLogicalElementCapabilities.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_EnabledLogicalElementCapabilities(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_EnabledLogicalElementCapabilitiesHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_EnabledLogicalElementCapabilities.");
                        resultArrayList.add(new CIM_EnabledLogicalElementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_EnabledLogicalElementCapabilities.");
                        resultArrayList.add(new CIM_EnabledLogicalElementCapabilities(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_EnabledLogicalElementCapabilities)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_EnabledLogicalElementCapabilities.");
                        resultArrayList.add(new CIM_EnabledLogicalElementCapabilities(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_EnabledLogicalElementCapabilities getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_EnabledLogicalElementCapabilities getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_EnabledLogicalElementCapabilities dataInstance = null;
        Class<?> clazz = CIM_EnabledLogicalElementCapabilitiesHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_EnabledLogicalElementCapabilities)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_EnabledLogicalElementCapabilities.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_EnabledLogicalElementCapabilities(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_EnabledLogicalElementCapabilities getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_EnabledLogicalElementCapabilities.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_EnabledLogicalElementCapabilities.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_EnabledLogicalElementCapabilities.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_EnabledLogicalElementCapabilities createInstance(WBEMClient client, CIM_EnabledLogicalElementCapabilities dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_EnabledLogicalElementCapabilities newDataInstance = CIM_EnabledLogicalElementCapabilitiesHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_EnabledLogicalElementCapabilities modifyInstance(WBEMClient client, CIM_EnabledLogicalElementCapabilities dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_EnabledLogicalElementCapabilities dataInstance2 = CIM_EnabledLogicalElementCapabilitiesHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_EnabledLogicalElementCapabilities dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_EnabledLogicalElementCapabilities.getPackages());
    }
