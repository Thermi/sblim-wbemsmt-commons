/** 
  * CIM_CollectionOfMSEsHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_CollectionOfMSEs
  *    
  * 
  * generated Class
  * @see CIM_CollectionOfMSEs
  */
...
public class CIM_CollectionOfMSEsHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_CollectionOfMSEs or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_CollectionOfMSEs.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_CollectionOfMSEs.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_CollectionOfMSEs or the subclasses if deep == true
    */        
    public final static List<CIM_CollectionOfMSEs> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_CollectionOfMSEs> resultArrayList = new ArrayList<CIM_CollectionOfMSEs>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_CollectionOfMSEs.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CollectionOfMSEs(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_CollectionOfMSEsHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CollectionOfMSEs.");
                        resultArrayList.add(new CIM_CollectionOfMSEs(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CollectionOfMSEs.");
                        resultArrayList.add(new CIM_CollectionOfMSEs(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_CollectionOfMSEs)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CollectionOfMSEs.");
                        resultArrayList.add(new CIM_CollectionOfMSEs(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_CollectionOfMSEs getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_CollectionOfMSEs getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_CollectionOfMSEs dataInstance = null;
        Class<?> clazz = CIM_CollectionOfMSEsHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_CollectionOfMSEs)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CollectionOfMSEs.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_CollectionOfMSEs(cimInstance);
            }
        } catch (Exception e) {
...
//**********************************************************************
    ...
    */    
    public final static void deleteInstance(WBEMClient client, CIM_CollectionOfMSEs dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_CollectionOfMSEs.getPackages());
    }
