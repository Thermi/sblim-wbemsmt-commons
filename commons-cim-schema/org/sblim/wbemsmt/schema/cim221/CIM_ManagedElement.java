...
//**********************************************************************
    ...
    **/
    ...
    /**
     * Get the list with CIM_SoftwareIdentity objects associated by the association CIM_ElementSoftwareIdentity
     * 
     * @param cimClient the WBEMClient for the communication
     *
     ...
     **/
     ...
     public java.util.List<CIM_SoftwareIdentity> getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentitys(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentitys(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_SoftwareIdentity> getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentitys(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<CIM_SoftwareIdentity> getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentitys(WBEMClient cimClient, String associationClass, String resultClass, String role, String resultRole, boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList) throws WbemsmtException {

         if (cimClient == null) {
             throw new WbemsmtException(WbemsmtException.ERR_INVALID_PARAMETER ,"The cimClient parameter does not contain a valid reference.");
         }

         java.util.List<CIM_SoftwareIdentity> result = new java.util.ArrayList<CIM_SoftwareIdentity>();
         CloseableIterator enumeration = null;
         ...
         try {
                 ...
                 if (obj instanceof CIMInstance) {
                     ...
                     if (clazz == null) {
                         System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of the base class.");
                         result.add(new CIM_SoftwareIdentity(cimInstance));
                         continue;
                     }
                     ...
                     try {
                         Object[] actargs = new Object[] {cimInstance};
                         Object dataObj = cons.newInstance(actargs);
                         result.add((CIM_SoftwareIdentity)dataObj);
                     } catch (Exception e) {
                         System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of the base class.");
                         result.add(new CIM_SoftwareIdentity(cimInstance));
                         continue;
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentityNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentityNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTSOFTWAREIDENTITY,
    	                             CIM_SoftwareIdentity.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentityNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_SoftwareIdentity_CIM_ElementSoftwareIdentityNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
