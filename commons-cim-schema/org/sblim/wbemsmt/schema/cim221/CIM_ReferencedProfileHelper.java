/** 
  * CIM_ReferencedProfileHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ReferencedProfile
  *    
  * 
  * generated Class
  * @see CIM_ReferencedProfile
  */
...
public class CIM_ReferencedProfileHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ReferencedProfile or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ReferencedProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ReferencedProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ReferencedProfile or the subclasses if deep == true
    */        
    public final static List<CIM_ReferencedProfile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ReferencedProfile> resultArrayList = new ArrayList<CIM_ReferencedProfile>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ReferencedProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ReferencedProfile(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ReferencedProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ReferencedProfile.");
                        resultArrayList.add(new CIM_ReferencedProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ReferencedProfile.");
                        resultArrayList.add(new CIM_ReferencedProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ReferencedProfile)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ReferencedProfile.");
                        resultArrayList.add(new CIM_ReferencedProfile(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ReferencedProfile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ReferencedProfile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ReferencedProfile dataInstance = null;
        Class<?> clazz = CIM_ReferencedProfileHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ReferencedProfile)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ReferencedProfile.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ReferencedProfile(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ReferencedProfile getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ReferencedProfile.PROPERTY_ANTECEDENT_CIM_REGISTEREDPROFILE.NAME,new CIMDataType(CIM_RegisteredProfile.CIM_CLASS_NAME),setThis,false,false,CIM_ReferencedProfile.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ReferencedProfile.PROPERTY_DEPENDENT_CIM_REGISTEREDPROFILE.NAME,new CIMDataType(CIM_RegisteredProfile.CIM_CLASS_NAME),setThis,false,false,CIM_ReferencedProfile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ReferencedProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ReferencedProfile createInstance(WBEMClient client, CIM_ReferencedProfile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ReferencedProfile newDataInstance = CIM_ReferencedProfileHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ReferencedProfile modifyInstance(WBEMClient client, CIM_ReferencedProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ReferencedProfile dataInstance2 = CIM_ReferencedProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ReferencedProfile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ReferencedProfile.getPackages());
    }
