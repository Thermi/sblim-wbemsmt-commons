/** 
  ...
  * 
  * Description: Helper class for CIM_SettingContext
  *    
  * 
  * generated Class
  * @see CIM_SettingContext
  */
...
public class CIM_SettingContextHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_SettingContext or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SettingContext.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SettingContext.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_SettingContext or the subclasses if deep == true
    */        
    public final static List<CIM_SettingContext> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SettingContext> resultArrayList = new ArrayList<CIM_SettingContext>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SettingContext.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SettingContext(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_SettingContextHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SettingContext)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SettingContext getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SettingContext getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_SettingContext)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SettingContext.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_SettingContext(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_SettingContext getInstance(WBEMClient client, String namespace
                                                       ,CIM_Configuration Context
                                                       ,CIM_Setting Setting
        ...
        Object setThis = null;
                                 ...
                                 setThis = Context != null ? Context.getCimObjectPath() : null;
                           
           keyProperties[0]  = new CIMProperty(CIM_SettingContext.PROPERTY_CONTEXT_CIM_CONFIGURATION.NAME,new CIMDataType(CIM_Configuration.CIM_CLASS_NAME),setThis,false,false,CIM_SettingContext.CIM_CLASS_NAME); 
                   
                                 setThis = Setting != null ? Setting.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_SettingContext.PROPERTY_SETTING_CIM_SETTING.NAME,new CIMDataType(CIM_Setting.CIM_CLASS_NAME),setThis,false,false,CIM_SettingContext.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SettingContext.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SettingContext createInstance(WBEMClient client, CIM_SettingContext dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SettingContext newDataInstance = CIM_SettingContextHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SettingContext modifyInstance(WBEMClient client, CIM_SettingContext dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SettingContext dataInstance2 = CIM_SettingContextHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SettingContext dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SettingContext.getPackages());
    }
