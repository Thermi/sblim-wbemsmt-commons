/** 
  * CIM_RegisteredSubProfileHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_RegisteredSubProfile
  *    
  * 
  * generated Class
  * @see CIM_RegisteredSubProfile
  */
...
public class CIM_RegisteredSubProfileHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_RegisteredSubProfile or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_RegisteredSubProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_RegisteredSubProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_RegisteredSubProfile or the subclasses if deep == true
    */        
    public final static List<CIM_RegisteredSubProfile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_RegisteredSubProfile> resultArrayList = new ArrayList<CIM_RegisteredSubProfile>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_RegisteredSubProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_RegisteredSubProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RegisteredSubProfile.");
                        resultArrayList.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RegisteredSubProfile.");
                        resultArrayList.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_RegisteredSubProfile)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RegisteredSubProfile.");
                        resultArrayList.add(new CIM_RegisteredSubProfile(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_RegisteredSubProfile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_RegisteredSubProfile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_RegisteredSubProfile dataInstance = null;
        Class<?> clazz = CIM_RegisteredSubProfileHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_RegisteredSubProfile)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RegisteredSubProfile.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_RegisteredSubProfile(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_RegisteredSubProfile getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_RegisteredSubProfile.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_RegisteredSubProfile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_RegisteredSubProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_RegisteredSubProfile createInstance(WBEMClient client, CIM_RegisteredSubProfile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_RegisteredSubProfile newDataInstance = CIM_RegisteredSubProfileHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_RegisteredSubProfile modifyInstance(WBEMClient client, CIM_RegisteredSubProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_RegisteredSubProfile dataInstance2 = CIM_RegisteredSubProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_RegisteredSubProfile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_RegisteredSubProfile.getPackages());
    }
