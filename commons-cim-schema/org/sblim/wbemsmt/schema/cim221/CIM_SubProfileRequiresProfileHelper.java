/** 
  * CIM_SubProfileRequiresProfileHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_SubProfileRequiresProfile
  *    
  * 
  * generated Class
  * @see CIM_SubProfileRequiresProfile
  */
...
public class CIM_SubProfileRequiresProfileHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_SubProfileRequiresProfile or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SubProfileRequiresProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SubProfileRequiresProfile.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_SubProfileRequiresProfile or the subclasses if deep == true
    */        
    public final static List<CIM_SubProfileRequiresProfile> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SubProfileRequiresProfile> resultArrayList = new ArrayList<CIM_SubProfileRequiresProfile>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SubProfileRequiresProfile.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_SubProfileRequiresProfileHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_SubProfileRequiresProfile.");
                        resultArrayList.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_SubProfileRequiresProfile.");
                        resultArrayList.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SubProfileRequiresProfile)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SubProfileRequiresProfile.");
                        resultArrayList.add(new CIM_SubProfileRequiresProfile(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SubProfileRequiresProfile getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SubProfileRequiresProfile getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_SubProfileRequiresProfile dataInstance = null;
        Class<?> clazz = CIM_SubProfileRequiresProfileHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_SubProfileRequiresProfile)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SubProfileRequiresProfile.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_SubProfileRequiresProfile(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_SubProfileRequiresProfile getInstance(WBEMClient client, String namespace
                                                       ,CIM_RegisteredProfile Antecedent
                                                       ,CIM_RegisteredSubProfile Dependent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SubProfileRequiresProfile.PROPERTY_ANTECEDENT_CIM_REGISTEREDPROFILE.NAME,new CIMDataType(CIM_RegisteredProfile.CIM_CLASS_NAME),setThis,false,false,CIM_SubProfileRequiresProfile.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_SubProfileRequiresProfile.PROPERTY_DEPENDENT_CIM_REGISTEREDSUBPROFILE.NAME,new CIMDataType(CIM_RegisteredSubProfile.CIM_CLASS_NAME),setThis,false,false,CIM_SubProfileRequiresProfile.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SubProfileRequiresProfile.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SubProfileRequiresProfile createInstance(WBEMClient client, CIM_SubProfileRequiresProfile dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SubProfileRequiresProfile newDataInstance = CIM_SubProfileRequiresProfileHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SubProfileRequiresProfile modifyInstance(WBEMClient client, CIM_SubProfileRequiresProfile dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SubProfileRequiresProfile dataInstance2 = CIM_SubProfileRequiresProfileHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SubProfileRequiresProfile dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SubProfileRequiresProfile.getPackages());
    }
