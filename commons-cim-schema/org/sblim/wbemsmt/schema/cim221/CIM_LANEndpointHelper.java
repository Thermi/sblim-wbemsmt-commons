/** 
  ...
  * 
  * Description: Helper class for CIM_LANEndpoint
  *    
  * 
  * generated Class
  * @see CIM_LANEndpoint
...
public class CIM_LANEndpointHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_LANEndpoint or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_LANEndpoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_LANEndpoint.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_LANEndpoint or the subclasses if deep == true
    */        
    public final static List<CIM_LANEndpoint> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_LANEndpoint> resultArrayList = new ArrayList<CIM_LANEndpoint>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_LANEndpoint.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_LANEndpoint(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_LANEndpointHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_LANEndpoint.");
                        resultArrayList.add(new CIM_LANEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_LANEndpoint.");
                        resultArrayList.add(new CIM_LANEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_LANEndpoint)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_LANEndpoint.");
                        resultArrayList.add(new CIM_LANEndpoint(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_LANEndpoint getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_LANEndpoint getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_LANEndpoint dataInstance = null;
        Class<?> clazz = CIM_LANEndpointHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_LANEndpoint)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_LANEndpoint.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_LANEndpoint(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_LANEndpoint getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_LANEndpoint.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_LANEndpoint.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[1]  = new CIMProperty(CIM_LANEndpoint.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_LANEndpoint.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[2]  = new CIMProperty(CIM_LANEndpoint.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_LANEndpoint.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_LANEndpoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_LANEndpoint createInstance(WBEMClient client, CIM_LANEndpoint dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_LANEndpoint newDataInstance = CIM_LANEndpointHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_LANEndpoint modifyInstance(WBEMClient client, CIM_LANEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_LANEndpoint dataInstance2 = CIM_LANEndpointHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_LANEndpoint dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_LANEndpoint.getPackages());
    }
