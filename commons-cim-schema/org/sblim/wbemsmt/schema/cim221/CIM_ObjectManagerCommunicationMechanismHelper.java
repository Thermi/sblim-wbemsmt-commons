/** 
  * CIM_ObjectManagerCommunicationMechanismHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ObjectManagerCommunicationMechanism
  *    
  * 
  * generated Class
  * @see CIM_ObjectManagerCommunicationMechanism
  */
...
public class CIM_ObjectManagerCommunicationMechanismHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ObjectManagerCommunicationMechanism or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ObjectManagerCommunicationMechanism or the subclasses if deep == true
    */        
    public final static List<CIM_ObjectManagerCommunicationMechanism> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ObjectManagerCommunicationMechanism> resultArrayList = new ArrayList<CIM_ObjectManagerCommunicationMechanism>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ObjectManagerCommunicationMechanismHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ObjectManagerCommunicationMechanism.");
                        resultArrayList.add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ObjectManagerCommunicationMechanism.");
                        resultArrayList.add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ObjectManagerCommunicationMechanism)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ObjectManagerCommunicationMechanism.");
                        resultArrayList.add(new CIM_ObjectManagerCommunicationMechanism(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ObjectManagerCommunicationMechanism getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ObjectManagerCommunicationMechanism getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ObjectManagerCommunicationMechanism dataInstance = null;
        Class<?> clazz = CIM_ObjectManagerCommunicationMechanismHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ObjectManagerCommunicationMechanism)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ObjectManagerCommunicationMechanism.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ObjectManagerCommunicationMechanism(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ObjectManagerCommunicationMechanism getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ObjectManagerCommunicationMechanism.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(CIM_ObjectManagerCommunicationMechanism.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_ObjectManagerCommunicationMechanism.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(CIM_ObjectManagerCommunicationMechanism.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ObjectManagerCommunicationMechanism createInstance(WBEMClient client, CIM_ObjectManagerCommunicationMechanism dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ObjectManagerCommunicationMechanism newDataInstance = CIM_ObjectManagerCommunicationMechanismHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ObjectManagerCommunicationMechanism modifyInstance(WBEMClient client, CIM_ObjectManagerCommunicationMechanism dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ObjectManagerCommunicationMechanism dataInstance2 = CIM_ObjectManagerCommunicationMechanismHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ObjectManagerCommunicationMechanism dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ObjectManagerCommunicationMechanism.getPackages());
    }
