/** 
  * CIM_ProtocolEndpointHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ProtocolEndpoint
  *    
  * 
  * generated Class
  * @see CIM_ProtocolEndpoint
  */
...
public class CIM_ProtocolEndpointHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ProtocolEndpoint or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ProtocolEndpoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ProtocolEndpoint.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ProtocolEndpoint or the subclasses if deep == true
    */        
    public final static List<CIM_ProtocolEndpoint> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ProtocolEndpoint> resultArrayList = new ArrayList<CIM_ProtocolEndpoint>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ProtocolEndpoint.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ProtocolEndpoint(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ProtocolEndpointHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ProtocolEndpoint.");
                        resultArrayList.add(new CIM_ProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ProtocolEndpoint.");
                        resultArrayList.add(new CIM_ProtocolEndpoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ProtocolEndpoint)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ProtocolEndpoint.");
                        resultArrayList.add(new CIM_ProtocolEndpoint(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ProtocolEndpoint getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ProtocolEndpoint getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ProtocolEndpoint dataInstance = null;
        Class<?> clazz = CIM_ProtocolEndpointHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ProtocolEndpoint)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ProtocolEndpoint.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ProtocolEndpoint(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ProtocolEndpoint getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ProtocolEndpoint.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ProtocolEndpoint.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[1]  = new CIMProperty(CIM_ProtocolEndpoint.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ProtocolEndpoint.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[2]  = new CIMProperty(CIM_ProtocolEndpoint.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_ProtocolEndpoint.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ProtocolEndpoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ProtocolEndpoint createInstance(WBEMClient client, CIM_ProtocolEndpoint dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ProtocolEndpoint newDataInstance = CIM_ProtocolEndpointHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ProtocolEndpoint modifyInstance(WBEMClient client, CIM_ProtocolEndpoint dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ProtocolEndpoint dataInstance2 = CIM_ProtocolEndpointHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ProtocolEndpoint dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ProtocolEndpoint.getPackages());
    }
