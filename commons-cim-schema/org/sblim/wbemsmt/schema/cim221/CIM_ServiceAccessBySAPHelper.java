/** 
  * CIM_ServiceAccessBySAPHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ServiceAccessBySAP
  *    
  * 
  * generated Class
  * @see CIM_ServiceAccessBySAP
  */
...
public class CIM_ServiceAccessBySAPHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ServiceAccessBySAP or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ServiceAccessBySAP.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ServiceAccessBySAP.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ServiceAccessBySAP or the subclasses if deep == true
    */        
    public final static List<CIM_ServiceAccessBySAP> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ServiceAccessBySAP> resultArrayList = new ArrayList<CIM_ServiceAccessBySAP>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ServiceAccessBySAP.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ServiceAccessBySAPHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ServiceAccessBySAP(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ServiceAccessBySAP)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ServiceAccessBySAP.");
                        resultArrayList.add(new CIM_ServiceAccessBySAP(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ServiceAccessBySAP getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ServiceAccessBySAP getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ServiceAccessBySAP dataInstance = null;
        Class<?> clazz = CIM_ServiceAccessBySAPHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ServiceAccessBySAP)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ServiceAccessBySAP.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ServiceAccessBySAP(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ServiceAccessBySAP getInstance(WBEMClient client, String namespace
                                                       ,CIM_Service Antecedent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ServiceAccessBySAP.PROPERTY_ANTECEDENT_CIM_SERVICE.NAME,new CIMDataType(CIM_Service.CIM_CLASS_NAME),setThis,false,false,CIM_ServiceAccessBySAP.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ServiceAccessBySAP.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,new CIMDataType(CIM_ServiceAccessPoint.CIM_CLASS_NAME),setThis,false,false,CIM_ServiceAccessBySAP.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ServiceAccessBySAP.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ServiceAccessBySAP createInstance(WBEMClient client, CIM_ServiceAccessBySAP dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ServiceAccessBySAP newDataInstance = CIM_ServiceAccessBySAPHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ServiceAccessBySAP modifyInstance(WBEMClient client, CIM_ServiceAccessBySAP dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ServiceAccessBySAP dataInstance2 = CIM_ServiceAccessBySAPHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ServiceAccessBySAP dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ServiceAccessBySAP.getPackages());
    }
