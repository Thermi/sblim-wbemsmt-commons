/** 
  * CIM_NamespaceInManagerHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_NamespaceInManager
  *    
  * 
  * generated Class
  * @see CIM_NamespaceInManager
  */
...
public class CIM_NamespaceInManagerHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_NamespaceInManager or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_NamespaceInManager.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_NamespaceInManager.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_NamespaceInManager or the subclasses if deep == true
    */        
    public final static List<CIM_NamespaceInManager> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_NamespaceInManager> resultArrayList = new ArrayList<CIM_NamespaceInManager>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_NamespaceInManager.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_NamespaceInManager(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_NamespaceInManagerHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_NamespaceInManager.");
                        resultArrayList.add(new CIM_NamespaceInManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_NamespaceInManager.");
                        resultArrayList.add(new CIM_NamespaceInManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_NamespaceInManager)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_NamespaceInManager.");
                        resultArrayList.add(new CIM_NamespaceInManager(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_NamespaceInManager getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_NamespaceInManager getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_NamespaceInManager dataInstance = null;
        Class<?> clazz = CIM_NamespaceInManagerHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_NamespaceInManager)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_NamespaceInManager.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_NamespaceInManager(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_NamespaceInManager getInstance(WBEMClient client, String namespace
                                                       ,CIM_ObjectManager Antecedent
                                                       ,CIM_Namespace Dependent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_NamespaceInManager.PROPERTY_ANTECEDENT_CIM_OBJECTMANAGER.NAME,new CIMDataType(CIM_ObjectManager.CIM_CLASS_NAME),setThis,false,false,CIM_NamespaceInManager.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_NamespaceInManager.PROPERTY_DEPENDENT_CIM_NAMESPACE.NAME,new CIMDataType(CIM_Namespace.CIM_CLASS_NAME),setThis,false,false,CIM_NamespaceInManager.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_NamespaceInManager.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_NamespaceInManager createInstance(WBEMClient client, CIM_NamespaceInManager dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_NamespaceInManager newDataInstance = CIM_NamespaceInManagerHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_NamespaceInManager modifyInstance(WBEMClient client, CIM_NamespaceInManager dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_NamespaceInManager dataInstance2 = CIM_NamespaceInManagerHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_NamespaceInManager dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_NamespaceInManager.getPackages());
    }
