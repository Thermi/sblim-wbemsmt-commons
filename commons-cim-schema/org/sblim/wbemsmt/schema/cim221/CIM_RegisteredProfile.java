...
//**********************************************************************
    ...
    **/
     ...
     **/
     ...
     public java.util.List<CIM_RegisteredSubProfile> getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_RegisteredSubProfile> getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<CIM_RegisteredSubProfile> getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfiles(WBEMClient cimClient, String associationClass, String resultClass, String role, String resultRole, boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList) throws WbemsmtException {

         if (cimClient == null) {
             throw new WbemsmtException(WbemsmtException.ERR_INVALID_PARAMETER ,"The cimClient parameter does not contain a valid reference.");
         }

         java.util.List<CIM_RegisteredSubProfile> result = new java.util.ArrayList<CIM_RegisteredSubProfile>();
         CloseableIterator enumeration = null;
         ...
         try {
                 ...
                 if (obj instanceof CIMInstance) {
                     ...
                     try {
                         Object[] actargs = new Object[] {cimInstance};
                         Object dataObj = cons.newInstance(actargs);
                         result.add((CIM_RegisteredSubProfile)dataObj);
                     } catch (Exception e) {
                         System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of the base class.");
                         result.add(new CIM_RegisteredSubProfile(cimInstance));
                         continue;
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_CIM_SUBPROFILEREQUIRESPROFILE,
    	                             CIM_RegisteredSubProfile.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_RegisteredSubProfile_CIM_SubProfileRequiresProfileNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
