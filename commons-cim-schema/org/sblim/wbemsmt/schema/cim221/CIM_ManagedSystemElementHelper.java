/** 
  * CIM_ManagedSystemElementHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_ManagedSystemElement
  *    
  * 
  * generated Class
  * @see CIM_ManagedSystemElement
  */
...
public class CIM_ManagedSystemElementHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ManagedSystemElement or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ManagedSystemElement.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ManagedSystemElement.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ManagedSystemElement or the subclasses if deep == true
    */        
    public final static List<CIM_ManagedSystemElement> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ManagedSystemElement> resultArrayList = new ArrayList<CIM_ManagedSystemElement>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ManagedSystemElement.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ManagedSystemElement(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ManagedSystemElementHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ManagedSystemElement.");
                        resultArrayList.add(new CIM_ManagedSystemElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ManagedSystemElement.");
                        resultArrayList.add(new CIM_ManagedSystemElement(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ManagedSystemElement)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ManagedSystemElement.");
                        resultArrayList.add(new CIM_ManagedSystemElement(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ManagedSystemElement getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ManagedSystemElement getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ManagedSystemElement dataInstance = null;
        Class<?> clazz = CIM_ManagedSystemElementHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ManagedSystemElement)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ManagedSystemElement.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ManagedSystemElement(cimInstance);
            }
        } catch (Exception e) {
...
//**********************************************************************
    ...
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ManagedSystemElement dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ManagedSystemElement.getPackages());
    }
