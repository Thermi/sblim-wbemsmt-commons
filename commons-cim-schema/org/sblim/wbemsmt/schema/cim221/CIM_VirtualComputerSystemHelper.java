/** 
  * CIM_VirtualComputerSystemHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_VirtualComputerSystem
  *    
  * 
  * generated Class
  * @see CIM_VirtualComputerSystem
  */
...
public class CIM_VirtualComputerSystemHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_VirtualComputerSystem or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_VirtualComputerSystem.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_VirtualComputerSystem.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_VirtualComputerSystem or the subclasses if deep == true
    */        
    public final static List<CIM_VirtualComputerSystem> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_VirtualComputerSystem> resultArrayList = new ArrayList<CIM_VirtualComputerSystem>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_VirtualComputerSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_VirtualComputerSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_VirtualComputerSystem.");
                        resultArrayList.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_VirtualComputerSystem.");
                        resultArrayList.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_VirtualComputerSystem)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualComputerSystem.");
                        resultArrayList.add(new CIM_VirtualComputerSystem(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_VirtualComputerSystem getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_VirtualComputerSystem getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_VirtualComputerSystem dataInstance = null;
        Class<?> clazz = CIM_VirtualComputerSystemHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_VirtualComputerSystem)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_VirtualComputerSystem.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_VirtualComputerSystem(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_VirtualComputerSystem getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_VirtualComputerSystem.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualComputerSystem.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(CIM_VirtualComputerSystem.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_VirtualComputerSystem.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_VirtualComputerSystem.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_VirtualComputerSystem createInstance(WBEMClient client, CIM_VirtualComputerSystem dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_VirtualComputerSystem newDataInstance = CIM_VirtualComputerSystemHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_VirtualComputerSystem modifyInstance(WBEMClient client, CIM_VirtualComputerSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_VirtualComputerSystem dataInstance2 = CIM_VirtualComputerSystemHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_VirtualComputerSystem dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_VirtualComputerSystem.getPackages());
    }
