/**
 * CIM_HostedDependency.java Â© Copyright IBM Corp. 2006,2007 THIS FILE IS PROVIDED UNDER THE TER MS
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: HostedDependency defines a ManagedElement in
 *            the context of another ManagedElement in which it resides. generated Class
 */
...
public class CIM_HostedDependency extends CIM_Dependency {
    ...
    public CIM_HostedDependency(WBEMClient client, String namespace) throws WbemsmtException {
    ...
    public CIM_HostedDependency(CIMInstance cimInstance) throws WbemsmtException {
     ...
     * Default constructor
     */
    protected CIM_HostedDependency() {
    }
    ...
    public static CIMProperty create_Antecedent_CIM_ManagedElement(WBEMClient client,
        ...
        CIM_HostedDependency fco = new CIM_HostedDependency(client, namespace);
    ...
    public String getObjectName() {
        return CIM_HostedDependency.CIM_CLASS_NAME;
    }
