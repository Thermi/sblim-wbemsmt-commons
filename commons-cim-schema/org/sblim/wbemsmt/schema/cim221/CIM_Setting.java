...
//**********************************************************************
   ...
   {
              propertiesToCheck.put("SettingID",new CIMProperty("SettingID",CIMDataType.STRING_T,null));
...
//**********************************************************************
   ...
   public String get_SettingID()    {
       ...
       if (currentProperty == null || currentProperty.getValue() == null) {
           logger.warning("Property " + PROPERTY_SETTINGID.NAME + " was not found in instance " + getCimObjectPath());
           return null;
       }
   ...
   public boolean set_SettingID(String newValue)
   {
    ...
    public static CIMProperty create_SettingID(WBEMClient client, String namespace, String newValue) throws WbemsmtException {
        ...
        if (property != null)
        {
       	 ...
       	 {
       	 		   logger.warning("Property " + PROPERTY_SETTINGID.NAME + " was not found in instance " + fco.getCimObjectPath());
       	 }
        return property;
    }
   ...
   private static CIMProperty setPropertyValue_SettingID(CIMProperty currentProperty, String newValue)
   {
        Object setThis = null;        
...
//**********************************************************************
     ...
     **/
     ...
     public java.util.List<CIM_ManagedSystemElement> getAssociated_CIM_ManagedSystemElement_CIM_ElementSettings(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_ManagedSystemElement_CIM_ElementSettings(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_ManagedSystemElement> getAssociated_CIM_ManagedSystemElement_CIM_ElementSettings(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedSystemElement_CIM_ElementSettingNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_CIM_ManagedSystemElement_CIM_ElementSettingNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_CIM_ELEMENTSETTING,
    	                             CIM_ManagedSystemElement.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedSystemElement_CIM_ElementSettingNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_ManagedSystemElement_CIM_ElementSettingNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
     ...
     **/
     ...
     public java.util.List<CIM_Configuration> getAssociated_CIM_Configuration_CIM_SettingContexts(WBEMClient cimClient) throws WbemsmtException {
     
     	   return getAssociated_CIM_Configuration_CIM_SettingContexts(
     	                cimClient,
     ...
     **/
     ...
     public java.util.List<CIM_Configuration> getAssociated_CIM_Configuration_CIM_SettingContexts(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
     ...
     **/
     ...
     public java.util.List<CIM_Configuration> getAssociated_CIM_Configuration_CIM_SettingContexts(WBEMClient cimClient, String associationClass, String resultClass, String role, String resultRole, boolean includeQualifiers, boolean includeClassOrigin, java.lang.String[] propertyList) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_Configuration_CIM_SettingContextNames(WBEMClient cimClient) throws WbemsmtException {
    
    	    return getAssociated_CIM_Configuration_CIM_SettingContextNames (
    	                             cimClient,
    	                             true,
    	                             CIM_ASSOCIATOR_CLASS_NAME_CIM_SETTINGCONTEXT,
    	                             CIM_Configuration.CIM_CLASS_NAME,
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_Configuration_CIM_SettingContextNames(WBEMClient cimClient,String resultClass, String role, String resultRole) throws WbemsmtException {
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociated_CIM_Configuration_CIM_SettingContextNames(WBEMClient cimClient,boolean deep,String associationClass, String resultClass, String role, String resultRole) throws WbemsmtException {
   ...
   public java.util.List<CIM_SettingContext> getAssociations_CIM_SettingContext(WBEMClient cimClient, boolean includeQualifiers, boolean includeClassOrigin, String role,java.lang.String[] propertyList) throws WbemsmtException {

       if (cimClient == null) {
            throw new WbemsmtException(WbemsmtException.ERR_INVALID_PARAMETER ,"The cimClient parameter does not contain a valid reference.");
       }

       java.util.List<CIM_SettingContext> result = new java.util.ArrayList<CIM_SettingContext>();
       CloseableIterator enumeration = null;
          ...
          while (enumeration.hasNext()) {
             ...
             if (obj instanceof CIMInstance) {
                ...
                try {
                   Object[] actargs = new Object[] {cimInstance};
                   Object dataObj = cons.newInstance(actargs);
                   result.add((CIM_SettingContext)dataObj);
                } catch (Exception e) {
                   System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of the base class.");
                   result.add(new CIM_SettingContext(cimInstance));
                   continue;
    ...
    **/
    ...
    public java.util.List<CIMObjectPath> getAssociationNames_CIM_SettingContext(WBEMClient cimClient,String role, boolean deep) throws WbemsmtException {
        ...
        try {
                while (enumeration.hasNext()) {
                   ...
                   if (obj instanceof CIMObjectPath) {
                      if (deep || ((CIMObjectPath)obj).getObjectName().equals(CIM_SettingContext.CIM_CLASS_NAME)) {
                         result.add((CIMObjectPath)obj);
                      }
                   }
                }
...
//**********************************************************************                         
    ...
    public ApplyIncrementalChangeToCollectionResult invoke_ApplyIncrementalChangeToCollection(WBEMClient cimClient
                                 ,CIM_CollectionOfMSEs Collection
                      ,javax.cim.CIMDateTime TimeToApply
                      ,Boolean ContinueOnError
                      ,javax.cim.CIMDateTime MustBeCompletedBy
       ...
       CIMArgument[] outParameter = new CIMArgument[1];
                    ...
                    inParameter[0] = ( Collection == null ? null : new CIMArgument("Collection", new CIMDataType(CIM_CollectionOfMSEs.CIM_CLASS_NAME), Collection.getCimObjectPath()) );
       
                    inParameter[1] = ( TimeToApply == null ? null : new CIMArgument("TimeToApply", CIMDataType.DATETIME_T, TimeToApply) );
       
                    inParameter[2] = ( ContinueOnError == null ? null : new CIMArgument("ContinueOnError", CIMDataType.BOOLEAN_T, ContinueOnError) );
       
                    inParameter[3] = ( MustBeCompletedBy == null ? null : new CIMArgument("MustBeCompletedBy", CIMDataType.DATETIME_T, MustBeCompletedBy) );
       
                    inParameter[4] = ( PropertiesToApply == null ? null : new CIMArgument("PropertiesToApply", CIMDataType.STRING_ARRAY_T, PropertiesToApply) );
       ...
       try {
           Object oResult =  cimClient.invokeMethod(           	                                            this.getCimObjectPath()
           	                                         , 
                                                    METHOD_APPLYINCREMENTALCHANGETOCOLLECTION.NAME,
                                                    inParameter,
                                                    outParameter);
           if (oResult != null)
           {
   ...
   public static class ApplyIncrementalChangeToCollectionResult
   {
    ...
    public ApplyIncrementalChangeToMSEResult invoke_ApplyIncrementalChangeToMSE(WBEMClient cimClient
       ...
       CIMArgument[] outParameter = new CIMArgument[0];
                    ...
                    inParameter[0] = ( MSE == null ? null : new CIMArgument("MSE", new CIMDataType(CIM_ManagedSystemElement.CIM_CLASS_NAME), MSE.getCimObjectPath()) );
       
                    inParameter[1] = ( TimeToApply == null ? null : new CIMArgument("TimeToApply", CIMDataType.DATETIME_T, TimeToApply) );
       
                    inParameter[2] = ( MustBeCompletedBy == null ? null : new CIMArgument("MustBeCompletedBy", CIMDataType.DATETIME_T, MustBeCompletedBy) );
       
                    inParameter[3] = ( PropertiesToApply == null ? null : new CIMArgument("PropertiesToApply", CIMDataType.STRING_ARRAY_T, PropertiesToApply) );
       ...
       try {
           Object oResult =  cimClient.invokeMethod(           	                                            this.getCimObjectPath()
           	                                         , 
                                                    METHOD_APPLYINCREMENTALCHANGETOMSE.NAME,
                                                    inParameter,
                                                    outParameter);
           if (oResult != null)
           {
   ...
   public static class ApplyToCollectionResult
   {
    ...
    public ApplyToMSEResult invoke_ApplyToMSE(WBEMClient cimClient
                                 ,CIM_ManagedSystemElement MSE
                      ,javax.cim.CIMDateTime TimeToApply
                      ,javax.cim.CIMDateTime MustBeCompletedBy
                      ) throws WbemsmtException {
   ...
   public static class ApplyToMSEResult
   {
    ...
    public VerifyOKToApplyIncrementalChangeToCollectionResult invoke_VerifyOKToApplyIncrementalChangeToCollection(WBEMClient cimClient
                                 ,CIM_CollectionOfMSEs Collection
                      ,javax.cim.CIMDateTime TimeToApply
                      ,javax.cim.CIMDateTime MustBeCompletedBy
                      ,String[] PropertiesToApply
       ...
       try {
           Object oResult =  cimClient.invokeMethod(           	                                            this.getCimObjectPath()
           	                                         , 
                                                    METHOD_VERIFYOKTOAPPLYINCREMENTALCHANGETOCOLLECTION.NAME,
                                                    inParameter,
                                                    outParameter);
           if (oResult != null)
           {
   ...
   public static class VerifyOKToApplyIncrementalChangeToCollectionResult
   {
    ...
    public VerifyOKToApplyIncrementalChangeToMSEResult invoke_VerifyOKToApplyIncrementalChangeToMSE(WBEMClient cimClient
                                 ,CIM_ManagedSystemElement MSE
                      ,javax.cim.CIMDateTime TimeToApply
                      ,javax.cim.CIMDateTime MustBeCompletedBy
                      ,String[] PropertiesToApply
       ...
       try {
           Object oResult =  cimClient.invokeMethod(           	                                            this.getCimObjectPath()
           	                                         , 
                                                    METHOD_VERIFYOKTOAPPLYINCREMENTALCHANGETOMSE.NAME,
                                                    inParameter,
                                                    outParameter);
           if (oResult != null)
           {
   ...
   public static class VerifyOKToApplyIncrementalChangeToMSEResult
   {
    ...
    public VerifyOKToApplyToCollectionResult invoke_VerifyOKToApplyToCollection(WBEMClient cimClient
                                 ,CIM_CollectionOfMSEs Collection
                      ,javax.cim.CIMDateTime TimeToApply
                      ,javax.cim.CIMDateTime MustBeCompletedBy
                      ) throws WbemsmtException {
       ...
       try {
           Object oResult =  cimClient.invokeMethod(           	                                            this.getCimObjectPath()
           	                                         , 
                                                    METHOD_VERIFYOKTOAPPLYTOCOLLECTION.NAME,
                                                    inParameter,
                                                    outParameter);
           if (oResult != null)
           {
   ...
   public static class VerifyOKToApplyToCollectionResult
   {
    ...
    public VerifyOKToApplyToMSEResult invoke_VerifyOKToApplyToMSE(WBEMClient cimClient
       ...
       try {
           Object oResult =  cimClient.invokeMethod(           	                                            this.getCimObjectPath()
           	                                         , 
                                                    METHOD_VERIFYOKTOAPPLYTOMSE.NAME,
                                                    inParameter,
                                                    outParameter);
           if (oResult != null)
           {
