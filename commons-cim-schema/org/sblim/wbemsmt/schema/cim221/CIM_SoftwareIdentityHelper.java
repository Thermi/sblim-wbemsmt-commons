/** 
  ...
  * 
  * Description: Helper class for CIM_SoftwareIdentity
  *    
  * 
  * generated Class
  * @see CIM_SoftwareIdentity
  */
...
public class CIM_SoftwareIdentityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_SoftwareIdentity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_SoftwareIdentity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_SoftwareIdentity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_SoftwareIdentity or the subclasses if deep == true
    */        
    public final static List<CIM_SoftwareIdentity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_SoftwareIdentity> resultArrayList = new ArrayList<CIM_SoftwareIdentity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_SoftwareIdentity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_SoftwareIdentity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_SoftwareIdentityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_SoftwareIdentity)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_SoftwareIdentity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_SoftwareIdentity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_SoftwareIdentity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_SoftwareIdentity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_SoftwareIdentity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_SoftwareIdentity getInstance(WBEMClient client, String namespace
                                                       ,String InstanceID
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_SoftwareIdentity.PROPERTY_INSTANCEID.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_SoftwareIdentity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_SoftwareIdentity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_SoftwareIdentity createInstance(WBEMClient client, CIM_SoftwareIdentity dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_SoftwareIdentity newDataInstance = CIM_SoftwareIdentityHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_SoftwareIdentity modifyInstance(WBEMClient client, CIM_SoftwareIdentity dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_SoftwareIdentity dataInstance2 = CIM_SoftwareIdentityHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_SoftwareIdentity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_SoftwareIdentity.getPackages());
    }
