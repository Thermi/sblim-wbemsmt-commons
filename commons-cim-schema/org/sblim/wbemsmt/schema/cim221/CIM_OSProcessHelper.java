/** 
  ...
  * 
  * Description: Helper class for CIM_OSProcess
  *    
  * 
  * generated Class
  * @see CIM_OSProcess
...
public class CIM_OSProcessHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_OSProcess or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_OSProcess.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_OSProcess.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_OSProcess or the subclasses if deep == true
    */        
    public final static List<CIM_OSProcess> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_OSProcess> resultArrayList = new ArrayList<CIM_OSProcess>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_OSProcess.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_OSProcess(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_OSProcessHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_OSProcess.");
                        resultArrayList.add(new CIM_OSProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_OSProcess.");
                        resultArrayList.add(new CIM_OSProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_OSProcess)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OSProcess.");
                        resultArrayList.add(new CIM_OSProcess(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_OSProcess getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_OSProcess getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_OSProcess dataInstance = null;
        Class<?> clazz = CIM_OSProcessHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_OSProcess)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OSProcess.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_OSProcess(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_OSProcess getInstance(WBEMClient client, String namespace
                                                       ,CIM_OperatingSystem GroupComponent
                                                       ,CIM_Process PartComponent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_OSProcess.PROPERTY_GROUPCOMPONENT_CIM_OPERATINGSYSTEM.NAME,new CIMDataType(CIM_OperatingSystem.CIM_CLASS_NAME),setThis,false,false,CIM_OSProcess.CIM_CLASS_NAME); 
                   
                                 setThis = PartComponent != null ? PartComponent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_OSProcess.PROPERTY_PARTCOMPONENT_CIM_PROCESS.NAME,new CIMDataType(CIM_Process.CIM_CLASS_NAME),setThis,false,false,CIM_OSProcess.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_OSProcess.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_OSProcess createInstance(WBEMClient client, CIM_OSProcess dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_OSProcess newDataInstance = CIM_OSProcessHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_OSProcess modifyInstance(WBEMClient client, CIM_OSProcess dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_OSProcess dataInstance2 = CIM_OSProcessHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_OSProcess dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_OSProcess.getPackages());
    }
