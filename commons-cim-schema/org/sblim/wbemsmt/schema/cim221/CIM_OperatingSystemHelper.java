/** 
  ...
  * 
  * Description: Helper class for CIM_OperatingSystem
  *    
  * 
  * generated Class
  * @see CIM_OperatingSystem
  */
...
public class CIM_OperatingSystemHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_OperatingSystem or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_OperatingSystem.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_OperatingSystem.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_OperatingSystem or the subclasses if deep == true
    */        
    public final static List<CIM_OperatingSystem> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_OperatingSystem> resultArrayList = new ArrayList<CIM_OperatingSystem>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_OperatingSystem.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_OperatingSystem(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_OperatingSystemHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_OperatingSystem)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_OperatingSystem getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_OperatingSystem getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_OperatingSystem)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_OperatingSystem.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_OperatingSystem(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_OperatingSystem getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_OperatingSystem.PROPERTY_CSCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_OperatingSystem.CIM_CLASS_NAME); 
                   
                   setThis = CSName;
                
           keyProperties[1]  = new CIMProperty(CIM_OperatingSystem.PROPERTY_CSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_OperatingSystem.CIM_CLASS_NAME); 
                   
                   setThis = CreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_OperatingSystem.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_OperatingSystem.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[3]  = new CIMProperty(CIM_OperatingSystem.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_OperatingSystem.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_OperatingSystem.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_OperatingSystem createInstance(WBEMClient client, CIM_OperatingSystem dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_OperatingSystem newDataInstance = CIM_OperatingSystemHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_OperatingSystem modifyInstance(WBEMClient client, CIM_OperatingSystem dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_OperatingSystem dataInstance2 = CIM_OperatingSystemHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_OperatingSystem dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_OperatingSystem.getPackages());
    }
