/** 
  * CIM_CIMXMLCommunicationMechanismHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_CIMXMLCommunicationMechanism
  *    
  * 
  * generated Class
  * @see CIM_CIMXMLCommunicationMechanism
  */
...
public class CIM_CIMXMLCommunicationMechanismHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_CIMXMLCommunicationMechanism or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_CIMXMLCommunicationMechanism or the subclasses if deep == true
    */        
    public final static List<CIM_CIMXMLCommunicationMechanism> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_CIMXMLCommunicationMechanism> resultArrayList = new ArrayList<CIM_CIMXMLCommunicationMechanism>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_CIMXMLCommunicationMechanismHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CIMXMLCommunicationMechanism.");
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CIMXMLCommunicationMechanism.");
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_CIMXMLCommunicationMechanism)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CIMXMLCommunicationMechanism.");
                        resultArrayList.add(new CIM_CIMXMLCommunicationMechanism(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_CIMXMLCommunicationMechanism getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_CIMXMLCommunicationMechanism getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_CIMXMLCommunicationMechanism dataInstance = null;
        Class<?> clazz = CIM_CIMXMLCommunicationMechanismHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_CIMXMLCommunicationMechanism)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CIMXMLCommunicationMechanism.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_CIMXMLCommunicationMechanism(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_CIMXMLCommunicationMechanism getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_CIMXMLCommunicationMechanism.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME); 
                   
                   setThis = Name;
                
           keyProperties[1]  = new CIMProperty(CIM_CIMXMLCommunicationMechanism.PROPERTY_NAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME); 
                   
                   setThis = SystemCreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_CIMXMLCommunicationMechanism.PROPERTY_SYSTEMCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME); 
                   
                   setThis = SystemName;
                
           keyProperties[3]  = new CIMProperty(CIM_CIMXMLCommunicationMechanism.PROPERTY_SYSTEMNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_CIMXMLCommunicationMechanism.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_CIMXMLCommunicationMechanism createInstance(WBEMClient client, CIM_CIMXMLCommunicationMechanism dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_CIMXMLCommunicationMechanism newDataInstance = CIM_CIMXMLCommunicationMechanismHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_CIMXMLCommunicationMechanism modifyInstance(WBEMClient client, CIM_CIMXMLCommunicationMechanism dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_CIMXMLCommunicationMechanism dataInstance2 = CIM_CIMXMLCommunicationMechanismHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_CIMXMLCommunicationMechanism dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_CIMXMLCommunicationMechanism.getPackages());
    }
