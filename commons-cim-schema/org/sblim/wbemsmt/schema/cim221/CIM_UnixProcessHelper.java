/** 
  ...
  * 
  * Description: Helper class for CIM_UnixProcess
  *    
  * 
  * generated Class
  * @see CIM_UnixProcess
...
public class CIM_UnixProcessHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_UnixProcess or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_UnixProcess.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_UnixProcess.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_UnixProcess or the subclasses if deep == true
    */        
    public final static List<CIM_UnixProcess> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_UnixProcess> resultArrayList = new ArrayList<CIM_UnixProcess>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_UnixProcess.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_UnixProcess(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_UnixProcessHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_UnixProcess.");
                        resultArrayList.add(new CIM_UnixProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_UnixProcess.");
                        resultArrayList.add(new CIM_UnixProcess(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_UnixProcess)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_UnixProcess.");
                        resultArrayList.add(new CIM_UnixProcess(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_UnixProcess getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_UnixProcess getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_UnixProcess dataInstance = null;
        Class<?> clazz = CIM_UnixProcessHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_UnixProcess)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_UnixProcess.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_UnixProcess(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_UnixProcess getInstance(WBEMClient client, String namespace
        ...
        CIMProperty[] keyProperties = new CIMProperty[6];
        
        Object setThis = null;

                   
                   setThis = CSCreationClassName;
                
           keyProperties[0]  = new CIMProperty(CIM_UnixProcess.PROPERTY_CSCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_UnixProcess.CIM_CLASS_NAME); 
                   
                   setThis = CSName;
                
           keyProperties[1]  = new CIMProperty(CIM_UnixProcess.PROPERTY_CSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_UnixProcess.CIM_CLASS_NAME); 
                   
                   setThis = CreationClassName;
                
           keyProperties[2]  = new CIMProperty(CIM_UnixProcess.PROPERTY_CREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_UnixProcess.CIM_CLASS_NAME); 
                   
                   setThis = Handle;
                
           keyProperties[3]  = new CIMProperty(CIM_UnixProcess.PROPERTY_HANDLE.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_UnixProcess.CIM_CLASS_NAME); 
                   
                   setThis = OSCreationClassName;
                
           keyProperties[4]  = new CIMProperty(CIM_UnixProcess.PROPERTY_OSCREATIONCLASSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_UnixProcess.CIM_CLASS_NAME); 
                   
                   setThis = OSName;
                
           keyProperties[5]  = new CIMProperty(CIM_UnixProcess.PROPERTY_OSNAME.NAME,CIMDataType.STRING_T,setThis,true,false,CIM_UnixProcess.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_UnixProcess.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_UnixProcess createInstance(WBEMClient client, CIM_UnixProcess dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_UnixProcess newDataInstance = CIM_UnixProcessHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_UnixProcess modifyInstance(WBEMClient client, CIM_UnixProcess dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_UnixProcess dataInstance2 = CIM_UnixProcessHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_UnixProcess dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_UnixProcess.getPackages());
    }
