/** 
  * CIM_HostedDependencyHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_HostedDependency
  *    
  * 
  * generated Class
  * @see CIM_HostedDependency
  */
...
public class CIM_HostedDependencyHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_HostedDependency or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_HostedDependency.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_HostedDependency.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_HostedDependency or the subclasses if deep == true
    */        
    public final static List<CIM_HostedDependency> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_HostedDependency> resultArrayList = new ArrayList<CIM_HostedDependency>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_HostedDependency.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostedDependency(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_HostedDependencyHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_HostedDependency.");
                        resultArrayList.add(new CIM_HostedDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_HostedDependency.");
                        resultArrayList.add(new CIM_HostedDependency(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_HostedDependency)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_HostedDependency.");
                        resultArrayList.add(new CIM_HostedDependency(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_HostedDependency getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_HostedDependency getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_HostedDependency dataInstance = null;
        Class<?> clazz = CIM_HostedDependencyHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_HostedDependency)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_HostedDependency.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_HostedDependency(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_HostedDependency getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_HostedDependency.PROPERTY_ANTECEDENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_HostedDependency.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_HostedDependency.PROPERTY_DEPENDENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_HostedDependency.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_HostedDependency.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_HostedDependency createInstance(WBEMClient client, CIM_HostedDependency dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_HostedDependency newDataInstance = CIM_HostedDependencyHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_HostedDependency modifyInstance(WBEMClient client, CIM_HostedDependency dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_HostedDependency dataInstance2 = CIM_HostedDependencyHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_HostedDependency dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_HostedDependency.getPackages());
    }
