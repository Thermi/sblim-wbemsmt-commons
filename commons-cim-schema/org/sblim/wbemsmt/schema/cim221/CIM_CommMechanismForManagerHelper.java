/** 
  * CIM_CommMechanismForManagerHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_CommMechanismForManager
  *    
  * 
  * generated Class
  * @see CIM_CommMechanismForManager
  */
...
public class CIM_CommMechanismForManagerHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_CommMechanismForManager or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_CommMechanismForManager.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_CommMechanismForManager.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_CommMechanismForManager or the subclasses if deep == true
    */        
    public final static List<CIM_CommMechanismForManager> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_CommMechanismForManager> resultArrayList = new ArrayList<CIM_CommMechanismForManager>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_CommMechanismForManager.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_CommMechanismForManager(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_CommMechanismForManagerHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_CommMechanismForManager.");
                        resultArrayList.add(new CIM_CommMechanismForManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_CommMechanismForManager.");
                        resultArrayList.add(new CIM_CommMechanismForManager(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_CommMechanismForManager)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CommMechanismForManager.");
                        resultArrayList.add(new CIM_CommMechanismForManager(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_CommMechanismForManager getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_CommMechanismForManager getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_CommMechanismForManager dataInstance = null;
        Class<?> clazz = CIM_CommMechanismForManagerHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_CommMechanismForManager)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_CommMechanismForManager.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_CommMechanismForManager(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_CommMechanismForManager getInstance(WBEMClient client, String namespace
                                                       ,CIM_ObjectManager Antecedent
                                                       ,CIM_ObjectManagerCommunicationMechanism Dependent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_CommMechanismForManager.PROPERTY_ANTECEDENT_CIM_OBJECTMANAGER.NAME,new CIMDataType(CIM_ObjectManager.CIM_CLASS_NAME),setThis,false,false,CIM_CommMechanismForManager.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_CommMechanismForManager.PROPERTY_DEPENDENT_CIM_OBJECTMANAGERCOMMUNICATIONMECHANISM.NAME,new CIMDataType(CIM_ObjectManagerCommunicationMechanism.CIM_CLASS_NAME),setThis,false,false,CIM_CommMechanismForManager.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_CommMechanismForManager.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_CommMechanismForManager createInstance(WBEMClient client, CIM_CommMechanismForManager dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_CommMechanismForManager newDataInstance = CIM_CommMechanismForManagerHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_CommMechanismForManager modifyInstance(WBEMClient client, CIM_CommMechanismForManager dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_CommMechanismForManager dataInstance2 = CIM_CommMechanismForManagerHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_CommMechanismForManager dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_CommMechanismForManager.getPackages());
    }
