/** 
  * CIM_LogicalIdentityHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_LogicalIdentity
  *    
  * 
  * generated Class
  * @see CIM_LogicalIdentity
  */
...
public class CIM_LogicalIdentityHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_LogicalIdentity or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_LogicalIdentity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_LogicalIdentity.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_LogicalIdentity or the subclasses if deep == true
    */        
    public final static List<CIM_LogicalIdentity> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_LogicalIdentity> resultArrayList = new ArrayList<CIM_LogicalIdentity>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_LogicalIdentity.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_LogicalIdentity(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_LogicalIdentityHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_LogicalIdentity.");
                        resultArrayList.add(new CIM_LogicalIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_LogicalIdentity.");
                        resultArrayList.add(new CIM_LogicalIdentity(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_LogicalIdentity)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_LogicalIdentity.");
                        resultArrayList.add(new CIM_LogicalIdentity(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_LogicalIdentity getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_LogicalIdentity getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_LogicalIdentity dataInstance = null;
        Class<?> clazz = CIM_LogicalIdentityHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_LogicalIdentity)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_LogicalIdentity.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_LogicalIdentity(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_LogicalIdentity getInstance(WBEMClient client, String namespace
                                                       ,CIM_ManagedElement SystemElement
                                                       ,CIM_ManagedElement SameElement
        ...
        Object setThis = null;
                                 ...
                                 setThis = SystemElement != null ? SystemElement.getCimObjectPath() : null;
                           
           keyProperties[0]  = new CIMProperty(CIM_LogicalIdentity.PROPERTY_SYSTEMELEMENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_LogicalIdentity.CIM_CLASS_NAME); 
                   
                                 setThis = SameElement != null ? SameElement.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_LogicalIdentity.PROPERTY_SAMEELEMENT_CIM_MANAGEDELEMENT.NAME,new CIMDataType(CIM_ManagedElement.CIM_CLASS_NAME),setThis,false,false,CIM_LogicalIdentity.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_LogicalIdentity.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    */    
    public final static void deleteInstance(WBEMClient client, CIM_LogicalIdentity dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_LogicalIdentity.getPackages());
    }
