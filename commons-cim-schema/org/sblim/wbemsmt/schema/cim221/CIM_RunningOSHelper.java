/** 
  ...
  * 
  * Description: Helper class for CIM_RunningOS
  *    
  * 
  * generated Class
  * @see CIM_RunningOS
...
public class CIM_RunningOSHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_RunningOS or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_RunningOS.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_RunningOS.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_RunningOS or the subclasses if deep == true
    */        
    public final static List<CIM_RunningOS> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_RunningOS> resultArrayList = new ArrayList<CIM_RunningOS>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_RunningOS.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_RunningOS(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_RunningOSHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_RunningOS.");
                        resultArrayList.add(new CIM_RunningOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_RunningOS.");
                        resultArrayList.add(new CIM_RunningOS(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_RunningOS)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RunningOS.");
                        resultArrayList.add(new CIM_RunningOS(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_RunningOS getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_RunningOS getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_RunningOS dataInstance = null;
        Class<?> clazz = CIM_RunningOSHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_RunningOS)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_RunningOS.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_RunningOS(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_RunningOS getInstance(WBEMClient client, String namespace
                                                       ,CIM_OperatingSystem Antecedent
                                                       ,CIM_ComputerSystem Dependent
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_RunningOS.PROPERTY_ANTECEDENT_CIM_OPERATINGSYSTEM.NAME,new CIMDataType(CIM_OperatingSystem.CIM_CLASS_NAME),setThis,false,false,CIM_RunningOS.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_RunningOS.PROPERTY_DEPENDENT_CIM_COMPUTERSYSTEM.NAME,new CIMDataType(CIM_ComputerSystem.CIM_CLASS_NAME),setThis,false,false,CIM_RunningOS.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_RunningOS.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_RunningOS createInstance(WBEMClient client, CIM_RunningOS dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_RunningOS newDataInstance = CIM_RunningOSHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_RunningOS modifyInstance(WBEMClient client, CIM_RunningOS dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_RunningOS dataInstance2 = CIM_RunningOSHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_RunningOS dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_RunningOS.getPackages());
    }
