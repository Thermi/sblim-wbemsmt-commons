/** 
  ...
  * 
  * Description: Helper class for CIM_ElementSetting
  *    
  * 
  * generated Class
  * @see CIM_ElementSetting
  */
...
public class CIM_ElementSettingHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_ElementSetting or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_ElementSetting.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_ElementSetting.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_ElementSetting or the subclasses if deep == true
    */        
    public final static List<CIM_ElementSetting> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_ElementSetting> resultArrayList = new ArrayList<CIM_ElementSetting>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_ElementSetting.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_ElementSetting(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_ElementSettingHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_ElementSetting.");
                        resultArrayList.add(new CIM_ElementSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_ElementSetting.");
                        resultArrayList.add(new CIM_ElementSetting(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_ElementSetting)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementSetting.");
                        resultArrayList.add(new CIM_ElementSetting(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_ElementSetting getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_ElementSetting getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_ElementSetting dataInstance = null;
        Class<?> clazz = CIM_ElementSettingHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_ElementSetting)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_ElementSetting.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_ElementSetting(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_ElementSetting getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_ElementSetting.PROPERTY_ELEMENT_CIM_MANAGEDSYSTEMELEMENT.NAME,new CIMDataType(CIM_ManagedSystemElement.CIM_CLASS_NAME),setThis,false,false,CIM_ElementSetting.CIM_CLASS_NAME); 
                   
                                 setThis = Setting != null ? Setting.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_ElementSetting.PROPERTY_SETTING_CIM_SETTING.NAME,new CIMDataType(CIM_Setting.CIM_CLASS_NAME),setThis,false,false,CIM_ElementSetting.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_ElementSetting.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_ElementSetting createInstance(WBEMClient client, CIM_ElementSetting dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_ElementSetting newDataInstance = CIM_ElementSettingHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_ElementSetting modifyInstance(WBEMClient client, CIM_ElementSetting dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_ElementSetting dataInstance2 = CIM_ElementSettingHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_ElementSetting dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_ElementSetting.getPackages());
    }
