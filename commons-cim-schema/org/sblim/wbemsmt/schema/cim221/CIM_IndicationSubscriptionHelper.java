/** 
  ...
  * 
  * Description: Helper class for CIM_IndicationSubscription
  *    
  * 
  * generated Class
  * @see CIM_IndicationSubscription
  */
...
public class CIM_IndicationSubscriptionHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_IndicationSubscription or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_IndicationSubscription.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_IndicationSubscription.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_IndicationSubscription or the subclasses if deep == true
    */        
    public final static List<CIM_IndicationSubscription> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_IndicationSubscription> resultArrayList = new ArrayList<CIM_IndicationSubscription>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_IndicationSubscription.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_IndicationSubscription(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_IndicationSubscriptionHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_IndicationSubscription)dataObj);
                    } catch (Exception e) {
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_IndicationSubscription getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_IndicationSubscription getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_IndicationSubscription)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_IndicationSubscription.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_IndicationSubscription(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_IndicationSubscription getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
                                 ...
                                 setThis = Filter != null ? Filter.getCimObjectPath() : null;
                           
           keyProperties[0]  = new CIMProperty(CIM_IndicationSubscription.PROPERTY_FILTER_CIM_INDICATIONFILTER.NAME,new CIMDataType(CIM_IndicationFilter.CIM_CLASS_NAME),setThis,false,false,CIM_IndicationSubscription.CIM_CLASS_NAME); 
                   
                                 setThis = Handler != null ? Handler.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_IndicationSubscription.PROPERTY_HANDLER_CIM_LISTENERDESTINATION.NAME,new CIMDataType(CIM_ListenerDestination.CIM_CLASS_NAME),setThis,false,false,CIM_IndicationSubscription.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_IndicationSubscription.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_IndicationSubscription createInstance(WBEMClient client, CIM_IndicationSubscription dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_IndicationSubscription newDataInstance = CIM_IndicationSubscriptionHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_IndicationSubscription modifyInstance(WBEMClient client, CIM_IndicationSubscription dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_IndicationSubscription dataInstance2 = CIM_IndicationSubscriptionHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_IndicationSubscription dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_IndicationSubscription.getPackages());
    }
