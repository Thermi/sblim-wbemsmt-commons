/** 
  * CIM_HostedAccessPointHelper.java
  *
  * 
  ...
  * 
  * Description: Helper class for CIM_HostedAccessPoint
  *    
  * 
  * generated Class
  * @see CIM_HostedAccessPoint
  */
...
public class CIM_HostedAccessPointHelper extends AbstractWbemsmtFcoHelper
{
...
//**********************************************************************
    ...
    *
    * @return a list of CIMObjectPathes of instances of type CIM_HostedAccessPoint or the subclasses if deep == true
    */    
    public final static List<CIMObjectPath> enumerateInstanceNames(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
       ...
       CloseableIterator iterator = null;
	       ...
	       CIMObjectPath path = new CIMObjectPath(CIM_HostedAccessPoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace));
       ...
       try {
           ...
           while (iterator != null && iterator.hasNext()) {
              ...
              if (deep || CIM_HostedAccessPoint.CIM_CLASS_NAME.equals(cimObjectPath.getObjectName())) {
    ...
    * @param deep set to true if the subclasses should be also included
    *
    * @return a list of instances of type CIM_HostedAccessPoint or the subclasses if deep == true
    */        
    public final static List<CIM_HostedAccessPoint> enumerateInstances(WBEMClient client, String namespace, boolean deep) throws WbemsmtException {
    
        ArrayList<CIM_HostedAccessPoint> resultArrayList = new ArrayList<CIM_HostedAccessPoint>();
        ...
        try {
            while (iterator.hasNext()) {
                ...
                if (obj instanceof CIMInstance) {
                    ...
                    if (!deep && cimInstance.getClassName().equals(CIM_HostedAccessPoint.CIM_CLASS_NAME)) {
                        resultArrayList.add(new CIM_HostedAccessPoint(cimInstance));
                        continue;
                    }
                    Class<?> clazz = CIM_HostedAccessPointHelper.findClass(client, cimInstance);
                    if (clazz == null) {
                        System.err.println("The class " + cimInstance.getClassName() +" was not found. Constructing instance of class CIM_HostedAccessPoint.");
                        resultArrayList.add(new CIM_HostedAccessPoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        System.err.println("The required constructor of class " + cimInstance.getClassName() + " could not be found. Constructing instance of class CIM_HostedAccessPoint.");
                        resultArrayList.add(new CIM_HostedAccessPoint(cimInstance));
                        continue;
                    }
                    ...
                    try {
                        ...
                        resultArrayList.add((CIM_HostedAccessPoint)dataObj);
                    } catch (Exception e) {
                        System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_HostedAccessPoint.");
                        resultArrayList.add(new CIM_HostedAccessPoint(cimInstance));
                        continue;
                    }
...
//**********************************************************************
    ...
    * @return the instance
    */    
    public final static CIM_HostedAccessPoint getInstance(WBEMClient client, CIMObjectPath cimObjectPath) throws WbemsmtException  {
    ...
    */    
    public final static CIM_HostedAccessPoint getInstance(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException  {
        
        CIM_HostedAccessPoint dataInstance = null;
        Class<?> clazz = CIM_HostedAccessPointHelper.findClass(client, cimInstance);
        ...
        else
        {
            ...
            try {
                ...
                Object[] actargs = new Object[] {cimInstance};
                dataInstance = (CIM_HostedAccessPoint)cons.newInstance(actargs);
            } catch (Exception e) {
                System.err.println("The instance of class " + cimInstance.getClassName() + " could not be created successful. Constructing instance of class CIM_HostedAccessPoint.");
            }
        }
        ...
        try {
            ...
            {
                dataInstance = new CIM_HostedAccessPoint(cimInstance);
            }
        } catch (Exception e) {
    ...
    */    
    public final static CIM_HostedAccessPoint getInstance(WBEMClient client, String namespace
        ...
        Object setThis = null;
           ...
           keyProperties[0]  = new CIMProperty(CIM_HostedAccessPoint.PROPERTY_ANTECEDENT_CIM_SYSTEM.NAME,new CIMDataType(CIM_System.CIM_CLASS_NAME),setThis,false,false,CIM_HostedAccessPoint.CIM_CLASS_NAME); 
                   
                                 setThis = Dependent != null ? Dependent.getCimObjectPath() : null;
                           
           keyProperties[1]  = new CIMProperty(CIM_HostedAccessPoint.PROPERTY_DEPENDENT_CIM_SERVICEACCESSPOINT.NAME,new CIMDataType(CIM_ServiceAccessPoint.CIM_CLASS_NAME),setThis,false,false,CIM_HostedAccessPoint.CIM_CLASS_NAME); 
                
        
        CIMObjectPath path = new CIMObjectPath(CIM_HostedAccessPoint.CIM_CLASS_NAME,AbstractWbemsmtFcoHelper.harmonizeNamespace(namespace),keyProperties);        
...
//**********************************************************************
    ...
    *
    */    
    public final static CIM_HostedAccessPoint createInstance(WBEMClient client, CIM_HostedAccessPoint dataInstance, boolean notifyDifferencies)
           throws WbemsmtException
    { 
        ...
        CIM_HostedAccessPoint newDataInstance = CIM_HostedAccessPointHelper.getInstance(client, cimObjectPath);
...
//**********************************************************************
    ...
    */    
    public final static CIM_HostedAccessPoint modifyInstance(WBEMClient client, CIM_HostedAccessPoint dataInstance, boolean notifyDifferencies) throws WbemsmtException { 
        ...
        if (dataInstance.isModified()) {
           ...
           CIM_HostedAccessPoint dataInstance2 = CIM_HostedAccessPointHelper.getInstance(client, dataInstance.getCimObjectPath());
           if (notifyDifferencies)
           {
...
//**********************************************************************
    ...
    * @param dataInstance the FCO to create
    */    
    public final static void deleteInstance(WBEMClient client, CIM_HostedAccessPoint dataInstance) throws WbemsmtException {
...
//**********************************************************************
    ...
    public static Class<?> findClass(WBEMClient client, CIMInstance cimInstance) throws WbemsmtException {
        ...
        return org.sblim.wbemsmt.bl.fco.AbstractWbemsmtFcoHelper.findClass(client,cimInstance,CIM_HostedAccessPoint.getPackages());
    }
