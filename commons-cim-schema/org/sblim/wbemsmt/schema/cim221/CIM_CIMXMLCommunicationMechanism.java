/**
 * CIM_CIMXMLCommunicationMechanism.java Â© Copyright IBM Corp.  2009,2005 THIS FILE IS PROVIDED
 ...
 *            Karnam<prkarnam@in.ibm.com> Description: This class specializes
 *            ObjectManagerCommunicationMechanism, adding properties specific to the CIM-XML
 *            protocol (XML encoding and CIM Operations). generated Class
 */
...
public class CIM_CIMXMLCommunicationMechanism extends CIM_ObjectManagerCommunicationMechanism {
    ...
    public static class PROPERTY_COMMUNICATIONMECHANISM {
         ...
         */
        public final static javax.cim.UnsignedInteger16[] VALUE_MAP_ENTRIES = { VALUE_MAP_ENTRY_2_FOR_VALUE_ENTRY_CIM_XML };
         ...
         * Value Map for the property CommunicationMechanism   
         */
        public final static String[] VALUE_ENTRIES = { VALUE_ENTRY_CIM_XML };
         ...
         * Value Map for the property CommunicationMechanism   
         */
        public final static String[] VALUE_ENTRIES_FOR_DISPLAY = { VALUE_ENTRY_CIM_XML };
    ...
    public boolean set_CIMValidated(Boolean newValue) {
        ...
        if (currentProperty != null) {
            setProperty(setPropertyValue_CIMValidated(currentProperty, newValue));
            return true;
        }
        else {
            logger.warning("Property " + PROPERTY_CIMVALIDATED.NAME + " was not found in instance "
    ...
    public boolean set_CIMXMLProtocolVersion(javax.cim.UnsignedInteger16 newValue) {
        CIMProperty currentProperty = getProperty(PROPERTY_CIMXMLPROTOCOLVERSION.NAME);
        if (currentProperty != null) {
            setProperty(setPropertyValue_CIMXMLProtocolVersion(currentProperty, newValue));
            return true;
        }
        else {
            logger.warning("Property " + PROPERTY_CIMXMLPROTOCOLVERSION.NAME
