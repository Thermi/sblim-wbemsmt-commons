...
public class JsfLayouter {
	...
	protected HtmlOutputText getLabel(ValueExpression valueExpressionForText) {
		HtmlOutputText result = (HtmlOutputText) create(HtmlOutputText.COMPONENT_TYPE);
		result.setValueExpression("value",valueExpressionForText);
		return result;
	}
	...
	protected HtmlOutputText getLabelWithBoundValue(String appName,String key)
	{
		...
		return getLabel(localeManager.getExpression(appName, key));
