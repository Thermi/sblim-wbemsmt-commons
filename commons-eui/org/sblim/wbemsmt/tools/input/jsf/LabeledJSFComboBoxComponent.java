...
public class LabeledJSFComboBoxComponent extends LabeledJSFInputComponent implements LabeledStringArrayInputComponentIf {
	...
	private static void setComponentExpressions1(LabeledJSFComboBoxComponent component, String id) {
    ...
    public static void setComponentExpressions(HtmlSelectOneMenu menu, String id) {
	...
	public void installProperties(LabeledJSFInputComponent comp, String prefix) {
		...
		setComponentExpressions1((LabeledJSFComboBoxComponent) comp,prefix);
	}	
